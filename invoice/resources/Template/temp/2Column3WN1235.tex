...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Catherine  Lundin} \\
		{\large Amir 41}\\
		{\large 92117, Nha Trang, Texas, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caroline Edward Jönsson Pte Ltd } \\
		{\large Hazel 54}\\
		{\large 83092, Hanoi, Guangzhou, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
