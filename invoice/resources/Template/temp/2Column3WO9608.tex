...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Calvin Christopher Mohamed Pte Ltd} \\
		{\large Valentina 29}\\
		{\large 79533, Singapore, Floria, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kendall Fredriksson } \\
		{\large Kinsley 19}\\
		{\large 12781, Minsk, Bangkok, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
