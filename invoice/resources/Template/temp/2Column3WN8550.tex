...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jake Lee  Blom} \\
		{\large Mark 38}\\
		{\large 21912, Los Angeles, Hainan, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abigail Peter Berglund Corp } \\
		{\large Bryson 50}\\
		{\large 32446, Frankfurt am Main , Floria, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
