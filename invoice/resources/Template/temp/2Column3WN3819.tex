...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ayden William Hermansson} \\
		{\large Nathaniel 68}\\
		{\large 86109, Shanghai, Seattles, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bradley Robert Andreasson Pte Ltd } \\
		{\large Chase 97}\\
		{\large 30263, Moscow, Guangzhou, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
