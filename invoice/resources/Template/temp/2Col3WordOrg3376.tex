...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eliana Marie 	 Engström Pte Ltd} \\
		{\large Hadley 66}\\
		{\large 12565, Singapore, Amnat Charoen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camden Forsberg } \\
		{\large Maxwell 22}\\
		{\large 63614, New York , California, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
