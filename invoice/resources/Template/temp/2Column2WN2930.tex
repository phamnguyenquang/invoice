...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kenneth Ström} \\
		{\large Alexander 2}\\
		{\large 47489, Hong Kong, Huabei, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vivian David Lundström Corp } \\
		{\large Jonah 99}\\
		{\large 77147, Frankfurt am Main , Guangdong, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
