...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elijah Grace 	 Månsson} \\
		{\large Vanessa 89}\\
		{\large 82518, SaiGon, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large James  Alexander  Andersson Corp } \\
		{\large Athena 32}\\
		{\large 26366, Amsterdam, Buriam, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
