...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity Louise 	 Berggren} \\
		{\large Hazel 17}\\
		{\large 57543, Montreal, Guangdong, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nevaeh James Åkesson Pte Ltd } \\
		{\large Savannah 32}\\
		{\large 34466, Ho Chi Minh, Chiang Mai, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
