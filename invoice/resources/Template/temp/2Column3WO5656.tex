...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaitlyn Victoria Claesson Corp} \\
		{\large Luis 77}\\
		{\large 37403, Frankfurt am Main , Chiang Mai, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniel Hermansson } \\
		{\large Santiago 40}\\
		{\large 54653, Singapore, Bremen, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
