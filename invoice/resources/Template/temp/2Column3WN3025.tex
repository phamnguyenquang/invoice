...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline James Jansson} \\
		{\large Ariel 12}\\
		{\large 18518, Los Angeles, Saarland, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liam Thomas Lundberg Inc } \\
		{\large Lydia 5}\\
		{\large 24945, Melbourne, Indiana, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
