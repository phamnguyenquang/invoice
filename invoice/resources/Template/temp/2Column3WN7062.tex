...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jessica William Björk} \\
		{\large Roman 1}\\
		{\large 69491, Venice, Buriam, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emily Louise 	 Hellström Pte Ltd } \\
		{\large Avery 96}\\
		{\large 30273, Frankfurt am Main , Indiana, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
