...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  École des hautes études en sciences sociales} \\
		{\large Hailey 21}\\
		{\large 44768, Denver, California, Saudi Arabia }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Isabella Holmgren } \\
		{\large Kimberly 46}\\
		{\large 99351, SaiGon, Hessen, Turkey }\\
    \switchcolumn
