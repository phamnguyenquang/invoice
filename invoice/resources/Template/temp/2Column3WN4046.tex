...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tyler William Nordström} \\
		{\large Paige 60}\\
		{\large 66833, Lisbon, Heibei, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caroline  Alexander  Sandström Inc } \\
		{\large Riley 56}\\
		{\large 62205, Minsk, Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
