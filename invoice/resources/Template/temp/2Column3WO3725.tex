...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Antonio John Bergqvist Ltd} \\
		{\large Melody 43}\\
		{\large 20539, San Francisco, Hawaii, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Calvin Jakobsson } \\
		{\large Rose 59}\\
		{\large 54623, Amsterdam, Indiana, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
