...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vanessa Michael Fredriksson} \\
		{\large Jacob 27}\\
		{\large 65623, Hong Kong, Hessen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large King David Holmgren Ltd } \\
		{\large Ezekiel 10}\\
		{\large 83888, London , Bangkok, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
