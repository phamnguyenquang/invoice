...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Berglund} \\
		{\large Carson 16}\\
		{\large 66882, Moscow, Binh Thuan, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josiah William Lundberg Inc } \\
		{\large Sean 39}\\
		{\large 56579, Frankfurt am Main , Hamburg, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
