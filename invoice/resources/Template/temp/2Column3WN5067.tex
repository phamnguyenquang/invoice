...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Connor Christopher Isaksson} \\
		{\large Cora 29}\\
		{\large 36941, Shanghai, Hessen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cole Catherine  Bergqvist Inc } \\
		{\large Nora 13}\\
		{\large 43883, Sydney, Chiang Rai, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
