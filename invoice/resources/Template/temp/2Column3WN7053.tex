...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ava Michael Olofsson} \\
		{\large Scarlett 83}\\
		{\large 68594, San Francisco, Kentucky, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaiden Thomas Hansson Corp } \\
		{\large Stella 92}\\
		{\large 81936, Singapore, khanh Hoa, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
