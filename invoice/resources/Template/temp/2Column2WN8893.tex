...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rebecca Hermansson} \\
		{\large Graham 7}\\
		{\large 82467, Paris, California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Braxton Marie 	 Björklund Ltd } \\
		{\large Mia 76}\\
		{\large 21669, Ho Chi Minh, Ang Thong, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
