...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michelle Catherine  Abrahamsson Corp} \\
		{\large Jameson 27}\\
		{\large 47122, Last Vegas, khanh Hoa, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madeline Johansson } \\
		{\large Juliana 16}\\
		{\large 16774, Abu Dhabi, Huabei, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
