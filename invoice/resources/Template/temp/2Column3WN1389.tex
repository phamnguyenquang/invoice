...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Noah Elizabeth 	 Lindström} \\
		{\large Ezra 57}\\
		{\large 80166, Melbourne, Amnat Charoen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samuel David Lindberg Ltd } \\
		{\large Faith 71}\\
		{\large 78852, Hong Kong, Hessen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
