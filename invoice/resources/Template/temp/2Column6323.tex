...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Claesson Corp} \\
		{\large Christopher 76}\\
		{\large 26720, Singapore, Henan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Taylor Pettersson } \\
		{\large Oscar 39}\\
		{\large 47196, Shanghai, Ang Thong, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
