...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles Louise 	 Strömberg Ltd} \\
		{\large Jesus 55}\\
		{\large 51737, Vancouver, Binh Thuan, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ava Johansson } \\
		{\large Faith 76}\\
		{\large 13731, New York , Amnat Charoen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
