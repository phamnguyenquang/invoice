...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maverick Anne Berg Ltd} \\
		{\large Cora 34}\\
		{\large 96310, Frankfurt am Main , Saarland, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grayson Danielsson } \\
		{\large Maximus 63}\\
		{\large 44764, Chicago, California, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
