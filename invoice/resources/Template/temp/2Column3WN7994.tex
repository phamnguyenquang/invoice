...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  London Elizabeth 	 Nordström} \\
		{\large Micah 34}\\
		{\large 79381, Lisbon, Hawaii, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Marcus Peter Dahlberg Inc } \\
		{\large Mya 18}\\
		{\large 44210, Florence, Chiang Mai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
