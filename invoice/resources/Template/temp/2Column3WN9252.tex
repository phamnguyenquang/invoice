...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cole Rose 	 Nyström} \\
		{\large Timothy 6}\\
		{\large 30262, SaiGon, Hawaii, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalynn William Lundström Pte Ltd } \\
		{\large Andrew 31}\\
		{\large 36845, New York , Bremen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
