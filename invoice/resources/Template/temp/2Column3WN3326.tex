...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lila Edward Andersson} \\
		{\large Paisley 96}\\
		{\large 43943, Florence, Buriam, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Audrey  Alexander  Claesson Pte Ltd } \\
		{\large Caden 33}\\
		{\large 58759, Washington, Texas, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
