...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dominic Christopher Lindholm Ltd} \\
		{\large Aubrey 64}\\
		{\large 21479, New York , Guangzhou, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mackenzie Lindström } \\
		{\large Elias 2}\\
		{\large 72212, Singapore, Binh Thuan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
