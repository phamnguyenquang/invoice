...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Annabelle Samuelsson} \\
		{\large Lila 60}\\
		{\large 92747, Shanghai, Tuscany, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abraham David Abrahamsson Ltd } \\
		{\large Alexandra 86}\\
		{\large 11360, Ho Chi Minh, Hessen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
