...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leonardo Robert Lindberg} \\
		{\large Dominic 54}\\
		{\large 40827, Seoul, Guangdong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sofia Ann  Holmgren Pte Ltd } \\
		{\large Jayla 99}\\
		{\large 61323, Toronto, Ang Thong, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
