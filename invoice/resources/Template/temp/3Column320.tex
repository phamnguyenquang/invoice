...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  École pratique des hautes études} \\
		{\large Khloe 66}\\
		{\large 26832, Berlin, Guangdong, United Kingdom}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Sawyer Eliasson } \\
		{\large Adrian 82}\\
		{\large 86651, Istanbul, Henan, United Kingdom}\\
    \switchcolumn
