...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cayden Strömberg} \\
		{\large Abel 16}\\
		{\large 97727, Frankfurt am Main , Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large George Rose 	 Andreasson Ltd } \\
		{\large Hayden 43}\\
		{\large 28075, Frankfurt am Main , Chiang Rai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
