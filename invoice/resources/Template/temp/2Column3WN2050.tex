...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte Marie 	 Eriksson} \\
		{\large Jordyn 95}\\
		{\large 31427, New York , Ang Thong, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maya Peter Ekström Ltd } \\
		{\large Wyatt 74}\\
		{\large 35778, Berlin, California, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
