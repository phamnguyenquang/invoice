...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryker Lee  Claesson} \\
		{\large Makayla 90}\\
		{\large 83848, New York , California, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklynn Ann  Berglund Pte Ltd } \\
		{\large Luca 34}\\
		{\large 32418, Denver, Kentucky, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
