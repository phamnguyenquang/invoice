...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vincent William Holmgren Inc} \\
		{\large Adalynn 21}\\
		{\large 67403, Frankfurt am Main , Hamburg, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrew Håkansson } \\
		{\large Sawyer 57}\\
		{\large 77714, Nha Trang, Hainan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
