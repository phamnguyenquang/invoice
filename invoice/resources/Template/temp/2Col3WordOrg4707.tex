...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Victoria Lundqvist Corp} \\
		{\large Caleb 62}\\
		{\large 34099, Lisbon, Ang Thong, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brian Jansson } \\
		{\large Cayden 62}\\
		{\large 18745, Singapore, Guangdong, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
