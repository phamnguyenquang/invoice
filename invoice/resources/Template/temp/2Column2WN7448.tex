...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Athena Håkansson} \\
		{\large Steven 97}\\
		{\large 25957, Stuttgart, Ang Thong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vincent Elizabeth 	 Öberg Pte Ltd } \\
		{\large Miguel 64}\\
		{\large 95392, Singapore, California, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
