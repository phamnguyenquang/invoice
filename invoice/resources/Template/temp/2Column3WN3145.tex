...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leonardo Michael Sandberg} \\
		{\large Adeline 54}\\
		{\large 33678, Ho Chi Minh, Chai Nat, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon Lee  Lundberg Corp } \\
		{\large Autumn 7}\\
		{\large 20858, Bonn, Chai Nat, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
