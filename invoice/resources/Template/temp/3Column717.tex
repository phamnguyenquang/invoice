...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Amirkabir University of Technology} \\
		{\large Allison 72}\\
		{\large 11273, Abu Dhabi, Heibei, Saudi Arabia }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Emilia Björklund } \\
		{\large Max 6}\\
		{\large 95874, Osaka, Seattles, Indonesia s}\\
    \switchcolumn
