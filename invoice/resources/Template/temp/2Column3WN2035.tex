...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dominic Edward Sjöberg} \\
		{\large Adeline 45}\\
		{\large 39352, Amsterdam, Phu Yen, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harmony Peter Blomqvist Pte Ltd } \\
		{\large Bryce 93}\\
		{\large 56139, SaiGon, Chiang Rai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
