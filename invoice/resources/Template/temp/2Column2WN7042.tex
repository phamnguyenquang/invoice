...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Allison Forsberg} \\
		{\large Morgan 23}\\
		{\large 87557, Washington, Saarland, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brian  Alexander  Olofsson Pte Ltd } \\
		{\large Nathan 43}\\
		{\large 11521, Frankfurt am Main , Saarland, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
