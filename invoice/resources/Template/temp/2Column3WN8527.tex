...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Greyson Thomas Nyström} \\
		{\large Julia 99}\\
		{\large 41871, Istanbul, Bremen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everly Christopher Pettersson Pte Ltd } \\
		{\large King 57}\\
		{\large 46586, Boston, California, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
