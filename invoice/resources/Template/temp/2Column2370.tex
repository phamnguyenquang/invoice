...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  James Engström Pte Ltd} \\
		{\large Willow 60}\\
		{\large 81810, Frankfurt am Main , Guangzhou, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalie Karlsson } \\
		{\large Ezekiel 54}\\
		{\large 62598, Singapore, California, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
