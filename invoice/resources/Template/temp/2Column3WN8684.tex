...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madison Mary 	 Wikström} \\
		{\large Jeremiah 65}\\
		{\large 31104, Frankfurt am Main , Hainan, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Greyson  Alexander  Hansson Inc } \\
		{\large Sawyer 28}\\
		{\large 99080, Bonn, Chiang Mai, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
