...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aliyah Catherine  Sandström Pte Ltd} \\
		{\large Aaron 81}\\
		{\large 62265, Toronto, Buriam, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rachel Eliasson } \\
		{\large Mckenzie 90}\\
		{\large 48574, Chicago, Amnat Charoen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
