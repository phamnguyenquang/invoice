...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaden Elizabeth 	 Ahmed} \\
		{\large Jaxon 78}\\
		{\large 21156, Venice, Hamburg, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Payton Elizabeth 	 Pettersson Inc } \\
		{\large Valeria 22}\\
		{\large 97172, San Francisco, Ang Thong, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
