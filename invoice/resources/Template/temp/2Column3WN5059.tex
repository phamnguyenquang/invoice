...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Quinn Marie 	 Forsberg} \\
		{\large Destiny 12}\\
		{\large 25041, SaiGon, Hainan, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Graham Peter Lindberg Pte Ltd } \\
		{\large Ruby 87}\\
		{\large 50820, Frankfurt am Main , Guangdong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
