...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Louise 	 Lundin} \\
		{\large Leah 16}\\
		{\large 45585, Abu Dhabi, Guangdong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lauren Peter Sandberg Ltd } \\
		{\large Cora 25}\\
		{\large 11773, Shanghai, Chiang Mai, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
