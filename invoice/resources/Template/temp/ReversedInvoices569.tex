...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Medical College of Wisconsin} \\
		{\large Hazel 72}\\
		{\large 22548, Hong Kong, California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stella Johansson } \\
		{\large Katherine 34}\\
		{\large 96399, Tokyo, Floria, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
