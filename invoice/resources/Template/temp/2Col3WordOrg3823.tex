...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brielle John Persson Pte Ltd} \\
		{\large Kaden 3}\\
		{\large 11495, Frankfurt am Main , Saarland, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eliana Löfgren } \\
		{\large Elise 32}\\
		{\large 73950, Hanoi, Chiang Rai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
