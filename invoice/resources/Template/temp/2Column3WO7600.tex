...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hazel Mary 	 Martinsson Inc} \\
		{\large Vanessa 64}\\
		{\large 62444, Vancouver, Binh Thuan, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joseph Dahlberg } \\
		{\large Mia 60}\\
		{\large 59576, Frankfurt am Main , Bangkok, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
