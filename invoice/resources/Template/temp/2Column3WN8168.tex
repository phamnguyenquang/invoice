...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope Louise 	 Abrahamsson} \\
		{\large Leah 77}\\
		{\large 75543, Lisbon, Hawaii, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mason Elizabeth 	 Isaksson Inc } \\
		{\large Aidan 66}\\
		{\large 30969, Berlin, Binh Thuan, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
