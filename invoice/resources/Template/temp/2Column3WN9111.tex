...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bentley Mary 	 Holmberg} \\
		{\large Jude 80}\\
		{\large 44068, Washington, Buriam, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Steven Catherine  Bergqvist Pte Ltd } \\
		{\large Isabel 19}\\
		{\large 42896, Beijing, khanh Hoa, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
