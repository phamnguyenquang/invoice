...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaliyah Marie 	 Gustafsson Inc} \\
		{\large Adeline 96}\\
		{\large 46214, Frankfurt am Main , Seattles, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Steven Gustafsson } \\
		{\large Lydia 69}\\
		{\large 65127, Hanoi, Ang Thong, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
