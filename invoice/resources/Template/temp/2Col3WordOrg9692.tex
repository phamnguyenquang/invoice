...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sara Louise 	 Eriksson Ltd} \\
		{\large Londyn 44}\\
		{\large 35343, Munich, Guangzhou, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniela Pettersson } \\
		{\large Dominic 2}\\
		{\large 92604, Frankfurt am Main , Guangzhou, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
