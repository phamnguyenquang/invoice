...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Canadian Imperial Bank of Commerce} \\
		{\large Rebecca 73}\\
		{\large 74193, Madrid, Seattles, South Korea}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Tucker Sandström } \\
		{\large Jacob 49}\\
		{\large 30618, Budapest, Floria, Switzerland}\\
    \switchcolumn
