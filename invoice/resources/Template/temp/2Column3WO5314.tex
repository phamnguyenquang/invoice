...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklyn William Pettersson Ltd} \\
		{\large Valerie 51}\\
		{\large 82365, Frankfurt am Main , Saarland, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evan Olsson } \\
		{\large Nicholas 60}\\
		{\large 62806, Ho Chi Minh, Guangzhou, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
