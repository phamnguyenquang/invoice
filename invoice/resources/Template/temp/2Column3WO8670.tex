...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stephanie Catherine  Henriksson Pte Ltd} \\
		{\large Savannah 17}\\
		{\large 74540, Shanghai, Chiang Rai, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alana Jonsson } \\
		{\large Luca 64}\\
		{\large 52844, Last Vegas, Guangdong, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
