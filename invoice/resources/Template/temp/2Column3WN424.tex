...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Kate 	 Bengtsson} \\
		{\large Nicole 52}\\
		{\large 99738, Montreal, Hessen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Quinn May/Mae 	 Jonsson Ltd } \\
		{\large Isabella 26}\\
		{\large 20496, Paris, Guangzhou, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
