...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ximena Grace 	 Jansson Inc} \\
		{\large Nora 34}\\
		{\large 49356, Frankfurt am Main , Bremen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Henry Mattsson } \\
		{\large Isaiah 19}\\
		{\large 44841, Frankfurt am Main , Tuscany, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
