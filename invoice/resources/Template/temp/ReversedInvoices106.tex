...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Georgia State University} \\
		{\large Sarah 78}\\
		{\large 63914, Frankfurt am Main , Bremen, South Africa }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Emilia Lindqvist } \\
		{\large Hadley 31}\\
		{\large 78292, Ho Chi Minh, Guangdong, France }\\
    \switchcolumn
