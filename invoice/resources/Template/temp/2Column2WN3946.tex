...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lauren Larsson} \\
		{\large Alejandro 94}\\
		{\large 39535, Washington, California, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jordyn Elizabeth 	 Abrahamsson Ltd } \\
		{\large Zoe 30}\\
		{\large 85746, Chicago, Amnat Charoen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
