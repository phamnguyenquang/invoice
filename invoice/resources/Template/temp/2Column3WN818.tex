...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julianna Victoria Ahmed} \\
		{\large Cora 36}\\
		{\large 94187, New York , Henan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bella Catherine  Åkesson Inc } \\
		{\large Leo 2}\\
		{\large 55845, Frankfurt am Main , Hainan, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
