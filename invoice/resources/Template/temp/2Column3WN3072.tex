...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eric Louise 	 Jönsson} \\
		{\large Reese 42}\\
		{\large 57326, Nha Trang, khanh Hoa, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nevaeh Michael Lund Pte Ltd } \\
		{\large Savannah 21}\\
		{\large 69879, Barcelona, Phu Yen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
