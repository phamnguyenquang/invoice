...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Alabama in Huntsville} \\
		{\large Michael 98}\\
		{\large 31647, Melbourne, Indiana, ThaiLand}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Harper Lundqvist } \\
		{\large Samantha 73}\\
		{\large 28369, Moscow, Guangzhou, United Kingdom}\\
    \switchcolumn
