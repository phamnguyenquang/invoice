...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brody Jane Jönsson} \\
		{\large Dominic 31}\\
		{\large 96525, Tokyo, Hamburg, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kinsley  Alexander  Jakobsson Pte Ltd } \\
		{\large Emmett 71}\\
		{\large 15700, San Francisco, California, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
