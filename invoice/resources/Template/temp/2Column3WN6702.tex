...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline Grace 	 Sandström} \\
		{\large Tucker 95}\\
		{\large 56842, Moscow, Ang Thong, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabelle Thomas Hansen Pte Ltd } \\
		{\large Rebecca 38}\\
		{\large 73365, Singapore, Indiana, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
