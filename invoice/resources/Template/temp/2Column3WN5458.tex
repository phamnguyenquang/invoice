...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Izabella Thomas Holm} \\
		{\large Izabella 81}\\
		{\large 99439, Washington, Guangzhou, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ashley May/Mae 	 Danielsson Inc } \\
		{\large Grace 57}\\
		{\large 16644, Frankfurt am Main , Seattles, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
