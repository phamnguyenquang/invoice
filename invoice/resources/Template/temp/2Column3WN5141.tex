...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vivian Lee  Martinsson} \\
		{\large Jasmine 4}\\
		{\large 45406, Nha Trang, Hamburg, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Max Michael Berglund Pte Ltd } \\
		{\large David 38}\\
		{\large 25448, Frankfurt am Main , Amnat Charoen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
