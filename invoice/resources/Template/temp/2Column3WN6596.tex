...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brianna Mary 	 Andersson} \\
		{\large Kayla 19}\\
		{\large 42768, Vancouver, Hessen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jason Louise 	 Isaksson Pte Ltd } \\
		{\large Connor 77}\\
		{\large 94306, Singapore, Guangzhou, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
