...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooke Jane Jakobsson} \\
		{\large Katherine 24}\\
		{\large 86746, Nha Trang, Hawaii, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paige Amy  Fransson Pte Ltd } \\
		{\large Maddox 84}\\
		{\large 93907, Abu Dhabi, Amnat Charoen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
