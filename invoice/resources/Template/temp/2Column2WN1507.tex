...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joseph Gustafsson} \\
		{\large Caroline 40}\\
		{\large 65633, Nha Trang, Amnat Charoen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Clara  Alexander  Bengtsson Pte Ltd } \\
		{\large Mckenzie 65}\\
		{\large 83492, Berlin, Bremen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
