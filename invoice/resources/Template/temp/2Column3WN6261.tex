...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harper Elizabeth 	 Månsson} \\
		{\large Isaac 43}\\
		{\large 60298, Amsterdam, Buriam, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mariah Victoria Löfgren Ltd } \\
		{\large Angel 2}\\
		{\large 45200, Frankfurt am Main , Tuscany, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
