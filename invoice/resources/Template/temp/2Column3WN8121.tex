...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryson Christopher Hellström} \\
		{\large London 32}\\
		{\large 26996, Munich, Hainan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Serenity John Norberg Pte Ltd } \\
		{\large Parker 84}\\
		{\large 46509, Vienna, Guangdong, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
