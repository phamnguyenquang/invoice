...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Reese Mary 	 Forsberg} \\
		{\large Alex 53}\\
		{\large 36102, Seoul, Kentucky, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Violet Peter Mohamed Corp } \\
		{\large Sadie 77}\\
		{\large 42247, Ho Chi Minh, Amnat Charoen, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
