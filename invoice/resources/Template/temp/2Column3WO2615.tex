...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amir Anne Isaksson Pte Ltd} \\
		{\large Ashton 60}\\
		{\large 43127, Budapest, Guangdong, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn Andersson } \\
		{\large Alexander 73}\\
		{\large 47713, Ho Chi Minh, Chiang Rai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
