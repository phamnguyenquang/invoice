...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aidan May/Mae 	 Nordström} \\
		{\large Victor 25}\\
		{\large 97261, Istanbul, khanh Hoa, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Michael Larsson Pte Ltd } \\
		{\large Anthony 29}\\
		{\large 86268, Dubai, California, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
