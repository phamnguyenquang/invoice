...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Catherine David Lundström} \\
		{\large Sean 95}\\
		{\large 68065, Boston, Buriam, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hazel Amy  Wikström Corp } \\
		{\large Isabel 87}\\
		{\large 67072, Frankfurt am Main , Seattles, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
