...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Arianna Ann  Eliasson} \\
		{\large Reese 4}\\
		{\large 18155, Amsterdam, Kentucky, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayce Catherine  Forsberg Corp } \\
		{\large Leo 61}\\
		{\large 34403, Munich, Heibei, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
