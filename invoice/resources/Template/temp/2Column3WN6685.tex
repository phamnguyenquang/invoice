...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Addison Anne Mårtensson} \\
		{\large Molly 60}\\
		{\large 77994, Hong Kong, Tuscany, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Patrick Ann  Pålsson Corp } \\
		{\large Mackenzie 99}\\
		{\large 12168, Frankfurt am Main , Hessen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
