...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sofia Louise 	 Sandberg} \\
		{\large Patrick 52}\\
		{\large 58918, Stuttgart, Bangkok, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Preston Grace 	 Eliasson Inc } \\
		{\large Aurora 79}\\
		{\large 19873, Singapore, Indiana, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
