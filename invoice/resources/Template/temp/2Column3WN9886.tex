...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emilia Michael Hansson} \\
		{\large Autumn 9}\\
		{\large 59834, Milan, Chai Nat, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sawyer  Alexander  Larsson Corp } \\
		{\large Emery 74}\\
		{\large 43630, Ho Chi Minh, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
