...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryder Louise 	 Hansson Pte Ltd} \\
		{\large Eleanor 53}\\
		{\large 51248, Frankfurt am Main , Binh Thuan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniela Håkansson } \\
		{\large Emery 75}\\
		{\large 76020, Osaka, Seattles, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
