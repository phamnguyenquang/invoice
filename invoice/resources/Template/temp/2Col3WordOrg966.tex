...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline David Blomqvist Pte Ltd} \\
		{\large Kenneth 95}\\
		{\large 35715, Venice, Guangdong, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amelia Håkansson } \\
		{\large Alexandra 90}\\
		{\large 52268, Abu Dhabi, Chiang Rai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
