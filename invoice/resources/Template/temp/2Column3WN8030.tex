...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Edward Kate 	 Arvidsson} \\
		{\large London 85}\\
		{\large 71133, Vancouver, Buriam, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melody Christopher Björklund Pte Ltd } \\
		{\large Violet 68}\\
		{\large 97055, Frankfurt am Main , Ang Thong, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
