...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ian Christopher Hansen} \\
		{\large Daniel 8}\\
		{\large 50144, Paris, Kentucky, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Miguel  Alexander  Lundin Inc } \\
		{\large Audrey 61}\\
		{\large 73869, Los Angeles, Chai Nat, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
