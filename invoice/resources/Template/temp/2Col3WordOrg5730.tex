...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maverick John Strömberg Ltd} \\
		{\large Patrick 85}\\
		{\large 95956, Frankfurt am Main , Chiang Mai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaden Hansen } \\
		{\large Gabriel 21}\\
		{\large 69880, Rome, Hawaii, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
