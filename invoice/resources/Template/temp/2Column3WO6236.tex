...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Giovanni Marie 	 Nilsson Inc} \\
		{\large Lily 64}\\
		{\large 37500, Ho Chi Minh, Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leilani Nordström } \\
		{\large Kaden 57}\\
		{\large 17083, Frankfurt am Main , Chiang Mai, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
