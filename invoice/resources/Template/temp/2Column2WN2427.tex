...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Hedlund} \\
		{\large Maverick 7}\\
		{\large 70032, Melbourne, Hessen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Michael Nyström Corp } \\
		{\large Valeria 28}\\
		{\large 73759, Frankfurt am Main , Chai Nat, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
