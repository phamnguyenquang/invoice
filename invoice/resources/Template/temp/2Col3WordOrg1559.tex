...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aubree Edward Fredriksson Pte Ltd} \\
		{\large Morgan 26}\\
		{\large 36443, San Francisco, Texas, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaron Lundin } \\
		{\large Mia 72}\\
		{\large 36653, Washington, Kentucky, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
