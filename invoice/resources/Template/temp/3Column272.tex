...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Gwangju Institute of Science and Technology	South} \\
		{\large Ian 31}\\
		{\large 69010, Denver, Binh Thuan, Brazil }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Joshua Bengtsson } \\
		{\large Eleanor 23}\\
		{\large 21078, Frankfurt am Main , Hamburg, Turkey }\\
    \switchcolumn
