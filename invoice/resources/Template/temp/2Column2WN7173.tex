...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Richard Lindström} \\
		{\large Ariana 28}\\
		{\large 13625, Amsterdam, Hamburg, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryker William Danielsson Ltd } \\
		{\large Ryder 67}\\
		{\large 30761, Florence, Guangdong, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
