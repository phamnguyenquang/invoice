...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sawyer David Berglund} \\
		{\large Noah 38}\\
		{\large 43225, Beijing, Floria, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hadley May/Mae 	 Lundgren Pte Ltd } \\
		{\large Lauren 55}\\
		{\large 85268, Singapore, Bangkok, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
