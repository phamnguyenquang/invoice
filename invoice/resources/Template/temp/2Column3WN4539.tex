...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julian Kate 	 Jakobsson} \\
		{\large Benjamin 68}\\
		{\large 81021, Abu Dhabi, Chai Nat, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kyle Ann  Johansson Pte Ltd } \\
		{\large Kendall 8}\\
		{\large 64039, New York , Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
