...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Trinity Michael Fredriksson} \\
		{\large Roman 95}\\
		{\large 59869, Frankfurt am Main , Bangkok, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sofia  Alexander  Wallin Inc } \\
		{\large Makenzie 81}\\
		{\large 75245, Ho Chi Minh, Saarland, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
