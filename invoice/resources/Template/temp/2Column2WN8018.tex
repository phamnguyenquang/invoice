...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle Nordström} \\
		{\large Brady 89}\\
		{\large 68140, Frankfurt am Main , Hainan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amelia May/Mae 	 Fredriksson Ltd } \\
		{\large Leah 51}\\
		{\large 10694, Beijing, Binh Thuan, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
