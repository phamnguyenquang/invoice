...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maxwell Robert Hansson} \\
		{\large Thomas 78}\\
		{\large 95612, Amsterdam, Amnat Charoen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayla Anne Holmgren Corp } \\
		{\large Kaleb 10}\\
		{\large 74109, Frankfurt am Main , Texas, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
