...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Blake Edward Nyström} \\
		{\large William 12}\\
		{\large 82478, Vancouver, California, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexander Thomas Lundqvist Ltd } \\
		{\large Zoe 51}\\
		{\large 68840, Ho Chi Minh, khanh Hoa, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
