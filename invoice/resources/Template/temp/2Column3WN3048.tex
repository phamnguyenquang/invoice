...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everly Amy  Svensson} \\
		{\large Hannah 95}\\
		{\large 67929, Sydney, Bayern, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabella Thomas Pettersson Pte Ltd } \\
		{\large Makenzie 16}\\
		{\large 63480, San Francisco, Kentucky, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
