...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ava Robert Lindberg} \\
		{\large Andrea 46}\\
		{\large 83838, London , Binh Thuan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large George  Alexander  Isaksson Pte Ltd } \\
		{\large Micah 38}\\
		{\large 12393, Singapore, Floria, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
