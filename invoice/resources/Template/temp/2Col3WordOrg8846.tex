...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valerie  Alexander  Lindgren Corp} \\
		{\large Bradley 75}\\
		{\large 13885, Montreal, Hamburg, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Colin Arvidsson } \\
		{\large Mason 26}\\
		{\large 86316, Frankfurt am Main , Tuscany, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
