...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angel Grace 	 Björklund} \\
		{\large Levi 41}\\
		{\large 32680, SaiGon, Guangzhou, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mya Louise 	 Dahlberg Pte Ltd } \\
		{\large Alex 32}\\
		{\large 26234, Los Angeles, Floria, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
