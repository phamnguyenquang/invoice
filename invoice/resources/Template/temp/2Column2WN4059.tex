...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kingston Viklund} \\
		{\large Juliana 53}\\
		{\large 32749, Frankfurt am Main , Huabei, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elise Catherine  Abrahamsson Pte Ltd } \\
		{\large Hayden 94}\\
		{\large 21654, Venice, Binh Thuan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
