...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victoria David Pålsson Pte Ltd} \\
		{\large Jeremy 24}\\
		{\large 62219, Amsterdam, Hawaii, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sadie Lundström } \\
		{\large Maddox 50}\\
		{\large 11673, Bonn, Ang Thong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
