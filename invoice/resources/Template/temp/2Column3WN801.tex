...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Reagan Thomas Bengtsson} \\
		{\large Roman 89}\\
		{\large 24062, Istanbul, khanh Hoa, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan Christopher Viklund Pte Ltd } \\
		{\large Katelyn 21}\\
		{\large 46225, Hanoi, Buriam, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
