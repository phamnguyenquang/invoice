...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxon Louise 	 Sandström} \\
		{\large Malachi 10}\\
		{\large 59104, Washington, Kentucky, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alaina Marie 	 Lundström Inc } \\
		{\large Bentley 16}\\
		{\large 53759, Los Angeles, Binh Thuan, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
