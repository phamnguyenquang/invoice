...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklyn Mattsson} \\
		{\large Mya 27}\\
		{\large 40636, Dublin, Binh Thuan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mckenzie Grace 	 Hedlund Pte Ltd } \\
		{\large Laila 8}\\
		{\large 32139, Singapore, Huabei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
