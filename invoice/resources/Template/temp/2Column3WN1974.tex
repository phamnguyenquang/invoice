...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rachel Marie 	 Pettersson} \\
		{\large Hudson 77}\\
		{\large 90084, Frankfurt am Main , Henan, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Miguel Amy  Holmberg Inc } \\
		{\large Parker 80}\\
		{\large 12461, Amsterdam, Floria, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
