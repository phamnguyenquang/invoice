...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Giovanni Pettersson} \\
		{\large Penelope 43}\\
		{\large 45054, Taipei, Hamburg, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucy Elizabeth 	 Jonsson Pte Ltd } \\
		{\large Jaxon 3}\\
		{\large 53806, Frankfurt am Main , Tuscany, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
