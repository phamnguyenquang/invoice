...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Chase Catherine  Gunnarsson Ltd} \\
		{\large Angelina 93}\\
		{\large 88806, Abu Dhabi, Bayern, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesus Fredriksson } \\
		{\large Diego 36}\\
		{\large 61278, Seoul, Chiang Rai, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
