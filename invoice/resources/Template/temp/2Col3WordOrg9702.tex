...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Layla May/Mae 	 Claesson Pte Ltd} \\
		{\large Trinity 37}\\
		{\large 42016, Montreal, Amnat Charoen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sydney Månsson } \\
		{\large Payton 63}\\
		{\large 92693, New York , Guangdong, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
