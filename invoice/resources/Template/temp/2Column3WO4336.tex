...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jordan  Alexander  Lundqvist Inc} \\
		{\large Taylor 67}\\
		{\large 76512, Washington, Hessen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jordan Eriksson } \\
		{\large Theodore 71}\\
		{\large 69214, Chicago, Amnat Charoen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
