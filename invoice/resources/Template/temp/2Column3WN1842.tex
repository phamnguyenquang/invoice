...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lilly Ann  Hassan} \\
		{\large Aiden 29}\\
		{\large 46817, Vienna, Chai Nat, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Christopher Eliasson Inc } \\
		{\large Miles 61}\\
		{\large 70478, Frankfurt am Main , Texas, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
