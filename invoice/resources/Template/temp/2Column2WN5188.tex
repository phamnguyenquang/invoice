...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maverick Blomqvist} \\
		{\large Sophie 32}\\
		{\large 25894, Taipei, Floria, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Clara Elizabeth 	 Lindqvist Ltd } \\
		{\large Leo 9}\\
		{\large 84994, Montreal, Chiang Rai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
