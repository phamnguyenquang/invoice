...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  London Elizabeth 	 Johansson} \\
		{\large Zachary 40}\\
		{\large 90942, Osaka, Guangzhou, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon Jane Jakobsson Corp } \\
		{\large Makenzie 82}\\
		{\large 11301, Los Angeles, Chiang Mai, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
