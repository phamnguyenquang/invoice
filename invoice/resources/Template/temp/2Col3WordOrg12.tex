...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalie  Alexander  Lundgren Pte Ltd} \\
		{\large Leah 30}\\
		{\large 98132, Frankfurt am Main , Seattles, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian Olsson } \\
		{\large Ella 14}\\
		{\large 99173, Frankfurt am Main , khanh Hoa, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
