...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Skylar Christopher Mårtensson} \\
		{\large Payton 41}\\
		{\large 38729, Berlin, Chai Nat, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hailey David Jonsson Corp } \\
		{\large Makayla 43}\\
		{\large 88789, Denver, Phu Yen, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
