...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly William Eriksson} \\
		{\large Michael 96}\\
		{\large 28177, Frankfurt am Main , Bremen, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sydney May/Mae 	 Fredriksson Corp } \\
		{\large Logan 1}\\
		{\large 71865, Nha Trang, Kentucky, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
