...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daisy William Fransson} \\
		{\large Jordan 55}\\
		{\large 65174, Osaka, Chai Nat, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubrey Thomas Gunnarsson Pte Ltd } \\
		{\large Jocelyn 38}\\
		{\large 64398, Venice, Buriam, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
