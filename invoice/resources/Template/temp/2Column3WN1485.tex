...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brielle Victoria Söderberg} \\
		{\large Nathaniel 90}\\
		{\large 64490, Venice, Heibei, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucas Grace 	 Arvidsson Inc } \\
		{\large Mackenzie 89}\\
		{\large 33689, SaiGon, Bangkok, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
