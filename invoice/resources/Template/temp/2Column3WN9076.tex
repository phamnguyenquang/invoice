...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victoria Victoria Lindström} \\
		{\large Londyn 60}\\
		{\large 94765, Nha Trang, Chiang Rai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michael Peter Lundström Corp } \\
		{\large John 59}\\
		{\large 80061, Lisbon, Saarland, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
