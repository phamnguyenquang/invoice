...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Diego Edward Arvidsson Pte Ltd} \\
		{\large Sophie 72}\\
		{\large 54950, Last Vegas, Bremen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maria Berggren } \\
		{\large Owen 84}\\
		{\large 84032, Los Angeles, Henan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
