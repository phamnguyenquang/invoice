...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adriana Holmgren} \\
		{\large Gavin 85}\\
		{\large 34986, Frankfurt am Main , California, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eliza May/Mae 	 Dahlberg Corp } \\
		{\large Brandon 24}\\
		{\large 81244, Vancouver, Binh Thuan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
