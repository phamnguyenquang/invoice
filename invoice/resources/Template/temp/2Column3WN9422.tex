...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremiah  Alexander  Claesson} \\
		{\large Amy 21}\\
		{\large 48656, Munich, Bangkok, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brayden Louise 	 Olsson Ltd } \\
		{\large Gavin 77}\\
		{\large 20646, Frankfurt am Main , Chiang Mai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
