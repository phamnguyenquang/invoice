...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Julia   Winkler Ltd} \\
		{\large Scheidswald str 61}\\
		{\large 40999, Budapest, Tuscany, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stefan Kraus } \\
		{\large Scheidswald str 61}\\
		{\large 47892, Frankfurt am Main , Chiang Rai, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
