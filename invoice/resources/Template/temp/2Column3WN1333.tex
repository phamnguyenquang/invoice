...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon Amy  Holmgren} \\
		{\large Madelyn 52}\\
		{\large 10051, Venice, Indiana, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valerie Louise 	 Månsson Ltd } \\
		{\large Eliza 93}\\
		{\large 24193, Frankfurt am Main , Hessen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
