...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Danielsson} \\
		{\large Margaret 77}\\
		{\large 74854, Washington, Huabei, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brianna May/Mae 	 Blomqvist Corp } \\
		{\large Madison 82}\\
		{\large 71145, Vancouver, Guangzhou, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
