...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cayden Abrahamsson} \\
		{\large Aria 92}\\
		{\large 44201, Montreal, Amnat Charoen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Olivia Grace 	 Mårtensson Inc } \\
		{\large Zoe 90}\\
		{\large 20801, Frankfurt am Main , Heibei, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
