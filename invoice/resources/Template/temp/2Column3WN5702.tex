...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Owen James Sandström} \\
		{\large Gabriel 27}\\
		{\large 52413, Istanbul, Indiana, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayce Catherine  Lindberg Pte Ltd } \\
		{\large Vivian 68}\\
		{\large 86985, Shanghai, Chai Nat, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
