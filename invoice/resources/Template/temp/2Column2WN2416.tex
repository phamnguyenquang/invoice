...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emma Eriksson} \\
		{\large Jose 57}\\
		{\large 69475, Nha Trang, Bayern, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden Elizabeth 	 Lundqvist Pte Ltd } \\
		{\large Kingston 33}\\
		{\large 23812, Frankfurt am Main , Heibei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
