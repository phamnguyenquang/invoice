...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paisley May/Mae 	 Hellström} \\
		{\large Adriana 58}\\
		{\large 73927, Los Angeles, khanh Hoa, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesus Catherine  Lundgren Corp } \\
		{\large Catherine 54}\\
		{\large 50219, Vancouver, Chiang Mai, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
