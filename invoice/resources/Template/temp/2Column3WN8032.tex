...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aubree Robert Björklund} \\
		{\large Gabriella 24}\\
		{\large 67014, Frankfurt am Main , Bangkok, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella Kate 	 Claesson Ltd } \\
		{\large Jace 59}\\
		{\large 44351, Taipei, Floria, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
