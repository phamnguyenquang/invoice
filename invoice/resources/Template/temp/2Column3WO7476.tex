...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emilia Michael Fredriksson Corp} \\
		{\large Jesse 17}\\
		{\large 84954, Stuttgart, Guangzhou, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kayla Håkansson } \\
		{\large Cooper 98}\\
		{\large 11956, New York , Guangzhou, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
