...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mason Catherine  Mattsson Pte Ltd} \\
		{\large Lincoln 57}\\
		{\large 49110, Berlin, Seattles, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nolan Danielsson } \\
		{\large Aliyah 17}\\
		{\large 85626, Frankfurt am Main , Floria, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
