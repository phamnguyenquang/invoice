...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  David Victoria Lindgren} \\
		{\large Camila 58}\\
		{\large 91481, Florence, Texas, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caroline Marie 	 Andreasson Corp } \\
		{\large Brooke 89}\\
		{\large 83255, London , khanh Hoa, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
