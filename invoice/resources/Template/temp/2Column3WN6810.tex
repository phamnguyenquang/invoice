...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christian William Lundström} \\
		{\large Evelyn 87}\\
		{\large 43895, Amsterdam, Binh Thuan, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nora Christopher Holm Ltd } \\
		{\large Summer 37}\\
		{\large 84301, Tokyo, Indiana, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
