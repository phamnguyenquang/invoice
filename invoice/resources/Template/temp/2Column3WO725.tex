...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ivy Elizabeth 	 Håkansson Pte Ltd} \\
		{\large Brianna 50}\\
		{\large 63640, Frankfurt am Main , Binh Thuan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jake Axelsson } \\
		{\large Owen 48}\\
		{\large 34706, Dublin, Chiang Rai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
