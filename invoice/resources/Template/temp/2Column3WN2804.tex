...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles Kate 	 Engström} \\
		{\large Justin 2}\\
		{\large 61054, Madrid, khanh Hoa, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Damian Robert Pålsson Ltd } \\
		{\large Victoria 66}\\
		{\large 44702, Montreal, Guangzhou, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
