...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sophia Hassan Pte Ltd} \\
		{\large Ashley 47}\\
		{\large 73874, Frankfurt am Main , Amnat Charoen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ellie Nyström } \\
		{\large Alan 58}\\
		{\large 15620, Frankfurt am Main , Henan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
