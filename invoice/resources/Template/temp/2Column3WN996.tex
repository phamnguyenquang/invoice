...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jordyn  Alexander  Svensson} \\
		{\large Kennedy 54}\\
		{\large 96007, SaiGon, Henan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harmony Robert Söderberg Pte Ltd } \\
		{\large Paisley 40}\\
		{\large 64267, Los Angeles, Seattles, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
