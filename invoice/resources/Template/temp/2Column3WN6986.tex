...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Piper  Alexander  Gustafsson} \\
		{\large Jennifer 66}\\
		{\large 20882, Madrid, Seattles, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Silas Catherine  Olsson Ltd } \\
		{\large Antonio 23}\\
		{\large 49703, San Francisco, khanh Hoa, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
