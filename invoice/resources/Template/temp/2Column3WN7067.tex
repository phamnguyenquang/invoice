...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Peyton Elizabeth 	 Holmgren} \\
		{\large Norah 82}\\
		{\large 92087, Last Vegas, khanh Hoa, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Olivia Thomas Andreasson Corp } \\
		{\large Valeria 66}\\
		{\large 77374, Istanbul, Texas, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
