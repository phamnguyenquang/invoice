...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Destiny Rose 	 Lundgren} \\
		{\large Graham 4}\\
		{\large 92165, Stuttgart, Guangzhou, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maverick Louise 	 Persson Ltd } \\
		{\large Audrey 1}\\
		{\large 29035, Los Angeles, Binh Thuan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
