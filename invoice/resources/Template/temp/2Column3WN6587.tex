...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Margaret Louise 	 Norberg} \\
		{\large Elena 12}\\
		{\large 78132, Frankfurt am Main , Seattles, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Quinn Louise 	 Bergström Inc } \\
		{\large Madelyn 49}\\
		{\large 50022, Dublin, Huabei, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
