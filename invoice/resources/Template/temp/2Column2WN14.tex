...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kinsley Sjöberg} \\
		{\large Aidan 8}\\
		{\large 97150, Beijing, Huabei, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maverick Lee  Eriksson Pte Ltd } \\
		{\large Aria 30}\\
		{\large 99430, Last Vegas, Ang Thong, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
