...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valerie Kate 	 Strömberg} \\
		{\large Madelyn 1}\\
		{\large 12582, San Francisco, Bangkok, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Amy  Mohamed Inc } \\
		{\large Caleb 64}\\
		{\large 44698, San Francisco, Texas, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
