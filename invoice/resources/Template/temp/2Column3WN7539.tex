...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryson Thomas Nordström} \\
		{\large Preston 50}\\
		{\large 21344, Frankfurt am Main , Hamburg, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reagan Catherine  Sundberg Ltd } \\
		{\large Michael 83}\\
		{\large 25246, Last Vegas, Heibei, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
