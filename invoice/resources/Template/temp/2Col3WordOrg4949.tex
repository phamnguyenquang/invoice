...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caleb James Mattsson Ltd} \\
		{\large Nora 83}\\
		{\large 18339, Beijing, Chai Nat, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Mattsson } \\
		{\large Stella 64}\\
		{\large 11999, Frankfurt am Main , Indiana, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
