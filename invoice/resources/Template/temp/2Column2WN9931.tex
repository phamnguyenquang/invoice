...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Timothy Magnusson} \\
		{\large Samuel 75}\\
		{\large 28886, New York , Buriam, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gracie Marie 	 Olofsson Corp } \\
		{\large Jackson 83}\\
		{\large 37411, San Francisco, Tuscany, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
