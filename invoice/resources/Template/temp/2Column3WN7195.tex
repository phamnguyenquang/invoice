...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriella Christopher Lundqvist} \\
		{\large Jayla 81}\\
		{\large 47299, Barcelona, Bremen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liam May/Mae 	 Söderberg Ltd } \\
		{\large Eliza 36}\\
		{\large 40356, Dubai, Texas, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
