...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery Axelsson} \\
		{\large Emilia 56}\\
		{\large 31464, Hong Kong, Phu Yen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery David Jakobsson Corp } \\
		{\large Aria 43}\\
		{\large 75341, Frankfurt am Main , Buriam, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
