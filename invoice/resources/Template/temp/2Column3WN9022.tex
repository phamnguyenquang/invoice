...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Catherine Elizabeth 	 Andersson} \\
		{\large Caden 65}\\
		{\large 67171, Milan, Chiang Rai, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sawyer Robert Lundin Pte Ltd } \\
		{\large Brooklyn 94}\\
		{\large 16592, Dublin, Bayern, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
