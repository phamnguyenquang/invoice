...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alyssa Marie 	 Claesson} \\
		{\large Peyton 71}\\
		{\large 65383, Amsterdam, Indiana, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eleanor May/Mae 	 Persson Ltd } \\
		{\large Eliana 61}\\
		{\large 17856, Istanbul, Hessen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
