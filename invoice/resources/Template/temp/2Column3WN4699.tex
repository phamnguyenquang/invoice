...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jake Louise 	 Nordström} \\
		{\large Brandon 22}\\
		{\large 65796, Melbourne, Saarland, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariel Jane Norberg Ltd } \\
		{\large Levi 57}\\
		{\large 66607, Last Vegas, Kentucky, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
