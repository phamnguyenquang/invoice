...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jasmine May/Mae 	 Holmberg Corp} \\
		{\large Trinity 41}\\
		{\large 84018, Frankfurt am Main , Ang Thong, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jameson Eliasson } \\
		{\large Nora 10}\\
		{\large 62693, Vancouver, Hawaii, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
