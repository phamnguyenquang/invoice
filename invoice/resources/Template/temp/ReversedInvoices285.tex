...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Science and Technology Beijing} \\
		{\large Alaina 6}\\
		{\large 46068, Bonn, California, Indonesia s}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Nevaeh Karlsson } \\
		{\large Jayden 4}\\
		{\large 45265, Minsk, Chiang Rai, Saudi Arabia }\\
    \switchcolumn
