...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxson Grace 	 Eliasson Pte Ltd} \\
		{\large Emily 37}\\
		{\large 23214, Shanghai, Kentucky, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kayden Håkansson } \\
		{\large Elizabeth 6}\\
		{\large 88809, Madrid, Amnat Charoen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
