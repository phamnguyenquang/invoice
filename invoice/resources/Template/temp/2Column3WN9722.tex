...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ellie  Alexander  Ek} \\
		{\large Ezra 78}\\
		{\large 43024, Hong Kong, California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Allison Louise 	 Nilsson Ltd } \\
		{\large Alexandra 22}\\
		{\large 75998, Amsterdam, khanh Hoa, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
