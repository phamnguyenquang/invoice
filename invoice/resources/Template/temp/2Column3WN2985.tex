...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Londyn Catherine  Sundberg} \\
		{\large Ivan 39}\\
		{\large 26613, London , Hamburg, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brody Elizabeth 	 Magnusson Inc } \\
		{\large Victor 71}\\
		{\large 10956, Seoul, Seattles, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
