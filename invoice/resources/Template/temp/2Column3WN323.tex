...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hazel William Olofsson} \\
		{\large Charlotte 58}\\
		{\large 68633, San Francisco, Hessen, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Trinity Louise 	 Gunnarsson Inc } \\
		{\large Autumn 97}\\
		{\large 47943, Munich, Saarland, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
