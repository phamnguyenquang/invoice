...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grayson Catherine  Hellström} \\
		{\large Mason 25}\\
		{\large 28199, Melbourne, Bremen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maddox May/Mae 	 Hansson Ltd } \\
		{\large Eden 76}\\
		{\large 20049, Istanbul, Guangzhou, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
