...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bailey John Fredriksson} \\
		{\large Sofia 95}\\
		{\large 40990, Hanoi, Phu Yen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Malachi Louise 	 Bengtsson Pte Ltd } \\
		{\large Katelyn 24}\\
		{\large 19964, Florence, Tuscany, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
