...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brian Catherine  Holmgren Pte Ltd} \\
		{\large Madison 36}\\
		{\large 78350, Amsterdam, Hainan, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Levi Andersson } \\
		{\large Destiny 27}\\
		{\large 17707, Frankfurt am Main , Ang Thong, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
