...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nolan Victoria Holmberg} \\
		{\large Max 40}\\
		{\large 85215, New York , Hamburg, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Steven Elizabeth 	 Martinsson Inc } \\
		{\large Ava 46}\\
		{\large 21678, Frankfurt am Main , khanh Hoa, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
