...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte Elizabeth 	 Holmgren Pte Ltd} \\
		{\large Sebastian 64}\\
		{\large 87124, Washington, Amnat Charoen, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kevin Bergman } \\
		{\large Josiah 69}\\
		{\large 60103, Minsk, Hamburg, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
