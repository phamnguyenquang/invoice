...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sofia Peter Sjöberg Corp} \\
		{\large Ava 14}\\
		{\large 19815, Frankfurt am Main , California, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison Gustafsson } \\
		{\large Greyson 46}\\
		{\large 77376, Melbourne, Tuscany, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
