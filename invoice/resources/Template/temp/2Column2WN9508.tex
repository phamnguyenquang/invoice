...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Skylar Andreasson} \\
		{\large Grant 98}\\
		{\large 83599, Barcelona, Heibei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Edward William Sandström Pte Ltd } \\
		{\large Sophie 52}\\
		{\large 24084, Frankfurt am Main , Tuscany, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
