...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Andersson} \\
		{\large Bradley 29}\\
		{\large 57175, Singapore, Binh Thuan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anthony William Nyström Pte Ltd } \\
		{\large Mason 54}\\
		{\large 80318, Bonn, Bangkok, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
