...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmett  Alexander  Ekström} \\
		{\large Anna 94}\\
		{\large 28438, San Francisco, Tuscany, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Parker  Alexander  Lindberg Ltd } \\
		{\large Michael 87}\\
		{\large 62979, Osaka, Hessen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
