...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adriana Christopher Nilsson Corp} \\
		{\large Maddox 10}\\
		{\large 99147, Ho Chi Minh, Hessen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Violet Abrahamsson } \\
		{\large Adeline 38}\\
		{\large 40980, Frankfurt am Main , Floria, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
