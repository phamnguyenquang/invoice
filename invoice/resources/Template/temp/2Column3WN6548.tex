...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maxwell May/Mae 	 Wikström} \\
		{\large Josephine 66}\\
		{\large 26662, Stuttgart, Bangkok, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathaniel David Bergström Inc } \\
		{\large Harmony 67}\\
		{\large 41994, Toronto, Ang Thong, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
