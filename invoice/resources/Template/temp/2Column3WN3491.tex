...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Claire May/Mae 	 Dahl} \\
		{\large Eden 64}\\
		{\large 36301, Taipei, Guangdong, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kinsley Catherine  Blomqvist Pte Ltd } \\
		{\large Lauren 23}\\
		{\large 55083, Los Angeles, Amnat Charoen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
