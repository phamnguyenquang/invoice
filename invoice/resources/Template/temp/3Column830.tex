...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Technology Sydney} \\
		{\large Alex 54}\\
		{\large 23098, Last Vegas, Binh Thuan, Canada }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Clara Norberg } \\
		{\large Jace 89}\\
		{\large 71945, Venice, California, United Kingdom}\\
    \switchcolumn
