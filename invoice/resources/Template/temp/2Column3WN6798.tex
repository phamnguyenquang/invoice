...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariana Anne Berglund} \\
		{\large Mya 84}\\
		{\large 58742, Shanghai, Guangdong, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maddox Christopher Jönsson Corp } \\
		{\large Athena 24}\\
		{\large 66949, Los Angeles, Ang Thong, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
