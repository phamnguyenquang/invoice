...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaylee Christopher Abrahamsson Pte Ltd} \\
		{\large Adalyn 59}\\
		{\large 76766, Milan, Henan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reese Karlsson } \\
		{\large Adriana 58}\\
		{\large 72600, San Francisco, Guangdong, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
