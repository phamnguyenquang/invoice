...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  David Christopher Lund} \\
		{\large Jaden 11}\\
		{\large 22673, SaiGon, Chiang Rai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Greyson Louise 	 Sundberg Pte Ltd } \\
		{\large Grayson 53}\\
		{\large 49907, Melbourne, Bayern, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
