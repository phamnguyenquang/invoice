...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Antonio Louise 	 Pettersson} \\
		{\large Bryce 94}\\
		{\large 26682, Florence, Guangzhou, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madeline Kate 	 Sundberg Pte Ltd } \\
		{\large Jayce 32}\\
		{\large 85560, Madrid, Chiang Rai, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
