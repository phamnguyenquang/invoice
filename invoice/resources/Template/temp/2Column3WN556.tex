...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesse  Alexander  Abrahamsson} \\
		{\large Sophia 38}\\
		{\large 39413, Singapore, Huabei, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everett Christopher Eriksson Ltd } \\
		{\large Brody 79}\\
		{\large 62713, Montreal, Seattles, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
