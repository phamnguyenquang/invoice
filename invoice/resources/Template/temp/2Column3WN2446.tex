...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Naomi William Jakobsson} \\
		{\large Kimberly 57}\\
		{\large 56954, Nha Trang, California, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian Marie 	 Magnusson Pte Ltd } \\
		{\large Ellie 24}\\
		{\large 79202, Barcelona, Guangdong, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
