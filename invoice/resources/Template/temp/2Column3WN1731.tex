...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aiden Peter Henriksson} \\
		{\large Jameson 14}\\
		{\large 31844, San Francisco, Binh Thuan, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abel Marie 	 Hermansson Inc } \\
		{\large Daisy 93}\\
		{\large 79717, Nha Trang, Buriam, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
