...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Thomas Christopher Eliasson Ltd} \\
		{\large Isabelle 39}\\
		{\large 69685, Singapore, Guangzhou, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sawyer Andreasson } \\
		{\large Lilly 55}\\
		{\large 88191, Frankfurt am Main , Guangdong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
