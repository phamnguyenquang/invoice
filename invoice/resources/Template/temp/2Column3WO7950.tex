...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope Anne Lundberg Pte Ltd} \\
		{\large Anthony 49}\\
		{\large 61477, Montreal, Guangzhou, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valeria Bengtsson } \\
		{\large Amir 19}\\
		{\large 49758, Seoul, Amnat Charoen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
