...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ivan Edward Nyberg} \\
		{\large Noah 1}\\
		{\large 21679, Frankfurt am Main , Amnat Charoen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Olivia Lee  Lundqvist Pte Ltd } \\
		{\large Colton 36}\\
		{\large 39097, Toronto, Buriam, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
