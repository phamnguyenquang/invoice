...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carson Elizabeth 	 Sjöberg} \\
		{\large Jasmine 78}\\
		{\large 15359, Washington, Kentucky, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas Michael Magnusson Pte Ltd } \\
		{\large Eric 89}\\
		{\large 40401, Beijing, Guangzhou, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
