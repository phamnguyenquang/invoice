...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine David Håkansson} \\
		{\large Piper 17}\\
		{\large 75787, Montreal, Ang Thong, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caden Marie 	 Olofsson Pte Ltd } \\
		{\large Mateo 99}\\
		{\large 55338, Ho Chi Minh, Guangdong, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
