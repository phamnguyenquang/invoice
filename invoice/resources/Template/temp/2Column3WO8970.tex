...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezekiel Christopher Jansson Pte Ltd} \\
		{\large Grace 70}\\
		{\large 79614, Nha Trang, Tuscany, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emery Sandberg } \\
		{\large Natalie 87}\\
		{\large 76701, Moscow, Saarland, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
