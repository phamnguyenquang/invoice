...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jasmine Kate 	 Falk} \\
		{\large Leonardo 3}\\
		{\large 61627, Frankfurt am Main , Bremen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Louise 	 Viklund Corp } \\
		{\large Aubrey 27}\\
		{\large 87208, London , Hessen, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
