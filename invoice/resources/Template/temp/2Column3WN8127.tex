...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Arianna May/Mae 	 Mårtensson} \\
		{\large Hannah 64}\\
		{\large 95262, Bonn, Chiang Mai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isla Grace 	 Holmgren Inc } \\
		{\large Carter 77}\\
		{\large 21150, Istanbul, Huabei, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
