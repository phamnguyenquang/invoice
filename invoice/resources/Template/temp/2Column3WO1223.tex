...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Edward Lundberg Pte Ltd} \\
		{\large Claire 29}\\
		{\large 51102, Toronto, Bangkok, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amy Bergström } \\
		{\large Caroline 5}\\
		{\large 76985, Nha Trang, California, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
