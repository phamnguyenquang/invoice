...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Richard Larsson} \\
		{\large Andrea 47}\\
		{\large 40971, Washington, Kentucky, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Londyn Christopher Olsson Inc } \\
		{\large Jasmine 80}\\
		{\large 70055, Florence, Amnat Charoen, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
