...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jacob Danielsson} \\
		{\large Paul 68}\\
		{\large 24040, Sydney, Huabei, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Allison Christopher Jonsson Inc } \\
		{\large Allison 49}\\
		{\large 69598, Frankfurt am Main , Indiana, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
