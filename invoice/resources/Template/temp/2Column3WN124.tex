...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gracie Lee  Löfgren} \\
		{\large Alan 3}\\
		{\large 98712, New York , Guangdong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklyn Grace 	 Dahlberg Ltd } \\
		{\large Marcus 64}\\
		{\large 17247, San Francisco, Bangkok, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
