...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eli Svensson} \\
		{\large Nicholas 76}\\
		{\large 45172, Frankfurt am Main , Floria, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jameson Victoria Bengtsson Pte Ltd } \\
		{\large Makayla 47}\\
		{\large 46540, Melbourne, Phu Yen, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
