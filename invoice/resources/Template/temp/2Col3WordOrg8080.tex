...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremiah James Hellström Pte Ltd} \\
		{\large Gracie 32}\\
		{\large 10844, Stuttgart, Hawaii, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abigail Åberg } \\
		{\large Kayden 7}\\
		{\large 32368, Los Angeles, Chiang Mai, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
