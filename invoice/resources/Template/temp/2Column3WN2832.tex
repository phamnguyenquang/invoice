...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ximena Robert Bergman} \\
		{\large Zoe 18}\\
		{\large 78953, Barcelona, Tuscany, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Serenity Jane Håkansson Pte Ltd } \\
		{\large Kayden 93}\\
		{\large 47683, Melbourne, Bangkok, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
