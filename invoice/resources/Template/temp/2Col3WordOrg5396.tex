...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles Mary 	 Claesson Pte Ltd} \\
		{\large Katherine 71}\\
		{\large 27156, Frankfurt am Main , Phu Yen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Scarlett Mårtensson } \\
		{\large Santiago 17}\\
		{\large 76970, Berlin, Buriam, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
