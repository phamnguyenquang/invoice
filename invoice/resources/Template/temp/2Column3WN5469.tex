...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayce Amy  Håkansson} \\
		{\large Joel 49}\\
		{\large 71205, Venice, Bayern, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Louise 	 Bengtsson Pte Ltd } \\
		{\large Sydney 87}\\
		{\large 72655, Vancouver, Amnat Charoen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
