...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Anthony Lindström} \\
		{\large Sophie 34}\\
		{\large 73180, Madrid, Chiang Mai, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anthony William Andersson Pte Ltd } \\
		{\large Kinsley 20}\\
		{\large 66535, Frankfurt am Main , Phu Yen, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
