...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Silas  Alexander  Holmgren} \\
		{\large Avery 14}\\
		{\large 11746, Beijing, Hawaii, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cameron Louise 	 Månsson Pte Ltd } \\
		{\large Kingston 31}\\
		{\large 21196, Frankfurt am Main , Ang Thong, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
