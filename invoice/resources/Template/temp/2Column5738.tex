...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery Löfgren Corp} \\
		{\large Elijah 59}\\
		{\large 53382, Frankfurt am Main , Huabei, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Robert Lindberg } \\
		{\large Sydney 45}\\
		{\large 90464, Frankfurt am Main , Floria, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
