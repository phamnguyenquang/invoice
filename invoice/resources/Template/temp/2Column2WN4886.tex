...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ashton Hermansson} \\
		{\large Jessica 37}\\
		{\large 59414, Frankfurt am Main , Saarland, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wesley Grace 	 Viklund Ltd } \\
		{\large Alyssa 60}\\
		{\large 80017, Vienna, khanh Hoa, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
