...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Addison Elizabeth 	 Strömberg Pte Ltd} \\
		{\large Jack 54}\\
		{\large 87313, Minsk, Hessen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooke Olofsson } \\
		{\large Jonathan 80}\\
		{\large 75437, Frankfurt am Main , Chai Nat, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
