...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mackenzie Louise 	 Mårtensson} \\
		{\large Aliyah 69}\\
		{\large 42440, New York , Chiang Rai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kayla Jane Olofsson Pte Ltd } \\
		{\large Adeline 58}\\
		{\large 17421, Beijing, Huabei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
