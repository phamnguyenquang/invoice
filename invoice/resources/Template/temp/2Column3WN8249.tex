...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juliana Lee  Berglund} \\
		{\large Luke 55}\\
		{\large 45320, Berlin, Bremen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jason Catherine  Abrahamsson Pte Ltd } \\
		{\large Kayden 63}\\
		{\large 36867, Singapore, California, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
