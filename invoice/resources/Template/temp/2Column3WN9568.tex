...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emily  Alexander  Lundström} \\
		{\large Isabel 78}\\
		{\large 89543, Stuttgart, Amnat Charoen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonathan  Alexander  Persson Corp } \\
		{\large Aiden 24}\\
		{\large 74201, Beijing, Heibei, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
