...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bennett Christopher Strömberg Inc} \\
		{\large Christopher 28}\\
		{\large 92242, Melbourne, Bayern, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Miles Nilsson } \\
		{\large Alejandro 10}\\
		{\large 74852, Frankfurt am Main , Ang Thong, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
