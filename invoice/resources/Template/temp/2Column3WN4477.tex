...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abigail Anne Andreasson} \\
		{\large Joseph 14}\\
		{\large 51821, Barcelona, Henan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Athena Anne Berggren Inc } \\
		{\large Dylan 62}\\
		{\large 89426, Sydney, Kentucky, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
