...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Roman Berggren} \\
		{\large Ximena 23}\\
		{\large 93138, Beijing, Saarland, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everly Amy  Wikström Ltd } \\
		{\large Jaxson 75}\\
		{\large 99195, Frankfurt am Main , California, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
