...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Peyton Louise 	 Hedlund} \\
		{\large Brooke 98}\\
		{\large 72399, San Francisco, Hamburg, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hannah  Alexander  Blomqvist Ltd } \\
		{\large Wesley 27}\\
		{\large 80060, San Francisco, Huabei, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
