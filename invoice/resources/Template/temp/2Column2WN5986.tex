...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles Lundberg} \\
		{\large Lincoln 94}\\
		{\large 35139, Montreal, Tuscany, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicole Catherine  Gustafsson Pte Ltd } \\
		{\large Brooklynn 39}\\
		{\large 83878, Washington, Seattles, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
