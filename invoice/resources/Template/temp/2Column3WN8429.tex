...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Claire Lee  Söderberg} \\
		{\large Nevaeh 48}\\
		{\large 66766, Frankfurt am Main , Seattles, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maya  Alexander  Bergman Ltd } \\
		{\large Charlotte 92}\\
		{\large 98984, Lisbon, Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
