...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alaina Lee  Gustafsson Pte Ltd} \\
		{\large Ryder 61}\\
		{\large 93484, Last Vegas, Amnat Charoen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesse Ekström } \\
		{\large Edward 5}\\
		{\large 85934, Frankfurt am Main , Buriam, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
