...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hudson Mary 	 Lind} \\
		{\large Valeria 23}\\
		{\large 42446, San Francisco, Chiang Rai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rachel Catherine  Bengtsson Ltd } \\
		{\large Reagan 85}\\
		{\large 70680, Istanbul, Kentucky, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
