...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lillian Elizabeth 	 Jansson} \\
		{\large Caroline 29}\\
		{\large 86213, Lisbon, Hainan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aiden  Alexander  Blomqvist Corp } \\
		{\large Sarah 67}\\
		{\large 75001, Paris, Ang Thong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
