...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles Anne Fredriksson} \\
		{\large Samantha 64}\\
		{\large 12295, Moscow, Phu Yen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jace William Dahlberg Pte Ltd } \\
		{\large Camila 4}\\
		{\large 80066, Taipei, Hessen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
