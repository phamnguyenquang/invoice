...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jennifer Sundberg} \\
		{\large Mackenzie 34}\\
		{\large 50477, Frankfurt am Main , Binh Thuan, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Londyn Rose 	 Lundgren Pte Ltd } \\
		{\large Damian 82}\\
		{\large 70465, Beijing, Floria, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
