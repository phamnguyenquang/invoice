...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eleanor William Andersson Pte Ltd} \\
		{\large Grayson 9}\\
		{\large 13231, Amsterdam, Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hadley Strömberg } \\
		{\large Harper 74}\\
		{\large 90127, Madrid, Indiana, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
