...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline May/Mae 	 Mattsson} \\
		{\large Trinity 37}\\
		{\large 48414, SaiGon, Hawaii, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melanie Marie 	 Isaksson Ltd } \\
		{\large Olivia 89}\\
		{\large 30016, Frankfurt am Main , Guangdong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
