...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isaac May/Mae 	 Strömberg} \\
		{\large Jameson 23}\\
		{\large 48587, Frankfurt am Main , Hamburg, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremiah Grace 	 Pettersson Corp } \\
		{\large Rylee 93}\\
		{\large 30422, London , Bayern, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
