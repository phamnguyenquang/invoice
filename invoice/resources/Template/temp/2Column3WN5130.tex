...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Faith Anne Månsson} \\
		{\large Jeremy 16}\\
		{\large 68109, Frankfurt am Main , Guangzhou, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zachary May/Mae 	 Isaksson Corp } \\
		{\large Patrick 64}\\
		{\large 84520, Lisbon, Hamburg, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
