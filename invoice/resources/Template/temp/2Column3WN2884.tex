...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley  Alexander  Nordin} \\
		{\large Rachel 81}\\
		{\large 86150, Shanghai, Hamburg, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Kate 	 Olofsson Inc } \\
		{\large Jaden 20}\\
		{\large 49049, Barcelona, Hamburg, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
