...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezra May/Mae 	 Jonsson} \\
		{\large Liliana 79}\\
		{\large 54992, Last Vegas, California, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Axel Edward Persson Pte Ltd } \\
		{\large Valeria 66}\\
		{\large 58742, Los Angeles, Henan, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
