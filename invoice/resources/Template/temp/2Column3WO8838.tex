...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Margaret May/Mae 	 Jakobsson Corp} \\
		{\large Gracie 52}\\
		{\large 61056, Frankfurt am Main , Seattles, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Micah Nordin } \\
		{\large Jameson 16}\\
		{\large 81767, Istanbul, Amnat Charoen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
