...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angel Danielsson} \\
		{\large Makenzie 88}\\
		{\large 95369, San Francisco, Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Delilah May/Mae 	 Björklund Pte Ltd } \\
		{\large Oliver 61}\\
		{\large 40803, Abu Dhabi, Chiang Rai, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
