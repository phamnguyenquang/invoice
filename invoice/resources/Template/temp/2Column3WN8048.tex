...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michelle Michael Björk} \\
		{\large Piper 24}\\
		{\large 82544, Frankfurt am Main , Hawaii, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ximena James Arvidsson Pte Ltd } \\
		{\large Lucas 30}\\
		{\large 90047, Dublin, Kentucky, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
