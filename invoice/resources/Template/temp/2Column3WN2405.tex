...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Thomas Gustafsson} \\
		{\large Eliza 63}\\
		{\large 66692, Berlin, Bremen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mila Catherine  Berglund Corp } \\
		{\large Aaliyah 4}\\
		{\large 95893, Toronto, Guangdong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
