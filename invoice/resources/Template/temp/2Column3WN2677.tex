...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Molly Louise 	 Isaksson} \\
		{\large Jackson 64}\\
		{\large 80709, Budapest, Bayern, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Marcus Catherine  Lindström Corp } \\
		{\large Zoe 63}\\
		{\large 19499, Last Vegas, Huabei, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
