...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Indian Institute of Technology Roorkee} \\
		{\large Hailey 12}\\
		{\large 35066, Frankfurt am Main , Ang Thong, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sara Fredriksson } \\
		{\large Graham 92}\\
		{\large 37420, Stuttgart, Bayern, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
