...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michelle Edward Holm} \\
		{\large Layla 85}\\
		{\large 36684, Last Vegas, Seattles, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Dylan David Larsson Pte Ltd } \\
		{\large Weston 93}\\
		{\large 44807, San Francisco, Amnat Charoen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
