...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Edward May/Mae 	 Lund} \\
		{\large Miguel 87}\\
		{\large 50456, Vienna, Heibei, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas Edward Fredriksson Pte Ltd } \\
		{\large Isabella 91}\\
		{\large 63210, Frankfurt am Main , Floria, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
