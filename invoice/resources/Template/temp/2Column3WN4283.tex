...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jennifer Jane Larsson} \\
		{\large Tucker 1}\\
		{\large 65250, Last Vegas, Heibei, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isla Peter Gunnarsson Inc } \\
		{\large Carter 19}\\
		{\large 34035, Frankfurt am Main , Ang Thong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
