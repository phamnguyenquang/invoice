...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Camden Thomas Abrahamsson} \\
		{\large Autumn 62}\\
		{\large 62417, Osaka, Bayern, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Robert Håkansson Ltd } \\
		{\large Gabrielle 95}\\
		{\large 41079, Frankfurt am Main , Kentucky, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
