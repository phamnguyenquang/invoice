...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brayden Amy  Eliasson Pte Ltd} \\
		{\large Victoria 85}\\
		{\large 51854, Toronto, Chiang Mai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kendall Abrahamsson } \\
		{\large Wyatt 90}\\
		{\large 61437, Moscow, Amnat Charoen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
