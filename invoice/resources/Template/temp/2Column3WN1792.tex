...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Axel Peter Strömberg} \\
		{\large Riley 49}\\
		{\large 52542, Hong Kong, Chiang Mai, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie  Alexander  Sjögren Pte Ltd } \\
		{\large Grayson 91}\\
		{\large 47412, Frankfurt am Main , Saarland, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
