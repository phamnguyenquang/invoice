...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Matthew Amy  Lundström Corp} \\
		{\large Andrea 35}\\
		{\large 85354, Frankfurt am Main , Chai Nat, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley Mårtensson } \\
		{\large Aaron 48}\\
		{\large 44439, Shanghai, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
