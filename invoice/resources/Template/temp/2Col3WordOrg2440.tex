...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Steven William Jonsson Corp} \\
		{\large Mia 86}\\
		{\large 42957, SaiGon, Kentucky, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everett Samuelsson } \\
		{\large Braxton 14}\\
		{\large 43605, San Francisco, Seattles, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
