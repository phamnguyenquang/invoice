...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elizabeth Edward Mårtensson Corp} \\
		{\large Christopher 9}\\
		{\large 51139, Paris, Hamburg, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Marcus Gunnarsson } \\
		{\large Natalia 56}\\
		{\large 69068, Ho Chi Minh, California, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
