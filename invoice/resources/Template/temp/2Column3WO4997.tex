...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adam Louise 	 Andreasson Pte Ltd} \\
		{\large Delilah 16}\\
		{\large 57576, Munich, California, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isla Gunnarsson } \\
		{\large Jonathan 11}\\
		{\large 87976, Frankfurt am Main , Hamburg, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
