...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesus Elizabeth 	 Fransson} \\
		{\large Vanessa 60}\\
		{\large 64022, Last Vegas, Ang Thong, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maverick Louise 	 Holm Pte Ltd } \\
		{\large Joshua 36}\\
		{\large 48878, Melbourne, Floria, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
