...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alana Peter Lundin} \\
		{\large Paisley 38}\\
		{\large 69344, Abu Dhabi, Buriam, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Marcus Michael Norberg Pte Ltd } \\
		{\large Harmony 86}\\
		{\large 94242, Toronto, California, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
