...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalia Peter Eriksson Inc} \\
		{\large Destiny 47}\\
		{\large 52282, Frankfurt am Main , Seattles, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ashton Lund } \\
		{\large Roman 28}\\
		{\large 50764, Washington, Amnat Charoen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
