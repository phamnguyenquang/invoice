...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Margaret James Mårtensson} \\
		{\large Zachary 2}\\
		{\large 23213, Taipei, Amnat Charoen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaiden Catherine  Löfgren Ltd } \\
		{\large Laila 97}\\
		{\large 62316, Dubai, Saarland, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
