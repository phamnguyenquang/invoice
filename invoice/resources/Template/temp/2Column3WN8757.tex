...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jade Michael Mohamed} \\
		{\large Amelia 40}\\
		{\large 18199, Minsk, Chiang Rai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexa William Abrahamsson Ltd } \\
		{\large Audrey 16}\\
		{\large 45517, Los Angeles, khanh Hoa, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
