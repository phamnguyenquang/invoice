...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryker  Alexander  Andreasson} \\
		{\large Weston 72}\\
		{\large 74211, Montreal, Saarland, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy Peter Larsson Pte Ltd } \\
		{\large Anna 60}\\
		{\large 93679, Vancouver, Ang Thong, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
