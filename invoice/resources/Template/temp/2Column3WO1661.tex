...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexis  Alexander  Hellström Corp} \\
		{\large Eli 97}\\
		{\large 18031, Frankfurt am Main , Texas, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zoe Abrahamsson } \\
		{\large Nicolas 93}\\
		{\large 56384, New York , Ang Thong, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
