...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ximena Lee  Gunnarsson} \\
		{\large Joseph 75}\\
		{\large 57173, Ho Chi Minh, Bremen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Morgan Elizabeth 	 Gustafsson Pte Ltd } \\
		{\large Violet 90}\\
		{\large 72317, Singapore, Phu Yen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
