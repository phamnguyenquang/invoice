...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adam Christopher Sundberg Pte Ltd} \\
		{\large Weston 7}\\
		{\large 55866, San Francisco, Phu Yen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Khloe Gustafsson } \\
		{\large Nicolas 45}\\
		{\large 96519, Melbourne, Huabei, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
