...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline Anne Nyström} \\
		{\large Dominic 83}\\
		{\large 40620, Minsk, Chai Nat, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tucker Louise 	 Axelsson Inc } \\
		{\large Piper 84}\\
		{\large 83712, Frankfurt am Main , Chiang Mai, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
