...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Levi Lind} \\
		{\large Stella 95}\\
		{\large 73236, Frankfurt am Main , Bremen, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas Louise 	 Andreasson Pte Ltd } \\
		{\large Jackson 91}\\
		{\large 75060, Washington, Guangdong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
