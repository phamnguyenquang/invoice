...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Edward Mary 	 Hansen Inc} \\
		{\large Sofia 46}\\
		{\large 70554, Nha Trang, Chiang Rai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Allison Sjöberg } \\
		{\large Madeline 83}\\
		{\large 16604, Frankfurt am Main , Bangkok, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
