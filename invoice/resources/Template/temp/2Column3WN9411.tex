...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ashton Peter Danielsson} \\
		{\large Timothy 32}\\
		{\large 88709, Frankfurt am Main , Chiang Mai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isaiah Ann  Mårtensson Inc } \\
		{\large Brandon 20}\\
		{\large 86318, Frankfurt am Main , Amnat Charoen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
