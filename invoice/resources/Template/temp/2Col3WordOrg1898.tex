...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harper Catherine  Isaksson Pte Ltd} \\
		{\large Greyson 27}\\
		{\large 63890, Singapore, Buriam, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas Lundgren } \\
		{\large Leo 51}\\
		{\large 46188, Frankfurt am Main , California, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
