...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bailey Amy  Söderberg Pte Ltd} \\
		{\large Hadley 72}\\
		{\large 46023, Denver, Seattles, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angel Bergqvist } \\
		{\large Christopher 47}\\
		{\large 83049, Amsterdam, Hainan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
