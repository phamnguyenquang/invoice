...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stella Michael Fredriksson Pte Ltd} \\
		{\large Jonah 88}\\
		{\large 38326, Berlin, Huabei, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lauren Persson } \\
		{\large Laila 6}\\
		{\large 24350, Ho Chi Minh, Guangzhou, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
