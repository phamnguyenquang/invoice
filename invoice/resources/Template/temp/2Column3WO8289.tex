...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julian Christopher Ekström Corp} \\
		{\large Norah 5}\\
		{\large 39756, Frankfurt am Main , Saarland, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalyn Hansen } \\
		{\large Emma 86}\\
		{\large 16826, Chicago, Buriam, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
