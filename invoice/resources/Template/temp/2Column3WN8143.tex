...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery Jane Karlsson} \\
		{\large Paige 24}\\
		{\large 81236, Melbourne, Seattles, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michael Catherine  Andersson Pte Ltd } \\
		{\large Violet 54}\\
		{\large 82557, Abu Dhabi, Hessen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
