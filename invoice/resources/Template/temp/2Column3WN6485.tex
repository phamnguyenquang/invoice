...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sofia Michael Hedlund} \\
		{\large Ivan 15}\\
		{\large 56963, Washington, Henan, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abel Elizabeth 	 Lundberg Pte Ltd } \\
		{\large Jade 8}\\
		{\large 19694, Munich, Amnat Charoen, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
