...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lyla William Gustafsson} \\
		{\large Kenneth 83}\\
		{\large 81676, Melbourne, Henan, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabelle Robert Dahlberg Inc } \\
		{\large Jeremiah 56}\\
		{\large 58021, Melbourne, Binh Thuan, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
