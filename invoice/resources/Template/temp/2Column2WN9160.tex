...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maxwell Eklund} \\
		{\large Jesus 84}\\
		{\large 78184, Paris, Hamburg, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Arianna Christopher Ahmed Pte Ltd } \\
		{\large Trinity 68}\\
		{\large 18737, Melbourne, Henan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
