...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline Elizabeth 	 Samuelsson} \\
		{\large London 34}\\
		{\large 37608, Rome, Indiana, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vincent Thomas Löfgren Ltd } \\
		{\large Samuel 85}\\
		{\large 47793, New York , Phu Yen, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
