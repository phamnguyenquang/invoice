...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josiah Catherine  Gunnarsson} \\
		{\large Jeremiah 9}\\
		{\large 17347, Washington, Seattles, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ava Grace 	 Abrahamsson Corp } \\
		{\large Kaylee 80}\\
		{\large 29891, Toronto, Heibei, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
