...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harrison Thomas Holmgren} \\
		{\large Paisley 80}\\
		{\large 22462, Nha Trang, Amnat Charoen, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniel May/Mae 	 Lind Pte Ltd } \\
		{\large Brayden 99}\\
		{\large 84404, Melbourne, Guangdong, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
