...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Huazhong University of Science and Technology} \\
		{\large Diego 99}\\
		{\large 70022, Osaka, khanh Hoa, Canada }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Aaron Berglund } \\
		{\large Valerie 47}\\
		{\large 26032, Paris, Bangkok, Switzerland}\\
    \switchcolumn
