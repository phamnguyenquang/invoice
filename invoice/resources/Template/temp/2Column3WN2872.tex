...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mackenzie Edward Johansson} \\
		{\large Isaiah 57}\\
		{\large 21054, Last Vegas, Bayern, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eden Grace 	 Bergström Inc } \\
		{\large Mark 24}\\
		{\large 72490, Melbourne, Guangzhou, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
