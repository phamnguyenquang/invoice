...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melanie David Nyström} \\
		{\large Kaleb 87}\\
		{\large 63094, Hong Kong, Tuscany, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large King Lee  Håkansson Inc } \\
		{\large Daniela 61}\\
		{\large 47536, Frankfurt am Main , Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
