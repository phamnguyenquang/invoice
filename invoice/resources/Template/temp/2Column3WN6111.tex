...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leah Grace 	 Hassan} \\
		{\large Juan 14}\\
		{\large 21237, Madrid, Kentucky, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elizabeth Louise 	 Söderberg Corp } \\
		{\large Jeremiah 28}\\
		{\large 38811, San Francisco, Floria, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
