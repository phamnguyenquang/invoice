...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria Jane Jonsson} \\
		{\large Emma 96}\\
		{\large 42038, Washington, Chiang Mai, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicole May/Mae 	 Lindqvist Pte Ltd } \\
		{\large Emmett 57}\\
		{\large 76080, Madrid, Saarland, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
