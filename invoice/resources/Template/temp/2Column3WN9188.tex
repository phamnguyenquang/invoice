...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julianna David Björklund} \\
		{\large Sara 25}\\
		{\large 66480, Abu Dhabi, Bangkok, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryan Amy  Nyberg Ltd } \\
		{\large Timothy 98}\\
		{\large 28403, Frankfurt am Main , Saarland, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
