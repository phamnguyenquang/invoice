...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Greyson Thomas Fransson Inc} \\
		{\large Autumn 90}\\
		{\large 87775, Singapore, Hamburg, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Layla Lundgren } \\
		{\large Grayson 3}\\
		{\large 26087, Ho Chi Minh, khanh Hoa, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
