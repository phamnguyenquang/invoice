...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grace Victoria Falk} \\
		{\large Owen 56}\\
		{\large 52572, Vienna, Guangdong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Greyson Catherine  Olofsson Inc } \\
		{\large Blake 41}\\
		{\large 84518, Toronto, Texas, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
