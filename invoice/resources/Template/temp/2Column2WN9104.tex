...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Margaret Lundström} \\
		{\large Benjamin 35}\\
		{\large 32652, Shanghai, Chiang Rai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kendall David Hermansson Pte Ltd } \\
		{\large Hazel 13}\\
		{\large 36871, New York , khanh Hoa, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
