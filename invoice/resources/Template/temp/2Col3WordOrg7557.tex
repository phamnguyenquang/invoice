...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Parker Catherine  Norberg Inc} \\
		{\large Melanie 66}\\
		{\large 12685, Sydney, khanh Hoa, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryder Danielsson } \\
		{\large Vanessa 67}\\
		{\large 55671, Frankfurt am Main , Bremen, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
