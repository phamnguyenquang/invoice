...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sawyer Edward Gustafsson Ltd} \\
		{\large Sarah 92}\\
		{\large 88771, Frankfurt am Main , Huabei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anna Andreasson } \\
		{\large Claire 4}\\
		{\large 37594, Seoul, Amnat Charoen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
