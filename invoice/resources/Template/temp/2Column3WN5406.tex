...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dominic Robert Abrahamsson} \\
		{\large Kaiden 45}\\
		{\large 52483, Stuttgart, Seattles, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nevaeh Christopher Björk Pte Ltd } \\
		{\large Annabelle 32}\\
		{\large 98285, Vancouver, Henan, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
