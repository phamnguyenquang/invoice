...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicholas Elizabeth 	 Lindqvist} \\
		{\large Kyle 34}\\
		{\large 89507, Osaka, Indiana, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Londyn Elizabeth 	 Olsson Ltd } \\
		{\large Taylor 5}\\
		{\large 92820, Frankfurt am Main , Chiang Mai, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
