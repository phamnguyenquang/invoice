...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Austin Amy  Wikström} \\
		{\large Miguel 97}\\
		{\large 13074, Singapore, Guangdong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cooper Marie 	 Berglund Corp } \\
		{\large Hannah 60}\\
		{\large 37187, Melbourne, Hessen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
