...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaitlyn Gunnarsson} \\
		{\large Jaxon 76}\\
		{\large 67371, Ho Chi Minh, Guangdong, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Michael Fransson Corp } \\
		{\large Damian 50}\\
		{\large 12847, San Francisco, Chiang Mai, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
