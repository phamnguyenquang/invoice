...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra  Alexander  Arvidsson} \\
		{\large Serenity 95}\\
		{\large 96452, Abu Dhabi, Indiana, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paul Louise 	 Eriksson Inc } \\
		{\large Christopher 66}\\
		{\large 23791, Abu Dhabi, Hessen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
