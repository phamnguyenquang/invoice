...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly Fredriksson Pte Ltd} \\
		{\large Samantha 67}\\
		{\large 59887, Florence, Guangdong, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Axel Hermansson } \\
		{\large Ivy 86}\\
		{\large 57486, Frankfurt am Main , Chiang Mai, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
