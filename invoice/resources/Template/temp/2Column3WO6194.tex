...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalyn Louise 	 Johansson Pte Ltd} \\
		{\large Kaden 40}\\
		{\large 97753, Madrid, Kentucky, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katelyn Hassan } \\
		{\large Elizabeth 75}\\
		{\large 38714, Abu Dhabi, Saarland, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
