...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Robert Jane Pettersson} \\
		{\large Colin 89}\\
		{\large 65924, Abu Dhabi, Hawaii, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Declan Michael Sjögren Pte Ltd } \\
		{\large Caden 85}\\
		{\large 42167, Chicago, khanh Hoa, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
