...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kayden Marie 	 Gunnarsson} \\
		{\large Claire 93}\\
		{\large 96145, Budapest, Texas, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan John Månsson Corp } \\
		{\large Braxton 37}\\
		{\large 71294, Istanbul, Tuscany, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
