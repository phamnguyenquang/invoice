...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harmony Catherine  Magnusson Inc} \\
		{\large Hazel 9}\\
		{\large 45644, Melbourne, Hessen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maddox Berggren } \\
		{\large Clara 59}\\
		{\large 38707, Taipei, Ang Thong, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
