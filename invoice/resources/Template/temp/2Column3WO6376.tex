...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle Ann  Bergman Pte Ltd} \\
		{\large Nora 43}\\
		{\large 67615, Frankfurt am Main , Saarland, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josephine Viklund } \\
		{\large Cayden 68}\\
		{\large 15287, Melbourne, Buriam, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
