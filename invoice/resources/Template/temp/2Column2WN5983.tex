...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kenneth Wallin} \\
		{\large Jeremiah 85}\\
		{\large 77958, San Francisco, Guangdong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Ann  Håkansson Corp } \\
		{\large Skylar 92}\\
		{\large 59140, Taipei, Chiang Mai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
