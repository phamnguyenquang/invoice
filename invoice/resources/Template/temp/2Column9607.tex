...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isaiah Karlsson Pte Ltd} \\
		{\large Brooke 84}\\
		{\large 20573, Singapore, Binh Thuan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucas Lindberg } \\
		{\large Madeline 1}\\
		{\large 19738, Last Vegas, Chiang Mai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
