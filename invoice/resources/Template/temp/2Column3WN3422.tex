...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Riley John Lind} \\
		{\large Layla 76}\\
		{\large 84408, Ho Chi Minh, Amnat Charoen, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremiah Rose 	 Berglund Corp } \\
		{\large Clara 40}\\
		{\large 76334, Ho Chi Minh, Bremen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
