...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caden Mary 	 Olofsson} \\
		{\large Roman 84}\\
		{\large 52702, Berlin, Hawaii, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kenneth Edward Pålsson Pte Ltd } \\
		{\large Brooke 27}\\
		{\large 97360, Frankfurt am Main , Bayern, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
