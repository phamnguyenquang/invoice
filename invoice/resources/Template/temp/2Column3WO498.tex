...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria May/Mae 	 Forsberg Ltd} \\
		{\large Christopher 87}\\
		{\large 16960, Madrid, Hessen, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ella Hansen } \\
		{\large Hannah 99}\\
		{\large 24254, SaiGon, Bremen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
