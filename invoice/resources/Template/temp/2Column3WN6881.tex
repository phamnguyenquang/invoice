...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jessica Christopher Lindholm} \\
		{\large Josiah 19}\\
		{\large 84919, Hong Kong, Bayern, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large George Mary 	 Sandström Pte Ltd } \\
		{\large Harper 45}\\
		{\large 37677, Tokyo, Guangzhou, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
