...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abraham Christopher Pettersson} \\
		{\large Jayce 57}\\
		{\large 80436, Washington, Guangzhou, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rylee Marie 	 Bengtsson Pte Ltd } \\
		{\large Jaxson 73}\\
		{\large 14437, Osaka, Guangzhou, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
