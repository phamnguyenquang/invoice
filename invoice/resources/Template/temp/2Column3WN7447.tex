...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gianna Catherine  Bergström} \\
		{\large Brooklyn 10}\\
		{\large 68569, Budapest, Chai Nat, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Logan Louise 	 Lindholm Ltd } \\
		{\large Stella 67}\\
		{\large 32997, Budapest, Hainan, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
