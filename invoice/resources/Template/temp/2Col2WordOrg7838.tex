...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Declan Ekström Inc} \\
		{\large Jessica 3}\\
		{\large 83347, Frankfurt am Main , Chiang Mai, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alana Eriksson } \\
		{\large Andrea 4}\\
		{\large 69453, Frankfurt am Main , Hawaii, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
