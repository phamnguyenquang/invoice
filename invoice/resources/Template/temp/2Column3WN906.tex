...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  David Christopher Pettersson} \\
		{\large Preston 66}\\
		{\large 96200, Venice, California, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juliana Edward Mohamed Inc } \\
		{\large Taylor 49}\\
		{\large 41198, Amsterdam, Hessen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
