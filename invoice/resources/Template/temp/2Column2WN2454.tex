...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harrison Andreasson} \\
		{\large Valeria 74}\\
		{\large 25606, Budapest, Henan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jameson Grace 	 Gustafsson Pte Ltd } \\
		{\large Mya 7}\\
		{\large 65555, Munich, Ang Thong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
