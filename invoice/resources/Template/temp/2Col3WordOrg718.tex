...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  William Anne Löfgren Pte Ltd} \\
		{\large Faith 51}\\
		{\large 79658, Frankfurt am Main , Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore Eliasson } \\
		{\large Reagan 1}\\
		{\large 38467, Taipei, Floria, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
