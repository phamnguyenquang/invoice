...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cameron Robert Samuelsson} \\
		{\large Bella 90}\\
		{\large 74115, Florence, Tuscany, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caroline Marie 	 Bengtsson Corp } \\
		{\large Caden 18}\\
		{\large 14038, Ho Chi Minh, Hawaii, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
