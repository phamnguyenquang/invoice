...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brady Thomas Sjögren} \\
		{\large Molly 88}\\
		{\large 21161, Venice, khanh Hoa, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paige  Alexander  Blomqvist Corp } \\
		{\large Aubree 52}\\
		{\large 35955, Budapest, Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
