...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  John May/Mae 	 Engström Inc} \\
		{\large Adalynn 68}\\
		{\large 78999, Frankfurt am Main , Chai Nat, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Axelsson } \\
		{\large Elijah 88}\\
		{\large 60856, Budapest, Tuscany, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
