...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel Louise 	 Jönsson} \\
		{\large Bryson 92}\\
		{\large 32178, San Francisco, Chiang Rai, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abigail Grace 	 Holmgren Ltd } \\
		{\large Claire 1}\\
		{\large 20703, Stuttgart, khanh Hoa, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
