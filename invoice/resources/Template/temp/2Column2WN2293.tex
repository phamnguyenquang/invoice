...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly Jakobsson} \\
		{\large Christian 10}\\
		{\large 54550, Montreal, California, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine May/Mae 	 Eklund Pte Ltd } \\
		{\large Emma 82}\\
		{\large 55245, Denver, Bremen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
