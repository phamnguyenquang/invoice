...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Payton Grace 	 Andersson Inc} \\
		{\large Owen 24}\\
		{\large 47528, Frankfurt am Main , Bayern, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas Berglund } \\
		{\large Josiah 51}\\
		{\large 64772, Hong Kong, Hessen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
