...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  King Kate 	 Hansen} \\
		{\large Elijah 81}\\
		{\large 16970, Last Vegas, California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariana Robert Lund Ltd } \\
		{\large Genesis 83}\\
		{\large 68772, Washington, Bremen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
