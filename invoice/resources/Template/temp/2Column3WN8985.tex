...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katelyn Christopher Mårtensson} \\
		{\large Cora 91}\\
		{\large 86828, Milan, Indiana, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte Christopher Andersson Pte Ltd } \\
		{\large Josephine 25}\\
		{\large 62465, Montreal, Hessen, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
