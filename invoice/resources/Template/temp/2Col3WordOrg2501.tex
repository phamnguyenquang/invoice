...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Olivia Robert Viklund Inc} \\
		{\large Bella 18}\\
		{\large 71682, Frankfurt am Main , Bayern, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abel Abrahamsson } \\
		{\large Amelia 11}\\
		{\large 83872, Hanoi, Texas, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
