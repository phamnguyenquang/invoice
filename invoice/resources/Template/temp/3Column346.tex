...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  China Pharmaceutical University} \\
		{\large Kaylee 84}\\
		{\large 80275, Montreal, Tuscany, China }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Bentley Samuelsson } \\
		{\large Lydia 38}\\
		{\large 20960, Frankfurt am Main , Guangdong, South Africa }\\
    \switchcolumn
