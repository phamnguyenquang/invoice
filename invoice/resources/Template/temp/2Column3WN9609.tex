...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Reese Thomas Blomqvist} \\
		{\large Weston 81}\\
		{\large 19876, Melbourne, Amnat Charoen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Arianna Elizabeth 	 Persson Inc } \\
		{\large Reese 73}\\
		{\large 33064, Last Vegas, Hainan, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
