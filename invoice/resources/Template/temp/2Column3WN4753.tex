...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amir Elizabeth 	 Blom} \\
		{\large Morgan 52}\\
		{\large 63075, Los Angeles, Seattles, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mark  Alexander  Samuelsson Pte Ltd } \\
		{\large Benjamin 75}\\
		{\large 18799, Budapest, Hessen, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
