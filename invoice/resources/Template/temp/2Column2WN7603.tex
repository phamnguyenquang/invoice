...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Parker Henriksson} \\
		{\large Greyson 87}\\
		{\large 28232, San Francisco, Chiang Rai, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grant May/Mae 	 Olofsson Inc } \\
		{\large Marcus 69}\\
		{\large 25807, Los Angeles, California, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
