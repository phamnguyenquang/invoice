...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina Victoria Axelsson Pte Ltd} \\
		{\large Colin 47}\\
		{\large 48922, Los Angeles, Guangzhou, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Londyn Åkesson } \\
		{\large Cole 27}\\
		{\large 93346, Denver, Guangzhou, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
