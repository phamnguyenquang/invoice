...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carlos Elizabeth 	 Lindberg Inc} \\
		{\large Jacob 58}\\
		{\large 13554, Frankfurt am Main , Buriam, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gavin Samuelsson } \\
		{\large Hudson 93}\\
		{\large 64325, Frankfurt am Main , Bremen, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
