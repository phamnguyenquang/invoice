...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bennett Håkansson} \\
		{\large Ivan 34}\\
		{\large 42264, Seoul, Buriam, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kimberly Catherine  Fredriksson Pte Ltd } \\
		{\large Kinsley 22}\\
		{\large 59558, Berlin, Phu Yen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
