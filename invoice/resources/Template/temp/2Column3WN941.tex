...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cameron  Alexander  Åberg} \\
		{\large Hazel 24}\\
		{\large 68081, Montreal, Tuscany, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Trinity Christopher Nilsson Ltd } \\
		{\large Sofia 84}\\
		{\large 92450, Vienna, Tuscany, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
