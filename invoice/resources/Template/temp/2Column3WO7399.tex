...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madison John Lindgren Pte Ltd} \\
		{\large Scarlett 12}\\
		{\large 88225, Singapore, Hawaii, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremy Mohamed } \\
		{\large Natalia 8}\\
		{\large 67787, Barcelona, Amnat Charoen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
