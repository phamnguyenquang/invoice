...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Anne Hermansson} \\
		{\large Ryleigh 73}\\
		{\large 57171, Budapest, khanh Hoa, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abraham Lee  Samuelsson Inc } \\
		{\large Noah 26}\\
		{\large 96437, Washington, Hawaii, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
