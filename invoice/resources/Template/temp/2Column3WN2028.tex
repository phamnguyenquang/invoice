...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalyn Catherine  Mårtensson} \\
		{\large Kaleb 87}\\
		{\large 89492, Barcelona, Bayern, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian James Martinsson Pte Ltd } \\
		{\large Cole 41}\\
		{\large 82571, Montreal, Bayern, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
