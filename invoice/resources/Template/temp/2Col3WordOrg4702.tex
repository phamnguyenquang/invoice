...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harrison May/Mae 	 Andersson Pte Ltd} \\
		{\large Amelia 28}\\
		{\large 64959, Taipei, khanh Hoa, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jacob Isaksson } \\
		{\large Everett 16}\\
		{\large 36402, Last Vegas, Chiang Mai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
