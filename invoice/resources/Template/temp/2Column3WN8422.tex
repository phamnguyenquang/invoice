...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victoria Robert Eklund} \\
		{\large Maverick 51}\\
		{\large 73019, Lisbon, Kentucky, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Santiago Robert Hansson Pte Ltd } \\
		{\large Landon 2}\\
		{\large 77677, Last Vegas, Chai Nat, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
