...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eva Robert Ali} \\
		{\large Evelyn 22}\\
		{\large 23859, Singapore, Texas, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalia Victoria Lindgren Pte Ltd } \\
		{\large David 27}\\
		{\large 20834, Frankfurt am Main , Tuscany, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
