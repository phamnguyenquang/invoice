...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Skylar Thomas Gustafsson} \\
		{\large Alexander 17}\\
		{\large 95166, Frankfurt am Main , Hawaii, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paisley Victoria Engström Ltd } \\
		{\large Gianna 69}\\
		{\large 71110, Milan, Indiana, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
