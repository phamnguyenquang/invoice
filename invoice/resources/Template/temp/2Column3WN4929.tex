...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emily David Eklund} \\
		{\large Jackson 90}\\
		{\large 89543, Lisbon, Seattles, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everett William Olofsson Pte Ltd } \\
		{\large Hayden 21}\\
		{\large 78199, Budapest, Amnat Charoen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
