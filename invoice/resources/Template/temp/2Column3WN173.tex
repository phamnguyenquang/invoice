...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stephanie Elizabeth 	 Lundström} \\
		{\large Jocelyn 41}\\
		{\large 59634, Tokyo, Hessen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sean Edward Berglund Ltd } \\
		{\large Mackenzie 11}\\
		{\large 78595, Washington, Binh Thuan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
