...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Fredriksson Pte Ltd} \\
		{\large Michael 42}\\
		{\large 53536, Last Vegas, Bayern, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julianna Isaksson } \\
		{\large Kaleb 48}\\
		{\large 89024, Frankfurt am Main , Hessen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
