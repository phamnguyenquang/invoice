...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isaac  Alexander  Mårtensson Pte Ltd} \\
		{\large Austin 98}\\
		{\large 69823, Frankfurt am Main , Indiana, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brayden Eriksson } \\
		{\large Calvin 82}\\
		{\large 85055, Hong Kong, Saarland, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
