...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Blake Elizabeth 	 Sandström} \\
		{\large Aiden 97}\\
		{\large 52025, Singapore, Amnat Charoen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy Catherine  Berg Corp } \\
		{\large Kevin 34}\\
		{\large 69314, Last Vegas, Tuscany, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
