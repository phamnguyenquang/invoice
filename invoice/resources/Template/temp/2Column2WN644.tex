...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Braxton Lundberg} \\
		{\large Emmett 99}\\
		{\large 50731, Madrid, Guangdong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryson  Alexander  Mohamed Pte Ltd } \\
		{\large Grace 11}\\
		{\large 98010, SaiGon, Bangkok, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
