...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valerie Kate 	 Ahmed} \\
		{\large Alyssa 83}\\
		{\large 10962, Ho Chi Minh, Chai Nat, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aliyah Louise 	 Martinsson Pte Ltd } \\
		{\large Jose 10}\\
		{\large 73101, Hong Kong, Ang Thong, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
