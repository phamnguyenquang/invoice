...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leilani Ekström} \\
		{\large Ivan 51}\\
		{\large 38917, Boston, khanh Hoa, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson Christopher Andersson Pte Ltd } \\
		{\large Summer 31}\\
		{\large 27324, Los Angeles, Huabei, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
