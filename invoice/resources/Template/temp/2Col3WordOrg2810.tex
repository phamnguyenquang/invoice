...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emilia Louise 	 Jakobsson Inc} \\
		{\large Sebastian 32}\\
		{\large 29505, Nha Trang, California, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucas Samuelsson } \\
		{\large Jameson 4}\\
		{\large 58923, Frankfurt am Main , Chiang Rai, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
