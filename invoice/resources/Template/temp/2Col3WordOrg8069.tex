...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everly Christopher Axelsson Ltd} \\
		{\large Leilani 78}\\
		{\large 91230, Berlin, Chiang Mai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Willow Martinsson } \\
		{\large Weston 42}\\
		{\large 15039, Melbourne, Texas, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
