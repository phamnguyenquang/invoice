...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lillian Catherine  Ekström Corp} \\
		{\large Morgan 76}\\
		{\large 88784, Frankfurt am Main , Phu Yen, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large David Engström } \\
		{\large Richard 88}\\
		{\large 67685, Vancouver, California, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
