...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Justin Elizabeth 	 Lundqvist} \\
		{\large Maddox 80}\\
		{\large 95362, New York , Binh Thuan, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liliana Michael Hedlund Corp } \\
		{\large Giovanni 37}\\
		{\large 43881, Chicago, Texas, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
