...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elise Marie 	 Hermansson Pte Ltd} \\
		{\large Kayla 17}\\
		{\large 82432, Hong Kong, Indiana, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paul Berggren } \\
		{\large Kyle 82}\\
		{\large 38785, Frankfurt am Main , khanh Hoa, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
