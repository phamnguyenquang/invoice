...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Oscar Ann  Lundberg} \\
		{\large Wyatt 3}\\
		{\large 93249, Frankfurt am Main , Bayern, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Thomas James Abrahamsson Corp } \\
		{\large Kimberly 65}\\
		{\large 33649, Montreal, Saarland, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
