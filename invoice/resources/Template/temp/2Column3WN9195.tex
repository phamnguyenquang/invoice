...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Allison Elizabeth 	 Lundberg} \\
		{\large Brooklyn 18}\\
		{\large 62246, Frankfurt am Main , Phu Yen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brielle Ann  Sjöberg Ltd } \\
		{\large Patrick 35}\\
		{\large 11627, Melbourne, Amnat Charoen, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
