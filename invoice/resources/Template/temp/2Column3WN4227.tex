...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  George David Jansson} \\
		{\large Adalyn 33}\\
		{\large 69663, Vienna, Bangkok, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklyn John Henriksson Corp } \\
		{\large Khloe 81}\\
		{\large 23813, Abu Dhabi, Chiang Rai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
