...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxson Mary 	 Nyberg Corp} \\
		{\large Paisley 12}\\
		{\large 34097, Vancouver, Amnat Charoen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Athena Gustafsson } \\
		{\large Maddox 22}\\
		{\large 58095, San Francisco, Amnat Charoen, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
