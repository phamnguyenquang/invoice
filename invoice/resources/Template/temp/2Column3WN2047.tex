...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  George Christopher Andersson} \\
		{\large Lily 50}\\
		{\large 32670, Lisbon, Hainan, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madeline Edward Johansson Pte Ltd } \\
		{\large Isabelle 80}\\
		{\large 87569, SaiGon, Hessen, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
