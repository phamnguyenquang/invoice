...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hayden Persson Pte Ltd} \\
		{\large Joseph 12}\\
		{\large 36992, Singapore, Bangkok, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jameson Abrahamsson } \\
		{\large Graham 50}\\
		{\large 95754, Ho Chi Minh, Ang Thong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
