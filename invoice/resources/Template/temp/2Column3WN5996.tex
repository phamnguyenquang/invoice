...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Braxton Robert Eriksson} \\
		{\large Mark 83}\\
		{\large 26645, Florence, Kentucky, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Blake  Alexander  Gustafsson Inc } \\
		{\large Weston 97}\\
		{\large 26639, Florence, Amnat Charoen, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
