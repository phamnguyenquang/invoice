...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everly Thomas Håkansson} \\
		{\large Hudson 57}\\
		{\large 66127, Stuttgart, Bangkok, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicole Mary 	 Åkesson Pte Ltd } \\
		{\large Aria 88}\\
		{\large 57871, Frankfurt am Main , Chai Nat, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
