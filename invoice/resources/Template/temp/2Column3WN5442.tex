...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Elizabeth 	 Nilsson} \\
		{\large Camila 83}\\
		{\large 45997, Frankfurt am Main , Tuscany, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Anne Holmberg Ltd } \\
		{\large Damian 72}\\
		{\large 55967, Toronto, Buriam, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
