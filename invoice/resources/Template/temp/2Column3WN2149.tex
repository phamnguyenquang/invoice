...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayden William Axelsson} \\
		{\large Lucas 90}\\
		{\large 31394, Madrid, Phu Yen, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valentina John Hedlund Corp } \\
		{\large Max 90}\\
		{\large 46186, Los Angeles, Chiang Rai, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
