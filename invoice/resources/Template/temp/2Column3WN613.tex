...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jade  Alexander  Andersson} \\
		{\large Ximena 95}\\
		{\large 97730, Los Angeles, Heibei, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camila May/Mae 	 Mattsson Pte Ltd } \\
		{\large Valeria 63}\\
		{\large 47370, Vienna, Guangzhou, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
