...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Robert Louise 	 Andersson Ltd} \\
		{\large Jace 65}\\
		{\large 52839, San Francisco, Chiang Rai, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josephine Åkesson } \\
		{\large Jonah 19}\\
		{\large 15262, Vancouver, Bangkok, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
