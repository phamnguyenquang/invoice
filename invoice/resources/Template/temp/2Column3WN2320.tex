...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon  Alexander  Gustafsson} \\
		{\large Alaina 46}\\
		{\large 18322, Nha Trang, Chiang Mai, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luca Ann  Andersson Pte Ltd } \\
		{\large Charlotte 45}\\
		{\large 60663, London , Kentucky, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
