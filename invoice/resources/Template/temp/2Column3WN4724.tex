...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Anthony Mary 	 Svensson} \\
		{\large Aliyah 32}\\
		{\large 85702, Amsterdam, Amnat Charoen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eden David Ekström Ltd } \\
		{\large Melanie 68}\\
		{\large 78110, Venice, Hessen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
