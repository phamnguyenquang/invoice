...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayden William Holmgren} \\
		{\large Avery 58}\\
		{\large 57520, Vancouver, Floria, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isaiah Thomas Andersson Pte Ltd } \\
		{\large Roman 61}\\
		{\large 47107, Hanoi, Floria, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
