...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Diego Marie 	 Lundqvist Inc} \\
		{\large Reagan 21}\\
		{\large 94304, Barcelona, Guangzhou, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Allison Abrahamsson } \\
		{\large Riley 97}\\
		{\large 57377, Abu Dhabi, Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
