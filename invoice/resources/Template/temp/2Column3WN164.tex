...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexander Marie 	 Lund} \\
		{\large Aubree 1}\\
		{\large 60214, Chicago, khanh Hoa, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Genesis Catherine  Ström Pte Ltd } \\
		{\large Evelyn 67}\\
		{\large 33899, Chicago, Chai Nat, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
