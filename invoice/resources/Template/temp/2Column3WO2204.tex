...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tristan  Alexander  Jonsson Corp} \\
		{\large Willow 41}\\
		{\large 35836, Chicago, Guangdong, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonah Bergman } \\
		{\large Lila 41}\\
		{\large 11921, Frankfurt am Main , Guangzhou, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
