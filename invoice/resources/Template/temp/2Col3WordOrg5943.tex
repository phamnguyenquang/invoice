...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Genesis Kate 	 Martinsson Pte Ltd} \\
		{\large Lilly 48}\\
		{\large 49776, Berlin, khanh Hoa, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abigail Viklund } \\
		{\large Madeline 89}\\
		{\large 75280, Nha Trang, Hawaii, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
