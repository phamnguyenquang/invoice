...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harrison Samuelsson} \\
		{\large Julianna 42}\\
		{\large 97522, Milan, Chai Nat, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexa Grace 	 Månsson Pte Ltd } \\
		{\large Amelia 96}\\
		{\large 79610, Frankfurt am Main , Bangkok, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
