...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Elizabeth 	 Lundqvist} \\
		{\large Khloe 15}\\
		{\large 74581, Seoul, Huabei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Colton Louise 	 Claesson Corp } \\
		{\large Aria 5}\\
		{\large 33958, Dubai, khanh Hoa, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
