...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bailey Elizabeth 	 Viklund} \\
		{\large Diego 22}\\
		{\large 86735, Hanoi, Chai Nat, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paisley Catherine  Nyberg Pte Ltd } \\
		{\large Harmony 52}\\
		{\large 15918, Budapest, Guangzhou, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
