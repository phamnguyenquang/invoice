...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isla  Alexander  Sjögren} \\
		{\large Jameson 46}\\
		{\large 35528, Vancouver, Ang Thong, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Timothy Elizabeth 	 Olsson Corp } \\
		{\large Jake 82}\\
		{\large 22186, Stuttgart, Chiang Rai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
