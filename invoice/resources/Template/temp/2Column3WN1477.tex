...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Scarlett Elizabeth 	 Lindgren} \\
		{\large Josiah 11}\\
		{\large 78749, Amsterdam, Indiana, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maximus Elizabeth 	 Bergqvist Pte Ltd } \\
		{\large Gabrielle 76}\\
		{\large 46732, Melbourne, California, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
