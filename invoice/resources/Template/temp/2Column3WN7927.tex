...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daisy  Alexander  Lundqvist} \\
		{\large Kaden 60}\\
		{\large 58318, Barcelona, khanh Hoa, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angel John Hermansson Ltd } \\
		{\large Andrea 59}\\
		{\large 26404, Paris, Saarland, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
