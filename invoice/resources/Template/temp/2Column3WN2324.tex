...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremy Robert Bergström} \\
		{\large Joel 15}\\
		{\large 11895, Melbourne, Indiana, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mya Peter Lundström Inc } \\
		{\large Valentina 83}\\
		{\large 81675, Hong Kong, Kentucky, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
