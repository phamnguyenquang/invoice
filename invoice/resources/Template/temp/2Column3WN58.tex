...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Robert William Blomqvist} \\
		{\large Ryleigh 50}\\
		{\large 38320, Chicago, Phu Yen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesse Catherine  Hansen Corp } \\
		{\large Harrison 7}\\
		{\large 45673, Moscow, Chai Nat, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
