...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bailey Christopher Olsson} \\
		{\large Leo 42}\\
		{\large 37270, Chicago, Heibei, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalia Peter Gustafsson Ltd } \\
		{\large Marcus 71}\\
		{\large 71272, Frankfurt am Main , Bangkok, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
