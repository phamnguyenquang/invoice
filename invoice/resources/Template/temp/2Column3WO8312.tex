...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jose Elizabeth 	 Fransson Pte Ltd} \\
		{\large Jude 6}\\
		{\large 17725, Abu Dhabi, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore Åberg } \\
		{\large Ryan 45}\\
		{\large 12183, Venice, Indiana, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
