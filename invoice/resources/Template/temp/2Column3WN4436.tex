...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juliana Louise 	 Gustafsson} \\
		{\large Jack 95}\\
		{\large 36952, Taipei, California, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carter John Eliasson Ltd } \\
		{\large Ava 45}\\
		{\large 33729, Los Angeles, Hamburg, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
