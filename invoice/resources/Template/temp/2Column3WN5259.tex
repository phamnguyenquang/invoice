...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklyn Elizabeth 	 Forsberg} \\
		{\large Everett 46}\\
		{\large 66793, Tokyo, Phu Yen, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Max Louise 	 Björklund Corp } \\
		{\large Emilia 4}\\
		{\large 18861, Barcelona, California, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
