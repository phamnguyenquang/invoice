...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jessica Michael Henriksson} \\
		{\large Jayla 15}\\
		{\large 13967, New York , khanh Hoa, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lilly Louise 	 Forsberg Inc } \\
		{\large Eliana 83}\\
		{\large 72885, Amsterdam, khanh Hoa, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
