...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luke Louise 	 Holm Pte Ltd} \\
		{\large Richard 19}\\
		{\large 14530, Ho Chi Minh, California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Weston Falk } \\
		{\large Sophia 86}\\
		{\large 17449, Frankfurt am Main , Bangkok, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
