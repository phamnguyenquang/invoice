...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Oklahoma Health Sciences Center} \\
		{\large Blake 92}\\
		{\large 12969, Abu Dhabi, California, ThaiLand}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Daniel Johansson } \\
		{\large Jordyn 21}\\
		{\large 80505, Amsterdam, Indiana, China }\\
    \switchcolumn
