...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriel Peter Andersson} \\
		{\large Emmanuel 15}\\
		{\large 16183, Melbourne, Hawaii, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joshua Edward Lind Pte Ltd } \\
		{\large Ella 6}\\
		{\large 47263, Denver, Kentucky, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
