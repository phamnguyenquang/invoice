...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniel Mary 	 Sandström} \\
		{\large Juliana 57}\\
		{\large 72468, Frankfurt am Main , Saarland, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Colton Marie 	 Holmberg Ltd } \\
		{\large Brooke 77}\\
		{\large 39212, Denver, Chiang Mai, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
