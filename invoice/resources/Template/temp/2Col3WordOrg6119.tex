...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kayla Michael Bergqvist Corp} \\
		{\large Audrey 9}\\
		{\large 59124, Barcelona, Guangzhou, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madeline Nordin } \\
		{\large Cameron 45}\\
		{\large 92417, Frankfurt am Main , Guangdong, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
