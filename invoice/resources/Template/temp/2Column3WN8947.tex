...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  William Edward Axelsson} \\
		{\large Jennifer 3}\\
		{\large 94005, New York , Indiana, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josiah Amy  Claesson Inc } \\
		{\large Miguel 19}\\
		{\large 55485, Frankfurt am Main , Huabei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
