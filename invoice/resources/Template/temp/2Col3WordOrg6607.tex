...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leah Kate 	 Fransson Pte Ltd} \\
		{\large Makenzie 7}\\
		{\large 74048, Frankfurt am Main , Binh Thuan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmett Hansen } \\
		{\large Riley 81}\\
		{\large 64616, Dublin, Buriam, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
