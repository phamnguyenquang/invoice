...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Victoria University of Wellington	New} \\
		{\large Wyatt 13}\\
		{\large 57385, Paris, Chai Nat, Cambodia}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Samantha Håkansson } \\
		{\large Cayden 72}\\
		{\large 35689, Montreal, Kentucky, Cambodia}\\
    \switchcolumn
