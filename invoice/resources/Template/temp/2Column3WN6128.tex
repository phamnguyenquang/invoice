...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everly Elizabeth 	 Åkesson} \\
		{\large Bryson 34}\\
		{\large 69418, Tokyo, Hessen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cameron Victoria Dahlberg Pte Ltd } \\
		{\large Oscar 56}\\
		{\large 18918, Munich, Hainan, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
