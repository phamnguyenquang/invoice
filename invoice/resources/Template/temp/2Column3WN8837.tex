...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isaac Edward Andersson} \\
		{\large Ryleigh 86}\\
		{\large 77408, Vancouver, Hawaii, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklynn David Sundberg Corp } \\
		{\large Julia 38}\\
		{\large 31989, Frankfurt am Main , Hamburg, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
