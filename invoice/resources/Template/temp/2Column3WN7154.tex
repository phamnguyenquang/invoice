...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Diego Michael Lundgren} \\
		{\large Violet 30}\\
		{\large 55257, Beijing, California, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniela Grace 	 Fredriksson Inc } \\
		{\large Edward 16}\\
		{\large 17374, Frankfurt am Main , Bangkok, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
