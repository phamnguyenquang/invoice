...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aubree Marie 	 Claesson Inc} \\
		{\large Lauren 24}\\
		{\large 30952, Frankfurt am Main , khanh Hoa, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jordyn Arvidsson } \\
		{\large Hannah 77}\\
		{\large 93201, Minsk, California, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
