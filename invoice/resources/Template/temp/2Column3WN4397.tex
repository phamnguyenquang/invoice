...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline Louise 	 Claesson} \\
		{\large Aubrey 38}\\
		{\large 38914, Shanghai, Heibei, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valerie Anne Björklund Inc } \\
		{\large Parker 49}\\
		{\large 75312, New York , Guangzhou, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
