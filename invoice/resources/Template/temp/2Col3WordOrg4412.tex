...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Anna Louise 	 Gustafsson Corp} \\
		{\large Ryan 59}\\
		{\large 17986, Frankfurt am Main , Binh Thuan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kevin Lundström } \\
		{\large Brody 11}\\
		{\large 87824, Frankfurt am Main , Kentucky, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
