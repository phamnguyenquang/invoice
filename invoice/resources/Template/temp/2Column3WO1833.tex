...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melanie Anne Hansson Pte Ltd} \\
		{\large Lila 17}\\
		{\large 14738, Frankfurt am Main , California, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everett Gunnarsson } \\
		{\large Jameson 22}\\
		{\large 65891, Istanbul, Hainan, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
