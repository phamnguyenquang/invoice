...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrea Michael Hedlund} \\
		{\large Adalyn 74}\\
		{\large 29594, Paris, Ang Thong, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubree Rose 	 Abrahamsson Pte Ltd } \\
		{\large Natalia 33}\\
		{\large 67114, Moscow, Guangdong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
