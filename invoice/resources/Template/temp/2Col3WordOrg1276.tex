...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery Elizabeth 	 Lindström Pte Ltd} \\
		{\large Evelyn 43}\\
		{\large 99346, Taipei, Bremen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gianna Bergström } \\
		{\large Emilia 36}\\
		{\large 17622, Frankfurt am Main , Amnat Charoen, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
