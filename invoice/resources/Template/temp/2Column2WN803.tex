...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luis Mohamed} \\
		{\large Alyssa 49}\\
		{\large 29497, Frankfurt am Main , Guangdong, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexa Christopher Lindgren Pte Ltd } \\
		{\large Gabrielle 45}\\
		{\large 19409, Paris, Hessen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
