...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rose Robert Sandberg} \\
		{\large Kayla 79}\\
		{\large 10265, Paris, Hessen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonathan Ann  Engström Pte Ltd } \\
		{\large Alexandra 10}\\
		{\large 73039, San Francisco, Hessen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
