...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maria Gunnarsson} \\
		{\large Valerie 36}\\
		{\large 33547, Last Vegas, Ang Thong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sydney Christopher Löfgren Corp } \\
		{\large Caden 56}\\
		{\large 36149, Stuttgart, Kentucky, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
