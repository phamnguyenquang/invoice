...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Miles Grace 	 Axelsson} \\
		{\large Ivy 27}\\
		{\large 79438, Munich, Kentucky, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Max  Alexander  Isaksson Pte Ltd } \\
		{\large Carson 64}\\
		{\large 60901, Shanghai, Guangzhou, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
