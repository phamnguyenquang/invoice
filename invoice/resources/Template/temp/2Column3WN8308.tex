...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mia Mary 	 Mårtensson} \\
		{\large Abigail 46}\\
		{\large 47231, Amsterdam, Henan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Robert Edward Sandström Pte Ltd } \\
		{\large Christopher 37}\\
		{\large 70410, Chicago, Ang Thong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
