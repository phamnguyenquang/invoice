...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maverick May/Mae 	 Hellström} \\
		{\large Quinn 41}\\
		{\large 46609, Frankfurt am Main , Kentucky, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gianna Rose 	 Lindström Corp } \\
		{\large Athena 91}\\
		{\large 56451, Frankfurt am Main , Saarland, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
