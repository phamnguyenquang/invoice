...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Clara Mary 	 Åberg} \\
		{\large Camila 71}\\
		{\large 80230, Washington, Floria, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden Victoria Mattsson Inc } \\
		{\large Eli 97}\\
		{\large 39069, Nha Trang, Kentucky, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
