...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaliyah David Jakobsson} \\
		{\large Carter 70}\\
		{\large 15298, Sydney, Binh Thuan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Calvin Christopher Öberg Pte Ltd } \\
		{\large Maya 32}\\
		{\large 85003, Budapest, Phu Yen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
