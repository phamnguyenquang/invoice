...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maxwell Christopher Nilsson} \\
		{\large Paul 12}\\
		{\large 91279, Stuttgart, Tuscany, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evelyn Grace 	 Lundström Inc } \\
		{\large Mariah 33}\\
		{\large 89582, Barcelona, Hamburg, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
