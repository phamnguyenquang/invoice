...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vincent May/Mae 	 Hellström} \\
		{\large Serenity 1}\\
		{\large 12844, Amsterdam, Ang Thong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carlos Rose 	 Karlsson Ltd } \\
		{\large Scarlett 91}\\
		{\large 81136, Lisbon, Heibei, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
