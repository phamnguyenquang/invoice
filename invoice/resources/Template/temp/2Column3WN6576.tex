...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Arianna John Samuelsson} \\
		{\large Jonah 26}\\
		{\large 28146, Seoul, Hainan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Taylor May/Mae 	 Berglund Ltd } \\
		{\large Daniela 74}\\
		{\large 80698, Stuttgart, Phu Yen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
