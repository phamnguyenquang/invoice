...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valerie May/Mae 	 Gunnarsson} \\
		{\large Alexis 72}\\
		{\large 57466, Lisbon, Guangdong, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ximena Rose 	 Nilsson Corp } \\
		{\large Chloe 85}\\
		{\large 58717, Frankfurt am Main , Indiana, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
