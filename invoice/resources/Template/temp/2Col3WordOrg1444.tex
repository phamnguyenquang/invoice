...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Peter Abrahamsson Pte Ltd} \\
		{\large Nevaeh 84}\\
		{\large 90035, Washington, California, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Steven Björklund } \\
		{\large Arianna 52}\\
		{\large 60864, Shanghai, Bangkok, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
