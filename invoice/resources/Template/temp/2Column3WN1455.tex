...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryker Elizabeth 	 Månsson} \\
		{\large Mackenzie 36}\\
		{\large 93030, Dubai, Amnat Charoen, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harrison Thomas Arvidsson Corp } \\
		{\large Melody 63}\\
		{\large 14632, Frankfurt am Main , Chai Nat, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
