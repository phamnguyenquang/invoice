...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elias Louise 	 Andreasson Ltd} \\
		{\large Juliana 9}\\
		{\large 13043, Denver, Binh Thuan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gracie Nordström } \\
		{\large Sadie 65}\\
		{\large 75987, Last Vegas, Binh Thuan, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
