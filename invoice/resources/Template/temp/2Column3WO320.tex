...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria Thomas Lindgren Pte Ltd} \\
		{\large Jude 78}\\
		{\large 51427, Abu Dhabi, Saarland, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carson Åberg } \\
		{\large Ruby 85}\\
		{\large 39180, Frankfurt am Main , Chiang Rai, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
