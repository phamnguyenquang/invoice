...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madison Grace 	 Bengtsson} \\
		{\large Asher 32}\\
		{\large 23437, Taipei, Amnat Charoen, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nevaeh Lee  Björklund Corp } \\
		{\large Declan 73}\\
		{\large 53679, Amsterdam, Saarland, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
