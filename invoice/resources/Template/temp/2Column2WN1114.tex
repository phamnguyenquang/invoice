...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lilly Abrahamsson} \\
		{\large Alaina 21}\\
		{\large 96715, Frankfurt am Main , Guangzhou, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lyla Rose 	 Mattsson Inc } \\
		{\large Rylee 4}\\
		{\large 34826, Frankfurt am Main , Buriam, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
