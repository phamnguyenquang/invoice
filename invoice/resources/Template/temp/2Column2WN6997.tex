...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amelia Martinsson} \\
		{\large Wyatt 36}\\
		{\large 34837, Singapore, Tuscany, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jessica Lee  Bergström Pte Ltd } \\
		{\large Ariana 14}\\
		{\large 83867, Barcelona, Chai Nat, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
