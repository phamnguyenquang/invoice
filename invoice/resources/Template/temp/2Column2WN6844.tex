...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaden Hassan} \\
		{\large Kendall 24}\\
		{\large 81354, Chicago, Chiang Rai, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isla Grace 	 Sandberg Ltd } \\
		{\large Liliana 12}\\
		{\large 30581, Frankfurt am Main , Seattles, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
