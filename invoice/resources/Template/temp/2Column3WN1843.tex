...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Weston Victoria Karlsson} \\
		{\large Angelina 4}\\
		{\large 64607, Berlin, California, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aiden Catherine  Andreasson Corp } \\
		{\large Kayden 15}\\
		{\large 63566, Los Angeles, Hessen, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
