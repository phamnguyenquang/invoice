...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Matthew Fredriksson} \\
		{\large Dominic 29}\\
		{\large 28395, San Francisco, Bayern, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juan Thomas Nordström Ltd } \\
		{\large Alice 76}\\
		{\large 21972, Ho Chi Minh, Kentucky, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
