...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte  Alexander  Karlsson Corp} \\
		{\large Alan 43}\\
		{\large 46158, Osaka, Indiana, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evelyn Lundgren } \\
		{\large Brantley 99}\\
		{\large 95021, Frankfurt am Main , Buriam, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
