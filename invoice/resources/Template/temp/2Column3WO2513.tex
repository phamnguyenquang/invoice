...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Benjamin Michael Ekström Ltd} \\
		{\large Emmanuel 38}\\
		{\large 85361, Toronto, Indiana, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evan Mårtensson } \\
		{\large Aaron 64}\\
		{\large 27636, Barcelona, Guangdong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
