...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jose Louise 	 Holmberg} \\
		{\large Adriana 21}\\
		{\large 69061, Boston, Phu Yen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy  Alexander  Bengtsson Pte Ltd } \\
		{\large Sebastian 97}\\
		{\large 69310, Abu Dhabi, Chiang Mai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
