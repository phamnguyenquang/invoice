...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Annabelle Christopher Lindgren Ltd} \\
		{\large Nicole 93}\\
		{\large 18869, Washington, Amnat Charoen, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ellie Bergström } \\
		{\large Bennett 55}\\
		{\large 25842, Tokyo, Hamburg, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
