...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tyler Lee  Lundqvist} \\
		{\large Melanie 89}\\
		{\large 45192, Budapest, Seattles, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everett Edward Gustafsson Inc } \\
		{\large Trinity 68}\\
		{\large 93639, Hong Kong, khanh Hoa, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
