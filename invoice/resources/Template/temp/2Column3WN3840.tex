...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxon Thomas Eriksson} \\
		{\large Elena 35}\\
		{\large 60059, Amsterdam, Saarland, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jasmine Marie 	 Berglund Ltd } \\
		{\large Angelina 85}\\
		{\large 16931, SaiGon, Chiang Rai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
