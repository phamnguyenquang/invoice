...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rachel William Bergman} \\
		{\large Aurora 42}\\
		{\large 76015, Tokyo, Chiang Mai, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Asher William Gustafsson Pte Ltd } \\
		{\large Lila 18}\\
		{\large 25044, Hong Kong, Bangkok, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
