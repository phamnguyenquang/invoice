...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon  Alexander  Andreasson} \\
		{\large Brandon 91}\\
		{\large 79848, Seoul, Hessen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Izabella Mary 	 Hansson Pte Ltd } \\
		{\large Zoey 22}\\
		{\large 28808, Berlin, Buriam, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
