...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paul Thomas Pettersson Ltd} \\
		{\large Alexandra 24}\\
		{\large 86751, Los Angeles, Chiang Mai, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Blake Samuelsson } \\
		{\large Peyton 54}\\
		{\large 32702, Ho Chi Minh, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
