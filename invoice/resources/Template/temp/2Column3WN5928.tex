...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Evelyn  Alexander  Ström} \\
		{\large Maxwell 27}\\
		{\large 79979, Venice, Hamburg, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden Louise 	 Pålsson Pte Ltd } \\
		{\large Josephine 74}\\
		{\large 77004, Sydney, Binh Thuan, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
