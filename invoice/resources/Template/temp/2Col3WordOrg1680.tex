...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope  Alexander  Blomqvist Inc} \\
		{\large Katelyn 39}\\
		{\large 62226, Ho Chi Minh, Chiang Mai, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Londyn Gustafsson } \\
		{\large Alejandro 37}\\
		{\large 70556, Seoul, Phu Yen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
