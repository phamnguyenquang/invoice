...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stephanie Kate 	 Persson} \\
		{\large Norah 8}\\
		{\large 86671, Nha Trang, Huabei, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Micah James Eklund Pte Ltd } \\
		{\large Zoey 39}\\
		{\large 18977, Ho Chi Minh, California, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
