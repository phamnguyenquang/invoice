...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Braxton Kate 	 Olofsson Pte Ltd} \\
		{\large Brianna 97}\\
		{\large 33207, Tokyo, Chiang Mai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bennett Fredriksson } \\
		{\large Victoria 10}\\
		{\large 16303, New York , California, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
