...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariana Samuelsson} \\
		{\large Eli 90}\\
		{\large 22374, Frankfurt am Main , Hainan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joseph Catherine  Hansson Inc } \\
		{\large Jade 73}\\
		{\large 28228, SaiGon, Henan, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
