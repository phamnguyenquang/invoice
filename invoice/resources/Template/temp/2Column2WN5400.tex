...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicholas Holmberg} \\
		{\large Mark 88}\\
		{\large 97734, Los Angeles, Chiang Rai, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jessica Louise 	 Lindgren Pte Ltd } \\
		{\large Amy 12}\\
		{\large 68760, Budapest, Chiang Rai, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
