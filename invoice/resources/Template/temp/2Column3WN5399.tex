...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Colton William Svensson} \\
		{\large Steven 37}\\
		{\large 41546, Frankfurt am Main , Heibei, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaitlyn Mary 	 Karlsson Corp } \\
		{\large Laila 66}\\
		{\large 51282, Lisbon, Floria, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
