...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vanessa Fredriksson} \\
		{\large Jack 81}\\
		{\large 11878, Dubai, California, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elise Christopher Olofsson Inc } \\
		{\large Norah 36}\\
		{\large 97926, Ho Chi Minh, khanh Hoa, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
