...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Federal University of Rio de Janeiro} \\
		{\large Alex 49}\\
		{\large 26537, Frankfurt am Main , Amnat Charoen, Indonesia s}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Jesse Dahl } \\
		{\large Grant 11}\\
		{\large 12701, Barcelona, Guangdong, South Africa }\\
    \switchcolumn
