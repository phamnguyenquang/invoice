...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicolas Robert Isaksson} \\
		{\large Calvin 69}\\
		{\large 39184, Hong Kong, Floria, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julia Peter Hellström Pte Ltd } \\
		{\large Jaxson 30}\\
		{\large 28769, Los Angeles, Huabei, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
