...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexa Jane Wikström Pte Ltd} \\
		{\large Adalyn 84}\\
		{\large 25418, San Francisco, Indiana, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paisley Bengtsson } \\
		{\large Londyn 86}\\
		{\large 56806, Osaka, Guangzhou, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
