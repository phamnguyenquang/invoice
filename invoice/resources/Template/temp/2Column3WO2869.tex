...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezekiel Louise 	 Danielsson Pte Ltd} \\
		{\large Max 42}\\
		{\large 97735, Florence, Amnat Charoen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gavin Lindgren } \\
		{\large Zoey 43}\\
		{\large 42160, Dublin, khanh Hoa, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
