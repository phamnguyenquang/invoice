...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katherine Louise 	 Dahlberg Inc} \\
		{\large Amy 73}\\
		{\large 77064, Berlin, Buriam, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathaniel Viklund } \\
		{\large Calvin 20}\\
		{\large 56191, Frankfurt am Main , Bremen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
