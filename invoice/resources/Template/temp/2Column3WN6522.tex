...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity Kate 	 Björk} \\
		{\large Caden 65}\\
		{\large 11765, Frankfurt am Main , Heibei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Morgan May/Mae 	 Eklund Pte Ltd } \\
		{\large Avery 91}\\
		{\large 92312, Paris, Hessen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
