...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Oliver Strömberg} \\
		{\large Jocelyn 85}\\
		{\large 16084, Moscow, Chiang Rai, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Destiny Christopher Magnusson Pte Ltd } \\
		{\large Kaylee 75}\\
		{\large 67308, Shanghai, Ang Thong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
