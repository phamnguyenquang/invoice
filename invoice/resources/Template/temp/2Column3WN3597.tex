...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harrison William Bergman} \\
		{\large Sophia 65}\\
		{\large 59061, Seoul, Ang Thong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tucker  Alexander  Olofsson Pte Ltd } \\
		{\large Bradley 77}\\
		{\large 59274, Osaka, Hainan, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
