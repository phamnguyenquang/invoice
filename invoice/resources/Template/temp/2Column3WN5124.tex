...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eliana Jane Ekström} \\
		{\large Kaylee 71}\\
		{\large 49727, Abu Dhabi, Huabei, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valeria Christopher Jansson Inc } \\
		{\large Kayden 86}\\
		{\large 18074, Taipei, Binh Thuan, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
