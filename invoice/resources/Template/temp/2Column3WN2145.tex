...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Athena Catherine  Samuelsson} \\
		{\large Summer 74}\\
		{\large 14257, Venice, Buriam, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmett  Alexander  Lindberg Ltd } \\
		{\large Nicolas 21}\\
		{\large 60449, Boston, Amnat Charoen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
