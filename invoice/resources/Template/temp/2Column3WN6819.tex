...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryker Thomas Åberg} \\
		{\large Edward 32}\\
		{\large 12852, Shanghai, Amnat Charoen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madelyn Edward Holmgren Pte Ltd } \\
		{\large Naomi 19}\\
		{\large 57928, Last Vegas, Amnat Charoen, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
