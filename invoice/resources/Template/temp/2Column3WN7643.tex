...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Weston Mary 	 Martinsson} \\
		{\large Maddox 6}\\
		{\large 22784, Washington, California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Morgan Grace 	 Dahl Pte Ltd } \\
		{\large Olivia 90}\\
		{\large 35161, Budapest, Texas, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
