...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Wrocław University of Science and Technology} \\
		{\large Ryleigh 81}\\
		{\large 13179, Washington, Tuscany, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lincoln Sjögren } \\
		{\large Josiah 37}\\
		{\large 29615, Vancouver, Floria, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
