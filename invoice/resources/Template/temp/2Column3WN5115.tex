...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lillian Victoria Holmberg} \\
		{\large King 91}\\
		{\large 72703, Sydney, Huabei, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayden Anne Claesson Pte Ltd } \\
		{\large Trinity 65}\\
		{\large 31359, Budapest, Floria, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
