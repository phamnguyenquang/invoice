...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Santiago Thomas Abrahamsson} \\
		{\large Easton 65}\\
		{\large 49330, Tokyo, Hamburg, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley Jane Karlsson Pte Ltd } \\
		{\large Isabella 23}\\
		{\large 52696, SaiGon, Hawaii, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
