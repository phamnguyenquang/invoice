...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Audrey Victoria Henriksson} \\
		{\large Nathan 30}\\
		{\large 69120, Los Angeles, Heibei, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juliana Anne Lindqvist Inc } \\
		{\large Ellie 31}\\
		{\large 90307, SaiGon, Tuscany, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
