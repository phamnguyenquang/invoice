...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aidan  Alexander  Johansson Pte Ltd} \\
		{\large Adam 85}\\
		{\large 42304, Hong Kong, Bayern, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harper Blomqvist } \\
		{\large Ashley 59}\\
		{\large 94428, Abu Dhabi, Tuscany, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
