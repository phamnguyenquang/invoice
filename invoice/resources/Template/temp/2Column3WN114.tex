...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Faith Ann  Larsson} \\
		{\large Tristan 1}\\
		{\large 98259, Chicago, Hessen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison May/Mae 	 Pålsson Pte Ltd } \\
		{\large Kinsley 92}\\
		{\large 34671, Nha Trang, Seattles, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
