...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Landon May/Mae 	 Hansson} \\
		{\large Bailey 64}\\
		{\large 14625, Florence, Bangkok, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alice Louise 	 Danielsson Ltd } \\
		{\large Sadie 21}\\
		{\large 31406, Frankfurt am Main , Hawaii, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
