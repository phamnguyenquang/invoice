...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cole Thomas Eklund Ltd} \\
		{\large Gavin 26}\\
		{\large 46919, Frankfurt am Main , Amnat Charoen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Easton Fredriksson } \\
		{\large Camden 29}\\
		{\large 85858, Rome, Binh Thuan, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
