...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cooper Jakobsson} \\
		{\large Benjamin 16}\\
		{\large 33740, Frankfurt am Main , Chiang Mai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaden May/Mae 	 Norberg Corp } \\
		{\large Anna 27}\\
		{\large 10739, Dublin, Hainan, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
