...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Henry Amy  Berg} \\
		{\large Graham 45}\\
		{\large 47354, Ho Chi Minh, Hamburg, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Jane Sandberg Corp } \\
		{\large Gavin 8}\\
		{\large 89829, Shanghai, Hessen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
