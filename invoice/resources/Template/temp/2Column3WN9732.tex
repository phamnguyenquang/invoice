...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maximus Peter Johansson} \\
		{\large Maverick 41}\\
		{\large 54132, San Francisco, Henan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Max Robert Mårtensson Inc } \\
		{\large Parker 34}\\
		{\large 15268, Amsterdam, Hessen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
