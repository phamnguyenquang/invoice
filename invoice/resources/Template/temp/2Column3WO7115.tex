...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Naomi Christopher Hansson Inc} \\
		{\large Kayla 43}\\
		{\large 76201, Venice, Ang Thong, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan Mårtensson } \\
		{\large Sawyer 77}\\
		{\large 61135, Frankfurt am Main , Heibei, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
