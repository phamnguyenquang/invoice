...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaliyah Eliasson} \\
		{\large Jeremiah 89}\\
		{\large 46948, Frankfurt am Main , Hamburg, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adriana  Alexander  Ek Pte Ltd } \\
		{\large Angel 48}\\
		{\large 70105, Last Vegas, Amnat Charoen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
