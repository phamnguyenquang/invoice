...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaylee  Alexander  Henriksson} \\
		{\large Abel 29}\\
		{\large 19555, Taipei, Kentucky, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mark Lee  Hermansson Pte Ltd } \\
		{\large Zoe 76}\\
		{\large 67523, Shanghai, Bayern, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
