...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariel Peter Arvidsson} \\
		{\large Oliver 95}\\
		{\large 84254, Frankfurt am Main , Texas, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vivian Louise 	 Lundgren Inc } \\
		{\large Cayden 16}\\
		{\large 70478, Abu Dhabi, Phu Yen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
