...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zoey Mary 	 Olofsson Pte Ltd} \\
		{\large Theodore 64}\\
		{\large 28599, Frankfurt am Main , Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aiden Dahlberg } \\
		{\large Leo 88}\\
		{\large 44793, Hong Kong, Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
