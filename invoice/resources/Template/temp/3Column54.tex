...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Medical University of South Carolina} \\
		{\large Grant 4}\\
		{\large 65150, San Francisco, Seattles, Indonesia s}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Jennifer Lundström } \\
		{\large Matthew 45}\\
		{\large 10647, Los Angeles, Ang Thong, Cambodia}\\
    \switchcolumn
