...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kylie  Alexander  Isaksson Pte Ltd} \\
		{\large Silas 99}\\
		{\large 80154, SaiGon, Guangdong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryker Björklund } \\
		{\large Aliyah 45}\\
		{\large 74829, Barcelona, Floria, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
