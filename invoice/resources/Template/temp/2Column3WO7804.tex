...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jackson Rose 	 Mårtensson Inc} \\
		{\large Hadley 2}\\
		{\large 41656, Toronto, Saarland, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aurora Hedlund } \\
		{\large Noah 32}\\
		{\large 67572, Frankfurt am Main , Chiang Rai, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
