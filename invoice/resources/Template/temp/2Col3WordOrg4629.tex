...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Arianna Jane Holmgren Pte Ltd} \\
		{\large Melody 23}\\
		{\large 26617, Frankfurt am Main , Bangkok, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samuel Eliasson } \\
		{\large Gael 6}\\
		{\large 73352, Frankfurt am Main , Tuscany, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
