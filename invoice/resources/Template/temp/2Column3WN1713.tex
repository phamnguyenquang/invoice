...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Piper Christopher Hansen} \\
		{\large Nicolas 76}\\
		{\large 81595, Frankfurt am Main , Guangzhou, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eliza Peter Hansson Corp } \\
		{\large Parker 13}\\
		{\large 61648, Florence, Hessen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
