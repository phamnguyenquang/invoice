...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Taylor Abrahamsson} \\
		{\large Aubree 2}\\
		{\large 15016, Amsterdam, Chiang Mai, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kimberly Catherine  Sjöberg Corp } \\
		{\large Alana 30}\\
		{\large 56338, Abu Dhabi, Guangdong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
