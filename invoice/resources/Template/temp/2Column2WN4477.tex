...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremy Persson} \\
		{\large Jordan 44}\\
		{\large 14494, Tokyo, Bremen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Christopher Svensson Corp } \\
		{\large Braxton 28}\\
		{\large 87828, Florence, Buriam, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
