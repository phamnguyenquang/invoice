...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carlos Edward Sandström} \\
		{\large Hudson 60}\\
		{\large 51339, Berlin, Ang Thong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large George Catherine  Olofsson Pte Ltd } \\
		{\large Antonio 34}\\
		{\large 53798, Beijing, Buriam, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
