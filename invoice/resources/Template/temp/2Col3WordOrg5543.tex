...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mason Catherine  Gustafsson Pte Ltd} \\
		{\large Logan 12}\\
		{\large 21213, Los Angeles, Hainan, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joshua Jönsson } \\
		{\large Lily 64}\\
		{\large 15062, Barcelona, Bayern, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
