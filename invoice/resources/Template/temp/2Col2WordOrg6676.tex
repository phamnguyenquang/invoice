...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesse Lundström Pte Ltd} \\
		{\large Daniela 8}\\
		{\large 39373, Frankfurt am Main , Buriam, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brody Eriksson } \\
		{\large Bradley 34}\\
		{\large 35276, San Francisco, Kentucky, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
