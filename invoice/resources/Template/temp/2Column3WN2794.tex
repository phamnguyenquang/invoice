...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rachel Marie 	 Nordin} \\
		{\large Kai 10}\\
		{\large 98814, Ho Chi Minh, Binh Thuan, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everly John Claesson Pte Ltd } \\
		{\large Gracie 45}\\
		{\large 95530, Nha Trang, khanh Hoa, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
