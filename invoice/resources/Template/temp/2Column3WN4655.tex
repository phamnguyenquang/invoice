...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cayden Mary 	 Nyström} \\
		{\large Alexandra 68}\\
		{\large 27887, Chicago, Saarland, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lincoln William Axelsson Pte Ltd } \\
		{\large Henry 17}\\
		{\large 47992, Denver, Bangkok, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
