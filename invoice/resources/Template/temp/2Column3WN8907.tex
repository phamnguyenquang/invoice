...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leilani Marie 	 Forsberg} \\
		{\large Brooklynn 94}\\
		{\large 65986, San Francisco, Hessen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrew Christopher Löfgren Corp } \\
		{\large Isabelle 33}\\
		{\large 95375, Toronto, Heibei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
