...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Santiago Bergqvist} \\
		{\large Alex 84}\\
		{\large 18178, Frankfurt am Main , Hainan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caden Amy  Hermansson Inc } \\
		{\large Valeria 80}\\
		{\large 17171, Barcelona, Seattles, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
