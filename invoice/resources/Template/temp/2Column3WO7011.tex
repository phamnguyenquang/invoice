...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aliyah Elizabeth 	 Blomqvist Pte Ltd} \\
		{\large Angelina 30}\\
		{\large 68275, Frankfurt am Main , Buriam, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Delilah Hansen } \\
		{\large Lyla 36}\\
		{\large 23984, Istanbul, Huabei, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
