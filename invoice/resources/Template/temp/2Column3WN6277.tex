...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayden Kate 	 Berg} \\
		{\large Trinity 94}\\
		{\large 46001, Frankfurt am Main , Ang Thong, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lydia Elizabeth 	 Fredriksson Ltd } \\
		{\large Dylan 26}\\
		{\large 79659, Frankfurt am Main , Phu Yen, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
