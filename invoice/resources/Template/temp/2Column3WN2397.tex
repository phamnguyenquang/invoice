...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Destiny Grace 	 Svensson} \\
		{\large Madison 88}\\
		{\large 90474, Venice, Binh Thuan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesus William Björklund Inc } \\
		{\large Carson 71}\\
		{\large 15198, Frankfurt am Main , Ang Thong, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
