...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexander Hellström} \\
		{\large Jameson 56}\\
		{\large 86398, Frankfurt am Main , Huabei, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mckenzie Anne Lundin Inc } \\
		{\large Ruby 89}\\
		{\large 78364, Istanbul, Chiang Mai, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
