...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalynn Elizabeth 	 Forsberg} \\
		{\large Clara 36}\\
		{\large 85503, Berlin, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rebecca  Alexander  Hellström Ltd } \\
		{\large Lily 6}\\
		{\large 58241, Shanghai, Seattles, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
