...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  George Amy  Åkesson} \\
		{\large Gracie 28}\\
		{\large 25588, Vancouver, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabella Peter Forsberg Ltd } \\
		{\large Michelle 93}\\
		{\large 47227, Rome, Tuscany, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
