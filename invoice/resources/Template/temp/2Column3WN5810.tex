...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hazel  Alexander  Bengtsson} \\
		{\large Molly 77}\\
		{\large 36553, Vancouver, khanh Hoa, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Peyton Mary 	 Fredriksson Inc } \\
		{\large Payton 78}\\
		{\large 30917, Dubai, Chiang Mai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
