...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabel Peter Viklund} \\
		{\large Anna 4}\\
		{\large 83127, Hanoi, Seattles, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abigail William Martinsson Ltd } \\
		{\large Khloe 93}\\
		{\large 53359, Chicago, Amnat Charoen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
