...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elijah Louise 	 Lindström} \\
		{\large Grayson 23}\\
		{\large 81450, Hanoi, Guangdong, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vincent Catherine  Gunnarsson Inc } \\
		{\large Makayla 18}\\
		{\large 14278, Madrid, khanh Hoa, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
