...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Nanyang Technological University} \\
		{\large Ava 50}\\
		{\large 41350, Abu Dhabi, Amnat Charoen, ThaiLand}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Ellie Gunnarsson } \\
		{\large Mateo 68}\\
		{\large 30755, Frankfurt am Main , Indiana, Switzerland}\\
    \switchcolumn
