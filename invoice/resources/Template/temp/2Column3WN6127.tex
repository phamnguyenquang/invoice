...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Louise 	 Lind} \\
		{\large Adalynn 94}\\
		{\large 56376, Berlin, Tuscany, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large William  Alexander  Jakobsson Corp } \\
		{\large Kaden 93}\\
		{\large 58656, Shanghai, Amnat Charoen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
