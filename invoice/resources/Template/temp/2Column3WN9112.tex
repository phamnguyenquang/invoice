...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Samuel Thomas Jonsson} \\
		{\large Makayla 79}\\
		{\large 56628, Singapore, Indiana, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremiah James Eliasson Ltd } \\
		{\large Christopher 19}\\
		{\large 51759, Vancouver, Chai Nat, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
