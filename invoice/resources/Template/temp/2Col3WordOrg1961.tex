...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Grace 	 Andersson Pte Ltd} \\
		{\large Aliyah 27}\\
		{\large 61010, Frankfurt am Main , Binh Thuan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jake Blomqvist } \\
		{\large Sebastian 37}\\
		{\large 18274, Melbourne, Amnat Charoen, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
