...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brayden Christopher Jakobsson} \\
		{\large Victoria 45}\\
		{\large 13049, Minsk, Bremen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madelyn Elizabeth 	 Axelsson Pte Ltd } \\
		{\large Ryker 67}\\
		{\large 19652, Frankfurt am Main , Chiang Rai, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
