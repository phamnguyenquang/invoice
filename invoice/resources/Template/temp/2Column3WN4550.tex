...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaden Catherine  Hermansson} \\
		{\large Carson 66}\\
		{\large 94199, Montreal, Guangdong, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camila Thomas Sandström Pte Ltd } \\
		{\large Penelope 18}\\
		{\large 27301, New York , Hawaii, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
