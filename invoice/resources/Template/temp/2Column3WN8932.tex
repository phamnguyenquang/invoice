...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall Louise 	 Karlsson} \\
		{\large Jeremiah 34}\\
		{\large 71223, Bonn, Seattles, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madison  Alexander  Berglund Pte Ltd } \\
		{\large Edward 32}\\
		{\large 99411, Melbourne, Amnat Charoen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
