...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonah Marie 	 Olofsson} \\
		{\large Clara 18}\\
		{\large 97570, Budapest, Bayern, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabelle Edward Strömberg Corp } \\
		{\large Melanie 5}\\
		{\large 41250, Dublin, Saarland, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
