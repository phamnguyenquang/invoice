...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ayden Sandberg} \\
		{\large Nicholas 61}\\
		{\large 53112, Los Angeles, Guangdong, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubrey James Björklund Ltd } \\
		{\large Abigail 5}\\
		{\large 85495, Shanghai, Seattles, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
