...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle Christopher Andreasson} \\
		{\large Jackson 97}\\
		{\large 73352, Shanghai, Tuscany, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonathan Lee  Svensson Pte Ltd } \\
		{\large Ezekiel 37}\\
		{\large 34958, Sydney, Binh Thuan, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
