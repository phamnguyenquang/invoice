...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brian Robert Öberg} \\
		{\large Brian 32}\\
		{\large 15436, Hong Kong, Hessen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stella Victoria Martinsson Pte Ltd } \\
		{\large Levi 65}\\
		{\large 80020, New York , khanh Hoa, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
