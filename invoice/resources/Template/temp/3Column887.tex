...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Nanjing University of Science and Technology} \\
		{\large Hailey 12}\\
		{\large 11148, Frankfurt am Main , Texas, Canada }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Thomas Nordström } \\
		{\large Lyla 49}\\
		{\large 41841, Berlin, Bremen, South Africa }\\
    \switchcolumn
