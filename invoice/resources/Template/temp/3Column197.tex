...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  COMSATS Institute of Information Technology} \\
		{\large Julian 98}\\
		{\large 36731, Vancouver, Hawaii, Russia}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Grant Forsberg } \\
		{\large Faith 94}\\
		{\large 67061, Nha Trang, California, ThaiLand}\\
    \switchcolumn
