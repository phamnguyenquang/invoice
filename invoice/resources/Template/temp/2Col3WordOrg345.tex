...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kayden Elizabeth 	 Holmberg Pte Ltd} \\
		{\large Juliana 45}\\
		{\large 48051, Frankfurt am Main , Chiang Rai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vivian Viklund } \\
		{\large Lucy 69}\\
		{\large 21335, Washington, Chiang Rai, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
