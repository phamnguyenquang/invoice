...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jace Nordström} \\
		{\large Alexandra 8}\\
		{\large 57351, Amsterdam, Amnat Charoen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abigail Ann  Blomqvist Pte Ltd } \\
		{\large Isabella 71}\\
		{\large 69573, Paris, Hainan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
