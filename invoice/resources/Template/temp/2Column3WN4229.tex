...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vivian Victoria Sjöberg} \\
		{\large Cayden 48}\\
		{\large 72054, Tokyo, Seattles, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ivy Edward Hansson Corp } \\
		{\large Kaylee 22}\\
		{\large 93391, Last Vegas, Seattles, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
