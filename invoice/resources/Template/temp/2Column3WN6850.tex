...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalyn James Gustafsson} \\
		{\large Alexis 16}\\
		{\large 13566, Amsterdam, Heibei, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eliana Louise 	 Lindström Pte Ltd } \\
		{\large Bennett 11}\\
		{\large 47336, Berlin, Phu Yen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
