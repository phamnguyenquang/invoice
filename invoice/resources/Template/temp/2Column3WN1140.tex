...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery Elizabeth 	 Hedlund} \\
		{\large Theodore 70}\\
		{\large 87436, Boston, Buriam, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Molly  Alexander  Hermansson Inc } \\
		{\large Victoria 39}\\
		{\large 86996, Vancouver, Binh Thuan, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
