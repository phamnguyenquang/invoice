...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Catherine John Andersson Ltd} \\
		{\large Christopher 88}\\
		{\large 80419, Dublin, Amnat Charoen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubrey Jakobsson } \\
		{\large Jaxon 36}\\
		{\large 72344, Vancouver, Seattles, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
