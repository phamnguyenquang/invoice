...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Greyson Rose 	 Sundberg} \\
		{\large Giovanni 1}\\
		{\large 59253, Dubai, Saarland, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madison William Olsson Pte Ltd } \\
		{\large Brianna 30}\\
		{\large 13181, Frankfurt am Main , Chiang Rai, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
