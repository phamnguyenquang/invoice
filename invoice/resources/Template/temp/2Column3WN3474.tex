...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Camden Christopher Andreasson} \\
		{\large Eliza 9}\\
		{\large 51782, Osaka, Guangdong, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Izabella Robert Mohamed Corp } \\
		{\large Max 53}\\
		{\large 63713, Last Vegas, Henan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
