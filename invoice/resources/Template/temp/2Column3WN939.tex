...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jade Louise 	 Andersson} \\
		{\large Katherine 97}\\
		{\large 31770, Istanbul, khanh Hoa, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vincent Mary 	 Persson Pte Ltd } \\
		{\large Sawyer 79}\\
		{\large 59582, Vancouver, Saarland, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
