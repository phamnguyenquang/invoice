...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  King  Alexander  Gunnarsson} \\
		{\large Maddox 4}\\
		{\large 95818, Minsk, Huabei, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore Elizabeth 	 Andersson Pte Ltd } \\
		{\large Kylie 76}\\
		{\large 35101, Hanoi, Chai Nat, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
