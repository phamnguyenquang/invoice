...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lily Victoria Forsberg Pte Ltd} \\
		{\large Jeremy 35}\\
		{\large 87319, Last Vegas, Amnat Charoen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lincoln Lindström } \\
		{\large Easton 79}\\
		{\large 10842, Amsterdam, Bayern, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
