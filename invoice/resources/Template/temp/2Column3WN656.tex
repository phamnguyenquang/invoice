...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Rose 	 Berggren} \\
		{\large Bryan 11}\\
		{\large 85481, Toronto, Tuscany, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Levi  Alexander  Andersson Inc } \\
		{\large Malachi 54}\\
		{\large 85732, London , Henan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
