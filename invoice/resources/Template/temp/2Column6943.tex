...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryleigh Arvidsson Corp} \\
		{\large Valerie 94}\\
		{\large 60940, Frankfurt am Main , Chiang Mai, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valerie Forsberg } \\
		{\large Jessica 84}\\
		{\large 65494, Denver, Hainan, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
