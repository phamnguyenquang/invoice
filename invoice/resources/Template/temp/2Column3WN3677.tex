...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mark Victoria Dahl} \\
		{\large Morgan 52}\\
		{\large 59577, Lisbon, Kentucky, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emilia Christopher Bergqvist Ltd } \\
		{\large Connor 93}\\
		{\large 66743, Nha Trang, Huabei, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
