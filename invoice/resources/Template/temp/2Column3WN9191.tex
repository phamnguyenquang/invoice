...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maverick  Alexander  Gustafsson} \\
		{\large Gael 36}\\
		{\large 83514, Dublin, California, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison Michael Nyberg Pte Ltd } \\
		{\large Hunter 65}\\
		{\large 39078, Vienna, Hawaii, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
