...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Veterinary Medicine Vienna} \\
		{\large Ashton 10}\\
		{\large 36140, Madrid, California, Indonesia s}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Aaron Lindberg } \\
		{\large Norah 8}\\
		{\large 49759, Paris, Saarland, China }\\
    \switchcolumn
