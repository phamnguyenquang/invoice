...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaden Lundberg} \\
		{\large Paisley 30}\\
		{\large 87111, Venice, Bremen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Grace 	 Lundqvist Pte Ltd } \\
		{\large Emmett 72}\\
		{\large 50576, Barcelona, Ang Thong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
