...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ayden  Alexander  Lindström} \\
		{\large Layla 31}\\
		{\large 48293, Ho Chi Minh, Texas, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicolas Michael Axelsson Inc } \\
		{\large Madelyn 92}\\
		{\large 42945, Boston, Seattles, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
