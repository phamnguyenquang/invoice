...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bentley  Alexander  Björklund} \\
		{\large Jesus 62}\\
		{\large 55425, Shanghai, khanh Hoa, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vincent William Mårtensson Pte Ltd } \\
		{\large Jayce 63}\\
		{\large 85863, Beijing, California, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
