...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michael  Alexander  Lindholm Ltd} \\
		{\large Wyatt 10}\\
		{\large 50253, Frankfurt am Main , Seattles, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tucker Olofsson } \\
		{\large Ivan 38}\\
		{\large 77034, Shanghai, Hamburg, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
