...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vivian Catherine  Berglund} \\
		{\large Sophia 38}\\
		{\large 86628, Last Vegas, Huabei, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jack Anne Fransson Pte Ltd } \\
		{\large Bryson 34}\\
		{\large 22704, Chicago, Saarland, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
