...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mackenzie James Nordin} \\
		{\large Sophie 77}\\
		{\large 10615, Bonn, Chiang Mai, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Violet Louise 	 Lundström Pte Ltd } \\
		{\large Skylar 8}\\
		{\large 42397, Frankfurt am Main , Floria, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
