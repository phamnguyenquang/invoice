...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lila Christopher Åkesson} \\
		{\large Benjamin 73}\\
		{\large 71710, SaiGon, Hainan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniel Elizabeth 	 Lundberg Ltd } \\
		{\large Theodore 20}\\
		{\large 60890, Dublin, Bayern, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
