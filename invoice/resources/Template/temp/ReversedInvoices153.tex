...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Tromsø – The Arctic University of Norway} \\
		{\large Eden 24}\\
		{\large 49951, Vienna, Floria, Singapore}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Angelina Fredriksson } \\
		{\large Brantley 4}\\
		{\large 71963, Venice, Texas, Australia }\\
    \switchcolumn
