...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly Elizabeth 	 Persson} \\
		{\large Ian 41}\\
		{\large 10285, Frankfurt am Main , Ang Thong, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Naomi Michael Lindgren Pte Ltd } \\
		{\large Bryan 84}\\
		{\large 92016, Boston, Seattles, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
