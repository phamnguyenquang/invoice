...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezra John Mårtensson} \\
		{\large Wesley 79}\\
		{\large 30848, Dublin, Chiang Rai, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sophie Catherine  Mattsson Corp } \\
		{\large Hailey 57}\\
		{\large 53616, Frankfurt am Main , Tuscany, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
