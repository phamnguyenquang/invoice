...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline Sjögren} \\
		{\large Brady 46}\\
		{\large 51007, Ho Chi Minh, Buriam, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hannah Michael Bergström Pte Ltd } \\
		{\large Jayce 83}\\
		{\large 82937, Chicago, Ang Thong, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
