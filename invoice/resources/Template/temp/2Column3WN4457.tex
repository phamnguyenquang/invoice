...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emilia Elizabeth 	 Nyberg} \\
		{\large Catherine 83}\\
		{\large 44415, Stuttgart, Guangzhou, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ruby Christopher Mårtensson Ltd } \\
		{\large Jackson 35}\\
		{\large 56281, Budapest, Bremen, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
