...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesus Pettersson Ltd} \\
		{\large Quinn 19}\\
		{\large 24295, Vancouver, Henan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Santiago Danielsson } \\
		{\large Serenity 30}\\
		{\large 89499, Frankfurt am Main , Kentucky, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
