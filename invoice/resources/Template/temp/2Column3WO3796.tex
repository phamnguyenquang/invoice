...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Camila John Hellström Pte Ltd} \\
		{\large Delilah 20}\\
		{\large 35634, Los Angeles, Amnat Charoen, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mckenzie Magnusson } \\
		{\large Blake 47}\\
		{\large 48312, Los Angeles, Guangdong, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
