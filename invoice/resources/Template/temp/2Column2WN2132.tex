...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jennifer Andreasson} \\
		{\large Aria 74}\\
		{\large 42875, Montreal, Chai Nat, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Malachi David Nordström Corp } \\
		{\large Christopher 36}\\
		{\large 13924, Florence, Texas, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
