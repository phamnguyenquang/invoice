...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaron Christopher Persson} \\
		{\large Sara 39}\\
		{\large 20915, Vienna, Kentucky, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariel Thomas Jansson Inc } \\
		{\large Norah 84}\\
		{\large 76082, Last Vegas, Henan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
