...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tyler Peter Andreasson Corp} \\
		{\large Emmanuel 34}\\
		{\large 66187, Shanghai, Tuscany, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Weston Henriksson } \\
		{\large Julia 2}\\
		{\large 84564, San Francisco, Hainan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
