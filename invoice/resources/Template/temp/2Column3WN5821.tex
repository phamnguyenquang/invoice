...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  William Anne Berg} \\
		{\large Ruby 78}\\
		{\large 52082, Frankfurt am Main , Hainan, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mary Elizabeth 	 Eliasson Pte Ltd } \\
		{\large Sarah 60}\\
		{\large 40487, Shanghai, Seattles, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
