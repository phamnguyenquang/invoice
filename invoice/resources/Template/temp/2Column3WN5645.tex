...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victor  Alexander  Hellström} \\
		{\large Carter 71}\\
		{\large 77345, Melbourne, Seattles, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lilly Victoria Nilsson Inc } \\
		{\large Amir 3}\\
		{\large 44844, Beijing, Amnat Charoen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
