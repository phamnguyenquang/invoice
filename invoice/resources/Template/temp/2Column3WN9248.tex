...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Victoria Öberg} \\
		{\large Genesis 98}\\
		{\large 76118, Montreal, Hessen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaliyah Kate 	 Bergqvist Inc } \\
		{\large Oliver 50}\\
		{\large 85070, Last Vegas, Guangzhou, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
