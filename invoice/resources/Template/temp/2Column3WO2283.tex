...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesse Christopher Johansson Ltd} \\
		{\large Valentina 21}\\
		{\large 36881, Frankfurt am Main , Texas, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melanie Eliasson } \\
		{\large Maya 85}\\
		{\large 61798, Hanoi, Amnat Charoen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
