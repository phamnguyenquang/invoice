...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hadley Victoria Olsson} \\
		{\large Adalyn 18}\\
		{\large 30264, Montreal, Seattles, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alana Anne Henriksson Ltd } \\
		{\large Isabel 52}\\
		{\large 86724, Abu Dhabi, Chiang Rai, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
