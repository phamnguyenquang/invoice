...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mya May/Mae 	 Lindström Pte Ltd} \\
		{\large Mark 87}\\
		{\large 10093, Last Vegas, Seattles, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Parker Fransson } \\
		{\large Jaxson 15}\\
		{\large 78198, Chicago, Binh Thuan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
