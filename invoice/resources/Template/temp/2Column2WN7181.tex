...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vivian Björklund} \\
		{\large Eliza 13}\\
		{\large 96189, London , Ang Thong, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Athena Rose 	 Andersson Inc } \\
		{\large Jonathan 55}\\
		{\large 24967, Los Angeles, Amnat Charoen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
