...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Scarlett Lindgren Pte Ltd} \\
		{\large Kaylee 14}\\
		{\large 61730, Washington, Hamburg, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Savannah Lundin } \\
		{\large Eliza 73}\\
		{\large 38458, Hong Kong, Chiang Mai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
