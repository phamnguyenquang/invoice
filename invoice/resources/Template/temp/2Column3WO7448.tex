...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sara Thomas Blomqvist Pte Ltd} \\
		{\large Eleanor 32}\\
		{\large 82619, Osaka, Bangkok, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kimberly Martinsson } \\
		{\large Lillian 69}\\
		{\large 86239, Frankfurt am Main , Chai Nat, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
