...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alana Edward Sundberg} \\
		{\large Grant 83}\\
		{\large 87075, Milan, Amnat Charoen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Peyton Rose 	 Martinsson Pte Ltd } \\
		{\large Xavier 49}\\
		{\large 33748, Los Angeles, Amnat Charoen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
