...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carter Löfgren} \\
		{\large Hudson 56}\\
		{\large 40752, Taipei, Guangdong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Declan  Alexander  Lundström Pte Ltd } \\
		{\large Juliana 61}\\
		{\large 45662, Paris, Guangdong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
