...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle Amy  Hellström} \\
		{\large Madeline 68}\\
		{\large 33328, Seoul, Guangzhou, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremiah Edward Arvidsson Pte Ltd } \\
		{\large Leilani 74}\\
		{\large 63599, Nha Trang, Ang Thong, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
