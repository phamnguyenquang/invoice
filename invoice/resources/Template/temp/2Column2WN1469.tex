...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rebecca Gunnarsson} \\
		{\large Logan 65}\\
		{\large 95894, Montreal, Hawaii, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joel Thomas Isaksson Inc } \\
		{\large Eliana 87}\\
		{\large 98490, Frankfurt am Main , Heibei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
