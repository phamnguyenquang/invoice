...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christian Robert Holmberg} \\
		{\large Alexa 21}\\
		{\large 40971, Frankfurt am Main , Bayern, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kimberly Thomas Johansson Ltd } \\
		{\large Preston 83}\\
		{\large 56106, Rome, Phu Yen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
