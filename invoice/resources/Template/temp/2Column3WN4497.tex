...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalyn Christopher Persson} \\
		{\large Bennett 42}\\
		{\large 91311, Budapest, Saarland, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucas Rose 	 Olsson Ltd } \\
		{\large Scarlett 60}\\
		{\large 78367, Hong Kong, Texas, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
