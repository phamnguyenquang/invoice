...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cooper  Alexander  Sandström Pte Ltd} \\
		{\large Summer 67}\\
		{\large 72946, Hong Kong, Henan, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremiah Lundström } \\
		{\large Alaina 92}\\
		{\large 72530, Frankfurt am Main , Seattles, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
