...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra William Nordström} \\
		{\large Jesse 74}\\
		{\large 26904, SaiGon, Buriam, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abraham Kate 	 Berggren Inc } \\
		{\large Levi 78}\\
		{\large 10960, Stuttgart, Amnat Charoen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
