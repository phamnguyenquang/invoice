...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juan Christopher Bengtsson} \\
		{\large Luca 51}\\
		{\large 44065, Vancouver, Binh Thuan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rachel Marie 	 Blomqvist Ltd } \\
		{\large Maria 20}\\
		{\large 20353, Dublin, Kentucky, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
