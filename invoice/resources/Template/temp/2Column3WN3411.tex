...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jessica Louise 	 Samuelsson} \\
		{\large Chloe 10}\\
		{\large 90951, San Francisco, Chiang Mai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camila Jane Jonsson Pte Ltd } \\
		{\large Isabel 54}\\
		{\large 75182, Hong Kong, Heibei, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
