...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caleb David Abrahamsson} \\
		{\large Kendall 91}\\
		{\large 11383, Vancouver, Chiang Rai, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Faith Anne Hellström Pte Ltd } \\
		{\large Katelyn 60}\\
		{\large 36681, Beijing, khanh Hoa, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
