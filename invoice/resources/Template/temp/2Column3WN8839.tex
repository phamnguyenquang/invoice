...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Landon Elizabeth 	 Eriksson} \\
		{\large Diego 56}\\
		{\large 31852, Barcelona, Huabei, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jake David Lundqvist Pte Ltd } \\
		{\large Emilia 3}\\
		{\large 33482, Hanoi, Amnat Charoen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
