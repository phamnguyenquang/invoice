...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lincoln Catherine  Claesson} \\
		{\large Riley 19}\\
		{\large 88400, San Francisco, Heibei, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mason Victoria Holmberg Pte Ltd } \\
		{\large Logan 96}\\
		{\large 84493, Boston, Guangzhou, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
