...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Louise 	 Isaksson} \\
		{\large Harrison 70}\\
		{\large 88687, Seoul, Seattles, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Louise 	 Lindgren Inc } \\
		{\large Eric 20}\\
		{\large 89876, Amsterdam, Saarland, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
