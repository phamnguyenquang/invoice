...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sadie Isaksson} \\
		{\large Asher 86}\\
		{\large 85429, Frankfurt am Main , Hamburg, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella Michael Lundqvist Corp } \\
		{\large Gabrielle 23}\\
		{\large 13998, Minsk, Saarland, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
