...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklynn Edward Magnusson} \\
		{\large Brandon 76}\\
		{\large 66659, Chicago, Floria, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kyle  Alexander  Jönsson Ltd } \\
		{\large Edward 75}\\
		{\large 24139, Tokyo, Hawaii, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
