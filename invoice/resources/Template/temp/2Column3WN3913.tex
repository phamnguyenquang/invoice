...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxson Rose 	 Blomqvist} \\
		{\large Gael 79}\\
		{\large 75724, San Francisco, Hainan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kayden John Andreasson Pte Ltd } \\
		{\large Christopher 46}\\
		{\large 52672, Denver, Heibei, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
