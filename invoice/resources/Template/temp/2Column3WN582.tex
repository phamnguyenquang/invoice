...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel Amy  Wikström} \\
		{\large Levi 97}\\
		{\large 37859, Hanoi, Chai Nat, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Clara David Samuelsson Corp } \\
		{\large Carter 40}\\
		{\large 17016, Frankfurt am Main , Henan, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
