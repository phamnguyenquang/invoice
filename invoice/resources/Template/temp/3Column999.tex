...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Tata Institute of Fundamental Research} \\
		{\large Lillian 2}\\
		{\large 21028, Frankfurt am Main , Henan, France }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Allison Åkesson } \\
		{\large Ian 85}\\
		{\large 83797, Dubai, Henan, South Africa }\\
    \switchcolumn
