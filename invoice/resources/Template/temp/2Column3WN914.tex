...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kenneth Elizabeth 	 Blom} \\
		{\large Lyla 44}\\
		{\large 25979, Last Vegas, California, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Louise 	 Johansson Ltd } \\
		{\large Avery 9}\\
		{\large 52938, Berlin, Phu Yen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
