...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla Kate 	 Hedlund Pte Ltd} \\
		{\large Alan 75}\\
		{\large 71676, Frankfurt am Main , Seattles, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caleb Söderberg } \\
		{\large Angel 18}\\
		{\large 51228, Ho Chi Minh, Chiang Rai, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
