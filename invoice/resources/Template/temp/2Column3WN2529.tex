...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Benjamin Anne Mattsson} \\
		{\large Amy 53}\\
		{\large 76301, Montreal, Amnat Charoen, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rachel Louise 	 Fredriksson Inc } \\
		{\large Leah 87}\\
		{\large 15094, Barcelona, Amnat Charoen, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
