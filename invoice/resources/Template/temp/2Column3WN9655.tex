...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gracie Robert Lundin} \\
		{\large Julian 12}\\
		{\large 97423, Munich, Hainan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Giovanni Mary 	 Hellström Pte Ltd } \\
		{\large Eli 19}\\
		{\large 72925, Los Angeles, Indiana, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
