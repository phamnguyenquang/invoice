...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Savannah Edward Henriksson} \\
		{\large Hadley 5}\\
		{\large 77548, San Francisco, Bangkok, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kevin William Sjöberg Ltd } \\
		{\large Lila 21}\\
		{\large 21468, Last Vegas, Guangzhou, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
