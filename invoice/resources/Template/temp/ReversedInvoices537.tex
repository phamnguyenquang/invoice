...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Norwegian University of Science and Technology} \\
		{\large Oscar 33}\\
		{\large 47584, Toronto, Hessen, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nora Jönsson } \\
		{\large Sophie 41}\\
		{\large 31622, Amsterdam, Hainan, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
