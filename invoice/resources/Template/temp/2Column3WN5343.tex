...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angel Kate 	 Andreasson} \\
		{\large Aubree 81}\\
		{\large 99840, Vancouver, Ang Thong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Weston Elizabeth 	 Björklund Ltd } \\
		{\large Hayden 13}\\
		{\large 98544, Barcelona, Heibei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
