...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Molly Elizabeth 	 Persson Pte Ltd} \\
		{\large Kayden 64}\\
		{\large 15969, San Francisco, Amnat Charoen, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kimberly Gunnarsson } \\
		{\large Wyatt 34}\\
		{\large 36799, London , Chiang Mai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
