...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Parker Grace 	 Wikström Inc} \\
		{\large Kevin 58}\\
		{\large 72413, Moscow, Texas, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryson Sandström } \\
		{\large Charlotte 85}\\
		{\large 37470, Frankfurt am Main , Bayern, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
