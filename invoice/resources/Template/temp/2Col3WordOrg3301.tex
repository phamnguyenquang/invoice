...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline  Alexander  Gunnarsson Pte Ltd} \\
		{\large Elena 20}\\
		{\large 97560, Bonn, Hainan, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leilani Fransson } \\
		{\large Carlos 73}\\
		{\large 41943, Nha Trang, Guangdong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
