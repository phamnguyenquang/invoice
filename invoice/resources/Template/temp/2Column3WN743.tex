...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity May/Mae 	 Axelsson} \\
		{\large Madelyn 96}\\
		{\large 56839, Berlin, Guangdong, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Quinn Christopher Söderberg Ltd } \\
		{\large Nolan 63}\\
		{\large 36629, Paris, Hawaii, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
