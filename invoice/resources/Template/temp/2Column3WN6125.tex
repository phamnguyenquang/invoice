...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexa Christopher Berggren} \\
		{\large Mya 97}\\
		{\large 74834, Last Vegas, Hessen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carson Louise 	 Lundgren Inc } \\
		{\large Hadley 30}\\
		{\large 10437, Frankfurt am Main , Floria, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
