...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carson Hellström} \\
		{\large Sean 15}\\
		{\large 60164, Ho Chi Minh, Guangdong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hayden Louise 	 Danielsson Corp } \\
		{\large Jace 22}\\
		{\large 98350, Hong Kong, Saarland, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
