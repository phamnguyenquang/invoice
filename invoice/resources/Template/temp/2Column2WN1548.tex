...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jacob Andreasson} \\
		{\large Khloe 61}\\
		{\large 90455, Frankfurt am Main , Heibei, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Arianna Elizabeth 	 Wikström Ltd } \\
		{\large Kaden 66}\\
		{\large 70862, Barcelona, khanh Hoa, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
