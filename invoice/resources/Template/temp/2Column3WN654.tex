...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grayson David Berg} \\
		{\large Paul 26}\\
		{\large 41116, Frankfurt am Main , khanh Hoa, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Taylor Louise 	 Sandström Inc } \\
		{\large Reese 65}\\
		{\large 41147, Hong Kong, Hainan, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
