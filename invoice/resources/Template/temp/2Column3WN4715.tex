...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brian Marie 	 Mårtensson} \\
		{\large Londyn 94}\\
		{\large 26078, Amsterdam, Amnat Charoen, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicole Christopher Söderberg Inc } \\
		{\large Giovanni 76}\\
		{\large 85411, Rome, Texas, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
