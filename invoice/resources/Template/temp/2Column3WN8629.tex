...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Victoria Hellström} \\
		{\large Luna 9}\\
		{\large 58931, Munich, Texas, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rose Robert Berggren Corp } \\
		{\large Maya 87}\\
		{\large 42788, Vancouver, Bremen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
