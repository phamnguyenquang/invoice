...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abraham Lee  Strömberg} \\
		{\large Kevin 14}\\
		{\large 33419, Nha Trang, Bangkok, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jude Elizabeth 	 Lindqvist Corp } \\
		{\large Ayden 48}\\
		{\large 81053, Lisbon, Chiang Mai, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
