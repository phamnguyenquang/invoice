...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adriana Elizabeth 	 Söderberg} \\
		{\large Jack 3}\\
		{\large 11062, Los Angeles, Saarland, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Levi John Jakobsson Inc } \\
		{\large Emmett 80}\\
		{\large 47153, Toronto, khanh Hoa, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
