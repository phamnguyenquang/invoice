...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victor Thomas Olsson} \\
		{\large Miguel 68}\\
		{\large 87518, Montreal, Guangdong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evan Marie 	 Holmgren Ltd } \\
		{\large Henry 92}\\
		{\large 68974, Vancouver, Bayern, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
