...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julianna David Nordström} \\
		{\large Stephanie 3}\\
		{\large 35936, Rome, Chiang Rai, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubree Marie 	 Pålsson Pte Ltd } \\
		{\large Alex 15}\\
		{\large 34832, Lisbon, Chiang Mai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
