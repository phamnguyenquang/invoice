...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melanie Anne Holmgren} \\
		{\large Caleb 48}\\
		{\large 80118, Moscow, Chiang Rai, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cooper Edward Henriksson Ltd } \\
		{\large John 38}\\
		{\large 54404, Los Angeles, Guangdong, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
