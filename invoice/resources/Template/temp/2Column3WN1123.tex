...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Noah Louise 	 Nordström} \\
		{\large Adeline 83}\\
		{\large 62027, Frankfurt am Main , Chiang Mai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maddox Lee  Lindberg Pte Ltd } \\
		{\large Audrey 75}\\
		{\large 29985, Ho Chi Minh, Bayern, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
