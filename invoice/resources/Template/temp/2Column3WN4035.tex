...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hannah Louise 	 Axelsson} \\
		{\large Braxton 14}\\
		{\large 40093, Ho Chi Minh, Binh Thuan, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sarah Amy  Samuelsson Corp } \\
		{\large Athena 82}\\
		{\large 94864, Frankfurt am Main , Huabei, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
