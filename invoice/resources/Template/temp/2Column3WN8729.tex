...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julianna Elizabeth 	 Olofsson} \\
		{\large Justin 65}\\
		{\large 82186, Amsterdam, Hessen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emilia John Gustafsson Corp } \\
		{\large Richard 98}\\
		{\large 82408, Osaka, Indiana, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
