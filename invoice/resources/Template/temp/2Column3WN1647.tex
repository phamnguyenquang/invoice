...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valentina Amy  Söderberg} \\
		{\large Cayden 31}\\
		{\large 77410, Melbourne, Guangzhou, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lily Christopher Wallin Pte Ltd } \\
		{\large Eva 77}\\
		{\large 29606, Hong Kong, Hawaii, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
