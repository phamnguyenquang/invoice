...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sarah  Alexander  Andreasson} \\
		{\large John 63}\\
		{\large 61494, Singapore, Amnat Charoen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Santiago Elizabeth 	 Berglund Corp } \\
		{\large Harper 25}\\
		{\large 57834, Seoul, Floria, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
