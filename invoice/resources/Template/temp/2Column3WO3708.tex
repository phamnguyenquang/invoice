...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hayden Victoria Berg Pte Ltd} \\
		{\large Jose 4}\\
		{\large 99776, Frankfurt am Main , Chiang Rai, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklyn Andersson } \\
		{\large Stella 30}\\
		{\large 60755, Montreal, Saarland, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
