...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julian Grace 	 Nordström Ltd} \\
		{\large Isabel 38}\\
		{\large 49683, Paris, Kentucky, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brielle Nilsson } \\
		{\large Alexa 45}\\
		{\large 51266, Frankfurt am Main , Buriam, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
