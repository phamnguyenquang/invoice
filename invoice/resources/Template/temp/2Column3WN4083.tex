...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Axel Christopher Lundgren} \\
		{\large Savannah 5}\\
		{\large 53847, Dublin, Chai Nat, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubree Catherine  Gunnarsson Ltd } \\
		{\large Quinn 56}\\
		{\large 21424, Paris, Huabei, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
