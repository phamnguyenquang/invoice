...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla Rose 	 Abrahamsson} \\
		{\large Emmanuel 85}\\
		{\large 64479, Paris, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elizabeth Edward Jonsson Inc } \\
		{\large Parker 38}\\
		{\large 56957, Washington, Chiang Rai, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
