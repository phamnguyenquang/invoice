...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katherine Christopher Magnusson} \\
		{\large Christopher 85}\\
		{\large 87071, Milan, Kentucky, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anthony Anne Jakobsson Pte Ltd } \\
		{\large Alexandra 50}\\
		{\large 94292, Chicago, Phu Yen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
