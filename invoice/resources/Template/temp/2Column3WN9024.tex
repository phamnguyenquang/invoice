...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bailey Edward Bergqvist} \\
		{\large Nolan 54}\\
		{\large 86649, Melbourne, Phu Yen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aria Edward Lindholm Pte Ltd } \\
		{\large Hannah 25}\\
		{\large 20758, Seoul, Amnat Charoen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
