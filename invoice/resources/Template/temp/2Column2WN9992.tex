...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexis Gunnarsson} \\
		{\large Benjamin 92}\\
		{\large 34578, Singapore, Binh Thuan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonah Christopher Wallin Ltd } \\
		{\large Mckenzie 16}\\
		{\large 43727, Frankfurt am Main , Chai Nat, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
