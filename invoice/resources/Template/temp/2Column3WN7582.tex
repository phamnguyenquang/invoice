...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Thomas Victoria Hermansson} \\
		{\large Jace 95}\\
		{\large 29599, Hong Kong, California, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Patrick Edward Eklund Corp } \\
		{\large Scarlett 31}\\
		{\large 93582, Rome, Tuscany, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
