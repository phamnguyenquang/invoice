...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lucas Peter Åberg Pte Ltd} \\
		{\large Noah 20}\\
		{\large 92080, Frankfurt am Main , Buriam, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Londyn Sjögren } \\
		{\large Henry 72}\\
		{\large 15195, Berlin, Heibei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
