...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Clara Anne Sjögren} \\
		{\large Connor 57}\\
		{\large 25958, Taipei, Binh Thuan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryson Catherine  Mårtensson Pte Ltd } \\
		{\large Jaxson 45}\\
		{\large 64991, San Francisco, Tuscany, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
