...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harrison Michael Hansson Corp} \\
		{\large Colton 84}\\
		{\large 49900, Montreal, Binh Thuan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carlos Eriksson } \\
		{\large Hazel 36}\\
		{\large 84778, Abu Dhabi, Hawaii, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
