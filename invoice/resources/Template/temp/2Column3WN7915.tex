...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hudson Grace 	 Ekström} \\
		{\large Graham 57}\\
		{\large 51703, Istanbul, Hamburg, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ava Lee  Gustafsson Pte Ltd } \\
		{\large Aubrey 92}\\
		{\large 88916, Frankfurt am Main , Saarland, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
