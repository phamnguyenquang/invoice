...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madison  Alexander  Larsson Inc} \\
		{\large Gabriella 75}\\
		{\large 17558, Abu Dhabi, Amnat Charoen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore Gunnarsson } \\
		{\large Jaxon 75}\\
		{\large 74734, SaiGon, Chiang Rai, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
