...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonathan David Arvidsson Pte Ltd} \\
		{\large Thomas 45}\\
		{\large 37840, Denver, Amnat Charoen, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryleigh Gunnarsson } \\
		{\large Calvin 20}\\
		{\large 73150, Singapore, Chiang Mai, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
