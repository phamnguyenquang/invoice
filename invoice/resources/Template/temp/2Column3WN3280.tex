...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mason Catherine  Eriksson} \\
		{\large Ryan 42}\\
		{\large 12551, Seoul, khanh Hoa, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jason Mary 	 Ahmed Ltd } \\
		{\large Kaden 94}\\
		{\large 24154, Ho Chi Minh, Guangdong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
