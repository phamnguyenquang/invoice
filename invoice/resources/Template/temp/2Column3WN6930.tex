...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liam Mary 	 Berggren} \\
		{\large Tristan 90}\\
		{\large 22958, Beijing, Henan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Molly David Persson Pte Ltd } \\
		{\large Mckenzie 1}\\
		{\large 24649, Frankfurt am Main , Bangkok, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
