...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katherine Louise 	 Wikström Inc} \\
		{\large Max 66}\\
		{\large 91324, Seoul, Binh Thuan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabrielle Axelsson } \\
		{\large Daniela 65}\\
		{\large 25457, Frankfurt am Main , Floria, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
