...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryan Sundberg} \\
		{\large David 52}\\
		{\large 72124, Frankfurt am Main , Chiang Rai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jake James Strömberg Pte Ltd } \\
		{\large Allison 82}\\
		{\large 57154, Vienna, Bayern, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
