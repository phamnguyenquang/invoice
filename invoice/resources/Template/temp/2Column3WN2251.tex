...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Noah Edward Martinsson} \\
		{\large Adalyn 83}\\
		{\large 50018, Vancouver, Tuscany, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Robert May/Mae 	 Pålsson Ltd } \\
		{\large Chase 18}\\
		{\large 17799, San Francisco, Guangdong, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
