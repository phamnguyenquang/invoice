...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hazel Elizabeth 	 Olofsson Pte Ltd} \\
		{\large Savannah 10}\\
		{\large 20510, Istanbul, Chiang Mai, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Margaret Löfgren } \\
		{\large Tucker 82}\\
		{\large 76600, Denver, Guangzhou, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
