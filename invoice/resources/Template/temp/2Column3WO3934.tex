...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bentley James Gustafsson Pte Ltd} \\
		{\large Gracie 76}\\
		{\large 55618, Frankfurt am Main , Henan, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brianna Claesson } \\
		{\large Sawyer 16}\\
		{\large 99905, Singapore, Indiana, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
