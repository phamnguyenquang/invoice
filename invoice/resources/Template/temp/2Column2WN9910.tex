...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalie Arvidsson} \\
		{\large Ryker 73}\\
		{\large 51915, Montreal, Hessen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalia  Alexander  Olsson Pte Ltd } \\
		{\large Evan 95}\\
		{\large 89099, Nha Trang, Hessen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
