...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Anthony David Andersson Inc} \\
		{\large Adrian 72}\\
		{\large 75087, Shanghai, khanh Hoa, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mackenzie Abrahamsson } \\
		{\large Aria 73}\\
		{\large 79516, Frankfurt am Main , Hessen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
