...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Payton May/Mae 	 Ekström} \\
		{\large Adrian 1}\\
		{\large 27339, Melbourne, Bayern, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emily John Lindqvist Pte Ltd } \\
		{\large Aria 87}\\
		{\large 28094, San Francisco, Tuscany, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
