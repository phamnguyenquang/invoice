...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Piper Olofsson Corp} \\
		{\large Brady 68}\\
		{\large 58412, Frankfurt am Main , Hessen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalyn Pettersson } \\
		{\large Connor 73}\\
		{\large 28368, Los Angeles, khanh Hoa, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
