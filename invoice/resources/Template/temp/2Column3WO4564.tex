...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall Victoria Nordin Ltd} \\
		{\large David 95}\\
		{\large 71740, Frankfurt am Main , Hawaii, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stella Lundqvist } \\
		{\large Gabriel 88}\\
		{\large 70297, Last Vegas, Huabei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
