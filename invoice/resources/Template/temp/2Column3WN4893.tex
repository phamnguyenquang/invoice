...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Quinn Elizabeth 	 Mohamed} \\
		{\large Alexander 19}\\
		{\large 77633, Istanbul, Bangkok, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maria Christopher Magnusson Pte Ltd } \\
		{\large Maria 83}\\
		{\large 32555, Florence, Amnat Charoen, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
