...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michael Louise 	 Arvidsson} \\
		{\large Bennett 85}\\
		{\large 91862, Rome, Kentucky, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hudson Louise 	 Gustafsson Corp } \\
		{\large Juan 52}\\
		{\large 12954, Berlin, Guangdong, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
