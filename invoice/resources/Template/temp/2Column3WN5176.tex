...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tyler Mary 	 Lindström} \\
		{\large Makenzie 20}\\
		{\large 77805, Taipei, Chai Nat, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Levi  Alexander  Fredriksson Inc } \\
		{\large Jonathan 94}\\
		{\large 70469, Frankfurt am Main , Guangdong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
