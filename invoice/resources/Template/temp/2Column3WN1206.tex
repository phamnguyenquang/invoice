...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vivian Catherine  Danielsson} \\
		{\large Mila 96}\\
		{\large 54542, Denver, Floria, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adrian Michael Löfgren Pte Ltd } \\
		{\large Jeremiah 85}\\
		{\large 43152, Dubai, Amnat Charoen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
