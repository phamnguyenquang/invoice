...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Summer Michael Dahl} \\
		{\large Parker 8}\\
		{\large 19927, Boston, Heibei, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elise Robert Fredriksson Corp } \\
		{\large Marcus 19}\\
		{\large 34557, Frankfurt am Main , Texas, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
