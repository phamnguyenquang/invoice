...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  South China Agricultural University} \\
		{\large Tucker 98}\\
		{\large 23976, Florence, Chiang Rai, United State }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Hunter Forsberg } \\
		{\large Ellie 27}\\
		{\large 88359, Boston, Indiana, Argentina }\\
    \switchcolumn
