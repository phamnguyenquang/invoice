...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  King Catherine  Abrahamsson Ltd} \\
		{\large Jonathan 68}\\
		{\large 11659, Boston, Seattles, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ella Fredriksson } \\
		{\large Weston 81}\\
		{\large 43298, Shanghai, khanh Hoa, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
