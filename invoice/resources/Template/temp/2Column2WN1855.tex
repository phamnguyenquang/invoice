...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaliyah Olofsson} \\
		{\large Jackson 65}\\
		{\large 13906, Singapore, Chiang Rai, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy Christopher Wikström Corp } \\
		{\large Valeria 30}\\
		{\large 80617, Washington, khanh Hoa, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
