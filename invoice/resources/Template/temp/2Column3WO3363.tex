...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaylee Catherine  Håkansson Pte Ltd} \\
		{\large Isla 9}\\
		{\large 72919, Vienna, Hessen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vincent Öberg } \\
		{\large Miles 81}\\
		{\large 14237, Frankfurt am Main , Hamburg, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
