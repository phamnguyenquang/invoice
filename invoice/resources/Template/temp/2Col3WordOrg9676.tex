...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elijah Christopher Lindström Pte Ltd} \\
		{\large Adriana 53}\\
		{\large 62712, San Francisco, Floria, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jasmine Nilsson } \\
		{\large Skylar 79}\\
		{\large 40954, Istanbul, Hamburg, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
