...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Richard Peter Björk Pte Ltd} \\
		{\large Rylee 73}\\
		{\large 36009, Toronto, California, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zoey Lundgren } \\
		{\large Katelyn 7}\\
		{\large 12735, Frankfurt am Main , Amnat Charoen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
