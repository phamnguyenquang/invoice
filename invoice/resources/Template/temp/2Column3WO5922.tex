...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Reagan Victoria Martinsson Pte Ltd} \\
		{\large Ryker 61}\\
		{\large 22415, Berlin, California, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella Persson } \\
		{\large Gianna 89}\\
		{\large 78832, Nha Trang, California, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
