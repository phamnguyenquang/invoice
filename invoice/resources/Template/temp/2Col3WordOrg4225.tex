...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles Louise 	 Lund Corp} \\
		{\large Oliver 34}\\
		{\large 62930, Frankfurt am Main , California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooke Ekström } \\
		{\large Robert 62}\\
		{\large 71630, Madrid, Bangkok, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
