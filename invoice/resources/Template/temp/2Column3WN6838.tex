...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Edward Nilsson} \\
		{\large Brayden 69}\\
		{\large 83184, Montreal, Guangdong, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas Catherine  Olsson Pte Ltd } \\
		{\large Riley 41}\\
		{\large 77446, SaiGon, Amnat Charoen, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
