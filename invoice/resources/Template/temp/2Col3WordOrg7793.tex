...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria Elizabeth 	 Lindholm Pte Ltd} \\
		{\large Elias 67}\\
		{\large 96171, Moscow, Amnat Charoen, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gracie Holmgren } \\
		{\large Colton 8}\\
		{\large 18251, Toronto, Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
