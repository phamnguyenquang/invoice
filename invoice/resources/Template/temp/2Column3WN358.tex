...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rose Marie 	 Dahlberg} \\
		{\large Diego 60}\\
		{\large 25845, Frankfurt am Main , Hessen, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valeria May/Mae 	 Lindberg Corp } \\
		{\large Peyton 12}\\
		{\large 60130, Denver, Seattles, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
