...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brianna Anne Danielsson Pte Ltd} \\
		{\large John 9}\\
		{\large 63838, Frankfurt am Main , Phu Yen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lincoln Olsson } \\
		{\large Jennifer 18}\\
		{\large 83919, Vancouver, Bayern, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
