...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Riley Lee  Hellström} \\
		{\large Paige 6}\\
		{\large 53225, SaiGon, Bremen, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sean Rose 	 Eklund Pte Ltd } \\
		{\large Juan 32}\\
		{\large 75119, Frankfurt am Main , Chiang Rai, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
