...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lydia Lindström} \\
		{\large Aliyah 8}\\
		{\large 54046, Frankfurt am Main , Buriam, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elena Christopher Hansen Ltd } \\
		{\large Ezra 35}\\
		{\large 74493, Stuttgart, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
