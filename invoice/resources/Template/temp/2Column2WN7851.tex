...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Riley Fredriksson} \\
		{\large Jade 42}\\
		{\large 92079, Frankfurt am Main , Chai Nat, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julian Edward Lund Pte Ltd } \\
		{\large Rylee 53}\\
		{\large 53298, Hanoi, Chiang Mai, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
