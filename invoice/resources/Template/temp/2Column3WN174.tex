...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon John Mårtensson} \\
		{\large Caleb 14}\\
		{\large 42951, San Francisco, Chiang Rai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Jane Holmgren Pte Ltd } \\
		{\large Adalynn 43}\\
		{\large 68370, Seoul, Seattles, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
