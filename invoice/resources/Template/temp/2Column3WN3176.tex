...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall Marie 	 Nyström} \\
		{\large Isabelle 93}\\
		{\large 79256, Dublin, Bremen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas William Fransson Inc } \\
		{\large Victor 1}\\
		{\large 96608, Frankfurt am Main , Bayern, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
