...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrea John Hellström} \\
		{\large Gianna 91}\\
		{\large 84706, Berlin, Chai Nat, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrea Louise 	 Svensson Corp } \\
		{\large Angel 46}\\
		{\large 51390, Denver, Binh Thuan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
