...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juan  Alexander  Pettersson} \\
		{\large Tyler 87}\\
		{\large 86919, Amsterdam, Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alana Rose 	 Hellström Inc } \\
		{\large Amelia 30}\\
		{\large 69954, San Francisco, Bremen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
