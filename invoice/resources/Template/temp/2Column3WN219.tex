...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryson Grace 	 Berggren} \\
		{\large Weston 40}\\
		{\large 89551, Los Angeles, Guangzhou, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabel Marie 	 Ahmed Corp } \\
		{\large Arianna 64}\\
		{\large 58081, Frankfurt am Main , Buriam, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
