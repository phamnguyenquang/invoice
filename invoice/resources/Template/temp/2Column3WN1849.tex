...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  London Lee  Karlsson} \\
		{\large Ashton 36}\\
		{\large 90892, Sydney, Amnat Charoen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Weston Elizabeth 	 Nordström Corp } \\
		{\large Eli 45}\\
		{\large 10657, Washington, Indiana, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
