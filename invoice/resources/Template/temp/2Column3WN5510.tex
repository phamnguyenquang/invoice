...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie David Pettersson} \\
		{\large Jeremy 90}\\
		{\large 28051, Nha Trang, Guangzhou, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrea  Alexander  Karlsson Pte Ltd } \\
		{\large Oliver 3}\\
		{\large 26513, Lisbon, Floria, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
