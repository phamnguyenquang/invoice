...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Payton  Alexander  Abrahamsson} \\
		{\large Gavin 84}\\
		{\large 68645, New York , Hamburg, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Colton John Bergström Ltd } \\
		{\large Hayden 55}\\
		{\large 75958, Montreal, Binh Thuan, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
