...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dominic James Hansen Corp} \\
		{\large Sean 71}\\
		{\large 59218, Washington, Ang Thong, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julian Samuelsson } \\
		{\large Charles 31}\\
		{\large 96765, San Francisco, khanh Hoa, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
