...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklyn Anne Nordström Corp} \\
		{\large Kenneth 76}\\
		{\large 80171, SaiGon, Chiang Rai, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Chloe Nilsson } \\
		{\large Jameson 41}\\
		{\large 93065, Frankfurt am Main , Ang Thong, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
