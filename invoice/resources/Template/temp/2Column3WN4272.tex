...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalie Grace 	 Hermansson} \\
		{\large Violet 57}\\
		{\large 67569, Shanghai, Hessen, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmett Anne Månsson Pte Ltd } \\
		{\large Catherine 58}\\
		{\large 72702, Frankfurt am Main , Heibei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
