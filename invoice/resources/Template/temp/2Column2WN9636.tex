...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mason Samuelsson} \\
		{\large Alexandra 12}\\
		{\large 82857, Florence, California, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Anne Wikström Pte Ltd } \\
		{\large Kennedy 13}\\
		{\large 42179, Frankfurt am Main , Texas, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
