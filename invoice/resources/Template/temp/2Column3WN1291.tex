...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ivan Lee  Abrahamsson} \\
		{\large Mia 15}\\
		{\large 22212, Barcelona, Indiana, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Destiny Grace 	 Nordström Pte Ltd } \\
		{\large Zoe 72}\\
		{\large 58841, Nha Trang, Amnat Charoen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
