...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Morgan May/Mae 	 Forsberg} \\
		{\large Anna 32}\\
		{\large 19906, Paris, Bremen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalyn Marie 	 Eriksson Inc } \\
		{\large Miguel 13}\\
		{\large 24503, Frankfurt am Main , Guangzhou, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
