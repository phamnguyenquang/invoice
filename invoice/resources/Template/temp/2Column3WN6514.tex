...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abraham Michael Strömberg} \\
		{\large Ashley 68}\\
		{\large 30738, Berlin, Guangdong, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jasmine Michael Lundgren Pte Ltd } \\
		{\large John 13}\\
		{\large 73947, Singapore, Chiang Mai, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
