...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Naomi Christopher Nyström} \\
		{\large Edward 67}\\
		{\large 34253, Taipei, Hamburg, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wyatt Elizabeth 	 Nyberg Pte Ltd } \\
		{\large Angelina 30}\\
		{\large 74965, Sydney, Amnat Charoen, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
