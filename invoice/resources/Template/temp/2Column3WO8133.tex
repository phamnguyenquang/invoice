...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Braxton Victoria Karlsson Pte Ltd} \\
		{\large Margaret 13}\\
		{\large 46125, Hanoi, Chai Nat, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gianna Engström } \\
		{\large Jesse 87}\\
		{\large 42974, Vancouver, Guangdong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
