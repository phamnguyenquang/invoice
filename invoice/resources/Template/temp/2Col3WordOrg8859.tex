...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Connor Victoria Wikström Ltd} \\
		{\large Miguel 13}\\
		{\large 87385, Ho Chi Minh, Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Faith Nilsson } \\
		{\large Brooklynn 19}\\
		{\large 88619, Los Angeles, Ang Thong, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
