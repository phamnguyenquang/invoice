...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sophie William Hansson} \\
		{\large Addison 84}\\
		{\large 79941, San Francisco, Chiang Rai, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrew Lee  Lundgren Ltd } \\
		{\large Anna 69}\\
		{\large 61379, Rome, Phu Yen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
