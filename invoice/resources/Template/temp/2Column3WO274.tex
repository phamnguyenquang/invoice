...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Calvin Elizabeth 	 Blomqvist Pte Ltd} \\
		{\large Angelina 4}\\
		{\large 82860, Barcelona, Bayern, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie Sandström } \\
		{\large London 11}\\
		{\large 40306, San Francisco, Tuscany, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
