...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  King Elizabeth 	 Bengtsson Pte Ltd} \\
		{\large Josiah 23}\\
		{\large 67167, Washington, California, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Dylan Mårtensson } \\
		{\large Maddox 11}\\
		{\large 51452, Budapest, Guangdong, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
