...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariana Amy  Bergström Pte Ltd} \\
		{\large David 39}\\
		{\large 45470, Abu Dhabi, Ang Thong, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Annabelle Andersson } \\
		{\large Bryan 38}\\
		{\large 86552, Montreal, Saarland, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
