...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dominic Thomas Lindberg} \\
		{\large Gabriella 89}\\
		{\large 26341, Frankfurt am Main , Kentucky, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella Christopher Jakobsson Inc } \\
		{\large Eliza 70}\\
		{\large 87507, San Francisco, Bangkok, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
