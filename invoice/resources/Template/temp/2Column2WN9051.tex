...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Easton Sandström} \\
		{\large Jaxon 68}\\
		{\large 98944, Madrid, Seattles, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gael Catherine  Danielsson Corp } \\
		{\large Emery 6}\\
		{\large 88004, Montreal, Chiang Rai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
