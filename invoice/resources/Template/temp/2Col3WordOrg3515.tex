...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Greyson Jane Holmberg Corp} \\
		{\large Luis 3}\\
		{\large 99654, Frankfurt am Main , Floria, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evelyn Åkesson } \\
		{\large Tristan 47}\\
		{\large 51108, Frankfurt am Main , Chai Nat, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
