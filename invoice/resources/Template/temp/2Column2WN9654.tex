...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valentina Sjögren} \\
		{\large Patrick 63}\\
		{\large 95430, Munich, Binh Thuan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley  Alexander  Magnusson Corp } \\
		{\large Lucy 76}\\
		{\large 36444, Beijing, Henan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
