...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Diego William Fransson} \\
		{\large Melanie 8}\\
		{\large 22398, SaiGon, Amnat Charoen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brayden Thomas Ahmed Pte Ltd } \\
		{\large Summer 48}\\
		{\large 81623, Chicago, khanh Hoa, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
