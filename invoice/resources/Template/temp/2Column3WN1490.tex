...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bennett David Gustafsson} \\
		{\large Faith 88}\\
		{\large 82737, Melbourne, Guangzhou, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie Anne Danielsson Pte Ltd } \\
		{\large Juan 26}\\
		{\large 33622, San Francisco, Hamburg, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
