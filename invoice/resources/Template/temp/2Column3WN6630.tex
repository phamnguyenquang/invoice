...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Santiago Mary 	 Danielsson} \\
		{\large Molly 55}\\
		{\large 57546, Minsk, Floria, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie Elizabeth 	 Lundberg Inc } \\
		{\large Michael 93}\\
		{\large 22391, Budapest, Bremen, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
