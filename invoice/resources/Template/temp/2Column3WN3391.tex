...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Wesley Catherine  Hellström} \\
		{\large Greyson 96}\\
		{\large 50948, Minsk, Hawaii, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmett Grace 	 Eriksson Ltd } \\
		{\large Violet 28}\\
		{\large 65296, Shanghai, Chiang Rai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
