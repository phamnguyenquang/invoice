...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Audrey John Samuelsson} \\
		{\large Elias 23}\\
		{\large 80679, Los Angeles, Bayern, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Izabella Rose 	 Wikström Corp } \\
		{\large Maxwell 45}\\
		{\large 58975, Moscow, Hainan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
