...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nevaeh David Arvidsson} \\
		{\large Lily 43}\\
		{\large 52161, Frankfurt am Main , Heibei, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryan James Claesson Pte Ltd } \\
		{\large Isaiah 75}\\
		{\large 42190, Paris, Buriam, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
