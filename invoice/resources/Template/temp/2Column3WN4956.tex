...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Richard Mary 	 Sandström} \\
		{\large Jordan 69}\\
		{\large 63294, Lisbon, Ang Thong, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maddox Victoria Bergström Corp } \\
		{\large Carter 69}\\
		{\large 89472, Minsk, California, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
