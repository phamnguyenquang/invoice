...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stephanie Sjöberg Pte Ltd} \\
		{\large Vincent 44}\\
		{\large 68389, Frankfurt am Main , Amnat Charoen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samantha Sandström } \\
		{\large Jose 61}\\
		{\large 80626, Melbourne, Guangzhou, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
