...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro Louise 	 Forsberg} \\
		{\large Jameson 68}\\
		{\large 66774, Toronto, Chiang Mai, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aurora May/Mae 	 Johansson Pte Ltd } \\
		{\large Bailey 87}\\
		{\large 27452, Vancouver, Huabei, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
