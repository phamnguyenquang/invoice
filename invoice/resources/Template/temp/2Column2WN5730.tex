...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liliana Lundström} \\
		{\large Cayden 31}\\
		{\large 89813, Stuttgart, Phu Yen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jack Edward Nyberg Corp } \\
		{\large Autumn 24}\\
		{\large 43434, Frankfurt am Main , Seattles, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
