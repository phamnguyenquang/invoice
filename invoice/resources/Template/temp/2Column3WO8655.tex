...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Justin Christopher Lindqvist Pte Ltd} \\
		{\large Weston 5}\\
		{\large 79970, Frankfurt am Main , Phu Yen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Steven Månsson } \\
		{\large Adriana 85}\\
		{\large 85544, New York , Phu Yen, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
