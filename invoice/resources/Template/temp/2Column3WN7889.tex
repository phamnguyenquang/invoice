...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Athena Elizabeth 	 Isaksson} \\
		{\large Leonardo 1}\\
		{\large 51674, Last Vegas, Guangzhou, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Naomi Thomas Danielsson Corp } \\
		{\large Nevaeh 17}\\
		{\large 20024, New York , Chai Nat, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
