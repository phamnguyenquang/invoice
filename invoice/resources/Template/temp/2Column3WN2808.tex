...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kevin Marie 	 Pettersson} \\
		{\large Victor 50}\\
		{\large 36815, Budapest, Heibei, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paisley Mary 	 Ali Pte Ltd } \\
		{\large Angel 24}\\
		{\large 28297, Barcelona, Saarland, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
