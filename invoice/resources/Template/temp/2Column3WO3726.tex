...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall David Pålsson Pte Ltd} \\
		{\large Alana 56}\\
		{\large 15653, Frankfurt am Main , Floria, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hannah Söderberg } \\
		{\large Lillian 4}\\
		{\large 47121, Budapest, khanh Hoa, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
