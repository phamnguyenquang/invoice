...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Greyson Ann  Karlsson Ltd} \\
		{\large Kinsley 45}\\
		{\large 13038, Ho Chi Minh, Indiana, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harper Viklund } \\
		{\large Ryleigh 55}\\
		{\large 47991, Los Angeles, Binh Thuan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
