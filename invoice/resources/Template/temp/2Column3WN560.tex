...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lillian Jane Arvidsson} \\
		{\large Kyle 22}\\
		{\large 64038, Toronto, Huabei, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian Mary 	 Björklund Pte Ltd } \\
		{\large Anthony 35}\\
		{\large 57546, Frankfurt am Main , Chai Nat, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
