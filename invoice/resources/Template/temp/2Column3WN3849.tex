...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elise Grace 	 Lundström} \\
		{\large Margaret 93}\\
		{\large 53012, Abu Dhabi, Bayern, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalia Robert Fredriksson Corp } \\
		{\large Hannah 18}\\
		{\large 50253, Vancouver, California, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
