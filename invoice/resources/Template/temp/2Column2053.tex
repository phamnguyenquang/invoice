...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Antonio Holmgren Pte Ltd} \\
		{\large Alan 38}\\
		{\large 19654, Frankfurt am Main , Hawaii, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Antonio Axelsson } \\
		{\large Jordan 17}\\
		{\large 68564, Berlin, Binh Thuan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
