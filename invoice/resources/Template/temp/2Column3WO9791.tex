...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michael Anne Blom Pte Ltd} \\
		{\large Londyn 77}\\
		{\large 76669, Frankfurt am Main , Bangkok, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore Samuelsson } \\
		{\large Jaden 91}\\
		{\large 24722, Melbourne, California, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
