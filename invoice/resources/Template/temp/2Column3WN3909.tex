...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alana Marie 	 Lindqvist} \\
		{\large Ezra 35}\\
		{\large 60958, Washington, Buriam, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mateo Robert Fransson Corp } \\
		{\large Edward 54}\\
		{\large 25541, Last Vegas, Guangzhou, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
