...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michael Marie 	 Wallin Ltd} \\
		{\large Easton 62}\\
		{\large 85067, Frankfurt am Main , California, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tyler Åkesson } \\
		{\large Brielle 48}\\
		{\large 56604, Frankfurt am Main , Huabei, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
