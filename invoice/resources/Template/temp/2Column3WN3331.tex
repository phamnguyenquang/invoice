...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Summer  Alexander  Jansson} \\
		{\large Riley 35}\\
		{\large 57213, Stuttgart, Texas, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large James Lee  Lund Pte Ltd } \\
		{\large Sebastian 83}\\
		{\large 11403, Taipei, Chiang Mai, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
