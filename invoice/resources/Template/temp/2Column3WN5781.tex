...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melody  Alexander  Wallin} \\
		{\large John 36}\\
		{\large 22957, Barcelona, Floria, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sean Louise 	 Håkansson Pte Ltd } \\
		{\large Katelyn 23}\\
		{\large 88517, Lisbon, Guangzhou, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
