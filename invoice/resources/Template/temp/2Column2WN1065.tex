...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Andersson} \\
		{\large Layla 83}\\
		{\large 99696, Los Angeles, Bangkok, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large George Jane Ek Ltd } \\
		{\large Mckenzie 16}\\
		{\large 16065, Frankfurt am Main , Saarland, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
