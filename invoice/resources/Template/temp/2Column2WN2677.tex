...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Samuel Lindholm} \\
		{\large Victor 49}\\
		{\large 25607, San Francisco, Hamburg, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmanuel Christopher Fransson Pte Ltd } \\
		{\large Tyler 41}\\
		{\large 55489, Singapore, Tuscany, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
