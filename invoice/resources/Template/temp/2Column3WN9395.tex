...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joseph Edward Jakobsson} \\
		{\large Ayden 53}\\
		{\large 40797, Stuttgart, Heibei, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melanie Grace 	 Eliasson Ltd } \\
		{\large Alexander 16}\\
		{\large 83850, Beijing, Heibei, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
