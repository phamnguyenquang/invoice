...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ellie Holmgren} \\
		{\large Emma 8}\\
		{\large 99240, Frankfurt am Main , Chiang Mai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Savannah Michael Lindqvist Corp } \\
		{\large Lincoln 88}\\
		{\large 43931, Paris, Guangzhou, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
