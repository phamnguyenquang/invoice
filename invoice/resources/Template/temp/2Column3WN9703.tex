...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ruby May/Mae 	 Engström} \\
		{\large Brooke 78}\\
		{\large 46031, Osaka, Hawaii, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher  Alexander  Dahlberg Inc } \\
		{\large Brody 77}\\
		{\large 53264, Dubai, Ang Thong, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
