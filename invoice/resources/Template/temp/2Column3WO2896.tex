...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nevaeh Marie 	 Lindberg Ltd} \\
		{\large Maddox 69}\\
		{\large 74466, Nha Trang, Tuscany, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jace Hansen } \\
		{\large Sofia 5}\\
		{\large 48644, Frankfurt am Main , Saarland, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
