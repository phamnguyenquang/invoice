...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Faith Rose 	 Åberg} \\
		{\large Alexander 65}\\
		{\large 50105, Barcelona, Kentucky, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon Louise 	 Blomqvist Inc } \\
		{\large Luis 16}\\
		{\large 77419, Barcelona, Chiang Mai, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
