...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kenneth Grace 	 Norberg Corp} \\
		{\large Samantha 23}\\
		{\large 46706, Frankfurt am Main , Ang Thong, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriel Mattsson } \\
		{\large Nathan 41}\\
		{\large 72422, Budapest, Hessen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
