...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayce Victoria Sandström Inc} \\
		{\large Isla 26}\\
		{\large 23585, Washington, Chiang Rai, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Victor Wikström } \\
		{\large Gabriella 52}\\
		{\large 13736, Frankfurt am Main , Heibei, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
