...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Easton Victoria Fransson} \\
		{\large Elias 38}\\
		{\large 89588, Frankfurt am Main , khanh Hoa, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jack William Lundgren Pte Ltd } \\
		{\large Robert 47}\\
		{\large 93032, Frankfurt am Main , Texas, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
