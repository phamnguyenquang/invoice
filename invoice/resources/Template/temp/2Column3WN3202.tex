...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jennifer Catherine  Pålsson} \\
		{\large Tristan 64}\\
		{\large 79483, Milan, Hainan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklyn Mary 	 Hassan Ltd } \\
		{\large Ruby 11}\\
		{\large 65101, Frankfurt am Main , Heibei, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
