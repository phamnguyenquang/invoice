...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abigail William Engström Inc} \\
		{\large Samantha 96}\\
		{\large 61755, Osaka, Hessen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bradley Jakobsson } \\
		{\large Brantley 2}\\
		{\large 15226, Frankfurt am Main , Amnat Charoen, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
