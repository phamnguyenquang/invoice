...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity Victoria Samuelsson} \\
		{\large Eli 82}\\
		{\large 44623, Melbourne, Guangdong, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayce  Alexander  Lundberg Corp } \\
		{\large Marcus 58}\\
		{\large 28829, SaiGon, Texas, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
