...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abigail Michael Hellström} \\
		{\large Annabelle 68}\\
		{\large 66383, Ho Chi Minh, Chiang Rai, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryson Catherine  Andersson Ltd } \\
		{\large Abigail 67}\\
		{\large 61338, Shanghai, Ang Thong, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
