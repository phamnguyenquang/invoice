...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bennett Louise 	 Berg} \\
		{\large Alice 55}\\
		{\large 24246, Frankfurt am Main , Bayern, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxson Louise 	 Andreasson Pte Ltd } \\
		{\large Valerie 3}\\
		{\large 94695, Sydney, Indiana, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
