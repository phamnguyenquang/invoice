...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mya Grace 	 Henriksson} \\
		{\large James 57}\\
		{\large 96820, Frankfurt am Main , Guangzhou, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Marcus Catherine  Persson Corp } \\
		{\large Brianna 66}\\
		{\large 96439, Denver, Guangdong, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
