...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonathan Rose 	 Gunnarsson} \\
		{\large Isaac 42}\\
		{\large 95206, Hong Kong, California, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rylee Marie 	 Henriksson Pte Ltd } \\
		{\large Alexander 28}\\
		{\large 10621, Berlin, California, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
