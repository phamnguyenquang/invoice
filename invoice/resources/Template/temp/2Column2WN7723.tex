...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stephanie Isaksson} \\
		{\large Jeremy 48}\\
		{\large 77605, Frankfurt am Main , Huabei, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan Elizabeth 	 Hassan Pte Ltd } \\
		{\large Stephanie 51}\\
		{\large 95747, Beijing, Saarland, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
