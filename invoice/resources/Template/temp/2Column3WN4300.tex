...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniela Michael Johansson} \\
		{\large Madeline 96}\\
		{\large 34617, Vancouver, Chiang Mai, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ella Edward Abrahamsson Pte Ltd } \\
		{\large Hazel 37}\\
		{\large 11276, New York , Phu Yen, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
