...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adeline Louise 	 Pettersson Pte Ltd} \\
		{\large Natalie 74}\\
		{\large 30529, Ho Chi Minh, Buriam, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie Dahl } \\
		{\large Ian 3}\\
		{\large 97465, Amsterdam, Guangdong, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
