...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rachel Mary 	 Henriksson} \\
		{\large Riley 65}\\
		{\large 55977, Minsk, Kentucky, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Payton Thomas Dahlberg Pte Ltd } \\
		{\large Mila 47}\\
		{\large 83486, Vancouver, Phu Yen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
