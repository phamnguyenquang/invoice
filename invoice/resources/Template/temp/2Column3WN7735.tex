...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luna Peter Pålsson} \\
		{\large Rose 9}\\
		{\large 26543, Rome, Guangzhou, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elizabeth Victoria Norberg Inc } \\
		{\large Isabella 57}\\
		{\large 71384, Frankfurt am Main , khanh Hoa, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
