...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alex Michael Ström} \\
		{\large Eliza 48}\\
		{\large 79581, Hong Kong, Chai Nat, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriel James Bergström Pte Ltd } \\
		{\large Gabriel 26}\\
		{\large 10673, Budapest, Kentucky, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
