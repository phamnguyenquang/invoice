...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everett John Dahlberg} \\
		{\large Ava 81}\\
		{\large 40047, Vienna, Hainan, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine John Henriksson Ltd } \\
		{\large Emily 27}\\
		{\large 51211, Frankfurt am Main , Amnat Charoen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
