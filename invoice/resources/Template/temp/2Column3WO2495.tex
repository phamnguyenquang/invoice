...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles Michael Forsberg Inc} \\
		{\large Emmett 49}\\
		{\large 28568, Frankfurt am Main , Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Violet Gunnarsson } \\
		{\large Bryce 24}\\
		{\large 18737, Lisbon, Chiang Rai, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
