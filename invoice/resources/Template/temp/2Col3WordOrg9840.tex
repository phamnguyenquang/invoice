...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Weston Thomas Fransson Corp} \\
		{\large Thomas 71}\\
		{\large 55086, Stuttgart, Hamburg, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brian Hedlund } \\
		{\large Aurora 69}\\
		{\large 39034, Frankfurt am Main , Guangzhou, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
