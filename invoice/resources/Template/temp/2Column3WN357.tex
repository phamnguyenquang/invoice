...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luca Victoria Gunnarsson} \\
		{\large Tyler 77}\\
		{\large 50235, San Francisco, Hessen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Austin May/Mae 	 Ahmed Pte Ltd } \\
		{\large Blake 23}\\
		{\large 99143, Ho Chi Minh, Buriam, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
