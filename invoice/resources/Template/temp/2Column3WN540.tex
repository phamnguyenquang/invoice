...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bennett Christopher Andreasson} \\
		{\large Hudson 22}\\
		{\large 55196, Beijing, Floria, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mariah Louise 	 Isaksson Ltd } \\
		{\large Eva 88}\\
		{\large 15030, Hong Kong, Seattles, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
