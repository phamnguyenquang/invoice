...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  University of Maine, Orono} \\
		{\large Jesus 56}\\
		{\large 66249, Barcelona, Ang Thong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wyatt Olofsson } \\
		{\large Gavin 93}\\
		{\large 52233, Frankfurt am Main , Saarland, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
