...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Levi Grace 	 Abrahamsson Ltd} \\
		{\large Payton 61}\\
		{\large 23743, Singapore, Hessen, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonathan Bergqvist } \\
		{\large Maria 11}\\
		{\large 78966, Frankfurt am Main , Chiang Rai, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
