...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriella Elizabeth 	 Martinsson} \\
		{\large Kenneth 7}\\
		{\large 57412, Washington, Guangzhou, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eliza William Öberg Corp } \\
		{\large Cameron 11}\\
		{\large 38622, Istanbul, khanh Hoa, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
