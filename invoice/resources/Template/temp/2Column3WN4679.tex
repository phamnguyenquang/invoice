...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eliana Anne Svensson} \\
		{\large Bennett 36}\\
		{\large 18023, Melbourne, Hamburg, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kinsley Thomas Lund Inc } \\
		{\large Brantley 20}\\
		{\large 48844, Frankfurt am Main , Kentucky, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
