...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adeline Catherine  Bergström} \\
		{\large Ella 76}\\
		{\large 97396, Chicago, Heibei, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harmony Rose 	 Jakobsson Inc } \\
		{\large Brianna 49}\\
		{\large 91355, Seoul, Indiana, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
