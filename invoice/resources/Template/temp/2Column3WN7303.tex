...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaron Catherine  Bergman} \\
		{\large Scarlett 19}\\
		{\large 31693, SaiGon, Ang Thong, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Trinity Robert Ali Pte Ltd } \\
		{\large Jace 62}\\
		{\large 79285, San Francisco, Kentucky, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
