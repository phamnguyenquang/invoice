...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juan Jane Sandberg} \\
		{\large Madelyn 96}\\
		{\large 33919, SaiGon, Hessen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isaiah Louise 	 Bergman Pte Ltd } \\
		{\large Colton 37}\\
		{\large 22871, Frankfurt am Main , Chiang Rai, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
