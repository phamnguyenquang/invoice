...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Layla Victoria Sjögren Pte Ltd} \\
		{\large Kinsley 5}\\
		{\large 64744, Hong Kong, Hainan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joshua Sjöberg } \\
		{\large Mya 78}\\
		{\large 48031, Melbourne, Tuscany, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
