...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amir Amy  Martinsson Pte Ltd} \\
		{\large Jake 62}\\
		{\large 16573, Frankfurt am Main , Texas, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabel Henriksson } \\
		{\large Katelyn 66}\\
		{\large 60234, San Francisco, khanh Hoa, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
