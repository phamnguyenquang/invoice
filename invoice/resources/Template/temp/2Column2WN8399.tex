...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Antonio Berglund} \\
		{\large Daniela 37}\\
		{\large 75292, San Francisco, Bangkok, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jake Kate 	 Andreasson Pte Ltd } \\
		{\large Makenzie 15}\\
		{\large 38294, Frankfurt am Main , Binh Thuan, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
