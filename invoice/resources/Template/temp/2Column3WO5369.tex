...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madison Elizabeth 	 Engström Inc} \\
		{\large Jessica 94}\\
		{\large 12852, Frankfurt am Main , Binh Thuan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sadie Berg } \\
		{\large Kyle 58}\\
		{\large 56755, Ho Chi Minh, Chiang Mai, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
