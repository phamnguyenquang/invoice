...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxon Christopher Andersson Inc} \\
		{\large Jayden 89}\\
		{\large 11371, Los Angeles, Kentucky, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxson Hansen } \\
		{\large Samuel 88}\\
		{\large 99571, Hong Kong, Chiang Rai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
