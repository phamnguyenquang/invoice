...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gianna Kate 	 Blomqvist} \\
		{\large Colin 47}\\
		{\large 45529, Vancouver, khanh Hoa, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kendall Elizabeth 	 Bergqvist Ltd } \\
		{\large Ivy 40}\\
		{\large 90579, Washington, Bangkok, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
