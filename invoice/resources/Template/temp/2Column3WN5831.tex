...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezekiel Rose 	 Olofsson} \\
		{\large Serenity 26}\\
		{\large 57196, San Francisco, Hamburg, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madelyn Rose 	 Lind Ltd } \\
		{\large Logan 55}\\
		{\large 95963, Frankfurt am Main , Henan, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
