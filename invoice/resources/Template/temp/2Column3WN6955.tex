...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Declan Lee  Bergman} \\
		{\large Alyssa 28}\\
		{\large 76908, New York , khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lyla Edward Wikström Ltd } \\
		{\large Mark 65}\\
		{\large 41947, Abu Dhabi, Bremen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
