...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla May/Mae 	 Danielsson} \\
		{\large Kingston 50}\\
		{\large 96404, Hong Kong, Saarland, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Lee  Lundström Inc } \\
		{\large Carlos 10}\\
		{\large 72045, Florence, Bremen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
