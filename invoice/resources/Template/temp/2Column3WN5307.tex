...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  John James Sjögren} \\
		{\large Connor 92}\\
		{\large 60760, Nha Trang, Amnat Charoen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Santiago Victoria Åkesson Inc } \\
		{\large Adalynn 61}\\
		{\large 46547, Amsterdam, California, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
