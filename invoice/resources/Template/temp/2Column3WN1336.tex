...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mila Lee  Wikström} \\
		{\large Hannah 1}\\
		{\large 98942, Barcelona, Tuscany, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Faith Christopher Wikström Inc } \\
		{\large Austin 55}\\
		{\large 66070, Venice, Bangkok, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
