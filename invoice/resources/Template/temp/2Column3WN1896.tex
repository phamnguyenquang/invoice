...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Santiago Michael Andersson} \\
		{\large Valeria 51}\\
		{\large 31849, Frankfurt am Main , Tuscany, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Greyson Louise 	 Hassan Corp } \\
		{\large Kai 27}\\
		{\large 94021, Chicago, Indiana, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
