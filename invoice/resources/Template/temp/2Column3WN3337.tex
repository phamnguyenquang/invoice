...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lily David Claesson} \\
		{\large Katelyn 75}\\
		{\large 66665, Ho Chi Minh, Hessen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mila Victoria Eklund Ltd } \\
		{\large Evan 18}\\
		{\large 65343, Frankfurt am Main , Indiana, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
