...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrew Robert Samuelsson} \\
		{\large Ashley 50}\\
		{\large 19102, Dubai, Chai Nat, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eden Louise 	 Henriksson Inc } \\
		{\large Anthony 6}\\
		{\large 57948, Montreal, Guangzhou, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
