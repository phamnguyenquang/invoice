...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayce Elizabeth 	 Lindqvist} \\
		{\large Xavier 13}\\
		{\large 17896, San Francisco, Huabei, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayla Lee  Berggren Inc } \\
		{\large Jasmine 23}\\
		{\large 80539, Shanghai, Binh Thuan, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
