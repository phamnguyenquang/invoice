...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jason Louise 	 Holmberg} \\
		{\large Mia 5}\\
		{\large 46733, Seoul, Bayern, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Steven Michael Ali Pte Ltd } \\
		{\large Jose 5}\\
		{\large 28980, Ho Chi Minh, Amnat Charoen, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
