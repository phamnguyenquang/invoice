...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jessica Victoria Ahmed} \\
		{\large Grace 59}\\
		{\large 71544, Boston, Phu Yen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grayson Amy  Abrahamsson Ltd } \\
		{\large Malachi 87}\\
		{\large 92957, Frankfurt am Main , Saarland, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
