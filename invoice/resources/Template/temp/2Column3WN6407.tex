...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaitlyn  Alexander  Eliasson} \\
		{\large Paisley 12}\\
		{\large 50735, San Francisco, California, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kenneth Kate 	 Pålsson Inc } \\
		{\large Chase 29}\\
		{\large 68015, Budapest, Floria, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
