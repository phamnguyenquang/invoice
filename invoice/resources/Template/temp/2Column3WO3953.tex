...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cora Victoria Sundberg Pte Ltd} \\
		{\large Colton 82}\\
		{\large 49918, Washington, California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bailey Lindqvist } \\
		{\large Zachary 48}\\
		{\large 92724, Hong Kong, Guangdong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
