...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaron Louise 	 Berglund Ltd} \\
		{\large Lilly 85}\\
		{\large 16567, Florence, California, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angelina Lindström } \\
		{\large Quinn 19}\\
		{\large 76881, Barcelona, Bayern, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
