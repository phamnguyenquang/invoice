...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Preston William Isaksson} \\
		{\large Valentina 81}\\
		{\large 67768, Frankfurt am Main , Chiang Mai, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden Edward Forsberg Ltd } \\
		{\large Juan 5}\\
		{\large 70943, Munich, Hamburg, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
