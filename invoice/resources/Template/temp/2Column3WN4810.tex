...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Timothy Amy  Pettersson} \\
		{\large Allison 38}\\
		{\large 56047, Last Vegas, Amnat Charoen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn Victoria Lindholm Inc } \\
		{\large Adeline 10}\\
		{\large 54389, Berlin, Henan, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
