...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mckenzie  Alexander  Isaksson} \\
		{\large Rylee 30}\\
		{\large 15332, Los Angeles, Floria, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Parker Catherine  Holm Corp } \\
		{\large Nicolas 55}\\
		{\large 92492, Toronto, Amnat Charoen, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
