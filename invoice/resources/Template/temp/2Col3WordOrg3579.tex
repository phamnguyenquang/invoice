...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Max Michael Söderberg Pte Ltd} \\
		{\large Miguel 54}\\
		{\large 98767, Frankfurt am Main , Hawaii, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooke Holmgren } \\
		{\large Ryker 82}\\
		{\large 95740, Shanghai, Kentucky, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
