...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cameron Berggren} \\
		{\large Everly 8}\\
		{\large 28320, Frankfurt am Main , Hainan, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angelina Kate 	 Larsson Inc } \\
		{\large Jessica 62}\\
		{\large 22330, Frankfurt am Main , Indiana, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
