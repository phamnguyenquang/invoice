...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaiden Christopher Nyberg} \\
		{\large Serenity 67}\\
		{\large 85208, Dublin, khanh Hoa, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lauren Rose 	 Samuelsson Ltd } \\
		{\large Ivy 1}\\
		{\large 26057, Hong Kong, Guangzhou, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
