...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abigail Rose 	 Danielsson} \\
		{\large Madeline 38}\\
		{\large 89402, Budapest, Phu Yen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Michael Nyberg Corp } \\
		{\large Eva 61}\\
		{\large 32343, Minsk, Amnat Charoen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
