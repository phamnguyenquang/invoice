...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklyn Edward Norberg} \\
		{\large Alejandro 38}\\
		{\large 81409, Seoul, Chiang Mai, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paul Anne Fredriksson Inc } \\
		{\large Penelope 13}\\
		{\large 84812, Frankfurt am Main , Heibei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
