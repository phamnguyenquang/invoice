...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mackenzie Håkansson Ltd} \\
		{\large Sadie 98}\\
		{\large 39396, Frankfurt am Main , Henan, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christian Henriksson } \\
		{\large Abraham 1}\\
		{\large 47334, San Francisco, Kentucky, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
