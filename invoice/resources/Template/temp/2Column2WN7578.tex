...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayden Berglund} \\
		{\large Mason 32}\\
		{\large 91091, Melbourne, Binh Thuan, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Steven David Jansson Inc } \\
		{\large King 55}\\
		{\large 82436, Frankfurt am Main , Chiang Mai, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
