...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Annabelle Christopher Pettersson Pte Ltd} \\
		{\large Nicholas 66}\\
		{\large 80002, Singapore, Ang Thong, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalyn Wallin } \\
		{\large Bryce 46}\\
		{\large 17459, Florence, Bangkok, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
