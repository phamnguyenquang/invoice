...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  John Victoria Lundqvist Pte Ltd} \\
		{\large Bentley 16}\\
		{\large 71927, Montreal, California, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charles Gunnarsson } \\
		{\large Hannah 30}\\
		{\large 19484, Frankfurt am Main , Hawaii, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
