...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Oliver May/Mae 	 Söderberg} \\
		{\large Joseph 88}\\
		{\large 22481, Hong Kong, Hawaii, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella Amy  Hellström Pte Ltd } \\
		{\large Izabella 27}\\
		{\large 95384, Shanghai, khanh Hoa, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
