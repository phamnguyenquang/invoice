...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity Elizabeth 	 Hassan} \\
		{\large Madeline 67}\\
		{\large 93314, Sydney, Chai Nat, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Khloe Victoria Eklund Pte Ltd } \\
		{\large Dylan 65}\\
		{\large 15537, Nha Trang, Hamburg, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
