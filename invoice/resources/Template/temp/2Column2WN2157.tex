...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Diego Berglund} \\
		{\large Maximus 4}\\
		{\large 61556, Frankfurt am Main , Bangkok, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leo Elizabeth 	 Blomqvist Pte Ltd } \\
		{\large Abigail 68}\\
		{\large 81256, Ho Chi Minh, Seattles, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
