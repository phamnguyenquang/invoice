...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryker Catherine  Strömberg} \\
		{\large Carson 48}\\
		{\large 13173, Hong Kong, California, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayla Lee  Abrahamsson Inc } \\
		{\large Brooklynn 34}\\
		{\large 44943, Minsk, Kentucky, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
