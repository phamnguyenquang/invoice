...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josiah Edward Andersson Inc} \\
		{\large Alan 21}\\
		{\large 91745, San Francisco, Chiang Rai, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eden Björklund } \\
		{\large Elise 31}\\
		{\large 69435, Frankfurt am Main , Ang Thong, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
