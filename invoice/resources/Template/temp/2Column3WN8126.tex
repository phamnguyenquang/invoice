...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grant Catherine  Mattsson} \\
		{\large Benjamin 77}\\
		{\large 67435, Tokyo, Phu Yen, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hailey Victoria Mattsson Pte Ltd } \\
		{\large Ariana 51}\\
		{\large 91091, Berlin, Binh Thuan, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
