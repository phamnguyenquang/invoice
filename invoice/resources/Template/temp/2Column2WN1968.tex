...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  John Löfgren} \\
		{\large Nathan 86}\\
		{\large 87651, Abu Dhabi, Amnat Charoen, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Scarlett Mary 	 Eriksson Corp } \\
		{\large Adalynn 63}\\
		{\large 97198, Last Vegas, Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
