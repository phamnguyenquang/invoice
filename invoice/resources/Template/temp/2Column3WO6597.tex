...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathan Mary 	 Berglund Corp} \\
		{\large Hayden 82}\\
		{\large 85682, Frankfurt am Main , Saarland, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adrian Blomqvist } \\
		{\large Hudson 59}\\
		{\large 44858, Frankfurt am Main , Bayern, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
