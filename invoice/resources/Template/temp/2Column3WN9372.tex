...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley John Abrahamsson} \\
		{\large Josephine 43}\\
		{\large 92436, Paris, Chai Nat, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jordan Jane Nordin Corp } \\
		{\large Lillian 4}\\
		{\large 80650, Hong Kong, Ang Thong, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
