...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ayden Nyström} \\
		{\large Diego 86}\\
		{\large 10969, Melbourne, Guangdong, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tucker Catherine  Jonsson Pte Ltd } \\
		{\large Lucas 34}\\
		{\large 42719, Nha Trang, Ang Thong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
