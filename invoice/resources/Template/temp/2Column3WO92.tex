...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Delilah Thomas Nordström Pte Ltd} \\
		{\large Bradley 79}\\
		{\large 95124, Ho Chi Minh, Seattles, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Sandberg } \\
		{\large Preston 18}\\
		{\large 79990, Osaka, Bangkok, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
