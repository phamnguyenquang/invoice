...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valentina Rose 	 Nyström} \\
		{\large Greyson 39}\\
		{\large 77930, Shanghai, Bangkok, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Payton Thomas Fredriksson Pte Ltd } \\
		{\large Joseph 86}\\
		{\large 73144, Frankfurt am Main , Tuscany, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
