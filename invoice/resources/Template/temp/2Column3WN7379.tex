...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Kate 	 Sundberg} \\
		{\large Kai 26}\\
		{\large 70683, Ho Chi Minh, Chiang Mai, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Oscar David Viklund Ltd } \\
		{\large Emmett 41}\\
		{\large 81593, New York , khanh Hoa, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
