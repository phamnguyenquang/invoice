...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Reagan Mary 	 Lundberg} \\
		{\large Leilani 99}\\
		{\large 84503, Barcelona, Hawaii, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juliana Louise 	 Magnusson Pte Ltd } \\
		{\large Kaitlyn 8}\\
		{\large 65959, Last Vegas, Huabei, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
