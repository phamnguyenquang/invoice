...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isaac Elizabeth 	 Månsson} \\
		{\large Thomas 67}\\
		{\large 91096, Chicago, Hessen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie Peter Eliasson Pte Ltd } \\
		{\large Mariah 20}\\
		{\large 19039, Frankfurt am Main , Hamburg, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
