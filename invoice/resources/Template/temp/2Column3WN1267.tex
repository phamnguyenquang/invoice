...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Robert Robert Jansson} \\
		{\large Jordan 66}\\
		{\large 84285, Dublin, Guangdong, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adrian Mary 	 Åkesson Pte Ltd } \\
		{\large Jayden 31}\\
		{\large 97065, Singapore, Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
