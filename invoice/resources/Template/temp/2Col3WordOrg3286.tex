...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sofia Christopher Hermansson Inc} \\
		{\large Preston 99}\\
		{\large 15568, Amsterdam, Henan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jameson Hedlund } \\
		{\large Jasmine 27}\\
		{\large 96516, Florence, Floria, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
