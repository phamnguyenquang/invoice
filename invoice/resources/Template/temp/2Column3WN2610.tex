...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ayden Edward Abrahamsson} \\
		{\large John 50}\\
		{\large 33423, Frankfurt am Main , Phu Yen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabelle Grace 	 Ek Corp } \\
		{\large Daisy 98}\\
		{\large 69164, Melbourne, Saarland, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
