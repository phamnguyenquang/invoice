...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Axel Mary 	 Ali} \\
		{\large Peyton 70}\\
		{\large 10945, Ho Chi Minh, Guangdong, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bailey  Alexander  Bergström Corp } \\
		{\large Riley 2}\\
		{\large 82399, Washington, Amnat Charoen, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
