...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesse  Alexander  Henriksson} \\
		{\large Diego 83}\\
		{\large 43413, San Francisco, Phu Yen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aidan Robert Eliasson Inc } \\
		{\large Allison 47}\\
		{\large 63382, Venice, Bremen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
