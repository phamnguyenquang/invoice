...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emilia Mary 	 Lundqvist Pte Ltd} \\
		{\large Madelyn 52}\\
		{\large 58954, Frankfurt am Main , Ang Thong, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tyler Abrahamsson } \\
		{\large Nevaeh 87}\\
		{\large 10266, Seoul, Indiana, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
