...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Anna Johansson} \\
		{\large Penelope 36}\\
		{\large 98934, Frankfurt am Main , Binh Thuan, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bradley Ann  Engström Corp } \\
		{\large Gianna 95}\\
		{\large 94810, Minsk, Kentucky, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
