...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luke Christopher Hermansson} \\
		{\large Olivia 74}\\
		{\large 68241, Chicago, Ang Thong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alyssa Elizabeth 	 Johansson Ltd } \\
		{\large Lily 8}\\
		{\large 54046, Paris, Chiang Rai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
