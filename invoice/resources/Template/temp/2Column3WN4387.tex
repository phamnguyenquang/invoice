...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremiah Louise 	 Forsberg} \\
		{\large Alyssa 59}\\
		{\large 68246, Montreal, Phu Yen, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maya Michael Lind Pte Ltd } \\
		{\large Brooklyn 3}\\
		{\large 25807, Washington, Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
