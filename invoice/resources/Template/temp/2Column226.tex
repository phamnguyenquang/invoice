...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryan Lundgren Pte Ltd} \\
		{\large Gabrielle 4}\\
		{\large 74861, Melbourne, Chiang Rai, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maddox Söderberg } \\
		{\large Harrison 32}\\
		{\large 60247, Frankfurt am Main , Chiang Mai, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
