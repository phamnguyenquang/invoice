...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Robert Michael Hedlund Pte Ltd} \\
		{\large Tristan 97}\\
		{\large 70671, Amsterdam, Guangdong, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Austin Nordström } \\
		{\large Brady 37}\\
		{\large 86720, Frankfurt am Main , Chai Nat, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
