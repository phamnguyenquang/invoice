...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Annabelle Thomas Bergström} \\
		{\large Madeline 77}\\
		{\large 68404, Melbourne, Bayern, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley Louise 	 Eliasson Ltd } \\
		{\large Maria 89}\\
		{\large 21628, Melbourne, Guangzhou, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
