...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabella Thomas Nilsson} \\
		{\large Jacob 7}\\
		{\large 94029, Madrid, Bangkok, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jessica Louise 	 Andreasson Pte Ltd } \\
		{\large Jordan 3}\\
		{\large 57332, Montreal, Henan, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
