...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremy Peter Johansson} \\
		{\large Wyatt 59}\\
		{\large 16894, Frankfurt am Main , khanh Hoa, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jacob  Alexander  Hansson Ltd } \\
		{\large Andrea 68}\\
		{\large 93824, Los Angeles, Tuscany, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
