...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel Peter Jansson Inc} \\
		{\large Paige 13}\\
		{\large 81299, Hong Kong, Hawaii, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sophia Strömberg } \\
		{\large Londyn 76}\\
		{\large 28056, San Francisco, khanh Hoa, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
