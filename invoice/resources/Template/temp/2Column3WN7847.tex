...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mckenzie  Alexander  Henriksson} \\
		{\large Edward 93}\\
		{\large 31417, San Francisco, Hainan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brian Thomas Holmberg Inc } \\
		{\large Daniela 58}\\
		{\large 55537, Hanoi, Bayern, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
