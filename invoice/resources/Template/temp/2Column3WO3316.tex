...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle May/Mae 	 Bengtsson Pte Ltd} \\
		{\large Morgan 66}\\
		{\large 24765, Taipei, Guangzhou, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Henriksson } \\
		{\large Lydia 72}\\
		{\large 36576, Lisbon, Kentucky, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
