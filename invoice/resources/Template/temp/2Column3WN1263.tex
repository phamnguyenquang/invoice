...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Weston Robert Gunnarsson} \\
		{\large Ezra 12}\\
		{\large 38548, Rome, Kentucky, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy Catherine  Pettersson Pte Ltd } \\
		{\large Allison 69}\\
		{\large 36870, Vancouver, Phu Yen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
