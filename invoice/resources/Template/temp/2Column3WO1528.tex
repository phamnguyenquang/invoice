...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kayden Elizabeth 	 Gustafsson Ltd} \\
		{\large Noah 46}\\
		{\large 37714, Last Vegas, Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elizabeth Löfgren } \\
		{\large Samantha 93}\\
		{\large 33062, Ho Chi Minh, Indiana, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
