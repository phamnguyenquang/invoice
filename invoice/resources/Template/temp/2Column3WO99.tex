...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxson Rose 	 Jönsson Ltd} \\
		{\large Naomi 19}\\
		{\large 59536, New York , Amnat Charoen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Molly Johansson } \\
		{\large Melody 20}\\
		{\large 31044, Frankfurt am Main , Guangdong, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
