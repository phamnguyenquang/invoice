...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bentley Christopher Lindgren Corp} \\
		{\large Bentley 82}\\
		{\large 16179, Frankfurt am Main , Guangdong, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmett Nordin } \\
		{\large Diego 24}\\
		{\large 41679, Abu Dhabi, Kentucky, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
