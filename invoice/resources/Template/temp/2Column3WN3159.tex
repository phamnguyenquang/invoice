...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina David Ahmed} \\
		{\large Annabelle 39}\\
		{\large 60144, Berlin, Hamburg, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alana Edward Wallin Pte Ltd } \\
		{\large Valeria 62}\\
		{\large 61655, Frankfurt am Main , Amnat Charoen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
