...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Louise 	 Sandström} \\
		{\large Lucy 68}\\
		{\large 38108, Sydney, California, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angel  Alexander  Lundgren Ltd } \\
		{\large Malachi 84}\\
		{\large 99170, Minsk, Saarland, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
