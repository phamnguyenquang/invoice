...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Marcus May/Mae 	 Nilsson} \\
		{\large Brandon 39}\\
		{\large 87811, Abu Dhabi, Huabei, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Savannah Christopher Öberg Ltd } \\
		{\large Alexa 26}\\
		{\large 98441, Amsterdam, Floria, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
