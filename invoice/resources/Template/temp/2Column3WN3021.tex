...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Noah Elizabeth 	 Hansen} \\
		{\large Mila 79}\\
		{\large 21428, Hong Kong, Saarland, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vanessa William Berglund Inc } \\
		{\large Piper 79}\\
		{\large 34655, Nha Trang, Chiang Rai, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
