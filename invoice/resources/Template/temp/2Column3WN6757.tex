...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryce Christopher Nordin} \\
		{\large Maddox 51}\\
		{\large 33040, Hanoi, Chiang Rai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kevin Grace 	 Axelsson Pte Ltd } \\
		{\large John 95}\\
		{\large 54136, Budapest, Bayern, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
