...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel Grace 	 Forsberg Pte Ltd} \\
		{\large Kaitlyn 93}\\
		{\large 76493, San Francisco, Hainan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abel Ahmed } \\
		{\large Adalyn 92}\\
		{\large 65727, Chicago, Amnat Charoen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
