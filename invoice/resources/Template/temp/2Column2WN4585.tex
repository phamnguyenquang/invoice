...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon Lindholm} \\
		{\large Bentley 28}\\
		{\large 37288, Frankfurt am Main , Henan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kylie Marie 	 Andreasson Pte Ltd } \\
		{\large Molly 24}\\
		{\large 27071, Berlin, Chiang Rai, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
