...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  École Polytechnique Fédérale de Lausanne} \\
		{\large Theodore 89}\\
		{\large 34109, Taipei, Huabei, Canada }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Valentina Holmgren } \\
		{\large Molly 20}\\
		{\large 42788, Lisbon, Heibei, Philippines}\\
    \switchcolumn
