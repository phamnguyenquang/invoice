...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie Grace 	 Jönsson Pte Ltd} \\
		{\large Jayden 29}\\
		{\large 93494, Ho Chi Minh, Ang Thong, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eli Sundberg } \\
		{\large Cameron 12}\\
		{\large 95005, Abu Dhabi, Chiang Mai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
