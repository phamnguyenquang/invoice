...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vanessa Peter Holm} \\
		{\large Steven 66}\\
		{\large 92742, Washington, Chiang Rai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alana Louise 	 Jonsson Pte Ltd } \\
		{\large Jose 96}\\
		{\large 95983, Munich, Binh Thuan, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
