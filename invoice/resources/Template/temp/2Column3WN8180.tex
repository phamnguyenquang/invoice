...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elena Christopher Isaksson} \\
		{\large Dylan 22}\\
		{\large 79415, Boston, Saarland, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Destiny Robert Åberg Inc } \\
		{\large Reese 79}\\
		{\large 58864, Los Angeles, Chiang Rai, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
