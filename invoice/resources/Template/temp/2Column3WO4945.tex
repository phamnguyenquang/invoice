...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Silas Elizabeth 	 Jönsson Inc} \\
		{\large Violet 81}\\
		{\large 32903, Frankfurt am Main , Saarland, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samuel Hansen } \\
		{\large Daniel 29}\\
		{\large 96986, Frankfurt am Main , Chai Nat, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
