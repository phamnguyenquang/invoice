...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonah Grace 	 Pettersson Pte Ltd} \\
		{\large Naomi 87}\\
		{\large 97251, Frankfurt am Main , Bangkok, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caden Andersson } \\
		{\large Nora 34}\\
		{\large 12356, Frankfurt am Main , Kentucky, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
