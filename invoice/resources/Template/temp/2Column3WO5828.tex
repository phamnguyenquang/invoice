...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Samantha Anne Sandberg Pte Ltd} \\
		{\large Jordyn 91}\\
		{\large 79245, Amsterdam, Chiang Rai, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalynn Söderberg } \\
		{\large Eleanor 51}\\
		{\large 64465, Melbourne, Ang Thong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
