...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Chloe James Björklund} \\
		{\large Harmony 47}\\
		{\large 91096, Budapest, Chiang Rai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mya Grace 	 Björklund Pte Ltd } \\
		{\large Samuel 79}\\
		{\large 90459, San Francisco, Chai Nat, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
