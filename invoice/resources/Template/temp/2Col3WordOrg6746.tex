...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victoria Robert Sjöberg Ltd} \\
		{\large Emilia 9}\\
		{\large 14342, Nha Trang, California, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bailey Gustafsson } \\
		{\large Natalie 59}\\
		{\large 31788, Frankfurt am Main , Chiang Rai, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
