...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria Nordin} \\
		{\large Piper 9}\\
		{\large 35105, Melbourne, Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emilia Christopher Håkansson Pte Ltd } \\
		{\large Ryker 89}\\
		{\large 69424, Abu Dhabi, Chai Nat, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
