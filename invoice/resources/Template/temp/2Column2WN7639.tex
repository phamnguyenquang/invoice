...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Åberg} \\
		{\large Leonardo 58}\\
		{\large 19789, SaiGon, Chai Nat, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angel May/Mae 	 Danielsson Pte Ltd } \\
		{\large Brantley 31}\\
		{\large 23646, Venice, khanh Hoa, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
