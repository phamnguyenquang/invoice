...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity Michael Nordström} \\
		{\large Caden 16}\\
		{\large 32739, Venice, Kentucky, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte Louise 	 Sandberg Corp } \\
		{\large Joshua 26}\\
		{\large 15461, Dublin, California, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
