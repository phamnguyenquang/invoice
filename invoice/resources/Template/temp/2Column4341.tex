...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christian Pettersson Pte Ltd} \\
		{\large Calvin 38}\\
		{\large 61654, San Francisco, Seattles, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Morgan Lundgren } \\
		{\large Patrick 41}\\
		{\large 20662, Frankfurt am Main , Tuscany, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
