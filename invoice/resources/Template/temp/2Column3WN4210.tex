...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christian Lee  Abrahamsson} \\
		{\large Gabriella 35}\\
		{\large 24254, Sydney, Tuscany, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sadie Anne Claesson Corp } \\
		{\large Adalyn 12}\\
		{\large 21393, Los Angeles, Chiang Mai, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
