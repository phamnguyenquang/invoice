...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery Engström} \\
		{\large Kayla 80}\\
		{\large 86332, Berlin, Hainan, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonah Thomas Fredriksson Pte Ltd } \\
		{\large Timothy 60}\\
		{\large 48901, Frankfurt am Main , Tuscany, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
