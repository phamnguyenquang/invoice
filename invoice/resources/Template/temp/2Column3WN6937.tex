...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sarah  Alexander  Forsberg} \\
		{\large Gracie 22}\\
		{\large 62184, Barcelona, Amnat Charoen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Miguel  Alexander  Hellström Corp } \\
		{\large Christian 64}\\
		{\large 26547, Beijing, Texas, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
