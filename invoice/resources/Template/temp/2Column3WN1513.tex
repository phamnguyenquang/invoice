...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leilani Thomas Wallin} \\
		{\large Kimberly 81}\\
		{\large 47484, SaiGon, Chai Nat, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brielle Thomas Gustafsson Ltd } \\
		{\large Declan 81}\\
		{\large 44738, Nha Trang, Hessen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
