...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mckenzie Peter Wikström} \\
		{\large Caleb 10}\\
		{\large 77198, Hong Kong, Kentucky, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniela Christopher Hansson Pte Ltd } \\
		{\large Kaiden 73}\\
		{\large 30473, Vancouver, Hainan, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
