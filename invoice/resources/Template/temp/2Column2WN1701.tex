...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathan Magnusson} \\
		{\large Amir 11}\\
		{\large 14465, Frankfurt am Main , Huabei, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juan Catherine  Eliasson Pte Ltd } \\
		{\large Bailey 35}\\
		{\large 46592, Last Vegas, Buriam, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
