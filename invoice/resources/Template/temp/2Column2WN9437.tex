...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie Nyström} \\
		{\large Emilia 95}\\
		{\large 38467, Frankfurt am Main , Guangzhou, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Chloe Rose 	 Ekström Pte Ltd } \\
		{\large Steven 6}\\
		{\large 23598, Ho Chi Minh, Henan, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
