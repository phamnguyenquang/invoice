...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zachary Åberg} \\
		{\large George 51}\\
		{\large 15628, Abu Dhabi, khanh Hoa, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leilani Anne Holmgren Pte Ltd } \\
		{\large Genesis 7}\\
		{\large 70708, Budapest, California, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
