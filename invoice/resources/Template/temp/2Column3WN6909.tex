...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jordyn William Olofsson} \\
		{\large Jordan 2}\\
		{\large 95372, Toronto, Kentucky, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Parker David Magnusson Corp } \\
		{\large Morgan 79}\\
		{\large 52853, Melbourne, Chiang Mai, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
