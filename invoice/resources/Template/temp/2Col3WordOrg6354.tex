...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope William Ekström Pte Ltd} \\
		{\large Leonardo 83}\\
		{\large 17520, Frankfurt am Main , Seattles, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maya Nordström } \\
		{\large Brooke 32}\\
		{\large 54106, Melbourne, Huabei, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
