...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie Amy  Olofsson} \\
		{\large Christopher 73}\\
		{\large 87729, Chicago, Saarland, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley Thomas Sjögren Ltd } \\
		{\large Connor 70}\\
		{\large 48349, Venice, California, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
