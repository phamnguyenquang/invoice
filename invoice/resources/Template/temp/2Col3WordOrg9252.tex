...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jason Thomas Axelsson Inc} \\
		{\large Alexandra 44}\\
		{\large 16497, Boston, khanh Hoa, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kevin Axelsson } \\
		{\large Christopher 69}\\
		{\large 38549, Osaka, Kentucky, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
