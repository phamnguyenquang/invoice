...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jessica Victoria Mårtensson} \\
		{\large Ximena 64}\\
		{\large 37519, Frankfurt am Main , Floria, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Layla Elizabeth 	 Dahlberg Inc } \\
		{\large Micah 21}\\
		{\large 15702, Melbourne, Chiang Mai, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
