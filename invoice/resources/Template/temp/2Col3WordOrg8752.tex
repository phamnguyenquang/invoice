...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sarah David Andersson Ltd} \\
		{\large Emmett 70}\\
		{\large 99115, Frankfurt am Main , Heibei, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reagan Strömberg } \\
		{\large Ivan 72}\\
		{\large 68846, San Francisco, Texas, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
