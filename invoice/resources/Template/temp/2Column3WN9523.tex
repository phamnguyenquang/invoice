...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  David Catherine  Johansson} \\
		{\large Daisy 12}\\
		{\large 38372, Frankfurt am Main , Huabei, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Trinity Christopher Lundgren Pte Ltd } \\
		{\large Jack 25}\\
		{\large 22655, Milan, Hessen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
