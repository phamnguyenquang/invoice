...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elizabeth Christopher Pålsson Inc} \\
		{\large Aaliyah 61}\\
		{\large 91482, Milan, California, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Taylor Bengtsson } \\
		{\large Norah 50}\\
		{\large 46523, Los Angeles, Huabei, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
