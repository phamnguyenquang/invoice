...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sophie David Lindström} \\
		{\large Valentina 72}\\
		{\large 31270, Bonn, Floria, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vivian Jane Sjöberg Corp } \\
		{\large Christopher 26}\\
		{\large 77165, Stuttgart, Chiang Mai, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
