...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alice  Alexander  Månsson} \\
		{\large Alexa 43}\\
		{\large 43181, Los Angeles, Bangkok, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elise Elizabeth 	 Norberg Corp } \\
		{\large Alexandra 30}\\
		{\large 32189, Ho Chi Minh, Chiang Mai, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
