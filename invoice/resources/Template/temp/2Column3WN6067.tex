...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Izabella Louise 	 Danielsson} \\
		{\large Allison 13}\\
		{\large 49740, Last Vegas, Saarland, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Roman  Alexander  Henriksson Corp } \\
		{\large Ezekiel 25}\\
		{\large 29236, Munich, Saarland, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
