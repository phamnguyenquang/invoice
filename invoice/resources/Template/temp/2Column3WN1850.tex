...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniela William Sundberg} \\
		{\large Sarah 45}\\
		{\large 68895, Singapore, Phu Yen, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grant  Alexander  Jakobsson Corp } \\
		{\large Jade 55}\\
		{\large 52079, Vienna, Chiang Mai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
