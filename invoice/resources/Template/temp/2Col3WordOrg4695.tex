...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Oscar Louise 	 Wikström Pte Ltd} \\
		{\large Emmett 88}\\
		{\large 46477, Hong Kong, Phu Yen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte Jakobsson } \\
		{\large Mason 41}\\
		{\large 72906, Singapore, Bayern, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
