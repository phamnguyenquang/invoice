...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leilani Edward Holm} \\
		{\large Abigail 78}\\
		{\large 37592, Hong Kong, Guangdong, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ivy William Hermansson Pte Ltd } \\
		{\large Abel 83}\\
		{\large 16313, Florence, Kentucky, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
