...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalynn Abrahamsson Corp} \\
		{\large Annabelle 23}\\
		{\large 56949, Frankfurt am Main , Phu Yen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jordyn Olsson } \\
		{\large Addison 47}\\
		{\large 68097, Frankfurt am Main , Chiang Rai, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
