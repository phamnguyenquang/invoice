...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eli May/Mae 	 Eliasson} \\
		{\large Reese 91}\\
		{\large 11431, Paris, khanh Hoa, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Mary 	 Engström Pte Ltd } \\
		{\large Khloe 26}\\
		{\large 21960, Budapest, California, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
