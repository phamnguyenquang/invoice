...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriel Nordin} \\
		{\large Jake 88}\\
		{\large 59359, Abu Dhabi, Ang Thong, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hazel Michael Holmgren Pte Ltd } \\
		{\large Luca 80}\\
		{\large 95490, San Francisco, Guangzhou, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
