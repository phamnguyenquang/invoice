...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabel Victoria Johansson} \\
		{\large Brooklyn 8}\\
		{\large 16447, Lisbon, Guangdong, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Arianna Marie 	 Svensson Corp } \\
		{\large Cooper 88}\\
		{\large 18246, Nha Trang, Hamburg, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
