...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Greyson May/Mae 	 Hassan} \\
		{\large Jameson 40}\\
		{\large 46549, Berlin, Hessen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Michael Gustafsson Pte Ltd } \\
		{\large Ryan 85}\\
		{\large 51387, Ho Chi Minh, Chiang Mai, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
