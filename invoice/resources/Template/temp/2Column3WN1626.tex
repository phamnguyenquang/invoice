...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Margaret  Alexander  Abrahamsson} \\
		{\large Chase 99}\\
		{\large 29602, London , Binh Thuan, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Xavier Mary 	 Gunnarsson Ltd } \\
		{\large Leah 87}\\
		{\large 82316, Chicago, Bremen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
