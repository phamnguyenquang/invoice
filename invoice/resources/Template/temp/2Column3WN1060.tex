...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mateo Edward Henriksson} \\
		{\large Brantley 31}\\
		{\large 47030, Paris, Guangdong, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aurora Thomas Danielsson Inc } \\
		{\large Victor 49}\\
		{\large 35084, Berlin, khanh Hoa, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
