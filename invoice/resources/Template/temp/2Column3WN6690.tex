...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emery Elizabeth 	 Andersson} \\
		{\large Alexis 69}\\
		{\large 79965, Ho Chi Minh, Chiang Mai, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leilani David Sjöberg Pte Ltd } \\
		{\large Kenneth 31}\\
		{\large 34352, San Francisco, Guangdong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
