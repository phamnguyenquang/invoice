...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine William Berggren} \\
		{\large Elijah 1}\\
		{\large 44025, Ho Chi Minh, Guangdong, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gavin James Bergström Ltd } \\
		{\large Parker 71}\\
		{\large 62391, Florence, Chiang Mai, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
