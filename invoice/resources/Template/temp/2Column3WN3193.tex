...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Arianna David Lindström} \\
		{\large Serenity 37}\\
		{\large 15147, San Francisco, Amnat Charoen, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Thomas Åberg Ltd } \\
		{\large Damian 34}\\
		{\large 94565, Madrid, Binh Thuan, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
