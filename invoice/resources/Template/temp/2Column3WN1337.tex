...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Morgan Christopher Öberg} \\
		{\large Ashley 2}\\
		{\large 16182, Frankfurt am Main , Guangdong, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrew James Bengtsson Pte Ltd } \\
		{\large Emilia 47}\\
		{\large 57802, Taipei, Tuscany, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
