...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jack Mary 	 Martinsson} \\
		{\large London 3}\\
		{\large 79577, Istanbul, Guangzhou, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stella David Lindström Pte Ltd } \\
		{\large Sawyer 89}\\
		{\large 26703, Madrid, Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
