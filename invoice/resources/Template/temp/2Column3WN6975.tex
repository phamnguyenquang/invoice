...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amy Lee  Nilsson} \\
		{\large Nicole 78}\\
		{\large 27064, San Francisco, Guangzhou, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daisy Amy  Forsberg Inc } \\
		{\large Piper 54}\\
		{\large 82454, Budapest, Kentucky, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
