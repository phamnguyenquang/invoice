...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Camden Victoria Sjöberg} \\
		{\large Gianna 17}\\
		{\large 11549, Milan, Ang Thong, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexa David Henriksson Inc } \\
		{\large Landon 25}\\
		{\large 83146, Frankfurt am Main , Hessen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
