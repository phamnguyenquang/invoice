...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Richard Kate 	 Löfgren} \\
		{\large Zachary 86}\\
		{\large 10356, Vancouver, Kentucky, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evelyn John Hedlund Ltd } \\
		{\large Alexandra 44}\\
		{\large 70278, Frankfurt am Main , Chiang Mai, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
