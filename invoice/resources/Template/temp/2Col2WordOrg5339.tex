...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Margaret Samuelsson Inc} \\
		{\large Melody 63}\\
		{\large 47080, Hong Kong, Chiang Rai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaliyah Samuelsson } \\
		{\large Kendall 78}\\
		{\large 45471, Singapore, Bremen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
