...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madelyn Kate 	 Andersson} \\
		{\large Londyn 59}\\
		{\large 48259, Last Vegas, Saarland, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vanessa Jane Håkansson Ltd } \\
		{\large David 96}\\
		{\large 38549, Stuttgart, Guangzhou, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
