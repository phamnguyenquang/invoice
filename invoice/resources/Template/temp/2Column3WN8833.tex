...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly Edward Holmberg} \\
		{\large Ezra 22}\\
		{\large 95653, Los Angeles, Floria, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lincoln David Sandström Pte Ltd } \\
		{\large Isabelle 65}\\
		{\large 79728, Milan, Chai Nat, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
