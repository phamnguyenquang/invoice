...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cayden Edward Persson} \\
		{\large Vincent 20}\\
		{\large 73356, Toronto, California, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Khloe Ann  Åberg Pte Ltd } \\
		{\large Jesse 47}\\
		{\large 70771, San Francisco, Bayern, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
