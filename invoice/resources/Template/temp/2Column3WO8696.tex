...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Richard Robert Strömberg Corp} \\
		{\large Noah 50}\\
		{\large 29908, Tokyo, Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Parker Strömberg } \\
		{\large Sawyer 27}\\
		{\large 17549, Toronto, Buriam, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
