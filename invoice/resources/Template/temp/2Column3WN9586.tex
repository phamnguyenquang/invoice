...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonathan Anne Viklund} \\
		{\large Sophia 45}\\
		{\large 43918, Shanghai, Heibei, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harrison Thomas Gustafsson Pte Ltd } \\
		{\large James 8}\\
		{\large 73606, Frankfurt am Main , Ang Thong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
