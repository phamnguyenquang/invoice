...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alana May/Mae 	 Pettersson} \\
		{\large Ezra 8}\\
		{\large 31886, Barcelona, Indiana, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Logan Jane Jönsson Pte Ltd } \\
		{\large King 17}\\
		{\large 73220, Vancouver, Amnat Charoen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
