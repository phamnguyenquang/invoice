...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jameson Catherine  Andreasson} \\
		{\large Nevaeh 77}\\
		{\large 51838, Shanghai, Chiang Mai, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ava Jane Martinsson Corp } \\
		{\large Ashley 32}\\
		{\large 35547, SaiGon, Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
