...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alaina Hedlund} \\
		{\large Isaac 85}\\
		{\large 43438, Beijing, Saarland, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxon Catherine  Lindberg Pte Ltd } \\
		{\large Weston 78}\\
		{\large 99054, Frankfurt am Main , Chiang Mai, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
