...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles Fredriksson} \\
		{\large Julia 49}\\
		{\large 81130, Singapore, Seattles, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abraham James Ström Pte Ltd } \\
		{\large Colton 17}\\
		{\large 75237, Last Vegas, Amnat Charoen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
