...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope Claesson} \\
		{\large Ruby 22}\\
		{\large 70604, Florence, Chiang Mai, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalia Michael Fredriksson Pte Ltd } \\
		{\large Anthony 78}\\
		{\large 19191, Istanbul, Ang Thong, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
