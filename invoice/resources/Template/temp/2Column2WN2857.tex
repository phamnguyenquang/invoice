...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaden Berggren} \\
		{\large Zachary 88}\\
		{\large 50621, Nha Trang, Ang Thong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Edward Edward Axelsson Ltd } \\
		{\large Mark 65}\\
		{\large 22016, Milan, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
