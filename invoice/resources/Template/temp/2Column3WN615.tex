...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abel Christopher Sandström} \\
		{\large Scarlett 20}\\
		{\large 58375, Washington, Kentucky, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maya  Alexander  Engström Corp } \\
		{\large Rachel 44}\\
		{\large 78889, Dubai, Hessen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
