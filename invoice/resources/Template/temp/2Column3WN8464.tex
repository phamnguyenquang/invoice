...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jude James Dahlberg} \\
		{\large Cayden 32}\\
		{\large 61806, Dublin, Saarland, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Austin Victoria Henriksson Pte Ltd } \\
		{\large Nicole 8}\\
		{\large 33686, Last Vegas, Kentucky, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
