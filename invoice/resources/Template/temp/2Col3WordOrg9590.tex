...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grant Elizabeth 	 Johansson Inc} \\
		{\large Brielle 40}\\
		{\large 10399, Tokyo, Chai Nat, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Matthew Eliasson } \\
		{\large Norah 29}\\
		{\large 15949, Frankfurt am Main , Chiang Rai, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
