...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniela Christopher Lundqvist Pte Ltd} \\
		{\large Camila 11}\\
		{\large 90614, San Francisco, Chai Nat, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Logan Bergman } \\
		{\large Riley 17}\\
		{\large 50490, Last Vegas, Hessen, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
