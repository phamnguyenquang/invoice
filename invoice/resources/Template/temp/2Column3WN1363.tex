...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leonardo Christopher Lindström} \\
		{\large Eliana 97}\\
		{\large 97333, Sydney, Buriam, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaylee James Mattsson Ltd } \\
		{\large Madelyn 99}\\
		{\large 56626, Frankfurt am Main , Chiang Rai, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
