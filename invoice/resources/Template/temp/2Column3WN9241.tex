...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eliza Peter Danielsson} \\
		{\large Audrey 47}\\
		{\large 45818, Washington, Buriam, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Annabelle Jane Samuelsson Ltd } \\
		{\large Nathaniel 67}\\
		{\large 34061, New York , Binh Thuan, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
