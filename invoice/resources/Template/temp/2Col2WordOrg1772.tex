...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina Mattsson Pte Ltd} \\
		{\large Annabelle 92}\\
		{\large 31163, Melbourne, Ang Thong, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evan Bergström } \\
		{\large Rebecca 57}\\
		{\large 54357, Boston, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
