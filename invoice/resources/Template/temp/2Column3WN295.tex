...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jose May/Mae 	 Jakobsson} \\
		{\large Carson 81}\\
		{\large 99583, Hong Kong, Heibei, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryder Thomas Svensson Pte Ltd } \\
		{\large Jayce 50}\\
		{\large 84051, Venice, Saarland, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
