...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Claire May/Mae 	 Fredriksson Pte Ltd} \\
		{\large Aliyah 29}\\
		{\large 97357, Ho Chi Minh, California, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rylee Lundström } \\
		{\large Austin 62}\\
		{\large 13946, Stuttgart, Hamburg, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
