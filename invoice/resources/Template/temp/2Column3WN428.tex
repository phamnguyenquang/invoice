...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madison John Svensson} \\
		{\large Robert 34}\\
		{\large 84606, Tokyo, Bayern, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Steven Grace 	 Bergqvist Pte Ltd } \\
		{\large Sara 51}\\
		{\large 48769, Melbourne, Amnat Charoen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
