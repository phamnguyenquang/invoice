...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariana Åkesson} \\
		{\large Gracie 84}\\
		{\large 38780, Budapest, California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Autumn Robert Lindgren Ltd } \\
		{\large Ariel 52}\\
		{\large 85307, Barcelona, Binh Thuan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
