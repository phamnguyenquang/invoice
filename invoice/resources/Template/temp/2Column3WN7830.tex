...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Matthew Elizabeth 	 Eklund} \\
		{\large King 78}\\
		{\large 21496, Frankfurt am Main , Kentucky, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Trinity Anne Svensson Pte Ltd } \\
		{\large Axel 64}\\
		{\large 21028, Boston, Chai Nat, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
