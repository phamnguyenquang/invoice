...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian May/Mae 	 Svensson} \\
		{\large Skylar 99}\\
		{\large 48425, Paris, Saarland, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caleb Marie 	 Lindgren Corp } \\
		{\large Adalyn 38}\\
		{\large 75043, Los Angeles, Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
