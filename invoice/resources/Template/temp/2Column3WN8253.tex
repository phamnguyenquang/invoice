...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grayson Jane Lund} \\
		{\large Evan 17}\\
		{\large 35118, Moscow, Bremen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julian Anne Blomqvist Pte Ltd } \\
		{\large Jude 20}\\
		{\large 76870, Frankfurt am Main , Indiana, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
