...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Edward Christopher Bergman} \\
		{\large Rylee 42}\\
		{\large 97536, Singapore, Ang Thong, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tucker Marie 	 Lindberg Corp } \\
		{\large Eric 78}\\
		{\large 71423, Abu Dhabi, Amnat Charoen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
