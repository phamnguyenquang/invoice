...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Laila William Ekström} \\
		{\large Julianna 82}\\
		{\large 27637, Boston, Texas, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesse Victoria Andreasson Inc } \\
		{\large Lila 45}\\
		{\large 73992, Frankfurt am Main , Guangdong, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
