...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emery Christopher Ek Pte Ltd} \\
		{\large Logan 95}\\
		{\large 71657, Frankfurt am Main , Tuscany, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everett Nilsson } \\
		{\large Kaiden 84}\\
		{\large 71822, Shanghai, Hessen, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
