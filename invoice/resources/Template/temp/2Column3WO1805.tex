...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Robert Robert Arvidsson Pte Ltd} \\
		{\large Maximus 89}\\
		{\large 66282, Barcelona, khanh Hoa, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hudson Andreasson } \\
		{\large Riley 20}\\
		{\large 66099, Berlin, Huabei, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
