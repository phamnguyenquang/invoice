...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mariah Samuelsson} \\
		{\large Hannah 23}\\
		{\large 71474, Last Vegas, Guangdong, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brianna May/Mae 	 Mattsson Corp } \\
		{\large Owen 59}\\
		{\large 18317, Frankfurt am Main , Kentucky, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
