...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra Louise 	 Claesson} \\
		{\large Ariel 51}\\
		{\large 35916, Frankfurt am Main , Texas, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Damian Kate 	 Holmgren Inc } \\
		{\large Daisy 84}\\
		{\large 82584, Vienna, Amnat Charoen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
