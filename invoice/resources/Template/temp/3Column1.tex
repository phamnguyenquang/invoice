...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Swedish University of Agricultural Sciences} \\
		{\large Aiden 45}\\
		{\large 48850, Beijing, Amnat Charoen, France }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Victor Abrahamsson } \\
		{\large Kennedy 47}\\
		{\large 79469, Chicago, Hainan, South Korea}\\
    \switchcolumn
