...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayla James Bergström Ltd} \\
		{\large Christopher 13}\\
		{\large 35010, Stuttgart, Seattles, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonah Hermansson } \\
		{\large Vivian 52}\\
		{\large 89951, Munich, Hessen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
