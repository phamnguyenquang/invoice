...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Owen Victoria Blomqvist} \\
		{\large Reagan 57}\\
		{\large 28664, Dubai, Chiang Rai, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alice Peter Isaksson Inc } \\
		{\large Josephine 79}\\
		{\large 65084, San Francisco, Heibei, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
