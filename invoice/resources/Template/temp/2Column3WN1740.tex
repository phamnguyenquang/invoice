...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalyn Peter Nilsson} \\
		{\large Savannah 55}\\
		{\large 83943, Abu Dhabi, Hawaii, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sophia Victoria Hermansson Pte Ltd } \\
		{\large Ryker 33}\\
		{\large 95534, Munich, Amnat Charoen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
