...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leonardo Michael Öberg} \\
		{\large Graham 37}\\
		{\large 72024, Abu Dhabi, Bremen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryan William Fredriksson Corp } \\
		{\large Isaiah 73}\\
		{\large 49373, Istanbul, Hessen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
