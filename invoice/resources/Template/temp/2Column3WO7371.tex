...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Mary 	 Hermansson Pte Ltd} \\
		{\large Samantha 81}\\
		{\large 33372, Lisbon, Guangdong, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Morgan Gustafsson } \\
		{\large Nathaniel 86}\\
		{\large 86171, Bonn, Chiang Mai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
