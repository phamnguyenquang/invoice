...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mark Victoria Wikström} \\
		{\large Greyson 53}\\
		{\large 97606, Ho Chi Minh, Tuscany, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everly David Blomqvist Pte Ltd } \\
		{\large Declan 94}\\
		{\large 79622, Osaka, Indiana, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
