...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harmony Peter Norberg Ltd} \\
		{\large Katherine 51}\\
		{\large 90267, Frankfurt am Main , Amnat Charoen, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valeria Mohamed } \\
		{\large Sebastian 1}\\
		{\large 53937, Ho Chi Minh, Huabei, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
