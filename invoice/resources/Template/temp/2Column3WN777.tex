...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hailey Marie 	 Björk} \\
		{\large Grace 87}\\
		{\large 40001, Toronto, Chiang Rai, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grace Thomas Eklund Inc } \\
		{\large Adam 65}\\
		{\large 12405, Stuttgart, Ang Thong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
