...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elijah  Alexander  Samuelsson} \\
		{\large Emilia 63}\\
		{\large 46359, Munich, Saarland, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Skylar Jane Andersson Corp } \\
		{\large Melody 56}\\
		{\large 48772, Paris, California, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
