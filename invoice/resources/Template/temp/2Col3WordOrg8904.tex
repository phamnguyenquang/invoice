...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina Mary 	 Bengtsson Ltd} \\
		{\large Makenzie 29}\\
		{\large 99716, Amsterdam, Hessen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabrielle Abrahamsson } \\
		{\large Isaiah 83}\\
		{\large 69257, Moscow, Hessen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
