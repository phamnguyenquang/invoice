...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklyn Amy  Mattsson} \\
		{\large Alyssa 77}\\
		{\large 92424, Singapore, Hessen, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmanuel Thomas Bergström Pte Ltd } \\
		{\large Axel 73}\\
		{\large 69231, Last Vegas, Tuscany, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
