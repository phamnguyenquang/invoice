...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Audrey Hermansson} \\
		{\large Ryan 19}\\
		{\large 70408, Madrid, Guangdong, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley Ann  Fransson Pte Ltd } \\
		{\large Chase 57}\\
		{\large 92924, Melbourne, Chiang Rai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
