...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremiah Mary 	 Sundberg} \\
		{\large Isla 61}\\
		{\large 92262, Budapest, Chiang Rai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caden Marie 	 Persson Pte Ltd } \\
		{\large Isaiah 5}\\
		{\large 16333, Frankfurt am Main , Chiang Mai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
