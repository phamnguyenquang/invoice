...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Tokyo Medical and Dental University} \\
		{\large King 88}\\
		{\large 15032, Los Angeles, Binh Thuan, Denmark}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Juan Hedlund } \\
		{\large Alana 40}\\
		{\large 47399, Moscow, Chiang Mai, Switzerland}\\
    \switchcolumn
