...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity May/Mae 	 Lindqvist} \\
		{\large Hudson 98}\\
		{\large 27926, Amsterdam, Guangdong, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sophia Christopher Dahl Corp } \\
		{\large Mark 44}\\
		{\large 66892, Vienna, Guangdong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
