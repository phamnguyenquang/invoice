...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Olivia Louise 	 Lundqvist} \\
		{\large Katelyn 44}\\
		{\large 60880, Osaka, California, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathaniel Grace 	 Håkansson Ltd } \\
		{\large Alexa 73}\\
		{\large 21967, Madrid, Ang Thong, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
