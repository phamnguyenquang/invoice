...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jack James Blomqvist Corp} \\
		{\large Adalynn 28}\\
		{\large 24332, Istanbul, Chai Nat, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Nordin } \\
		{\large Ivan 84}\\
		{\large 67327, Ho Chi Minh, Amnat Charoen, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
