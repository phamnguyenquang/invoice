...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Izabella  Alexander  Strömberg Corp} \\
		{\large Payton 77}\\
		{\large 70845, Frankfurt am Main , Binh Thuan, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryleigh Ek } \\
		{\large Lillian 6}\\
		{\large 28237, Frankfurt am Main , Chiang Rai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
