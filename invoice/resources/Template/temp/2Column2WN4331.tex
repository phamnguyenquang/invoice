...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juliana Arvidsson} \\
		{\large Payton 55}\\
		{\large 28110, Osaka, Hainan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Penelope Victoria Mattsson Pte Ltd } \\
		{\large Samuel 49}\\
		{\large 29023, SaiGon, Floria, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
