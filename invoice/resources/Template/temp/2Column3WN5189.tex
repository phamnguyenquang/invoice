...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaylee Ann  Claesson} \\
		{\large Ellie 79}\\
		{\large 87634, Melbourne, Indiana, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christian Grace 	 Söderberg Ltd } \\
		{\large Aliyah 93}\\
		{\large 45662, Toronto, Binh Thuan, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
