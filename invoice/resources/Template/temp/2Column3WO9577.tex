...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maxwell Catherine  Wallin Pte Ltd} \\
		{\large Aidan 2}\\
		{\large 73467, Ho Chi Minh, khanh Hoa, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Damian Holmberg } \\
		{\large Paige 27}\\
		{\large 49637, Berlin, California, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
