...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Trinity Christopher Forsberg Pte Ltd} \\
		{\large Isla 30}\\
		{\large 23468, Toronto, Hawaii, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lillian Engström } \\
		{\large Mya 13}\\
		{\large 29585, San Francisco, Saarland, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
