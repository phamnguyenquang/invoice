...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stella Ann  Engström Ltd} \\
		{\large Jaxon 7}\\
		{\large 81771, Frankfurt am Main , California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sydney Axelsson } \\
		{\large Madison 44}\\
		{\large 16580, Los Angeles, Tuscany, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
