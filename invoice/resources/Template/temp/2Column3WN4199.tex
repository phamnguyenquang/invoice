...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Camila  Alexander  Hellström} \\
		{\large Alex 88}\\
		{\large 28374, Berlin, Hawaii, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Willow Catherine  Sandberg Inc } \\
		{\large Rebecca 5}\\
		{\large 30087, Frankfurt am Main , Hessen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
