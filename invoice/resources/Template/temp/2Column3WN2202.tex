...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sofia Christopher Magnusson} \\
		{\large Riley 25}\\
		{\large 16954, Frankfurt am Main , Phu Yen, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Peyton William Fredriksson Pte Ltd } \\
		{\large Jeremy 20}\\
		{\large 76006, Paris, Binh Thuan, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
