...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Camden Elizabeth 	 Bergman} \\
		{\large Juliana 67}\\
		{\large 98977, Shanghai, Seattles, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grayson  Alexander  Ahmed Ltd } \\
		{\large Isabelle 26}\\
		{\large 42073, Washington, khanh Hoa, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
