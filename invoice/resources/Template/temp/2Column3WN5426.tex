...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Arianna Louise 	 Lundberg} \\
		{\large Liam 75}\\
		{\large 89760, Moscow, Amnat Charoen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cameron Thomas Larsson Inc } \\
		{\large Nathan 99}\\
		{\large 14909, Ho Chi Minh, Henan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
