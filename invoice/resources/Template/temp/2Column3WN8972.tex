...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eli David Svensson} \\
		{\large Amy 70}\\
		{\large 92570, Frankfurt am Main , Huabei, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mary Catherine  Lindqvist Pte Ltd } \\
		{\large Mila 98}\\
		{\large 12191, Madrid, Binh Thuan, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
