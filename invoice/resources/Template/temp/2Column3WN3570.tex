...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaiden William Bergman} \\
		{\large Grace 85}\\
		{\large 69915, Florence, Binh Thuan, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalyn Amy  Larsson Pte Ltd } \\
		{\large Rylee 57}\\
		{\large 73881, Vancouver, Guangdong, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
