...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valentina Louise 	 Åberg Pte Ltd} \\
		{\large Liliana 96}\\
		{\large 37791, Frankfurt am Main , Bayern, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angel Pettersson } \\
		{\large Grace 31}\\
		{\large 48712, Last Vegas, Ang Thong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
