...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  London Gunnarsson} \\
		{\large Anna 58}\\
		{\large 39411, Ho Chi Minh, Guangdong, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Connor Christopher Söderberg Ltd } \\
		{\large Naomi 71}\\
		{\large 47445, Frankfurt am Main , Hamburg, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
