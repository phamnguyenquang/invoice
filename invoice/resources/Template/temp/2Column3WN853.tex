...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cameron Edward Axelsson} \\
		{\large Claire 44}\\
		{\large 92144, Stuttgart, Bangkok, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large King Jane Lindqvist Pte Ltd } \\
		{\large Ella 85}\\
		{\large 55114, Last Vegas, Huabei, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
