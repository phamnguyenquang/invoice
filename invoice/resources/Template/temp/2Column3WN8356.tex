...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emma Peter Nordström} \\
		{\large Weston 52}\\
		{\large 69383, SaiGon, Hessen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Braxton Michael Hassan Corp } \\
		{\large Norah 10}\\
		{\large 74093, Frankfurt am Main , Hawaii, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
