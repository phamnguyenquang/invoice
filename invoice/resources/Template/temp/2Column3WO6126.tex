...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zachary Ann  Lundin Corp} \\
		{\large Kennedy 69}\\
		{\large 74975, San Francisco, Buriam, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalie Eklund } \\
		{\large Makayla 49}\\
		{\large 53915, Frankfurt am Main , Amnat Charoen, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
