...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Benjamin Lundqvist} \\
		{\large Abigail 13}\\
		{\large 59715, San Francisco, khanh Hoa, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Delilah Louise 	 Öberg Ltd } \\
		{\large Kevin 77}\\
		{\large 61987, Florence, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
