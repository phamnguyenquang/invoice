...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Noah Robert Samuelsson} \\
		{\large Mila 2}\\
		{\large 20293, Stuttgart, Tuscany, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaitlyn Marie 	 Bergqvist Corp } \\
		{\large Jonah 36}\\
		{\large 73473, Berlin, Chiang Mai, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
