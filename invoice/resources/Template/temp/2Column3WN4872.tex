...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ethan Victoria Hellström} \\
		{\large Anna 37}\\
		{\large 21984, Budapest, Huabei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madelyn Rose 	 Gunnarsson Ltd } \\
		{\large Cora 49}\\
		{\large 16459, Beijing, Chiang Rai, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
