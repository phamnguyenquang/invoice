...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Xavier Jane Nordin} \\
		{\large Avery 72}\\
		{\large 13620, Shanghai, Chiang Mai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryan May/Mae 	 Olsson Inc } \\
		{\large Jonah 94}\\
		{\large 76422, Frankfurt am Main , Texas, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
