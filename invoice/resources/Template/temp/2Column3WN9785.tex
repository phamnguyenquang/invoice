...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hazel Catherine  Axelsson} \\
		{\large Liliana 58}\\
		{\large 76574, Abu Dhabi, Guangzhou, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Asher May/Mae 	 Danielsson Inc } \\
		{\large Claire 21}\\
		{\large 96427, Munich, Bangkok, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
