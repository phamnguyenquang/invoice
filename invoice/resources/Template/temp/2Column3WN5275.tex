...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Genesis May/Mae 	 Hansson} \\
		{\large Brian 52}\\
		{\large 93306, Dubai, Guangzhou, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Skylar Anne Johansson Corp } \\
		{\large Claire 22}\\
		{\large 50393, Frankfurt am Main , Seattles, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
