...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Addison Anne Bergqvist} \\
		{\large Summer 35}\\
		{\large 35161, Toronto, Binh Thuan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Oscar Grace 	 Engström Corp } \\
		{\large Valerie 4}\\
		{\large 30112, Ho Chi Minh, Indiana, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
