...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremy Jakobsson Pte Ltd} \\
		{\large Alexandra 28}\\
		{\large 19740, Florence, Hessen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Austin Viklund } \\
		{\large Avery 58}\\
		{\large 82750, Frankfurt am Main , Chai Nat, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
