...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alyssa Jane Gunnarsson} \\
		{\large Nora 40}\\
		{\large 54437, Budapest, Huabei, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anna Marie 	 Jakobsson Pte Ltd } \\
		{\large Camila 21}\\
		{\large 16713, Frankfurt am Main , California, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
