...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Landon Louise 	 Pålsson} \\
		{\large Calvin 84}\\
		{\large 17342, Melbourne, Guangdong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Chase Victoria Arvidsson Corp } \\
		{\large Genesis 83}\\
		{\large 32271, Ho Chi Minh, Hessen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
