...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alana Christopher Jansson} \\
		{\large Matthew 72}\\
		{\large 72668, Abu Dhabi, Henan, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luca Grace 	 Nordin Pte Ltd } \\
		{\large Harmony 68}\\
		{\large 79173, Los Angeles, Guangdong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
