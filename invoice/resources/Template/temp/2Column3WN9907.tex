...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Weston Jane Björklund} \\
		{\large Angelina 80}\\
		{\large 45491, Munich, Indiana, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxson Peter Engström Pte Ltd } \\
		{\large Natalia 24}\\
		{\large 53750, Frankfurt am Main , Ang Thong, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
