...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mckenzie Louise 	 Viklund} \\
		{\large Aiden 5}\\
		{\large 16275, Istanbul, Guangdong, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicole Elizabeth 	 Nilsson Inc } \\
		{\large Austin 2}\\
		{\large 78673, Taipei, California, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
