...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Taylor  Alexander  Fredriksson} \\
		{\large Tyler 31}\\
		{\large 37989, Singapore, Chai Nat, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luca Grace 	 Pettersson Pte Ltd } \\
		{\large Abigail 90}\\
		{\large 80594, Chicago, Heibei, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
