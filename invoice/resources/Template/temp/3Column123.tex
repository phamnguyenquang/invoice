...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Paul Valéry University, Montpellier III} \\
		{\large Olivia 31}\\
		{\large 12692, London , Amnat Charoen, United Kingdom}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Alex Sjögren } \\
		{\large Daniela 24}\\
		{\large 25967, San Francisco, Guangdong, United State }\\
    \switchcolumn
