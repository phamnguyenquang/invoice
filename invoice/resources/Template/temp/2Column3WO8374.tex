...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie Grace 	 Lundqvist Pte Ltd} \\
		{\large Cole 16}\\
		{\large 84053, Amsterdam, khanh Hoa, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Richard Sjöberg } \\
		{\large Skylar 86}\\
		{\large 48948, Montreal, Bangkok, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
