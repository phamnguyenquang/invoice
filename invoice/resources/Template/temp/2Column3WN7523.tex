...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madison Victoria Åkesson} \\
		{\large Mila 33}\\
		{\large 51727, Last Vegas, Buriam, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Noah Marie 	 Hedlund Corp } \\
		{\large Evan 4}\\
		{\large 97277, Frankfurt am Main , Bangkok, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
