...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eleanor Thomas Abrahamsson} \\
		{\large Amir 74}\\
		{\large 82775, Vancouver, Kentucky, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Malachi Louise 	 Eliasson Ltd } \\
		{\large Nicholas 66}\\
		{\large 50540, Dublin, Chai Nat, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
