...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Morgan Catherine  Karlsson Pte Ltd} \\
		{\large Colin 57}\\
		{\large 60417, Los Angeles, Bangkok, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everett Arvidsson } \\
		{\large Ryker 77}\\
		{\large 47252, Abu Dhabi, Bayern, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
