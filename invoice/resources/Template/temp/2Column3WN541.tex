...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alaina Jane Fransson} \\
		{\large Hadley 32}\\
		{\large 76016, Frankfurt am Main , Chiang Mai, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aliyah James Nilsson Inc } \\
		{\large Micah 74}\\
		{\large 18963, Singapore, Hamburg, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
