...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Landon Samuelsson Pte Ltd} \\
		{\large Sawyer 50}\\
		{\large 98205, Barcelona, California, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Blake Eriksson } \\
		{\large Maximus 34}\\
		{\large 75228, Amsterdam, California, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
