...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremy Arvidsson} \\
		{\large Asher 72}\\
		{\large 36884, Los Angeles, Guangdong, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn May/Mae 	 Andreasson Pte Ltd } \\
		{\large Jennifer 37}\\
		{\large 73693, New York , Chai Nat, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
