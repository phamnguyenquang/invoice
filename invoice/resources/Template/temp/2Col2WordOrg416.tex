...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melody Andersson Pte Ltd} \\
		{\large Christopher 33}\\
		{\large 54518, Denver, Saarland, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Londyn Lindström } \\
		{\large Gabriella 22}\\
		{\large 29509, Istanbul, Bangkok, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
