...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of North Carolina at Greensboro} \\
		{\large Ivan 9}\\
		{\large 46437, Hong Kong, Henan, Denmark}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Katherine Nyberg } \\
		{\large Isaac 14}\\
		{\large 12708, Los Angeles, Tuscany, Singapore}\\
    \switchcolumn
