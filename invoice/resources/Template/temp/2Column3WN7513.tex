...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vanessa Louise 	 Björk} \\
		{\large Gavin 19}\\
		{\large 32181, Singapore, Phu Yen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Savannah  Alexander  Johansson Ltd } \\
		{\large Carlos 33}\\
		{\large 41290, Budapest, Henan, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
