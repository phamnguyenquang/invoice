...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Chase Robert Berglund} \\
		{\large Tucker 92}\\
		{\large 71948, Berlin, Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julia Louise 	 Olsson Ltd } \\
		{\large Mya 26}\\
		{\large 78493, San Francisco, Bremen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
