...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Anthony Michael Karlsson} \\
		{\large Taylor 51}\\
		{\large 96319, Berlin, Seattles, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalia David Söderberg Ltd } \\
		{\large Jonathan 13}\\
		{\large 56042, Boston, Chiang Rai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
