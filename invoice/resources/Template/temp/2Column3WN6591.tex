...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexander Anne Bergman} \\
		{\large Chloe 29}\\
		{\large 54199, Vienna, Chai Nat, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julianna Robert Persson Ltd } \\
		{\large Ellie 61}\\
		{\large 59527, Taipei, Chiang Rai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
