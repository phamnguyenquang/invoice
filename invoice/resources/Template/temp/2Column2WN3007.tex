...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezekiel Andreasson} \\
		{\large Quinn 3}\\
		{\large 72340, Sydney, Binh Thuan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aurora Louise 	 Axelsson Ltd } \\
		{\large Eli 16}\\
		{\large 54080, Barcelona, Guangdong, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
