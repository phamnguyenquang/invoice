...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hunter Louise 	 Olofsson} \\
		{\large Autumn 33}\\
		{\large 95318, Last Vegas, Hessen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katelyn Rose 	 Arvidsson Inc } \\
		{\large Kennedy 96}\\
		{\large 33146, Washington, Hessen, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
