...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Claire  Alexander  Lindholm Inc} \\
		{\large Miles 25}\\
		{\large 81509, Abu Dhabi, Guangdong, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melody Håkansson } \\
		{\large Caden 52}\\
		{\large 63225, Paris, Ang Thong, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
