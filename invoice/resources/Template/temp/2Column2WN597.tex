...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Faith Lindholm} \\
		{\large Khloe 24}\\
		{\large 86603, San Francisco, Guangdong, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley Edward Jönsson Ltd } \\
		{\large Bryson 26}\\
		{\large 27052, Frankfurt am Main , Chiang Rai, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
