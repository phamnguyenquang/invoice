...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tucker Jane Andreasson Pte Ltd} \\
		{\large Jesus 61}\\
		{\large 10422, Frankfurt am Main , Hainan, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Söderberg } \\
		{\large Mackenzie 72}\\
		{\large 43938, Denver, Hainan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
