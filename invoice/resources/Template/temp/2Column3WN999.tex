...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lilly Peter Fredriksson} \\
		{\large Gabrielle 14}\\
		{\large 14056, Frankfurt am Main , Henan, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas Peter Eriksson Pte Ltd } \\
		{\large Daniela 39}\\
		{\large 36247, Vienna, Hawaii, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
