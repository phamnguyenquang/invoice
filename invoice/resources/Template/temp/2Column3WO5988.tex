...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Camila David Löfgren Pte Ltd} \\
		{\large Andrew 60}\\
		{\large 55768, Frankfurt am Main , Seattles, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Allison Gustafsson } \\
		{\large Ryder 88}\\
		{\large 93223, Moscow, Bayern, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
