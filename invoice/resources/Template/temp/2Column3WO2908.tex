...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leonardo Victoria Axelsson Corp} \\
		{\large Jordan 51}\\
		{\large 11381, Nha Trang, khanh Hoa, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everly Lindström } \\
		{\large Valerie 22}\\
		{\large 47000, Istanbul, Guangzhou, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
