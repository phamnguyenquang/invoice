...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaden Andersson} \\
		{\large Carter 59}\\
		{\large 80361, Frankfurt am Main , Amnat Charoen, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Giovanni Christopher Bergqvist Corp } \\
		{\large Lily 7}\\
		{\large 81195, Hong Kong, Hawaii, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
