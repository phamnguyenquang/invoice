...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luke May/Mae 	 Lindqvist} \\
		{\large Paige 93}\\
		{\large 72599, London , Buriam, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson Jane Jansson Pte Ltd } \\
		{\large Landon 34}\\
		{\large 89484, Nha Trang, Guangdong, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
