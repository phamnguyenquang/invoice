...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Athena Engström Pte Ltd} \\
		{\large Calvin 85}\\
		{\large 25079, Last Vegas, California, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liam Sandström } \\
		{\large Sawyer 25}\\
		{\large 88132, Frankfurt am Main , California, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
