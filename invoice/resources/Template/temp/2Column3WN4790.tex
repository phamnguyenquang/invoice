...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Peyton Michael Eklund} \\
		{\large Jaxson 59}\\
		{\large 93426, Frankfurt am Main , Hawaii, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Annabelle Elizabeth 	 Bergqvist Corp } \\
		{\large Alexander 64}\\
		{\large 82069, Barcelona, Tuscany, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
