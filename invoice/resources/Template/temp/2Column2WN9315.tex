...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra Johansson} \\
		{\large Liliana 99}\\
		{\large 30398, Shanghai, Saarland, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Robert Kate 	 Samuelsson Pte Ltd } \\
		{\large Jeremy 84}\\
		{\large 65811, Beijing, Amnat Charoen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
