...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniela Thomas Dahlberg Inc} \\
		{\large Christopher 48}\\
		{\large 20026, SaiGon, Chiang Rai, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eden Wikström } \\
		{\large Willow 94}\\
		{\large 61900, San Francisco, Hamburg, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
