...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  David Marie 	 Ali} \\
		{\large Cora 29}\\
		{\large 65371, Moscow, California, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian Catherine  Åkesson Inc } \\
		{\large Alan 48}\\
		{\large 19743, Frankfurt am Main , Bayern, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
