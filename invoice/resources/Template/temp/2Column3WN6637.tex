...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Giovanni Mary 	 Hassan} \\
		{\large Violet 91}\\
		{\large 41549, Frankfurt am Main , Phu Yen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Graham Peter Jakobsson Ltd } \\
		{\large Cayden 20}\\
		{\large 17395, Singapore, Phu Yen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
