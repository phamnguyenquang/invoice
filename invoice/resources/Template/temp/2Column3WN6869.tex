...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Edward Lundqvist} \\
		{\large Morgan 60}\\
		{\large 87126, Singapore, khanh Hoa, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonah May/Mae 	 Lindqvist Inc } \\
		{\large Nicole 74}\\
		{\large 18713, Vienna, Ang Thong, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
