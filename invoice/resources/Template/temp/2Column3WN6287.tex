...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elizabeth Victoria Sundberg} \\
		{\large Silas 72}\\
		{\large 88917, Chicago, Henan, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aurora May/Mae 	 Martinsson Ltd } \\
		{\large Mateo 6}\\
		{\large 87958, Frankfurt am Main , Binh Thuan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
