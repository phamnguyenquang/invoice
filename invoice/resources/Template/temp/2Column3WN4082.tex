...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle Louise 	 Åberg} \\
		{\large Ashton 88}\\
		{\large 98978, Los Angeles, Henan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn Marie 	 Lundgren Inc } \\
		{\large Michael 17}\\
		{\large 32875, Last Vegas, California, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
