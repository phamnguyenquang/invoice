...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon Victoria Lindqvist Pte Ltd} \\
		{\large Andrew 3}\\
		{\large 29095, Melbourne, Buriam, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie Pålsson } \\
		{\large Maximus 68}\\
		{\large 92008, Berlin, Binh Thuan, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
