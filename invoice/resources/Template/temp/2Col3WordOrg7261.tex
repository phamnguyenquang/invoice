...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julian James Nordström Corp} \\
		{\large Miguel 94}\\
		{\large 91818, Nha Trang, Huabei, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabel Lindberg } \\
		{\large Mckenzie 50}\\
		{\large 33297, Los Angeles, Chai Nat, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
