...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rutgers University-New Brunswick} \\
		{\large Alex 26}\\
		{\large 84756, Taipei, Henan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kayla Lindström } \\
		{\large Paul 22}\\
		{\large 83017, Frankfurt am Main , Phu Yen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
