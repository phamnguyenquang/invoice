...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aliyah Marie 	 Martinsson} \\
		{\large Aidan 49}\\
		{\large 52151, Toronto, Amnat Charoen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniel David Mohamed Inc } \\
		{\large Blake 92}\\
		{\large 66023, Budapest, Floria, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
