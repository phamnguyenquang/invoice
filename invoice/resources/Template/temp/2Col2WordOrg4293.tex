...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Morgan Olsson Ltd} \\
		{\large Jason 33}\\
		{\large 76615, Frankfurt am Main , Ang Thong, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tyler Ekström } \\
		{\large Penelope 99}\\
		{\large 58828, Frankfurt am Main , Amnat Charoen, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
