...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jose Elizabeth 	 Abrahamsson} \\
		{\large Kenneth 66}\\
		{\large 31626, Montreal, Tuscany, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julian Thomas Holmberg Pte Ltd } \\
		{\large Sadie 60}\\
		{\large 48461, Berlin, Bangkok, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
