...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michelle Kate 	 Gunnarsson} \\
		{\large Angelina 61}\\
		{\large 58045, Frankfurt am Main , Ang Thong, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eden Grace 	 Andersson Ltd } \\
		{\large Isabella 14}\\
		{\large 39676, Amsterdam, Phu Yen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
