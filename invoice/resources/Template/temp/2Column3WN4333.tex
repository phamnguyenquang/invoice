...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Thomas John Bergman} \\
		{\large Jordyn 94}\\
		{\large 90189, Frankfurt am Main , Hessen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mya Christopher Viklund Ltd } \\
		{\large Sydney 73}\\
		{\large 13382, Last Vegas, Guangdong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
