...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Jakobsson} \\
		{\large Hailey 67}\\
		{\large 76861, Singapore, Texas, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Weston Ann  Gustafsson Ltd } \\
		{\large Oliver 92}\\
		{\large 13792, Hong Kong, Amnat Charoen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
