...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lily David Nordin} \\
		{\large Lila 43}\\
		{\large 56383, Stuttgart, California, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zachary Elizabeth 	 Jönsson Pte Ltd } \\
		{\large Rylee 86}\\
		{\large 50009, Seoul, Chai Nat, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
