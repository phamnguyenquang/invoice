...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Samantha Johansson Ltd} \\
		{\large Caden 6}\\
		{\large 30681, Hong Kong, Seattles, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leilani Lind } \\
		{\large Daniela 95}\\
		{\large 47626, Frankfurt am Main , Chiang Mai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
