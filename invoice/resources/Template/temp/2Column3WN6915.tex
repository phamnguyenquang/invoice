...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Delilah Catherine  Andersson} \\
		{\large Nolan 40}\\
		{\large 38094, Istanbul, Texas, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liliana William Viklund Inc } \\
		{\large Paisley 22}\\
		{\large 64680, Vienna, Hamburg, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
