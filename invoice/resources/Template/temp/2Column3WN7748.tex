...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carlos Marie 	 Lundgren} \\
		{\large Daniel 62}\\
		{\large 94067, Montreal, Chiang Mai, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nevaeh Christopher Wallin Inc } \\
		{\large Bryan 51}\\
		{\large 88319, Melbourne, Chiang Mai, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
