...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ivan Amy  Lindgren} \\
		{\large Connor 42}\\
		{\large 97703, Montreal, Binh Thuan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Noah  Alexander  Nyström Pte Ltd } \\
		{\large Bryan 70}\\
		{\large 16241, London , Tuscany, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
