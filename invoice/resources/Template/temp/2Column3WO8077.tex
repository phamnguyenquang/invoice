...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adrian Christopher Forsberg Ltd} \\
		{\large George 26}\\
		{\large 40720, Lisbon, Chiang Rai, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas Isaksson } \\
		{\large Mason 26}\\
		{\large 48917, Frankfurt am Main , Indiana, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
