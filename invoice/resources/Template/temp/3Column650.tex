...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  King Abdullah University of Science and Technology	Saudi} \\
		{\large Jonah 34}\\
		{\large 55731, Chicago, Guangzhou, United State }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Noah Jakobsson } \\
		{\large Amelia 84}\\
		{\large 16481, Dubai, Henan, Italy }\\
    \switchcolumn
