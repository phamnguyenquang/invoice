...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luke Anne Samuelsson} \\
		{\large Penelope 13}\\
		{\large 69352, Frankfurt am Main , Floria, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julia  Alexander  Lindström Inc } \\
		{\large Carson 77}\\
		{\large 89516, Amsterdam, Guangdong, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
