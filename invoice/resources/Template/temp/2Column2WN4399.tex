...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Mårtensson} \\
		{\large Colin 54}\\
		{\large 75509, Los Angeles, Bremen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Roman Louise 	 Nordström Pte Ltd } \\
		{\large Kingston 49}\\
		{\large 20649, Istanbul, Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
