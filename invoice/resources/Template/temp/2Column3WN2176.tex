...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eliza Edward Abrahamsson} \\
		{\large Ryker 70}\\
		{\large 11345, Hong Kong, Chiang Mai, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mckenzie Edward Andreasson Pte Ltd } \\
		{\large Alexis 49}\\
		{\large 22385, Berlin, Buriam, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
