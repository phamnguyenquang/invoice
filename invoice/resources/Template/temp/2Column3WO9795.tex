...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  John Elizabeth 	 Lundgren Pte Ltd} \\
		{\large Carter 27}\\
		{\large 33351, Frankfurt am Main , Bangkok, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Declan Axelsson } \\
		{\large Jaden 34}\\
		{\large 14878, Abu Dhabi, Hamburg, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
