...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sadie Louise 	 Lundqvist Corp} \\
		{\large Khloe 9}\\
		{\large 46842, Frankfurt am Main , Huabei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Layla Bergström } \\
		{\large Caleb 61}\\
		{\large 74396, Nha Trang, Hessen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
