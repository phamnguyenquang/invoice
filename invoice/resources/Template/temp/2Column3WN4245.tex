...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Morgan Rose 	 Eriksson} \\
		{\large Ella 88}\\
		{\large 44114, Hanoi, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elias Mary 	 Danielsson Corp } \\
		{\large Aaron 97}\\
		{\large 11192, Frankfurt am Main , Binh Thuan, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
