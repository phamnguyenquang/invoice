...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Damian Victoria Hassan} \\
		{\large Isla 11}\\
		{\large 92162, Frankfurt am Main , Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ian Catherine  Forsberg Inc } \\
		{\large Tristan 79}\\
		{\large 25972, Seoul, Texas, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
