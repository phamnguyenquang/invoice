...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rose Marie 	 Arvidsson} \\
		{\large Amelia 87}\\
		{\large 67869, Ho Chi Minh, Texas, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Catherine  Hansson Inc } \\
		{\large Ellie 47}\\
		{\large 71514, New York , Amnat Charoen, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
