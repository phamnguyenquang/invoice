...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Micah Grace 	 Hellström} \\
		{\large Reese 89}\\
		{\large 36440, Madrid, Henan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ellie Jane Hellström Ltd } \\
		{\large Aaron 44}\\
		{\large 13309, Frankfurt am Main , Bangkok, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
