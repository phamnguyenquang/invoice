...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lila Victoria Ekström} \\
		{\large Kayla 23}\\
		{\large 84597, Washington, Chai Nat, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Calvin Marie 	 Hermansson Ltd } \\
		{\large Aubree 11}\\
		{\large 27031, Frankfurt am Main , Chiang Rai, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
