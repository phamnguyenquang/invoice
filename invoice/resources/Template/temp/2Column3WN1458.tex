...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kenneth Amy  Lundberg} \\
		{\large Bella 19}\\
		{\large 27143, Munich, Guangzhou, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Thomas Ström Pte Ltd } \\
		{\large Dylan 79}\\
		{\large 20431, Vancouver, khanh Hoa, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
