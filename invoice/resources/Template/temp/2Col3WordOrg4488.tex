...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope Louise 	 Hellström Pte Ltd} \\
		{\large Zoey 37}\\
		{\large 56019, Ho Chi Minh, Phu Yen, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luca Abrahamsson } \\
		{\large Allison 87}\\
		{\large 18051, Abu Dhabi, Ang Thong, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
