...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katherine Elizabeth 	 Eriksson} \\
		{\large Khloe 97}\\
		{\large 94511, Munich, Tuscany, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Genesis Lee  Andreasson Inc } \\
		{\large Jason 66}\\
		{\large 95025, Dubai, Chiang Rai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
