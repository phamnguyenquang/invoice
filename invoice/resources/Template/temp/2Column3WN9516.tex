...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valentina May/Mae 	 Hellström} \\
		{\large Bryce 3}\\
		{\large 97187, Budapest, Guangdong, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bradley Grace 	 Hansson Pte Ltd } \\
		{\large Penelope 33}\\
		{\large 74803, Frankfurt am Main , khanh Hoa, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
