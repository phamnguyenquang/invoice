...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everly William Jonsson Corp} \\
		{\large Carson 24}\\
		{\large 97469, Barcelona, Hessen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexander Hermansson } \\
		{\large Aubrey 84}\\
		{\large 57182, Ho Chi Minh, California, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
