...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isaiah Hansson} \\
		{\large Aiden 68}\\
		{\large 67173, Madrid, Buriam, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kenneth Christopher Fredriksson Pte Ltd } \\
		{\large Andrea 99}\\
		{\large 79759, Los Angeles, Bremen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
