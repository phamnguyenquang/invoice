...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vanessa  Alexander  Bengtsson Inc} \\
		{\large Anna 99}\\
		{\large 89522, Nha Trang, Bangkok, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon Lundgren } \\
		{\large Bennett 67}\\
		{\large 10163, Frankfurt am Main , Bangkok, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
