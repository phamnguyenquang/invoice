...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adeline Louise 	 Ali} \\
		{\large Athena 10}\\
		{\large 45201, San Francisco, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alan James Andersson Ltd } \\
		{\large Colin 5}\\
		{\large 70419, SaiGon, Binh Thuan, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
