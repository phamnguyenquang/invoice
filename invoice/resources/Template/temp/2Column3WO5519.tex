...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rebecca Thomas Larsson Pte Ltd} \\
		{\large Justin 23}\\
		{\large 50719, Denver, Guangdong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Max Blom } \\
		{\large Alana 40}\\
		{\large 90237, Frankfurt am Main , Bremen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
