...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tucker Christopher Forsberg Pte Ltd} \\
		{\large Izabella 57}\\
		{\large 66300, London , Guangzhou, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grace Bengtsson } \\
		{\large Brianna 60}\\
		{\large 28997, Florence, Indiana, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
