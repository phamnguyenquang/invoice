...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  James James Bergqvist} \\
		{\large Joshua 79}\\
		{\large 29021, Last Vegas, Henan, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Izabella Louise 	 Hermansson Corp } \\
		{\large Natalie 46}\\
		{\large 82830, Frankfurt am Main , Amnat Charoen, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
