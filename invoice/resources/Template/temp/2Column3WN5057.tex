...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle Christopher Ström} \\
		{\large Maddox 63}\\
		{\large 26423, Stuttgart, Heibei, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hunter Anne Abrahamsson Corp } \\
		{\large Leilani 36}\\
		{\large 15376, Florence, Ang Thong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
