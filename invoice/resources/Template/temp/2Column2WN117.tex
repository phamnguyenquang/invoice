...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liliana Lundin} \\
		{\large Chloe 34}\\
		{\large 74277, New York , Henan, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Annabelle Ann  Abrahamsson Pte Ltd } \\
		{\large Abel 82}\\
		{\large 72042, Frankfurt am Main , Binh Thuan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
