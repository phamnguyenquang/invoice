...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sydney Nyström} \\
		{\large Noah 39}\\
		{\large 38924, Tokyo, khanh Hoa, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anthony David Claesson Corp } \\
		{\large Connor 87}\\
		{\large 31648, Frankfurt am Main , Amnat Charoen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
