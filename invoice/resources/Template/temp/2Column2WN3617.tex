...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luis Blomqvist} \\
		{\large Katelyn 61}\\
		{\large 92045, San Francisco, Binh Thuan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grant Marie 	 Nordström Ltd } \\
		{\large Genesis 28}\\
		{\large 39916, Amsterdam, Seattles, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
