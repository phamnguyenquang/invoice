...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kennedy Edward Martinsson} \\
		{\large Brody 78}\\
		{\large 54299, Last Vegas, Amnat Charoen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabrielle Grace 	 Gustafsson Pte Ltd } \\
		{\large Natalia 28}\\
		{\large 28836, Montreal, Tuscany, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
