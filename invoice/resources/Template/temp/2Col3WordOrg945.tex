...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kenneth Marie 	 Gustafsson Pte Ltd} \\
		{\large Hannah 93}\\
		{\large 37928, Budapest, Kentucky, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaden Henriksson } \\
		{\large Jaxson 57}\\
		{\large 92599, Amsterdam, Chiang Mai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
