...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juliana James Danielsson} \\
		{\large Vincent 87}\\
		{\large 59120, Singapore, Bremen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sara Elizabeth 	 Månsson Pte Ltd } \\
		{\large Adeline 96}\\
		{\large 36661, New York , Saarland, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
