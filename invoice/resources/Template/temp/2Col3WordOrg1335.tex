...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Annabelle  Alexander  Hermansson Pte Ltd} \\
		{\large Levi 87}\\
		{\large 23429, Frankfurt am Main , Chai Nat, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Parker Ekström } \\
		{\large Stephanie 47}\\
		{\large 60618, Ho Chi Minh, Tuscany, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
