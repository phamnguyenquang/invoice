...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaron May/Mae 	 Eliasson} \\
		{\large Andrea 36}\\
		{\large 30850, Sydney, Saarland, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalynn  Alexander  Lund Pte Ltd } \\
		{\large Grant 6}\\
		{\large 19056, Abu Dhabi, Ang Thong, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
