...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everett James Danielsson Inc} \\
		{\large Riley 2}\\
		{\large 66389, Frankfurt am Main , Henan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leilani Eliasson } \\
		{\large Grayson 92}\\
		{\large 42698, Lisbon, Bangkok, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
