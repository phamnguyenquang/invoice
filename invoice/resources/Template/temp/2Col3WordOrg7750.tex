...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elise  Alexander  Forsberg Pte Ltd} \\
		{\large Abraham 40}\\
		{\large 11884, Nha Trang, khanh Hoa, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aliyah Pålsson } \\
		{\large Natalia 38}\\
		{\large 19825, San Francisco, Ang Thong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
