...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Louise 	 Berglund} \\
		{\large Ryan 26}\\
		{\large 94236, Toronto, Floria, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubrey Catherine  Berglund Pte Ltd } \\
		{\large Matthew 3}\\
		{\large 84328, London , khanh Hoa, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
