...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Malachi Mary 	 Mattsson} \\
		{\large Melody 27}\\
		{\large 25050, Amsterdam, Hawaii, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camila Robert Lindqvist Inc } \\
		{\large Diego 99}\\
		{\large 98312, Washington, Guangzhou, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
