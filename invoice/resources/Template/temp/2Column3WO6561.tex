...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eleanor May/Mae 	 Mårtensson Corp} \\
		{\large Kaiden 73}\\
		{\large 27827, Frankfurt am Main , Chiang Mai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bradley Strömberg } \\
		{\large Paisley 80}\\
		{\large 15574, Seoul, Seattles, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
