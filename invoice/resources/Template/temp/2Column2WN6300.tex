...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alaina Mattsson} \\
		{\large Leah 37}\\
		{\large 29824, Nha Trang, Buriam, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathan Christopher Nilsson Pte Ltd } \\
		{\large Brody 43}\\
		{\large 55037, Montreal, Buriam, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
