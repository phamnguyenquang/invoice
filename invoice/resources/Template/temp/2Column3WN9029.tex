...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aria Elizabeth 	 Danielsson} \\
		{\large Mackenzie 84}\\
		{\large 13808, Florence, Ang Thong, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katherine Michael Nordin Pte Ltd } \\
		{\large Savannah 72}\\
		{\large 58281, Madrid, Saarland, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
