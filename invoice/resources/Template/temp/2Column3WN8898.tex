...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ivan Elizabeth 	 Lundin} \\
		{\large Ximena 65}\\
		{\large 33375, Washington, Chiang Mai, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Molly May/Mae 	 Gunnarsson Pte Ltd } \\
		{\large Caroline 87}\\
		{\large 61221, Hanoi, Kentucky, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
