...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grant  Alexander  Strömberg Pte Ltd} \\
		{\large Oscar 19}\\
		{\large 67228, Singapore, Hamburg, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kai Sandberg } \\
		{\large George 31}\\
		{\large 11914, New York , Bangkok, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
