...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mckenzie Victoria Jansson} \\
		{\large Alexandra 44}\\
		{\large 35475, Amsterdam, Chai Nat, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Willow Kate 	 Åkesson Corp } \\
		{\large Wesley 15}\\
		{\large 95661, Chicago, Bangkok, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
