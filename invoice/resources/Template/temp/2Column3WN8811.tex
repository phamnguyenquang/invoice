...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ximena Peter Bergström} \\
		{\large Julianna 38}\\
		{\large 44173, Berlin, Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nevaeh Amy  Dahlberg Pte Ltd } \\
		{\large Daniel 27}\\
		{\large 19447, Florence, Chai Nat, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
