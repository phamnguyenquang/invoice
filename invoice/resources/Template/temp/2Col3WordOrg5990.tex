...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Xavier  Alexander  Berggren Corp} \\
		{\large Emmett 37}\\
		{\large 58482, SaiGon, Floria, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samantha Jonsson } \\
		{\large Alexandra 88}\\
		{\large 26064, Last Vegas, Kentucky, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
