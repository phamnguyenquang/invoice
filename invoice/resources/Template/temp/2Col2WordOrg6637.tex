...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harrison Andersson Pte Ltd} \\
		{\large Izabella 37}\\
		{\large 53360, Frankfurt am Main , Hainan, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camila Fredriksson } \\
		{\large Elijah 56}\\
		{\large 82773, Washington, Saarland, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
