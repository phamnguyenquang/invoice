...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Molly Peter Magnusson} \\
		{\large Mia 65}\\
		{\large 20272, Dublin, Buriam, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brayden Peter Blomqvist Pte Ltd } \\
		{\large Adalynn 92}\\
		{\large 67269, Frankfurt am Main , Chiang Rai, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
