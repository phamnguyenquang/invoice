...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isla  Alexander  Lindberg} \\
		{\large Chase 17}\\
		{\large 92823, Bonn, Chai Nat, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katherine Catherine  Björklund Corp } \\
		{\large Mariah 56}\\
		{\large 42848, Vancouver, Ang Thong, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
