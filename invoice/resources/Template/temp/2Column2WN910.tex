...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michael Söderberg} \\
		{\large Stella 27}\\
		{\large 32339, Frankfurt am Main , California, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Arianna Thomas Lundström Ltd } \\
		{\large Sawyer 12}\\
		{\large 74565, Dubai, Henan, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
