...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stephanie Louise 	 Fredriksson} \\
		{\large Addison 8}\\
		{\large 40620, Lisbon, Guangdong, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy  Alexander  Löfgren Inc } \\
		{\large Jesse 19}\\
		{\large 89593, Madrid, Hawaii, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
