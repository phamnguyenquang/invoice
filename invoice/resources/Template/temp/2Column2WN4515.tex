...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexander Löfgren} \\
		{\large Jaxon 34}\\
		{\large 76708, SaiGon, Binh Thuan, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariel Elizabeth 	 Blomqvist Corp } \\
		{\large Jameson 41}\\
		{\large 81248, San Francisco, Bayern, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
