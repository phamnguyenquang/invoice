...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lydia Michael Pettersson} \\
		{\large Liam 17}\\
		{\large 55342, Sydney, Floria, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kingston Jane Lind Corp } \\
		{\large Aaliyah 82}\\
		{\large 88943, San Francisco, Amnat Charoen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
