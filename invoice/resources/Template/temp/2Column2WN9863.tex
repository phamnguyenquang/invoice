...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryker Lindgren} \\
		{\large Gabrielle 9}\\
		{\large 98338, Seoul, Amnat Charoen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Miles Louise 	 Samuelsson Pte Ltd } \\
		{\large Marcus 84}\\
		{\large 82061, New York , Guangdong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
