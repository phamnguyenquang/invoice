...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Marie 	 Danielsson} \\
		{\large Ayden 9}\\
		{\large 82486, Paris, Binh Thuan, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Damian William Lundström Pte Ltd } \\
		{\large Naomi 32}\\
		{\large 95237, Beijing, Heibei, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
