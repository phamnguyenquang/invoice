...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Richard Mary 	 Sandberg} \\
		{\large Jayce 84}\\
		{\large 29211, Toronto, Chai Nat, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emilia Catherine  Abrahamsson Pte Ltd } \\
		{\large Nicholas 84}\\
		{\large 12973, Singapore, khanh Hoa, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
