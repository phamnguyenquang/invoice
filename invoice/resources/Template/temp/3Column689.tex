...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Montana - Missoula} \\
		{\large Kyle 15}\\
		{\large 77062, New York , California, Saudi Arabia }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Caden Jönsson } \\
		{\large Caleb 32}\\
		{\large 31303, San Francisco, Henan, South Korea}\\
    \switchcolumn
