...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michelle Jakobsson} \\
		{\large Kaiden 10}\\
		{\large 54268, Washington, Heibei, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bailey Louise 	 Holmberg Pte Ltd } \\
		{\large Jackson 2}\\
		{\large 44088, Frankfurt am Main , Buriam, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
