...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hadley James Jakobsson} \\
		{\large Angel 91}\\
		{\large 28142, Madrid, Phu Yen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abraham Edward Viklund Inc } \\
		{\large Maddox 41}\\
		{\large 86878, Frankfurt am Main , Bangkok, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
