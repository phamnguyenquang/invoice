...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vincent Catherine  Mohamed} \\
		{\large Melanie 89}\\
		{\large 22693, Nha Trang, California, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Diego  Alexander  Sundberg Corp } \\
		{\large Katherine 9}\\
		{\large 78627, Beijing, Texas, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
