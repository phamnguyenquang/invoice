...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maria  Alexander  Eklund} \\
		{\large Margaret 14}\\
		{\large 31561, Ho Chi Minh, Texas, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jordan Peter Sandberg Ltd } \\
		{\large Julian 34}\\
		{\large 54172, Barcelona, Guangdong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
