...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaden Kate 	 Lindberg} \\
		{\large Kaylee 25}\\
		{\large 89359, Frankfurt am Main , Guangdong, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sara Anne Lindholm Ltd } \\
		{\large Carlos 91}\\
		{\large 99251, Los Angeles, Hessen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
