...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery Eriksson} \\
		{\large Victor 61}\\
		{\large 15271, Last Vegas, Huabei, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Summer Edward Samuelsson Inc } \\
		{\large Kylie 96}\\
		{\large 54158, Frankfurt am Main , Hamburg, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
