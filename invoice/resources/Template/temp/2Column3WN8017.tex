...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Londyn Victoria Johansson} \\
		{\large Eliza 96}\\
		{\large 94326, Nha Trang, khanh Hoa, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Calvin Kate 	 Andersson Pte Ltd } \\
		{\large Wesley 30}\\
		{\large 81354, Hong Kong, Bayern, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
