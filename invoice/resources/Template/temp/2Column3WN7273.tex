...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Lee  Söderberg} \\
		{\large Victoria 48}\\
		{\large 82855, Istanbul, Huabei, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher  Alexander  Holmgren Ltd } \\
		{\large Aiden 73}\\
		{\large 63878, Dubai, Buriam, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
