...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Timothy Marie 	 Mattsson} \\
		{\large Elijah 85}\\
		{\large 99553, Budapest, Floria, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harmony Louise 	 Arvidsson Pte Ltd } \\
		{\large Emilia 70}\\
		{\large 67045, Toronto, Chiang Rai, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
