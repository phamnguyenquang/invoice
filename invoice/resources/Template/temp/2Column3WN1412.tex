...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ashton Amy  Hermansson} \\
		{\large Jace 69}\\
		{\large 15082, Milan, Chiang Mai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Santiago Jane Lundgren Pte Ltd } \\
		{\large Charlotte 59}\\
		{\large 10688, Hanoi, Ang Thong, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
