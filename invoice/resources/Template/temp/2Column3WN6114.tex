...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bentley Michael Lundström} \\
		{\large Ryleigh 67}\\
		{\large 74907, New York , khanh Hoa, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Blake Rose 	 Löfgren Corp } \\
		{\large Antonio 67}\\
		{\large 95465, London , Chiang Rai, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
