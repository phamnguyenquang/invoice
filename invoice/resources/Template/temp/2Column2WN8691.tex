...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Timothy Dahl} \\
		{\large Jake 76}\\
		{\large 42154, Frankfurt am Main , Hainan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sean William Andersson Pte Ltd } \\
		{\large Greyson 30}\\
		{\large 90625, Milan, Chiang Mai, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
