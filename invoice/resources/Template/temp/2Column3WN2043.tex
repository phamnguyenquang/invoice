...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Samantha James Hermansson} \\
		{\large Lucas 18}\\
		{\large 24595, SaiGon, Saarland, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nora Catherine  Nordström Inc } \\
		{\large Harrison 45}\\
		{\large 20461, Frankfurt am Main , Bangkok, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
