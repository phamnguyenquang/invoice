...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Parker Robert Sundberg} \\
		{\large Annabelle 86}\\
		{\large 16749, Los Angeles, Bangkok, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adam Christopher Blomqvist Pte Ltd } \\
		{\large Isabel 78}\\
		{\large 58260, Tokyo, Indiana, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
