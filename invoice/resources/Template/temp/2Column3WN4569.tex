...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexander Marie 	 Ekström} \\
		{\large Mariah 43}\\
		{\large 61968, Los Angeles, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Norah Peter Magnusson Pte Ltd } \\
		{\large Connor 65}\\
		{\large 46920, Moscow, Hainan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
