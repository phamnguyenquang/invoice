...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kai Nordin Inc} \\
		{\large Damian 64}\\
		{\large 88177, Frankfurt am Main , Seattles, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caden Fransson } \\
		{\large Harrison 62}\\
		{\large 11684, Frankfurt am Main , Buriam, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
