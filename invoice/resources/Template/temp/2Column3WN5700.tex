...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Christopher Blom} \\
		{\large Ashley 78}\\
		{\large 78477, New York , Bayern, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caroline Louise 	 Nyberg Corp } \\
		{\large Vanessa 69}\\
		{\large 88600, Washington, Chiang Rai, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
