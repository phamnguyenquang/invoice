...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Arianna May/Mae 	 Pettersson} \\
		{\large Hayden 11}\\
		{\large 38808, Last Vegas, Chiang Rai, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kyle Catherine  Hansen Corp } \\
		{\large Easton 34}\\
		{\large 25426, Nha Trang, Seattles, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
