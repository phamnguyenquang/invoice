...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Violet Olofsson} \\
		{\large Carter 83}\\
		{\large 40586, Frankfurt am Main , Chai Nat, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large George David Arvidsson Ltd } \\
		{\large Levi 16}\\
		{\large 11261, Dublin, Chiang Rai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
