...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alyssa Amy  Henriksson} \\
		{\large Brianna 88}\\
		{\large 41615, Last Vegas, Hawaii, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isaac William Björk Pte Ltd } \\
		{\large Jeremy 42}\\
		{\large 47616, Los Angeles, Indiana, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
