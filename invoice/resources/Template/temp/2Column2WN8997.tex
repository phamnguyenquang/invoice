...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daisy Hedlund} \\
		{\large Emilia 61}\\
		{\large 13311, Frankfurt am Main , Seattles, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christian John Dahlberg Ltd } \\
		{\large Brandon 48}\\
		{\large 90517, Istanbul, Chai Nat, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
