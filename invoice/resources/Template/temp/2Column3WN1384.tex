...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valerie Christopher Magnusson} \\
		{\large Antonio 45}\\
		{\large 25635, Dubai, Chiang Rai, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Khloe Elizabeth 	 Nyström Pte Ltd } \\
		{\large Braxton 13}\\
		{\large 28759, Madrid, Chai Nat, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
