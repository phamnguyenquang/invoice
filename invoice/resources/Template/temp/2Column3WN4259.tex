...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mia Victoria Nordin} \\
		{\large Damian 22}\\
		{\large 98391, Florence, Ang Thong, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makayla Christopher Andreasson Pte Ltd } \\
		{\large Hailey 8}\\
		{\large 21149, Toronto, Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
