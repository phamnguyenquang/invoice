...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ava Louise 	 Mårtensson} \\
		{\large Hunter 18}\\
		{\large 20548, Frankfurt am Main , Buriam, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caroline May/Mae 	 Fredriksson Inc } \\
		{\large Bradley 88}\\
		{\large 40217, Denver, Heibei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
