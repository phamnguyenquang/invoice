...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklyn Catherine  Fredriksson Ltd} \\
		{\large Izabella 82}\\
		{\large 61902, Frankfurt am Main , Bayern, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Molly Engström } \\
		{\large Violet 77}\\
		{\large 44569, New York , Chiang Mai, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
