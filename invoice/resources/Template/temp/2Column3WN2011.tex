...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalia May/Mae 	 Gunnarsson} \\
		{\large Miles 49}\\
		{\large 57881, Munich, Heibei, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmanuel Mary 	 Claesson Inc } \\
		{\large Maya 21}\\
		{\large 88429, Chicago, Chiang Rai, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
