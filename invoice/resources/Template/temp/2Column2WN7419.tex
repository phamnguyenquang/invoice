...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery Bergman} \\
		{\large Samantha 28}\\
		{\large 40907, San Francisco, Seattles, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vanessa May/Mae 	 Olsson Pte Ltd } \\
		{\large Aria 26}\\
		{\large 40527, Last Vegas, Floria, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
