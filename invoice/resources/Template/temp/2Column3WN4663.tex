...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Graham William Björklund} \\
		{\large Gabriel 78}\\
		{\large 32185, Toronto, Indiana, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison  Alexander  Björklund Ltd } \\
		{\large Christian 63}\\
		{\large 35254, Munich, Bremen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
