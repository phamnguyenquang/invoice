...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Palacký University Olomouc	Czech} \\
		{\large Christopher 90}\\
		{\large 55273, Lisbon, Hessen, Italy }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Ashley Hassan } \\
		{\large Ayden 9}\\
		{\large 59699, Tokyo, Chiang Rai, United Kingdom}\\
    \switchcolumn
