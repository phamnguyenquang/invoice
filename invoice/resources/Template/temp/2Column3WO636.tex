...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jasmine Louise 	 Lindberg Pte Ltd} \\
		{\large Makenzie 83}\\
		{\large 28865, Vancouver, Saarland, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madeline Sandberg } \\
		{\large Valeria 13}\\
		{\large 72458, Vienna, khanh Hoa, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
