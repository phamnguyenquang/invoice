...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aurora May/Mae 	 Berglund} \\
		{\large Christian 24}\\
		{\large 55462, Moscow, Huabei, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden Louise 	 Claesson Corp } \\
		{\large Bryan 13}\\
		{\large 11989, New York , Guangzhou, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
