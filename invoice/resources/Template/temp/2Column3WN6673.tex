...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline Louise 	 Strömberg} \\
		{\large Nicole 61}\\
		{\large 31993, Abu Dhabi, Hamburg, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maverick Catherine  Nordström Corp } \\
		{\large Tristan 90}\\
		{\large 30914, Barcelona, Henan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
