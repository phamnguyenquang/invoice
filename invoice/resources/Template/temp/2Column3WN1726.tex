...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brody  Alexander  Axelsson} \\
		{\large Kayla 35}\\
		{\large 46538, Hanoi, Phu Yen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isaiah Peter Lundin Pte Ltd } \\
		{\large Mckenzie 15}\\
		{\large 57556, Barcelona, Chiang Rai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
