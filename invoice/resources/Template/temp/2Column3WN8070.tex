...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Easton  Alexander  Fredriksson} \\
		{\large Theodore 18}\\
		{\large 33985, Washington, Guangzhou, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joshua Ann  Hansson Corp } \\
		{\large Mckenzie 7}\\
		{\large 42437, Lisbon, Ang Thong, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
