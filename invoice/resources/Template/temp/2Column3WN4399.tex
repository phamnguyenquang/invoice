...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Quinn Grace 	 Lundström} \\
		{\large Isabel 61}\\
		{\large 92370, San Francisco, Buriam, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexandra John Karlsson Corp } \\
		{\large Autumn 16}\\
		{\large 11780, Dubai, Chiang Mai, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
