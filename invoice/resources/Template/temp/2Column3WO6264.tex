...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everly Amy  Abrahamsson Inc} \\
		{\large Alexandra 37}\\
		{\large 28931, Munich, Floria, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Izabella Samuelsson } \\
		{\large Brady 21}\\
		{\large 22219, San Francisco, Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
