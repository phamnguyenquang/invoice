...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Piper Edward Lindgren} \\
		{\large Giovanni 58}\\
		{\large 49607, Barcelona, Guangdong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmett Thomas Sandström Corp } \\
		{\large Joshua 65}\\
		{\large 76737, Moscow, Amnat Charoen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
