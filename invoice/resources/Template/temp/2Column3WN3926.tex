...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Delilah Lee  Jonsson} \\
		{\large Lucy 90}\\
		{\large 56649, Amsterdam, Phu Yen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liliana Louise 	 Holm Pte Ltd } \\
		{\large Edward 87}\\
		{\large 24894, Stuttgart, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
