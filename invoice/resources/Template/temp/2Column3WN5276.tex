...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grace Marie 	 Lundström} \\
		{\large Paul 88}\\
		{\large 55249, Denver, Chiang Mai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sofia Louise 	 Lundgren Pte Ltd } \\
		{\large Margaret 34}\\
		{\large 23251, Chicago, Chiang Rai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
