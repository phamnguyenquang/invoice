...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery Ekström} \\
		{\large Izabella 62}\\
		{\large 50247, Frankfurt am Main , California, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ashley Thomas Fransson Pte Ltd } \\
		{\large Valeria 98}\\
		{\large 51457, Moscow, Amnat Charoen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
