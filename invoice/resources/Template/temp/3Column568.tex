...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Australian National University} \\
		{\large Paul 7}\\
		{\large 62656, Nha Trang, Guangzhou, ThaiLand}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Nevaeh Bergqvist } \\
		{\large Parker 54}\\
		{\large 93412, Abu Dhabi, Seattles, South Africa }\\
    \switchcolumn
