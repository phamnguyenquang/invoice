...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caleb Amy  Ström} \\
		{\large Sofia 67}\\
		{\large 34797, Frankfurt am Main , Amnat Charoen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn Robert Sjöberg Corp } \\
		{\large Jameson 15}\\
		{\large 65261, Minsk, Huabei, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
