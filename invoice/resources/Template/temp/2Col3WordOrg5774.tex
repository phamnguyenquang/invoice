...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Piper Marie 	 Nyström Pte Ltd} \\
		{\large Elena 76}\\
		{\large 97412, Washington, Amnat Charoen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michael Lundgren } \\
		{\large Riley 54}\\
		{\large 23661, Bonn, Indiana, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
