...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kinsley Victoria Henriksson} \\
		{\large Addison 73}\\
		{\large 35855, Hanoi, Hessen, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Arianna Anne Isaksson Pte Ltd } \\
		{\large Isabel 47}\\
		{\large 73763, Budapest, Seattles, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
