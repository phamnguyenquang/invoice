...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elise Louise 	 Viklund} \\
		{\large Hudson 34}\\
		{\large 37588, San Francisco, Kentucky, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Edward Anne Eriksson Ltd } \\
		{\large Aliyah 76}\\
		{\large 57939, Frankfurt am Main , Hamburg, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
