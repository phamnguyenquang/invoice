...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  AGH University of Science and Technology} \\
		{\large Violet 92}\\
		{\large 38048, Frankfurt am Main , Hawaii, Turkey }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Rylee Nyström } \\
		{\large John 91}\\
		{\large 81334, Shanghai, Chai Nat, France }\\
    \switchcolumn
