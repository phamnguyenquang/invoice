...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Christopher Olofsson} \\
		{\large Trinity 37}\\
		{\large 54909, Abu Dhabi, Ang Thong, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isaiah Mary 	 Blom Inc } \\
		{\large Carlos 58}\\
		{\large 90483, Montreal, Huabei, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
