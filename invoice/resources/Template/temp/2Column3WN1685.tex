...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brielle Edward Bergström} \\
		{\large Natalie 79}\\
		{\large 19535, Osaka, Buriam, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grayson Catherine  Samuelsson Pte Ltd } \\
		{\large Aiden 91}\\
		{\large 24918, Beijing, Chai Nat, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
