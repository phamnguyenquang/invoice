...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle Mary 	 Fredriksson} \\
		{\large John 70}\\
		{\large 70954, Last Vegas, Bangkok, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklyn Elizabeth 	 Lindqvist Ltd } \\
		{\large Trinity 50}\\
		{\large 72660, Madrid, Tuscany, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
