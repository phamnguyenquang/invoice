...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maximus Grace 	 Nordström} \\
		{\large Gabrielle 86}\\
		{\large 51655, Melbourne, Kentucky, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caleb Robert Wikström Ltd } \\
		{\large Ximena 64}\\
		{\large 91754, Ho Chi Minh, Kentucky, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
