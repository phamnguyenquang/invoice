...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Technion – Israel Institute of Technology} \\
		{\large Penelope 98}\\
		{\large 24110, Sydney, Bremen, United Kingdom}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Tyler Martinsson } \\
		{\large Victoria 94}\\
		{\large 11818, Dublin, Hessen, Switzerland}\\
    \switchcolumn
