...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Athena Kate 	 Johansson Pte Ltd} \\
		{\large Luis 98}\\
		{\large 39657, Frankfurt am Main , Indiana, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hunter Sjöberg } \\
		{\large Londyn 11}\\
		{\large 49887, Beijing, Texas, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
