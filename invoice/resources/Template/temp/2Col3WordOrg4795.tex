...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sophie Robert Gunnarsson Pte Ltd} \\
		{\large Angel 57}\\
		{\large 25126, Frankfurt am Main , Chiang Rai, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katelyn Pettersson } \\
		{\large Samuel 38}\\
		{\large 58730, Lisbon, Hainan, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
