...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victor James Karlsson} \\
		{\large Ryker 62}\\
		{\large 38969, Frankfurt am Main , Texas, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sean Edward Mårtensson Corp } \\
		{\large Brianna 2}\\
		{\large 13623, Dublin, Saarland, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
