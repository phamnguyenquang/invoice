...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stella Mary 	 Holm} \\
		{\large Elizabeth 77}\\
		{\large 61285, Ho Chi Minh, California, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremy Elizabeth 	 Larsson Corp } \\
		{\large Nicole 74}\\
		{\large 14945, Paris, khanh Hoa, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
