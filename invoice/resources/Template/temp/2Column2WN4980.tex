...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jackson Fredriksson} \\
		{\large Olivia 90}\\
		{\large 82578, Last Vegas, Chiang Rai, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalia Victoria Lindgren Inc } \\
		{\large Eva 49}\\
		{\large 45094, Florence, Binh Thuan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
