...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Genesis Christopher Andreasson} \\
		{\large Isabella 41}\\
		{\large 15707, Seoul, Heibei, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kayden Kate 	 Lindqvist Corp } \\
		{\large John 86}\\
		{\large 72020, Amsterdam, Tuscany, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
