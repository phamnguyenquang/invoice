...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hailey  Alexander  Lundström} \\
		{\large Kaleb 82}\\
		{\large 37457, Frankfurt am Main , Huabei, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Annabelle Grace 	 Öberg Ltd } \\
		{\large Jordyn 6}\\
		{\large 24238, Milan, Tuscany, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
