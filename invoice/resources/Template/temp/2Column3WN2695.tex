...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elena May/Mae 	 Björklund} \\
		{\large Brianna 50}\\
		{\large 58768, Toronto, Henan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anna John Björklund Ltd } \\
		{\large Caroline 76}\\
		{\large 80610, Hong Kong, California, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
