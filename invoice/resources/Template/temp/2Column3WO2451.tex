...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cora John Sjögren Pte Ltd} \\
		{\large Jocelyn 9}\\
		{\large 26236, Frankfurt am Main , Kentucky, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large David Öberg } \\
		{\large Valentina 93}\\
		{\large 97724, Minsk, California, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
