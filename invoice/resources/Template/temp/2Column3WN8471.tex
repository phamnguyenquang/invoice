...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Giovanni Elizabeth 	 Lundström} \\
		{\large Adeline 66}\\
		{\large 56044, Rome, Bangkok, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brody Christopher Holmgren Pte Ltd } \\
		{\large Athena 39}\\
		{\large 72500, Dubai, Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
