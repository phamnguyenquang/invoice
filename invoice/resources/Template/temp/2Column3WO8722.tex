...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina Louise 	 Jonsson Pte Ltd} \\
		{\large Riley 91}\\
		{\large 93086, Melbourne, Binh Thuan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madison Sjöberg } \\
		{\large Jude 17}\\
		{\large 89958, Berlin, Chiang Mai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
