...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michelle Michael Jakobsson} \\
		{\large Victor 12}\\
		{\large 42844, Frankfurt am Main , Amnat Charoen, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jake David Nyström Pte Ltd } \\
		{\large Jayce 77}\\
		{\large 66263, Moscow, Amnat Charoen, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
