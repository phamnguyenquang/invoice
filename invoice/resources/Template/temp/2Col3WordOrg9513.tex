...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elijah John Mårtensson Inc} \\
		{\large Sarah 81}\\
		{\large 90885, Istanbul, Guangdong, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella Bergman } \\
		{\large Alaina 21}\\
		{\large 18058, Madrid, Chiang Rai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
