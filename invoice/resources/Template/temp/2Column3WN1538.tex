...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zoey Kate 	 Sundberg} \\
		{\large Christian 29}\\
		{\large 60231, San Francisco, Amnat Charoen, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Giovanni Catherine  Lindqvist Inc } \\
		{\large Cole 96}\\
		{\large 59846, Singapore, Guangdong, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
