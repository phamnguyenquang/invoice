...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalyn William Strömberg} \\
		{\large Steven 42}\\
		{\large 60368, Frankfurt am Main , Guangzhou, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Autumn Mary 	 Björk Corp } \\
		{\large Lucy 52}\\
		{\large 14020, Ho Chi Minh, Buriam, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
