...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Michael Lundgren} \\
		{\large Genesis 41}\\
		{\large 34381, Beijing, Chiang Mai, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aiden Edward Lundin Pte Ltd } \\
		{\large Alexander 81}\\
		{\large 24099, Berlin, Henan, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
