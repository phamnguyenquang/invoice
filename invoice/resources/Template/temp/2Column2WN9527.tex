...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Max Månsson} \\
		{\large Zoe 88}\\
		{\large 33601, Sydney, Floria, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maverick William Andersson Ltd } \\
		{\large Ayden 62}\\
		{\large 73533, Frankfurt am Main , Buriam, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
