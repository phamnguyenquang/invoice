...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ethan Anne Åberg} \\
		{\large Brantley 91}\\
		{\large 85492, Frankfurt am Main , Huabei, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ethan Peter Hermansson Ltd } \\
		{\large Serenity 15}\\
		{\large 91433, Washington, Seattles, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
