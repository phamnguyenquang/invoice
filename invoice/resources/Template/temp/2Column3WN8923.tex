...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elijah Mary 	 Lundgren} \\
		{\large Norah 72}\\
		{\large 22712, Frankfurt am Main , Bremen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carson Rose 	 Abrahamsson Pte Ltd } \\
		{\large Jameson 37}\\
		{\large 82444, Frankfurt am Main , Saarland, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
