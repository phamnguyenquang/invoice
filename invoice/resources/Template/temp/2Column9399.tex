...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jameson Lindqvist Pte Ltd} \\
		{\large Marcus 16}\\
		{\large 30658, Frankfurt am Main , Bremen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rose Andreasson } \\
		{\large Nicholas 89}\\
		{\large 17251, San Francisco, Huabei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
