...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles John Nordin} \\
		{\large Victoria 53}\\
		{\large 64950, Montreal, Bremen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Benjamin Michael Blomqvist Corp } \\
		{\large Cole 60}\\
		{\large 29914, Frankfurt am Main , Buriam, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
