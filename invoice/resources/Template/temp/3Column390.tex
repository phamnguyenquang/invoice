...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  International School for Advanced Studies} \\
		{\large Destiny 1}\\
		{\large 37421, Melbourne, Hessen, Indonesia s}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Gavin Danielsson } \\
		{\large Kinsley 26}\\
		{\large 95103, Boston, Phu Yen, ThaiLand}\\
    \switchcolumn
