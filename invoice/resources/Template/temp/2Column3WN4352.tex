...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Scarlett Michael Mohamed} \\
		{\large Jesus 64}\\
		{\large 32710, Tokyo, Huabei, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Dominic John Lundgren Pte Ltd } \\
		{\large Maya 2}\\
		{\large 86512, Frankfurt am Main , Buriam, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
