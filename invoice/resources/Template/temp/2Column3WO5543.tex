...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cora Christopher Fredriksson Pte Ltd} \\
		{\large Maddox 75}\\
		{\large 58307, Sydney, Floria, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryson Ali } \\
		{\large Thomas 21}\\
		{\large 75015, San Francisco, Tuscany, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
