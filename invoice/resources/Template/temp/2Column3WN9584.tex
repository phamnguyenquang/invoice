...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Henry Victoria Samuelsson} \\
		{\large Luis 1}\\
		{\large 80392, Ho Chi Minh, Hessen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mckenzie Edward Magnusson Corp } \\
		{\large Jude 7}\\
		{\large 79200, Last Vegas, Hamburg, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
