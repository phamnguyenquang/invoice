...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall Christopher Gustafsson} \\
		{\large Aaron 75}\\
		{\large 81092, Melbourne, Chai Nat, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gianna Catherine  Lindström Inc } \\
		{\large Ariel 85}\\
		{\large 23164, Munich, Binh Thuan, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
