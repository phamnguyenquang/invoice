...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leah William Henriksson} \\
		{\large Caleb 49}\\
		{\large 32901, Istanbul, Bayern, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amelia William Blomqvist Ltd } \\
		{\large Mya 22}\\
		{\large 98577, Venice, Binh Thuan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
