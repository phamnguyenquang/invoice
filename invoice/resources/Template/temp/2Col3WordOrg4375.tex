...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Evan Victoria Blomqvist Corp} \\
		{\large Mary 11}\\
		{\large 96311, Chicago, Amnat Charoen, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Gunnarsson } \\
		{\large Theodore 77}\\
		{\large 46509, New York , Seattles, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
