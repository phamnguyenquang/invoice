...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nora Catherine  Nyberg} \\
		{\large Natalia 11}\\
		{\large 10965, Paris, Hamburg, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Levi Kate 	 Karlsson Pte Ltd } \\
		{\large Ariana 38}\\
		{\large 45499, Dubai, Amnat Charoen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
