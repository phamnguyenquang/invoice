...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mary Catherine  Bengtsson} \\
		{\large Alyssa 17}\\
		{\large 39726, Munich, khanh Hoa, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kinsley Edward Forsberg Inc } \\
		{\large Diego 51}\\
		{\large 57704, Toronto, Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
