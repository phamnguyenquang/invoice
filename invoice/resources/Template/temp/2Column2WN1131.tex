...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Easton Holmberg} \\
		{\large Lilly 94}\\
		{\large 90486, New York , Amnat Charoen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Quinn Catherine  Gustafsson Pte Ltd } \\
		{\large Reese 78}\\
		{\large 67118, Chicago, Bayern, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
