...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Miles John Blomqvist Pte Ltd} \\
		{\large Skylar 26}\\
		{\large 88951, Frankfurt am Main , Chiang Mai, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valerie Dahl } \\
		{\large Roman 9}\\
		{\large 18475, Dublin, Binh Thuan, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
