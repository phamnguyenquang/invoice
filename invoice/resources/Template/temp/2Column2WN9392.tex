...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Samuel Olofsson} \\
		{\large Michelle 41}\\
		{\large 54984, Los Angeles, Kentucky, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kendall Peter Sandberg Corp } \\
		{\large Edward 96}\\
		{\large 80085, Shanghai, Amnat Charoen, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
