...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Londyn John Gustafsson Ltd} \\
		{\large Elizabeth 70}\\
		{\large 64677, Chicago, California, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charles Wallin } \\
		{\large Khloe 6}\\
		{\large 98406, Frankfurt am Main , Seattles, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
