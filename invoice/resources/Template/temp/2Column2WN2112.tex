...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Blom} \\
		{\large Gracie 65}\\
		{\large 69266, Los Angeles, Heibei, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayden Marie 	 Andersson Corp } \\
		{\large Valerie 57}\\
		{\large 69572, Vancouver, Chiang Rai, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
