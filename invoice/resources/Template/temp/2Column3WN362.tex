...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jameson Ann  Johansson} \\
		{\large Adeline 71}\\
		{\large 46494, Frankfurt am Main , Hamburg, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zoe Michael Dahlberg Corp } \\
		{\large Gabriel 20}\\
		{\large 23756, Washington, California, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
