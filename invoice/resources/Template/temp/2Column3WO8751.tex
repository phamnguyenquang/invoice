...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicholas Michael Andersson Pte Ltd} \\
		{\large Jesus 97}\\
		{\large 44418, Barcelona, Texas, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalia Lindholm } \\
		{\large Kevin 52}\\
		{\large 37271, Los Angeles, khanh Hoa, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
