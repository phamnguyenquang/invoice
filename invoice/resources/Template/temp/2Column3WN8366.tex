...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Piper David Bergqvist} \\
		{\large Londyn 93}\\
		{\large 15357, San Francisco, Bayern, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie Amy  Söderberg Corp } \\
		{\large Lydia 15}\\
		{\large 62342, Berlin, Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
