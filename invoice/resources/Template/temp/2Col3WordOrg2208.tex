...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vincent May/Mae 	 Sandberg Pte Ltd} \\
		{\large Ryleigh 68}\\
		{\large 72573, Frankfurt am Main , Hainan, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mason Lindström } \\
		{\large Alana 36}\\
		{\large 55139, Bonn, Tuscany, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
