...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie Lundström Pte Ltd} \\
		{\large Everett 87}\\
		{\large 13241, San Francisco, Amnat Charoen, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Micah Pettersson } \\
		{\large Kylie 28}\\
		{\large 59669, Frankfurt am Main , Seattles, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
