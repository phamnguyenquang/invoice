...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sophie Claesson} \\
		{\large Cayden 39}\\
		{\large 54378, Istanbul, Buriam, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cameron William Andreasson Corp } \\
		{\large Arianna 97}\\
		{\large 67321, Lisbon, Binh Thuan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
