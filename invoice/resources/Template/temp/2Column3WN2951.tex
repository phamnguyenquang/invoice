...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cole Thomas Bengtsson} \\
		{\large Chase 66}\\
		{\large 34795, Paris, Amnat Charoen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jordyn Victoria Danielsson Pte Ltd } \\
		{\large Angel 5}\\
		{\large 58694, Osaka, Hawaii, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
