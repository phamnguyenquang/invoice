...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leilani Christopher Håkansson} \\
		{\large Sophie 13}\\
		{\large 56508, Venice, Bayern, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grant  Alexander  Andreasson Ltd } \\
		{\large Adalynn 19}\\
		{\large 72818, San Francisco, Bayern, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
