...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicholas Edward Abrahamsson} \\
		{\large Axel 65}\\
		{\large 89607, Frankfurt am Main , Binh Thuan, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hudson Peter Lindholm Ltd } \\
		{\large Brielle 73}\\
		{\large 72489, Ho Chi Minh, Bremen, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
