...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremy Christopher Björk Inc} \\
		{\large Ella 86}\\
		{\large 97703, San Francisco, Tuscany, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Norberg } \\
		{\large Ruby 65}\\
		{\large 65756, Ho Chi Minh, Hawaii, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
