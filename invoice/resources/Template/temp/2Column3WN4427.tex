...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Noah Louise 	 Lundberg} \\
		{\large Ariel 40}\\
		{\large 61788, Frankfurt am Main , Ang Thong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hannah Marie 	 Pålsson Inc } \\
		{\large Nolan 78}\\
		{\large 92977, Denver, Bremen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
