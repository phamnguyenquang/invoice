...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Khloe Sundberg} \\
		{\large Dominic 77}\\
		{\large 16376, Hanoi, Seattles, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxson Louise 	 Magnusson Pte Ltd } \\
		{\large Jonah 89}\\
		{\large 28689, Frankfurt am Main , Hamburg, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
