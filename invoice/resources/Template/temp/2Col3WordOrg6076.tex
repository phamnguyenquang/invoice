...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Faith David Håkansson Corp} \\
		{\large Emilia 89}\\
		{\large 58346, Nha Trang, Amnat Charoen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Holmberg } \\
		{\large Alice 82}\\
		{\large 25758, Minsk, Chai Nat, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
