...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bailey Grace 	 Karlsson} \\
		{\large Ayden 68}\\
		{\large 39832, Rome, Binh Thuan, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harmony Lee  Bergqvist Pte Ltd } \\
		{\large Kendall 18}\\
		{\large 96229, Barcelona, Guangzhou, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
