...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hailey Grace 	 Blomqvist} \\
		{\large Lucas 78}\\
		{\large 32821, Frankfurt am Main , Buriam, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grant  Alexander  Andersson Inc } \\
		{\large Kai 80}\\
		{\large 41691, Melbourne, Heibei, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
