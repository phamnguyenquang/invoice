...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Catherine Grace 	 Löfgren} \\
		{\large Margaret 97}\\
		{\large 32144, Dublin, Phu Yen, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camila Grace 	 Samuelsson Corp } \\
		{\large Aurora 27}\\
		{\large 56970, Nha Trang, California, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
