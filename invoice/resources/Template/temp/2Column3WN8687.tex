...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Noah Amy  Pettersson} \\
		{\large Stephanie 35}\\
		{\large 82956, Last Vegas, khanh Hoa, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caden William Lund Pte Ltd } \\
		{\large Nathaniel 87}\\
		{\large 27207, Boston, Seattles, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
