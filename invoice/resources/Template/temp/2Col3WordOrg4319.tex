...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Savannah Peter Lindholm Ltd} \\
		{\large Isla 98}\\
		{\large 30176, Barcelona, Hainan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Savannah Lindström } \\
		{\large Luke 44}\\
		{\large 76584, Frankfurt am Main , Tuscany, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
