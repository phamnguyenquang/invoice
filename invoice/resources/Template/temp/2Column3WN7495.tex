...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Morgan Louise 	 Jakobsson} \\
		{\large Abel 12}\\
		{\large 74305, Shanghai, Floria, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caroline Catherine  Mårtensson Pte Ltd } \\
		{\large Greyson 73}\\
		{\large 55984, Dublin, Indiana, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
