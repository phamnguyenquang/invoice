...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Timothy Thomas Lundberg} \\
		{\large Brielle 53}\\
		{\large 78969, Abu Dhabi, Bangkok, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmett Rose 	 Andersson Ltd } \\
		{\large Brooklynn 51}\\
		{\large 49833, Hanoi, Phu Yen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
