...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kyle Louise 	 Sjögren Pte Ltd} \\
		{\large Morgan 46}\\
		{\large 98405, Budapest, Indiana, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmanuel Abrahamsson } \\
		{\large Gavin 51}\\
		{\large 46522, Chicago, California, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
