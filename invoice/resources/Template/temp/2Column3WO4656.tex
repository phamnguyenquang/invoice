...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel May/Mae 	 Fredriksson Ltd} \\
		{\large Isabella 38}\\
		{\large 60274, Dublin, Amnat Charoen, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Graham Söderberg } \\
		{\large Isabelle 58}\\
		{\large 62358, Nha Trang, Bangkok, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
