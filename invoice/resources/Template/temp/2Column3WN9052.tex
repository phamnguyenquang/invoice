...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victor May/Mae 	 Pettersson} \\
		{\large Dylan 17}\\
		{\large 79015, San Francisco, Hamburg, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathaniel Michael Nyberg Pte Ltd } \\
		{\large Hannah 8}\\
		{\large 50667, Frankfurt am Main , Amnat Charoen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
