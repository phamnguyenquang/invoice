...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro William Lundström} \\
		{\large Lila 51}\\
		{\large 98747, New York , Tuscany, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesse William Hedlund Ltd } \\
		{\large Vanessa 77}\\
		{\large 32027, Shanghai, khanh Hoa, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
