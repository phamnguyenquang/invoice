...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christian Victoria Lundström Pte Ltd} \\
		{\large Julianna 33}\\
		{\large 96365, Shanghai, Kentucky, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brianna Lundström } \\
		{\large Natalia 30}\\
		{\large 13218, Beijing, Chiang Rai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
