...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michelle Michael Söderberg Ltd} \\
		{\large Emily 8}\\
		{\large 89559, Last Vegas, khanh Hoa, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Violet Andersson } \\
		{\large Nathan 36}\\
		{\large 69413, Dublin, Seattles, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
