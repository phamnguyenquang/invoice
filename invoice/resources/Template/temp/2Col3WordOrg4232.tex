...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexander Victoria Jansson Pte Ltd} \\
		{\large Kingston 64}\\
		{\large 96971, Moscow, khanh Hoa, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madison Andersson } \\
		{\large Maria 99}\\
		{\large 30258, San Francisco, Hessen, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
