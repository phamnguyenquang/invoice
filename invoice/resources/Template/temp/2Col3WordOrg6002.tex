...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon Christopher Johansson Pte Ltd} \\
		{\large Claire 58}\\
		{\large 16196, Florence, Indiana, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lilly Blomqvist } \\
		{\large Margaret 22}\\
		{\large 10069, Vancouver, khanh Hoa, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
