...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jordyn Elizabeth 	 Lindholm} \\
		{\large Declan 21}\\
		{\large 37640, Melbourne, Hainan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriel Thomas Eklund Pte Ltd } \\
		{\large Jaxson 66}\\
		{\large 50261, Lisbon, Bayern, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
