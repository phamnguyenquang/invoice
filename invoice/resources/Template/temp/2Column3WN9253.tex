...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremy John Samuelsson} \\
		{\large Adrian 13}\\
		{\large 42949, Moscow, Chiang Mai, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryleigh Edward Håkansson Inc } \\
		{\large Lucas 70}\\
		{\large 38975, Barcelona, Chai Nat, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
