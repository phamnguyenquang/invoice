...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paul Catherine  Nyberg} \\
		{\large Eleanor 13}\\
		{\large 86701, Toronto, Bremen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan Catherine  Isaksson Pte Ltd } \\
		{\large Joel 51}\\
		{\large 55091, Seoul, California, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
