...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juan Nordström} \\
		{\large Brooklynn 87}\\
		{\large 82636, Vancouver, Bayern, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Elizabeth 	 Samuelsson Ltd } \\
		{\large Elias 40}\\
		{\large 89407, Stuttgart, California, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
