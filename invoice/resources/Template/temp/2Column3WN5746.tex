...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalia Mary 	 Hedlund} \\
		{\large Destiny 93}\\
		{\large 45177, Denver, Chiang Mai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryan Edward Lundqvist Ltd } \\
		{\large Kaiden 40}\\
		{\large 94316, Hong Kong, Bremen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
