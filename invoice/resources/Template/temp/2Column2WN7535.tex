...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dominic Håkansson} \\
		{\large Patrick 8}\\
		{\large 40086, Frankfurt am Main , Hessen, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brian Victoria Bergqvist Inc } \\
		{\large Emmett 58}\\
		{\large 76544, Toronto, Binh Thuan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
