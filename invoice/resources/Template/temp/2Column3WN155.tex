...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bradley William Jönsson} \\
		{\large Savannah 60}\\
		{\large 42938, Nha Trang, Indiana, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Xavier Elizabeth 	 Björklund Pte Ltd } \\
		{\large Hailey 20}\\
		{\large 94624, Denver, Amnat Charoen, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
