...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina Ann  Hansson} \\
		{\large Riley 32}\\
		{\large 35805, Ho Chi Minh, Guangdong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Braxton William Lundberg Pte Ltd } \\
		{\large Valeria 77}\\
		{\large 61239, Chicago, Bangkok, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
