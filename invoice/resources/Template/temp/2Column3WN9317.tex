...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra Elizabeth 	 Gustafsson} \\
		{\large Leah 1}\\
		{\large 63300, Frankfurt am Main , Buriam, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gracie Edward Bergström Inc } \\
		{\large Levi 64}\\
		{\large 28853, Florence, Hawaii, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
