...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Connor Robert Pettersson} \\
		{\large Roman 6}\\
		{\large 19151, Rome, Chiang Rai, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evan Louise 	 Håkansson Inc } \\
		{\large Brooke 11}\\
		{\large 74734, Frankfurt am Main , Texas, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
