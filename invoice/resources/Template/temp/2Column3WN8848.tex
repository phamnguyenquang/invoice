...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jasmine Kate 	 Sundberg} \\
		{\large Bryan 10}\\
		{\large 13621, Last Vegas, Guangzhou, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriel Catherine  Bengtsson Pte Ltd } \\
		{\large Easton 80}\\
		{\large 69981, Dublin, Guangzhou, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
