...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eric Christopher Persson} \\
		{\large Micah 90}\\
		{\large 57536, Montreal, Chiang Rai, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wyatt Peter Sundberg Corp } \\
		{\large Eli 91}\\
		{\large 88678, Moscow, Amnat Charoen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
