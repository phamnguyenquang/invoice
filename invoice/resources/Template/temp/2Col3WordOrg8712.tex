...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juliana Michael Lindström Corp} \\
		{\large Piper 7}\\
		{\large 25645, Vienna, Heibei, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ruby Andreasson } \\
		{\large Isaiah 65}\\
		{\large 49464, Frankfurt am Main , Chiang Rai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
