...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Scarlett Christopher Gustafsson Ltd} \\
		{\large Reagan 11}\\
		{\large 62252, Nha Trang, Kentucky, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wesley Henriksson } \\
		{\large Jordan 76}\\
		{\large 79903, Denver, Phu Yen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
