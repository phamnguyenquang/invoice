...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aurora Grace 	 Lindgren} \\
		{\large Gabriel 91}\\
		{\large 81475, San Francisco, Seattles, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carlos Elizabeth 	 Sjöberg Pte Ltd } \\
		{\large Kaitlyn 53}\\
		{\large 81375, Dubai, Chai Nat, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
