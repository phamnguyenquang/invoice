...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jace Rose 	 Engström} \\
		{\large Emery 22}\\
		{\large 65449, Seoul, Hamburg, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emma William Fredriksson Pte Ltd } \\
		{\large Emily 90}\\
		{\large 58098, Hong Kong, Binh Thuan, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
