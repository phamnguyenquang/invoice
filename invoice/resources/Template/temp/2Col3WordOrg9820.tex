...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaden Thomas Hassan Ltd} \\
		{\large Cooper 45}\\
		{\large 21431, Frankfurt am Main , Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kayla Lund } \\
		{\large Hunter 43}\\
		{\large 86336, Vancouver, Huabei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
