...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Layla  Alexander  Löfgren Ltd} \\
		{\large Liliana 85}\\
		{\large 84368, Budapest, Saarland, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Athena Mattsson } \\
		{\large Joshua 86}\\
		{\large 72018, Frankfurt am Main , Amnat Charoen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
