...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kennedy Grace 	 Norberg} \\
		{\large Ivy 87}\\
		{\large 64960, Abu Dhabi, Indiana, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabella Edward Arvidsson Corp } \\
		{\large Sarah 17}\\
		{\large 24950, Florence, Amnat Charoen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
