...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of California, San Francisco} \\
		{\large Asher 86}\\
		{\large 17018, London , Chiang Rai, South Africa }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Daisy Lindberg } \\
		{\large Ethan 73}\\
		{\large 97573, Vancouver, California, Russia}\\
    \switchcolumn
