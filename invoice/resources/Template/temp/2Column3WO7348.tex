...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hudson  Alexander  Bergström Pte Ltd} \\
		{\large Logan 47}\\
		{\large 44945, Venice, khanh Hoa, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie Dahlberg } \\
		{\large Jake 67}\\
		{\large 67579, Frankfurt am Main , Guangzhou, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
