...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall Christopher Sandström} \\
		{\large Aubrey 61}\\
		{\large 21565, Beijing, Binh Thuan, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucy Victoria Olofsson Inc } \\
		{\large Stephanie 29}\\
		{\large 17268, Last Vegas, Hessen, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
