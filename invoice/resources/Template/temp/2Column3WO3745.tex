...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Annabelle May/Mae 	 Arvidsson Inc} \\
		{\large Daniela 23}\\
		{\large 21629, New York , Phu Yen, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lila Eliasson } \\
		{\large Layla 48}\\
		{\large 53552, Frankfurt am Main , Bayern, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
