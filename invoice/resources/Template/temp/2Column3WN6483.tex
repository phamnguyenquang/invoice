...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luna Louise 	 Lundqvist} \\
		{\large Andrew 27}\\
		{\large 75710, Washington, Tuscany, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicolas Edward Berg Ltd } \\
		{\large Kenneth 61}\\
		{\large 64680, Frankfurt am Main , Texas, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
