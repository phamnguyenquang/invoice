...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kevin Berggren} \\
		{\large Jocelyn 70}\\
		{\large 70301, Singapore, Floria, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Destiny Elizabeth 	 Lindström Pte Ltd } \\
		{\large Emily 1}\\
		{\large 98424, Frankfurt am Main , Hamburg, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
