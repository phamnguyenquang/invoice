...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jocelyn Kate 	 Sandström} \\
		{\large Peyton 65}\\
		{\large 59211, Lisbon, Huabei, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adam May/Mae 	 Jönsson Pte Ltd } \\
		{\large Amy 31}\\
		{\large 87519, Abu Dhabi, Saarland, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
