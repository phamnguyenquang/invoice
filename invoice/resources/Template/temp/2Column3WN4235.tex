...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Evan Rose 	 Lundin} \\
		{\large Christopher 82}\\
		{\large 76090, Minsk, Kentucky, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julianna Michael Danielsson Ltd } \\
		{\large Grayson 71}\\
		{\large 22269, Bonn, California, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
