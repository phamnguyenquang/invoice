...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle Hermansson} \\
		{\large Gabrielle 32}\\
		{\large 69384, Frankfurt am Main , Buriam, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathaniel Lee  Lindholm Pte Ltd } \\
		{\large Jack 70}\\
		{\large 13631, Los Angeles, Guangzhou, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
