...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicole James Håkansson} \\
		{\large Brianna 59}\\
		{\large 68188, Dublin, Bremen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juan Christopher Olsson Pte Ltd } \\
		{\large Aliyah 76}\\
		{\large 71475, San Francisco, Ang Thong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
