...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julianna Christopher Samuelsson Ltd} \\
		{\large Samuel 61}\\
		{\large 97109, Florence, Guangdong, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmanuel Gustafsson } \\
		{\large Maxwell 48}\\
		{\large 52214, Hong Kong, Huabei, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
