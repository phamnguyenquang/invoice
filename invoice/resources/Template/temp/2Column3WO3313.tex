...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Blake Thomas Hedlund Corp} \\
		{\large Annabelle 34}\\
		{\large 62027, Hong Kong, Hessen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mackenzie Åkesson } \\
		{\large Leonardo 15}\\
		{\large 43471, Frankfurt am Main , Chiang Mai, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
