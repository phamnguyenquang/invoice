...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vanessa Louise 	 Lundström} \\
		{\large Isabella 90}\\
		{\large 92956, Budapest, Hainan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hazel Catherine  Holmgren Ltd } \\
		{\large King 99}\\
		{\large 10750, Lisbon, Phu Yen, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
