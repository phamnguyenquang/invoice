...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Margaret Nordin Inc} \\
		{\large Timothy 92}\\
		{\large 54020, Frankfurt am Main , Saarland, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariel Svensson } \\
		{\large Alana 70}\\
		{\large 88740, San Francisco, Heibei, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
