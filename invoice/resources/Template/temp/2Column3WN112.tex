...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Austin Grace 	 Olofsson} \\
		{\large Kendall 67}\\
		{\large 15947, Frankfurt am Main , California, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore James Forsberg Ltd } \\
		{\large Andrew 1}\\
		{\large 21585, Moscow, Buriam, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
