...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eva Bergqvist} \\
		{\large Chloe 14}\\
		{\large 54420, Hong Kong, Chiang Mai, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariana Mary 	 Abrahamsson Corp } \\
		{\large Adriana 54}\\
		{\large 58009, Nha Trang, Hamburg, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
