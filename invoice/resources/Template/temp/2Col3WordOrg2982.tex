...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harper Thomas Jönsson Pte Ltd} \\
		{\large Zoe 67}\\
		{\large 78606, Vancouver, Kentucky, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eric Fredriksson } \\
		{\large Eliza 50}\\
		{\large 84643, Frankfurt am Main , Buriam, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
