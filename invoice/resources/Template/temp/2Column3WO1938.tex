...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elizabeth  Alexander  Andreasson Corp} \\
		{\large Mary 63}\\
		{\large 25921, Dublin, Heibei, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Silas Hansen } \\
		{\large Makenzie 28}\\
		{\large 72628, Frankfurt am Main , Chiang Rai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
