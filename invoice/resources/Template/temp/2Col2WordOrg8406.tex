...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elizabeth Hassan Pte Ltd} \\
		{\large King 77}\\
		{\large 44862, Frankfurt am Main , Hamburg, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melanie Pettersson } \\
		{\large Piper 78}\\
		{\large 43012, Istanbul, Floria, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
