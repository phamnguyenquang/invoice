...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jennifer Åkesson Ltd} \\
		{\large Lydia 61}\\
		{\large 92588, Frankfurt am Main , Amnat Charoen, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sawyer Mattsson } \\
		{\large Sophie 5}\\
		{\large 36140, San Francisco, Heibei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
