...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro Catherine  Lundgren Pte Ltd} \\
		{\large Kaden 31}\\
		{\large 99729, Abu Dhabi, Chai Nat, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Forsberg } \\
		{\large Kaden 21}\\
		{\large 19817, Venice, Heibei, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
