...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brielle Marie 	 Gunnarsson Ltd} \\
		{\large Jessica 21}\\
		{\large 47900, Frankfurt am Main , Heibei, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amy Johansson } \\
		{\large Miles 73}\\
		{\large 10340, Beijing, Guangdong, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
