...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eleanor Catherine  Sandberg} \\
		{\large Miguel 37}\\
		{\large 39357, Frankfurt am Main , khanh Hoa, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Jane Sjöberg Corp } \\
		{\large Parker 71}\\
		{\large 16887, Los Angeles, Buriam, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
