...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hayden Svensson} \\
		{\large Hunter 72}\\
		{\large 55918, Frankfurt am Main , Binh Thuan, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zoe  Alexander  Svensson Pte Ltd } \\
		{\large Ella 12}\\
		{\large 15768, San Francisco, Hawaii, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
