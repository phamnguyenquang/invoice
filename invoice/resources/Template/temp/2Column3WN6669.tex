...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklyn Catherine  Hedlund} \\
		{\large Juan 58}\\
		{\large 84191, Amsterdam, Phu Yen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan Louise 	 Ekström Inc } \\
		{\large Wesley 23}\\
		{\large 64148, SaiGon, Hessen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
