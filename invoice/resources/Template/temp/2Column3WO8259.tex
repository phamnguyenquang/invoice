...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayden  Alexander  Bergqvist Ltd} \\
		{\large Makenzie 82}\\
		{\large 36094, Berlin, Henan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samuel Abrahamsson } \\
		{\large Angel 32}\\
		{\large 69924, Montreal, Amnat Charoen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
