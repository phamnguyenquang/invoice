...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Samuel Robert Lundström Pte Ltd} \\
		{\large Delilah 56}\\
		{\large 80957, Budapest, Hessen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grant Henriksson } \\
		{\large Liliana 2}\\
		{\large 31908, Los Angeles, Hawaii, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
