...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Austin Rose 	 Gustafsson Ltd} \\
		{\large Eva 65}\\
		{\large 41351, San Francisco, Heibei, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jessica Jakobsson } \\
		{\large Abigail 50}\\
		{\large 70107, Abu Dhabi, Bangkok, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
