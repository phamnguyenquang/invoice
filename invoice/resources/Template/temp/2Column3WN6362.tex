...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ashton Marie 	 Magnusson} \\
		{\large Steven 20}\\
		{\large 22781, Taipei, Chiang Rai, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vanessa Christopher Månsson Inc } \\
		{\large Caden 3}\\
		{\large 58501, Stuttgart, Hainan, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
