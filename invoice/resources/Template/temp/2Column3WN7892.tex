...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alaina Christopher Holmberg} \\
		{\large Luca 1}\\
		{\large 71404, Washington, Tuscany, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elijah Victoria Lindgren Pte Ltd } \\
		{\large Eden 73}\\
		{\large 82809, Bonn, Bremen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
