...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lincoln Thomas Blomqvist} \\
		{\large Aidan 23}\\
		{\large 84292, Melbourne, Indiana, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathaniel Jane Andersson Pte Ltd } \\
		{\large Emmett 22}\\
		{\large 73445, Last Vegas, Huabei, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
