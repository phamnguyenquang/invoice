...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grayson Hassan} \\
		{\large Ivy 44}\\
		{\large 30079, Berlin, Hainan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan  Alexander  Holmgren Corp } \\
		{\large Aaron 10}\\
		{\large 43487, Frankfurt am Main , Chai Nat, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
