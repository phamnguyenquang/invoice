...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Blake Catherine  Mårtensson Ltd} \\
		{\large Eden 39}\\
		{\large 44280, Frankfurt am Main , Huabei, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carter Berglund } \\
		{\large Aubree 15}\\
		{\large 34953, Frankfurt am Main , California, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
