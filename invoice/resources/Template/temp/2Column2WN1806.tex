...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isaiah Holmberg} \\
		{\large Ximena 48}\\
		{\large 92371, Hanoi, Hessen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Marie 	 Karlsson Corp } \\
		{\large Luis 90}\\
		{\large 58491, Frankfurt am Main , Ang Thong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
