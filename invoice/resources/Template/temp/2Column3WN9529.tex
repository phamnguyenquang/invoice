...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joel Robert Forsberg} \\
		{\large Lilly 6}\\
		{\large 18456, Abu Dhabi, Bremen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maximus Elizabeth 	 Persson Inc } \\
		{\large Ethan 17}\\
		{\large 30917, Madrid, Amnat Charoen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
