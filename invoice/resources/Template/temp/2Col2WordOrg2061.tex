...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Pettersson Pte Ltd} \\
		{\large John 31}\\
		{\large 72326, Vancouver, Tuscany, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elizabeth Larsson } \\
		{\large Matthew 59}\\
		{\large 87129, Frankfurt am Main , Binh Thuan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
