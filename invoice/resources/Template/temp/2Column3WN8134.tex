...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kenneth Mary 	 Åberg} \\
		{\large Maddox 12}\\
		{\large 92495, Berlin, Hamburg, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Chase William Lundin Pte Ltd } \\
		{\large Elijah 16}\\
		{\large 31948, Singapore, Indiana, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
