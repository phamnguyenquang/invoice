...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Gustafsson} \\
		{\large Ella 65}\\
		{\large 34172, Istanbul, Kentucky, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Edward Victoria Martinsson Corp } \\
		{\large Julianna 96}\\
		{\large 15329, Minsk, Buriam, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
