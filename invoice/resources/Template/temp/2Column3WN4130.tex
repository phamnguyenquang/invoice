...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alyssa  Alexander  Nilsson} \\
		{\large Charlotte 37}\\
		{\large 39277, Istanbul, Bayern, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madelyn Marie 	 Danielsson Pte Ltd } \\
		{\large Wyatt 39}\\
		{\large 11106, Lisbon, California, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
