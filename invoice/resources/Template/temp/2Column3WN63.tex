...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Scarlett Amy  Hedlund} \\
		{\large Gael 48}\\
		{\large 93883, San Francisco, Seattles, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxson Anne Norberg Corp } \\
		{\large Jennifer 1}\\
		{\large 55616, Amsterdam, Binh Thuan, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
