...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tyler Nyström} \\
		{\large Jonah 21}\\
		{\large 12320, Berlin, California, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Owen  Alexander  Sandström Inc } \\
		{\large Steven 36}\\
		{\large 45667, Frankfurt am Main , Guangzhou, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
