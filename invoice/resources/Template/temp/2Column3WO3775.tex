...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sophie Marie 	 Lundin Pte Ltd} \\
		{\large Justin 89}\\
		{\large 44747, San Francisco, Tuscany, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniel Lundberg } \\
		{\large Genesis 9}\\
		{\large 61392, San Francisco, Indiana, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
