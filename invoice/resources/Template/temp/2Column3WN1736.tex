...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gracie Mary 	 Berggren} \\
		{\large Trinity 16}\\
		{\large 76180, Osaka, Chai Nat, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Greyson Christopher Viklund Inc } \\
		{\large Alan 2}\\
		{\large 97955, Abu Dhabi, Bremen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
