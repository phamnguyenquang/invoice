...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caleb Victoria Samuelsson} \\
		{\large Skylar 7}\\
		{\large 52489, SaiGon, Ang Thong, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Colton Christopher Hermansson Corp } \\
		{\large Harrison 7}\\
		{\large 90737, Last Vegas, Hamburg, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
