...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Anna Robert Larsson Corp} \\
		{\large Hadley 26}\\
		{\large 76852, Frankfurt am Main , Ang Thong, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte Hedlund } \\
		{\large Paisley 38}\\
		{\large 74957, Paris, Ang Thong, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
