...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalynn Jansson} \\
		{\large Jordyn 78}\\
		{\large 14586, Frankfurt am Main , Hamburg, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathaniel Louise 	 Andersson Pte Ltd } \\
		{\large Alejandro 8}\\
		{\large 16725, Boston, Indiana, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
