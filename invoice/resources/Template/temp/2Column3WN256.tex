...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mackenzie William Johansson} \\
		{\large James 69}\\
		{\large 84543, Amsterdam, Ang Thong, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jason Marie 	 Gustafsson Inc } \\
		{\large Harmony 77}\\
		{\large 28546, Budapest, Hessen, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
