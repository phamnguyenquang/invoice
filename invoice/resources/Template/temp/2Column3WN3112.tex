...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Miguel Jane Fredriksson} \\
		{\large Brody 82}\\
		{\large 53964, Frankfurt am Main , Chiang Mai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camden Peter Hermansson Inc } \\
		{\large Quinn 91}\\
		{\large 52685, Madrid, Hamburg, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
