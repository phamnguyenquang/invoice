...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adeline Hermansson Pte Ltd} \\
		{\large Declan 97}\\
		{\large 49432, San Francisco, Hainan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madison Öberg } \\
		{\large Elizabeth 90}\\
		{\large 40175, Frankfurt am Main , Chiang Mai, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
