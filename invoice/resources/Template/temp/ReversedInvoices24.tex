...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of California, Merced} \\
		{\large Alaina 78}\\
		{\large 68146, London , Chiang Rai, Canada }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Hazel Jönsson } \\
		{\large Silas 98}\\
		{\large 13311, Frankfurt am Main , Hessen, Switzerland}\\
    \switchcolumn
