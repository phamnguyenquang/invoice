...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Logan John Jonsson} \\
		{\large Elise 24}\\
		{\large 92269, Seoul, khanh Hoa, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josiah Catherine  Björklund Inc } \\
		{\large Christopher 86}\\
		{\large 99755, Shanghai, Guangzhou, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
