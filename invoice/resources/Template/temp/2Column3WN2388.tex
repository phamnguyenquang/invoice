...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Edward Peter Berggren} \\
		{\large Isabella 74}\\
		{\large 46600, Tokyo, Chiang Rai, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Patrick Catherine  Olofsson Corp } \\
		{\large Annabelle 27}\\
		{\large 23600, Florence, Saarland, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
