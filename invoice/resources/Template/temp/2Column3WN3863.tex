...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mia Victoria Lundqvist} \\
		{\large Julianna 2}\\
		{\large 96455, Frankfurt am Main , Henan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isaiah Louise 	 Martinsson Ltd } \\
		{\large Ximena 59}\\
		{\large 35134, Budapest, Buriam, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
