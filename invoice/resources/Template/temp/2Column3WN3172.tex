...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro Christopher Olofsson} \\
		{\large Addison 15}\\
		{\large 91514, Amsterdam, Binh Thuan, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grayson Anne Jakobsson Corp } \\
		{\large Juliana 20}\\
		{\large 20956, Chicago, Tuscany, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
