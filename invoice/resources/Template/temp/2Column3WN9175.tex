...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eleanor David Sandberg} \\
		{\large Samantha 36}\\
		{\large 96827, San Francisco, Hessen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jack Ann  Abrahamsson Ltd } \\
		{\large Norah 55}\\
		{\large 13744, San Francisco, Kentucky, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
