...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jocelyn Michael Nyberg} \\
		{\large Kaitlyn 80}\\
		{\large 34907, Vancouver, Buriam, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angel Anne Gustafsson Corp } \\
		{\large Sarah 81}\\
		{\large 14962, San Francisco, Chiang Rai, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
