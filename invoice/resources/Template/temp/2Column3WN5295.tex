...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Wesley Christopher Blomqvist} \\
		{\large Kaleb 24}\\
		{\large 72567, Istanbul, Bremen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy Louise 	 Hansen Pte Ltd } \\
		{\large Benjamin 79}\\
		{\large 62029, Florence, khanh Hoa, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
