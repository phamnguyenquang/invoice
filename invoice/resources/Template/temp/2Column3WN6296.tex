...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brady Louise 	 Nordström} \\
		{\large Dylan 54}\\
		{\large 42559, Last Vegas, Phu Yen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Xavier Michael Pettersson Inc } \\
		{\large James 75}\\
		{\large 69608, SaiGon, Kentucky, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
