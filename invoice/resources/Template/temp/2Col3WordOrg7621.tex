...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity Christopher Persson Ltd} \\
		{\large Timothy 56}\\
		{\large 15651, Istanbul, Huabei, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zoe Lindström } \\
		{\large Aaliyah 12}\\
		{\large 28877, Frankfurt am Main , Hawaii, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
