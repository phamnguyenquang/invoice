...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  William David Håkansson Pte Ltd} \\
		{\large Kenneth 36}\\
		{\large 31008, Sydney, California, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Genesis Gustafsson } \\
		{\large Joshua 66}\\
		{\large 19222, Frankfurt am Main , California, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
