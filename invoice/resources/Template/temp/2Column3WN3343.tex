...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eliana Robert Lindberg} \\
		{\large Vanessa 11}\\
		{\large 44500, Singapore, Phu Yen, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian James Holmberg Corp } \\
		{\large Bennett 22}\\
		{\large 33989, San Francisco, khanh Hoa, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
