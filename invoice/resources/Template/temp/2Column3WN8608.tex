...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elena James Holmberg} \\
		{\large Julian 58}\\
		{\large 69361, Abu Dhabi, Amnat Charoen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Margaret Catherine  Åberg Inc } \\
		{\large Valerie 39}\\
		{\large 97862, New York , Kentucky, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
