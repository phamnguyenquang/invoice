...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Richard Edward Hellström} \\
		{\large James 64}\\
		{\large 28984, Frankfurt am Main , Bayern, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michelle Rose 	 Andreasson Ltd } \\
		{\large Caleb 85}\\
		{\large 23019, Minsk, Guangdong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
