...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryce Lind} \\
		{\large Riley 37}\\
		{\large 38611, Frankfurt am Main , Tuscany, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paige William Ekström Inc } \\
		{\large Cooper 11}\\
		{\large 54849, Last Vegas, Huabei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
