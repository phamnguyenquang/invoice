...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ellie Peter Blomqvist} \\
		{\large Nevaeh 90}\\
		{\large 76338, Vancouver, Kentucky, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anna Elizabeth 	 Sandström Corp } \\
		{\large Aaron 92}\\
		{\large 76582, Vancouver, Indiana, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
