...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Addison Louise 	 Jönsson Corp} \\
		{\large Anthony 38}\\
		{\large 32149, SaiGon, Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Summer Hermansson } \\
		{\large Ariel 54}\\
		{\large 63981, Stuttgart, Hainan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
