...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniel Mary 	 Henriksson} \\
		{\large Nathan 30}\\
		{\large 98057, Los Angeles, Bremen, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas Christopher Berggren Corp } \\
		{\large Levi 38}\\
		{\large 39599, San Francisco, Indiana, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
