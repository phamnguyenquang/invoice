...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jordan Larsson} \\
		{\large Jude 7}\\
		{\large 27777, Abu Dhabi, Floria, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joseph Louise 	 Olsson Ltd } \\
		{\large Camila 3}\\
		{\large 94031, Frankfurt am Main , Ang Thong, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
