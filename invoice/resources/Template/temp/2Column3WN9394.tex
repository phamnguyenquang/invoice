...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jace Amy  Lindqvist} \\
		{\large Max 1}\\
		{\large 75764, Florence, Bayern, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ian Elizabeth 	 Lindberg Ltd } \\
		{\large Abigail 85}\\
		{\large 62780, Frankfurt am Main , Guangdong, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
