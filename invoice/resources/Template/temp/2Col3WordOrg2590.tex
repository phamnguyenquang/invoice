...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paul Christopher Viklund Pte Ltd} \\
		{\large Isla 85}\\
		{\large 46445, Frankfurt am Main , Guangzhou, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paige Hellström } \\
		{\large Natalie 44}\\
		{\large 21446, Taipei, Heibei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
