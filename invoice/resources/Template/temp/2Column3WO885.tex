...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayce Mary 	 Samuelsson Ltd} \\
		{\large Skylar 9}\\
		{\large 77406, Barcelona, Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmanuel Lundberg } \\
		{\large Greyson 86}\\
		{\large 70262, Vienna, Chiang Rai, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
