...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Victoria Jonsson} \\
		{\large Sophia 25}\\
		{\large 39358, Dubai, Binh Thuan, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alejandro William Sandberg Pte Ltd } \\
		{\large Abigail 44}\\
		{\large 61534, Istanbul, Floria, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
