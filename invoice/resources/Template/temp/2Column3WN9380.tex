...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sara Lee  Lundberg} \\
		{\large Lauren 76}\\
		{\large 53439, Munich, Hawaii, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aliyah William Bergqvist Pte Ltd } \\
		{\large Joel 20}\\
		{\large 93408, Frankfurt am Main , Heibei, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
