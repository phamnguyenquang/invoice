...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Malachi Christopher Bergström} \\
		{\large Jessica 21}\\
		{\large 91453, Berlin, California, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Delilah Ann  Mårtensson Corp } \\
		{\large Trinity 78}\\
		{\large 64102, Berlin, Henan, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
