...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vanessa  Alexander  Ek Pte Ltd} \\
		{\large David 64}\\
		{\large 21378, Last Vegas, Seattles, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley Holmgren } \\
		{\large Blake 14}\\
		{\large 58966, Melbourne, Seattles, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
