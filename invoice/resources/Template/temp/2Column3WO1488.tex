...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Catherine  Isaksson Pte Ltd} \\
		{\large Maxwell 43}\\
		{\large 75989, Lisbon, Chiang Mai, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Strömberg } \\
		{\large Carson 56}\\
		{\large 29425, Beijing, Ang Thong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
