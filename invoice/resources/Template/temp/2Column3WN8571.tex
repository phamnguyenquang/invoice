...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaiden Ann  Sjöberg} \\
		{\large Molly 69}\\
		{\large 36263, Vienna, Hawaii, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brady Elizabeth 	 Bergman Pte Ltd } \\
		{\large Ian 77}\\
		{\large 93300, Nha Trang, California, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
