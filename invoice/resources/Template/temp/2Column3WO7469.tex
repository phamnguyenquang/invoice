...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rebecca Victoria Nordin Ltd} \\
		{\large Aliyah 4}\\
		{\large 19525, Barcelona, Chiang Mai, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bennett Lundström } \\
		{\large Grayson 27}\\
		{\large 42947, Washington, Amnat Charoen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
