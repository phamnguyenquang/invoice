...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zoe Catherine  Lundström} \\
		{\large Giovanni 5}\\
		{\large 45032, Rome, Bayern, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella John Fredriksson Pte Ltd } \\
		{\large Savannah 28}\\
		{\large 34656, Frankfurt am Main , Bremen, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
