...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicholas Robert Lundqvist Ltd} \\
		{\large Brayden 45}\\
		{\large 72502, Abu Dhabi, Amnat Charoen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mariah Sundberg } \\
		{\large Khloe 18}\\
		{\large 44587, Singapore, Binh Thuan, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
