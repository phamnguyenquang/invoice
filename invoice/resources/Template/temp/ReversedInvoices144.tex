...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Illinois Institute of Technology} \\
		{\large Kai 83}\\
		{\large 69859, Frankfurt am Main , Chai Nat, Mexico }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Claire Wikström } \\
		{\large Arianna 73}\\
		{\large 17184, Hong Kong, Amnat Charoen, Indonesia s}\\
    \switchcolumn
