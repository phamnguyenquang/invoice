...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Catherine  Berg} \\
		{\large Lincoln 36}\\
		{\large 43873, Frankfurt am Main , Binh Thuan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Graham Louise 	 Mattsson Pte Ltd } \\
		{\large Gabriel 89}\\
		{\large 39870, Berlin, Bangkok, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
