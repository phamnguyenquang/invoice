...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caleb Andersson} \\
		{\large Evan 46}\\
		{\large 66797, Hanoi, Binh Thuan, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon Elizabeth 	 Holmgren Inc } \\
		{\large Jude 84}\\
		{\large 52412, San Francisco, Tuscany, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
