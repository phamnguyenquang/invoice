...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Diego Arvidsson} \\
		{\large Delilah 77}\\
		{\large 92512, Frankfurt am Main , Huabei, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julia Kate 	 Håkansson Pte Ltd } \\
		{\large Ivy 42}\\
		{\large 78077, Abu Dhabi, Hamburg, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
