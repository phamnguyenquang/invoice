...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremiah Amy  Björk} \\
		{\large Josephine 9}\\
		{\large 25830, Istanbul, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ivan James Bengtsson Corp } \\
		{\large Ivy 3}\\
		{\large 14809, Barcelona, Indiana, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
