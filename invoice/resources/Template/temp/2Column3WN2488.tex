...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline May/Mae 	 Lind} \\
		{\large Ellie 33}\\
		{\large 78410, Shanghai, Buriam, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eric Christopher Björk Inc } \\
		{\large Annabelle 37}\\
		{\large 22497, Abu Dhabi, Amnat Charoen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
