...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel Mary 	 Magnusson} \\
		{\large Isla 37}\\
		{\large 92844, Hong Kong, California, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kenneth Mary 	 Axelsson Pte Ltd } \\
		{\large Jude 6}\\
		{\large 92476, Bonn, Amnat Charoen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
