...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle Thomas Wallin Pte Ltd} \\
		{\large Daniela 2}\\
		{\large 78350, Beijing, California, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Landon Pettersson } \\
		{\large Aidan 7}\\
		{\large 56277, Amsterdam, California, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
