...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro Christopher Nordström} \\
		{\large Delilah 61}\\
		{\large 16210, Munich, Indiana, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Patrick Ann  Larsson Ltd } \\
		{\large Bailey 70}\\
		{\large 54713, Melbourne, Phu Yen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
