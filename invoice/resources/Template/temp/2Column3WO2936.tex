...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carlos Louise 	 Magnusson Inc} \\
		{\large Alaina 10}\\
		{\large 26896, Chicago, Chai Nat, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valentina Hansson } \\
		{\large Sara 41}\\
		{\large 70466, Frankfurt am Main , Ang Thong, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
