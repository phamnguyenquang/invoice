...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zoe Michael Axelsson Pte Ltd} \\
		{\large Noah 47}\\
		{\large 18398, Frankfurt am Main , Indiana, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Levi Dahl } \\
		{\large Izabella 27}\\
		{\large 43452, Barcelona, Chiang Mai, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
