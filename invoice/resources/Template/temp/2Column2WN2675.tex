...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brielle Lindström} \\
		{\large Brayden 35}\\
		{\large 35127, Ho Chi Minh, Guangzhou, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxon Edward Berglund Inc } \\
		{\large Reese 63}\\
		{\large 97725, Los Angeles, Bremen, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
