...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope Louise 	 Norberg Ltd} \\
		{\large Maria 20}\\
		{\large 96036, Taipei, California, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liliana Sjögren } \\
		{\large Cora 17}\\
		{\large 77635, Frankfurt am Main , Chiang Rai, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
