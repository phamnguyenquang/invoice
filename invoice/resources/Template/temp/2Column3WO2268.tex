...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Preston Louise 	 Lindström Pte Ltd} \\
		{\large Athena 12}\\
		{\large 66379, Barcelona, Tuscany, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hayden Andersson } \\
		{\large Jacob 53}\\
		{\large 81653, Budapest, Ang Thong, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
