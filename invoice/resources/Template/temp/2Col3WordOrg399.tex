...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valerie Anne Olofsson Pte Ltd} \\
		{\large Matthew 61}\\
		{\large 77244, Boston, Binh Thuan, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalie Blomqvist } \\
		{\large Lucy 39}\\
		{\large 44363, Frankfurt am Main , Floria, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
