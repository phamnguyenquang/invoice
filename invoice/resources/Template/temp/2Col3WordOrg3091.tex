...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremiah William Björklund Pte Ltd} \\
		{\large Camden 80}\\
		{\large 75344, Lisbon, Indiana, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mackenzie Jakobsson } \\
		{\large Sophie 26}\\
		{\large 31698, Venice, Hawaii, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
