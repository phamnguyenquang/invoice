...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla Mattsson} \\
		{\large Leah 72}\\
		{\large 52305, San Francisco, Amnat Charoen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tucker Thomas Arvidsson Pte Ltd } \\
		{\large Amelia 35}\\
		{\large 33584, Paris, Heibei, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
