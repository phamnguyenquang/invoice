...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luna Lindström} \\
		{\large Samuel 23}\\
		{\large 43859, Berlin, Heibei, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalia Thomas Gustafsson Inc } \\
		{\large Avery 77}\\
		{\large 44634, Frankfurt am Main , Indiana, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
