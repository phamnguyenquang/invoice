...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Camila Lee  Hedlund} \\
		{\large Zoey 21}\\
		{\large 18501, Florence, Chiang Mai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hailey Catherine  Berglund Corp } \\
		{\large Gracie 41}\\
		{\large 77598, Vancouver, Ang Thong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
