...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bentley Dahlberg} \\
		{\large Jayden 29}\\
		{\large 57462, Frankfurt am Main , Chiang Mai, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrew Christopher Dahl Ltd } \\
		{\large Aidan 23}\\
		{\large 66997, Hong Kong, Amnat Charoen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
