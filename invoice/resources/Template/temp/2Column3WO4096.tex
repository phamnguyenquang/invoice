...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Faith Victoria Nordström Inc} \\
		{\large Sophie 21}\\
		{\large 48249, Frankfurt am Main , Guangdong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayce Pålsson } \\
		{\large Gabriella 61}\\
		{\large 78544, Shanghai, Huabei, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
