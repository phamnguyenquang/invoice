...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valentina David Hansson} \\
		{\large Patrick 99}\\
		{\large 17445, Denver, Amnat Charoen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabrielle Christopher Gunnarsson Ltd } \\
		{\large Julia 76}\\
		{\large 66526, Rome, Guangdong, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
