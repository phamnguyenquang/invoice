...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniel Lundgren Pte Ltd} \\
		{\large Scarlett 78}\\
		{\large 63119, Frankfurt am Main , Hawaii, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elias Bengtsson } \\
		{\large Alyssa 26}\\
		{\large 18588, San Francisco, Heibei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
