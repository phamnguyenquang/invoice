...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexander David Pettersson} \\
		{\large Mark 6}\\
		{\large 43777, Los Angeles, Floria, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sara Michael Berg Ltd } \\
		{\large Christian 17}\\
		{\large 38291, Washington, Bremen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
