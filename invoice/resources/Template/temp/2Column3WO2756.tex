...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Laila Christopher Andersson Pte Ltd} \\
		{\large Bella 76}\\
		{\large 28020, Ho Chi Minh, Tuscany, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Taylor Blom } \\
		{\large Clara 86}\\
		{\large 72971, Frankfurt am Main , Hessen, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
