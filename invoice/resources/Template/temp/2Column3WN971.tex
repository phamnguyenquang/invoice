...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brian John Björklund} \\
		{\large Natalie 3}\\
		{\large 19764, Denver, Guangdong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cooper May/Mae 	 Ahmed Ltd } \\
		{\large Abigail 90}\\
		{\large 19800, Frankfurt am Main , Guangdong, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
