...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Xavier Peter Lindholm} \\
		{\large Steven 29}\\
		{\large 11897, Denver, Amnat Charoen, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Landon Louise 	 Forsberg Pte Ltd } \\
		{\large Daniela 33}\\
		{\large 68998, Munich, Tuscany, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
