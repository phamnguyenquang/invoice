...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christian Dahlberg} \\
		{\large Abigail 47}\\
		{\large 93780, Frankfurt am Main , Chiang Rai, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaylee Grace 	 Magnusson Pte Ltd } \\
		{\large Sebastian 87}\\
		{\large 79330, Minsk, Chiang Mai, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
