...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Oscar Victoria Samuelsson} \\
		{\large Austin 82}\\
		{\large 60779, Stuttgart, Saarland, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ruby Robert Ali Inc } \\
		{\large Alaina 5}\\
		{\large 37612, Frankfurt am Main , Guangzhou, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
