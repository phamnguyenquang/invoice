...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sydney Dahlberg} \\
		{\large Hunter 22}\\
		{\large 73159, Nha Trang, Buriam, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexa Robert Hellström Inc } \\
		{\large Londyn 84}\\
		{\large 73424, Frankfurt am Main , Kentucky, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
