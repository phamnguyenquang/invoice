...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Patrick Jane Danielsson} \\
		{\large Ivan 5}\\
		{\large 54564, Singapore, Amnat Charoen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxon Elizabeth 	 Karlsson Pte Ltd } \\
		{\large Aria 49}\\
		{\large 59319, Vancouver, Huabei, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
