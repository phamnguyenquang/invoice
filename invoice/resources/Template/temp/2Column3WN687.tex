...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Matthew Louise 	 Ali} \\
		{\large Ximena 90}\\
		{\large 52898, Beijing, Chai Nat, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liliana Christopher Lind Pte Ltd } \\
		{\large Madeline 58}\\
		{\large 68262, Melbourne, Bremen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
