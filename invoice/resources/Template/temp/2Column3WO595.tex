...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eleanor Kate 	 Blomqvist Inc} \\
		{\large Eli 56}\\
		{\large 62084, Moscow, Chiang Rai, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaylee Bergman } \\
		{\large Madison 6}\\
		{\large 93103, Frankfurt am Main , Henan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
