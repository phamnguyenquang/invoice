...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eleanor Thomas Henriksson Pte Ltd} \\
		{\large Malachi 91}\\
		{\large 37749, San Francisco, California, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bentley Sandberg } \\
		{\large Leonardo 39}\\
		{\large 31815, Barcelona, Hessen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
