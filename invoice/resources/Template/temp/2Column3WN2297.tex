...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremy David Berglund} \\
		{\large Vanessa 49}\\
		{\large 89357, Ho Chi Minh, Floria, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charles Christopher Nilsson Corp } \\
		{\large Mckenzie 23}\\
		{\large 88140, Abu Dhabi, Chai Nat, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
