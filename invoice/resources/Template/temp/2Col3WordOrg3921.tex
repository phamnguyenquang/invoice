...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jackson Elizabeth 	 Lundin Pte Ltd} \\
		{\large Nathan 42}\\
		{\large 42881, Los Angeles, Tuscany, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Genesis Jakobsson } \\
		{\large Kaylee 50}\\
		{\large 79009, Vancouver, Hessen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
