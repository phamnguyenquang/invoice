...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adriana Mary 	 Eliasson Pte Ltd} \\
		{\large Wesley 20}\\
		{\large 95958, Frankfurt am Main , California, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gracie Ali } \\
		{\large Ian 29}\\
		{\large 88832, New York , Floria, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
