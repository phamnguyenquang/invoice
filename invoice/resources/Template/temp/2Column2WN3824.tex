...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremy Mattsson} \\
		{\large Antonio 39}\\
		{\large 79895, Frankfurt am Main , Amnat Charoen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mark William Lind Inc } \\
		{\large Elizabeth 98}\\
		{\large 54128, Budapest, Hessen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
