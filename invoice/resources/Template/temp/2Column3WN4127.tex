...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maya Edward Arvidsson} \\
		{\large Madelyn 46}\\
		{\large 28059, Singapore, Amnat Charoen, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katherine Catherine  Eklund Ltd } \\
		{\large Rylee 37}\\
		{\large 10500, Budapest, Buriam, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
