...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon Louise 	 Nyberg} \\
		{\large Brayden 46}\\
		{\large 45693, Denver, Hamburg, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grace William Bergström Corp } \\
		{\large Hayden 21}\\
		{\large 47023, Ho Chi Minh, Ang Thong, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
