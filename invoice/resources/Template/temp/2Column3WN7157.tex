...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adriana Amy  Sandberg} \\
		{\large Malachi 24}\\
		{\large 83476, Melbourne, Hessen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abel May/Mae 	 Martinsson Pte Ltd } \\
		{\large Oliver 9}\\
		{\large 20001, Last Vegas, Texas, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
