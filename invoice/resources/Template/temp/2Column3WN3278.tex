...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bentley Louise 	 Eriksson} \\
		{\large Oliver 46}\\
		{\large 45000, Venice, California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Benjamin David Gunnarsson Ltd } \\
		{\large Paisley 65}\\
		{\large 91973, Berlin, Chai Nat, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
