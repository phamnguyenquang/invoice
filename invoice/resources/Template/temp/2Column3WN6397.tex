...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ximena John Martinsson} \\
		{\large Jocelyn 75}\\
		{\large 87710, Nha Trang, Saarland, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Chloe Ann  Samuelsson Ltd } \\
		{\large Bella 41}\\
		{\large 74798, Frankfurt am Main , Chiang Mai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
