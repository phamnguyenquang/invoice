...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joseph Lee  Andersson Pte Ltd} \\
		{\large Izabella 68}\\
		{\large 16394, Vienna, Binh Thuan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josephine Eriksson } \\
		{\large Hunter 85}\\
		{\large 13659, Bonn, Amnat Charoen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
