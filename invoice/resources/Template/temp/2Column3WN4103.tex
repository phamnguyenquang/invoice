...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Audrey James Månsson} \\
		{\large Nicole 88}\\
		{\large 86410, Frankfurt am Main , Bayern, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maxwell Rose 	 Löfgren Corp } \\
		{\large Nicole 40}\\
		{\large 70506, Frankfurt am Main , Indiana, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
