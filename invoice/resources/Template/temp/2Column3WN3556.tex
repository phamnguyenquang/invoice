...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Naomi Peter Jonsson} \\
		{\large Camden 29}\\
		{\large 56219, Frankfurt am Main , Tuscany, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabrielle Anne Sundberg Corp } \\
		{\large Kaitlyn 62}\\
		{\large 98117, Shanghai, Floria, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
