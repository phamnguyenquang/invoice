...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Rose 	 Sundberg Ltd} \\
		{\large Serenity 33}\\
		{\large 45850, Istanbul, California, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emilia Henriksson } \\
		{\large Sebastian 39}\\
		{\large 12855, Frankfurt am Main , Seattles, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
