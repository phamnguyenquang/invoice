...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Riley Louise 	 Norberg} \\
		{\large Jack 97}\\
		{\large 55212, Lisbon, Seattles, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mackenzie Rose 	 Ekström Corp } \\
		{\large James 80}\\
		{\large 32407, Vancouver, Hamburg, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
