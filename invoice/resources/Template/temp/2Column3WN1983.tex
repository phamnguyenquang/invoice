...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Landon James Lundgren} \\
		{\large Greyson 65}\\
		{\large 53607, Montreal, Seattles, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryan Kate 	 Hermansson Corp } \\
		{\large Eliza 9}\\
		{\large 99294, Los Angeles, khanh Hoa, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
