...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eden James Hermansson} \\
		{\large Levi 67}\\
		{\large 57159, Barcelona, Saarland, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian William Lundqvist Ltd } \\
		{\large Ryleigh 24}\\
		{\large 85973, SaiGon, Kentucky, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
