...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaylee Edward Hellström} \\
		{\large Elizabeth 37}\\
		{\large 65548, Madrid, California, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adeline Michael Söderberg Ltd } \\
		{\large Santiago 71}\\
		{\large 39556, Washington, Indiana, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
