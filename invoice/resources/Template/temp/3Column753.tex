...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Federico Santa María Technical University} \\
		{\large Evan 98}\\
		{\large 71033, Hong Kong, Saarland, Denmark}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Valentina Söderberg } \\
		{\large Liam 85}\\
		{\large 65739, Sydney, Hamburg, Japan }\\
    \switchcolumn
