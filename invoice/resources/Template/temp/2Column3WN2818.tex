...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grayson Mary 	 Dahlberg} \\
		{\large Autumn 81}\\
		{\large 54780, Washington, Amnat Charoen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Louise 	 Eklund Pte Ltd } \\
		{\large Asher 81}\\
		{\large 36599, Singapore, Heibei, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
