...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jack Christopher Abrahamsson Ltd} \\
		{\large Richard 36}\\
		{\large 74092, Ho Chi Minh, Heibei, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kayla Lundqvist } \\
		{\large Mila 81}\\
		{\large 43719, Stuttgart, Buriam, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
