...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Norah Michael Lundgren Inc} \\
		{\large Aiden 41}\\
		{\large 89860, Barcelona, Chiang Mai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hadley Pettersson } \\
		{\large Jacob 26}\\
		{\large 40685, San Francisco, Chai Nat, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
