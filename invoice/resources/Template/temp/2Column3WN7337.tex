...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Scarlett Michael Lundqvist} \\
		{\large Everly 6}\\
		{\large 71906, Stuttgart, Seattles, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jude Rose 	 Martinsson Pte Ltd } \\
		{\large Maria 51}\\
		{\large 67787, Osaka, Hessen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
