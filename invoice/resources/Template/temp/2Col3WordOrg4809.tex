...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nora May/Mae 	 Jakobsson Pte Ltd} \\
		{\large Jesus 82}\\
		{\large 22543, Nha Trang, Kentucky, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryker Nilsson } \\
		{\large Nicole 36}\\
		{\large 88593, San Francisco, Ang Thong, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
