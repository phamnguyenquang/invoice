...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lincoln Marie 	 Löfgren} \\
		{\large Madelyn 69}\\
		{\large 25906, Budapest, Hessen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Willow Elizabeth 	 Hermansson Inc } \\
		{\large Timothy 15}\\
		{\large 25259, Frankfurt am Main , Binh Thuan, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
