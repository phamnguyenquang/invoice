...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sadie Grace 	 Jonsson} \\
		{\large Victor 73}\\
		{\large 35765, Vienna, Henan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harmony William Dahlberg Pte Ltd } \\
		{\large Antonio 69}\\
		{\large 42261, Stuttgart, Amnat Charoen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
