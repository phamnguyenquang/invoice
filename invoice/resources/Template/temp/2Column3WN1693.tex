...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrea Robert Fredriksson} \\
		{\large Quinn 35}\\
		{\large 20894, Venice, Guangdong, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paisley Jane Lindqvist Pte Ltd } \\
		{\large Cooper 46}\\
		{\large 86202, SaiGon, Phu Yen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
