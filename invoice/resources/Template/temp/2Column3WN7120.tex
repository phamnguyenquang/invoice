...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon May/Mae 	 Nordin} \\
		{\large Aria 63}\\
		{\large 34942, Lisbon, Amnat Charoen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryker Catherine  Söderberg Ltd } \\
		{\large Oscar 2}\\
		{\large 10107, Nha Trang, Kentucky, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
