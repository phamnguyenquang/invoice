...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grace Grace 	 Nyström} \\
		{\large Jessica 98}\\
		{\large 88955, Boston, Bangkok, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julian Jane Andreasson Pte Ltd } \\
		{\large Juliana 18}\\
		{\large 64880, Tokyo, Huabei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
