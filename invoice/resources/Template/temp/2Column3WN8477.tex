...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luca Louise 	 Lindqvist} \\
		{\large Camila 97}\\
		{\large 55707, Hong Kong, Phu Yen, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Faith Elizabeth 	 Lindgren Inc } \\
		{\large Richard 13}\\
		{\large 61321, Amsterdam, Binh Thuan, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
