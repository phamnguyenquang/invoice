...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maria John Olsson} \\
		{\large Riley 54}\\
		{\large 24847, Hong Kong, Henan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michelle Rose 	 Lindström Pte Ltd } \\
		{\large Eliana 6}\\
		{\large 95821, Montreal, Amnat Charoen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
