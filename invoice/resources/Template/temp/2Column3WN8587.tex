...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sarah Anne Andersson} \\
		{\large Levi 52}\\
		{\large 76278, Budapest, Hamburg, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angelina Jane Gustafsson Pte Ltd } \\
		{\large Camila 79}\\
		{\large 20629, San Francisco, khanh Hoa, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
