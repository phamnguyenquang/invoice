...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luis  Alexander  Samuelsson} \\
		{\large Caleb 90}\\
		{\large 11310, Tokyo, Floria, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liliana Rose 	 Bergström Inc } \\
		{\large Piper 64}\\
		{\large 88079, Stuttgart, Seattles, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
