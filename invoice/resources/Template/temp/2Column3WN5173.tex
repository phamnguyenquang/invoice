...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Richard Thomas Andersson} \\
		{\large Oliver 41}\\
		{\large 96570, Shanghai, Guangdong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brody Michael Isaksson Ltd } \\
		{\large Grant 87}\\
		{\large 20832, Frankfurt am Main , Bremen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
