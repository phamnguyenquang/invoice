...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carter May/Mae 	 Lundberg} \\
		{\large Autumn 70}\\
		{\large 81759, Venice, Amnat Charoen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julianna James Hellström Corp } \\
		{\large Kayla 65}\\
		{\large 50581, Frankfurt am Main , Indiana, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
