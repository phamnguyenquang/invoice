...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Elizabeth 	 Svensson Ltd} \\
		{\large Emmanuel 63}\\
		{\large 23803, Frankfurt am Main , Chiang Rai, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aurora Mårtensson } \\
		{\large Gabriel 48}\\
		{\large 63947, Last Vegas, Hessen, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
