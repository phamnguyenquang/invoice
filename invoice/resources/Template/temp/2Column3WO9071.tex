...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kingston Peter Bergström Inc} \\
		{\large Izabella 54}\\
		{\large 56499, Barcelona, Chiang Rai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everett Martinsson } \\
		{\large Edward 39}\\
		{\large 19054, Budapest, Indiana, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
