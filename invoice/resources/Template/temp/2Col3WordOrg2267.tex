...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maximus  Alexander  Andersson Pte Ltd} \\
		{\large Alexandra 3}\\
		{\large 18389, Washington, Texas, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabelle Holmberg } \\
		{\large Nicole 37}\\
		{\large 70231, Vancouver, Hawaii, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
