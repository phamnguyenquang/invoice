...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian John Berggren} \\
		{\large Vivian 81}\\
		{\large 80871, Shanghai, Binh Thuan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Morgan Kate 	 Hedlund Pte Ltd } \\
		{\large Alice 92}\\
		{\large 19584, Singapore, Chai Nat, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
