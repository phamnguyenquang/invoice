...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  King Louise 	 Jansson} \\
		{\large Eli 49}\\
		{\large 96845, Denver, Chiang Rai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesus May/Mae 	 Ström Corp } \\
		{\large Cayden 7}\\
		{\large 59416, Amsterdam, Hessen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
