...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juan Victoria Håkansson Ltd} \\
		{\large Addison 92}\\
		{\large 47814, Frankfurt am Main , Seattles, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makayla Arvidsson } \\
		{\large Brody 59}\\
		{\large 23804, New York , Amnat Charoen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
