...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kevin  Alexander  Engström Pte Ltd} \\
		{\large Alexis 91}\\
		{\large 20513, Frankfurt am Main , Binh Thuan, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ashton Strömberg } \\
		{\large Makayla 65}\\
		{\large 82526, Berlin, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
