...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mariah Jansson} \\
		{\large Carlos 23}\\
		{\large 27145, Washington, Guangzhou, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Molly Christopher Pålsson Pte Ltd } \\
		{\large Isaiah 75}\\
		{\large 42647, Istanbul, Hamburg, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
