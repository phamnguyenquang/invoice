...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ethan  Alexander  Sjöberg} \\
		{\large Gabrielle 34}\\
		{\large 45983, Melbourne, Heibei, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Thomas  Alexander  Jönsson Corp } \\
		{\large Jaxson 87}\\
		{\large 18493, Shanghai, Amnat Charoen, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
