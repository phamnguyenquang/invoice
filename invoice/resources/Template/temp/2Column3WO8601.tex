...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Riley William Lundqvist Pte Ltd} \\
		{\large Ezra 71}\\
		{\large 63969, Seoul, Binh Thuan, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cooper Lundström } \\
		{\large Tristan 64}\\
		{\large 67580, New York , khanh Hoa, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
