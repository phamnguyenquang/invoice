...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Matthew May/Mae 	 Söderberg} \\
		{\large Gabriel 76}\\
		{\large 73683, Shanghai, Bangkok, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lauren  Alexander  Pålsson Corp } \\
		{\large Rachel 61}\\
		{\large 20202, Milan, Bangkok, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
