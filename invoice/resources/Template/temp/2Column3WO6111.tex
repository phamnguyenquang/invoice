...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Londyn May/Mae 	 Bergqvist Corp} \\
		{\large Roman 86}\\
		{\large 92046, Hanoi, Buriam, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ezekiel Björklund } \\
		{\large Calvin 35}\\
		{\large 40356, Frankfurt am Main , Hainan, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
