...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Evan Jane Ström} \\
		{\large Isaiah 71}\\
		{\large 86745, SaiGon, khanh Hoa, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jacob Marie 	 Bengtsson Pte Ltd } \\
		{\large Jocelyn 1}\\
		{\large 86317, Boston, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
