...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Max Jane Lundberg} \\
		{\large Mia 36}\\
		{\large 37483, Vancouver, Binh Thuan, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paisley Jane Ali Ltd } \\
		{\large Luis 98}\\
		{\large 68848, Frankfurt am Main , Bayern, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
