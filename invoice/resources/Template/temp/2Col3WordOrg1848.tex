...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Riley Catherine  Fredriksson Pte Ltd} \\
		{\large Isaac 48}\\
		{\large 82656, Melbourne, Guangdong, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Piper Pettersson } \\
		{\large Sofia 42}\\
		{\large 10406, Abu Dhabi, Bayern, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
