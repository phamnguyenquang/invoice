...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Damian Thomas Isaksson} \\
		{\large Antonio 18}\\
		{\large 29657, Florence, California, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kimberly Louise 	 Eklund Pte Ltd } \\
		{\large Dylan 28}\\
		{\large 45052, Chicago, Hessen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
