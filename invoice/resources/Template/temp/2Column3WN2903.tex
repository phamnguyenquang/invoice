...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaron  Alexander  Lundström} \\
		{\large Kaiden 92}\\
		{\large 10609, Frankfurt am Main , Hamburg, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Noah Marie 	 Lindgren Inc } \\
		{\large Ryder 21}\\
		{\large 77453, San Francisco, Ang Thong, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
