...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Annabelle Amy  Ström} \\
		{\large Kylie 80}\\
		{\large 78590, Washington, Amnat Charoen, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Summer David Berggren Inc } \\
		{\large Vincent 10}\\
		{\large 33569, Frankfurt am Main , California, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
