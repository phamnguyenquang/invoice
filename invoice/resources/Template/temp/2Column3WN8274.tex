...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Wesley David Sundberg} \\
		{\large Andrea 61}\\
		{\large 75755, Rome, Ang Thong, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Benjamin Amy  Viklund Inc } \\
		{\large Wesley 47}\\
		{\large 69164, Frankfurt am Main , California, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
