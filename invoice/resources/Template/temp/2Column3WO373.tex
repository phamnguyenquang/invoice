...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madison Rose 	 Fredriksson Inc} \\
		{\large Ryan 87}\\
		{\large 83986, San Francisco, Saarland, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kinsley Lindström } \\
		{\large Brielle 26}\\
		{\large 42262, Nha Trang, Amnat Charoen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
