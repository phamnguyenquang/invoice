...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jackson Michael Ström} \\
		{\large Elise 11}\\
		{\large 50466, Toronto, Hessen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lincoln  Alexander  Pålsson Inc } \\
		{\large Everly 89}\\
		{\large 62162, Vienna, Indiana, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
