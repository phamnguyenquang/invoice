...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Taylor Victoria Fransson} \\
		{\large Natalie 47}\\
		{\large 16526, Barcelona, Chai Nat, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alyssa Mary 	 Hansen Pte Ltd } \\
		{\large Blake 4}\\
		{\large 73249, Abu Dhabi, Guangzhou, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
