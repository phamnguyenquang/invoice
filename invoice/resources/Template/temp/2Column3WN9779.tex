...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Benjamin Louise 	 Danielsson} \\
		{\large Charles 93}\\
		{\large 59417, Munich, Indiana, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sara Victoria Danielsson Ltd } \\
		{\large Zoey 59}\\
		{\large 94888, San Francisco, Indiana, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
