...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicolas Karlsson} \\
		{\large Skylar 39}\\
		{\large 69966, Frankfurt am Main , Hawaii, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Greyson William Abrahamsson Inc } \\
		{\large Athena 78}\\
		{\large 90081, Seoul, Chiang Mai, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
