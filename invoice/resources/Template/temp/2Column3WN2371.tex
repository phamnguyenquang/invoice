...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonah  Alexander  Olofsson} \\
		{\large Savannah 34}\\
		{\large 47282, Hanoi, California, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Dominic Catherine  Jönsson Ltd } \\
		{\large Hannah 95}\\
		{\large 44598, Boston, Binh Thuan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
