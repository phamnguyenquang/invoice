...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalie May/Mae 	 Strömberg Inc} \\
		{\large Clara 27}\\
		{\large 25298, Nha Trang, Seattles, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anthony Lund } \\
		{\large Lila 70}\\
		{\large 14851, San Francisco, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
