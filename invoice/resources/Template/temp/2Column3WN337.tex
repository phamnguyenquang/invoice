...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emily Rose 	 Hellström} \\
		{\large Nora 18}\\
		{\large 18833, Osaka, Amnat Charoen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Steven Christopher Karlsson Inc } \\
		{\large Eleanor 56}\\
		{\large 25500, Beijing, Phu Yen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
