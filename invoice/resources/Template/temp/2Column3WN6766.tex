...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Levi Edward Nordin} \\
		{\large Rebecca 93}\\
		{\large 14998, Singapore, California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaden May/Mae 	 Danielsson Pte Ltd } \\
		{\large Adalynn 85}\\
		{\large 61714, Vienna, Hamburg, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
