...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lydia Jane Wikström} \\
		{\large Steven 72}\\
		{\large 81645, Frankfurt am Main , Bangkok, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paul Kate 	 Sandberg Pte Ltd } \\
		{\large Kimberly 74}\\
		{\large 38572, Milan, Bayern, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
