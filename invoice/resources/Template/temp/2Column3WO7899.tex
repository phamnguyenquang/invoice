...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joshua  Alexander  Forsberg Inc} \\
		{\large Daniela 15}\\
		{\large 42398, Frankfurt am Main , Guangdong, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Taylor Engström } \\
		{\large Ashton 52}\\
		{\large 78326, Stuttgart, Hawaii, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
