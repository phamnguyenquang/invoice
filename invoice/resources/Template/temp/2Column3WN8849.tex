...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalia Mary 	 Bergman} \\
		{\large Ashley 63}\\
		{\large 25738, Sydney, Chiang Rai, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Timothy Edward Danielsson Inc } \\
		{\large Gabrielle 74}\\
		{\large 19174, Vancouver, Amnat Charoen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
