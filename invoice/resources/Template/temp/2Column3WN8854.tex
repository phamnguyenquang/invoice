...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sophie Mary 	 Ström} \\
		{\large Alana 88}\\
		{\large 12738, Vienna, Amnat Charoen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaleb Elizabeth 	 Norberg Pte Ltd } \\
		{\large Jesse 75}\\
		{\large 79941, Toronto, Indiana, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
