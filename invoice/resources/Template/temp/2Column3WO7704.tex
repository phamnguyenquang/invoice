...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valentina Anne Pettersson Pte Ltd} \\
		{\large Melanie 5}\\
		{\large 74040, SaiGon, Buriam, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian Abrahamsson } \\
		{\large Jesus 75}\\
		{\large 59129, Florence, Amnat Charoen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
