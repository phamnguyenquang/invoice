...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zachary James Olofsson} \\
		{\large Violet 53}\\
		{\large 17294, New York , Phu Yen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Allison Ann  Hermansson Pte Ltd } \\
		{\large Austin 65}\\
		{\large 87778, Paris, Bremen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
