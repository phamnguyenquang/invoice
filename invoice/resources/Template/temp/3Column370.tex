...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Martin Luther University of Halle-Wittenberg} \\
		{\large Kaleb 5}\\
		{\large 31821, Melbourne, Hessen, New Zealand}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Emmett Lundberg } \\
		{\large Hannah 30}\\
		{\large 85740, Florence, Heibei, Saudi Arabia }\\
    \switchcolumn
