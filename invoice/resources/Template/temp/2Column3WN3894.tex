...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aiden Elizabeth 	 Olsson} \\
		{\large Gael 94}\\
		{\large 58085, Ho Chi Minh, Amnat Charoen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grant William Lund Corp } \\
		{\large Hayden 54}\\
		{\large 52811, SaiGon, Chiang Mai, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
