...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrew Lindgren Pte Ltd} \\
		{\large Harmony 79}\\
		{\large 56933, Montreal, Chai Nat, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Trinity Hellström } \\
		{\large Sebastian 79}\\
		{\large 18007, Frankfurt am Main , Guangdong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
