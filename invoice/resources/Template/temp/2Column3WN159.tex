...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dominic Amy  Lindberg} \\
		{\large Nevaeh 35}\\
		{\large 75140, Lisbon, Chiang Rai, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reagan William Bergqvist Pte Ltd } \\
		{\large Liam 89}\\
		{\large 84132, Budapest, California, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
