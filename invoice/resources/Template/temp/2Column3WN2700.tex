...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julianna Marie 	 Hermansson} \\
		{\large Landon 58}\\
		{\large 81057, Shanghai, Saarland, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paige May/Mae 	 Mårtensson Pte Ltd } \\
		{\large Weston 32}\\
		{\large 43803, Dublin, Hessen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
