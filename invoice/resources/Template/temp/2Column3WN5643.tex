...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everly Robert Hellström} \\
		{\large Trinity 87}\\
		{\large 72155, Madrid, Binh Thuan, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Victoria Rose 	 Holmgren Ltd } \\
		{\large Maya 29}\\
		{\large 19599, Madrid, Amnat Charoen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
