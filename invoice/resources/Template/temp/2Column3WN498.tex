...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Antonio Christopher Hermansson} \\
		{\large Jonathan 67}\\
		{\large 81448, Beijing, Chiang Rai, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maverick Kate 	 Ali Ltd } \\
		{\large Andrew 79}\\
		{\large 75487, Washington, Hamburg, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
