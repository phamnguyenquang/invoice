...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Budapest University of Technology and Economics} \\
		{\large Braxton 64}\\
		{\large 92368, Istanbul, Indiana, Saudi Arabia }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Ivan Engström } \\
		{\large Angel 9}\\
		{\large 78934, Montreal, Buriam, Australia }\\
    \switchcolumn
