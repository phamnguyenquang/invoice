...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Grace 	 Mohamed} \\
		{\large Reese 64}\\
		{\large 45457, Madrid, Chiang Rai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mariah Michael Jakobsson Inc } \\
		{\large Mia 87}\\
		{\large 65702, Nha Trang, Guangzhou, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
