...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Miguel Peter Hermansson} \\
		{\large Destiny 48}\\
		{\large 13374, Frankfurt am Main , Chiang Mai, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Silas Thomas Sjöberg Ltd } \\
		{\large Miguel 1}\\
		{\large 76064, Washington, Hawaii, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
