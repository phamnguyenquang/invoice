...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kayla Rose 	 Dahlberg} \\
		{\large Isabel 83}\\
		{\large 71107, Nha Trang, Bayern, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie  Alexander  Lindholm Corp } \\
		{\large Brandon 96}\\
		{\large 77001, Stuttgart, khanh Hoa, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
