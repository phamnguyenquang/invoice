...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Roman Strömberg} \\
		{\large Madelyn 32}\\
		{\large 71754, Last Vegas, Seattles, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklynn William Bergström Pte Ltd } \\
		{\large Caden 28}\\
		{\large 53965, New York , Huabei, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
