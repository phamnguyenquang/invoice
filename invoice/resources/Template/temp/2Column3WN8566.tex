...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Preston Victoria Hansson} \\
		{\large Luca 3}\\
		{\large 98659, Nha Trang, Guangdong, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Santiago Marie 	 Nordström Pte Ltd } \\
		{\large Ximena 30}\\
		{\large 53324, Moscow, Huabei, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
