...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cole Michael Sandberg} \\
		{\large Silas 93}\\
		{\large 20106, Stuttgart, Guangdong, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sean Victoria Magnusson Inc } \\
		{\large Gabriel 63}\\
		{\large 33240, Frankfurt am Main , Ang Thong, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
