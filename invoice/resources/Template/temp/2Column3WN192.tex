...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Max Kate 	 Engström} \\
		{\large Zachary 87}\\
		{\large 45048, San Francisco, Bremen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stella Elizabeth 	 Ekström Inc } \\
		{\large Nicole 90}\\
		{\large 99669, Nha Trang, Bangkok, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
