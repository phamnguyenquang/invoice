...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro May/Mae 	 Lundin Pte Ltd} \\
		{\large Maxwell 69}\\
		{\large 98594, London , Bremen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maverick Hermansson } \\
		{\large Calvin 94}\\
		{\large 74307, Stuttgart, Chai Nat, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
