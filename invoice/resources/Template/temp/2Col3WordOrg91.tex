...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayden Peter Henriksson Corp} \\
		{\large Lily 2}\\
		{\large 59036, Frankfurt am Main , Hessen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesse Hansson } \\
		{\large Izabella 93}\\
		{\large 50626, Taipei, Bangkok, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
