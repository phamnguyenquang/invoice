...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariana  Alexander  Sandström} \\
		{\large Marcus 11}\\
		{\large 34841, Milan, Huabei, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adrian James Wikström Pte Ltd } \\
		{\large Xavier 84}\\
		{\large 76955, Taipei, Floria, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
