...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Summer Grace 	 Persson} \\
		{\large Mateo 25}\\
		{\large 90433, SaiGon, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Arianna Thomas Hassan Inc } \\
		{\large Alan 56}\\
		{\large 77640, Abu Dhabi, khanh Hoa, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
