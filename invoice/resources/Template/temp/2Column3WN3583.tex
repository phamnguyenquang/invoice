...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everett  Alexander  Persson} \\
		{\large Luna 67}\\
		{\large 79158, Stuttgart, Chiang Mai, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jude Thomas Andersson Inc } \\
		{\large Kimberly 88}\\
		{\large 58305, Frankfurt am Main , Guangzhou, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
