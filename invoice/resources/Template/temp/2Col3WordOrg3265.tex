...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope Robert Månsson Inc} \\
		{\large Sydney 11}\\
		{\large 22180, Los Angeles, Chiang Mai, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Silas Månsson } \\
		{\large Nicolas 93}\\
		{\large 29890, Frankfurt am Main , Tuscany, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
