...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bennett  Alexander  Hedlund} \\
		{\large Evan 36}\\
		{\large 74687, Hong Kong, Texas, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aria Christopher Lundström Pte Ltd } \\
		{\large Chloe 63}\\
		{\large 30799, Florence, Seattles, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
