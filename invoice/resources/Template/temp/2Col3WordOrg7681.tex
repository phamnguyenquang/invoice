...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie William Lindholm Inc} \\
		{\large Eva 84}\\
		{\large 69865, Sydney, Chiang Rai, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katherine Nyström } \\
		{\large Sarah 66}\\
		{\large 24950, Frankfurt am Main , Buriam, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
