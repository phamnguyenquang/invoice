...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Laila Mary 	 Lundgren} \\
		{\large Faith 78}\\
		{\large 88424, Amsterdam, Seattles, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella Kate 	 Karlsson Pte Ltd } \\
		{\large Grayson 48}\\
		{\large 47173, Nha Trang, Henan, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
