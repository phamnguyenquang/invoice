...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Intesa Sanpaolo} \\
		{\large Athena 61}\\
		{\large 93678, Montreal, Heibei, Philippines}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Nevaeh Larsson } \\
		{\large Christopher 57}\\
		{\large 95601, San Francisco, Huabei, United Kingdom}\\
    \switchcolumn
