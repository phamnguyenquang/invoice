...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bailey  Alexander  Berggren} \\
		{\large Jacob 99}\\
		{\large 19959, Hong Kong, Ang Thong, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sean Robert Löfgren Ltd } \\
		{\large Elise 25}\\
		{\large 45202, London , Guangdong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
