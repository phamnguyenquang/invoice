...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Savannah Jane Gustafsson} \\
		{\large Jayce 82}\\
		{\large 22673, San Francisco, Guangdong, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tucker James Sjögren Ltd } \\
		{\large Theodore 74}\\
		{\large 80785, Washington, Ang Thong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
