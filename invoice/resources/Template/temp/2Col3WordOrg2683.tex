...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nevaeh Michael Forsberg Corp} \\
		{\large Jace 12}\\
		{\large 90741, Minsk, Buriam, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Izabella Lindgren } \\
		{\large Greyson 25}\\
		{\large 91800, Frankfurt am Main , Guangdong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
