...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Pittsburgh} \\
		{\large Alexa 55}\\
		{\large 78246, Florence, Floria, United Kingdom}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Alejandro Andersson } \\
		{\large Ezekiel 94}\\
		{\large 44329, Ho Chi Minh, Amnat Charoen, Switzerland}\\
    \switchcolumn
