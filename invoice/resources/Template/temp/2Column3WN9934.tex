...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sophia Christopher Holmgren} \\
		{\large Mckenzie 8}\\
		{\large 45719, Madrid, Indiana, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Justin Grace 	 Lindström Corp } \\
		{\large Giovanni 17}\\
		{\large 85561, San Francisco, Binh Thuan, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
