...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harmony Lindberg} \\
		{\large Ella 83}\\
		{\large 57029, Beijing, California, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grant Christopher Claesson Corp } \\
		{\large Charles 54}\\
		{\large 77329, Barcelona, Guangdong, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
