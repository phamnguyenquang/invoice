...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon  Alexander  Nordström} \\
		{\large Noah 88}\\
		{\large 76343, Stuttgart, California, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Thomas Strömberg Pte Ltd } \\
		{\large Liam 88}\\
		{\large 87165, Berlin, Hamburg, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
