...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katherine Bengtsson} \\
		{\large Ava 18}\\
		{\large 91223, San Francisco, Chai Nat, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camden Elizabeth 	 Hansson Corp } \\
		{\large Hudson 69}\\
		{\large 85686, Melbourne, Hessen, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
