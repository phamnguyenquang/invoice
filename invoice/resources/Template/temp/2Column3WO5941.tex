...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope Peter Sandström Pte Ltd} \\
		{\large Adriana 88}\\
		{\large 43784, Abu Dhabi, Saarland, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samantha Lindberg } \\
		{\large Lyla 72}\\
		{\large 53420, Boston, Amnat Charoen, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
