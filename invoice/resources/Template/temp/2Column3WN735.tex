...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryleigh May/Mae 	 Mohamed} \\
		{\large Levi 42}\\
		{\large 83172, Bonn, Bangkok, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Kate 	 Nyström Pte Ltd } \\
		{\large Taylor 36}\\
		{\large 22220, London , Bayern, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
