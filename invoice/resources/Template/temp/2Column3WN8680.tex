...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Londyn Louise 	 Blomqvist} \\
		{\large Ryleigh 91}\\
		{\large 12441, Shanghai, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sarah Elizabeth 	 Andersson Inc } \\
		{\large Mariah 99}\\
		{\large 23613, Frankfurt am Main , Amnat Charoen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
