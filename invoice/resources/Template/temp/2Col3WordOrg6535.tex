...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Edward Edward Axelsson Ltd} \\
		{\large Clara 48}\\
		{\large 50287, Amsterdam, Binh Thuan, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Lindberg } \\
		{\large Cole 10}\\
		{\large 95896, New York , Amnat Charoen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
