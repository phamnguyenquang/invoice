...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jacob Christopher Björklund} \\
		{\large Scarlett 38}\\
		{\large 28208, Nha Trang, Seattles, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mason Peter Nordström Corp } \\
		{\large Santiago 3}\\
		{\large 60744, Frankfurt am Main , Chiang Rai, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
