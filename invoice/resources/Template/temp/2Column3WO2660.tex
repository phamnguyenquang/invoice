...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jasmine May/Mae 	 Martinsson Inc} \\
		{\large Elizabeth 15}\\
		{\large 35821, Abu Dhabi, Amnat Charoen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Eriksson } \\
		{\large Joel 97}\\
		{\large 58778, Beijing, Hawaii, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
