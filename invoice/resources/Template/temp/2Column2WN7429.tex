...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rebecca Nilsson} \\
		{\large Alejandro 33}\\
		{\large 59000, Melbourne, Chiang Mai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maxwell Louise 	 Björk Pte Ltd } \\
		{\large Jordan 61}\\
		{\large 44389, Vancouver, Huabei, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
