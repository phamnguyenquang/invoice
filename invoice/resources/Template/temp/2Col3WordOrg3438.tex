...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalia Ann  Holmgren Pte Ltd} \\
		{\large Lucas 26}\\
		{\large 51384, Hong Kong, Chiang Mai, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brayden Ekström } \\
		{\large Madelyn 23}\\
		{\large 26081, Frankfurt am Main , Hessen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
