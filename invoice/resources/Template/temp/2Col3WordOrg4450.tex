...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Athena  Alexander  Berglund Ltd} \\
		{\large Sydney 95}\\
		{\large 87477, New York , Heibei, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Naomi Martinsson } \\
		{\large Adalynn 41}\\
		{\large 59006, Frankfurt am Main , Ang Thong, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
