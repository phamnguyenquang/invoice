...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Benjamin Holmberg} \\
		{\large Melanie 95}\\
		{\large 51200, Amsterdam, Guangzhou, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lauren Michael Ahmed Pte Ltd } \\
		{\large Hailey 62}\\
		{\large 88048, Frankfurt am Main , Guangdong, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
