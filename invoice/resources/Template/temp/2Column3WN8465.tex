...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Marcus  Alexander  Blom} \\
		{\large Kayden 68}\\
		{\large 59300, Frankfurt am Main , Phu Yen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryson Lee  Nyberg Ltd } \\
		{\large Nathaniel 88}\\
		{\large 76503, Milan, Huabei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
