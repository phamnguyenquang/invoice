...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hayden Catherine  Karlsson Ltd} \\
		{\large Brayden 64}\\
		{\large 67579, Budapest, Amnat Charoen, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubrey Norberg } \\
		{\large Emilia 25}\\
		{\large 28679, Singapore, Guangdong, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
