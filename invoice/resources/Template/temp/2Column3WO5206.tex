...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Delilah Jane Lundqvist Pte Ltd} \\
		{\large Carson 62}\\
		{\large 51150, Ho Chi Minh, Floria, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Magnusson } \\
		{\large Jacob 66}\\
		{\large 92645, Munich, Tuscany, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
