...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victoria Rose 	 Bergström} \\
		{\large Ximena 63}\\
		{\large 86969, Chicago, Ang Thong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valerie Christopher Lindholm Corp } \\
		{\large Sawyer 8}\\
		{\large 15598, Seoul, Guangdong, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
