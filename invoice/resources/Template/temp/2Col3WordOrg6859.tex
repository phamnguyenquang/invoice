...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aria Kate 	 Olofsson Ltd} \\
		{\large Brantley 36}\\
		{\large 55873, Budapest, Hawaii, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklynn Gustafsson } \\
		{\large Miguel 58}\\
		{\large 19666, Frankfurt am Main , Binh Thuan, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
