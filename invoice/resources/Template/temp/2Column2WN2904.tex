...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathan Bergström} \\
		{\large Isabelle 62}\\
		{\large 37443, Denver, Phu Yen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Quinn Anne Mattsson Inc } \\
		{\large Violet 68}\\
		{\large 47731, Frankfurt am Main , Chiang Rai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
