...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brody Elizabeth 	 Arvidsson} \\
		{\large Adalynn 2}\\
		{\large 96860, Los Angeles, Bangkok, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Violet Christopher Engström Pte Ltd } \\
		{\large Mya 32}\\
		{\large 78495, Milan, Tuscany, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
