...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Addison John Forsberg} \\
		{\large Nolan 2}\\
		{\large 40754, Singapore, Binh Thuan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryder Louise 	 Strömberg Corp } \\
		{\large Sawyer 78}\\
		{\large 30291, Last Vegas, Chai Nat, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
