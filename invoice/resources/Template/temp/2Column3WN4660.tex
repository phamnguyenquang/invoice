...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bella Mary 	 Lindholm} \\
		{\large Jace 33}\\
		{\large 93767, Stuttgart, Amnat Charoen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklyn  Alexander  Johansson Corp } \\
		{\large Colton 57}\\
		{\large 82447, Stuttgart, Ang Thong, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
