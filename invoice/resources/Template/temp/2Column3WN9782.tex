...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mackenzie Anne Svensson} \\
		{\large Kayden 15}\\
		{\large 76558, Nha Trang, Chiang Mai, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michelle May/Mae 	 Eliasson Pte Ltd } \\
		{\large Emma 40}\\
		{\large 49407, Sydney, Buriam, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
