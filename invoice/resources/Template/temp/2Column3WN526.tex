...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aurora  Alexander  Blomqvist} \\
		{\large Lucy 9}\\
		{\large 54677, Frankfurt am Main , Hessen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maxwell Catherine  Eliasson Ltd } \\
		{\large Abraham 33}\\
		{\large 48587, Dubai, Guangdong, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
