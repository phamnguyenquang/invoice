...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lucas Anne Lundström Corp} \\
		{\large Eliana 90}\\
		{\large 15929, Dublin, Huabei, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Roman Nilsson } \\
		{\large Ella 52}\\
		{\large 86155, Frankfurt am Main , Guangzhou, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
