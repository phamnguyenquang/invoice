...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla Victoria Fransson Corp} \\
		{\large Annabelle 18}\\
		{\large 88609, Frankfurt am Main , Henan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madelyn Claesson } \\
		{\large Landon 62}\\
		{\large 86620, Madrid, Saarland, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
