...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dylan Catherine  Magnusson} \\
		{\large Jason 58}\\
		{\large 12871, Milan, Bremen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alejandro Thomas Lundberg Pte Ltd } \\
		{\large Cayden 20}\\
		{\large 90004, Amsterdam, Guangzhou, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
