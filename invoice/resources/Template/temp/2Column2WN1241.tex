...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezekiel Holmgren} \\
		{\large Elena 28}\\
		{\large 51771, Los Angeles, Floria, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Peyton Elizabeth 	 Fredriksson Inc } \\
		{\large Theodore 25}\\
		{\large 48425, Los Angeles, Binh Thuan, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
