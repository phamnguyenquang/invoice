...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle Marie 	 Fredriksson} \\
		{\large Avery 57}\\
		{\large 38308, Hong Kong, California, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxon John Hassan Pte Ltd } \\
		{\large Kenneth 47}\\
		{\large 34983, Toronto, Bayern, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
