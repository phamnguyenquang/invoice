...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Layla Peter Engström} \\
		{\large Jesse 99}\\
		{\large 82281, Frankfurt am Main , Guangdong, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabel David Isaksson Pte Ltd } \\
		{\large Carter 40}\\
		{\large 50991, Nha Trang, Heibei, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
