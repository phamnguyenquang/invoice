...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kinsley Catherine  Dahlberg} \\
		{\large Mya 82}\\
		{\large 95119, Lisbon, Amnat Charoen, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabel Amy  Sjögren Inc } \\
		{\large Arianna 65}\\
		{\large 91412, Stuttgart, Kentucky, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
