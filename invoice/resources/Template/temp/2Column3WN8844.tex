...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stephanie David Åberg} \\
		{\large Violet 96}\\
		{\large 20492, Hong Kong, Huabei, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn Victoria Sandström Corp } \\
		{\large Londyn 75}\\
		{\large 55739, Berlin, Hamburg, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
