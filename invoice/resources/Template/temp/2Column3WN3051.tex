...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Santiago Lee  Lundin} \\
		{\large Andrew 1}\\
		{\large 58290, New York , Amnat Charoen, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kayla James Fredriksson Ltd } \\
		{\large Sophie 31}\\
		{\large 50454, Melbourne, Bremen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
