...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madison William Lund Pte Ltd} \\
		{\large Mason 59}\\
		{\large 47893, Ho Chi Minh, Amnat Charoen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alex Lindholm } \\
		{\large Bennett 53}\\
		{\large 62158, Venice, California, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
