...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gianna Louise 	 Nordström Ltd} \\
		{\large Rylee 3}\\
		{\large 31217, Hong Kong, Tuscany, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Max Johansson } \\
		{\large Kevin 21}\\
		{\large 88560, San Francisco, Seattles, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
