...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everly Mattsson} \\
		{\large Annabelle 43}\\
		{\large 48943, Beijing, Hessen, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vanessa Elizabeth 	 Lind Corp } \\
		{\large Jake 91}\\
		{\large 46907, Frankfurt am Main , Amnat Charoen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
