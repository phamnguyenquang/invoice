...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrew Louise 	 Lindholm} \\
		{\large Elijah 95}\\
		{\large 10852, Boston, Hamburg, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everly May/Mae 	 Lindqvist Pte Ltd } \\
		{\large Abraham 96}\\
		{\large 67730, Sydney, California, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
