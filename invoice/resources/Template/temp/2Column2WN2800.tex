...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalie Mohamed} \\
		{\large Joshua 78}\\
		{\large 71543, Abu Dhabi, Saarland, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Delilah Thomas Magnusson Corp } \\
		{\large Declan 98}\\
		{\large 77868, Montreal, Phu Yen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
