...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrew Lundin} \\
		{\large Alyssa 92}\\
		{\large 87454, Vancouver, Seattles, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michelle Robert Sjögren Pte Ltd } \\
		{\large Aaron 4}\\
		{\large 17495, Frankfurt am Main , Hamburg, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
