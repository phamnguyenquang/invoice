...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Norah Edward Lundqvist} \\
		{\large Oscar 20}\\
		{\large 35598, Berlin, Binh Thuan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reese Louise 	 Wallin Corp } \\
		{\large Brianna 97}\\
		{\large 37739, Chicago, Floria, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
