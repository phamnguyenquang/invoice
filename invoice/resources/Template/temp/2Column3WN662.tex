...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Elizabeth 	 Berglund} \\
		{\large Giovanni 32}\\
		{\large 78529, Amsterdam, Bremen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy Peter Magnusson Pte Ltd } \\
		{\large Zoe 35}\\
		{\large 68666, Beijing, Bangkok, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
