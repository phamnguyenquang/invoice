...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kinsley Lindqvist} \\
		{\large Chloe 53}\\
		{\large 82379, Frankfurt am Main , Binh Thuan, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kyle Peter Hassan Corp } \\
		{\large Zoey 19}\\
		{\large 73962, Abu Dhabi, Saarland, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
