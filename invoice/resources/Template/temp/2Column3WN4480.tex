...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Noah Louise 	 Sjögren} \\
		{\large Daniela 68}\\
		{\large 42574, San Francisco, Floria, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Serenity Edward Andersson Pte Ltd } \\
		{\large Isaac 96}\\
		{\large 24334, Berlin, Chiang Rai, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
