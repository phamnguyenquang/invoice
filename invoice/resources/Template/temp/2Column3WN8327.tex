...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brody Michael Wikström} \\
		{\large Maxwell 73}\\
		{\large 18534, Berlin, Binh Thuan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooke Kate 	 Lindholm Pte Ltd } \\
		{\large Elise 12}\\
		{\large 94831, San Francisco, Texas, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
