...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sadie Lee  Arvidsson} \\
		{\large Matthew 50}\\
		{\large 54344, Berlin, Binh Thuan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Owen  Alexander  Hermansson Corp } \\
		{\large Autumn 45}\\
		{\large 56031, Hanoi, California, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
