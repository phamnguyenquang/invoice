...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stella Marie 	 Falk} \\
		{\large Henry 2}\\
		{\large 86250, Frankfurt am Main , Phu Yen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Matthew Mary 	 Strömberg Ltd } \\
		{\large Zoey 56}\\
		{\large 38382, Washington, Hessen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
