...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Allison Elizabeth 	 Magnusson} \\
		{\large Justin 24}\\
		{\large 82556, Frankfurt am Main , Ang Thong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Payton Catherine  Norberg Ltd } \\
		{\large Alexandra 89}\\
		{\large 37690, Berlin, Heibei, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
