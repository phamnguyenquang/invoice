...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Preston Louise 	 Blomqvist} \\
		{\large Autumn 66}\\
		{\large 55565, Beijing, khanh Hoa, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cole May/Mae 	 Nordin Pte Ltd } \\
		{\large Avery 56}\\
		{\large 56806, SaiGon, Chiang Rai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
