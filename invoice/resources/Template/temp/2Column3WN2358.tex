...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eleanor Victoria Johansson} \\
		{\large Isabel 96}\\
		{\large 28489, Washington, Hessen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brian  Alexander  Gustafsson Corp } \\
		{\large Benjamin 86}\\
		{\large 43868, Washington, Hamburg, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
