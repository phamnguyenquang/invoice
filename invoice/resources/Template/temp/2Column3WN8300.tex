...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Richard Thomas Holm} \\
		{\large Ella 69}\\
		{\large 34836, San Francisco, Hessen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Taylor Edward Karlsson Pte Ltd } \\
		{\large Connor 71}\\
		{\large 47855, Toronto, Hessen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
