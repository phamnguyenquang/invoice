...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Allison Christopher Pålsson Pte Ltd} \\
		{\large Kyle 27}\\
		{\large 86217, Berlin, Bangkok, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Robert Eriksson } \\
		{\large Edward 98}\\
		{\large 63355, Los Angeles, Hamburg, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
