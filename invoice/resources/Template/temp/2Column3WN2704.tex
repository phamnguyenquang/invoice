...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Catherine Louise 	 Pålsson} \\
		{\large Layla 86}\\
		{\large 77775, Frankfurt am Main , Binh Thuan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joshua Amy  Ekström Pte Ltd } \\
		{\large Scarlett 40}\\
		{\large 61194, Bonn, Hessen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
