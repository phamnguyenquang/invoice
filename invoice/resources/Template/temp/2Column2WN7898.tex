...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katherine Bergqvist} \\
		{\large Zachary 81}\\
		{\large 52386, Lisbon, Chiang Rai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elizabeth Marie 	 Hansson Pte Ltd } \\
		{\large Isaiah 98}\\
		{\large 34070, Stuttgart, Chiang Rai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
