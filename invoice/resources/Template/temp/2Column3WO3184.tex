...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Violet Louise 	 Lundberg Inc} \\
		{\large Noah 90}\\
		{\large 72532, Frankfurt am Main , Hessen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everett Håkansson } \\
		{\large Maddox 86}\\
		{\large 83906, Vancouver, Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
