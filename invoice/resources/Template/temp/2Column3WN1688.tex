...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalia Amy  Magnusson} \\
		{\large Julianna 51}\\
		{\large 33744, Taipei, Floria, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Colton Elizabeth 	 Holmgren Corp } \\
		{\large London 42}\\
		{\large 65360, Amsterdam, khanh Hoa, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
