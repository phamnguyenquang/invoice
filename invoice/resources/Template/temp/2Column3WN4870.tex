...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Declan Victoria Berggren} \\
		{\large Charlotte 80}\\
		{\large 70041, Frankfurt am Main , Bangkok, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mackenzie Jane Lindqvist Corp } \\
		{\large Paige 41}\\
		{\large 74166, Ho Chi Minh, Amnat Charoen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
