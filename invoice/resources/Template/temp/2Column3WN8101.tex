...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katelyn Louise 	 Samuelsson} \\
		{\large Nicholas 86}\\
		{\large 37014, Berlin, Tuscany, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Robert Karlsson Pte Ltd } \\
		{\large Jayden 89}\\
		{\large 58081, Frankfurt am Main , Hainan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
