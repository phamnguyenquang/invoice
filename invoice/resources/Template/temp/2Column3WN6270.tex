...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariana  Alexander  Jakobsson} \\
		{\large Piper 19}\\
		{\large 77391, Toronto, Hessen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sawyer Ann  Bergström Pte Ltd } \\
		{\large Robert 73}\\
		{\large 27586, Chicago, Bremen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
