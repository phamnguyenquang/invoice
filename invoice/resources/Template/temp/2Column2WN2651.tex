...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaleb Dahlberg} \\
		{\large Kingston 35}\\
		{\large 50851, Dubai, Seattles, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kyle Anne Jansson Pte Ltd } \\
		{\large Thomas 7}\\
		{\large 82161, Frankfurt am Main , Chiang Mai, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
