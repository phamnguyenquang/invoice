...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liliana Lindström} \\
		{\large Melody 2}\\
		{\large 89379, San Francisco, Binh Thuan, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Destiny Edward Andreasson Ltd } \\
		{\large Hannah 28}\\
		{\large 53029, Hong Kong, Hamburg, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
