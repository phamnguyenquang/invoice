...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery William Lindgren Pte Ltd} \\
		{\large Claire 74}\\
		{\large 89974, Frankfurt am Main , Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hadley Ali } \\
		{\large Jocelyn 81}\\
		{\large 25332, Venice, Floria, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
