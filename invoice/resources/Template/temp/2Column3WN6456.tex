...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryson  Alexander  Bergman} \\
		{\large Nicholas 64}\\
		{\large 58428, Hong Kong, Guangdong, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angelina James Andersson Ltd } \\
		{\large Margaret 99}\\
		{\large 45492, San Francisco, Heibei, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
