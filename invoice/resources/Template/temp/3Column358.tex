...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Beijing University of Posts and Telecommunications} \\
		{\large Madison 91}\\
		{\large 37779, Frankfurt am Main , Binh Thuan, India }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Brayden Johansson } \\
		{\large Brooke 28}\\
		{\large 57656, Beijing, Chiang Mai, New Zealand}\\
    \switchcolumn
