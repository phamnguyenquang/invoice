...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rebecca Edward Ahmed} \\
		{\large Hazel 38}\\
		{\large 93436, San Francisco, Bangkok, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryker Marie 	 Abrahamsson Pte Ltd } \\
		{\large Nicolas 20}\\
		{\large 96752, Istanbul, khanh Hoa, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
