...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aria Persson} \\
		{\large Gracie 73}\\
		{\large 23069, Frankfurt am Main , Bangkok, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmett John Axelsson Pte Ltd } \\
		{\large Ella 77}\\
		{\large 40806, Frankfurt am Main , Guangzhou, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
