...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklynn Michael Hermansson} \\
		{\large Adalyn 88}\\
		{\large 53290, Budapest, khanh Hoa, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abel Christopher Åkesson Corp } \\
		{\large Kayla 26}\\
		{\large 30137, Berlin, Chai Nat, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
