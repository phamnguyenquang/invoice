...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel  Alexander  Persson} \\
		{\large Autumn 7}\\
		{\large 31303, Stuttgart, Hainan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bentley Victoria Magnusson Ltd } \\
		{\large Riley 15}\\
		{\large 24222, Seoul, Chiang Rai, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
