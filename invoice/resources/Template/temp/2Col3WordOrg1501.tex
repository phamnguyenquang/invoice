...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Samuel William Bergström Pte Ltd} \\
		{\large Khloe 39}\\
		{\large 82053, Vienna, Floria, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mackenzie Fransson } \\
		{\large Maddox 42}\\
		{\large 32149, Melbourne, California, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
