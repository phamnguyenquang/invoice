...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alaina  Alexander  Hellström} \\
		{\large Antonio 90}\\
		{\large 68052, Hong Kong, Indiana, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Patrick Elizabeth 	 Axelsson Corp } \\
		{\large Jocelyn 33}\\
		{\large 53118, Frankfurt am Main , Bangkok, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
