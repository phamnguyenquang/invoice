...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabel Jakobsson Pte Ltd} \\
		{\large Christopher 74}\\
		{\large 24563, Hong Kong, Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brianna Ekström } \\
		{\large Harrison 37}\\
		{\large 76169, Nha Trang, Binh Thuan, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
