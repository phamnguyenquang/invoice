...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ashton Anne Forsberg} \\
		{\large Mary 50}\\
		{\large 86466, Frankfurt am Main , Binh Thuan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amy David Gustafsson Ltd } \\
		{\large Valeria 2}\\
		{\large 31853, Melbourne, California, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
