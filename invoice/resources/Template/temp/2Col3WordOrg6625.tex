...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Thomas Fredriksson Pte Ltd} \\
		{\large Ryleigh 66}\\
		{\large 70678, Nha Trang, Amnat Charoen, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Eliasson } \\
		{\large Jaxon 32}\\
		{\large 90855, Frankfurt am Main , Binh Thuan, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
