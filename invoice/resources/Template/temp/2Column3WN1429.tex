...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Easton Christopher Lundström} \\
		{\large Kyle 17}\\
		{\large 12855, Vancouver, Phu Yen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Savannah Ann  Engström Pte Ltd } \\
		{\large Lucas 73}\\
		{\large 62768, Budapest, Hessen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
