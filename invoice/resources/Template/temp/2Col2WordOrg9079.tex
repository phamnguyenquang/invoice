...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hannah Nilsson Pte Ltd} \\
		{\large Austin 14}\\
		{\large 82271, Frankfurt am Main , Guangdong, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Justin Arvidsson } \\
		{\large James 70}\\
		{\large 13823, San Francisco, Hawaii, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
