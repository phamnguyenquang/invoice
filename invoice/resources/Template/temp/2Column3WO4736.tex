...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julian Christopher Åberg Inc} \\
		{\large Luke 22}\\
		{\large 11430, Last Vegas, Guangzhou, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan Holmberg } \\
		{\large Amelia 95}\\
		{\large 78988, Berlin, Ang Thong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
