...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elijah  Alexander  Arvidsson Corp} \\
		{\large Maximus 43}\\
		{\large 62942, Hong Kong, Amnat Charoen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan Abrahamsson } \\
		{\large Brielle 25}\\
		{\large 59180, Last Vegas, Texas, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
