...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maverick Martinsson} \\
		{\large Cora 89}\\
		{\large 74384, Washington, Chiang Mai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katelyn William Lundström Corp } \\
		{\large Violet 91}\\
		{\large 33037, Madrid, Floria, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
