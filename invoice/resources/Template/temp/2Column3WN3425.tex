...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Landon Marie 	 Danielsson} \\
		{\large Lila 20}\\
		{\large 10277, Hong Kong, Huabei, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julian Ann  Andersson Inc } \\
		{\large Bryce 42}\\
		{\large 67756, Amsterdam, Floria, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
