...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hannah Louise 	 Söderberg Inc} \\
		{\large Elizabeth 5}\\
		{\large 15059, San Francisco, Bangkok, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brady Falk } \\
		{\large Owen 24}\\
		{\large 64818, Frankfurt am Main , Guangdong, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
