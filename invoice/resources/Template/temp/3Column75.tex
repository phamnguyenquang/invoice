...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Chonnam National University	South} \\
		{\large Stella 57}\\
		{\large 63212, Hong Kong, Indiana, South Africa }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Adriana Lund } \\
		{\large Serenity 16}\\
		{\large 80783, Hong Kong, Amnat Charoen, Saudi Arabia }\\
    \switchcolumn
