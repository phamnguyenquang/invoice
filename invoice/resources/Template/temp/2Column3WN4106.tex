...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklynn Christopher Svensson} \\
		{\large Christian 42}\\
		{\large 49457, Berlin, Guangdong, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kinsley May/Mae 	 Jönsson Corp } \\
		{\large Jaden 86}\\
		{\large 32020, Moscow, Tuscany, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
