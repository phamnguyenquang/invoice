...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Xavier Louise 	 Lundin} \\
		{\large Mya 56}\\
		{\large 27971, Lisbon, Hamburg, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexa Christopher Dahlberg Pte Ltd } \\
		{\large Caleb 7}\\
		{\large 83208, Last Vegas, Chai Nat, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
