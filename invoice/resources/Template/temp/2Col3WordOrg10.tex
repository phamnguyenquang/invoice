...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  James David Bergström Ltd} \\
		{\large Everly 73}\\
		{\large 16886, Frankfurt am Main , Tuscany, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brody Hansen } \\
		{\large Anthony 2}\\
		{\large 99859, Istanbul, Chai Nat, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
