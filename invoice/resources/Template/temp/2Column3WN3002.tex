...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Destiny John Björklund} \\
		{\large Reese 26}\\
		{\large 48520, Frankfurt am Main , Hamburg, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Henry Mary 	 Gunnarsson Inc } \\
		{\large Sebastian 49}\\
		{\large 57912, Sydney, Huabei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
