...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Malachi Lindberg} \\
		{\large Valerie 68}\\
		{\large 59272, Amsterdam, Chiang Rai, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gianna Louise 	 Blomqvist Ltd } \\
		{\large Ariana 82}\\
		{\large 75188, Chicago, Guangzhou, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
