...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexander Louise 	 Holmgren} \\
		{\large Jake 26}\\
		{\large 62416, Nha Trang, Bayern, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maverick James Samuelsson Pte Ltd } \\
		{\large Gabrielle 52}\\
		{\large 98385, Dubai, Guangdong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
