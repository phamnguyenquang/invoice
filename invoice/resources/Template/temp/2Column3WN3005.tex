...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Catherine  Söderberg} \\
		{\large Hailey 34}\\
		{\large 65694, Moscow, Bangkok, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ayden Christopher Andreasson Pte Ltd } \\
		{\large Aria 86}\\
		{\large 37050, Vienna, Guangdong, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
