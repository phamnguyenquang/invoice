...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liliana Christopher Larsson} \\
		{\large Jayla 36}\\
		{\large 73239, Dublin, Guangzhou, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Calvin May/Mae 	 Jönsson Inc } \\
		{\large Chase 64}\\
		{\large 77999, Frankfurt am Main , Saarland, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
