...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrea Rose 	 Larsson} \\
		{\large Caleb 38}\\
		{\large 80096, Stuttgart, Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alana Jane Dahlberg Pte Ltd } \\
		{\large Josephine 4}\\
		{\large 96224, Budapest, Buriam, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
