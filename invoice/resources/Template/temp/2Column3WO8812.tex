...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro Elizabeth 	 Karlsson Pte Ltd} \\
		{\large Owen 19}\\
		{\large 93537, Paris, Hawaii, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Declan Engström } \\
		{\large Connor 84}\\
		{\large 23015, Taipei, Chiang Mai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
