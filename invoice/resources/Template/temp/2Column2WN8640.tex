...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryan Söderberg} \\
		{\large Payton 50}\\
		{\large 67482, Frankfurt am Main , California, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isaiah Elizabeth 	 Mohamed Inc } \\
		{\large Oliver 67}\\
		{\large 96262, Paris, khanh Hoa, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
