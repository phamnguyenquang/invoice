...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valentina Michael Jonsson} \\
		{\large Izabella 47}\\
		{\large 16731, Taipei, khanh Hoa, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Laila Christopher Eliasson Ltd } \\
		{\large Elena 53}\\
		{\large 82202, Last Vegas, Kentucky, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
