...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle Bengtsson} \\
		{\large Ellie 48}\\
		{\large 23245, Amsterdam, Ang Thong, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaleb Louise 	 Nordin Pte Ltd } \\
		{\large Christopher 94}\\
		{\large 43829, San Francisco, Texas, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
