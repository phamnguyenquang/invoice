...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ruby Persson} \\
		{\large Valentina 15}\\
		{\large 48854, Berlin, Guangdong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Braxton Ann  Andersson Pte Ltd } \\
		{\large Mary 3}\\
		{\large 88875, Frankfurt am Main , Tuscany, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
