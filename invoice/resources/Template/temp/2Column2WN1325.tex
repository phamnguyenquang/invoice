...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madison Gustafsson} \\
		{\large Valentina 60}\\
		{\large 78227, Abu Dhabi, Chai Nat, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katherine Catherine  Isaksson Pte Ltd } \\
		{\large Peyton 51}\\
		{\large 71213, Singapore, Saarland, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
