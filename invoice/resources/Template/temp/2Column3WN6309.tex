...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amelia Elizabeth 	 Andreasson} \\
		{\large Caroline 72}\\
		{\large 33102, Toronto, Amnat Charoen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large John Louise 	 Sandberg Pte Ltd } \\
		{\large Eden 33}\\
		{\large 35758, Florence, Chiang Rai, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
