...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elise Hedlund} \\
		{\large Alyssa 59}\\
		{\large 91927, Ho Chi Minh, khanh Hoa, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariana Grace 	 Nordin Corp } \\
		{\large Sadie 39}\\
		{\large 22261, Ho Chi Minh, Seattles, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
