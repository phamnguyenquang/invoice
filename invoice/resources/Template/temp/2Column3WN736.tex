...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bailey Marie 	 Ahmed} \\
		{\large Adeline 76}\\
		{\large 98489, Milan, Ang Thong, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Skylar Christopher Sundberg Ltd } \\
		{\large Isabel 43}\\
		{\large 98366, Los Angeles, Chiang Rai, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
