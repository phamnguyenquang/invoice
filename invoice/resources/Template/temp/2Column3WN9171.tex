...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josiah Ann  Danielsson} \\
		{\large Abraham 13}\\
		{\large 17167, Last Vegas, Seattles, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Clara Christopher Larsson Inc } \\
		{\large Paul 9}\\
		{\large 98533, Hong Kong, Chiang Rai, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
