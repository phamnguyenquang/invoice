...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emily Louise 	 Håkansson} \\
		{\large Leilani 77}\\
		{\large 78873, Shanghai, Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rachel John Lindholm Inc } \\
		{\large Izabella 55}\\
		{\large 65489, Frankfurt am Main , Bangkok, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
