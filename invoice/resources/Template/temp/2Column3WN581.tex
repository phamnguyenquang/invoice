...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesus Louise 	 Pettersson} \\
		{\large Victor 38}\\
		{\large 68530, Dubai, Ang Thong, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madison Victoria Nyberg Inc } \\
		{\large Morgan 43}\\
		{\large 17888, Beijing, Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
