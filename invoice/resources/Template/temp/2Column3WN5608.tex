...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmett Victoria Dahl} \\
		{\large Michael 19}\\
		{\large 29330, Frankfurt am Main , Guangdong, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubree Louise 	 Wikström Corp } \\
		{\large Bradley 40}\\
		{\large 46498, Hanoi, Hessen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
