...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla  Alexander  Nordström} \\
		{\large Eliana 75}\\
		{\large 74400, Denver, Hamburg, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alyssa  Alexander  Bergqvist Ltd } \\
		{\large Kaitlyn 6}\\
		{\large 83495, Barcelona, Saarland, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
