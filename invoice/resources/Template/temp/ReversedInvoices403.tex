...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Goethe University Frankfurt} \\
		{\large Evan 4}\\
		{\large 21400, New York , Bremen, VietNam}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Peyton Lindholm } \\
		{\large Christopher 45}\\
		{\large 21566, Dublin, California, France }\\
    \switchcolumn
