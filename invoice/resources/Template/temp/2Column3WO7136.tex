...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicole Edward Eriksson Inc} \\
		{\large Daisy 43}\\
		{\large 52156, Frankfurt am Main , California, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aidan Eriksson } \\
		{\large Wyatt 76}\\
		{\large 30307, Chicago, Saarland, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
