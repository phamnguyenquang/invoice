...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Benjamin  Alexander  Samuelsson Ltd} \\
		{\large Kimberly 26}\\
		{\large 72139, New York , Texas, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kylie Strömberg } \\
		{\large Ximena 98}\\
		{\large 48209, Frankfurt am Main , Guangzhou, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
