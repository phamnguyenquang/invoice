...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sarah  Alexander  Lind} \\
		{\large Henry 31}\\
		{\large 53466, San Francisco, Guangdong, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Preston John Berggren Pte Ltd } \\
		{\large Damian 23}\\
		{\large 86758, Denver, Hawaii, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
