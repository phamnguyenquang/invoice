...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Izabella Marie 	 Isaksson} \\
		{\large Nicholas 92}\\
		{\large 83835, Montreal, Chiang Rai, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kingston Thomas Axelsson Ltd } \\
		{\large Ryleigh 49}\\
		{\large 82245, Chicago, California, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
