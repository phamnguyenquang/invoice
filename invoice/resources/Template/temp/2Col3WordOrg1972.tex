...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brayden  Alexander  Håkansson Pte Ltd} \\
		{\large Rachel 49}\\
		{\large 84310, Frankfurt am Main , Hessen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hudson Dahl } \\
		{\large Logan 45}\\
		{\large 23464, Vancouver, Texas, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
