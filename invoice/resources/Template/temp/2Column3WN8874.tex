...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abel  Alexander  Magnusson} \\
		{\large Kayla 56}\\
		{\large 71199, Washington, khanh Hoa, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hunter Robert Blomqvist Pte Ltd } \\
		{\large Jake 16}\\
		{\large 45588, Lisbon, Ang Thong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
