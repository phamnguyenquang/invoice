...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Wikström} \\
		{\large Melanie 55}\\
		{\large 43439, Frankfurt am Main , Hainan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alana Louise 	 Andreasson Pte Ltd } \\
		{\large Bryan 46}\\
		{\large 65482, SaiGon, Bayern, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
