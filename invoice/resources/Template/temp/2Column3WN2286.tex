...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kayla Victoria Pålsson} \\
		{\large Matthew 71}\\
		{\large 66184, Melbourne, Seattles, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ivan Rose 	 Martinsson Inc } \\
		{\large Christopher 99}\\
		{\large 86039, Dublin, Hamburg, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
