...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria Elizabeth 	 Ström} \\
		{\large Christopher 44}\\
		{\large 16528, Bonn, Tuscany, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Molly James Holm Pte Ltd } \\
		{\large Quinn 6}\\
		{\large 14759, Shanghai, Hawaii, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
