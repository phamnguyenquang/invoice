...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  National and Kapodistrian University of Athens} \\
		{\large Sawyer 1}\\
		{\large 13045, Amsterdam, Buriam, Australia }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Madelyn Strömberg } \\
		{\large Nicolas 72}\\
		{\large 91835, Berlin, Bayern, ThaiLand}\\
    \switchcolumn
