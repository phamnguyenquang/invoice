...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amelia Lee  Danielsson Pte Ltd} \\
		{\large Kimberly 58}\\
		{\large 30643, Amsterdam, Chiang Rai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Micah Nyström } \\
		{\large Adalyn 65}\\
		{\large 10309, Amsterdam, Chiang Rai, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
