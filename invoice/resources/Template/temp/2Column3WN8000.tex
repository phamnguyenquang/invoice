...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Michael Andreasson} \\
		{\large Stephanie 49}\\
		{\large 23126, Berlin, Chiang Mai, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gianna Grace 	 Håkansson Corp } \\
		{\large Caleb 65}\\
		{\large 94411, Florence, Buriam, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
