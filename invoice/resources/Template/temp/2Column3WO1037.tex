...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles May/Mae 	 Sundberg Corp} \\
		{\large Noah 81}\\
		{\large 79818, Venice, Chiang Mai, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Penelope Samuelsson } \\
		{\large Aaliyah 36}\\
		{\large 40476, Frankfurt am Main , Texas, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
