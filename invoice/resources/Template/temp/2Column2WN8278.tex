...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Oliver Hermansson} \\
		{\large Jack 72}\\
		{\large 31584, Sydney, Binh Thuan, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaitlyn Catherine  Arvidsson Corp } \\
		{\large Gael 53}\\
		{\large 73537, Los Angeles, Phu Yen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
