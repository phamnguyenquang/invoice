...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline Michael Hermansson Corp} \\
		{\large Penelope 11}\\
		{\large 99291, Barcelona, Huabei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ian Månsson } \\
		{\large Kaitlyn 30}\\
		{\large 49136, Frankfurt am Main , khanh Hoa, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
