...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liliana Catherine  Holmgren Ltd} \\
		{\large Rebecca 7}\\
		{\large 82659, Istanbul, Amnat Charoen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wyatt Johansson } \\
		{\large Lilly 89}\\
		{\large 30976, Hong Kong, Hessen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
