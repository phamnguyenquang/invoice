...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Robert Victoria Sandberg} \\
		{\large Kennedy 97}\\
		{\large 27967, Lisbon, Guangzhou, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katherine Victoria Åkesson Corp } \\
		{\large Bennett 52}\\
		{\large 30679, Abu Dhabi, Heibei, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
