...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Colton John Johansson} \\
		{\large Jesus 18}\\
		{\large 63199, Dubai, Floria, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mila  Alexander  Lundgren Inc } \\
		{\large Zachary 37}\\
		{\large 97888, Frankfurt am Main , khanh Hoa, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
