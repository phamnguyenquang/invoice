...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mark Elizabeth 	 Gustafsson} \\
		{\large Jose 69}\\
		{\large 91972, Ho Chi Minh, Seattles, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mark Edward Pålsson Corp } \\
		{\large Maverick 25}\\
		{\large 89660, Dublin, Chiang Mai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
