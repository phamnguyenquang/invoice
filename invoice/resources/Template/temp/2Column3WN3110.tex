...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Justin Christopher Larsson} \\
		{\large Charlotte 73}\\
		{\large 39654, Munich, Henan, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Thomas Nordin Inc } \\
		{\large Caden 40}\\
		{\large 15699, Abu Dhabi, Amnat Charoen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
