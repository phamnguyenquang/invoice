...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Gustafsson} \\
		{\large Mary 43}\\
		{\large 58242, Florence, Amnat Charoen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lily Robert Björk Pte Ltd } \\
		{\large Norah 23}\\
		{\large 79709, Denver, Chiang Mai, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
