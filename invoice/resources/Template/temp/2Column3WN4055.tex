...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Levi Amy  Isaksson} \\
		{\large Noah 29}\\
		{\large 27642, Singapore, Hainan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore Louise 	 Eriksson Pte Ltd } \\
		{\large George 39}\\
		{\large 76247, Chicago, Indiana, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
