...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joel  Alexander  Ekström} \\
		{\large Paisley 22}\\
		{\large 15828, Singapore, Floria, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kenneth Christopher Nyberg Inc } \\
		{\large Isaac 81}\\
		{\large 26563, Denver, Bayern, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
