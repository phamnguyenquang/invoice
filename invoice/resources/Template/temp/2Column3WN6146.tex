...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Scarlett Catherine  Sjöberg} \\
		{\large Lyla 99}\\
		{\large 46975, Abu Dhabi, Saarland, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mateo Anne Pettersson Ltd } \\
		{\large Liam 15}\\
		{\large 74193, Taipei, Chiang Mai, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
