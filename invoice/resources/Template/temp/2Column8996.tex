...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joel Lindholm Pte Ltd} \\
		{\large Jace 41}\\
		{\large 90708, Frankfurt am Main , Hessen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elizabeth Wallin } \\
		{\large Caleb 89}\\
		{\large 65529, Frankfurt am Main , Chai Nat, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
