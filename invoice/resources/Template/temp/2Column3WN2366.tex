...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bentley Christopher Berg} \\
		{\large Grayson 2}\\
		{\large 49621, Last Vegas, Bangkok, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madison Rose 	 Sundberg Pte Ltd } \\
		{\large Mason 29}\\
		{\large 92631, Stuttgart, Indiana, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
