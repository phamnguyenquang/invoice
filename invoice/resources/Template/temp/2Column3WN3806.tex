...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  King Jane Lundgren} \\
		{\large Melanie 60}\\
		{\large 81701, Amsterdam, Guangdong, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Austin Victoria Fredriksson Pte Ltd } \\
		{\large Graham 94}\\
		{\large 14502, Taipei, Saarland, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
