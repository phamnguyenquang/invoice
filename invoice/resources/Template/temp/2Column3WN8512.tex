...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Chase Edward Martinsson} \\
		{\large Christopher 98}\\
		{\large 64761, Minsk, Floria, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large James Michael Fransson Corp } \\
		{\large Abraham 2}\\
		{\large 51542, Venice, khanh Hoa, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
