...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Athena Edward Åberg} \\
		{\large Hannah 96}\\
		{\large 31516, Ho Chi Minh, Kentucky, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emery Louise 	 Nordström Corp } \\
		{\large Amelia 22}\\
		{\large 56006, Singapore, Hessen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
