...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daisy Louise 	 Lundqvist} \\
		{\large Leonardo 29}\\
		{\large 24408, Minsk, Chai Nat, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joseph Victoria Andreasson Inc } \\
		{\large Ariana 13}\\
		{\large 29410, SaiGon, Seattles, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
