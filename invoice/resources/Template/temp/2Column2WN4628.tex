...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kylie Bergman} \\
		{\large Isabella 30}\\
		{\large 82314, Hong Kong, Chiang Mai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eli Christopher Andersson Pte Ltd } \\
		{\large Asher 42}\\
		{\large 59836, London , Indiana, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
