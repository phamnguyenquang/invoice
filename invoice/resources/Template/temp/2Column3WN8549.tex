...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mary Catherine  Månsson} \\
		{\large Aurora 33}\\
		{\large 21740, Abu Dhabi, Hessen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stella Ann  Johansson Inc } \\
		{\large Alexis 26}\\
		{\large 49032, Frankfurt am Main , Phu Yen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
