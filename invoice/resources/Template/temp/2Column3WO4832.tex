...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Edward Grace 	 Andersson Pte Ltd} \\
		{\large Anthony 85}\\
		{\large 60062, Frankfurt am Main , Binh Thuan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian Blom } \\
		{\large Cameron 29}\\
		{\large 84444, Stuttgart, Saarland, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
