...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte Elizabeth 	 Blomqvist} \\
		{\large Reese 62}\\
		{\large 95210, Frankfurt am Main , Huabei, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucas David Jonsson Ltd } \\
		{\large Molly 94}\\
		{\large 30006, Frankfurt am Main , California, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
