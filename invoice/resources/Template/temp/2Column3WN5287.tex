...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonathan Rose 	 Sjöberg} \\
		{\large Makayla 70}\\
		{\large 29121, San Francisco, Chai Nat, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brielle Marie 	 Henriksson Corp } \\
		{\large Ryan 45}\\
		{\large 64263, Florence, Hawaii, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
