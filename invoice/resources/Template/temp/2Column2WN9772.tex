...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Antonio Gunnarsson} \\
		{\large Evan 76}\\
		{\large 22543, Vancouver, Guangzhou, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabella Elizabeth 	 Hermansson Inc } \\
		{\large Abraham 39}\\
		{\large 90871, Boston, Kentucky, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
