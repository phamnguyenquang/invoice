...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Catholic University of the Sacred Heart} \\
		{\large Summer 78}\\
		{\large 84818, Los Angeles, Chiang Rai, Indonesia s}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Avery Pettersson } \\
		{\large Benjamin 10}\\
		{\large 80564, London , Bayern, ThaiLand}\\
    \switchcolumn
