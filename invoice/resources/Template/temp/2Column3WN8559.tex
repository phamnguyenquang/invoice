...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ximena Ann  Jönsson} \\
		{\large Elijah 81}\\
		{\large 18225, Last Vegas, Hessen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aurora Peter Persson Pte Ltd } \\
		{\large Amy 95}\\
		{\large 16738, Frankfurt am Main , Guangzhou, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
