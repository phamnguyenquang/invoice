...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaden Anne Svensson Pte Ltd} \\
		{\large Katelyn 26}\\
		{\large 64793, Frankfurt am Main , Hainan, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katelyn Berglund } \\
		{\large Joel 8}\\
		{\large 67078, Frankfurt am Main , Bremen, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
