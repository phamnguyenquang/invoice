...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezra Elizabeth 	 Bergström} \\
		{\large Lyla 51}\\
		{\large 25385, Frankfurt am Main , Seattles, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isla John Lindström Inc } \\
		{\large Roman 56}\\
		{\large 17426, Vancouver, Bremen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
