...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adriana Lee  Hellström} \\
		{\large Chloe 45}\\
		{\large 45492, San Francisco, Saarland, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryan Marie 	 Lindberg Ltd } \\
		{\large Jordyn 39}\\
		{\large 17177, Chicago, Amnat Charoen, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
