...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vivian Mary 	 Olsson} \\
		{\large Rylee 63}\\
		{\large 76605, Ho Chi Minh, Guangdong, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaiden Elizabeth 	 Lindgren Ltd } \\
		{\large Asher 50}\\
		{\large 46058, Vancouver, Huabei, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
