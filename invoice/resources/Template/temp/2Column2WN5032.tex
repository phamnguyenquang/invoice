...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaron Lindholm} \\
		{\large Taylor 38}\\
		{\large 14108, Frankfurt am Main , Hamburg, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaylee Anne Axelsson Pte Ltd } \\
		{\large Alexis 10}\\
		{\large 37653, Frankfurt am Main , Chiang Mai, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
