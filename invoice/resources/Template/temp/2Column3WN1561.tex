...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melanie Marie 	 Strömberg} \\
		{\large Izabella 50}\\
		{\large 36313, Budapest, Amnat Charoen, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aiden Edward Henriksson Ltd } \\
		{\large Aubree 10}\\
		{\large 89438, Abu Dhabi, Seattles, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
