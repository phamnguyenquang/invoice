...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Izabella William Andersson} \\
		{\large Adeline 31}\\
		{\large 92017, Chicago, Guangdong, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Marie 	 Svensson Inc } \\
		{\large Anna 11}\\
		{\large 91589, Stuttgart, Bangkok, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
