...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Peyton Jane Jakobsson} \\
		{\large Isabelle 97}\\
		{\large 79005, Budapest, Chai Nat, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn Elizabeth 	 Larsson Corp } \\
		{\large Skylar 60}\\
		{\large 82960, Beijing, khanh Hoa, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
