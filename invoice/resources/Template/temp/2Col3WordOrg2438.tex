...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryder Kate 	 Dahlberg Corp} \\
		{\large Tristan 28}\\
		{\large 65107, Seoul, Binh Thuan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michelle Dahlberg } \\
		{\large Bailey 94}\\
		{\large 24292, Frankfurt am Main , Phu Yen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
