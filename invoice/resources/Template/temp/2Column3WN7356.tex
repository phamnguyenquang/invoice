...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Damian Catherine  Håkansson} \\
		{\large Vanessa 22}\\
		{\large 88357, Berlin, Indiana, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Quinn Peter Gustafsson Pte Ltd } \\
		{\large Eric 72}\\
		{\large 53705, Boston, Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
