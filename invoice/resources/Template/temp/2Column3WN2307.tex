...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  King Catherine  Bergqvist} \\
		{\large Cameron 25}\\
		{\large 20100, Minsk, Hawaii, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley David Gustafsson Pte Ltd } \\
		{\large Preston 22}\\
		{\large 29565, Los Angeles, Hamburg, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
