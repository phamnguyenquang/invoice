...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aliyah Lindholm} \\
		{\large Madelyn 41}\\
		{\large 94102, Nha Trang, Seattles, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sawyer Catherine  Berggren Ltd } \\
		{\large Emily 21}\\
		{\large 92820, Frankfurt am Main , California, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
