...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Layla Catherine  Wikström} \\
		{\large Carson 77}\\
		{\large 70388, Istanbul, Amnat Charoen, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nolan William Hansen Pte Ltd } \\
		{\large Jeremiah 43}\\
		{\large 18562, Chicago, Hamburg, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
