...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Blake Louise 	 Lindström} \\
		{\large Vanessa 19}\\
		{\large 97862, Abu Dhabi, khanh Hoa, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caleb Victoria Berglund Pte Ltd } \\
		{\large Jayla 69}\\
		{\large 43827, Istanbul, Seattles, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
