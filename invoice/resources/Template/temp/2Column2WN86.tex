...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paisley Bengtsson} \\
		{\large Harmony 70}\\
		{\large 52883, Istanbul, Hainan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalynn Jane Nilsson Pte Ltd } \\
		{\large Eleanor 13}\\
		{\large 63304, Frankfurt am Main , Hainan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
