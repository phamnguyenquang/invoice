...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isaac Michael Öberg} \\
		{\large Margaret 37}\\
		{\large 97981, Washington, Kentucky, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brady  Alexander  Fransson Ltd } \\
		{\large Roman 30}\\
		{\large 54726, Amsterdam, Seattles, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
