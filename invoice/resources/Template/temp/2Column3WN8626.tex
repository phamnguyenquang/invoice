...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harper Kate 	 Eriksson} \\
		{\large Maddox 75}\\
		{\large 76652, Moscow, Phu Yen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sean Robert Hassan Pte Ltd } \\
		{\large Ashley 73}\\
		{\large 23946, Frankfurt am Main , Heibei, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
