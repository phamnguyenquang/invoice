...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle Rose 	 Lundqvist} \\
		{\large Jeremiah 60}\\
		{\large 11547, San Francisco, khanh Hoa, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sophie John Pålsson Ltd } \\
		{\large Jennifer 78}\\
		{\large 51909, Dubai, Hawaii, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
