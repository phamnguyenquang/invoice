...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery Rose 	 Gustafsson} \\
		{\large Isaac 73}\\
		{\large 23141, Munich, Heibei, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaleb  Alexander  Henriksson Ltd } \\
		{\large Luis 11}\\
		{\large 15459, Frankfurt am Main , Heibei, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
