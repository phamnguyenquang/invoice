...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Allison James Gunnarsson Pte Ltd} \\
		{\large King 9}\\
		{\large 55779, Berlin, Guangzhou, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lauren Martinsson } \\
		{\large Bentley 83}\\
		{\large 69304, Singapore, Hessen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
