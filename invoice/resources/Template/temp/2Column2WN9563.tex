...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Bengtsson} \\
		{\large Braxton 61}\\
		{\large 28174, Last Vegas, Buriam, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalynn  Alexander  Holmberg Ltd } \\
		{\large Alexis 60}\\
		{\large 31297, Frankfurt am Main , Chiang Rai, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
