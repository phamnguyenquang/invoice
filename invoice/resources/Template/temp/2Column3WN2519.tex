...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hailey May/Mae 	 Fransson} \\
		{\large Colin 9}\\
		{\large 97333, Amsterdam, Kentucky, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalia Lee  Nordström Corp } \\
		{\large Sofia 86}\\
		{\large 74480, Hong Kong, Chai Nat, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
