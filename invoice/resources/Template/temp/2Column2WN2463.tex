...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adam Löfgren} \\
		{\large Ashton 48}\\
		{\large 67345, Frankfurt am Main , Saarland, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hayden Kate 	 Söderberg Pte Ltd } \\
		{\large Steven 13}\\
		{\large 38392, Minsk, Seattles, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
