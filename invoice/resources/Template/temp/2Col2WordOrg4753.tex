...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everett Olsson Pte Ltd} \\
		{\large Amelia 68}\\
		{\large 90882, Frankfurt am Main , Kentucky, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Arianna Eliasson } \\
		{\large Abigail 96}\\
		{\large 78581, Boston, Binh Thuan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
