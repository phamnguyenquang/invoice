...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amir Victoria Öberg} \\
		{\large Adriana 8}\\
		{\large 82023, San Francisco, Floria, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wesley Victoria Fransson Corp } \\
		{\large Kingston 13}\\
		{\large 20875, Shanghai, Tuscany, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
