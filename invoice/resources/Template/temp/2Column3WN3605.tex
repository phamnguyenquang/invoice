...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grace John Isaksson} \\
		{\large Eli 67}\\
		{\large 56931, Frankfurt am Main , Amnat Charoen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Taylor James Lindholm Corp } \\
		{\large Greyson 13}\\
		{\large 42838, Ho Chi Minh, Kentucky, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
