...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Addison Hassan} \\
		{\large Jennifer 25}\\
		{\large 96131, Frankfurt am Main , Ang Thong, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maverick Edward Fransson Pte Ltd } \\
		{\large Madeline 90}\\
		{\large 88525, Dubai, California, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
