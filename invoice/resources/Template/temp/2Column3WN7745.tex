...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hayden James Mårtensson} \\
		{\large Jesus 22}\\
		{\large 40501, Singapore, Kentucky, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daisy Jane Svensson Inc } \\
		{\large Lauren 58}\\
		{\large 63460, Frankfurt am Main , Hamburg, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
