...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Preston Viklund} \\
		{\large Dylan 22}\\
		{\large 62089, Montreal, Guangzhou, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Easton James Bergström Pte Ltd } \\
		{\large Leonardo 60}\\
		{\large 34643, Frankfurt am Main , Guangzhou, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
