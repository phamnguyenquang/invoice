...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luke Andreasson} \\
		{\large Audrey 47}\\
		{\large 66668, Frankfurt am Main , Indiana, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Edward Grace 	 Gustafsson Corp } \\
		{\large Sadie 73}\\
		{\large 73207, Barcelona, Buriam, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
