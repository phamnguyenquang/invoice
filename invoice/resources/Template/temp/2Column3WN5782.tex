...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everly Marie 	 Holmgren} \\
		{\large Bryson 22}\\
		{\large 20503, Shanghai, Chiang Rai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maverick Ann  Fredriksson Ltd } \\
		{\large Preston 11}\\
		{\large 60488, Dublin, Hamburg, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
