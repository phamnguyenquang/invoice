...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Silas May/Mae 	 Engström Pte Ltd} \\
		{\large Kayla 30}\\
		{\large 86746, SaiGon, Bremen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella Mattsson } \\
		{\large Jaxson 5}\\
		{\large 15381, Nha Trang, Bangkok, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
