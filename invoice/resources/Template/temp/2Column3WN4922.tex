...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tristan Rose 	 Holmgren} \\
		{\large Skylar 18}\\
		{\large 18792, Florence, Hamburg, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooke Grace 	 Blomqvist Pte Ltd } \\
		{\large Weston 57}\\
		{\large 77225, Chicago, Hainan, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
