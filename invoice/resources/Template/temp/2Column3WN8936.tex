...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mckenzie Marie 	 Söderberg} \\
		{\large Emily 45}\\
		{\large 85670, Hong Kong, Binh Thuan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Norah Ann  Holmberg Pte Ltd } \\
		{\large Jesse 90}\\
		{\large 75041, Hong Kong, khanh Hoa, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
