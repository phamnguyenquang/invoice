...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalia Grace 	 Gunnarsson} \\
		{\large Grant 89}\\
		{\large 43276, Montreal, Guangzhou, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ximena  Alexander  Henriksson Corp } \\
		{\large Riley 23}\\
		{\large 63368, Florence, Bremen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
