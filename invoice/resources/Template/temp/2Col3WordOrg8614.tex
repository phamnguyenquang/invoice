...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zachary  Alexander  Hellström Inc} \\
		{\large Jeremy 37}\\
		{\large 75127, San Francisco, California, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zoe Hellström } \\
		{\large Ariel 3}\\
		{\large 24115, Ho Chi Minh, Amnat Charoen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
