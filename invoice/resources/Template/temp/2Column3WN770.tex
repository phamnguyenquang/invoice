...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mariah Elizabeth 	 Hedlund} \\
		{\large Jayla 86}\\
		{\large 28960, Bonn, Huabei, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson John Engström Pte Ltd } \\
		{\large Sydney 26}\\
		{\large 60064, Nha Trang, Bayern, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
