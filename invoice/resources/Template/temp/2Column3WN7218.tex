...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Giovanni Peter Johansson} \\
		{\large Aurora 55}\\
		{\large 15056, Shanghai, California, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Destiny Kate 	 Lindström Pte Ltd } \\
		{\large Kaylee 99}\\
		{\large 94903, Singapore, Huabei, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
