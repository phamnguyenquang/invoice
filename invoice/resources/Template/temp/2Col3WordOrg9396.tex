...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Landon  Alexander  Sandberg Pte Ltd} \\
		{\large Tristan 14}\\
		{\large 28869, Munich, Chiang Rai, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alice Arvidsson } \\
		{\large Adalyn 44}\\
		{\large 47950, Ho Chi Minh, Kentucky, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
