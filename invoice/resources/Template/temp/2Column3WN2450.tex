...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carson Ann  Nyström} \\
		{\large Jaden 45}\\
		{\large 70594, Chicago, Binh Thuan, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Taylor Rose 	 Hermansson Pte Ltd } \\
		{\large Kevin 31}\\
		{\large 68950, Frankfurt am Main , Saarland, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
