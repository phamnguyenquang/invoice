...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liam Catherine  Andreasson Pte Ltd} \\
		{\large Aliyah 12}\\
		{\large 16315, Dubai, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leilani Gustafsson } \\
		{\large Micah 92}\\
		{\large 25062, Moscow, Texas, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
