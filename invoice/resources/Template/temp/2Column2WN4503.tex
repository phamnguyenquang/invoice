...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ivan Andreasson} \\
		{\large Victor 93}\\
		{\large 84769, Ho Chi Minh, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas Christopher Svensson Pte Ltd } \\
		{\large Carson 97}\\
		{\large 12216, San Francisco, Tuscany, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
