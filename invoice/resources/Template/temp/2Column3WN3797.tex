...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina Victoria Engström} \\
		{\large John 81}\\
		{\large 59158, Amsterdam, Seattles, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexis Robert Björklund Pte Ltd } \\
		{\large Valerie 94}\\
		{\large 92268, Bonn, California, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
