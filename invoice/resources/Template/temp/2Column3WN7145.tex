...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon  Alexander  Lindgren} \\
		{\large Charlotte 34}\\
		{\large 19095, Frankfurt am Main , Amnat Charoen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jordan Mary 	 Nyberg Pte Ltd } \\
		{\large Katherine 83}\\
		{\large 84405, Moscow, Buriam, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
