...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jacob Nilsson Ltd} \\
		{\large Savannah 90}\\
		{\large 90230, Frankfurt am Main , Texas, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexandra Jönsson } \\
		{\large Noah 7}\\
		{\large 69340, Ho Chi Minh, Binh Thuan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
