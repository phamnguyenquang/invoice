...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amelia Robert Sundberg} \\
		{\large Evan 26}\\
		{\large 15349, Frankfurt am Main , Chiang Rai, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Miles Marie 	 Nordström Ltd } \\
		{\large Joseph 90}\\
		{\large 98054, Paris, khanh Hoa, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
