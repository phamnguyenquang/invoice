...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ximena Elizabeth 	 Lundqvist Ltd} \\
		{\large Madison 36}\\
		{\large 98559, Bonn, Phu Yen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harrison Hedlund } \\
		{\large Faith 76}\\
		{\large 11952, Frankfurt am Main , Chai Nat, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
