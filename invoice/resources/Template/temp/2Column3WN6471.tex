...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maximus Victoria Hassan} \\
		{\large Emily 97}\\
		{\large 37783, Lisbon, Chiang Mai, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charles Louise 	 Lundqvist Pte Ltd } \\
		{\large Maxwell 63}\\
		{\large 91002, Paris, Guangzhou, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
