...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Evelyn Lundström} \\
		{\large Noah 26}\\
		{\large 15797, Shanghai, Henan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nevaeh Robert Hermansson Ltd } \\
		{\large Jude 53}\\
		{\large 27654, Frankfurt am Main , Phu Yen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
