...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles Victoria Eklund} \\
		{\large Adam 30}\\
		{\large 14168, Seoul, Chiang Rai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christian William Wikström Corp } \\
		{\large Jonah 82}\\
		{\large 35470, Barcelona, Saarland, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
