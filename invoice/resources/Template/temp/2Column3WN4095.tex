...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mark Catherine  Claesson} \\
		{\large Emilia 95}\\
		{\large 30547, Toronto, Tuscany, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leilani Mary 	 Bergström Ltd } \\
		{\large Riley 16}\\
		{\large 93388, Toronto, Hessen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
