...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Destiny May/Mae 	 Fredriksson Pte Ltd} \\
		{\large Autumn 92}\\
		{\large 36795, Washington, California, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mia Lundberg } \\
		{\large Nicole 34}\\
		{\large 22406, SaiGon, Buriam, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
