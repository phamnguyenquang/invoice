...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joseph Christopher Blomqvist Pte Ltd} \\
		{\large Jaden 23}\\
		{\large 53478, Amsterdam, Bangkok, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Braxton Åberg } \\
		{\large Emmett 28}\\
		{\large 97007, Frankfurt am Main , Ang Thong, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
