...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caleb Jakobsson Corp} \\
		{\large Camden 20}\\
		{\large 54967, San Francisco, Tuscany, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madelyn Ahmed } \\
		{\large Grayson 28}\\
		{\large 66479, Frankfurt am Main , Texas, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
