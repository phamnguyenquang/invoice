...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicole William Sandström} \\
		{\large Mackenzie 19}\\
		{\large 55153, Frankfurt am Main , Chai Nat, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harper Robert Holmgren Inc } \\
		{\large Vincent 58}\\
		{\large 74748, Frankfurt am Main , Seattles, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
