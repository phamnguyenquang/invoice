...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Violet  Alexander  Eriksson Pte Ltd} \\
		{\large Hunter 49}\\
		{\large 44539, New York , California, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan Jonsson } \\
		{\large Cora 39}\\
		{\large 92497, Barcelona, Hamburg, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
