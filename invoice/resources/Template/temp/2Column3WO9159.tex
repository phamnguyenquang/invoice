...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonah Peter Jansson Pte Ltd} \\
		{\large Jessica 65}\\
		{\large 84171, Frankfurt am Main , Phu Yen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maxwell Johansson } \\
		{\large Bryan 54}\\
		{\large 80269, London , Amnat Charoen, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
