...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harrison Andreasson Pte Ltd} \\
		{\large Jose 90}\\
		{\large 69731, Frankfurt am Main , Chiang Mai, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Xavier Lundström } \\
		{\large Silas 82}\\
		{\large 83413, Stuttgart, Saarland, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
