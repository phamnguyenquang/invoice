...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jennifer Anne Hassan} \\
		{\large Isabel 56}\\
		{\large 57800, Bonn, Saarland, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Willow May/Mae 	 Martinsson Pte Ltd } \\
		{\large Wesley 44}\\
		{\large 38060, Madrid, Chai Nat, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
