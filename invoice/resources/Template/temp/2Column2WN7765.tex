...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jasmine Eriksson} \\
		{\large Morgan 88}\\
		{\large 22500, Florence, Kentucky, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maria  Alexander  Bengtsson Corp } \\
		{\large Olivia 53}\\
		{\large 69847, Last Vegas, Henan, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
