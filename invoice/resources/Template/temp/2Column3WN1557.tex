...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isaiah Jane Eklund} \\
		{\large Nicholas 11}\\
		{\large 52849, Barcelona, California, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Oliver May/Mae 	 Henriksson Pte Ltd } \\
		{\large Zachary 22}\\
		{\large 32361, Beijing, Saarland, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
