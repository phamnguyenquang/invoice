...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaylee Amy  Bengtsson Pte Ltd} \\
		{\large Evelyn 32}\\
		{\large 79284, Frankfurt am Main , Hainan, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alejandro Fredriksson } \\
		{\large Julian 48}\\
		{\large 94428, Taipei, Binh Thuan, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
