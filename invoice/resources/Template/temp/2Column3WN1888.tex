...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Easton Kate 	 Strömberg} \\
		{\large Brooklynn 6}\\
		{\large 10534, Boston, Guangzhou, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harper Ann  Svensson Corp } \\
		{\large Bryson 38}\\
		{\large 84158, Frankfurt am Main , Amnat Charoen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
