...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariel  Alexander  Magnusson} \\
		{\large Declan 53}\\
		{\large 70198, San Francisco, Indiana, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jasmine William Hedlund Pte Ltd } \\
		{\large Isaac 22}\\
		{\large 83091, Ho Chi Minh, Huabei, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
