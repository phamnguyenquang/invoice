...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly Christopher Löfgren Pte Ltd} \\
		{\large Christopher 16}\\
		{\large 63439, Hong Kong, Hessen, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesse Lindqvist } \\
		{\large Vincent 37}\\
		{\large 90413, Amsterdam, Binh Thuan, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
