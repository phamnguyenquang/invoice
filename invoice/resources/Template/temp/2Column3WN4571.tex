...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Trinity John Jönsson} \\
		{\large Natalia 91}\\
		{\large 40629, Frankfurt am Main , Chai Nat, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brianna William Blomqvist Pte Ltd } \\
		{\large Timothy 59}\\
		{\large 32342, New York , Heibei, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
