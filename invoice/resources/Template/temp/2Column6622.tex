...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Audrey Gunnarsson Inc} \\
		{\large Aidan 70}\\
		{\large 29607, Frankfurt am Main , Ang Thong, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joshua Söderberg } \\
		{\large Alexandra 49}\\
		{\large 55469, Budapest, Binh Thuan, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
