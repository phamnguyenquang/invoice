...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emery Victoria Berggren Pte Ltd} \\
		{\large Riley 81}\\
		{\large 21983, Venice, Heibei, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vanessa Mårtensson } \\
		{\large Hazel 52}\\
		{\large 57958, Frankfurt am Main , Hessen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
