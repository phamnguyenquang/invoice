...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro Sundberg Pte Ltd} \\
		{\large Alyssa 77}\\
		{\large 17598, Frankfurt am Main , Binh Thuan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juan Danielsson } \\
		{\large Abraham 96}\\
		{\large 12806, Hanoi, Henan, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
