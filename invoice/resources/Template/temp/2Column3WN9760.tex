...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brielle Michael Gunnarsson} \\
		{\large James 95}\\
		{\large 15229, Toronto, Bayern, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kevin Catherine  Sundberg Pte Ltd } \\
		{\large Kaden 46}\\
		{\large 48533, Vienna, Seattles, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
