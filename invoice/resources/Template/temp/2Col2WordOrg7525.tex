...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mateo Hansson Ltd} \\
		{\large Ella 21}\\
		{\large 96309, SaiGon, Amnat Charoen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy Lindgren } \\
		{\large Cameron 21}\\
		{\large 18432, Frankfurt am Main , Saarland, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
