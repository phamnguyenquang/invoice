...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexis David Bergström} \\
		{\large Izabella 47}\\
		{\large 11026, Frankfurt am Main , Saarland, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooke Edward Lindberg Ltd } \\
		{\large Leonardo 11}\\
		{\large 40687, Frankfurt am Main , Heibei, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
