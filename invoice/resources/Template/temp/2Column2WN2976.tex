...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vincent Magnusson} \\
		{\large Nathaniel 6}\\
		{\large 15729, Ho Chi Minh, Chai Nat, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tucker Elizabeth 	 Berggren Corp } \\
		{\large Clara 49}\\
		{\large 87289, Hong Kong, California, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
