...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jordan Louise 	 Arvidsson} \\
		{\large Gabrielle 77}\\
		{\large 91179, Frankfurt am Main , Heibei, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Arianna Peter Eriksson Corp } \\
		{\large Carlos 30}\\
		{\large 18963, Montreal, Hessen, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
