...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte  Alexander  Nordström} \\
		{\large Savannah 39}\\
		{\large 67950, Budapest, Kentucky, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vivian Michael Löfgren Ltd } \\
		{\large Damian 78}\\
		{\large 49147, Stuttgart, Saarland, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
