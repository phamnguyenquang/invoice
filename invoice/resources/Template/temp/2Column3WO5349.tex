...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lucy  Alexander  Eliasson Corp} \\
		{\large Hunter 58}\\
		{\large 53221, Washington, Binh Thuan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jade Hermansson } \\
		{\large Kyle 26}\\
		{\large 52869, Bonn, Guangzhou, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
