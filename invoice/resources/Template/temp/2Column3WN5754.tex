...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalie Marie 	 Jansson} \\
		{\large Mark 50}\\
		{\large 32074, Sydney, Guangdong, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brianna Grace 	 Norberg Ltd } \\
		{\large Calvin 12}\\
		{\large 72353, Frankfurt am Main , Bayern, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
