...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity Peter Bengtsson} \\
		{\large Easton 31}\\
		{\large 36558, Melbourne, Bremen, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liliana Rose 	 Söderberg Pte Ltd } \\
		{\large Luna 62}\\
		{\large 87180, Chicago, Amnat Charoen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
