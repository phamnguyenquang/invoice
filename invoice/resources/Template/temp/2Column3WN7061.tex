...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juan Christopher Andreasson} \\
		{\large Isla 51}\\
		{\large 57371, Istanbul, Seattles, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camden Christopher Andersson Ltd } \\
		{\large Vincent 32}\\
		{\large 49407, Abu Dhabi, khanh Hoa, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
