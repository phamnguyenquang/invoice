...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Antonio Lindholm} \\
		{\large Alejandro 35}\\
		{\large 89554, Bonn, Chiang Rai, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elise  Alexander  Samuelsson Corp } \\
		{\large Arianna 33}\\
		{\large 19675, Frankfurt am Main , Bremen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
