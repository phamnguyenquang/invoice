...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  William Ann  Eliasson} \\
		{\large Alexis 26}\\
		{\large 16532, Tokyo, Heibei, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayce Catherine  Eklund Inc } \\
		{\large Mckenzie 66}\\
		{\large 15623, Vancouver, Amnat Charoen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
