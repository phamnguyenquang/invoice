...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Richard Jane Bergqvist Corp} \\
		{\large Skylar 1}\\
		{\large 95795, Shanghai, Hamburg, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonathan Eriksson } \\
		{\large Aliyah 59}\\
		{\large 67890, Washington, Binh Thuan, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
