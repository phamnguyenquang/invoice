...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Izabella James Håkansson} \\
		{\large Abraham 38}\\
		{\large 61437, Frankfurt am Main , Kentucky, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Braxton Catherine  Larsson Inc } \\
		{\large Rylee 22}\\
		{\large 19072, San Francisco, Hessen, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
