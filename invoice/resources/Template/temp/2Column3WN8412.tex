...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Peyton Rose 	 Norberg} \\
		{\large Edward 64}\\
		{\large 13898, Dublin, Binh Thuan, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alana Thomas Samuelsson Pte Ltd } \\
		{\large Nicholas 51}\\
		{\large 19496, Los Angeles, Saarland, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
