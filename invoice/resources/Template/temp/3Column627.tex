...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Icahn School of Medicine at Mount Sinai} \\
		{\large Destiny 12}\\
		{\large 88315, SaiGon, Phu Yen, Indonesia s}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Melody Sjöberg } \\
		{\large Lydia 35}\\
		{\large 31999, Munich, Bangkok, Indonesia s}\\
    \switchcolumn
