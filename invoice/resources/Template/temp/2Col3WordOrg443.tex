...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ellie Christopher Mårtensson Pte Ltd} \\
		{\large Evelyn 96}\\
		{\large 34797, Seoul, California, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Chase Johansson } \\
		{\large Hayden 39}\\
		{\large 34714, Berlin, Chiang Mai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
