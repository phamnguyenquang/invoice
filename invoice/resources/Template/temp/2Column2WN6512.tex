...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxson Bergman} \\
		{\large Stella 52}\\
		{\large 87406, Amsterdam, California, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie Amy  Jönsson Pte Ltd } \\
		{\large Cayden 65}\\
		{\large 75137, Frankfurt am Main , Indiana, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
