...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adam Rose 	 Nordström} \\
		{\large Jayce 40}\\
		{\large 85371, Budapest, Guangzhou, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alyssa Rose 	 Gustafsson Pte Ltd } \\
		{\large Alejandro 70}\\
		{\large 11207, Singapore, Kentucky, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
