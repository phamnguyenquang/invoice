...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezekiel Peter Lindberg Corp} \\
		{\large Calvin 67}\\
		{\large 42489, Frankfurt am Main , Hessen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Graham Henriksson } \\
		{\large Santiago 12}\\
		{\large 39407, Montreal, Hawaii, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
