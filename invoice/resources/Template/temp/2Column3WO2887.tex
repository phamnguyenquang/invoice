...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Piper  Alexander  Martinsson Pte Ltd} \\
		{\large Natalie 48}\\
		{\large 45756, Abu Dhabi, California, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harrison Axelsson } \\
		{\large Gabrielle 88}\\
		{\large 44012, Montreal, Seattles, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
