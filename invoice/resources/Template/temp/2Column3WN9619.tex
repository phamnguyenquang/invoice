...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alan Peter Fredriksson} \\
		{\large Avery 97}\\
		{\large 26487, Los Angeles, Tuscany, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaleb Robert Jonsson Pte Ltd } \\
		{\large Kingston 43}\\
		{\large 93233, Dublin, Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
