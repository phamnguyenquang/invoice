...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jordan Edward Nilsson} \\
		{\large Caroline 53}\\
		{\large 79117, Dublin, Seattles, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Damian Louise 	 Bengtsson Pte Ltd } \\
		{\large Zoey 69}\\
		{\large 76976, Berlin, Guangdong, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
