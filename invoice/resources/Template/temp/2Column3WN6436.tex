...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayden Marie 	 Andreasson} \\
		{\large Jude 64}\\
		{\large 30276, Minsk, Saarland, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sadie Victoria Lindholm Inc } \\
		{\large Rylee 26}\\
		{\large 33817, Frankfurt am Main , Chiang Mai, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
