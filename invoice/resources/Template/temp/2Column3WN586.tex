...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Oscar Thomas Berggren} \\
		{\large Lucy 43}\\
		{\large 70233, Abu Dhabi, Saarland, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte Louise 	 Bergqvist Corp } \\
		{\large Rebecca 26}\\
		{\large 45100, Budapest, Amnat Charoen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
