...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harmony Christopher Nordström Pte Ltd} \\
		{\large Gianna 78}\\
		{\large 23056, Hong Kong, Hessen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ivy Mårtensson } \\
		{\large Lauren 31}\\
		{\large 68707, Lisbon, Binh Thuan, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
