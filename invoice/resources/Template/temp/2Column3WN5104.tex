...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sarah Kate 	 Lindgren} \\
		{\large Charlotte 39}\\
		{\large 25611, Hong Kong, Hawaii, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luke Catherine  Nordström Pte Ltd } \\
		{\large Gael 99}\\
		{\large 96458, Frankfurt am Main , Buriam, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
