...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria Karlsson Inc} \\
		{\large Stella 51}\\
		{\large 33251, Frankfurt am Main , Binh Thuan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camden Mattsson } \\
		{\large Rylee 96}\\
		{\large 18623, Abu Dhabi, Amnat Charoen, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
