...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro Robert Hedlund Pte Ltd} \\
		{\large Christian 7}\\
		{\large 26429, Florence, Amnat Charoen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elijah Holmgren } \\
		{\large Kennedy 55}\\
		{\large 72629, Barcelona, Kentucky, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
