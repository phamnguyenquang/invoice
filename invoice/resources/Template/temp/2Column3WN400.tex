...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ximena Thomas Danielsson} \\
		{\large Quinn 61}\\
		{\large 42683, Last Vegas, Kentucky, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniela Jane Bergman Corp } \\
		{\large Caden 30}\\
		{\large 31823, Shanghai, Tuscany, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
