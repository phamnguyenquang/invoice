...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hudson Grace 	 Wikström} \\
		{\large Colton 86}\\
		{\large 37503, Osaka, Hawaii, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ashley Christopher Fredriksson Pte Ltd } \\
		{\large Alyssa 17}\\
		{\large 95446, Denver, Ang Thong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
