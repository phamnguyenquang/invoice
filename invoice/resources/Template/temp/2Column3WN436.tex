...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aidan May/Mae 	 Ström} \\
		{\large Rachel 43}\\
		{\large 63433, Frankfurt am Main , Hawaii, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mason Grace 	 Lundqvist Inc } \\
		{\large Layla 61}\\
		{\large 49239, Madrid, Bremen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
