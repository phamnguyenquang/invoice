...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grayson Catherine  Bergqvist Pte Ltd} \\
		{\large Maxwell 44}\\
		{\large 65305, SaiGon, California, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joseph Lindström } \\
		{\large Benjamin 8}\\
		{\large 12515, Singapore, Chiang Mai, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
