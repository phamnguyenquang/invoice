...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rachel Grace 	 Wallin} \\
		{\large Giovanni 54}\\
		{\large 86845, Frankfurt am Main , Guangdong, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Logan Peter Svensson Ltd } \\
		{\large Samantha 83}\\
		{\large 28220, Sydney, Tuscany, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
