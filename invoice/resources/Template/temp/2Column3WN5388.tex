...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ashley Christopher Nordström} \\
		{\large Kylie 74}\\
		{\large 45296, Singapore, Guangdong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kingston Mary 	 Pålsson Pte Ltd } \\
		{\large Eliana 12}\\
		{\large 35099, San Francisco, Hainan, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
