...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Oliver Ann  Claesson} \\
		{\large Maxwell 85}\\
		{\large 89350, Abu Dhabi, Chiang Rai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson Louise 	 Nilsson Corp } \\
		{\large Jayla 20}\\
		{\large 50771, Singapore, Binh Thuan, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
