...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hadley Victoria Eliasson} \\
		{\large Mary 46}\\
		{\large 75339, Madrid, Huabei, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vivian Christopher Mattsson Pte Ltd } \\
		{\large Caleb 40}\\
		{\large 42523, Stuttgart, Ang Thong, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
