...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sofia Strömberg} \\
		{\large Leilani 42}\\
		{\large 47044, Stuttgart, Hamburg, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sophie Kate 	 Bengtsson Inc } \\
		{\large Nolan 29}\\
		{\large 68653, Frankfurt am Main , Ang Thong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
