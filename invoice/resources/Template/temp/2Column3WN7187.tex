...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valerie John Forsberg} \\
		{\large Hunter 22}\\
		{\large 73071, Lisbon, khanh Hoa, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremy Christopher Olofsson Corp } \\
		{\large Izabella 35}\\
		{\large 31300, Abu Dhabi, Hessen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
