...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cooper David Berggren} \\
		{\large Caleb 11}\\
		{\large 86832, Ho Chi Minh, Ang Thong, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tucker Michael Danielsson Corp } \\
		{\large Emily 10}\\
		{\large 22429, Denver, Kentucky, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
