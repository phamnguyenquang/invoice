...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Destiny Victoria Axelsson Corp} \\
		{\large Gabrielle 23}\\
		{\large 54019, Shanghai, Bremen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Victoria Jansson } \\
		{\large Anna 84}\\
		{\large 42595, Frankfurt am Main , Phu Yen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
