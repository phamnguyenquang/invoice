...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abraham Sjögren} \\
		{\large Lucy 70}\\
		{\large 54958, Taipei, Buriam, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Penelope Edward Lindholm Corp } \\
		{\large Tyler 3}\\
		{\large 16138, Los Angeles, Chiang Rai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
