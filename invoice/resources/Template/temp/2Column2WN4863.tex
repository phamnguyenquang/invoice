...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luis Engström} \\
		{\large Ryder 7}\\
		{\large 86674, Frankfurt am Main , Kentucky, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carlos David Söderberg Pte Ltd } \\
		{\large Quinn 42}\\
		{\large 12866, Moscow, Bayern, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
