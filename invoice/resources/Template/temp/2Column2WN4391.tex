...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adriana Hansson} \\
		{\large Bryan 77}\\
		{\large 96193, Washington, Amnat Charoen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eli Grace 	 Lindgren Pte Ltd } \\
		{\large Xavier 87}\\
		{\large 80289, Melbourne, Ang Thong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
