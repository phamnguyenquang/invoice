...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brielle Elizabeth 	 Norberg} \\
		{\large Gabriel 65}\\
		{\large 91237, Frankfurt am Main , Ang Thong, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley  Alexander  Johansson Pte Ltd } \\
		{\large Destiny 72}\\
		{\large 39608, Chicago, Heibei, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
