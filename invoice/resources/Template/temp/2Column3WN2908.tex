...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall Marie 	 Gustafsson} \\
		{\large Jaden 35}\\
		{\large 87109, Frankfurt am Main , Hessen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alana Rose 	 Bergman Ltd } \\
		{\large Sara 83}\\
		{\large 67402, Budapest, California, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
