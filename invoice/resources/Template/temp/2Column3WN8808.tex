...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Peyton David Martinsson} \\
		{\large Charlotte 60}\\
		{\large 10050, Singapore, Chai Nat, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ethan Christopher Fredriksson Ltd } \\
		{\large Alex 64}\\
		{\large 75447, Osaka, Saarland, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
