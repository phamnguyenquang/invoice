...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Thomas Arvidsson} \\
		{\large Jennifer 46}\\
		{\large 84740, Los Angeles, Floria, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jude Robert Jakobsson Inc } \\
		{\large Caroline 51}\\
		{\large 38027, Minsk, California, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
