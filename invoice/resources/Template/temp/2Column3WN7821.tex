...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hailey Thomas Nilsson} \\
		{\large Eliana 20}\\
		{\large 85758, Beijing, Amnat Charoen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bentley Peter Lundgren Ltd } \\
		{\large London 47}\\
		{\large 20286, Florence, Guangzhou, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
