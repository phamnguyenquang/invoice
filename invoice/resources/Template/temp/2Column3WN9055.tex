...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Allison May/Mae 	 Jansson} \\
		{\large Brayden 10}\\
		{\large 66448, Ho Chi Minh, Amnat Charoen, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sophia Grace 	 Söderberg Ltd } \\
		{\large Charlotte 8}\\
		{\large 25631, San Francisco, Ang Thong, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
