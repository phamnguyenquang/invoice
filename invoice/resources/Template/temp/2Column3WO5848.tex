...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariana David Gunnarsson Corp} \\
		{\large Willow 61}\\
		{\large 40364, Vancouver, Binh Thuan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Peyton Håkansson } \\
		{\large Rebecca 42}\\
		{\large 79262, Vancouver, Chiang Mai, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
