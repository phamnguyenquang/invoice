...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Santiago Grace 	 Danielsson} \\
		{\large Jonah 91}\\
		{\large 65411, Tokyo, Binh Thuan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cole Amy  Persson Pte Ltd } \\
		{\large Parker 57}\\
		{\large 79059, SaiGon, Ang Thong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
