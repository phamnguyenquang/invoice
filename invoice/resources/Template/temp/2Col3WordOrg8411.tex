...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ivan Christopher Arvidsson Corp} \\
		{\large Aiden 92}\\
		{\large 26942, Stuttgart, Guangdong, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Serenity Berglund } \\
		{\large Malachi 83}\\
		{\large 26337, Frankfurt am Main , Heibei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
