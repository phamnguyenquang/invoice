...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juliana Isaksson} \\
		{\large Athena 90}\\
		{\large 71269, Hanoi, Chiang Rai, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathan  Alexander  Bergqvist Pte Ltd } \\
		{\large Timothy 89}\\
		{\large 34543, Frankfurt am Main , Seattles, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
