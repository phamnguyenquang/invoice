...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Payton Robert Samuelsson} \\
		{\large Margaret 42}\\
		{\large 10481, Los Angeles, Chiang Mai, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maximus Thomas Pettersson Corp } \\
		{\large Gael 28}\\
		{\large 47998, Singapore, Henan, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
