...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bailey Louise 	 Karlsson} \\
		{\large Grant 6}\\
		{\large 94643, Toronto, Phu Yen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathan  Alexander  Karlsson Ltd } \\
		{\large Jake 91}\\
		{\large 61797, Frankfurt am Main , Seattles, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
