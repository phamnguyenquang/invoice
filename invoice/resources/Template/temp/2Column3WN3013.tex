...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Kate 	 Andreasson} \\
		{\large Jackson 84}\\
		{\large 26487, Frankfurt am Main , Saarland, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayla Edward Mårtensson Pte Ltd } \\
		{\large Owen 48}\\
		{\large 38062, Seoul, Saarland, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
