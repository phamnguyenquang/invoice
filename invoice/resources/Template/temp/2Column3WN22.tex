...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla William Björk} \\
		{\large Robert 64}\\
		{\large 37484, Shanghai, Hamburg, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Braxton Edward Lundgren Pte Ltd } \\
		{\large Charlotte 6}\\
		{\large 10380, Chicago, Kentucky, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
