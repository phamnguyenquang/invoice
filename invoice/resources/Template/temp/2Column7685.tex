...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maria Lundqvist Pte Ltd} \\
		{\large John 88}\\
		{\large 12198, Frankfurt am Main , Ang Thong, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nevaeh Henriksson } \\
		{\large Max 95}\\
		{\large 14860, Ho Chi Minh, Binh Thuan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
