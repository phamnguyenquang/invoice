...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Delilah William Fredriksson} \\
		{\large Aubrey 75}\\
		{\large 60085, Frankfurt am Main , Tuscany, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hunter Amy  Wallin Corp } \\
		{\large Hayden 11}\\
		{\large 74549, Frankfurt am Main , Chiang Mai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
