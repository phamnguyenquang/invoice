...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Faith Louise 	 Jönsson Ltd} \\
		{\large Asher 40}\\
		{\large 25277, Frankfurt am Main , Guangdong, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariana Lundgren } \\
		{\large Grace 65}\\
		{\large 19420, Frankfurt am Main , Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
