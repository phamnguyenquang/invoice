...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paul Christopher Gunnarsson} \\
		{\large Kaitlyn 20}\\
		{\large 23689, Nha Trang, Hessen, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathaniel Louise 	 Björk Ltd } \\
		{\large Emma 43}\\
		{\large 80836, Lisbon, Ang Thong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
