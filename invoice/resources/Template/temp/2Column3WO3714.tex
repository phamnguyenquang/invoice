...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elena Amy  Strömberg Inc} \\
		{\large Eli 48}\\
		{\large 72967, Los Angeles, Amnat Charoen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Thomas Engström } \\
		{\large Kennedy 56}\\
		{\large 68025, Frankfurt am Main , Chiang Rai, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
