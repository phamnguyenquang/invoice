...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juliana Anne Lindström} \\
		{\large Nolan 54}\\
		{\large 21771, Istanbul, Tuscany, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Weston Elizabeth 	 Löfgren Pte Ltd } \\
		{\large Kaiden 78}\\
		{\large 57771, Vancouver, Kentucky, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
