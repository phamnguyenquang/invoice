...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Greyson Catherine  Åkesson} \\
		{\large Sawyer 18}\\
		{\large 14895, Frankfurt am Main , Bremen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Richard Peter Holmgren Ltd } \\
		{\large Gael 93}\\
		{\large 84807, Melbourne, Hawaii, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
