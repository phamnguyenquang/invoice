...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla Robert Lindgren} \\
		{\large Grace 5}\\
		{\large 85586, San Francisco, Hawaii, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evelyn John Bengtsson Ltd } \\
		{\large Maria 58}\\
		{\large 91052, Hong Kong, Indiana, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
