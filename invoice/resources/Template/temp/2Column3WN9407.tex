...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joseph Grace 	 Hansson} \\
		{\large Lincoln 90}\\
		{\large 53709, Berlin, Heibei, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madelyn Robert Söderberg Pte Ltd } \\
		{\large Ellie 74}\\
		{\large 39561, Singapore, Indiana, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
