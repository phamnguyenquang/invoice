...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hudson Catherine  Lundqvist} \\
		{\large Serenity 22}\\
		{\large 84780, Singapore, Chiang Mai, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryker Marie 	 Eliasson Ltd } \\
		{\large Lucas 25}\\
		{\large 85749, Last Vegas, Chiang Mai, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
