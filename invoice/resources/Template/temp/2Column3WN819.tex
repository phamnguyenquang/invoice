...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abraham Louise 	 Sandström} \\
		{\large Josiah 50}\\
		{\large 83223, Singapore, Saarland, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Willow Edward Olsson Inc } \\
		{\large Gianna 44}\\
		{\large 86389, Nha Trang, Guangzhou, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
