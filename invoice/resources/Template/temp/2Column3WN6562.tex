...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Louise 	 Lundgren} \\
		{\large Brooklyn 17}\\
		{\large 33362, Denver, Guangdong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alaina Rose 	 Blomqvist Ltd } \\
		{\large Olivia 42}\\
		{\large 16281, Frankfurt am Main , Indiana, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
