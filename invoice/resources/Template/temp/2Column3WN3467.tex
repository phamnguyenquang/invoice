...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryder John Andreasson} \\
		{\large Abraham 17}\\
		{\large 59727, Ho Chi Minh, Guangzhou, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaliyah Robert Hansson Inc } \\
		{\large Aliyah 67}\\
		{\large 84355, Los Angeles, Amnat Charoen, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
