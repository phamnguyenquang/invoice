...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope Louise 	 Söderberg} \\
		{\large Savannah 68}\\
		{\large 47841, New York , Heibei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Austin Catherine  Strömberg Pte Ltd } \\
		{\large Wesley 33}\\
		{\large 46430, Madrid, Floria, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
