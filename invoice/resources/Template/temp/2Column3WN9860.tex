...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maria May/Mae 	 Danielsson} \\
		{\large Jayden 27}\\
		{\large 18665, Chicago, Guangzhou, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucas Thomas Lundström Pte Ltd } \\
		{\large Aria 2}\\
		{\large 95014, Bonn, Bremen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
