...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eden Catherine  Larsson Pte Ltd} \\
		{\large Ximena 64}\\
		{\large 61673, Vancouver, California, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexis Holmgren } \\
		{\large Nathaniel 25}\\
		{\large 91539, New York , Huabei, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
