...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harrison Rose 	 Abrahamsson Pte Ltd} \\
		{\large Steven 33}\\
		{\large 12442, Frankfurt am Main , Chiang Mai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zoe Bergqvist } \\
		{\large Joseph 38}\\
		{\large 18355, Minsk, Hessen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
