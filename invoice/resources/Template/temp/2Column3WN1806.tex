...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Malachi Ann  Gunnarsson} \\
		{\large Jordan 82}\\
		{\large 99456, Barcelona, Tuscany, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joshua Grace 	 Bergman Pte Ltd } \\
		{\large Kennedy 51}\\
		{\large 13931, Stuttgart, Phu Yen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
