...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kennedy Elizabeth 	 Björk Pte Ltd} \\
		{\large Michael 18}\\
		{\large 76342, Nha Trang, Binh Thuan, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hadley Hermansson } \\
		{\large Jade 78}\\
		{\large 45495, Shanghai, Tuscany, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
