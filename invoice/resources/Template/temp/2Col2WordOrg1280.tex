...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jordyn Arvidsson Inc} \\
		{\large Nicolas 10}\\
		{\large 65218, Frankfurt am Main , Chiang Rai, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charles Eliasson } \\
		{\large Jayla 51}\\
		{\large 21092, Frankfurt am Main , Floria, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
