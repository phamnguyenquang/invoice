...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sophia Holmgren} \\
		{\large Mary 18}\\
		{\large 90153, Amsterdam, Amnat Charoen, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carson Elizabeth 	 Pettersson Corp } \\
		{\large Charles 51}\\
		{\large 23895, Frankfurt am Main , Indiana, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
