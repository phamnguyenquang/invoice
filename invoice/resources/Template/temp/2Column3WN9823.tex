...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Easton Grace 	 Viklund} \\
		{\large Mya 97}\\
		{\large 25361, Taipei, Binh Thuan, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sarah Elizabeth 	 Lundqvist Ltd } \\
		{\large Aiden 24}\\
		{\large 84856, Barcelona, Guangdong, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
