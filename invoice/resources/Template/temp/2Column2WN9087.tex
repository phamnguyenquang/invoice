...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline Jansson} \\
		{\large Nicholas 92}\\
		{\large 94171, Istanbul, Floria, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lyla Marie 	 Sjögren Pte Ltd } \\
		{\large Jayce 43}\\
		{\large 23205, San Francisco, Hessen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
