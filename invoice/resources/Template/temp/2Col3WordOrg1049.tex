...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lilly Mary 	 Lindberg Inc} \\
		{\large Harper 35}\\
		{\large 10050, Frankfurt am Main , Chiang Mai, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniel Lundin } \\
		{\large Kendall 4}\\
		{\large 50618, San Francisco, Chai Nat, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
