...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mya Robert Jonsson} \\
		{\large Camila 27}\\
		{\large 29505, Ho Chi Minh, Binh Thuan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reese Michael Andreasson Pte Ltd } \\
		{\large Landon 62}\\
		{\large 47860, Paris, Bangkok, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
