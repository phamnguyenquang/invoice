...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian David Abrahamsson} \\
		{\large Aidan 67}\\
		{\large 87565, Stuttgart, Binh Thuan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lilly Louise 	 Andersson Ltd } \\
		{\large Patrick 13}\\
		{\large 56028, Singapore, Bangkok, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
