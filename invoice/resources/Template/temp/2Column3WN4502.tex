...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Asher James Hellström} \\
		{\large Cooper 64}\\
		{\large 17616, London , Guangzhou, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaden Edward Berggren Pte Ltd } \\
		{\large Malachi 68}\\
		{\large 37780, Abu Dhabi, California, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
