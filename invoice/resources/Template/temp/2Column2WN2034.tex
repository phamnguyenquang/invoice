...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrea Löfgren} \\
		{\large Kaden 38}\\
		{\large 67843, Frankfurt am Main , Guangdong, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesse James Gustafsson Corp } \\
		{\large Greyson 76}\\
		{\large 64819, Hong Kong, Ang Thong, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
