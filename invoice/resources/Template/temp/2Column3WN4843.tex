...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alyssa Louise 	 Lindqvist} \\
		{\large Parker 17}\\
		{\large 38686, Washington, Floria, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Benjamin Victoria Sandström Corp } \\
		{\large Miles 60}\\
		{\large 71881, Hong Kong, Buriam, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
