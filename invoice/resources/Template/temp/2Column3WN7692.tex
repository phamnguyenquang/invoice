...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lila David Gustafsson} \\
		{\large Maxwell 37}\\
		{\large 27372, Berlin, Saarland, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joshua Louise 	 Sjögren Pte Ltd } \\
		{\large Gavin 72}\\
		{\large 42331, Venice, Binh Thuan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
