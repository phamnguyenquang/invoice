...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dominic Christopher Johansson} \\
		{\large Kennedy 4}\\
		{\large 97251, Stuttgart, California, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Oscar  Alexander  Ahmed Ltd } \\
		{\large Scarlett 20}\\
		{\large 46552, Tokyo, Ang Thong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
