...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Benjamin Louise 	 Johansson Ltd} \\
		{\large Amir 24}\\
		{\large 40612, Istanbul, Amnat Charoen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie Söderberg } \\
		{\large Scarlett 46}\\
		{\large 65209, Shanghai, Texas, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
