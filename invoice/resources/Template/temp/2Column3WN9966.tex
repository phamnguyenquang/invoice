...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathan May/Mae 	 Berglund} \\
		{\large Wesley 74}\\
		{\large 60319, Barcelona, Guangzhou, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katelyn James Norberg Pte Ltd } \\
		{\large Luis 72}\\
		{\large 14208, Dublin, Amnat Charoen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
