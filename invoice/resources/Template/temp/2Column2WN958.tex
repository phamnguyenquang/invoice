...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexander Eriksson} \\
		{\large Jaden 26}\\
		{\large 10887, Washington, Buriam, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hadley John Olsson Ltd } \\
		{\large Ryker 1}\\
		{\large 99639, Frankfurt am Main , Heibei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
