...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gianna Christopher Andreasson Pte Ltd} \\
		{\large Olivia 42}\\
		{\large 89583, Barcelona, Heibei, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vanessa Hassan } \\
		{\large Aubrey 47}\\
		{\large 46108, Osaka, Kentucky, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
