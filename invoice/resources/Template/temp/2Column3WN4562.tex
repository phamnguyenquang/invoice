...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aidan Elizabeth 	 Hassan} \\
		{\large Thomas 85}\\
		{\large 19269, Hanoi, Chiang Rai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elizabeth Elizabeth 	 Jönsson Corp } \\
		{\large Lily 46}\\
		{\large 88461, Berlin, Huabei, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
