...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria John Andreasson} \\
		{\large Jackson 60}\\
		{\large 51364, Taipei, khanh Hoa, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Margaret Lee  Hellström Inc } \\
		{\large Sean 19}\\
		{\large 62259, Istanbul, Bayern, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
