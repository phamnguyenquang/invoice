...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kinsley Victoria Svensson} \\
		{\large Joseph 16}\\
		{\large 49490, Ho Chi Minh, Buriam, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cole Edward Björk Pte Ltd } \\
		{\large Jose 32}\\
		{\large 94053, Madrid, Bayern, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
