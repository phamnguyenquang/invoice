...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adriana May/Mae 	 Ek} \\
		{\large Autumn 51}\\
		{\large 66296, Last Vegas, Indiana, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jessica Catherine  Lindqvist Pte Ltd } \\
		{\large Lila 80}\\
		{\large 32047, Montreal, Chiang Rai, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
