...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Oscar David Holmberg} \\
		{\large Paul 46}\\
		{\large 16065, Sydney, Ang Thong, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson Rose 	 Lindqvist Corp } \\
		{\large Harmony 30}\\
		{\large 79319, Frankfurt am Main , Bremen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
