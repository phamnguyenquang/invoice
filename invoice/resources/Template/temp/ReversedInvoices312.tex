...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of California, San Diego} \\
		{\large Skylar 6}\\
		{\large 69647, Frankfurt am Main , Guangzhou, VietNam}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Elijah Falk } \\
		{\large Matthew 93}\\
		{\large 55929, Boston, Chiang Mai, Japan }\\
    \switchcolumn
