...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Camden Löfgren} \\
		{\large Mya 81}\\
		{\large 30735, Shanghai, Heibei, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson Michael Gunnarsson Pte Ltd } \\
		{\large Grayson 93}\\
		{\large 47806, Moscow, Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
