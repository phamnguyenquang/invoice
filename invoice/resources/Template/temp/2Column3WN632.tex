...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie Elizabeth 	 Ström} \\
		{\large Kaleb 4}\\
		{\large 67450, Frankfurt am Main , Amnat Charoen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Clara Thomas Björklund Inc } \\
		{\large Aaron 71}\\
		{\large 56070, Sydney, California, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
