...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Camila Mary 	 Mattsson} \\
		{\large Miles 36}\\
		{\large 79070, Budapest, Amnat Charoen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luke May/Mae 	 Mårtensson Ltd } \\
		{\large Jade 98}\\
		{\large 88733, New York , Ang Thong, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
