...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sophie Christopher Jansson Corp} \\
		{\large Gael 47}\\
		{\large 78698, Frankfurt am Main , Hamburg, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jason Fredriksson } \\
		{\large Natalie 7}\\
		{\large 22017, London , Hamburg, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
