...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katelyn Marie 	 Lindgren Pte Ltd} \\
		{\large Elise 92}\\
		{\large 86467, Frankfurt am Main , Hawaii, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maximus Lindberg } \\
		{\large Leo 42}\\
		{\large 12120, Last Vegas, Texas, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
