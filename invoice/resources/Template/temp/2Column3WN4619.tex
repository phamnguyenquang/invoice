...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrea David Engström} \\
		{\large Connor 98}\\
		{\large 56953, Amsterdam, Bremen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liliana Peter Hermansson Corp } \\
		{\large Valerie 52}\\
		{\large 26235, Shanghai, Tuscany, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
