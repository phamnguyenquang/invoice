...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everly  Alexander  Engström} \\
		{\large Josiah 43}\\
		{\large 11353, Vancouver, Tuscany, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caleb Lee  Sjögren Corp } \\
		{\large Gianna 12}\\
		{\large 55034, Amsterdam, khanh Hoa, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
