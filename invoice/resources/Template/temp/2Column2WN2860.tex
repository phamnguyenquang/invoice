...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jordyn Norberg} \\
		{\large Alexa 99}\\
		{\large 47080, Minsk, khanh Hoa, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madelyn Elizabeth 	 Nyström Pte Ltd } \\
		{\large Mateo 1}\\
		{\large 13053, Frankfurt am Main , Chiang Mai, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
