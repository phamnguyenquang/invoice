...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cora Elizabeth 	 Johansson} \\
		{\large Sawyer 99}\\
		{\large 33480, Minsk, Binh Thuan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tucker Catherine  Johansson Pte Ltd } \\
		{\large Jaden 22}\\
		{\large 98386, Paris, Binh Thuan, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
