...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kevin Christopher Axelsson} \\
		{\large Abraham 7}\\
		{\large 69316, Berlin, Tuscany, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexandra May/Mae 	 Hermansson Pte Ltd } \\
		{\large Audrey 18}\\
		{\large 26604, Budapest, Guangzhou, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
