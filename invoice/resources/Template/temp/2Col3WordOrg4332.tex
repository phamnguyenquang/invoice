...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sophia Louise 	 Lindqvist Pte Ltd} \\
		{\large Cole 87}\\
		{\large 75192, SaiGon, California, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmanuel Danielsson } \\
		{\large Rachel 50}\\
		{\large 29085, Hong Kong, Binh Thuan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
