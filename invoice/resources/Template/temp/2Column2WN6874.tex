...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel Forsberg} \\
		{\large Abigail 76}\\
		{\large 14451, Frankfurt am Main , Heibei, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Edward Victoria Lundgren Pte Ltd } \\
		{\large Aaliyah 69}\\
		{\large 89662, Moscow, Heibei, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
