...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emma May/Mae 	 Pettersson} \\
		{\large Sara 80}\\
		{\large 15916, Frankfurt am Main , Saarland, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ellie Marie 	 Fredriksson Inc } \\
		{\large Thomas 83}\\
		{\large 93043, Frankfurt am Main , Saarland, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
