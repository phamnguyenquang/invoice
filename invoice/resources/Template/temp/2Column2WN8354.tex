...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Diego Lundgren} \\
		{\large Damian 36}\\
		{\large 25660, Dublin, Bangkok, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella Marie 	 Arvidsson Pte Ltd } \\
		{\large Alan 37}\\
		{\large 24332, Frankfurt am Main , Guangdong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
