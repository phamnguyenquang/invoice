...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hadley Magnusson} \\
		{\large Sean 34}\\
		{\large 32560, Frankfurt am Main , Ang Thong, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large John Kate 	 Bergström Pte Ltd } \\
		{\large Khloe 24}\\
		{\large 67976, Rome, Kentucky, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
