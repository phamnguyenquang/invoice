...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezekiel Bengtsson} \\
		{\large Lila 66}\\
		{\large 15186, New York , Indiana, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joseph Catherine  Björk Inc } \\
		{\large Natalie 3}\\
		{\large 83001, Frankfurt am Main , khanh Hoa, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
