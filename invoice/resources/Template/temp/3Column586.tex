...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Nanjing University of Aeronautics and Astronautics} \\
		{\large Scarlett 46}\\
		{\large 80595, Berlin, Indiana, China }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Arianna Claesson } \\
		{\large Isaac 25}\\
		{\large 77354, Last Vegas, Seattles, Switzerland}\\
    \switchcolumn
