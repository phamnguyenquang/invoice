...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  William Robert Lundström Pte Ltd} \\
		{\large Micah 85}\\
		{\large 86772, Ho Chi Minh, Chiang Rai, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon Wallin } \\
		{\large Mya 10}\\
		{\large 34004, Bonn, Saarland, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
