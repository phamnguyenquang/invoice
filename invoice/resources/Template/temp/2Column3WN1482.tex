...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Piper Elizabeth 	 Blom} \\
		{\large Abigail 8}\\
		{\large 49520, Frankfurt am Main , Hessen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cameron Michael Forsberg Inc } \\
		{\large Grayson 9}\\
		{\large 20863, Rome, Hamburg, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
