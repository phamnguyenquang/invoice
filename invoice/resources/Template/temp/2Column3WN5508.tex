...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexander  Alexander  Lindholm} \\
		{\large Izabella 9}\\
		{\large 74664, Hong Kong, Hawaii, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isla Anne Mårtensson Corp } \\
		{\large Kaylee 40}\\
		{\large 60058, Amsterdam, Buriam, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
