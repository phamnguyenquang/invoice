...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriella Andersson} \\
		{\large Alana 76}\\
		{\large 24003, Nha Trang, Saarland, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katherine Elizabeth 	 Mattsson Pte Ltd } \\
		{\large Elena 46}\\
		{\large 81449, Munich, Chiang Mai, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
