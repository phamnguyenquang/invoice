...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eleanor Michael Sjöberg} \\
		{\large Michelle 66}\\
		{\large 76066, Tokyo, khanh Hoa, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Blake John Abrahamsson Corp } \\
		{\large Juan 12}\\
		{\large 89957, Vancouver, Chai Nat, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
