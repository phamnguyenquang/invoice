...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity William Mårtensson Pte Ltd} \\
		{\large Henry 16}\\
		{\large 71617, Sydney, Bremen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklyn Lindberg } \\
		{\large Sebastian 97}\\
		{\large 74767, Hong Kong, Hamburg, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
