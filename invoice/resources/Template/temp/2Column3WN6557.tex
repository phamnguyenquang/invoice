...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carson Thomas Andreasson} \\
		{\large Adalynn 52}\\
		{\large 81072, Frankfurt am Main , Amnat Charoen, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large John Thomas Viklund Corp } \\
		{\large Brady 2}\\
		{\large 73208, Dublin, Floria, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
