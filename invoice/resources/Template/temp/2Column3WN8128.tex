...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Izabella Louise 	 Arvidsson} \\
		{\large Tucker 61}\\
		{\large 18988, Dublin, Texas, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Anne Lindgren Corp } \\
		{\large Lillian 33}\\
		{\large 33573, Montreal, Kentucky, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
