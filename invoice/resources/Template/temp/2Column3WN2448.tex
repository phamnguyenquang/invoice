...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eva  Alexander  Eriksson} \\
		{\large Damian 73}\\
		{\large 52255, Milan, Guangzhou, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Elizabeth 	 Martinsson Inc } \\
		{\large Gracie 81}\\
		{\large 44181, Stuttgart, California, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
