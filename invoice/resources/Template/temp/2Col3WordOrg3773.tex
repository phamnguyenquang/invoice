...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isaac May/Mae 	 Fredriksson Pte Ltd} \\
		{\large Maverick 88}\\
		{\large 47843, Nha Trang, Bayern, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Scarlett Sjögren } \\
		{\large Aliyah 73}\\
		{\large 54632, Dublin, Kentucky, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
