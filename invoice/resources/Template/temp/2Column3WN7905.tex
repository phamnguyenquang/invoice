...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina John Nyberg} \\
		{\large Kaleb 24}\\
		{\large 95157, Frankfurt am Main , Buriam, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sophia Thomas Sandberg Pte Ltd } \\
		{\large Makenzie 51}\\
		{\large 67260, San Francisco, khanh Hoa, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
