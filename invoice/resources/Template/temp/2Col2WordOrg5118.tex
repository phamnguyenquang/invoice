...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Malachi Henriksson Inc} \\
		{\large Natalie 59}\\
		{\large 42460, Frankfurt am Main , Bayern, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samantha Andersson } \\
		{\large Hadley 33}\\
		{\large 22034, Lisbon, Guangzhou, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
