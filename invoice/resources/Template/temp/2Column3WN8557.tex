...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ian May/Mae 	 Hassan} \\
		{\large Samuel 42}\\
		{\large 25028, Melbourne, Binh Thuan, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ian  Alexander  Eliasson Ltd } \\
		{\large Kimberly 44}\\
		{\large 24001, Hong Kong, Hessen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
