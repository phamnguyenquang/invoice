...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaden John Danielsson} \\
		{\large Grace 22}\\
		{\large 63470, Singapore, Amnat Charoen, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large John James Andersson Pte Ltd } \\
		{\large Liam 52}\\
		{\large 82224, San Francisco, khanh Hoa, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
