...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Arianna  Alexander  Sjöberg} \\
		{\large Destiny 92}\\
		{\large 80050, Istanbul, Buriam, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalynn Marie 	 Gustafsson Corp } \\
		{\large Alexa 27}\\
		{\large 68849, Hong Kong, Saarland, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
