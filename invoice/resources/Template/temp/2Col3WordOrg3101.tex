...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Antonio Robert Sandström Ltd} \\
		{\large Gracie 48}\\
		{\large 22968, Frankfurt am Main , Tuscany, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayden Söderberg } \\
		{\large Brian 46}\\
		{\large 21129, New York , Saarland, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
