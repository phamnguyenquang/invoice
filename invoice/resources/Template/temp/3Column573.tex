...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Campania Luigi Vanvitelli} \\
		{\large Zachary 2}\\
		{\large 66090, Chicago, Henan, Japan }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Maria Fredriksson } \\
		{\large Isaiah 12}\\
		{\large 80279, Abu Dhabi, Guangdong, United State }\\
    \switchcolumn
