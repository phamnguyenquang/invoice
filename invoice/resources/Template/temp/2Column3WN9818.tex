...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rylee James Jakobsson} \\
		{\large King 50}\\
		{\large 75825, Florence, Texas, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniela Louise 	 Lindberg Pte Ltd } \\
		{\large Destiny 45}\\
		{\large 72778, Nha Trang, Amnat Charoen, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
