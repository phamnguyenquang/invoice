...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jace Elizabeth 	 Bengtsson} \\
		{\large Alexa 91}\\
		{\large 89939, Sydney, Chai Nat, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julianna Robert Lindholm Inc } \\
		{\large Elijah 51}\\
		{\large 83856, Frankfurt am Main , Indiana, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
