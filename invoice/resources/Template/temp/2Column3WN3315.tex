...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mary Peter Lindberg} \\
		{\large Braxton 53}\\
		{\large 90799, Frankfurt am Main , khanh Hoa, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mateo John Hermansson Ltd } \\
		{\large Aaliyah 99}\\
		{\large 71349, Abu Dhabi, Ang Thong, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
