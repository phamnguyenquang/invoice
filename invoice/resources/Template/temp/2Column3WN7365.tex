...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joseph May/Mae 	 Löfgren} \\
		{\large Sydney 24}\\
		{\large 43959, Nha Trang, Floria, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camila Elizabeth 	 Arvidsson Corp } \\
		{\large Ezra 44}\\
		{\large 63642, Florence, Phu Yen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
