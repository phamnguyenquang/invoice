...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Steven Jonsson Corp} \\
		{\large Austin 8}\\
		{\large 64088, San Francisco, Hawaii, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emery Dahlberg } \\
		{\large Jasmine 69}\\
		{\large 32376, Frankfurt am Main , Amnat Charoen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
