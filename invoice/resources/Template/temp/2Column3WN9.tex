...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eden May/Mae 	 Arvidsson} \\
		{\large Axel 43}\\
		{\large 72779, San Francisco, Guangdong, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kendall Robert Hermansson Ltd } \\
		{\large Adeline 6}\\
		{\large 75051, Washington, Henan, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
