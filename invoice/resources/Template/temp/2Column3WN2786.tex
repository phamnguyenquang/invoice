...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sean Ann  Persson} \\
		{\large Josiah 58}\\
		{\large 89848, Amsterdam, Tuscany, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brayden Peter Eliasson Pte Ltd } \\
		{\large Adeline 42}\\
		{\large 93685, Frankfurt am Main , Huabei, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
