...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Skylar Samuelsson} \\
		{\large Kylie 44}\\
		{\large 89665, Shanghai, Binh Thuan, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julianna Thomas Fredriksson Pte Ltd } \\
		{\large Rylee 66}\\
		{\large 68181, Vienna, khanh Hoa, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
