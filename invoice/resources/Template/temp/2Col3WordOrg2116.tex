...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bradley Robert Mårtensson Pte Ltd} \\
		{\large Jordan 44}\\
		{\large 79520, Florence, Guangzhou, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley Johansson } \\
		{\large Zoe 50}\\
		{\large 42637, Melbourne, Binh Thuan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
