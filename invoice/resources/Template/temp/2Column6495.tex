...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Weston Bergström Pte Ltd} \\
		{\large Izabella 94}\\
		{\large 84964, SaiGon, California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Allison Andersson } \\
		{\large Luke 4}\\
		{\large 49115, Barcelona, Bangkok, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
