...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaliyah Robert Jakobsson Pte Ltd} \\
		{\large Zachary 62}\\
		{\large 93698, Frankfurt am Main , Chiang Mai, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eleanor Andersson } \\
		{\large Faith 39}\\
		{\large 98164, Washington, Hainan, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
