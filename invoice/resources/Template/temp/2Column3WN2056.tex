...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joshua Mary 	 Bergström} \\
		{\large Tucker 2}\\
		{\large 20989, Beijing, Ang Thong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonathan David Mårtensson Corp } \\
		{\large Mya 70}\\
		{\large 74865, Denver, Huabei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
