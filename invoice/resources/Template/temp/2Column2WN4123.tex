...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joel Nilsson} \\
		{\large Blake 86}\\
		{\large 65672, Barcelona, Ang Thong, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mya David Lundin Pte Ltd } \\
		{\large Christopher 27}\\
		{\large 41667, Rome, Chiang Mai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
