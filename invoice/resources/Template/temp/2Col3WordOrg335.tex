...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriella  Alexander  Björklund Pte Ltd} \\
		{\large Everly 3}\\
		{\large 74560, Barcelona, Amnat Charoen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Declan Hassan } \\
		{\large Kimberly 62}\\
		{\large 16361, Amsterdam, Hessen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
