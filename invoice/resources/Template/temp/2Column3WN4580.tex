...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxson May/Mae 	 Jansson} \\
		{\large Nicole 98}\\
		{\large 37191, Nha Trang, Guangdong, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jade Mary 	 Johansson Pte Ltd } \\
		{\large Victor 24}\\
		{\large 46939, Minsk, Guangzhou, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
