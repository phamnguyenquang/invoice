...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ivy Martinsson} \\
		{\large Damian 63}\\
		{\large 29813, Frankfurt am Main , Bayern, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Louise 	 Eliasson Corp } \\
		{\large Mason 32}\\
		{\large 20204, Montreal, Buriam, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
