...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Genesis Louise 	 Håkansson} \\
		{\large Olivia 92}\\
		{\large 37051, Shanghai, Hessen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie Grace 	 Johansson Pte Ltd } \\
		{\large Makenzie 74}\\
		{\large 13034, Shanghai, Buriam, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
