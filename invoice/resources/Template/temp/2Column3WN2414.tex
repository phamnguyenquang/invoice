...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall Lee  Abrahamsson} \\
		{\large Kennedy 51}\\
		{\large 64627, Last Vegas, Hamburg, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaliyah Victoria Björk Corp } \\
		{\large Elena 90}\\
		{\large 99689, Vienna, Texas, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
