...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brian  Alexander  Berggren Pte Ltd} \\
		{\large Aubrey 7}\\
		{\large 79700, Budapest, Binh Thuan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubrey Hellström } \\
		{\large Serenity 45}\\
		{\large 48933, Stuttgart, Binh Thuan, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
