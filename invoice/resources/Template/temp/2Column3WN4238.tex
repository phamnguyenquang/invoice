...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly Victoria Fredriksson} \\
		{\large Riley 20}\\
		{\large 89269, Singapore, Bremen, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emily Elizabeth 	 Henriksson Pte Ltd } \\
		{\large Jayden 47}\\
		{\large 14125, New York , Floria, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
