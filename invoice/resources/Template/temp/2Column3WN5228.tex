...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Victoria Bergström} \\
		{\large Kaleb 42}\\
		{\large 83885, Florence, Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madeline Rose 	 Lindberg Corp } \\
		{\large Caden 2}\\
		{\large 54610, Nha Trang, Indiana, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
