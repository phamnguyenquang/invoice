...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eleanor Victoria Jonsson} \\
		{\large Gavin 79}\\
		{\large 80062, Bonn, Guangdong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eliza  Alexander  Larsson Ltd } \\
		{\large Aliyah 75}\\
		{\large 89326, Ho Chi Minh, Bayern, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
