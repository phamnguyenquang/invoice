...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Naomi Jansson} \\
		{\large Connor 12}\\
		{\large 16112, Amsterdam, Chiang Rai, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zoe Catherine  Arvidsson Pte Ltd } \\
		{\large Kennedy 15}\\
		{\large 38804, Hong Kong, California, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
