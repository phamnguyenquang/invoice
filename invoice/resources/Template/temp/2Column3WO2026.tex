...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Justin Christopher Jönsson Corp} \\
		{\large Hunter 73}\\
		{\large 85057, Hanoi, Chai Nat, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison Blom } \\
		{\large Adriana 38}\\
		{\large 53482, Frankfurt am Main , Chai Nat, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
