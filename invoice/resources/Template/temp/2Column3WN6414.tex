...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla Peter Lundqvist} \\
		{\large Evan 46}\\
		{\large 84576, Vienna, Guangdong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley Catherine  Abrahamsson Pte Ltd } \\
		{\large Colton 30}\\
		{\large 67245, Denver, Kentucky, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
