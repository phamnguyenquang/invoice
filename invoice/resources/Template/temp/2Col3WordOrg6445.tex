...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alan Louise 	 Lundin Pte Ltd} \\
		{\large Isaiah 22}\\
		{\large 53233, Beijing, Guangzhou, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesus Axelsson } \\
		{\large Jason 15}\\
		{\large 34715, Frankfurt am Main , Amnat Charoen, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
