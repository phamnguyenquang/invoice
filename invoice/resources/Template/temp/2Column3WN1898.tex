...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Timothy Amy  Magnusson} \\
		{\large Caden 61}\\
		{\large 60730, Moscow, Guangdong, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caroline James Martinsson Corp } \\
		{\large Leah 26}\\
		{\large 70122, San Francisco, Chiang Mai, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
