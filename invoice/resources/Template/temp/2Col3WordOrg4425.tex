...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaylee Edward Norberg Inc} \\
		{\large Emily 53}\\
		{\large 46278, Munich, Guangzhou, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Easton Bergström } \\
		{\large Emmett 80}\\
		{\large 21621, Frankfurt am Main , Indiana, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
