...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Elizabeth 	 Larsson} \\
		{\large Kai 22}\\
		{\large 68865, Frankfurt am Main , Chai Nat, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Graham Peter Hermansson Inc } \\
		{\large Jameson 81}\\
		{\large 42676, Chicago, Seattles, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
