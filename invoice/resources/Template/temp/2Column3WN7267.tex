...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maximus Rose 	 Danielsson} \\
		{\large Mia 82}\\
		{\large 20394, Toronto, Floria, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremiah Catherine  Lindberg Pte Ltd } \\
		{\large Lucas 28}\\
		{\large 11701, Singapore, Phu Yen, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
