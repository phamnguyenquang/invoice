...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julianna Grace 	 Mårtensson} \\
		{\large Leonardo 99}\\
		{\large 45001, Ho Chi Minh, Texas, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ezra Louise 	 Åkesson Ltd } \\
		{\large Jaden 63}\\
		{\large 13062, Frankfurt am Main , Hainan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
