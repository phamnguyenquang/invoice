...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alana Edward Sandberg Ltd} \\
		{\large Josiah 91}\\
		{\large 29580, Washington, Saarland, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lily Engström } \\
		{\large Alex 43}\\
		{\large 59410, Frankfurt am Main , Floria, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
