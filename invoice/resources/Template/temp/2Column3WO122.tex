...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle Grace 	 Lindholm Pte Ltd} \\
		{\large Abraham 77}\\
		{\large 35562, Singapore, Chiang Mai, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kai Martinsson } \\
		{\large Jordyn 69}\\
		{\large 75178, Vienna, Amnat Charoen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
