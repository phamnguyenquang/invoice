...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Margaret James Magnusson} \\
		{\large Juan 62}\\
		{\large 60118, Berlin, Hamburg, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Steven Amy  Fredriksson Ltd } \\
		{\large Logan 56}\\
		{\large 61033, Toronto, Amnat Charoen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
