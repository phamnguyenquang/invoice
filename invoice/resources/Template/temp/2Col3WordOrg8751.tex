...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery Marie 	 Löfgren Inc} \\
		{\large Madison 81}\\
		{\large 18677, Nha Trang, Chiang Rai, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriel Olsson } \\
		{\large Eliza 96}\\
		{\large 70220, Frankfurt am Main , Chiang Mai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
