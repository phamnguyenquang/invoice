...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abel Catherine  Martinsson} \\
		{\large Jessica 78}\\
		{\large 37903, Barcelona, Chiang Mai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaden Edward Lundberg Pte Ltd } \\
		{\large Makayla 77}\\
		{\large 24006, New York , Kentucky, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
