...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalyn Louise 	 Hansen} \\
		{\large Daisy 94}\\
		{\large 93171, Montreal, Guangzhou, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eleanor Victoria Mattsson Pte Ltd } \\
		{\large Jade 70}\\
		{\large 68555, Madrid, Chiang Mai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
