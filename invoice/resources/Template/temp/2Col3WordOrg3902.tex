...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adam Victoria Fredriksson Corp} \\
		{\large Brady 88}\\
		{\large 94511, Shanghai, Chai Nat, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Quinn Lundström } \\
		{\large Maya 29}\\
		{\large 88965, Frankfurt am Main , Saarland, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
