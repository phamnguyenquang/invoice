...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amy Elizabeth 	 Jakobsson} \\
		{\large Amir 7}\\
		{\large 67376, Hong Kong, Amnat Charoen, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Mary 	 Söderberg Inc } \\
		{\large Aiden 64}\\
		{\large 23775, Singapore, Binh Thuan, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
