...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Summer Christopher Gunnarsson} \\
		{\large Patrick 72}\\
		{\large 88877, Ho Chi Minh, Phu Yen, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daisy Thomas Mohamed Pte Ltd } \\
		{\large William 84}\\
		{\large 22006, Vienna, Huabei, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
