...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mckenzie Robert Jakobsson} \\
		{\large Carter 76}\\
		{\large 39339, Frankfurt am Main , Huabei, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hayden James Eliasson Pte Ltd } \\
		{\large Riley 6}\\
		{\large 96429, Berlin, Buriam, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
