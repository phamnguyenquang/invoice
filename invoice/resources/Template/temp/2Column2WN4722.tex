...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Izabella Svensson} \\
		{\large Alice 26}\\
		{\large 20268, Dublin, Buriam, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Austin May/Mae 	 Forsberg Ltd } \\
		{\large Brian 44}\\
		{\large 87805, Frankfurt am Main , Saarland, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
