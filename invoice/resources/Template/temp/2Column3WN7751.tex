...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kingston James Arvidsson} \\
		{\large Mary 31}\\
		{\large 16888, Shanghai, Guangdong, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Marcus Robert Holmberg Pte Ltd } \\
		{\large Jameson 74}\\
		{\large 69460, Vienna, Ang Thong, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
