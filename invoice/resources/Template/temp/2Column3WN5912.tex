...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalia  Alexander  Axelsson} \\
		{\large Gabriella 26}\\
		{\large 29861, Barcelona, Hamburg, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elena Christopher Holmgren Corp } \\
		{\large Everly 80}\\
		{\large 90911, Venice, Hawaii, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
