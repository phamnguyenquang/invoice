...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leilani Elizabeth 	 Samuelsson Inc} \\
		{\large Makayla 56}\\
		{\large 50896, Amsterdam, Bangkok, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reagan Martinsson } \\
		{\large Avery 75}\\
		{\large 41139, Dublin, Guangdong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
