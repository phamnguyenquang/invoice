...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jose Thomas Persson} \\
		{\large George 93}\\
		{\large 86577, Beijing, Bayern, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon James Martinsson Inc } \\
		{\large Maxwell 60}\\
		{\large 77673, Frankfurt am Main , Hawaii, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
