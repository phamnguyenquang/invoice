...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Nice Sophia Antipolis} \\
		{\large Lyla 12}\\
		{\large 36713, Venice, Saarland, Ireland}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Victor Isaksson } \\
		{\large Vincent 32}\\
		{\large 56325, Ho Chi Minh, Hawaii, Philippines}\\
    \switchcolumn
