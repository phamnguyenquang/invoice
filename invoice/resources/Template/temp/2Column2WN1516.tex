...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abel Viklund} \\
		{\large John 11}\\
		{\large 99280, Ho Chi Minh, Indiana, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalynn Christopher Svensson Pte Ltd } \\
		{\large Brianna 51}\\
		{\large 41946, Shanghai, Henan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
