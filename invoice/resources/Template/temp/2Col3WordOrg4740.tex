...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daisy Elizabeth 	 Sandberg Ltd} \\
		{\large Ximena 84}\\
		{\large 33513, Chicago, Ang Thong, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hannah Martinsson } \\
		{\large Charlotte 8}\\
		{\large 41898, Los Angeles, Guangdong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
