...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Margaret Lee  Berggren} \\
		{\large Colton 56}\\
		{\large 35426, Frankfurt am Main , Henan, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie Louise 	 Engström Ltd } \\
		{\large Jeremy 56}\\
		{\large 65911, Budapest, Chiang Rai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
