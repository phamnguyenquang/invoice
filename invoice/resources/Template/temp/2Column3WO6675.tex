...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brianna Louise 	 Abrahamsson Corp} \\
		{\large Marcus 10}\\
		{\large 81383, Taipei, Amnat Charoen, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adriana Strömberg } \\
		{\large Luke 62}\\
		{\large 27499, San Francisco, Ang Thong, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
