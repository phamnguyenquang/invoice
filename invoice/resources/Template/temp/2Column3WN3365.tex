...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elizabeth Rose 	 Löfgren} \\
		{\large Ian 9}\\
		{\large 89479, Los Angeles, Bayern, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large James Elizabeth 	 Sandberg Ltd } \\
		{\large Kylie 48}\\
		{\large 79707, Vancouver, Hamburg, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
