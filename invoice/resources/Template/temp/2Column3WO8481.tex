...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Clara Christopher Henriksson Pte Ltd} \\
		{\large Ruby 65}\\
		{\large 31346, Frankfurt am Main , Bremen, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryson Lundgren } \\
		{\large Avery 26}\\
		{\large 15909, Florence, Hawaii, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
