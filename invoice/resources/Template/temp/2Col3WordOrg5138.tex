...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gavin Catherine  Löfgren Pte Ltd} \\
		{\large Kingston 24}\\
		{\large 95984, San Francisco, Buriam, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Skylar Falk } \\
		{\large Camden 59}\\
		{\large 46449, Singapore, khanh Hoa, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
