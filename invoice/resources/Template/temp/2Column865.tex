...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Savannah Andersson Pte Ltd} \\
		{\large Mason 20}\\
		{\large 23895, Washington, Henan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison Jakobsson } \\
		{\large Antonio 73}\\
		{\large 47675, Frankfurt am Main , Chiang Mai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
