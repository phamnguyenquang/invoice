...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Quinn Michael Strömberg Inc} \\
		{\large Everett 66}\\
		{\large 44659, Last Vegas, Hainan, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vincent Mårtensson } \\
		{\large Giovanni 23}\\
		{\large 69184, Frankfurt am Main , Hessen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
