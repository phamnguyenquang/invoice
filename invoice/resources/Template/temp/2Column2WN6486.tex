...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tyler Hedlund} \\
		{\large Allison 59}\\
		{\large 53222, Ho Chi Minh, Phu Yen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madison Robert Åkesson Pte Ltd } \\
		{\large Miguel 96}\\
		{\large 13975, Frankfurt am Main , Chiang Mai, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
