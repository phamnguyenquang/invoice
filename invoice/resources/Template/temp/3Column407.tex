...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Xi'an Jiaotong University} \\
		{\large Ariel 6}\\
		{\large 12069, Melbourne, Bremen, Indonesia s}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Arianna Håkansson } \\
		{\large George 25}\\
		{\large 40202, Minsk, Amnat Charoen, United Kingdom}\\
    \switchcolumn
