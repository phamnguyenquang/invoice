...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jameson Mattsson} \\
		{\large Max 58}\\
		{\large 34993, Budapest, Guangzhou, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mckenzie Louise 	 Strömberg Pte Ltd } \\
		{\large Kevin 74}\\
		{\large 72930, Frankfurt am Main , Hessen, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
