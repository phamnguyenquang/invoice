...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nolan  Alexander  Håkansson} \\
		{\large Abel 79}\\
		{\large 55653, Stuttgart, Hainan, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madison  Alexander  Johansson Corp } \\
		{\large Patrick 94}\\
		{\large 82911, SaiGon, Guangdong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
