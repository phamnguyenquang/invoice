...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Khloe James Dahlberg Corp} \\
		{\large Jeremiah 67}\\
		{\large 58935, Sydney, Amnat Charoen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Payton Axelsson } \\
		{\large Ashton 5}\\
		{\large 12621, San Francisco, Hainan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
