...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Mary 	 Ström Corp} \\
		{\large Hannah 32}\\
		{\large 66793, Frankfurt am Main , Henan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mya Fransson } \\
		{\large Lincoln 2}\\
		{\large 31697, Melbourne, Amnat Charoen, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
