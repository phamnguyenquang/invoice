...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liam Peter Persson} \\
		{\large Henry 16}\\
		{\large 55242, Shanghai, Hessen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gael Marie 	 Engström Ltd } \\
		{\large Cora 95}\\
		{\large 21325, Los Angeles, Hamburg, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
