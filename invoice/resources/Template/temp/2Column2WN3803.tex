...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abigail Lindström} \\
		{\large Jacob 90}\\
		{\large 96580, Tokyo, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zoe Louise 	 Eriksson Inc } \\
		{\large Eliana 93}\\
		{\large 96093, Los Angeles, Guangzhou, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
