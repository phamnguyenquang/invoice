...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Violet Lindberg} \\
		{\large Cameron 96}\\
		{\large 33648, Nha Trang, Bremen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Edward Danielsson Inc } \\
		{\large Michael 67}\\
		{\large 78795, Frankfurt am Main , Chiang Mai, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
