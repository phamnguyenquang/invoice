...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kinsley Robert Lindholm} \\
		{\large Gabriella 75}\\
		{\large 84168, Frankfurt am Main , Hessen, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caroline Marie 	 Lundqvist Ltd } \\
		{\large Vanessa 55}\\
		{\large 66677, Abu Dhabi, Bayern, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
