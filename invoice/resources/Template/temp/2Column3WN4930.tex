...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amir Louise 	 Fransson} \\
		{\large Sarah 56}\\
		{\large 79474, Stuttgart, Ang Thong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angel Elizabeth 	 Strömberg Ltd } \\
		{\large Valeria 55}\\
		{\large 50088, Singapore, Indiana, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
