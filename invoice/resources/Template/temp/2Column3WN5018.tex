...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rachel Louise 	 Hermansson} \\
		{\large George 75}\\
		{\large 18325, Hanoi, Heibei, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Chase  Alexander  Gunnarsson Pte Ltd } \\
		{\large Brody 85}\\
		{\large 51245, Berlin, Chiang Mai, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
