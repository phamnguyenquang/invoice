...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lillian William Pettersson} \\
		{\large Adriana 62}\\
		{\large 54410, Moscow, Chiang Mai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryker Amy  Engström Ltd } \\
		{\large Silas 78}\\
		{\large 22384, Nha Trang, Henan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
