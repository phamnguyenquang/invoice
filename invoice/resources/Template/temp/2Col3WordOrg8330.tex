...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryce David Ali Ltd} \\
		{\large Arianna 1}\\
		{\large 61616, Ho Chi Minh, Amnat Charoen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Ahmed } \\
		{\large Aaliyah 93}\\
		{\large 40866, San Francisco, Floria, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
