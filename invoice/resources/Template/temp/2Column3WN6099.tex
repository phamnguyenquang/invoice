...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Roman Victoria Strömberg} \\
		{\large Penelope 43}\\
		{\large 24207, Last Vegas, Bayern, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Santiago William Eriksson Ltd } \\
		{\large Brooklyn 62}\\
		{\large 93308, Osaka, Tuscany, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
