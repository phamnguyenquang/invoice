...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eleanor Rose 	 Nyström} \\
		{\large David 30}\\
		{\large 12146, Toronto, Seattles, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mason William Andreasson Inc } \\
		{\large Nicolas 92}\\
		{\large 46964, Dubai, Chiang Mai, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
