...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra Rose 	 Lindholm Pte Ltd} \\
		{\large Sean 8}\\
		{\large 92906, Berlin, Kentucky, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon Axelsson } \\
		{\large Benjamin 56}\\
		{\large 30540, Ho Chi Minh, Buriam, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
