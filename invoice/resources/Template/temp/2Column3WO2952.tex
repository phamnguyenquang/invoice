...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalia James Gustafsson Corp} \\
		{\large Nicolas 27}\\
		{\large 90482, Abu Dhabi, Binh Thuan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bella Björklund } \\
		{\large Hunter 99}\\
		{\large 42660, Osaka, Ang Thong, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
