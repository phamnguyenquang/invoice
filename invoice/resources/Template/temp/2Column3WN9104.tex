...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremiah Ann  Blom} \\
		{\large Easton 41}\\
		{\large 66537, Frankfurt am Main , Huabei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Destiny William Ahmed Corp } \\
		{\large Eleanor 55}\\
		{\large 45611, Dublin, Amnat Charoen, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
