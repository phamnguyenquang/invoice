...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalia Louise 	 Åkesson} \\
		{\large Leilani 2}\\
		{\large 88490, Berlin, Hessen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Greyson Peter Samuelsson Inc } \\
		{\large Savannah 33}\\
		{\large 34212, Barcelona, Hessen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
