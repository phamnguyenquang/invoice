...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aurora Thomas Ström} \\
		{\large Isabelle 41}\\
		{\large 13734, Rome, Kentucky, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaylee Elizabeth 	 Blomqvist Pte Ltd } \\
		{\large Lincoln 79}\\
		{\large 12264, Amsterdam, Tuscany, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
