...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonathan Karlsson} \\
		{\large Maximus 3}\\
		{\large 66522, Beijing, Binh Thuan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michelle Catherine  Lundström Ltd } \\
		{\large Isabel 45}\\
		{\large 83682, Dubai, Bayern, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
