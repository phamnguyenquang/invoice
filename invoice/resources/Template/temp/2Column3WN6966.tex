...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalia  Alexander  Lundin} \\
		{\large Marcus 88}\\
		{\large 70910, Singapore, Bayern, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ezekiel Jane Lundström Pte Ltd } \\
		{\large Jack 16}\\
		{\large 44986, Istanbul, Hamburg, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
