...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hadley Mary 	 Lindqvist} \\
		{\large Maverick 29}\\
		{\large 82650, Munich, California, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Izabella David Nordström Corp } \\
		{\large Easton 66}\\
		{\large 16061, Shanghai, Tuscany, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
