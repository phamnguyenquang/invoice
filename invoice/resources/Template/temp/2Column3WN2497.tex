...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremy Anne Danielsson} \\
		{\large Makenzie 70}\\
		{\large 36416, Toronto, Saarland, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Diego Amy  Bergström Pte Ltd } \\
		{\large Catherine 65}\\
		{\large 73613, Frankfurt am Main , Seattles, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
