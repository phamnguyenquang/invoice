...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Samantha Elizabeth 	 Hermansson} \\
		{\large Ryker 56}\\
		{\large 58154, Stuttgart, Guangzhou, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aiden David Mohamed Pte Ltd } \\
		{\large Kayla 59}\\
		{\large 29054, Montreal, California, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
