...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sean Lee  Karlsson} \\
		{\large Victoria 94}\\
		{\large 72510, Toronto, Hessen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mary Marie 	 Isaksson Inc } \\
		{\large Jaden 34}\\
		{\large 26156, San Francisco, California, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
