...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tucker Jane Öberg} \\
		{\large Jayden 93}\\
		{\large 98302, Vancouver, Tuscany, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexis Marie 	 Abrahamsson Inc } \\
		{\large Caroline 44}\\
		{\large 64260, Madrid, Amnat Charoen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
