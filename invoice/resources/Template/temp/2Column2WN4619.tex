...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniel Löfgren} \\
		{\large Elias 16}\\
		{\large 55015, Florence, Kentucky, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklyn Catherine  Mårtensson Corp } \\
		{\large Steven 47}\\
		{\large 46882, Singapore, California, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
