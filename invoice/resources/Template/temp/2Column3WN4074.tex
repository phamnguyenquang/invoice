...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abraham Grace 	 Holmberg} \\
		{\large Jayden 16}\\
		{\large 57365, Berlin, Ang Thong, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson Louise 	 Lindgren Inc } \\
		{\large Abigail 17}\\
		{\large 42180, Amsterdam, Bremen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
