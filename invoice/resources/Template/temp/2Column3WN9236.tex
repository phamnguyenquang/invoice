...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jace Michael Sandberg} \\
		{\large Maya 93}\\
		{\large 65231, Montreal, Hamburg, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carson Grace 	 Viklund Corp } \\
		{\large Riley 96}\\
		{\large 68556, Melbourne, Chiang Mai, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
