...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brianna Anne Lindqvist} \\
		{\large Weston 81}\\
		{\large 25976, Last Vegas, Phu Yen, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn Christopher Bergström Pte Ltd } \\
		{\large Savannah 38}\\
		{\large 88973, Abu Dhabi, Bangkok, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
