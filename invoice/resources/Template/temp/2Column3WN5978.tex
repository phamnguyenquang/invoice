...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mary May/Mae 	 Olsson} \\
		{\large Brooklyn 95}\\
		{\large 69401, Hong Kong, Seattles, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariana  Alexander  Jönsson Inc } \\
		{\large Elijah 79}\\
		{\large 94761, Stuttgart, Guangdong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
