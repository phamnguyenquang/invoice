...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maximus Jakobsson Ltd} \\
		{\large Brooklyn 42}\\
		{\large 57053, Singapore, Amnat Charoen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large James Lindgren } \\
		{\large Vanessa 24}\\
		{\large 35332, Frankfurt am Main , khanh Hoa, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
