...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  National Autonomous University of Mexico} \\
		{\large Joseph 96}\\
		{\large 10688, Seoul, Hainan, United State }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Andrew Martinsson } \\
		{\large Leilani 56}\\
		{\large 37278, Frankfurt am Main , Hawaii, Indonesia s}\\
    \switchcolumn
