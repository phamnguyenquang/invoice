...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklynn William Berg Corp} \\
		{\large Christopher 18}\\
		{\large 14893, Abu Dhabi, Seattles, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juan Holmberg } \\
		{\large Parker 91}\\
		{\large 63156, Frankfurt am Main , Bayern, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
