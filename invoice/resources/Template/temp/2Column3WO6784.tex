...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Declan Christopher Lindgren Inc} \\
		{\large Jeremiah 37}\\
		{\large 71259, Florence, Hawaii, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalia Olofsson } \\
		{\large Noah 67}\\
		{\large 72844, Los Angeles, Phu Yen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
