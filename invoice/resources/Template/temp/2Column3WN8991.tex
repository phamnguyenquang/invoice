...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Parker Edward Fredriksson} \\
		{\large Michelle 63}\\
		{\large 51396, Hanoi, Texas, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Izabella Christopher Norberg Pte Ltd } \\
		{\large Graham 28}\\
		{\large 11284, Vancouver, Hawaii, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
