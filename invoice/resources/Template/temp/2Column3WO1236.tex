...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maverick Catherine  Löfgren Ltd} \\
		{\large Axel 64}\\
		{\large 48301, Toronto, khanh Hoa, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniel Lund } \\
		{\large Natalia 16}\\
		{\large 45393, Frankfurt am Main , Chiang Rai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
