...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grace Catherine  Magnusson} \\
		{\large Alaina 92}\\
		{\large 80067, Frankfurt am Main , Binh Thuan, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brielle Kate 	 Holmgren Pte Ltd } \\
		{\large Alexis 68}\\
		{\large 52343, Melbourne, Hawaii, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
