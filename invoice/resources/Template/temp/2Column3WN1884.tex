...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Robert Marie 	 Engström} \\
		{\large Daniel 9}\\
		{\large 12938, Dubai, Chiang Mai, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abigail Amy  Danielsson Inc } \\
		{\large Sophie 75}\\
		{\large 51398, Los Angeles, Amnat Charoen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
