...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalynn Magnusson} \\
		{\large Bailey 52}\\
		{\large 47651, Abu Dhabi, Huabei, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liliana  Alexander  Svensson Inc } \\
		{\large Amy 42}\\
		{\large 82640, Hong Kong, Binh Thuan, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
