...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joseph Catherine  Ström} \\
		{\large Antonio 67}\\
		{\large 85061, Chicago, Hamburg, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Santiago Louise 	 Ström Pte Ltd } \\
		{\large Piper 85}\\
		{\large 67495, Washington, Chiang Rai, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
