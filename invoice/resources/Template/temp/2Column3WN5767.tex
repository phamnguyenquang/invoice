...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Micah Jane Andersson} \\
		{\large Santiago 33}\\
		{\large 93031, Nha Trang, Hessen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elizabeth Grace 	 Bergman Inc } \\
		{\large Madeline 79}\\
		{\large 15146, Melbourne, Saarland, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
