...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklynn James Lundström} \\
		{\large Wesley 96}\\
		{\large 66037, Washington, Hawaii, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amy Kate 	 Söderberg Inc } \\
		{\large Peyton 38}\\
		{\large 29771, Melbourne, Guangzhou, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
