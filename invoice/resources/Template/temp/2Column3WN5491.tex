...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Olivia Kate 	 Månsson} \\
		{\large Steven 5}\\
		{\large 35840, Osaka, California, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alana Victoria Wikström Corp } \\
		{\large Antonio 90}\\
		{\large 41504, Lisbon, Binh Thuan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
