...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Colton Mary 	 Svensson} \\
		{\large Kaden 85}\\
		{\large 51700, Frankfurt am Main , Bayern, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Dylan Robert Öberg Pte Ltd } \\
		{\large Ivy 78}\\
		{\large 78557, Beijing, Chiang Mai, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
