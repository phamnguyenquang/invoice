...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ivan May/Mae 	 Månsson} \\
		{\large Emmett 98}\\
		{\large 37227, Lisbon, Guangdong, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carlos Robert Norberg Corp } \\
		{\large Jayce 14}\\
		{\large 60723, Last Vegas, Floria, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
