...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxon Mary 	 Danielsson Corp} \\
		{\large Cole 66}\\
		{\large 95698, San Francisco, Guangdong, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Steven Lindholm } \\
		{\large Bailey 92}\\
		{\large 52182, Singapore, Binh Thuan, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
