...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victoria Jane Andersson} \\
		{\large Emma 9}\\
		{\large 86497, Singapore, Hessen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriel Michael Bergström Ltd } \\
		{\large Lydia 75}\\
		{\large 33521, Hong Kong, Phu Yen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
