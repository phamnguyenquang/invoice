...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lily Jane Andreasson Pte Ltd} \\
		{\large Daniel 98}\\
		{\large 29312, Last Vegas, Texas, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Skylar Fredriksson } \\
		{\large Abraham 64}\\
		{\large 79811, Bonn, Ang Thong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
