...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brianna James Bergström} \\
		{\large Micah 91}\\
		{\large 27355, Frankfurt am Main , Heibei, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryan Louise 	 Sundberg Pte Ltd } \\
		{\large Jeremiah 83}\\
		{\large 97685, Paris, Floria, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
