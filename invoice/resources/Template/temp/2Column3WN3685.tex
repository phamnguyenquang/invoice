...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mya Christopher Nilsson} \\
		{\large Faith 30}\\
		{\large 84956, Milan, Guangzhou, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hazel May/Mae 	 Claesson Corp } \\
		{\large Kaden 73}\\
		{\large 57260, Barcelona, Bayern, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
