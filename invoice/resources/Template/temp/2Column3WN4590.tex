...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Silas May/Mae 	 Sjögren} \\
		{\large Daniela 71}\\
		{\large 66073, Melbourne, Chiang Mai, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Louise 	 Strömberg Pte Ltd } \\
		{\large Thomas 20}\\
		{\large 29593, Last Vegas, Ang Thong, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
