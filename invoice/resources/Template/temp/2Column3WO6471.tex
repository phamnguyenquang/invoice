...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexis Peter Bengtsson Inc} \\
		{\large London 88}\\
		{\large 93380, Shanghai, Guangdong, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abraham Fransson } \\
		{\large Jace 96}\\
		{\large 56578, Frankfurt am Main , Binh Thuan, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
