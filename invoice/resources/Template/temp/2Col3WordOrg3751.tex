...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lily  Alexander  Nyberg Pte Ltd} \\
		{\large Ivan 90}\\
		{\large 14773, Vancouver, Chiang Mai, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kenneth Jansson } \\
		{\large Parker 2}\\
		{\large 39668, Istanbul, Hessen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
