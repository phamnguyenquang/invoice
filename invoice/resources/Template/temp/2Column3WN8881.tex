...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon  Alexander  Lind} \\
		{\large Daniel 22}\\
		{\large 97825, Hong Kong, Guangdong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stella Anne Viklund Pte Ltd } \\
		{\large David 25}\\
		{\large 27167, Moscow, Texas, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
