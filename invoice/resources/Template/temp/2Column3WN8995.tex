...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joseph Grace 	 Holmgren} \\
		{\large Ava 47}\\
		{\large 62990, Berlin, Hawaii, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Morgan May/Mae 	 Jonsson Ltd } \\
		{\large Sawyer 24}\\
		{\large 86894, San Francisco, California, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
