...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maxwell Anne Magnusson} \\
		{\large Madeline 57}\\
		{\large 37327, Chicago, Guangdong, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eden Victoria Ström Pte Ltd } \\
		{\large Angel 6}\\
		{\large 33163, Melbourne, Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
