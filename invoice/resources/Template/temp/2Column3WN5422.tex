...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kenneth Robert Eriksson} \\
		{\large Brody 60}\\
		{\large 92426, Vancouver, Phu Yen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Serenity May/Mae 	 Lundqvist Inc } \\
		{\large Luke 29}\\
		{\large 23541, Budapest, Ang Thong, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
