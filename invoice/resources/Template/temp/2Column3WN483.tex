...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grace  Alexander  Nyberg} \\
		{\large Kingston 9}\\
		{\large 71521, Abu Dhabi, Tuscany, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Dominic Catherine  Jonsson Corp } \\
		{\large Everly 25}\\
		{\large 47071, Nha Trang, Kentucky, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
