...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jackson Berggren} \\
		{\large Olivia 77}\\
		{\large 74764, San Francisco, Chiang Mai, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremiah May/Mae 	 Andreasson Pte Ltd } \\
		{\large Nevaeh 16}\\
		{\large 74172, Barcelona, Chiang Mai, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
