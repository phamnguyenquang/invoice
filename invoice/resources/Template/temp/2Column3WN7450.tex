...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Willow Christopher Larsson} \\
		{\large Gabrielle 93}\\
		{\large 43446, Madrid, Tuscany, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Willow Kate 	 Pettersson Corp } \\
		{\large Izabella 60}\\
		{\large 79609, London , Kentucky, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
