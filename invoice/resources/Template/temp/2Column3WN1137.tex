...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hailey Mary 	 Sandberg} \\
		{\large Melanie 39}\\
		{\large 35453, Boston, Amnat Charoen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nevaeh Mary 	 Hedlund Pte Ltd } \\
		{\large Lila 51}\\
		{\large 68946, Budapest, Tuscany, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
