...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Damian Grace 	 Danielsson} \\
		{\large Hailey 20}\\
		{\large 57156, Berlin, Hessen, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Logan Christopher Jansson Inc } \\
		{\large Maxwell 34}\\
		{\large 50249, Istanbul, Kentucky, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
