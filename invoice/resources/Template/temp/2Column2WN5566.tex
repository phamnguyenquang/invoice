...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mason Jönsson} \\
		{\large William 33}\\
		{\large 26822, Frankfurt am Main , Phu Yen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grayson Mary 	 Forsberg Corp } \\
		{\large Abigail 53}\\
		{\large 10606, New York , California, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
