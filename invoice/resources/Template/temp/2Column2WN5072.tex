...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hudson Abrahamsson} \\
		{\large Ryder 7}\\
		{\large 41927, Frankfurt am Main , Guangzhou, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Peyton Marie 	 Pettersson Ltd } \\
		{\large Daisy 90}\\
		{\large 18418, Venice, California, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
