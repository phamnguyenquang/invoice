...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rebecca Olsson} \\
		{\large Luna 19}\\
		{\large 73844, Istanbul, Heibei, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gael Elizabeth 	 Mårtensson Ltd } \\
		{\large Calvin 49}\\
		{\large 43062, Frankfurt am Main , Kentucky, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
