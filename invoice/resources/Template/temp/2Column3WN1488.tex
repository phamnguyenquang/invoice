...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kylie Thomas Björk} \\
		{\large Chloe 18}\\
		{\large 49484, Singapore, Guangdong, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmett Elizabeth 	 Sandström Pte Ltd } \\
		{\large Elena 7}\\
		{\large 50860, Denver, Chiang Rai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
