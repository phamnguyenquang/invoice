...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayla Catherine  Lindgren} \\
		{\large Arianna 67}\\
		{\large 80942, Washington, Chai Nat, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore Louise 	 Sandström Inc } \\
		{\large John 81}\\
		{\large 43860, Berlin, Hessen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
