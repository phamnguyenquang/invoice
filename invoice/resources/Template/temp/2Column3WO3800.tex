...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte May/Mae 	 Pettersson Pte Ltd} \\
		{\large Calvin 49}\\
		{\large 40184, Chicago, California, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juliana Håkansson } \\
		{\large Mila 93}\\
		{\large 90834, Ho Chi Minh, Kentucky, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
