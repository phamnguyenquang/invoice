...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryce Louise 	 Abrahamsson} \\
		{\large Jason 94}\\
		{\large 41886, New York , Hawaii, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison Elizabeth 	 Nyberg Ltd } \\
		{\large Eliza 90}\\
		{\large 29930, Frankfurt am Main , Guangzhou, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
