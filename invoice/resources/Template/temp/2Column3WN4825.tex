...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian John Pålsson} \\
		{\large Grace 43}\\
		{\large 85978, Singapore, Hamburg, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luke Michael Jakobsson Inc } \\
		{\large Leah 79}\\
		{\large 47588, Frankfurt am Main , Hawaii, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
