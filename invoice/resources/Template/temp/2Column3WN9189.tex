...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zachary Victoria Fredriksson} \\
		{\large Asher 98}\\
		{\large 31114, Melbourne, Heibei, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luna Catherine  Fransson Ltd } \\
		{\large Declan 4}\\
		{\large 86838, Ho Chi Minh, Buriam, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
