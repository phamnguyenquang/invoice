...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonah Robert Lundberg Pte Ltd} \\
		{\large Alan 5}\\
		{\large 80531, Frankfurt am Main , Chiang Mai, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Scarlett Bergqvist } \\
		{\large Cora 95}\\
		{\large 21567, Singapore, khanh Hoa, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
