...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra May/Mae 	 Bergström} \\
		{\large Lila 60}\\
		{\large 66495, Abu Dhabi, Tuscany, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryce Louise 	 Andreasson Pte Ltd } \\
		{\large Brandon 51}\\
		{\large 40819, New York , Kentucky, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
