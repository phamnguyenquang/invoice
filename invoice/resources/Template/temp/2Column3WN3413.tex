...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Catherine Michael Olsson} \\
		{\large Athena 85}\\
		{\large 71346, Last Vegas, Hawaii, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Braxton Ann  Fredriksson Pte Ltd } \\
		{\large Sean 18}\\
		{\large 24736, Tokyo, Amnat Charoen, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
