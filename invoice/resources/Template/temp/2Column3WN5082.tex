...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Logan  Alexander  Lindqvist} \\
		{\large Patrick 8}\\
		{\large 58846, Tokyo, Hessen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ashley Jane Lundberg Pte Ltd } \\
		{\large Jaxson 62}\\
		{\large 13441, Chicago, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
