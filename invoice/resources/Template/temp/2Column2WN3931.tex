...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Robert Nyström} \\
		{\large London 36}\\
		{\large 58989, San Francisco, Indiana, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isaiah Victoria Wikström Pte Ltd } \\
		{\large Isla 52}\\
		{\large 17899, San Francisco, Hainan, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
