...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lillian David Fredriksson Corp} \\
		{\large Savannah 25}\\
		{\large 77289, Shanghai, Henan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriel Björklund } \\
		{\large Christopher 54}\\
		{\large 48434, Chicago, Huabei, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
