...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Declan Månsson} \\
		{\large Sophia 7}\\
		{\large 18892, Abu Dhabi, Heibei, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Genesis Victoria Hellström Pte Ltd } \\
		{\large Bryson 4}\\
		{\large 81159, San Francisco, Chiang Rai, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
