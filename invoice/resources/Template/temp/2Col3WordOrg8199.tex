...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle  Alexander  Mohamed Pte Ltd} \\
		{\large Lila 20}\\
		{\large 57726, Singapore, Hamburg, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ayden Falk } \\
		{\large Josephine 40}\\
		{\large 86699, Frankfurt am Main , Hainan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
