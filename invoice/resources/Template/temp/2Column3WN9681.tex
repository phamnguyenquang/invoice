...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Taylor Christopher Bergström} \\
		{\large Carson 84}\\
		{\large 44477, Istanbul, Amnat Charoen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gael  Alexander  Berg Pte Ltd } \\
		{\large Camden 51}\\
		{\large 22961, Melbourne, Hamburg, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
