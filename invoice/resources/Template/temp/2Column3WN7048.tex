...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bradley Thomas Lundström} \\
		{\large Nathan 17}\\
		{\large 70266, Beijing, California, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Calvin Mary 	 Jakobsson Pte Ltd } \\
		{\large Cooper 43}\\
		{\large 10245, Dubai, Phu Yen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
