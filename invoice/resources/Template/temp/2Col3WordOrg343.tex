...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  George Catherine  Wikström Pte Ltd} \\
		{\large Valeria 91}\\
		{\large 74402, Taipei, Bremen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cora Lundgren } \\
		{\large Wyatt 32}\\
		{\large 31215, Frankfurt am Main , Saarland, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
