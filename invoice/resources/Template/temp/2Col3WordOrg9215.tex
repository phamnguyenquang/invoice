...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victoria William Sandberg Pte Ltd} \\
		{\large Brooke 24}\\
		{\large 29365, Singapore, Binh Thuan, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angelina Eriksson } \\
		{\large Daniela 61}\\
		{\large 99926, Amsterdam, Guangzhou, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
