...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Amy  Eriksson Ltd} \\
		{\large Adalynn 97}\\
		{\large 85780, Frankfurt am Main , Henan, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sydney Eriksson } \\
		{\large Michelle 76}\\
		{\large 66739, Los Angeles, Seattles, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
