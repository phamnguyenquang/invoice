...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesse Ann  Håkansson} \\
		{\large Abigail 65}\\
		{\large 13300, Los Angeles, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grace Victoria Holmgren Corp } \\
		{\large Sofia 41}\\
		{\large 61469, Dubai, Tuscany, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
