...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abigail Christopher Gunnarsson} \\
		{\large Jack 1}\\
		{\large 51527, Frankfurt am Main , Chiang Mai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grace William Ekström Ltd } \\
		{\large Makayla 17}\\
		{\large 83875, Abu Dhabi, Binh Thuan, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
