...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eleanor Louise 	 Andersson} \\
		{\large Eric 4}\\
		{\large 67913, Bonn, Hawaii, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Khloe  Alexander  Henriksson Pte Ltd } \\
		{\large Vivian 2}\\
		{\large 24598, SaiGon, khanh Hoa, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
