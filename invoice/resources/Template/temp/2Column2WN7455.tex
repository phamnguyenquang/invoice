...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Violet Lundqvist} \\
		{\large Nora 85}\\
		{\large 54579, Berlin, Chiang Rai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large David James Berglund Pte Ltd } \\
		{\large Tyler 5}\\
		{\large 61048, Last Vegas, Guangdong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
