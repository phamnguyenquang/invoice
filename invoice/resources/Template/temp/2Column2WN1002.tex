...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jocelyn Sandström} \\
		{\large Isla 54}\\
		{\large 84523, Singapore, Binh Thuan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jessica Louise 	 Andreasson Corp } \\
		{\large Jaxson 72}\\
		{\large 79452, Chicago, Chiang Rai, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
