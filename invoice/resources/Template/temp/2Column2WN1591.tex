...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elizabeth Bergman} \\
		{\large Madeline 88}\\
		{\large 22297, Frankfurt am Main , Guangdong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elena  Alexander  Pettersson Inc } \\
		{\large Isabel 56}\\
		{\large 10673, Tokyo, Bayern, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
