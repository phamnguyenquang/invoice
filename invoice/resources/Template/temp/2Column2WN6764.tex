...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Xavier Holmgren} \\
		{\large Delilah 33}\\
		{\large 87639, Ho Chi Minh, Chiang Rai, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hannah Elizabeth 	 Fredriksson Inc } \\
		{\large Jaxson 45}\\
		{\large 10720, Melbourne, Amnat Charoen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
