...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryson Louise 	 Sjöberg Pte Ltd} \\
		{\large Hadley 45}\\
		{\large 55145, Frankfurt am Main , Hessen, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samuel Blomqvist } \\
		{\large Jayla 49}\\
		{\large 40078, Osaka, Chiang Rai, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
