...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alyssa  Alexander  Claesson} \\
		{\large Patrick 2}\\
		{\large 71862, Melbourne, Chai Nat, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aurora John Jönsson Corp } \\
		{\large Sean 75}\\
		{\large 94224, Chicago, California, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
