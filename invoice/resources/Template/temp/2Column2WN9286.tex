...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Matthew Viklund} \\
		{\large Ivy 3}\\
		{\large 53651, Bonn, Hessen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Londyn Christopher Jonsson Inc } \\
		{\large Anthony 71}\\
		{\large 52611, Frankfurt am Main , Amnat Charoen, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
