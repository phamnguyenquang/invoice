...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elizabeth Jane Lindqvist} \\
		{\large Skylar 92}\\
		{\large 69154, Frankfurt am Main , Bremen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nora Thomas Lindström Ltd } \\
		{\large Eden 50}\\
		{\large 98730, Shanghai, Hawaii, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
