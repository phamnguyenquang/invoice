...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adeline Thomas Jakobsson Inc} \\
		{\large Scarlett 69}\\
		{\large 14524, Frankfurt am Main , Seattles, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmett Arvidsson } \\
		{\large Dylan 24}\\
		{\large 27917, Dublin, Phu Yen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
