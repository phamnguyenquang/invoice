...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aiden Henriksson} \\
		{\large Maddox 82}\\
		{\large 81688, Last Vegas, Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brianna Christopher Olofsson Pte Ltd } \\
		{\large Calvin 4}\\
		{\large 53767, London , Seattles, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
