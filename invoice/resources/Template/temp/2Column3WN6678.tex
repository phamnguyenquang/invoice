...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paisley Marie 	 Andreasson} \\
		{\large Austin 10}\\
		{\large 84481, Hong Kong, Binh Thuan, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rachel Louise 	 Holm Corp } \\
		{\large Carlos 59}\\
		{\large 46603, Munich, Amnat Charoen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
