...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aiden Andersson} \\
		{\large Gracie 51}\\
		{\large 21820, Ho Chi Minh, Bremen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesus Victoria Claesson Ltd } \\
		{\large Roman 5}\\
		{\large 25641, Ho Chi Minh, Tuscany, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
