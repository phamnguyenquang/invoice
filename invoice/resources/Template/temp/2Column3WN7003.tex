...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Edward Berglund} \\
		{\large Jacob 92}\\
		{\large 75667, San Francisco, Amnat Charoen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Quinn May/Mae 	 Lindström Inc } \\
		{\large Michelle 20}\\
		{\large 66627, Beijing, California, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
