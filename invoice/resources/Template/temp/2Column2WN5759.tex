...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon Bengtsson} \\
		{\large King 41}\\
		{\large 42677, Munich, Kentucky, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harrison Louise 	 Jonsson Corp } \\
		{\large Malachi 8}\\
		{\large 46139, Barcelona, Saarland, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
