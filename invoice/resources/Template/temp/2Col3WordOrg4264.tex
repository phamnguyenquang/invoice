...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina Lee  Sandberg Inc} \\
		{\large Reagan 43}\\
		{\large 80835, Last Vegas, Tuscany, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicolas Sjögren } \\
		{\large Mckenzie 52}\\
		{\large 59371, Stuttgart, Chiang Mai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
