...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daisy Amy  Sjöberg} \\
		{\large Zoe 54}\\
		{\large 66394, Barcelona, khanh Hoa, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ashley Michael Gunnarsson Ltd } \\
		{\large Kyle 79}\\
		{\large 21742, Venice, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
