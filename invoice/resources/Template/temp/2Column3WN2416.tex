...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabella Ann  Håkansson} \\
		{\large Jack 20}\\
		{\large 48291, Seoul, Saarland, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklyn Catherine  Ali Pte Ltd } \\
		{\large Kenneth 18}\\
		{\large 55953, Milan, Binh Thuan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
