...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Malachi Amy  Jönsson Pte Ltd} \\
		{\large Charlotte 23}\\
		{\large 73394, Shanghai, Binh Thuan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ayden Samuelsson } \\
		{\large Axel 2}\\
		{\large 51530, Melbourne, Amnat Charoen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
