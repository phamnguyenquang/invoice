...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Austin Thomas Berglund} \\
		{\large Tucker 73}\\
		{\large 72050, Toronto, Buriam, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leilani Peter Holmgren Pte Ltd } \\
		{\large Austin 17}\\
		{\large 90117, Milan, Huabei, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
