...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaitlyn May/Mae 	 Jonsson} \\
		{\large Gabriel 5}\\
		{\large 58767, Berlin, Kentucky, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gracie Mary 	 Eliasson Pte Ltd } \\
		{\large Isla 82}\\
		{\large 24816, Barcelona, Guangzhou, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
