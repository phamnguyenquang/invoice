...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Skylar Kate 	 Blomqvist} \\
		{\large Dylan 35}\\
		{\large 10402, Frankfurt am Main , Guangdong, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Destiny Catherine  Forsberg Inc } \\
		{\large Izabella 33}\\
		{\large 92337, Florence, Tuscany, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
