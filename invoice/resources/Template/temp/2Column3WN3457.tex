...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liam May/Mae 	 Lundberg} \\
		{\large Kendall 43}\\
		{\large 66319, Osaka, Heibei, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabelle Rose 	 Hermansson Pte Ltd } \\
		{\large London 98}\\
		{\large 51183, New York , Bangkok, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
