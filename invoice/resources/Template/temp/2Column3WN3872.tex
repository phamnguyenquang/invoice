...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Colin Grace 	 Andreasson} \\
		{\large Eric 85}\\
		{\large 27213, Barcelona, Hawaii, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cora Edward Dahlberg Inc } \\
		{\large Grant 98}\\
		{\large 73185, Frankfurt am Main , California, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
