...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Southern California} \\
		{\large Alejandro 86}\\
		{\large 53399, Istanbul, Chiang Rai, France }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Daniel Bergqvist } \\
		{\large Ximena 19}\\
		{\large 27919, Madrid, Guangdong, Philippines}\\
    \switchcolumn
