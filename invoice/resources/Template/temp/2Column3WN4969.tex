...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kinsley Elizabeth 	 Holm} \\
		{\large Emilia 32}\\
		{\large 93648, Los Angeles, Kentucky, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jameson Victoria Mattsson Ltd } \\
		{\large George 27}\\
		{\large 72628, Melbourne, Amnat Charoen, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
