...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lila Michael Jonsson Pte Ltd} \\
		{\large Mason 20}\\
		{\large 89719, Madrid, California, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aiden Sjöberg } \\
		{\large Ryker 59}\\
		{\large 89115, Frankfurt am Main , Hamburg, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
