...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle Amy  Abrahamsson Pte Ltd} \\
		{\large Katherine 94}\\
		{\large 55838, Abu Dhabi, Amnat Charoen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grayson Månsson } \\
		{\large Gael 84}\\
		{\large 55393, Frankfurt am Main , Huabei, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
