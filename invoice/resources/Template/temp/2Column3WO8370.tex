...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rylee Anne Holmgren Corp} \\
		{\large Jasmine 23}\\
		{\large 84721, Frankfurt am Main , Saarland, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Noah Lundström } \\
		{\large Alex 84}\\
		{\large 39541, Sydney, California, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
