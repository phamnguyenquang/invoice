...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leo David Berg} \\
		{\large Gavin 21}\\
		{\large 65696, Frankfurt am Main , Tuscany, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ezekiel Catherine  Andersson Ltd } \\
		{\large Chase 90}\\
		{\large 96831, London , Indiana, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
