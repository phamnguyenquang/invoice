...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Addison Victoria Sundberg Corp} \\
		{\large Vincent 51}\\
		{\large 31462, Stuttgart, Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brian Eklund } \\
		{\large Jesse 56}\\
		{\large 97535, Frankfurt am Main , Indiana, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
