...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Catherine Victoria Wikström Pte Ltd} \\
		{\large Elizabeth 23}\\
		{\large 34019, Denver, Heibei, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella Bergström } \\
		{\large Valerie 43}\\
		{\large 13987, Washington, Chiang Rai, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
