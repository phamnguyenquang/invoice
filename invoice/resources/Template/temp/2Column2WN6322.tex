...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklynn Gunnarsson} \\
		{\large Alexa 24}\\
		{\large 90301, Boston, Amnat Charoen, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ruby Victoria Karlsson Ltd } \\
		{\large Mila 1}\\
		{\large 91297, Last Vegas, Floria, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
