...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Londyn Elizabeth 	 Larsson Corp} \\
		{\large Dominic 43}\\
		{\large 94752, Melbourne, Bangkok, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elizabeth Strömberg } \\
		{\large Easton 63}\\
		{\large 72889, Washington, Saarland, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
