...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabella Elizabeth 	 Hansen} \\
		{\large Mackenzie 70}\\
		{\large 13336, Dublin, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Easton William Larsson Pte Ltd } \\
		{\large Lydia 1}\\
		{\large 39899, San Francisco, Chai Nat, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
