...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryker Michael Lundqvist} \\
		{\large Amelia 22}\\
		{\large 49180, Singapore, Seattles, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Braxton William Lindberg Inc } \\
		{\large Molly 82}\\
		{\large 69347, San Francisco, Hamburg, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
