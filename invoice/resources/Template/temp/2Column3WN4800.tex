...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maverick May/Mae 	 Sjöberg} \\
		{\large Caroline 57}\\
		{\large 79732, SaiGon, Hainan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayden Elizabeth 	 Sjögren Inc } \\
		{\large Kaiden 37}\\
		{\large 34912, Ho Chi Minh, Bangkok, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
