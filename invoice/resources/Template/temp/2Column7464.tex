...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Audrey Arvidsson Ltd} \\
		{\large Colton 6}\\
		{\large 34460, Frankfurt am Main , Bayern, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian Gustafsson } \\
		{\large Reagan 18}\\
		{\large 53659, Frankfurt am Main , Chiang Rai, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
