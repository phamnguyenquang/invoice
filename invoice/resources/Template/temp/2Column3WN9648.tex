...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalia Michael Hansen} \\
		{\large Maya 3}\\
		{\large 82525, Singapore, Chai Nat, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michael Peter Sundberg Inc } \\
		{\large Kylie 52}\\
		{\large 99365, Minsk, Amnat Charoen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
