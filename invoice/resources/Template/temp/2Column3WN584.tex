...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Justin Edward Sjögren} \\
		{\large Timothy 38}\\
		{\large 63563, Los Angeles, Guangdong, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexander Peter Mattsson Ltd } \\
		{\large Nathan 34}\\
		{\large 48728, SaiGon, Phu Yen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
