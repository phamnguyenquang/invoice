...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jude Lundström} \\
		{\large Ashton 98}\\
		{\large 80071, Budapest, Chiang Rai, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rachel Christopher Eriksson Ltd } \\
		{\large Kaiden 2}\\
		{\large 69737, Melbourne, Huabei, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
