...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ximena May/Mae 	 Mårtensson} \\
		{\large Emily 34}\\
		{\large 82493, Vancouver, Guangdong, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie David Danielsson Pte Ltd } \\
		{\large Noah 35}\\
		{\large 99471, Bonn, Ang Thong, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
