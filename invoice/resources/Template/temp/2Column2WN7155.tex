...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Benjamin Danielsson} \\
		{\large Tucker 88}\\
		{\large 83993, Vancouver, Ang Thong, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Annabelle John Axelsson Pte Ltd } \\
		{\large Ella 6}\\
		{\large 43032, Frankfurt am Main , Guangdong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
