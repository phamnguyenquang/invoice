...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sophia Martinsson} \\
		{\large Chase 77}\\
		{\large 50508, San Francisco, Ang Thong, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Blake Christopher Pålsson Ltd } \\
		{\large Hailey 84}\\
		{\large 58401, Frankfurt am Main , Buriam, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
