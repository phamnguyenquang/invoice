...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte  Alexander  Andreasson} \\
		{\large Catherine 86}\\
		{\large 59624, San Francisco, Bangkok, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juan William Gunnarsson Pte Ltd } \\
		{\large Willow 38}\\
		{\large 33819, Barcelona, Guangzhou, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
