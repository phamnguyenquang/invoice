...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kevin Victoria Hellström} \\
		{\large Mason 7}\\
		{\large 44658, Denver, Guangzhou, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liam Michael Larsson Pte Ltd } \\
		{\large Lucy 6}\\
		{\large 22816, Toronto, Seattles, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
