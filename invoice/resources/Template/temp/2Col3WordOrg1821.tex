...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hadley Rose 	 Nordström Pte Ltd} \\
		{\large Maverick 31}\\
		{\large 95935, Berlin, California, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eleanor Samuelsson } \\
		{\large Jacob 97}\\
		{\large 83300, Hong Kong, Chiang Mai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
