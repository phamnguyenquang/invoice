...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mariah Grace 	 Lundin Pte Ltd} \\
		{\large Carson 55}\\
		{\large 65767, Florence, Texas, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Steven Hedlund } \\
		{\large Wesley 57}\\
		{\large 71618, San Francisco, Chiang Rai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
