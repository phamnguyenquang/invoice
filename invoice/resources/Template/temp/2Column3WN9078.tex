...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Genesis Elizabeth 	 Mårtensson} \\
		{\large Olivia 83}\\
		{\large 33200, Dubai, Hainan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer John Andreasson Inc } \\
		{\large Makayla 91}\\
		{\large 17291, Barcelona, Phu Yen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
