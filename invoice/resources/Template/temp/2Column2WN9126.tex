...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriella Wikström} \\
		{\large Tyler 99}\\
		{\large 44939, Barcelona, Guangdong, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grant Peter Hermansson Inc } \\
		{\large Izabella 25}\\
		{\large 17733, Frankfurt am Main , Chiang Rai, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
