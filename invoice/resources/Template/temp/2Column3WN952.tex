...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amir James Åkesson} \\
		{\large Josiah 3}\\
		{\large 50728, Madrid, Bangkok, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vanessa Christopher Berggren Pte Ltd } \\
		{\large Brian 71}\\
		{\large 54156, Vienna, Chai Nat, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
