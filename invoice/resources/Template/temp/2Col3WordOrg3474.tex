...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayla Elizabeth 	 Hedlund Ltd} \\
		{\large Ezekiel 85}\\
		{\large 66530, Vienna, Bangkok, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ivy Sjöberg } \\
		{\large Ariel 46}\\
		{\large 74219, Frankfurt am Main , Seattles, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
