...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryder Hansson} \\
		{\large Summer 95}\\
		{\large 40810, San Francisco, Kentucky, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abraham James Lindqvist Pte Ltd } \\
		{\large Kennedy 16}\\
		{\large 79082, Venice, Indiana, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
