...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eric Grace 	 Nordin} \\
		{\large Aubrey 18}\\
		{\large 92755, London , Bangkok, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklynn Catherine  Martinsson Pte Ltd } \\
		{\large Reagan 7}\\
		{\large 58407, Berlin, Indiana, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
