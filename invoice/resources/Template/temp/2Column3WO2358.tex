...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mariah Mary 	 Andersson Inc} \\
		{\large Cayden 13}\\
		{\large 37904, Frankfurt am Main , Ang Thong, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large William Åkesson } \\
		{\large Autumn 24}\\
		{\large 80419, Taipei, California, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
