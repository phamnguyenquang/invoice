...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lillian Robert Söderberg Pte Ltd} \\
		{\large Andrew 39}\\
		{\large 41072, San Francisco, Hessen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Timothy Mattsson } \\
		{\large Valerie 99}\\
		{\large 25085, Last Vegas, Bremen, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
