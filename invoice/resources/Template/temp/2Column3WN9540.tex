...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Colin Lee  Lindgren} \\
		{\large Violet 61}\\
		{\large 44285, Frankfurt am Main , Ang Thong, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayce Edward Ström Pte Ltd } \\
		{\large Isabella 30}\\
		{\large 74725, Osaka, Hessen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
