...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paisley Martinsson} \\
		{\large Aubrey 22}\\
		{\large 11725, Sydney, Chai Nat, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maria Kate 	 Dahlberg Inc } \\
		{\large Jeremy 21}\\
		{\large 18729, San Francisco, Phu Yen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
