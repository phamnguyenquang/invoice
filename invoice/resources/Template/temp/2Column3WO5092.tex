...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katelyn Rose 	 Ekström Pte Ltd} \\
		{\large Axel 69}\\
		{\large 23000, Frankfurt am Main , Kentucky, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large James Abrahamsson } \\
		{\large Mckenzie 3}\\
		{\large 31122, Ho Chi Minh, Amnat Charoen, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
