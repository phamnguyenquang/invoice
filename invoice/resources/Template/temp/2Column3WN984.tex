...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexis Elizabeth 	 Fredriksson} \\
		{\large Nevaeh 46}\\
		{\large 82101, Paris, California, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large London Louise 	 Ali Inc } \\
		{\large Mary 74}\\
		{\large 18131, Venice, Guangdong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
