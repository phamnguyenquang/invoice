...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ximena Amy  Berggren} \\
		{\large Angel 45}\\
		{\large 16466, Hanoi, Chiang Rai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Margaret Robert Fredriksson Pte Ltd } \\
		{\large Willow 59}\\
		{\large 12202, London , Tuscany, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
