...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Capital Medical University} \\
		{\large Ryker 50}\\
		{\large 14509, Frankfurt am Main , Guangzhou, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Levi Berglund } \\
		{\large Jace 35}\\
		{\large 77584, Ho Chi Minh, Binh Thuan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
