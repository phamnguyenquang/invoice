...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maddox Anne Holmgren} \\
		{\large Lauren 51}\\
		{\large 46342, Nha Trang, Chiang Rai, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Delilah Thomas Pålsson Pte Ltd } \\
		{\large Easton 54}\\
		{\large 36803, Beijing, Guangzhou, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
