...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lucas Holmgren} \\
		{\large Eric 31}\\
		{\large 61965, Los Angeles, Kentucky, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklynn Ann  Gustafsson Pte Ltd } \\
		{\large Valeria 13}\\
		{\large 15543, Washington, Chiang Mai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
