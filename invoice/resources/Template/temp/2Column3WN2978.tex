...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Willow Catherine  Hermansson} \\
		{\large Brianna 14}\\
		{\large 42210, Shanghai, Bayern, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sadie  Alexander  Eliasson Corp } \\
		{\large Anthony 87}\\
		{\large 80936, Melbourne, khanh Hoa, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
