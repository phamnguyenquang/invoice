...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Santiago Louise 	 Ahmed} \\
		{\large Connor 19}\\
		{\large 88745, Barcelona, Hamburg, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charles Edward Olofsson Inc } \\
		{\large Ivy 31}\\
		{\large 73679, Frankfurt am Main , Heibei, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
