...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayce Ann  Nyström} \\
		{\large Audrey 18}\\
		{\large 82635, Dublin, Ang Thong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Peyton Catherine  Hermansson Inc } \\
		{\large Eliza 55}\\
		{\large 55612, San Francisco, Guangdong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
