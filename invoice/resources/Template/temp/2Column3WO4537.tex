...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariana Elizabeth 	 Gunnarsson Inc} \\
		{\large Oscar 96}\\
		{\large 66818, New York , Floria, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rose Bengtsson } \\
		{\large Samuel 79}\\
		{\large 39123, Amsterdam, Chiang Mai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
