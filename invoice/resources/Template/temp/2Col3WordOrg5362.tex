...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie James Pettersson Corp} \\
		{\large Michael 46}\\
		{\large 55161, Frankfurt am Main , Saarland, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large David Eklund } \\
		{\large Maximus 23}\\
		{\large 34343, Istanbul, Huabei, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
