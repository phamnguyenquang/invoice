...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rachel Elizabeth 	 Nordström Ltd} \\
		{\large Wesley 20}\\
		{\large 43749, Hanoi, Bangkok, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryan Danielsson } \\
		{\large Khloe 30}\\
		{\large 73685, Frankfurt am Main , Bayern, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
