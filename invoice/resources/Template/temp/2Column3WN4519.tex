...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Chase Louise 	 Jansson} \\
		{\large Ruby 43}\\
		{\large 23509, Singapore, Amnat Charoen, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everett Grace 	 Claesson Ltd } \\
		{\large Maverick 79}\\
		{\large 49087, Berlin, Guangdong, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
