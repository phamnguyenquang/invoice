...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Humboldt University of Berlin} \\
		{\large Christopher 91}\\
		{\large 60072, Dubai, Saarland, United State }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Timothy Pettersson } \\
		{\large Luna 63}\\
		{\large 35595, Chicago, Ang Thong, United State }\\
    \switchcolumn
