...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalia Rose 	 Sundberg} \\
		{\large Jaxson 5}\\
		{\large 13156, Frankfurt am Main , Saarland, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Weston Grace 	 Lundin Ltd } \\
		{\large Jayden 63}\\
		{\large 76197, Singapore, Kentucky, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
