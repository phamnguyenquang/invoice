...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Levi Mary 	 Lundqvist} \\
		{\large Isaac 75}\\
		{\large 87900, Osaka, Bremen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eden  Alexander  Gunnarsson Corp } \\
		{\large Lincoln 84}\\
		{\large 71055, Last Vegas, Chiang Rai, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
