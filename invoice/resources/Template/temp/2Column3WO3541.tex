...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harmony Elizabeth 	 Danielsson Inc} \\
		{\large Aria 37}\\
		{\large 34838, Rome, khanh Hoa, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaitlyn Danielsson } \\
		{\large Destiny 67}\\
		{\large 36298, Frankfurt am Main , Indiana, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
