...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Wesley Bergqvist} \\
		{\large Bradley 50}\\
		{\large 39867, Nha Trang, Guangdong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Taylor Marie 	 Lundqvist Corp } \\
		{\large Miguel 54}\\
		{\large 30176, Frankfurt am Main , Phu Yen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
