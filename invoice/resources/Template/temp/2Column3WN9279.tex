...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina Michael Wallin} \\
		{\large Paul 31}\\
		{\large 78944, Frankfurt am Main , Henan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mateo May/Mae 	 Holmgren Ltd } \\
		{\large Jace 63}\\
		{\large 76516, New York , Hainan, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
