...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stephanie Elizabeth 	 Berg Pte Ltd} \\
		{\large Aidan 75}\\
		{\large 18202, Florence, Saarland, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large David Lundgren } \\
		{\large Ruby 55}\\
		{\large 12784, Frankfurt am Main , Hessen, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
