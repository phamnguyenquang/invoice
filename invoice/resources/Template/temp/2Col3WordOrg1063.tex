...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Annabelle Amy  Lindholm Ltd} \\
		{\large Diego 57}\\
		{\large 87878, Boston, Chai Nat, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexandra Norberg } \\
		{\large Aliyah 23}\\
		{\large 53343, Frankfurt am Main , Guangzhou, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
