...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Malachi Rose 	 Sundberg} \\
		{\large Evelyn 23}\\
		{\large 74283, Amsterdam, Chiang Mai, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Damian May/Mae 	 Blomqvist Pte Ltd } \\
		{\large Abigail 26}\\
		{\large 92897, Melbourne, Kentucky, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
