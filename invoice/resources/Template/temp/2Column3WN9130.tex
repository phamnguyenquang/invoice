...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michael Louise 	 Hermansson} \\
		{\large Lilly 29}\\
		{\large 25302, Washington, khanh Hoa, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large King William Abrahamsson Pte Ltd } \\
		{\large Mckenzie 10}\\
		{\large 95118, Tokyo, Seattles, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
