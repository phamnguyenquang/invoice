...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Taipei Medical University} \\
		{\large Paul 41}\\
		{\large 17955, Vancouver, Bangkok, Australia }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Christopher Pettersson } \\
		{\large Graham 42}\\
		{\large 71586, Chicago, Chiang Mai, United State }\\
    \switchcolumn
