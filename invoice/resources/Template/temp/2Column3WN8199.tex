...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Savannah Jane Pettersson} \\
		{\large Alexandra 22}\\
		{\large 85763, Last Vegas, Seattles, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paige Anne Martinsson Ltd } \\
		{\large Adam 41}\\
		{\large 56097, Osaka, Binh Thuan, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
