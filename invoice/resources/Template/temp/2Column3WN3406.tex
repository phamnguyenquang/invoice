...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harper Elizabeth 	 Jansson} \\
		{\large Diego 98}\\
		{\large 90116, Washington, Saarland, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Allison Victoria Svensson Corp } \\
		{\large Ashton 7}\\
		{\large 39149, Osaka, Amnat Charoen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
