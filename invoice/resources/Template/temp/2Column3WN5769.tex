...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jacob William Blom} \\
		{\large Benjamin 87}\\
		{\large 96093, Tokyo, Chiang Rai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Richard Catherine  Engström Pte Ltd } \\
		{\large Maximus 57}\\
		{\large 17041, Last Vegas, Hamburg, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
