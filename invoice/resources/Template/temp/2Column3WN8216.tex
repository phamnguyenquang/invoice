...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Molly Peter Lundgren} \\
		{\large Hannah 20}\\
		{\large 35900, Washington, Texas, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zachary Louise 	 Abrahamsson Ltd } \\
		{\large Charles 94}\\
		{\large 67333, Stuttgart, Bayern, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
