...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aurora Fredriksson} \\
		{\large Ruby 73}\\
		{\large 59087, Ho Chi Minh, Chai Nat, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vivian Mary 	 Andersson Pte Ltd } \\
		{\large Oscar 1}\\
		{\large 93458, Hong Kong, Seattles, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
