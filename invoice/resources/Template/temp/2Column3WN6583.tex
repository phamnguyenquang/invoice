...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Camila Catherine  Lindqvist} \\
		{\large Bella 14}\\
		{\large 98531, Chicago, Bayern, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anna William Claesson Pte Ltd } \\
		{\large Elena 87}\\
		{\large 60284, SaiGon, Buriam, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
