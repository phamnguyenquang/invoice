...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tristan Bergqvist} \\
		{\large Liliana 57}\\
		{\large 68399, Venice, Chiang Rai, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexis May/Mae 	 Sjöberg Pte Ltd } \\
		{\large King 47}\\
		{\large 63623, San Francisco, Hessen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
