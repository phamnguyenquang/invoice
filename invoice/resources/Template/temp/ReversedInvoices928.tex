...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Braunschweig University of Technology} \\
		{\large Alan 78}\\
		{\large 68820, Last Vegas, Floria, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alejandro Danielsson } \\
		{\large Sophie 81}\\
		{\large 78990, Florence, Hainan, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
