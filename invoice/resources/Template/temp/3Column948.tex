...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Massachusetts Medical School} \\
		{\large Greyson 20}\\
		{\large 57243, Moscow, Indiana, Australia }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Aiden Forsberg } \\
		{\large Lilly 67}\\
		{\large 66676, Toronto, Guangzhou, Cambodia}\\
    \switchcolumn
