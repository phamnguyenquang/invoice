...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Wesley Engström Inc} \\
		{\large Axel 88}\\
		{\large 21611, Frankfurt am Main , California, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariana Dahlberg } \\
		{\large Clara 82}\\
		{\large 58362, New York , Chai Nat, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
