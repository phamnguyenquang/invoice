...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katherine Rose 	 Henriksson} \\
		{\large Ryan 5}\\
		{\large 99537, San Francisco, Huabei, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lyla Mary 	 Wallin Pte Ltd } \\
		{\large Dylan 62}\\
		{\large 66436, Osaka, Buriam, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
