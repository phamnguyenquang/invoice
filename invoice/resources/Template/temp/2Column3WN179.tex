...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cora Ann  Nyberg} \\
		{\large David 19}\\
		{\large 14139, London , Binh Thuan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Henry Catherine  Holmberg Pte Ltd } \\
		{\large Hudson 60}\\
		{\large 40080, Hanoi, Kentucky, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
