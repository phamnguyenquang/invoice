...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brielle Louise 	 Gunnarsson} \\
		{\large Grace 3}\\
		{\large 48077, Moscow, Hawaii, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden Anne Engström Inc } \\
		{\large Parker 2}\\
		{\large 75811, Frankfurt am Main , Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
