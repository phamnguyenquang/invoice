...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra Anne Lindberg} \\
		{\large Scarlett 61}\\
		{\large 49413, New York , California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nevaeh Mary 	 Norberg Inc } \\
		{\large Alice 10}\\
		{\large 79699, Frankfurt am Main , Tuscany, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
