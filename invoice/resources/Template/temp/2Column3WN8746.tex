...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Evan Amy  Hermansson} \\
		{\large Daniel 67}\\
		{\large 96540, Istanbul, Indiana, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Piper William Andreasson Pte Ltd } \\
		{\large Alice 87}\\
		{\large 99116, Moscow, Buriam, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
