...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emma Edward Claesson} \\
		{\large Bentley 76}\\
		{\large 68801, Washington, Chai Nat, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liliana May/Mae 	 Andersson Corp } \\
		{\large Kaleb 90}\\
		{\large 95183, Dublin, Floria, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
