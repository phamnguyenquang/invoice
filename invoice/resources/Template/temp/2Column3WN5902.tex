...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Morgan Christopher Martinsson} \\
		{\large Miles 8}\\
		{\large 30996, Barcelona, Buriam, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lillian Mary 	 Sjöberg Pte Ltd } \\
		{\large Maverick 88}\\
		{\large 95869, Istanbul, Ang Thong, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
