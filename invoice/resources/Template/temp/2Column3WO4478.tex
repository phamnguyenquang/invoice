...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Declan William Nilsson Pte Ltd} \\
		{\large Kaleb 72}\\
		{\large 87211, Singapore, Buriam, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mckenzie Hermansson } \\
		{\large Michelle 51}\\
		{\large 22553, London , Tuscany, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
