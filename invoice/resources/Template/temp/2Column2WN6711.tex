...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  William Samuelsson} \\
		{\large Paige 19}\\
		{\large 42962, Toronto, Guangzhou, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabelle Christopher Lundin Corp } \\
		{\large Jasmine 46}\\
		{\large 34085, San Francisco, Guangzhou, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
