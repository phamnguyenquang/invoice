...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jennifer  Alexander  Mårtensson} \\
		{\large Serenity 49}\\
		{\large 85903, Rome, Ang Thong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Richard Kate 	 Larsson Corp } \\
		{\large Lila 41}\\
		{\large 44075, Last Vegas, Phu Yen, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
