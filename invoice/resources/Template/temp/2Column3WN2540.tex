...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Violet David Samuelsson} \\
		{\large Amy 14}\\
		{\large 56621, Florence, Texas, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eli Elizabeth 	 Lindström Corp } \\
		{\large Jayden 54}\\
		{\large 31588, San Francisco, Henan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
