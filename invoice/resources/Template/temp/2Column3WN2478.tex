...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Marcus Anne Blomqvist} \\
		{\large Eric 31}\\
		{\large 76375, Last Vegas, Hainan, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valeria Kate 	 Abrahamsson Pte Ltd } \\
		{\large Izabella 2}\\
		{\large 39934, Abu Dhabi, Hamburg, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
