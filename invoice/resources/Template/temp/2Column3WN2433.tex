...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julianna Thomas Henriksson} \\
		{\large Anna 13}\\
		{\large 67469, Paris, Saarland, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harrison  Alexander  Eliasson Ltd } \\
		{\large Caroline 54}\\
		{\large 64030, Vienna, Kentucky, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
