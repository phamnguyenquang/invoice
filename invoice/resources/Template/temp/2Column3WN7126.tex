...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian James Håkansson} \\
		{\large Brandon 85}\\
		{\large 13523, Lisbon, Huabei, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aria Kate 	 Magnusson Ltd } \\
		{\large Abel 74}\\
		{\large 71924, Chicago, Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
