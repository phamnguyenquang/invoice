...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hadley Thomas Månsson} \\
		{\large Jaxon 43}\\
		{\large 29452, San Francisco, Chai Nat, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ivan Louise 	 Jönsson Inc } \\
		{\large Eleanor 17}\\
		{\large 24811, Toronto, Chiang Rai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
