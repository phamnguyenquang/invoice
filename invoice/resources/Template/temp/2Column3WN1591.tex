...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonah Elizabeth 	 Andersson} \\
		{\large Valerie 43}\\
		{\large 28905, Frankfurt am Main , Bremen, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hailey James Håkansson Inc } \\
		{\large Nicolas 85}\\
		{\large 41438, Nha Trang, Seattles, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
