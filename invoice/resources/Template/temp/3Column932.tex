...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Jawaharlal Nehru Centre for Advanced Scientific Research} \\
		{\large Nicolas 59}\\
		{\large 76053, Stuttgart, Kentucky, Ireland}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Hudson Mattsson } \\
		{\large Xavier 90}\\
		{\large 28441, Barcelona, Texas, Canada }\\
    \switchcolumn
