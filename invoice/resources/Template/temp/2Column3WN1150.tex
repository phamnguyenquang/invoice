...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gavin Marie 	 Pålsson} \\
		{\large Audrey 35}\\
		{\large 65543, Toronto, Guangzhou, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harrison Victoria Sandberg Inc } \\
		{\large Oscar 76}\\
		{\large 26215, Vancouver, Guangzhou, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
