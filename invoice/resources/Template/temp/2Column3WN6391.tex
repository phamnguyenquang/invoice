...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Annabelle Elizabeth 	 Håkansson} \\
		{\large Kaiden 72}\\
		{\large 14017, Florence, Phu Yen, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sophie  Alexander  Norberg Pte Ltd } \\
		{\large Noah 41}\\
		{\large 93917, Istanbul, Heibei, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
