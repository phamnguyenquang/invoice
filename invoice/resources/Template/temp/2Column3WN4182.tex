...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooke Amy  Lindström} \\
		{\large Amy 65}\\
		{\large 52368, Dublin, Bremen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kingston Catherine  Andreasson Corp } \\
		{\large Carter 33}\\
		{\large 13435, Istanbul, Seattles, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
