...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Delilah Amy  Björklund} \\
		{\large Brianna 78}\\
		{\large 42875, Stuttgart, California, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harmony William Abrahamsson Corp } \\
		{\large Cameron 36}\\
		{\large 11995, Melbourne, Hessen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
