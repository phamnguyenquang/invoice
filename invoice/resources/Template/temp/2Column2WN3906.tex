...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexis Hermansson} \\
		{\large Ashton 3}\\
		{\large 35382, Toronto, Seattles, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julianna Thomas Mårtensson Ltd } \\
		{\large Jayla 33}\\
		{\large 61069, Montreal, Amnat Charoen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
