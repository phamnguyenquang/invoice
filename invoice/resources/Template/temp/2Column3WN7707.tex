...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Molly Louise 	 Olofsson} \\
		{\large Ivy 67}\\
		{\large 88948, Singapore, Ang Thong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Xavier Louise 	 Viklund Corp } \\
		{\large Mckenzie 21}\\
		{\large 17333, Tokyo, Phu Yen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
