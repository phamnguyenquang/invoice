...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grace William Fransson} \\
		{\large Owen 4}\\
		{\large 44656, Frankfurt am Main , Hamburg, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Grace 	 Olofsson Corp } \\
		{\large Jesus 77}\\
		{\large 40866, SaiGon, Hainan, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
