...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bella Louise 	 Holmberg} \\
		{\large Ryleigh 26}\\
		{\large 86351, Frankfurt am Main , Phu Yen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Genesis Marie 	 Andersson Pte Ltd } \\
		{\large Brantley 7}\\
		{\large 12122, Last Vegas, Ang Thong, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
