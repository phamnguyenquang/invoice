...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Malachi Bengtsson} \\
		{\large Julian 58}\\
		{\large 40806, New York , Phu Yen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ashton Christopher Martinsson Ltd } \\
		{\large Henry 62}\\
		{\large 59814, Hong Kong, Floria, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
