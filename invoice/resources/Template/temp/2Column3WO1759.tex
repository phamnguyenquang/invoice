...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ella Mary 	 Danielsson Inc} \\
		{\large Steven 13}\\
		{\large 59511, Frankfurt am Main , Chai Nat, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie Lindholm } \\
		{\large Isaac 55}\\
		{\large 88881, Hanoi, Huabei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
