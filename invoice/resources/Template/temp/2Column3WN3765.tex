...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope Catherine  Jansson} \\
		{\large Ezra 23}\\
		{\large 21781, Denver, Bremen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Weston Victoria Eliasson Ltd } \\
		{\large Kingston 47}\\
		{\large 43298, Ho Chi Minh, Bayern, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
