...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Natural Resources and Life Sciences, Vienna} \\
		{\large Sarah 47}\\
		{\large 78436, Madrid, Indiana, United Kingdom}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Kaden Månsson } \\
		{\large Jonah 78}\\
		{\large 32613, Boston, Chai Nat, South Africa }\\
    \switchcolumn
