...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniela Edward Martinsson Corp} \\
		{\large Sarah 91}\\
		{\large 82244, Amsterdam, California, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stella Jönsson } \\
		{\large Lincoln 61}\\
		{\large 20504, Florence, Guangzhou, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
