...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaliyah May/Mae 	 Danielsson} \\
		{\large Skylar 70}\\
		{\large 49855, Berlin, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubree Lee  Olofsson Corp } \\
		{\large Reese 10}\\
		{\large 85444, Frankfurt am Main , Tuscany, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
