...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaylee Lund} \\
		{\large Amy 38}\\
		{\large 63917, Frankfurt am Main , Chai Nat, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tucker Kate 	 Andersson Inc } \\
		{\large Max 31}\\
		{\large 95930, Frankfurt am Main , California, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
