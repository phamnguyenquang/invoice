...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesus Jakobsson} \\
		{\large King 12}\\
		{\large 82190, Los Angeles, khanh Hoa, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Trinity  Alexander  Pettersson Inc } \\
		{\large Greyson 11}\\
		{\large 96955, Abu Dhabi, Chai Nat, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
