...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  John Amy  Åkesson} \\
		{\large Bradley 54}\\
		{\large 93919, Chicago, Saarland, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abraham Catherine  Andreasson Pte Ltd } \\
		{\large London 81}\\
		{\large 49551, Beijing, Tuscany, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
