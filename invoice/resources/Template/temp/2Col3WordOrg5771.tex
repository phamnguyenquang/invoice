...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katherine May/Mae 	 Wikström Ltd} \\
		{\large Andrea 28}\\
		{\large 36861, Munich, Kentucky, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kingston Nyberg } \\
		{\large Max 96}\\
		{\large 31570, Frankfurt am Main , khanh Hoa, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
