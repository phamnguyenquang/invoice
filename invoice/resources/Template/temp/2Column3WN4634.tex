...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariel David Nordin} \\
		{\large Josephine 21}\\
		{\large 38015, Frankfurt am Main , Bremen, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Braxton Elizabeth 	 Lundgren Pte Ltd } \\
		{\large Ryleigh 79}\\
		{\large 69801, Madrid, Amnat Charoen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
