...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leonardo Anne Nordström} \\
		{\large Noah 45}\\
		{\large 18764, Stuttgart, Seattles, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brian Rose 	 Martinsson Corp } \\
		{\large Lily 43}\\
		{\large 81696, Vancouver, Kentucky, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
