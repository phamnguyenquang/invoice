...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brayden  Alexander  Bengtsson Inc} \\
		{\large Brooklynn 85}\\
		{\large 40446, SaiGon, Hessen, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Abrahamsson } \\
		{\large Makayla 36}\\
		{\large 90287, San Francisco, Texas, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
