...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maria Christopher Danielsson} \\
		{\large Jacob 89}\\
		{\large 46311, Nha Trang, Amnat Charoen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luke Edward Andreasson Inc } \\
		{\large Isabel 88}\\
		{\large 26234, Washington, Huabei, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
