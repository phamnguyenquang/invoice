...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalyn Jakobsson} \\
		{\large Emily 27}\\
		{\large 42798, Moscow, Hessen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Victor Elizabeth 	 Isaksson Pte Ltd } \\
		{\large Stella 68}\\
		{\large 16736, San Francisco, Hessen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
