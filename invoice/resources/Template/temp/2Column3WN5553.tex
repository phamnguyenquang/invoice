...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angel Thomas Olsson} \\
		{\large Bryce 93}\\
		{\large 19753, Singapore, Saarland, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Naomi Jane Lindgren Ltd } \\
		{\large Ivy 35}\\
		{\large 48107, Frankfurt am Main , Texas, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
