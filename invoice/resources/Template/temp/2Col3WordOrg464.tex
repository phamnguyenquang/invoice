...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jessica Christopher Gustafsson Pte Ltd} \\
		{\large Tristan 98}\\
		{\large 68828, Milan, Guangdong, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valentina Lund } \\
		{\large Olivia 66}\\
		{\large 28482, San Francisco, Tuscany, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
