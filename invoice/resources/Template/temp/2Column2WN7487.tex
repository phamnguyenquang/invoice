...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Calvin Bergqvist} \\
		{\large Charlotte 84}\\
		{\large 99357, Frankfurt am Main , Texas, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ashley James Gunnarsson Pte Ltd } \\
		{\large Jordan 19}\\
		{\large 94466, Venice, Chiang Mai, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
