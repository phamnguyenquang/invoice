...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayla David Holmberg} \\
		{\large Zoe 38}\\
		{\large 66963, Minsk, Amnat Charoen, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ximena Louise 	 Fredriksson Corp } \\
		{\large Carlos 62}\\
		{\large 39926, Berlin, Guangdong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
