...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Anthony Amy  Söderberg} \\
		{\large Eric 8}\\
		{\large 28693, Berlin, Saarland, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Serenity Victoria Fredriksson Pte Ltd } \\
		{\large Colin 73}\\
		{\large 52974, Beijing, Bremen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
