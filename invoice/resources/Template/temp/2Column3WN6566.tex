...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Skylar Jane Strömberg} \\
		{\large Luca 40}\\
		{\large 74869, Last Vegas, Hainan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Robert May/Mae 	 Sjöberg Ltd } \\
		{\large Kinsley 35}\\
		{\large 95160, Tokyo, Amnat Charoen, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
