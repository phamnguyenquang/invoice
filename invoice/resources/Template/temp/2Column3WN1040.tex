...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle Kate 	 Eriksson} \\
		{\large Anna 28}\\
		{\large 73048, Chicago, khanh Hoa, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaliyah Rose 	 Henriksson Corp } \\
		{\large Steven 58}\\
		{\large 15302, Last Vegas, Buriam, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
