...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mariah Amy  Sjögren Pte Ltd} \\
		{\large Sebastian 62}\\
		{\large 24447, Stuttgart, California, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ezekiel Andreasson } \\
		{\large Gael 27}\\
		{\large 68213, Florence, Guangzhou, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
