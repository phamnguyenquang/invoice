...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina David Eklund Corp} \\
		{\large Asher 36}\\
		{\large 64372, Frankfurt am Main , Hawaii, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bradley Danielsson } \\
		{\large Jameson 41}\\
		{\large 85207, Amsterdam, Hessen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
