...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Weston Mattsson} \\
		{\large Jonah 80}\\
		{\large 14046, Stuttgart, Chiang Mai, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Greyson John Sjöberg Pte Ltd } \\
		{\large Kimberly 36}\\
		{\large 17381, Frankfurt am Main , Hainan, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
