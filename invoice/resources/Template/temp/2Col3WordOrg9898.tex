...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cameron Anne Jakobsson Pte Ltd} \\
		{\large Brianna 88}\\
		{\large 62799, Frankfurt am Main , Chai Nat, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grant Bergman } \\
		{\large Asher 82}\\
		{\large 80105, SaiGon, Chiang Rai, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
