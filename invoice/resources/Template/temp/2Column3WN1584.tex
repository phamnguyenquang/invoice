...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bradley Edward Engström} \\
		{\large Mason 20}\\
		{\large 68399, Los Angeles, Bremen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ian Anne Blomqvist Pte Ltd } \\
		{\large Gavin 17}\\
		{\large 38574, Beijing, Chiang Rai, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
