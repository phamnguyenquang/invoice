...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Greyson Marie 	 Pettersson} \\
		{\large Violet 35}\\
		{\large 86029, Last Vegas, Hainan, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josephine Louise 	 Nyberg Corp } \\
		{\large Sebastian 7}\\
		{\large 39533, Abu Dhabi, Bremen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
