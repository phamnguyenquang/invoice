...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrew Elizabeth 	 Andreasson} \\
		{\large London 44}\\
		{\large 58789, Florence, khanh Hoa, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anthony Amy  Gustafsson Ltd } \\
		{\large Rachel 90}\\
		{\large 62574, SaiGon, Hainan, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
