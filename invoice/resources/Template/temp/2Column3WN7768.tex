...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sarah  Alexander  Nilsson} \\
		{\large Jesse 48}\\
		{\large 43919, Singapore, Chai Nat, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isla Robert Eklund Pte Ltd } \\
		{\large Leilani 99}\\
		{\large 65912, Frankfurt am Main , Heibei, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
