...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  King Mary 	 Öberg} \\
		{\large Brandon 97}\\
		{\large 67694, Ho Chi Minh, Hawaii, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elizabeth Thomas Bergström Pte Ltd } \\
		{\large Christopher 22}\\
		{\large 94769, Amsterdam, Guangzhou, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
