...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Hong Kong University of Science and Technology	Hong} \\
		{\large Charlotte 95}\\
		{\large 47091, Moscow, Ang Thong, Saudi Arabia }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Ella Eliasson } \\
		{\large Ava 4}\\
		{\large 39956, Montreal, Guangdong, Saudi Arabia }\\
    \switchcolumn
