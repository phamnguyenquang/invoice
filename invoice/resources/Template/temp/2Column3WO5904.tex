...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jackson Elizabeth 	 Abrahamsson Ltd} \\
		{\large Santiago 16}\\
		{\large 71339, Hong Kong, Indiana, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Asher Arvidsson } \\
		{\large Willow 76}\\
		{\large 78763, Nha Trang, Hessen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
