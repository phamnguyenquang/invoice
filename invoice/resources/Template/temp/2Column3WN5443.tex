...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kingston Edward Blomqvist} \\
		{\large Riley 70}\\
		{\large 76742, Osaka, Bayern, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy Victoria Axelsson Corp } \\
		{\large Braxton 55}\\
		{\large 25242, Los Angeles, khanh Hoa, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
