...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ashley William Ekström} \\
		{\large Faith 91}\\
		{\large 36803, Melbourne, Hawaii, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paul Christopher Falk Pte Ltd } \\
		{\large Robert 51}\\
		{\large 48146, Milan, California, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
