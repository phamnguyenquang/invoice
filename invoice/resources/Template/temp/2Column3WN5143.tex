...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melanie Lee  Fredriksson} \\
		{\large Ezekiel 7}\\
		{\large 46195, Frankfurt am Main , Hessen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samuel John Strömberg Pte Ltd } \\
		{\large Ryan 28}\\
		{\large 69785, Tokyo, Texas, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
