...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stella Isaksson} \\
		{\large Liam 37}\\
		{\large 51072, Washington, Seattles, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Colton Edward Lindholm Ltd } \\
		{\large Parker 14}\\
		{\large 33871, Stuttgart, Binh Thuan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
