...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Blake Edward Nilsson Pte Ltd} \\
		{\large Daniel 41}\\
		{\large 25769, Vancouver, California, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Summer Lindgren } \\
		{\large Ethan 96}\\
		{\large 97605, Frankfurt am Main , Seattles, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
