...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesse John Nordin Corp} \\
		{\large Grayson 63}\\
		{\large 36555, Frankfurt am Main , Guangdong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Autumn Lindqvist } \\
		{\large Paisley 74}\\
		{\large 52954, Hong Kong, Ang Thong, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
