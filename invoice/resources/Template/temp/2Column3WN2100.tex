...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniela  Alexander  Ström} \\
		{\large Genesis 42}\\
		{\large 75959, Shanghai, Binh Thuan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evan David Karlsson Pte Ltd } \\
		{\large Ivy 72}\\
		{\large 84225, Sydney, Hessen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
