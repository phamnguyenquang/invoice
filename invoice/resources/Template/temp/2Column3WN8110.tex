...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leonardo May/Mae 	 Håkansson} \\
		{\large Jason 48}\\
		{\large 16921, London , Hamburg, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Louise 	 Wallin Pte Ltd } \\
		{\large Easton 2}\\
		{\large 12179, Berlin, Ang Thong, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
