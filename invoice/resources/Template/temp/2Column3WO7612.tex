...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paisley Michael Nyström Ltd} \\
		{\large Abraham 70}\\
		{\large 35361, San Francisco, Chiang Mai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vincent Claesson } \\
		{\large Brayden 16}\\
		{\large 40917, San Francisco, Hawaii, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
