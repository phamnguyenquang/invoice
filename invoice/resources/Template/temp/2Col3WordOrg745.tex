...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Camden Elizabeth 	 Wikström Ltd} \\
		{\large Ella 13}\\
		{\large 82640, San Francisco, Chai Nat, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn Hermansson } \\
		{\large Ryker 46}\\
		{\large 35241, Sydney, California, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
