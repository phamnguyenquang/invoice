...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Skylar Michael Abrahamsson} \\
		{\large Alejandro 87}\\
		{\large 49816, Toronto, Tuscany, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alan William Andersson Inc } \\
		{\large Edward 19}\\
		{\large 64500, New York , Amnat Charoen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
