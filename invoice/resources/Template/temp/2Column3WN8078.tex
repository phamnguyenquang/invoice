...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valerie Lee  Lind} \\
		{\large Ayden 3}\\
		{\large 27420, Frankfurt am Main , Chiang Mai, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryson John Lindgren Pte Ltd } \\
		{\large Greyson 83}\\
		{\large 94520, Hong Kong, Bremen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
