...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ivy Ann  Wikström} \\
		{\large Stella 87}\\
		{\large 75451, Frankfurt am Main , Tuscany, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jade Michael Olofsson Corp } \\
		{\large Lydia 11}\\
		{\large 51306, Frankfurt am Main , Bangkok, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
