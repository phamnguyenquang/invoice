...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Destiny Ann  Wikström} \\
		{\large Olivia 76}\\
		{\large 22151, Madrid, Hessen, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jameson Louise 	 Arvidsson Pte Ltd } \\
		{\large Charlotte 27}\\
		{\large 37918, Frankfurt am Main , Phu Yen, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
