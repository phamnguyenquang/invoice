...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kylie Louise 	 Samuelsson} \\
		{\large Colton 55}\\
		{\large 85146, Vancouver, Hawaii, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan Christopher Pettersson Corp } \\
		{\large Oliver 29}\\
		{\large 42911, Abu Dhabi, Hessen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
