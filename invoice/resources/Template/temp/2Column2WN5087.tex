...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrew Dahlberg} \\
		{\large Brayden 59}\\
		{\large 78523, Frankfurt am Main , Bangkok, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zoey Edward Samuelsson Inc } \\
		{\large Skylar 39}\\
		{\large 53455, Barcelona, Amnat Charoen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
