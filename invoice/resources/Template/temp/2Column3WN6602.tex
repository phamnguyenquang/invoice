...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cameron Elizabeth 	 Lundberg} \\
		{\large Maxwell 88}\\
		{\large 31219, Toronto, Henan, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Mary 	 Eriksson Pte Ltd } \\
		{\large Theodore 12}\\
		{\large 46293, Stuttgart, Guangdong, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
