...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joshua James Håkansson} \\
		{\large Thomas 82}\\
		{\large 19163, Hanoi, Hawaii, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Landon Victoria Abrahamsson Corp } \\
		{\large Carson 14}\\
		{\large 86070, Toronto, khanh Hoa, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
