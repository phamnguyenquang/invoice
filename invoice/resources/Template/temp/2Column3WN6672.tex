...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariel Louise 	 Eriksson} \\
		{\large Maxwell 22}\\
		{\large 65775, Venice, Indiana, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Destiny Marie 	 Lindqvist Corp } \\
		{\large Juan 81}\\
		{\large 90737, Budapest, Bremen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
