...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juliana Anne Mattsson} \\
		{\large Michelle 16}\\
		{\large 91323, Frankfurt am Main , Chiang Rai, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucy May/Mae 	 Andersson Ltd } \\
		{\large Lydia 97}\\
		{\large 42062, Dublin, Texas, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
