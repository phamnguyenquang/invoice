...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eliza May/Mae 	 Nordström} \\
		{\large Hannah 25}\\
		{\large 36907, Los Angeles, Guangdong, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daisy Peter Olofsson Inc } \\
		{\large Eva 81}\\
		{\large 71689, Dublin, Huabei, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
