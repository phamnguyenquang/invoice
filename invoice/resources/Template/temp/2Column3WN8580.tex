...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline May/Mae 	 Hedlund} \\
		{\large Gabriella 50}\\
		{\large 55922, Bonn, Buriam, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harrison Christopher Norberg Inc } \\
		{\large Madelyn 19}\\
		{\large 13572, Frankfurt am Main , Hessen, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
