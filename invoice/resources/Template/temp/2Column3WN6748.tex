...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline Victoria Pålsson} \\
		{\large Morgan 26}\\
		{\large 33887, San Francisco, California, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anna Thomas Arvidsson Inc } \\
		{\large Stephanie 73}\\
		{\large 21456, Chicago, Bangkok, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
