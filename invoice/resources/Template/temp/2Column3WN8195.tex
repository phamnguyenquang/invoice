...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aubree Peter Berggren} \\
		{\large Colton 86}\\
		{\large 16195, San Francisco, khanh Hoa, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie Catherine  Mattsson Inc } \\
		{\large Jonathan 17}\\
		{\large 59381, Bonn, Chiang Rai, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
