...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Peyton Rose 	 Lundqvist} \\
		{\large Juan 32}\\
		{\large 85980, Madrid, khanh Hoa, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mckenzie William Sandström Ltd } \\
		{\large Kayden 66}\\
		{\large 59151, Amsterdam, Hainan, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
