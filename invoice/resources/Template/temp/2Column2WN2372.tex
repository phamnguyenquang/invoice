...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brielle Åkesson} \\
		{\large Isaac 16}\\
		{\large 27072, Frankfurt am Main , Hainan, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Oliver Edward Wikström Pte Ltd } \\
		{\large Alan 50}\\
		{\large 61640, Florence, Bayern, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
