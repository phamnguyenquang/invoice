...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Christopher Eliasson} \\
		{\large Ximena 62}\\
		{\large 87469, Vancouver, Hessen, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sophie Ann  Lundgren Inc } \\
		{\large Luis 85}\\
		{\large 69797, Dubai, Chai Nat, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
