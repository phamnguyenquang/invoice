...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria  Alexander  Eliasson Ltd} \\
		{\large Jude 12}\\
		{\large 87465, Osaka, Indiana, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tyler Lindberg } \\
		{\large Aubree 39}\\
		{\large 32902, Frankfurt am Main , Guangzhou, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
