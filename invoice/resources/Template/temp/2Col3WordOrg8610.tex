...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valerie Michael Olofsson Ltd} \\
		{\large Wyatt 75}\\
		{\large 47665, Nha Trang, Chiang Rai, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jace Bengtsson } \\
		{\large Valeria 11}\\
		{\large 30832, Frankfurt am Main , Seattles, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
