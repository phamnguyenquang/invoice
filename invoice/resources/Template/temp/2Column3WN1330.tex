...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luca Elizabeth 	 Andersson} \\
		{\large Makenzie 1}\\
		{\large 65588, London , Bangkok, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ashton Victoria Lundqvist Ltd } \\
		{\large Destiny 37}\\
		{\large 17612, San Francisco, Saarland, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
