...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Miles Robert Pålsson} \\
		{\large Emmanuel 80}\\
		{\large 88056, Los Angeles, Bremen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Chase Louise 	 Bergman Pte Ltd } \\
		{\large Jade 59}\\
		{\large 22030, Hong Kong, Amnat Charoen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
