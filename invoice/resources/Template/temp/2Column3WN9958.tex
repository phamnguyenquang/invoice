...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Greyson Rose 	 Hellström} \\
		{\large Eva 85}\\
		{\large 88635, Beijing, Chiang Rai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Skylar May/Mae 	 Johansson Pte Ltd } \\
		{\large Destiny 99}\\
		{\large 55770, Rome, Guangdong, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
