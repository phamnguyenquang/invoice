...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brianna Catherine  Eklund} \\
		{\large Chloe 47}\\
		{\large 72186, Madrid, Seattles, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Izabella David Lund Ltd } \\
		{\large Annabelle 14}\\
		{\large 45247, Frankfurt am Main , Kentucky, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
