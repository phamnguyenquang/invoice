...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Calvin Hermansson} \\
		{\large James 27}\\
		{\large 59856, Munich, Hainan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eliana Thomas Blomqvist Ltd } \\
		{\large Morgan 29}\\
		{\large 36073, San Francisco, Binh Thuan, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
