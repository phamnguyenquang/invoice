...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Richard Catherine  Persson} \\
		{\large Brianna 77}\\
		{\large 70509, Berlin, Seattles, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lillian Christopher Jönsson Corp } \\
		{\large Wesley 32}\\
		{\large 31334, Ho Chi Minh, Saarland, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
