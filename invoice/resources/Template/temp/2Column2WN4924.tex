...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harper Sandström} \\
		{\large Christopher 80}\\
		{\large 44832, Frankfurt am Main , Hainan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bella Michael Ek Corp } \\
		{\large Jason 86}\\
		{\large 53246, Ho Chi Minh, Guangdong, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
