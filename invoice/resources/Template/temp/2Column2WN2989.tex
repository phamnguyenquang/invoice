...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro Magnusson} \\
		{\large Brandon 95}\\
		{\large 41417, SaiGon, Saarland, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large James Marie 	 Lindberg Pte Ltd } \\
		{\large Cora 95}\\
		{\large 88340, Venice, California, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
