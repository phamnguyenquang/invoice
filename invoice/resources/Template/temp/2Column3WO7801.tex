...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Norah Anne Nyström Inc} \\
		{\large Genesis 16}\\
		{\large 23579, Boston, California, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Arianna Fransson } \\
		{\large Blake 62}\\
		{\large 79965, Frankfurt am Main , Saarland, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
