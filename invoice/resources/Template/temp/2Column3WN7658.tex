...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Chloe Christopher Wikström} \\
		{\large Ashley 30}\\
		{\large 87407, Budapest, Kentucky, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrew May/Mae 	 Arvidsson Inc } \\
		{\large Easton 83}\\
		{\large 32722, Montreal, Texas, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
