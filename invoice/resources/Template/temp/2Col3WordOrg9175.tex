...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sophie Christopher Öberg Corp} \\
		{\large Richard 75}\\
		{\large 28380, Beijing, Buriam, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxon Magnusson } \\
		{\large Ellie 76}\\
		{\large 79932, San Francisco, Hawaii, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
