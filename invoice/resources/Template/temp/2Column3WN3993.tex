...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madelyn Michael Strömberg} \\
		{\large Chase 6}\\
		{\large 25422, Frankfurt am Main , Hawaii, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hayden Louise 	 Sjögren Ltd } \\
		{\large Elijah 5}\\
		{\large 82657, Dublin, Hamburg, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
