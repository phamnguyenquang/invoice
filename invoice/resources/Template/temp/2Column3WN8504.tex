...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sofia  Alexander  Ali} \\
		{\large Emma 95}\\
		{\large 40791, Chicago, Kentucky, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emery Marie 	 Karlsson Corp } \\
		{\large Gael 28}\\
		{\large 74785, Abu Dhabi, Saarland, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
