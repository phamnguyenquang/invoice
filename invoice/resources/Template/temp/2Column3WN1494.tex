...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kingston Lee  Holmgren} \\
		{\large Eden 48}\\
		{\large 28162, Frankfurt am Main , Bremen, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniel Louise 	 Berglund Pte Ltd } \\
		{\large Patrick 2}\\
		{\large 12692, Dubai, Ang Thong, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
