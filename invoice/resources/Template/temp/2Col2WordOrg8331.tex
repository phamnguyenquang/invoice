...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jennifer Sjöberg Pte Ltd} \\
		{\large Richard 51}\\
		{\large 86308, Frankfurt am Main , Chiang Rai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Asher Engström } \\
		{\large Nevaeh 68}\\
		{\large 68900, Seoul, California, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
