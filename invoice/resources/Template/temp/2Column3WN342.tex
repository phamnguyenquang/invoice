...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alex Louise 	 Arvidsson} \\
		{\large Joel 15}\\
		{\large 71173, San Francisco, Huabei, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emily Catherine  Pettersson Corp } \\
		{\large Micah 89}\\
		{\large 55768, Dublin, Amnat Charoen, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
