...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Molly Strömberg} \\
		{\large Christopher 23}\\
		{\large 43492, Frankfurt am Main , Guangdong, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Justin May/Mae 	 Henriksson Inc } \\
		{\large Henry 12}\\
		{\large 19580, Frankfurt am Main , Tuscany, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
