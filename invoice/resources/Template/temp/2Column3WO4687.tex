...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxson Louise 	 Hellström Pte Ltd} \\
		{\large Reese 13}\\
		{\large 16193, Frankfurt am Main , Chiang Mai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isla Hedlund } \\
		{\large Quinn 44}\\
		{\large 37849, Florence, Saarland, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
