...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicole Catherine  Pettersson Pte Ltd} \\
		{\large Adam 6}\\
		{\large 73470, Florence, Hessen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaden Andreasson } \\
		{\large Angel 59}\\
		{\large 33636, Amsterdam, Texas, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
