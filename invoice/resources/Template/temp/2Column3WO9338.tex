...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angel Christopher Gustafsson Inc} \\
		{\large Matthew 85}\\
		{\large 21045, Ho Chi Minh, khanh Hoa, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eleanor Blom } \\
		{\large Luis 95}\\
		{\large 53919, Abu Dhabi, Chiang Mai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
