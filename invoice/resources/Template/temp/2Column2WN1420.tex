...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesus Dahlberg} \\
		{\large Brooklyn 20}\\
		{\large 83477, Frankfurt am Main , Heibei, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liliana Kate 	 Hansson Pte Ltd } \\
		{\large Sean 69}\\
		{\large 62347, Frankfurt am Main , Indiana, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
