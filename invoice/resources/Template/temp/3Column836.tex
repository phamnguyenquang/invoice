...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Stockholm University} \\
		{\large Bella 30}\\
		{\large 88231, New York , Phu Yen, United Kingdom}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Skylar Axelsson } \\
		{\large Chase 90}\\
		{\large 49099, Frankfurt am Main , Chiang Rai, Switzerland}\\
    \switchcolumn
