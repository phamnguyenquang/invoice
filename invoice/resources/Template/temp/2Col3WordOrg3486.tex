...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katherine Elizabeth 	 Bergström Pte Ltd} \\
		{\large Alexandra 61}\\
		{\large 19624, Last Vegas, Guangdong, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kingston Gunnarsson } \\
		{\large Brian 40}\\
		{\large 40310, Minsk, Chiang Rai, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
