...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalia Olofsson} \\
		{\large Scarlett 58}\\
		{\large 36466, Toronto, California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ezekiel William Hermansson Inc } \\
		{\large Andrew 55}\\
		{\large 13257, Stuttgart, Hainan, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
