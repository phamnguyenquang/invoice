...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caden Anne Fredriksson} \\
		{\large Alexa 35}\\
		{\large 53504, Nha Trang, khanh Hoa, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adeline Rose 	 Söderberg Ltd } \\
		{\large Jordyn 36}\\
		{\large 98252, Moscow, Huabei, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
