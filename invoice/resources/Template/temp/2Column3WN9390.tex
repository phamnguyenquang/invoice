...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madison John Ali} \\
		{\large Alyssa 73}\\
		{\large 14994, Last Vegas, Amnat Charoen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lillian David Andersson Pte Ltd } \\
		{\large Harper 99}\\
		{\large 42503, Amsterdam, Phu Yen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
