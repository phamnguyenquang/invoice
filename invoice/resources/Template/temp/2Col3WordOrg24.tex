...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hayden Ann  Svensson Pte Ltd} \\
		{\large Jesus 6}\\
		{\large 39006, Frankfurt am Main , Hessen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alejandro Nordin } \\
		{\large Melanie 76}\\
		{\large 86578, San Francisco, Chai Nat, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
