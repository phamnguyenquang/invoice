...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Benjamin Peter Bengtsson} \\
		{\large Sarah 21}\\
		{\large 57510, Stuttgart, Guangzhou, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katherine Christopher Lindström Corp } \\
		{\large Alexander 83}\\
		{\large 30401, Bonn, California, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
