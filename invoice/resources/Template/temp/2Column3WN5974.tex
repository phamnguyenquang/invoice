...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jade Jane Persson} \\
		{\large Kenneth 25}\\
		{\large 56881, Amsterdam, Saarland, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Santiago Christopher Berglund Pte Ltd } \\
		{\large Sydney 85}\\
		{\large 64633, Madrid, Chiang Mai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
