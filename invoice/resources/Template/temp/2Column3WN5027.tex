...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Preston John Sundberg} \\
		{\large Paisley 24}\\
		{\large 91436, Florence, Binh Thuan, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eleanor Michael Andreasson Inc } \\
		{\large Valentina 70}\\
		{\large 25315, Chicago, Hessen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
