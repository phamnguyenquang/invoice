...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kylie David Mattsson} \\
		{\large Kennedy 29}\\
		{\large 85098, Ho Chi Minh, Bangkok, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathaniel Anne Mattsson Corp } \\
		{\large Naomi 82}\\
		{\large 71891, Dublin, Chai Nat, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
