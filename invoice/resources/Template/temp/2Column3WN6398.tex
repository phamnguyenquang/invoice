...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaron Michael Sundberg} \\
		{\large Elias 68}\\
		{\large 95424, Boston, Chiang Mai, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Khloe Robert Nyström Pte Ltd } \\
		{\large Sophie 15}\\
		{\large 32934, Frankfurt am Main , Amnat Charoen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
