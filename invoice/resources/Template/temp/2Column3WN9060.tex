...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alyssa Jane Håkansson} \\
		{\large King 72}\\
		{\large 61194, San Francisco, Buriam, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kingston David Axelsson Ltd } \\
		{\large Jordan 3}\\
		{\large 46217, Istanbul, Kentucky, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
