...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tristan Christopher Lund} \\
		{\large Abraham 44}\\
		{\large 19000, Chicago, khanh Hoa, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adriana Grace 	 Svensson Ltd } \\
		{\large Maverick 42}\\
		{\large 14571, Hong Kong, Hessen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
