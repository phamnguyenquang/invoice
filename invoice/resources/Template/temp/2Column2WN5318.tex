...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dominic Bergström} \\
		{\large Destiny 4}\\
		{\large 88390, Frankfurt am Main , Bangkok, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Declan David Danielsson Corp } \\
		{\large Lilly 55}\\
		{\large 90123, Berlin, California, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
