...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mackenzie Marie 	 Mårtensson} \\
		{\large Delilah 80}\\
		{\large 83891, Sydney, Buriam, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathaniel Robert Bergström Inc } \\
		{\large Summer 12}\\
		{\large 42050, Berlin, Hessen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
