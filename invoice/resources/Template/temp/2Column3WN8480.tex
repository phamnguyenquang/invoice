...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isla Ann  Björklund} \\
		{\large Everly 51}\\
		{\large 34803, Dublin, California, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabrielle Kate 	 Abrahamsson Ltd } \\
		{\large Malachi 80}\\
		{\large 52341, Frankfurt am Main , Buriam, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
