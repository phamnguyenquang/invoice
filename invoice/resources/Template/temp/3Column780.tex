...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Shanghai Pudong Development Bank} \\
		{\large Tucker 31}\\
		{\large 48737, Bonn, Tuscany, Singapore}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Maxwell Larsson } \\
		{\large Jennifer 39}\\
		{\large 48842, Frankfurt am Main , California, Argentina }\\
    \switchcolumn
