...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Victoria Claesson} \\
		{\large Avery 54}\\
		{\large 21416, Los Angeles, Saarland, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alice Thomas Sandberg Ltd } \\
		{\large Victor 33}\\
		{\large 62958, Washington, Guangdong, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
