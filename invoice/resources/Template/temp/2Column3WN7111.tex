...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elizabeth  Alexander  Ek} \\
		{\large Chase 76}\\
		{\large 31056, Hong Kong, Saarland, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn David Svensson Inc } \\
		{\large Clara 86}\\
		{\large 27238, Stuttgart, Chiang Mai, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
