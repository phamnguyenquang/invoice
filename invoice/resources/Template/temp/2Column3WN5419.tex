...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Reagan Christopher Lindqvist} \\
		{\large Zachary 89}\\
		{\large 80131, Venice, Chiang Mai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Levi Rose 	 Blom Pte Ltd } \\
		{\large Jaxson 31}\\
		{\large 52209, Madrid, khanh Hoa, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
