...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicole Michael Månsson Corp} \\
		{\large Natalie 66}\\
		{\large 36647, Los Angeles, Amnat Charoen, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexa Hassan } \\
		{\large Weston 37}\\
		{\large 34935, Frankfurt am Main , Heibei, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
