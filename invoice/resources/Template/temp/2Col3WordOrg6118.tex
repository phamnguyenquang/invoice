...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bennett Victoria Henriksson Corp} \\
		{\large George 52}\\
		{\large 53734, Last Vegas, Guangzhou, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalie Månsson } \\
		{\large Kai 58}\\
		{\large 50422, Last Vegas, Chiang Rai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
