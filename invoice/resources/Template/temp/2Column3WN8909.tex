...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Roman James Holmgren} \\
		{\large Madelyn 78}\\
		{\large 68068, Frankfurt am Main , California, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maverick Grace 	 Bergman Corp } \\
		{\large Jayce 36}\\
		{\large 53775, Singapore, Indiana, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
