...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brianna Louise 	 Dahl} \\
		{\large Thomas 60}\\
		{\large 10118, Frankfurt am Main , Guangzhou, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sarah Catherine  Nordström Corp } \\
		{\large Diego 16}\\
		{\large 84267, Munich, Binh Thuan, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
