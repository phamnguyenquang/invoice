...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paige Peter Berglund} \\
		{\large Julia 68}\\
		{\large 63995, Frankfurt am Main , Chiang Rai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brianna Ann  Sundberg Pte Ltd } \\
		{\large Abel 20}\\
		{\large 73636, Washington, Phu Yen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
