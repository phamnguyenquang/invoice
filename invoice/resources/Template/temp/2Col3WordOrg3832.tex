...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brayden Elizabeth 	 Jansson Pte Ltd} \\
		{\large Valentina 56}\\
		{\large 53586, Stuttgart, Heibei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jude Dahlberg } \\
		{\large Caroline 9}\\
		{\large 81797, Frankfurt am Main , Hamburg, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
