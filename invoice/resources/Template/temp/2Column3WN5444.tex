...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aubree Rose 	 Martinsson} \\
		{\large Brady 48}\\
		{\large 88194, Nha Trang, khanh Hoa, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alyssa Elizabeth 	 Lindberg Corp } \\
		{\large Hunter 62}\\
		{\large 63812, Istanbul, Chai Nat, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
