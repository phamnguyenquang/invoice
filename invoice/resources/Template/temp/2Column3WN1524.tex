...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayden Christopher Lindholm} \\
		{\large Hannah 32}\\
		{\large 19960, SaiGon, Chai Nat, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everett Thomas Lindgren Corp } \\
		{\large Levi 75}\\
		{\large 60671, Bonn, Kentucky, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
