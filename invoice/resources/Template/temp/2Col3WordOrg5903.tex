...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Autumn Christopher Karlsson Pte Ltd} \\
		{\large Rebecca 46}\\
		{\large 26088, Frankfurt am Main , Chai Nat, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxon Björk } \\
		{\large Izabella 18}\\
		{\large 87369, Sydney, Seattles, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
