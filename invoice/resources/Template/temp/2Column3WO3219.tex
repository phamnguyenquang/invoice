...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ivy James Pettersson Pte Ltd} \\
		{\large Ryder 87}\\
		{\large 15262, Boston, Bangkok, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vanessa Nordström } \\
		{\large Nora 93}\\
		{\large 52558, Frankfurt am Main , Amnat Charoen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
