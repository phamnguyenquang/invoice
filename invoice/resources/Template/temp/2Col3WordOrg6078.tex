...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Austin Michael Wikström Pte Ltd} \\
		{\large Kimberly 20}\\
		{\large 99657, Denver, Chiang Mai, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mark Berggren } \\
		{\large Alice 91}\\
		{\large 48420, Frankfurt am Main , Texas, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
