...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vincent Amy  Nilsson} \\
		{\large Taylor 64}\\
		{\large 47904, Washington, Phu Yen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sawyer Jane Fredriksson Pte Ltd } \\
		{\large Maximus 16}\\
		{\large 34098, Munich, Huabei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
