...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniel Thomas Hedlund} \\
		{\large Gabriella 69}\\
		{\large 25688, Tokyo, Chiang Rai, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bentley May/Mae 	 Bengtsson Inc } \\
		{\large Hailey 3}\\
		{\large 97633, Shanghai, Saarland, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
