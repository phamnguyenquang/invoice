...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cameron Abrahamsson Corp} \\
		{\large Penelope 17}\\
		{\large 87548, Frankfurt am Main , Saarland, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mason Viklund } \\
		{\large Rylee 69}\\
		{\large 66799, Melbourne, Chai Nat, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
