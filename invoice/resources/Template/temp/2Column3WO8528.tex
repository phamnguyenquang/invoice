...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Genesis James Gustafsson Inc} \\
		{\large Elizabeth 71}\\
		{\large 66241, Frankfurt am Main , Seattles, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caroline Söderberg } \\
		{\large Catherine 54}\\
		{\large 58072, Toronto, Ang Thong, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
