...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly Thomas Lundberg} \\
		{\large Emery 38}\\
		{\large 54219, Budapest, Saarland, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas Michael Mattsson Ltd } \\
		{\large Bradley 65}\\
		{\large 96580, Frankfurt am Main , Guangzhou, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
