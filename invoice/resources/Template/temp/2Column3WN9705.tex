...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria Amy  Eliasson} \\
		{\large Margaret 11}\\
		{\large 22772, Montreal, Guangzhou, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Richard  Alexander  Falk Pte Ltd } \\
		{\large Calvin 38}\\
		{\large 85852, Budapest, Buriam, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
