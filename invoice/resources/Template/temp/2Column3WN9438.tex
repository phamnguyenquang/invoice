...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nolan John Axelsson} \\
		{\large Skylar 75}\\
		{\large 98513, Ho Chi Minh, Amnat Charoen, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabrielle Peter Engström Pte Ltd } \\
		{\large Damian 36}\\
		{\large 26086, Barcelona, Hainan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
