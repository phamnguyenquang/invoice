...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalie Strömberg} \\
		{\large Kendall 97}\\
		{\large 72188, Frankfurt am Main , Bayern, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paisley Mary 	 Magnusson Ltd } \\
		{\large Izabella 62}\\
		{\large 48530, Chicago, Hessen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
