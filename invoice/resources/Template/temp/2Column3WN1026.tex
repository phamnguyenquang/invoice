...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Benjamin May/Mae 	 Håkansson} \\
		{\large Luis 35}\\
		{\large 98040, Barcelona, Guangzhou, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leah Christopher Forsberg Ltd } \\
		{\large Calvin 26}\\
		{\large 71210, Budapest, Bayern, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
