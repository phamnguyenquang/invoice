...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kingston Arvidsson} \\
		{\large Daisy 16}\\
		{\large 55390, Nha Trang, Hessen, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reagan William Jonsson Inc } \\
		{\large Tyler 97}\\
		{\large 27716, Frankfurt am Main , Chiang Mai, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
