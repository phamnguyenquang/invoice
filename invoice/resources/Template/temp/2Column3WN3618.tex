...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Reagan Marie 	 Bengtsson} \\
		{\large Gabriel 27}\\
		{\large 47254, Frankfurt am Main , Hessen, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathan James Lundberg Corp } \\
		{\large Christian 83}\\
		{\large 94522, Abu Dhabi, Amnat Charoen, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
