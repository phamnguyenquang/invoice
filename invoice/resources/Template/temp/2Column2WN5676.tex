...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Axel Eriksson} \\
		{\large David 12}\\
		{\large 92532, Venice, Seattles, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ashley Christopher Claesson Pte Ltd } \\
		{\large Mateo 68}\\
		{\large 23924, Frankfurt am Main , Bremen, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
