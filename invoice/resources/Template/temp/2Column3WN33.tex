...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adrian James Samuelsson} \\
		{\large Calvin 35}\\
		{\large 36721, Stuttgart, Amnat Charoen, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Payton Marie 	 Abrahamsson Ltd } \\
		{\large Landon 13}\\
		{\large 37487, Stuttgart, Chiang Rai, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
