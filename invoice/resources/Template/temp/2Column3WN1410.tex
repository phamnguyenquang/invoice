...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alana Louise 	 Bergman} \\
		{\large Elena 26}\\
		{\large 84624, Barcelona, Saarland, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Piper Ann  Lundin Inc } \\
		{\large John 55}\\
		{\large 64366, San Francisco, Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
