...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Samantha Mary 	 Holmberg} \\
		{\large Richard 91}\\
		{\large 93980, Los Angeles, Chiang Rai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aurora John Svensson Corp } \\
		{\large Melanie 60}\\
		{\large 12168, Dubai, Hessen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
