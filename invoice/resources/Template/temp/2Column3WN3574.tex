...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles Thomas Lindholm} \\
		{\large Jocelyn 75}\\
		{\large 63747, Ho Chi Minh, Ang Thong, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luke Ann  Håkansson Pte Ltd } \\
		{\large Abraham 28}\\
		{\large 67620, Denver, khanh Hoa, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
