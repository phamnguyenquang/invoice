...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriel Thomas Svensson} \\
		{\large Jonah 65}\\
		{\large 81134, Berlin, Chai Nat, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grant  Alexander  Hellström Pte Ltd } \\
		{\large Kyle 93}\\
		{\large 93622, Istanbul, khanh Hoa, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
