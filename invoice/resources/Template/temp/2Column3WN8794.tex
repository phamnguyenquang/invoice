...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tucker Ann  Nyberg} \\
		{\large Kinsley 97}\\
		{\large 20579, Last Vegas, Chai Nat, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brielle Peter Claesson Ltd } \\
		{\large Khloe 11}\\
		{\large 22451, Frankfurt am Main , Seattles, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
