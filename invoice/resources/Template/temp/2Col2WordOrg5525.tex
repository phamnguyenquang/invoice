...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Audrey Björklund Pte Ltd} \\
		{\large Eleanor 74}\\
		{\large 45484, Frankfurt am Main , Bangkok, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Logan Lundgren } \\
		{\large Jesus 97}\\
		{\large 30160, Frankfurt am Main , Guangzhou, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
