...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Austin Victoria Strömberg Ltd} \\
		{\large Rachel 25}\\
		{\large 31783, Frankfurt am Main , Floria, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxson Jönsson } \\
		{\large Adalynn 55}\\
		{\large 69886, San Francisco, Amnat Charoen, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
