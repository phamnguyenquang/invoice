...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Scarlett Christopher Sundberg Corp} \\
		{\large Emmanuel 65}\\
		{\large 40294, Berlin, Guangzhou, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson Isaksson } \\
		{\large Carson 54}\\
		{\large 15409, New York , Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
