...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lyla Edward Eliasson} \\
		{\large Josiah 95}\\
		{\large 57145, Rome, Bremen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie Michael Norberg Inc } \\
		{\large Emmett 37}\\
		{\large 55042, Melbourne, Amnat Charoen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
