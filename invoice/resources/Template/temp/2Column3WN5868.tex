...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emma  Alexander  Lindberg} \\
		{\large Luke 70}\\
		{\large 54024, Hong Kong, Guangzhou, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mackenzie William Magnusson Inc } \\
		{\large Preston 83}\\
		{\large 62525, Madrid, Hainan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
