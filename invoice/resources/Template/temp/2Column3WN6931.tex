...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Peyton Victoria Strömberg} \\
		{\large Elizabeth 97}\\
		{\large 47379, Barcelona, Huabei, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Elizabeth 	 Jönsson Ltd } \\
		{\large Nathaniel 76}\\
		{\large 70847, Frankfurt am Main , khanh Hoa, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
