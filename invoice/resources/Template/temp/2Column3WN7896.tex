...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle Catherine  Gustafsson} \\
		{\large Willow 35}\\
		{\large 36117, Amsterdam, Huabei, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nolan Edward Andersson Corp } \\
		{\large Kaitlyn 74}\\
		{\large 33349, Barcelona, Kentucky, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
