...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maximus Peter Olofsson Pte Ltd} \\
		{\large Maria 27}\\
		{\large 85246, Seoul, Binh Thuan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carlos Mårtensson } \\
		{\large Gracie 40}\\
		{\large 14313, Barcelona, California, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
