...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adeline  Alexander  Henriksson Corp} \\
		{\large Brady 72}\\
		{\large 57489, Taipei, Amnat Charoen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large James Andersson } \\
		{\large Joshua 10}\\
		{\large 76327, Melbourne, Phu Yen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
