...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Audrey Peter Nordin} \\
		{\large Isaiah 37}\\
		{\large 95635, Denver, Chiang Rai, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Savannah Michael Bergström Pte Ltd } \\
		{\large Julia 55}\\
		{\large 20981, Chicago, California, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
