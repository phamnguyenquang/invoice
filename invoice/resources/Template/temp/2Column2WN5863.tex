...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Blake Blomqvist} \\
		{\large Andrea 78}\\
		{\large 19267, Singapore, Ang Thong, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amir Louise 	 Claesson Pte Ltd } \\
		{\large Riley 47}\\
		{\large 46635, Frankfurt am Main , Guangzhou, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
