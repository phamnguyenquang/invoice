...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Mohamed} \\
		{\large Amy 62}\\
		{\large 75452, Melbourne, Seattles, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer William Jönsson Pte Ltd } \\
		{\large Zoe 87}\\
		{\large 28884, Abu Dhabi, Buriam, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
