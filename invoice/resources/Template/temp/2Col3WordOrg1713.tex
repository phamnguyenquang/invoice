...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Austin  Alexander  Henriksson Inc} \\
		{\large Rebecca 66}\\
		{\large 80832, Abu Dhabi, California, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Athena Lindström } \\
		{\large Miles 91}\\
		{\large 56301, Berlin, Saarland, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
