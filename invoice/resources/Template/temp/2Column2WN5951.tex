...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra Abrahamsson} \\
		{\large Jack 89}\\
		{\large 63053, Taipei, California, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cole David Gustafsson Pte Ltd } \\
		{\large Sofia 73}\\
		{\large 56520, Melbourne, Tuscany, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
