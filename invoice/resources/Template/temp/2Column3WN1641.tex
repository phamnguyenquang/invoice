...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hazel Ann  Pettersson} \\
		{\large Victor 5}\\
		{\large 40160, Frankfurt am Main , Ang Thong, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kenneth Peter Berglund Ltd } \\
		{\large Makenzie 34}\\
		{\large 79235, Florence, California, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
