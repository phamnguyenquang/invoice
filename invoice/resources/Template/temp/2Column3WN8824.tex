...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Chase Edward Hellström} \\
		{\large Abel 52}\\
		{\large 31198, Hong Kong, Floria, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bradley Anne Johansson Corp } \\
		{\large Kendall 54}\\
		{\large 24456, Frankfurt am Main , Seattles, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
