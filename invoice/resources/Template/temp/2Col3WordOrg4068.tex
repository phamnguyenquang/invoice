...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Giovanni Grace 	 Claesson Ltd} \\
		{\large Giovanni 98}\\
		{\large 28805, San Francisco, Bangkok, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Timothy Nordström } \\
		{\large Michael 99}\\
		{\large 42944, Hong Kong, Buriam, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
