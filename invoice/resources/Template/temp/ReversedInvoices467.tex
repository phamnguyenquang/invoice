...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  National Taiwan Ocean University} \\
		{\large Parker 99}\\
		{\large 38944, Amsterdam, Amnat Charoen, Singapore}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Adeline Wikström } \\
		{\large Lincoln 34}\\
		{\large 10402, Dublin, Hamburg, Denmark}\\
    \switchcolumn
