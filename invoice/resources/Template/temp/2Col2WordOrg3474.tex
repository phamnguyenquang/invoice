...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alaina Holmberg Pte Ltd} \\
		{\large Elise 24}\\
		{\large 25643, Vancouver, Ang Thong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Thomas Mårtensson } \\
		{\large Bradley 3}\\
		{\large 91546, Frankfurt am Main , Hamburg, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
