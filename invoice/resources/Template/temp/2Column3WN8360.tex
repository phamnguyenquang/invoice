...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bailey Edward Martinsson} \\
		{\large Graham 53}\\
		{\large 81009, Montreal, Chiang Mai, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adam Louise 	 Holmgren Inc } \\
		{\large Grace 46}\\
		{\large 56469, Dublin, Amnat Charoen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
