...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Addison Grace 	 Axelsson} \\
		{\large Isabella 12}\\
		{\large 97184, Toronto, Bremen, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grayson Catherine  Mattsson Ltd } \\
		{\large Joshua 25}\\
		{\large 83255, Ho Chi Minh, Tuscany, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
