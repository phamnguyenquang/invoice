...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Michael Bengtsson Ltd} \\
		{\large Anna 68}\\
		{\large 90235, Istanbul, Bremen, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Destiny Månsson } \\
		{\large Michael 25}\\
		{\large 15962, Frankfurt am Main , Tuscany, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
