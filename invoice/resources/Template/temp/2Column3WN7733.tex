...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stella Michael Mårtensson} \\
		{\large Maddox 38}\\
		{\large 55997, London , Texas, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Clara Peter Danielsson Inc } \\
		{\large Chloe 16}\\
		{\large 95858, Paris, Guangdong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
