...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gracie Lindqvist Corp} \\
		{\large Morgan 82}\\
		{\large 98122, Moscow, Hamburg, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hadley Wikström } \\
		{\large Luna 2}\\
		{\large 94062, Frankfurt am Main , Binh Thuan, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
