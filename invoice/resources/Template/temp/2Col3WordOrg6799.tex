...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriella Christopher Hansen Ltd} \\
		{\large Max 5}\\
		{\large 33235, Frankfurt am Main , Guangdong, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie Bergström } \\
		{\large Annabelle 75}\\
		{\large 83724, Dubai, Hamburg, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
