...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Malachi Louise 	 Fredriksson} \\
		{\large Brady 85}\\
		{\large 43055, Montreal, Henan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valeria  Alexander  Håkansson Corp } \\
		{\large Evan 88}\\
		{\large 94224, Washington, Huabei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
