...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Khloe Nordström} \\
		{\large Maddox 52}\\
		{\large 30721, Madrid, Amnat Charoen, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Christopher Olofsson Pte Ltd } \\
		{\large Luca 66}\\
		{\large 87952, Istanbul, Saarland, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
