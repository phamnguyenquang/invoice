...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madelyn James Hermansson} \\
		{\large Parker 99}\\
		{\large 67282, Montreal, Chiang Mai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isla Robert Johansson Pte Ltd } \\
		{\large Adam 46}\\
		{\large 31305, Dublin, Hessen, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
