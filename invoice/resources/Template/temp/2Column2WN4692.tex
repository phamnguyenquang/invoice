...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jameson Gunnarsson} \\
		{\large Bryce 37}\\
		{\large 96269, Denver, Floria, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harrison Marie 	 Arvidsson Pte Ltd } \\
		{\large Aaron 82}\\
		{\large 70262, Beijing, Chiang Rai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
