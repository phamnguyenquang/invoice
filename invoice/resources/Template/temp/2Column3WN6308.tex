...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adeline Edward Svensson} \\
		{\large Samantha 13}\\
		{\large 24429, Minsk, Henan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alana Elizabeth 	 Hermansson Ltd } \\
		{\large Brantley 62}\\
		{\large 21250, Boston, Tuscany, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
