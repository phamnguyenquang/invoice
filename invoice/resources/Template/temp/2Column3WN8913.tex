...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryleigh Rose 	 Karlsson} \\
		{\large Ella 68}\\
		{\large 62483, Vancouver, Chiang Mai, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniela Edward Lindqvist Ltd } \\
		{\large Carson 37}\\
		{\large 82877, Rome, Chiang Mai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
