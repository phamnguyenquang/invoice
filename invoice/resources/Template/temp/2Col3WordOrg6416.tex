...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Connor Kate 	 Bengtsson Corp} \\
		{\large Samantha 11}\\
		{\large 18532, Frankfurt am Main , California, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jason Mårtensson } \\
		{\large Evan 25}\\
		{\large 52133, Vienna, Chiang Mai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
