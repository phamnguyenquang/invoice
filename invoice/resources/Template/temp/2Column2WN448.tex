...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Arianna Sandström} \\
		{\large Rylee 2}\\
		{\large 10897, Vienna, Chai Nat, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jameson Anne Fransson Pte Ltd } \\
		{\large Jeremy 55}\\
		{\large 38516, Frankfurt am Main , Seattles, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
