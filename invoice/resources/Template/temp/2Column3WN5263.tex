...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Easton Thomas Öberg} \\
		{\large Jacob 77}\\
		{\large 48958, Osaka, khanh Hoa, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Noah  Alexander  Holmberg Ltd } \\
		{\large Aliyah 61}\\
		{\large 10684, Barcelona, Chiang Mai, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
