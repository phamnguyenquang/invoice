...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  London Lee  Nordin} \\
		{\large Bryson 47}\\
		{\large 39101, Ho Chi Minh, Heibei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brielle  Alexander  Holmberg Pte Ltd } \\
		{\large Emilia 7}\\
		{\large 43376, Madrid, Hessen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
