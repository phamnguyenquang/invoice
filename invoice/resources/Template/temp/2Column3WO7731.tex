...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adrian David Mattsson Corp} \\
		{\large Brady 59}\\
		{\large 72386, Stuttgart, Chiang Rai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Timothy Lundström } \\
		{\large Lucy 50}\\
		{\large 56614, Frankfurt am Main , khanh Hoa, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
