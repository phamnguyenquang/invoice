...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Riley Christopher Ström Pte Ltd} \\
		{\large Ryker 15}\\
		{\large 62536, Frankfurt am Main , Tuscany, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jude Karlsson } \\
		{\large Eliana 49}\\
		{\large 76367, Melbourne, Floria, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
