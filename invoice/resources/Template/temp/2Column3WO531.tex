...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eliza Catherine  Wikström Pte Ltd} \\
		{\large Connor 60}\\
		{\large 11008, Frankfurt am Main , California, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grace Viklund } \\
		{\large Hazel 17}\\
		{\large 17807, Stuttgart, Henan, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
