...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Chungbuk National University	South} \\
		{\large Vanessa 79}\\
		{\large 27819, Nha Trang, Phu Yen, South Korea}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Alan Nilsson } \\
		{\large Penelope 72}\\
		{\large 91293, Washington, Chiang Rai, Mexico }\\
    \switchcolumn
