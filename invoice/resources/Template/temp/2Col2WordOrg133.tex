...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carlos Bengtsson Ltd} \\
		{\large Justin 80}\\
		{\large 27546, New York , Ang Thong, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Victoria Blomqvist } \\
		{\large Aubrey 50}\\
		{\large 21675, Frankfurt am Main , Chiang Rai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
