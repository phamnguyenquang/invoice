...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Lundqvist Pte Ltd} \\
		{\large Reagan 87}\\
		{\large 50811, Barcelona, Hessen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonathan Mårtensson } \\
		{\large Timothy 38}\\
		{\large 55105, San Francisco, Hawaii, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
