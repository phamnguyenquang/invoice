...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryan Amy  Åkesson Pte Ltd} \\
		{\large Leo 99}\\
		{\large 17147, Los Angeles, khanh Hoa, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrew Nilsson } \\
		{\large Camden 85}\\
		{\large 82978, Frankfurt am Main , Chiang Rai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
