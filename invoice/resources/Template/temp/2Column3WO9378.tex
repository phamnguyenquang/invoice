...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Faith Catherine  Hansson Pte Ltd} \\
		{\large Laila 19}\\
		{\large 24753, Hong Kong, Ang Thong, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ivan Holm } \\
		{\large Liliana 82}\\
		{\large 46548, Frankfurt am Main , Buriam, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
