...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel Marie 	 Holmgren} \\
		{\large Grace 3}\\
		{\large 21682, Last Vegas, Henan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucy Lee  Hellström Corp } \\
		{\large Axel 31}\\
		{\large 10379, Hong Kong, Hamburg, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
