...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jordyn Elizabeth 	 Abrahamsson} \\
		{\large Ryder 59}\\
		{\large 28264, Frankfurt am Main , Huabei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Summer Ann  Hedlund Pte Ltd } \\
		{\large Joel 75}\\
		{\large 26336, Taipei, Hawaii, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
