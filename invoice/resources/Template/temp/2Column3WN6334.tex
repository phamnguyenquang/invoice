...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everly Catherine  Nordin} \\
		{\large Sadie 33}\\
		{\large 41095, Singapore, Guangzhou, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madelyn Grace 	 Andersson Corp } \\
		{\large Emma 64}\\
		{\large 84165, Hong Kong, Chai Nat, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
