...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jacob Amy  Mårtensson} \\
		{\large Timothy 54}\\
		{\large 35309, Frankfurt am Main , Phu Yen, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cora John Johansson Inc } \\
		{\large Julianna 6}\\
		{\large 19304, Florence, Saarland, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
