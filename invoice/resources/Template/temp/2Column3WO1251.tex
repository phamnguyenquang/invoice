...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isaiah Elizabeth 	 Danielsson Ltd} \\
		{\large Valeria 63}\\
		{\large 12128, Chicago, Bangkok, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elizabeth Holmgren } \\
		{\large Valerie 43}\\
		{\large 53032, Los Angeles, Indiana, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
