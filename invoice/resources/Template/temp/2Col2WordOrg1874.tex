...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dylan Nilsson Inc} \\
		{\large Kimberly 43}\\
		{\large 17724, Frankfurt am Main , Chiang Rai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathan Mårtensson } \\
		{\large Audrey 22}\\
		{\large 32703, San Francisco, Bremen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
