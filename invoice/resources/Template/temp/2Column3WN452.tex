...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brielle Christopher Ek} \\
		{\large Grant 56}\\
		{\large 63052, Singapore, Guangdong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Oscar Marie 	 Berglund Pte Ltd } \\
		{\large Paige 83}\\
		{\large 37993, Frankfurt am Main , Floria, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
