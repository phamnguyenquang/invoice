...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eleanor Marie 	 Lindström Pte Ltd} \\
		{\large Kinsley 13}\\
		{\large 63265, Munich, Seattles, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriel Ekström } \\
		{\large Elise 44}\\
		{\large 29569, Frankfurt am Main , Ang Thong, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
