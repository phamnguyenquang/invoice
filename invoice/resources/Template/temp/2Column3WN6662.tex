...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla Christopher Jansson} \\
		{\large Max 15}\\
		{\large 37702, Madrid, Floria, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madison Robert Ekström Inc } \\
		{\large Kendall 73}\\
		{\large 45468, Frankfurt am Main , Henan, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
