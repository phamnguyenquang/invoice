...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michael John Andersson} \\
		{\large Evan 78}\\
		{\large 99269, Frankfurt am Main , Seattles, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Quinn William Hansson Pte Ltd } \\
		{\large Paige 81}\\
		{\large 24080, Madrid, Indiana, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
