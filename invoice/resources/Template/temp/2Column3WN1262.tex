...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sarah James Holm} \\
		{\large Lincoln 76}\\
		{\large 19124, Barcelona, Amnat Charoen, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ezra Ann  Bergqvist Corp } \\
		{\large Josephine 6}\\
		{\large 65637, Frankfurt am Main , Guangzhou, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
