...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie Berglund} \\
		{\large Delilah 85}\\
		{\large 83888, Lisbon, Chiang Mai, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Audrey Victoria Nordström Inc } \\
		{\large Jake 58}\\
		{\large 47043, Frankfurt am Main , Buriam, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
