...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eliza  Alexander  Sjöberg} \\
		{\large Sean 31}\\
		{\large 75086, SaiGon, Hainan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camden Louise 	 Håkansson Pte Ltd } \\
		{\large Alice 47}\\
		{\large 64110, Washington, Hawaii, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
