...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kayden Grace 	 Nordström} \\
		{\large Lyla 63}\\
		{\large 17057, Barcelona, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elise Michael Berggren Ltd } \\
		{\large Nora 25}\\
		{\large 82182, Berlin, Chai Nat, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
