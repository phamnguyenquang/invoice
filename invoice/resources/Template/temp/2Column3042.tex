...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Delilah Hedlund Ltd} \\
		{\large Santiago 36}\\
		{\large 91097, Frankfurt am Main , Seattles, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie Dahlberg } \\
		{\large Layla 4}\\
		{\large 15685, Frankfurt am Main , Binh Thuan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
