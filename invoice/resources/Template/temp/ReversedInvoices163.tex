...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Science and Technology, Korea	South} \\
		{\large Nora 28}\\
		{\large 96811, Madrid, Amnat Charoen, Saudi Arabia }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Margaret Björk } \\
		{\large Hunter 56}\\
		{\large 44922, Munich, Hessen, Australia }\\
    \switchcolumn
