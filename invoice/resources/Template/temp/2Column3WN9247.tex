...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hadley Michael Eliasson} \\
		{\large Gabriel 81}\\
		{\large 91569, Vancouver, Binh Thuan, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michelle Amy  Eriksson Pte Ltd } \\
		{\large Eden 55}\\
		{\large 13209, Denver, Chiang Rai, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
