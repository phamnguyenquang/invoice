...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maria Pettersson} \\
		{\large Catherine 8}\\
		{\large 60966, Frankfurt am Main , Guangdong, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vincent Robert Svensson Corp } \\
		{\large Jordan 25}\\
		{\large 61260, Melbourne, Henan, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
