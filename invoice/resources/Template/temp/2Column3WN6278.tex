...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniel Jane Eriksson} \\
		{\large David 10}\\
		{\large 54593, Frankfurt am Main , Chiang Rai, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Clara James Svensson Corp } \\
		{\large Aaron 56}\\
		{\large 26116, Chicago, Bremen, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
