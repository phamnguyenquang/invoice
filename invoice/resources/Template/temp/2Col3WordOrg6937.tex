...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emery William Jönsson Pte Ltd} \\
		{\large Faith 86}\\
		{\large 59604, Venice, Texas, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon Mårtensson } \\
		{\large Isabelle 70}\\
		{\large 59725, New York , Chiang Mai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
