...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jackson Elizabeth 	 Holm} \\
		{\large Kevin 22}\\
		{\large 33527, Frankfurt am Main , Hamburg, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hailey Catherine  Svensson Ltd } \\
		{\large Benjamin 89}\\
		{\large 23048, Singapore, Bayern, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
