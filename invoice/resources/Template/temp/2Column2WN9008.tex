...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel Olofsson} \\
		{\large Braxton 32}\\
		{\large 97832, Last Vegas, Chai Nat, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine  Alexander  Söderberg Inc } \\
		{\large Kaitlyn 48}\\
		{\large 41460, Shanghai, Buriam, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
