...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Louise 	 Johansson} \\
		{\large Kaden 25}\\
		{\large 33339, Moscow, Binh Thuan, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Calvin Rose 	 Håkansson Ltd } \\
		{\large Taylor 99}\\
		{\large 47742, Montreal, Binh Thuan, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
