...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everett Catherine  Martinsson} \\
		{\large Aria 93}\\
		{\large 49886, Rome, Chiang Rai, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Thomas Louise 	 Claesson Pte Ltd } \\
		{\large Ximena 26}\\
		{\large 84459, Abu Dhabi, Chiang Rai, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
