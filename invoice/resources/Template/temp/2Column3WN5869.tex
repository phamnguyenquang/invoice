...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Christopher Arvidsson} \\
		{\large Abigail 27}\\
		{\large 28022, Berlin, Tuscany, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian Elizabeth 	 Mohamed Ltd } \\
		{\large Jayla 7}\\
		{\large 89041, Minsk, Kentucky, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
