...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaiden Söderberg} \\
		{\large Ellie 95}\\
		{\large 46544, Frankfurt am Main , Guangzhou, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexis Ann  Andreasson Ltd } \\
		{\large Jacob 66}\\
		{\large 42065, Washington, Binh Thuan, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
