...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Blake Lee  Nilsson Pte Ltd} \\
		{\large Isabelle 33}\\
		{\large 40073, Frankfurt am Main , California, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson Andersson } \\
		{\large Jayden 21}\\
		{\large 13597, Sydney, Saarland, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
