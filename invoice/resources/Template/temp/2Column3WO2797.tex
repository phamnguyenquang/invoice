...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Malachi Elizabeth 	 Hermansson Ltd} \\
		{\large Nevaeh 76}\\
		{\large 24058, Last Vegas, Chai Nat, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalynn Holmgren } \\
		{\large Carter 64}\\
		{\large 13145, New York , Guangzhou, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
