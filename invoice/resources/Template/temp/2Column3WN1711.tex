...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carter  Alexander  Bengtsson} \\
		{\large Michelle 61}\\
		{\large 26512, Barcelona, Hawaii, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesus  Alexander  Jakobsson Pte Ltd } \\
		{\large Lauren 39}\\
		{\large 75929, Lisbon, Ang Thong, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
