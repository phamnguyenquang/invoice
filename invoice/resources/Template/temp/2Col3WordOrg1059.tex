...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lucas Catherine  Larsson Pte Ltd} \\
		{\large Christian 71}\\
		{\large 40087, London , Bayern, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayden Hermansson } \\
		{\large Maverick 46}\\
		{\large 32149, Frankfurt am Main , Floria, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
