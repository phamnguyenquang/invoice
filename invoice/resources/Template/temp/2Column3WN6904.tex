...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Violet Thomas Hellström} \\
		{\large Liliana 10}\\
		{\large 19672, Paris, Chiang Rai, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Colin Thomas Hansson Pte Ltd } \\
		{\large Scarlett 91}\\
		{\large 25154, Shanghai, Guangdong, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
