...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Northwestern Polytechnical University} \\
		{\large Summer 66}\\
		{\large 86881, Melbourne, Ang Thong, Saudi Arabia }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Paige Ali } \\
		{\large Juliana 13}\\
		{\large 86045, San Francisco, Henan, Singapore}\\
    \switchcolumn
