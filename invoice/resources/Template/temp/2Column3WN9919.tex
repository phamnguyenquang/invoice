...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sean James Johansson} \\
		{\large Edward 27}\\
		{\large 34412, Hong Kong, khanh Hoa, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon Marie 	 Holmberg Pte Ltd } \\
		{\large Summer 12}\\
		{\large 17152, Venice, Hainan, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
