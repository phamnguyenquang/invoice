...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madelyn David Söderberg Inc} \\
		{\large Maxwell 31}\\
		{\large 32879, Chicago, Ang Thong, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn Gunnarsson } \\
		{\large Rebecca 27}\\
		{\large 55563, Frankfurt am Main , Kentucky, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
