...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie Anne Bengtsson} \\
		{\large Connor 19}\\
		{\large 87262, San Francisco, Bayern, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kevin Louise 	 Engström Inc } \\
		{\large Athena 28}\\
		{\large 44762, Madrid, Binh Thuan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
