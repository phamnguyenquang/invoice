...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Piper Michael Dahlberg} \\
		{\large Harper 90}\\
		{\large 37742, Frankfurt am Main , Floria, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jordyn May/Mae 	 Nordström Inc } \\
		{\large Lily 85}\\
		{\large 66802, Frankfurt am Main , Hessen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
