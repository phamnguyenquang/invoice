...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryce Jönsson} \\
		{\large Samuel 26}\\
		{\large 18711, Frankfurt am Main , Hamburg, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gavin Christopher Karlsson Corp } \\
		{\large Bennett 80}\\
		{\large 22035, Ho Chi Minh, Hessen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
