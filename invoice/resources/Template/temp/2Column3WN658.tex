...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adeline Catherine  Claesson} \\
		{\large Maddox 71}\\
		{\large 75401, Barcelona, Bangkok, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katelyn David Forsberg Corp } \\
		{\large Natalie 36}\\
		{\large 65344, Frankfurt am Main , Chai Nat, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
