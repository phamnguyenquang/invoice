...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mateo Robert Wallin} \\
		{\large Jonah 95}\\
		{\large 96439, Last Vegas, Chiang Rai, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large London Christopher Danielsson Pte Ltd } \\
		{\large Mary 74}\\
		{\large 25327, London , Huabei, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
