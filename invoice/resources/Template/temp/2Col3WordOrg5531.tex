...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklynn Grace 	 Berglund Ltd} \\
		{\large Chloe 27}\\
		{\large 30813, Frankfurt am Main , Guangzhou, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Laila Claesson } \\
		{\large Delilah 56}\\
		{\large 26029, Shanghai, khanh Hoa, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
