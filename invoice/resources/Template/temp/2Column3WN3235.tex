...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abigail Louise 	 Holmberg} \\
		{\large Patrick 16}\\
		{\large 21661, Frankfurt am Main , California, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camila Louise 	 Nyström Pte Ltd } \\
		{\large Genesis 10}\\
		{\large 61795, Montreal, Buriam, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
