...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cayden Christopher Viklund Pte Ltd} \\
		{\large Alan 92}\\
		{\large 29555, Last Vegas, Henan, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josephine Engström } \\
		{\large Riley 8}\\
		{\large 46137, Nha Trang, California, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
