...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklyn Grace 	 Andreasson Corp} \\
		{\large Miles 96}\\
		{\large 54784, Frankfurt am Main , khanh Hoa, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leilani Björklund } \\
		{\large Eliza 46}\\
		{\large 68816, Seoul, Ang Thong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
