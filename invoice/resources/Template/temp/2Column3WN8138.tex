...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carlos Elizabeth 	 Andreasson} \\
		{\large Lauren 24}\\
		{\large 69712, Budapest, Guangdong, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas Rose 	 Blomqvist Corp } \\
		{\large Ariel 84}\\
		{\large 55780, Abu Dhabi, Seattles, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
