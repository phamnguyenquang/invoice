...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Edward Lundström Pte Ltd} \\
		{\large Logan 73}\\
		{\large 39498, Frankfurt am Main , Henan, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Noah Arvidsson } \\
		{\large Jesse 62}\\
		{\large 91827, Toronto, Buriam, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
