...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hazel William Hermansson} \\
		{\large Lilly 49}\\
		{\large 14461, Dubai, Amnat Charoen, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cora Rose 	 Norberg Inc } \\
		{\large Vivian 68}\\
		{\large 66536, Frankfurt am Main , Phu Yen, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
