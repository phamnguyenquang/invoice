...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Blake Lindholm} \\
		{\large Katelyn 7}\\
		{\large 40726, Frankfurt am Main , Chiang Mai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubrey Victoria Fransson Inc } \\
		{\large Micah 77}\\
		{\large 98994, Chicago, Hamburg, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
