...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Piper Christopher Mohamed} \\
		{\large Sydney 96}\\
		{\large 12671, Tokyo, California, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sadie Elizabeth 	 Engström Pte Ltd } \\
		{\large Angel 73}\\
		{\large 46244, Boston, Indiana, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
