...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rylee Elizabeth 	 Isaksson} \\
		{\large Benjamin 11}\\
		{\large 89297, Dubai, Chiang Rai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josephine Jane Jakobsson Inc } \\
		{\large Alexander 76}\\
		{\large 70959, Hanoi, Hamburg, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
