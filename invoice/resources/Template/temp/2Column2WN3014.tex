...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Audrey Andreasson} \\
		{\large Ryleigh 50}\\
		{\large 31079, Shanghai, Floria, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sydney Rose 	 Henriksson Ltd } \\
		{\large Mark 98}\\
		{\large 22365, Los Angeles, Binh Thuan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
