...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalyn Michael Gunnarsson Pte Ltd} \\
		{\large Everly 34}\\
		{\large 96650, London , Guangdong, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Clara Eliasson } \\
		{\large Katherine 67}\\
		{\large 39972, Lisbon, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
