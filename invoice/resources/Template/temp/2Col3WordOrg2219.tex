...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mackenzie  Alexander  Jönsson Pte Ltd} \\
		{\large Matthew 1}\\
		{\large 15991, New York , Amnat Charoen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large John Hermansson } \\
		{\large Jordan 34}\\
		{\large 62145, Barcelona, Kentucky, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
