...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jake Olofsson} \\
		{\large Luna 50}\\
		{\large 54951, Ho Chi Minh, Indiana, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wyatt May/Mae 	 Holmgren Pte Ltd } \\
		{\large Jesse 71}\\
		{\large 87583, Nha Trang, California, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
