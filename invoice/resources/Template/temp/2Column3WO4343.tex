...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle Louise 	 Hedlund Corp} \\
		{\large Hadley 38}\\
		{\large 78946, San Francisco, Seattles, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore Sundberg } \\
		{\large Jasmine 31}\\
		{\large 89322, Venice, Heibei, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
