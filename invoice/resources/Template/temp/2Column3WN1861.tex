...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmett Louise 	 Martinsson} \\
		{\large Vincent 32}\\
		{\large 32016, Budapest, Chiang Mai, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alice Mary 	 Bergman Corp } \\
		{\large Valerie 51}\\
		{\large 36435, Ho Chi Minh, Amnat Charoen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
