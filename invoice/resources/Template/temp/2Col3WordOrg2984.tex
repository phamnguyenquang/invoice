...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Audrey Edward Magnusson Inc} \\
		{\large Carlos 26}\\
		{\large 92284, Frankfurt am Main , Bremen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Abrahamsson } \\
		{\large Liliana 60}\\
		{\large 16412, Venice, Hamburg, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
