...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabella May/Mae 	 Persson} \\
		{\large Payton 98}\\
		{\large 95205, Frankfurt am Main , Chai Nat, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josiah Edward Holmberg Ltd } \\
		{\large Jackson 37}\\
		{\large 65715, Tokyo, California, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
