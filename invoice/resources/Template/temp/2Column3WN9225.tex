...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eric  Alexander  Gunnarsson} \\
		{\large Preston 30}\\
		{\large 65812, Paris, Texas, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexandra Grace 	 Söderberg Ltd } \\
		{\large Gracie 14}\\
		{\large 98877, San Francisco, Hainan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
