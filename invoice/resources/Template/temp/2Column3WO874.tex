...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Miguel Peter Samuelsson Inc} \\
		{\large Mckenzie 6}\\
		{\large 97475, Melbourne, Guangzhou, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Roman Jakobsson } \\
		{\large Kingston 23}\\
		{\large 35826, Frankfurt am Main , California, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
