...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mila Edward Berg} \\
		{\large Jake 3}\\
		{\large 17616, Sydney, Hamburg, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large James Elizabeth 	 Danielsson Ltd } \\
		{\large Quinn 85}\\
		{\large 26561, Barcelona, Saarland, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
