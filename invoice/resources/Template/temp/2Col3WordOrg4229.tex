...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alex Catherine  Fredriksson Pte Ltd} \\
		{\large Sophie 1}\\
		{\large 87141, Washington, Chiang Mai, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makayla Hassan } \\
		{\large Jose 85}\\
		{\large 71103, Amsterdam, Hainan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
