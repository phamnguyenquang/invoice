...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Axel Lindqvist} \\
		{\large Zachary 86}\\
		{\large 59203, Frankfurt am Main , Heibei, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriel Michael Lindqvist Pte Ltd } \\
		{\large Bryson 86}\\
		{\large 18758, SaiGon, Hamburg, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
