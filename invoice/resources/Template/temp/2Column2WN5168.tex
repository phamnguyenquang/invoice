...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mila Larsson} \\
		{\large Max 88}\\
		{\large 45634, Barcelona, Hessen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sophie John Danielsson Pte Ltd } \\
		{\large Daniela 2}\\
		{\large 48785, Frankfurt am Main , Ang Thong, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
