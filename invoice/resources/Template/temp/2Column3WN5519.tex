...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bennett Kate 	 Bergqvist} \\
		{\large Kaylee 14}\\
		{\large 26830, San Francisco, Hessen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evelyn Rose 	 Wallin Corp } \\
		{\large Dominic 90}\\
		{\large 84343, Last Vegas, khanh Hoa, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
