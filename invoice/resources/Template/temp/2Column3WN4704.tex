...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Wyatt Kate 	 Andreasson} \\
		{\large Brian 11}\\
		{\large 27401, New York , Chai Nat, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremiah Lee  Hellström Inc } \\
		{\large Aiden 20}\\
		{\large 71287, Ho Chi Minh, Kentucky, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
