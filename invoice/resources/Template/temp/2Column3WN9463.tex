...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paige Christopher Abrahamsson} \\
		{\large Cole 19}\\
		{\large 34919, Istanbul, Chai Nat, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Graham Victoria Lindholm Inc } \\
		{\large Luke 35}\\
		{\large 65352, Istanbul, Bremen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
