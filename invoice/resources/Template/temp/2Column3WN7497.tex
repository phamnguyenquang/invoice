...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaleb Mary 	 Bengtsson} \\
		{\large Edward 83}\\
		{\large 18875, Lisbon, Indiana, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paul  Alexander  Lindqvist Corp } \\
		{\large Brody 90}\\
		{\large 58739, Ho Chi Minh, Indiana, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
