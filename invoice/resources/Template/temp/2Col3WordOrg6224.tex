...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline John Abrahamsson Inc} \\
		{\large Wyatt 9}\\
		{\large 90047, Istanbul, Chiang Mai, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Damian Johansson } \\
		{\large Steven 98}\\
		{\large 87563, Beijing, Chiang Rai, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
