...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Izabella Thomas Eliasson} \\
		{\large Eliza 14}\\
		{\large 48453, Frankfurt am Main , Texas, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriel Ann  Dahl Inc } \\
		{\large Noah 44}\\
		{\large 42677, Los Angeles, Chiang Mai, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
