...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abigail Christopher Viklund} \\
		{\large Christopher 42}\\
		{\large 44146, Ho Chi Minh, Floria, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wesley May/Mae 	 Berggren Pte Ltd } \\
		{\large Mya 26}\\
		{\large 83973, Berlin, Ang Thong, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
