...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Weston Anne Wikström} \\
		{\large Sofia 30}\\
		{\large 97731, Frankfurt am Main , Saarland, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Naomi James Sjöberg Pte Ltd } \\
		{\large Adam 38}\\
		{\large 42319, Montreal, Bangkok, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
