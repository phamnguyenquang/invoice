...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryce May/Mae 	 Danielsson Ltd} \\
		{\large Jesse 42}\\
		{\large 72556, Stuttgart, Hawaii, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremy Lundström } \\
		{\large Arianna 45}\\
		{\large 29566, Frankfurt am Main , Chai Nat, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
