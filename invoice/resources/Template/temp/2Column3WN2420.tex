...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isaiah Edward Strömberg} \\
		{\large Justin 29}\\
		{\large 83611, Hong Kong, Bangkok, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rose Kate 	 Magnusson Corp } \\
		{\large Julia 5}\\
		{\large 28971, Hanoi, Hessen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
