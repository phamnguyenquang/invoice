...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Weston William Sjögren} \\
		{\large Maya 99}\\
		{\large 34613, Florence, Indiana, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jason Louise 	 Pettersson Inc } \\
		{\large Luke 28}\\
		{\large 73625, Istanbul, Saarland, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
