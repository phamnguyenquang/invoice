...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle Strömberg} \\
		{\large Miguel 66}\\
		{\large 47168, Frankfurt am Main , Bangkok, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emery Victoria Holmgren Inc } \\
		{\large Hunter 32}\\
		{\large 69438, Minsk, Kentucky, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
