...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aubrey Jane Gustafsson} \\
		{\large Isaiah 76}\\
		{\large 33660, New York , Guangdong, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josiah Elizabeth 	 Holmgren Pte Ltd } \\
		{\large Jonathan 9}\\
		{\large 72848, Moscow, Hamburg, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
