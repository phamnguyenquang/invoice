...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline Hansen} \\
		{\large Bentley 15}\\
		{\large 10450, Ho Chi Minh, Ang Thong, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harmony Louise 	 Fredriksson Corp } \\
		{\large Declan 34}\\
		{\large 63281, Frankfurt am Main , Guangdong, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
