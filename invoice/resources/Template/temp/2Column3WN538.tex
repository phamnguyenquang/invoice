...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liam Christopher Svensson} \\
		{\large Valerie 56}\\
		{\large 30092, SaiGon, Guangdong, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ivan Jane Lundin Pte Ltd } \\
		{\large Cayden 63}\\
		{\large 15401, San Francisco, Huabei, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
