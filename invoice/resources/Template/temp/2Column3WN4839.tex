...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel  Alexander  Eklund} \\
		{\large Noah 18}\\
		{\large 82623, Shanghai, Chiang Mai, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mckenzie Elizabeth 	 Gunnarsson Inc } \\
		{\large Mark 93}\\
		{\large 65695, Stuttgart, Chiang Rai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
