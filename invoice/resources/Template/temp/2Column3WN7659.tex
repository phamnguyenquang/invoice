...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grant May/Mae 	 Lindholm} \\
		{\large Emma 12}\\
		{\large 69051, Toronto, Seattles, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maria William Nordin Pte Ltd } \\
		{\large Joseph 28}\\
		{\large 72260, Paris, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
