...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elena Mary 	 Strömberg} \\
		{\large Mia 9}\\
		{\large 20117, Last Vegas, Huabei, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bradley Catherine  Andreasson Corp } \\
		{\large Londyn 42}\\
		{\large 87054, Frankfurt am Main , Chiang Mai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
