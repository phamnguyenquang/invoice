...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Australia & New Zealand Banking Group} \\
		{\large Camden 77}\\
		{\large 98351, Budapest, Hessen, China }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Graham Andreasson } \\
		{\large Braxton 42}\\
		{\large 32338, Melbourne, Amnat Charoen, Indonesia s}\\
    \switchcolumn
