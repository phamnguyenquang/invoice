...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Naomi Catherine  Larsson} \\
		{\large Lilly 40}\\
		{\large 21359, Hong Kong, Kentucky, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katherine David Danielsson Corp } \\
		{\large Bradley 57}\\
		{\large 29650, Vancouver, Seattles, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
