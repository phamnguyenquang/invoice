...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maximus Christopher Svensson} \\
		{\large Katelyn 66}\\
		{\large 25476, Stuttgart, Guangzhou, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juan William Lundberg Corp } \\
		{\large Naomi 23}\\
		{\large 65406, San Francisco, Chiang Rai, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
