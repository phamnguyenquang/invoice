...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezekiel Christopher Ali} \\
		{\large Axel 5}\\
		{\large 79068, Singapore, Bremen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Diego Christopher Bergqvist Corp } \\
		{\large Everett 42}\\
		{\large 93739, Chicago, Hessen, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
