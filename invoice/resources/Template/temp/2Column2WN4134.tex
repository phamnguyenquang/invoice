...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklynn Lundberg} \\
		{\large Adeline 79}\\
		{\large 55985, Ho Chi Minh, Ang Thong, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariana Ann  Ström Corp } \\
		{\large Luca 66}\\
		{\large 66916, Last Vegas, Guangdong, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
