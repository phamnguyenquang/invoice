...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline Catherine  Andreasson} \\
		{\large Luis 83}\\
		{\large 12397, Los Angeles, Henan, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Blake Jane Hansson Corp } \\
		{\large Jesse 26}\\
		{\large 66197, Melbourne, Ang Thong, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
