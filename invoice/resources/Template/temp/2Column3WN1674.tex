...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Annabelle Michael Johansson} \\
		{\large Mason 95}\\
		{\large 68363, Barcelona, Buriam, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayden May/Mae 	 Lindholm Inc } \\
		{\large Willow 11}\\
		{\large 16046, Munich, Hawaii, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
