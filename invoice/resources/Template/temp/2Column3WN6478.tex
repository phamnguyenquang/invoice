...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Grace 	 Löfgren} \\
		{\large Kinsley 57}\\
		{\large 60005, Seoul, khanh Hoa, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Dominic  Alexander  Abrahamsson Corp } \\
		{\large Paige 72}\\
		{\large 50778, Shanghai, Phu Yen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
