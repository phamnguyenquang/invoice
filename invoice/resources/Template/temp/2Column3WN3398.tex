...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mackenzie  Alexander  Lindholm} \\
		{\large Jennifer 24}\\
		{\large 24105, Florence, California, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Edward May/Mae 	 Viklund Corp } \\
		{\large London 42}\\
		{\large 71828, Munich, Chiang Mai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
