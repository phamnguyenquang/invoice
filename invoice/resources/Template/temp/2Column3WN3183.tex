...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liliana Grace 	 Nordström} \\
		{\large Avery 37}\\
		{\large 62315, San Francisco, Texas, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bentley Catherine  Berg Inc } \\
		{\large Sydney 62}\\
		{\large 46383, Beijing, Saarland, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
