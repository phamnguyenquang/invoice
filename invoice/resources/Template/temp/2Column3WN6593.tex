...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melody David Ström} \\
		{\large Easton 47}\\
		{\large 10870, San Francisco, Hawaii, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alana May/Mae 	 Nyberg Pte Ltd } \\
		{\large Landon 91}\\
		{\large 65971, Madrid, Amnat Charoen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
