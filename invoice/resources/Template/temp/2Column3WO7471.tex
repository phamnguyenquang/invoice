...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elena Grace 	 Samuelsson Inc} \\
		{\large Catherine 6}\\
		{\large 69824, San Francisco, Chiang Rai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large David Arvidsson } \\
		{\large Ashley 46}\\
		{\large 58227, Bonn, Bangkok, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
