...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezekiel Catherine  Gunnarsson Inc} \\
		{\large Amy 92}\\
		{\large 21034, Beijing, Bremen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jameson Martinsson } \\
		{\large Thomas 69}\\
		{\large 39770, Ho Chi Minh, Bayern, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
