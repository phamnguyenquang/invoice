...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicholas Sundberg} \\
		{\large Santiago 2}\\
		{\large 14846, Frankfurt am Main , Guangzhou, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julianna May/Mae 	 Dahlberg Corp } \\
		{\large Ivan 61}\\
		{\large 98189, Lisbon, Bayern, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
