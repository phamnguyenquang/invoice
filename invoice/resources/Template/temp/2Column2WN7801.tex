...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gianna Strömberg} \\
		{\large Bradley 37}\\
		{\large 54591, Los Angeles, Chiang Rai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Delilah Rose 	 Abrahamsson Corp } \\
		{\large Paisley 23}\\
		{\large 60458, Toronto, Bayern, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
