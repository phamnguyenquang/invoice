...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josiah Christopher Björklund Inc} \\
		{\large Eva 78}\\
		{\large 16635, Hong Kong, Guangzhou, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Lindholm } \\
		{\large Paige 43}\\
		{\large 51011, Beijing, khanh Hoa, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
