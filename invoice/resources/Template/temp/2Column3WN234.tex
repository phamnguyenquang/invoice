...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Addison Jane Sjöberg} \\
		{\large Amelia 90}\\
		{\large 72038, Singapore, Henan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valentina Marie 	 Lundström Pte Ltd } \\
		{\large Luke 23}\\
		{\large 86477, New York , Bangkok, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
