...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria Victoria Hellström Pte Ltd} \\
		{\large Isla 7}\\
		{\large 82298, Frankfurt am Main , Amnat Charoen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sadie Martinsson } \\
		{\large Elias 52}\\
		{\large 90073, SaiGon, Heibei, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
