...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maya Elizabeth 	 Johansson Inc} \\
		{\large Nolan 41}\\
		{\large 30168, Frankfurt am Main , Kentucky, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Layla Sjögren } \\
		{\large Ryan 23}\\
		{\large 13054, Ho Chi Minh, Hamburg, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
