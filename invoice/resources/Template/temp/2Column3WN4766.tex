...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stella Catherine  Håkansson} \\
		{\large Destiny 97}\\
		{\large 27284, Los Angeles, Binh Thuan, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rose  Alexander  Lundgren Pte Ltd } \\
		{\large Elijah 54}\\
		{\large 89849, Washington, Tuscany, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
