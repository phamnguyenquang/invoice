...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina Isaksson} \\
		{\large Paige 43}\\
		{\large 31490, Moscow, Guangzhou, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Molly  Alexander  Nilsson Ltd } \\
		{\large Kenneth 11}\\
		{\large 42853, Ho Chi Minh, khanh Hoa, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
