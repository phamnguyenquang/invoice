...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  George Kate 	 Andreasson} \\
		{\large Maverick 11}\\
		{\large 65376, Hong Kong, Guangzhou, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaylee Grace 	 Jansson Pte Ltd } \\
		{\large Grace 31}\\
		{\large 82328, Tokyo, Chiang Rai, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
