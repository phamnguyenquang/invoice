...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alex John Engström} \\
		{\large Daniel 44}\\
		{\large 59736, Nha Trang, Hessen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Silas Louise 	 Magnusson Pte Ltd } \\
		{\large Isla 89}\\
		{\large 98237, Toronto, Bangkok, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
