...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Olivia James Hansen} \\
		{\large Kaden 10}\\
		{\large 15067, Shanghai, Kentucky, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maximus Victoria Svensson Corp } \\
		{\large Robert 87}\\
		{\large 84134, Frankfurt am Main , Kentucky, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
