...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luca Elizabeth 	 Löfgren} \\
		{\large Alana 58}\\
		{\large 50550, Budapest, Guangzhou, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alex Louise 	 Norberg Pte Ltd } \\
		{\large Olivia 12}\\
		{\large 96202, Shanghai, Chiang Mai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
