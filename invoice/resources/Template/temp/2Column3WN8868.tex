...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Taylor Grace 	 Jansson} \\
		{\large Autumn 74}\\
		{\large 64208, Los Angeles, Amnat Charoen, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alejandro Edward Hedlund Ltd } \\
		{\large Steven 78}\\
		{\large 69290, Florence, Henan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
