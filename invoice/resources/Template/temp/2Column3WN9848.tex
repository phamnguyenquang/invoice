...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Wesley Mary 	 Wikström} \\
		{\large Lila 3}\\
		{\large 44177, Lisbon, Tuscany, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isaiah  Alexander  Jakobsson Corp } \\
		{\large Kimberly 43}\\
		{\large 83112, Frankfurt am Main , California, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
