...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leonardo Victoria Bergqvist Pte Ltd} \\
		{\large Jade 2}\\
		{\large 33676, Frankfurt am Main , Hainan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elizabeth Jansson } \\
		{\large Abel 45}\\
		{\large 68082, Chicago, Chai Nat, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
