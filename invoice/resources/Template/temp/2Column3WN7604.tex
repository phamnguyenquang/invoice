...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lilly Elizabeth 	 Ström} \\
		{\large Mya 39}\\
		{\large 68455, San Francisco, Hessen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalia Ann  Ekström Corp } \\
		{\large Lucy 50}\\
		{\large 89325, Frankfurt am Main , khanh Hoa, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
