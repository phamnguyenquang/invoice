...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Claire Michael Dahlberg Pte Ltd} \\
		{\large Chloe 66}\\
		{\large 22917, Shanghai, Bremen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carlos Nilsson } \\
		{\large Hailey 27}\\
		{\large 48338, Singapore, Hawaii, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
