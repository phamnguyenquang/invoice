...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cora Robert Nyström} \\
		{\large Benjamin 99}\\
		{\large 94021, San Francisco, Bayern, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Piper Victoria Pettersson Inc } \\
		{\large Nevaeh 2}\\
		{\large 51016, Dublin, Amnat Charoen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
