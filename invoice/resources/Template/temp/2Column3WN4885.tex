...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabella John Berglund} \\
		{\large Ezekiel 32}\\
		{\large 65357, Frankfurt am Main , Hawaii, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aurora Robert Lindberg Ltd } \\
		{\large Jayce 41}\\
		{\large 76010, Toronto, Seattles, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
