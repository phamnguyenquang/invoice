...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sean May/Mae 	 Claesson} \\
		{\large Leah 35}\\
		{\large 93077, Venice, Phu Yen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mila Rose 	 Hermansson Pte Ltd } \\
		{\large Nicole 55}\\
		{\large 37120, Nha Trang, Chai Nat, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
