...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ximena William Hermansson} \\
		{\large Harper 68}\\
		{\large 53126, Venice, Guangzhou, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooke Thomas Arvidsson Pte Ltd } \\
		{\large Hadley 76}\\
		{\large 91251, Moscow, Kentucky, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
