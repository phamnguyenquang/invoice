...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Santiago Edward Gunnarsson} \\
		{\large Nora 28}\\
		{\large 97107, Venice, Kentucky, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large David Christopher Månsson Inc } \\
		{\large Jordan 13}\\
		{\large 63823, Moscow, Chiang Rai, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
