...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Wesley  Alexander  Persson Pte Ltd} \\
		{\large Morgan 48}\\
		{\large 84201, Singapore, Indiana, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabella Sundberg } \\
		{\large Makayla 11}\\
		{\large 79412, Abu Dhabi, California, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
