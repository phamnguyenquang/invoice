...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Trinity Christopher Lund} \\
		{\large Jesse 27}\\
		{\large 57717, Frankfurt am Main , Chai Nat, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Chloe Thomas Löfgren Pte Ltd } \\
		{\large Cooper 1}\\
		{\large 84789, Nha Trang, Hessen, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
