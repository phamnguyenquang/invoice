...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall James Sjöberg Corp} \\
		{\large Preston 4}\\
		{\large 37147, Los Angeles, Bayern, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amelia Bengtsson } \\
		{\large Vanessa 86}\\
		{\large 40160, Frankfurt am Main , Chai Nat, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
