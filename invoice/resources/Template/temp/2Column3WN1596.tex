...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sydney Mary 	 Viklund} \\
		{\large Samantha 92}\\
		{\large 65023, Frankfurt am Main , Chai Nat, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jade Victoria Sjögren Pte Ltd } \\
		{\large Mackenzie 76}\\
		{\large 88186, Hong Kong, Texas, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
