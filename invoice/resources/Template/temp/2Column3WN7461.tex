...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayla Lee  Samuelsson} \\
		{\large Liliana 71}\\
		{\large 67476, Last Vegas, Amnat Charoen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonathan Peter Lind Corp } \\
		{\large David 22}\\
		{\large 71625, Last Vegas, Kentucky, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
