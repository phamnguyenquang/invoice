...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryker Elizabeth 	 Pålsson} \\
		{\large Ryleigh 40}\\
		{\large 52145, Sydney, Ang Thong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Victoria Lindgren Corp } \\
		{\large Alan 4}\\
		{\large 25793, Frankfurt am Main , Floria, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
