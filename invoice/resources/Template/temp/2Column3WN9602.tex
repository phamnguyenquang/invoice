...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abigail Thomas Holmgren} \\
		{\large Nolan 98}\\
		{\large 58049, Vienna, Hessen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reese Kate 	 Gustafsson Ltd } \\
		{\large Alan 33}\\
		{\large 57563, Frankfurt am Main , Floria, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
