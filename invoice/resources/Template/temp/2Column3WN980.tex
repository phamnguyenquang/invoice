...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kayla Mary 	 Falk} \\
		{\large Madelyn 77}\\
		{\large 71578, Berlin, Buriam, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy Elizabeth 	 Bergström Pte Ltd } \\
		{\large Joseph 43}\\
		{\large 53120, San Francisco, Ang Thong, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
