...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joel Robert Holmgren} \\
		{\large Alexis 1}\\
		{\large 74280, Hong Kong, Chiang Rai, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gracie Victoria Lindström Pte Ltd } \\
		{\large Elijah 42}\\
		{\large 41666, Montreal, Indiana, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
