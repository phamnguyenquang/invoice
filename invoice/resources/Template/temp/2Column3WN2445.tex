...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabella May/Mae 	 Lind} \\
		{\large Adrian 7}\\
		{\large 93370, Barcelona, Floria, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eden John Strömberg Pte Ltd } \\
		{\large Londyn 29}\\
		{\large 24639, Abu Dhabi, Guangdong, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
