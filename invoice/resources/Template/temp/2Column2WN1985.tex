...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Catherine Persson} \\
		{\large Giovanni 86}\\
		{\large 60667, Madrid, Kentucky, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sophia Catherine  Nordin Pte Ltd } \\
		{\large Ximena 15}\\
		{\large 86036, Frankfurt am Main , Chai Nat, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
