...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Anna Ann  Blomqvist} \\
		{\large Brandon 84}\\
		{\large 96707, Last Vegas, Saarland, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas  Alexander  Bergqvist Pte Ltd } \\
		{\large Nora 32}\\
		{\large 25023, Last Vegas, Tuscany, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
