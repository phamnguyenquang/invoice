...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sydney May/Mae 	 Sjöberg} \\
		{\large Kaden 31}\\
		{\large 37173, Los Angeles, Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adam Michael Hassan Inc } \\
		{\large Chloe 94}\\
		{\large 92558, Florence, Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
