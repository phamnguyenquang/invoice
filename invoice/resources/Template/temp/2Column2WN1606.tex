...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Diego Nilsson} \\
		{\large Vanessa 48}\\
		{\large 19910, Frankfurt am Main , Bayern, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Scarlett Peter Fransson Pte Ltd } \\
		{\large Samantha 69}\\
		{\large 22049, Amsterdam, Bangkok, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
