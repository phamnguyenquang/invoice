...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everly Elizabeth 	 Axelsson} \\
		{\large London 65}\\
		{\large 42439, Chicago, Bangkok, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicolas Michael Wikström Corp } \\
		{\large Ezra 73}\\
		{\large 39742, Istanbul, Indiana, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
