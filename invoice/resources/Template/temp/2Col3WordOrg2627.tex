...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kayden Rose 	 Berglund Inc} \\
		{\large Parker 61}\\
		{\large 25636, Ho Chi Minh, Guangdong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valeria Björklund } \\
		{\large Maddox 70}\\
		{\large 83772, Last Vegas, Bayern, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
