...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Laila Victoria Gustafsson Pte Ltd} \\
		{\large Christopher 39}\\
		{\large 11116, Dubai, Heibei, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella Eliasson } \\
		{\large Daniela 55}\\
		{\large 73956, Montreal, Texas, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
