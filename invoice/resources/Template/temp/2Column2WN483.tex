...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalynn Claesson} \\
		{\large Sadie 96}\\
		{\large 16604, Frankfurt am Main , Seattles, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte Thomas Falk Corp } \\
		{\large Isaac 15}\\
		{\large 76364, Frankfurt am Main , Huabei, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
