...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juliana James Svensson} \\
		{\large Preston 20}\\
		{\large 16867, Amsterdam, Indiana, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryker May/Mae 	 Isaksson Corp } \\
		{\large Aurora 68}\\
		{\large 34913, Frankfurt am Main , khanh Hoa, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
