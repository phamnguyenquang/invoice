...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline  Alexander  Åkesson} \\
		{\large Carson 7}\\
		{\large 26871, Berlin, Indiana, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josiah Elizabeth 	 Jönsson Pte Ltd } \\
		{\large Lilly 34}\\
		{\large 21971, Montreal, Chai Nat, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
