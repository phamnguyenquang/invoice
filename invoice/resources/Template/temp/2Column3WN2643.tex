...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carson May/Mae 	 Andreasson} \\
		{\large Sarah 48}\\
		{\large 23736, Osaka, Ang Thong, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Timothy Christopher Holmberg Ltd } \\
		{\large Ashton 21}\\
		{\large 24600, Last Vegas, Kentucky, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
