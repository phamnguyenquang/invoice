...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katelyn Lee  Gustafsson Inc} \\
		{\large Brady 63}\\
		{\large 80394, Frankfurt am Main , Hainan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Layla Mårtensson } \\
		{\large Ethan 11}\\
		{\large 15462, Minsk, Hessen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
