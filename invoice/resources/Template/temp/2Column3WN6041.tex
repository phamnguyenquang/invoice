...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ashley Louise 	 Lindqvist} \\
		{\large Christopher 71}\\
		{\large 10991, Last Vegas, Binh Thuan, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brianna Ann  Engström Pte Ltd } \\
		{\large Noah 38}\\
		{\large 34137, Nha Trang, Amnat Charoen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
