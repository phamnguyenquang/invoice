...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ximena Louise 	 Persson Inc} \\
		{\large Brayden 91}\\
		{\large 71868, Moscow, Guangdong, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large David Bergqvist } \\
		{\large Graham 3}\\
		{\large 31160, Frankfurt am Main , Chai Nat, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
