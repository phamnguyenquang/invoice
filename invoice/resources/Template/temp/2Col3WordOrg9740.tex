...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eden May/Mae 	 Henriksson Pte Ltd} \\
		{\large Katelyn 69}\\
		{\large 17263, San Francisco, Buriam, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alejandro Norberg } \\
		{\large Jocelyn 93}\\
		{\large 24551, Paris, Chiang Rai, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
