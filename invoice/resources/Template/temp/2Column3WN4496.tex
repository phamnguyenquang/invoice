...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elena Elizabeth 	 Jönsson} \\
		{\large Max 27}\\
		{\large 86950, Taipei, Seattles, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexandra Elizabeth 	 Månsson Corp } \\
		{\large Joshua 50}\\
		{\large 62686, Montreal, Chai Nat, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
