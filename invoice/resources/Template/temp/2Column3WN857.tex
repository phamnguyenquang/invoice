...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julianna John Hansen} \\
		{\large Serenity 37}\\
		{\large 23198, Budapest, khanh Hoa, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anthony Robert Åkesson Corp } \\
		{\large Elijah 94}\\
		{\large 35285, Amsterdam, Saarland, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
