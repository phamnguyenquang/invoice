...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaitlyn Edward Nilsson Pte Ltd} \\
		{\large Layla 10}\\
		{\large 56238, Vancouver, Bremen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luca Dahlberg } \\
		{\large Mateo 2}\\
		{\large 50822, Frankfurt am Main , Bayern, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
