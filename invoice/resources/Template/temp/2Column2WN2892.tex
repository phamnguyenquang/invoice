...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Benjamin Håkansson} \\
		{\large Emmanuel 45}\\
		{\large 94111, Frankfurt am Main , Hawaii, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kayden Louise 	 Berg Inc } \\
		{\large Christopher 29}\\
		{\large 81094, Hanoi, Buriam, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
