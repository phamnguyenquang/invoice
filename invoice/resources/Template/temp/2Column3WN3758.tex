...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melody Michael Persson} \\
		{\large Abel 54}\\
		{\large 46923, Frankfurt am Main , Tuscany, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grace Robert Wallin Corp } \\
		{\large Emmett 89}\\
		{\large 15812, Madrid, Binh Thuan, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
