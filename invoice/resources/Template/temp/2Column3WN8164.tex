...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brian Elizabeth 	 Sandström} \\
		{\large Robert 74}\\
		{\large 68896, Budapest, Indiana, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joseph  Alexander  Lundberg Corp } \\
		{\large Brady 20}\\
		{\large 53091, Beijing, Saarland, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
