...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra  Alexander  Hansen} \\
		{\large Grace 2}\\
		{\large 49253, Toronto, Bremen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayden Rose 	 Blom Pte Ltd } \\
		{\large Zoey 39}\\
		{\large 79390, Last Vegas, Huabei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
