...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  London Edward Dahlberg} \\
		{\large Jaden 80}\\
		{\large 69259, Singapore, Chiang Mai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Norah David Andreasson Corp } \\
		{\large Brody 89}\\
		{\large 53476, Beijing, Saarland, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
