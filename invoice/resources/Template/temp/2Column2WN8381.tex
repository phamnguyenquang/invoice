...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isla Samuelsson} \\
		{\large Leilani 37}\\
		{\large 43862, Vancouver, Seattles, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lydia Ann  Viklund Inc } \\
		{\large Londyn 5}\\
		{\large 50766, Frankfurt am Main , Bayern, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
