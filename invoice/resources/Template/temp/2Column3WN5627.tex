...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mark Mary 	 Lundin} \\
		{\large Ruby 18}\\
		{\large 65225, Ho Chi Minh, Bremen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Izabella John Ali Corp } \\
		{\large Brayden 58}\\
		{\large 23000, Frankfurt am Main , Amnat Charoen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
