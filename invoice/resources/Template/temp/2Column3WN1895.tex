...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Payton Victoria Mohamed} \\
		{\large Gael 21}\\
		{\large 31520, Istanbul, Tuscany, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalia James Danielsson Pte Ltd } \\
		{\large Carlos 77}\\
		{\large 28624, Boston, Hawaii, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
