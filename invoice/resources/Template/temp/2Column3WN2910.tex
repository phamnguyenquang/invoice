...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emery Michael Lindholm} \\
		{\large Miguel 44}\\
		{\large 28235, San Francisco, Bremen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hudson Thomas Björklund Corp } \\
		{\large Avery 61}\\
		{\large 44822, Montreal, Hessen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
