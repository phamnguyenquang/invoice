...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Molly May/Mae 	 Samuelsson Ltd} \\
		{\large Hayden 31}\\
		{\large 58121, Taipei, Amnat Charoen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maxwell Lindgren } \\
		{\large Ellie 97}\\
		{\large 81506, Nha Trang, Bremen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
