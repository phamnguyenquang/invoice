...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryan  Alexander  Holmberg} \\
		{\large Grayson 67}\\
		{\large 67265, Frankfurt am Main , Bangkok, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aiden Jane Fransson Pte Ltd } \\
		{\large Preston 28}\\
		{\large 68043, Dubai, khanh Hoa, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
