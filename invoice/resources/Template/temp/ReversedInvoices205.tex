...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  All India Institute of Medical Sciences, Delhi} \\
		{\large Damian 54}\\
		{\large 57339, Dubai, Hessen, laos}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Santiago Hansen } \\
		{\large Sebastian 86}\\
		{\large 59191, Melbourne, Chiang Rai, VietNam}\\
    \switchcolumn
