...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Violet Elizabeth 	 Sjögren} \\
		{\large Kai 54}\\
		{\large 19127, Budapest, Bremen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Louise 	 Pettersson Ltd } \\
		{\large Sara 96}\\
		{\large 51682, Ho Chi Minh, Bayern, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
