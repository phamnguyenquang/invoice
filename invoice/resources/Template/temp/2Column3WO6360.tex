...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope Michael Jakobsson Corp} \\
		{\large Amy 90}\\
		{\large 81475, SaiGon, Chiang Rai, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mason Holmberg } \\
		{\large Axel 75}\\
		{\large 29390, Amsterdam, Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
