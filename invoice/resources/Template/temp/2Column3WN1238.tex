...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vanessa Louise 	 Åberg} \\
		{\large Tucker 33}\\
		{\large 46797, Stuttgart, Buriam, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan May/Mae 	 Andersson Corp } \\
		{\large Landon 94}\\
		{\large 31187, Los Angeles, Chiang Mai, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
