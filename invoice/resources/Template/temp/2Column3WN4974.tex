...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Skylar Kate 	 Hedlund} \\
		{\large Bella 35}\\
		{\large 88279, San Francisco, Indiana, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Ann  Lundberg Ltd } \\
		{\large Isabella 27}\\
		{\large 95821, Budapest, Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
