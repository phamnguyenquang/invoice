...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emilia Thomas Eriksson} \\
		{\large Charlotte 74}\\
		{\large 37971, Lisbon, Bayern, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ayden Elizabeth 	 Samuelsson Corp } \\
		{\large Maria 97}\\
		{\large 79064, Vancouver, Binh Thuan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
