...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicholas Kate 	 Johansson} \\
		{\large Marcus 88}\\
		{\large 74164, Hong Kong, Saarland, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lauren  Alexander  Sjögren Pte Ltd } \\
		{\large Samantha 11}\\
		{\large 37872, Sydney, Hamburg, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
