...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Damian Nilsson} \\
		{\large Jose 86}\\
		{\large 65000, Frankfurt am Main , Tuscany, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jace Elizabeth 	 Nyström Pte Ltd } \\
		{\large Isla 95}\\
		{\large 29909, Washington, Kentucky, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
