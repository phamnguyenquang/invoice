...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall Marie 	 Pålsson} \\
		{\large Adeline 9}\\
		{\large 38303, Florence, Kentucky, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryan Thomas Hellström Ltd } \\
		{\large Robert 81}\\
		{\large 17178, Frankfurt am Main , Chai Nat, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
