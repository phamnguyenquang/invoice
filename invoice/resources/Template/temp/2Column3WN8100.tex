...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla  Alexander  Svensson} \\
		{\large Elijah 48}\\
		{\large 69348, Budapest, Guangdong, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kai Catherine  Sjöberg Ltd } \\
		{\large Jaxon 59}\\
		{\large 26076, Taipei, Hamburg, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
