...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bradley Rose 	 Sjögren} \\
		{\large Xavier 60}\\
		{\large 94304, Last Vegas, Heibei, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Benjamin  Alexander  Berglund Pte Ltd } \\
		{\large Sophia 93}\\
		{\large 91546, Washington, Indiana, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
