...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  National University of Defense Technology} \\
		{\large Ivy 41}\\
		{\large 13150, Denver, Binh Thuan, Indonesia s}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Savannah Danielsson } \\
		{\large Ava 95}\\
		{\large 50104, Milan, Phu Yen, Japan }\\
    \switchcolumn
