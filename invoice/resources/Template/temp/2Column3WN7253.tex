...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Payton May/Mae 	 Lindström} \\
		{\large Brooklynn 53}\\
		{\large 42281, Paris, Tuscany, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charles  Alexander  Henriksson Pte Ltd } \\
		{\large Valerie 8}\\
		{\large 84295, Florence, Texas, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
