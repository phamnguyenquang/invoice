...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mariah Lee  Johansson} \\
		{\large Ivy 10}\\
		{\large 23339, New York , Seattles, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eliza Louise 	 Berg Pte Ltd } \\
		{\large Lillian 12}\\
		{\large 99714, Nha Trang, Chiang Rai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
