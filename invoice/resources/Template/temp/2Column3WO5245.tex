...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriella Louise 	 Ali Ltd} \\
		{\large Kennedy 47}\\
		{\large 19623, Melbourne, Binh Thuan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harper Nordström } \\
		{\large Aiden 5}\\
		{\large 84924, Frankfurt am Main , Huabei, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
