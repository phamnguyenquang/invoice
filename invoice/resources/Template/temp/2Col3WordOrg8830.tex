...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caleb Marie 	 Lundqvist Inc} \\
		{\large Sofia 79}\\
		{\large 38023, Frankfurt am Main , Binh Thuan, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adriana Björk } \\
		{\large Kevin 94}\\
		{\large 30764, Stuttgart, khanh Hoa, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
