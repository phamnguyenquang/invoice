...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrew Robert Hedlund Inc} \\
		{\large Alan 23}\\
		{\large 11926, Frankfurt am Main , Amnat Charoen, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathan Söderberg } \\
		{\large Brooke 50}\\
		{\large 94331, Dublin, khanh Hoa, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
