...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Willow May/Mae 	 Jonsson} \\
		{\large Kingston 21}\\
		{\large 62963, Frankfurt am Main , Buriam, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gracie Ann  Wikström Pte Ltd } \\
		{\large Nathan 16}\\
		{\large 62914, Budapest, Hainan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
