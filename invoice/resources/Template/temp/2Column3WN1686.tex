...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexander Edward Gustafsson} \\
		{\large Luca 77}\\
		{\large 70737, Vancouver, Hawaii, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elijah May/Mae 	 Nordström Ltd } \\
		{\large Hannah 93}\\
		{\large 42226, Florence, Huabei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
