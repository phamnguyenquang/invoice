...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalyn David Norberg} \\
		{\large Morgan 61}\\
		{\large 41442, San Francisco, Indiana, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sophia Edward Lundgren Inc } \\
		{\large Hailey 81}\\
		{\large 21127, Vancouver, Saarland, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
