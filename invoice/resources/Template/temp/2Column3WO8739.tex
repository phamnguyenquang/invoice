...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victoria Grace 	 Bergqvist Pte Ltd} \\
		{\large Naomi 68}\\
		{\large 59143, San Francisco, khanh Hoa, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn Mattsson } \\
		{\large Logan 61}\\
		{\large 49002, Los Angeles, Tuscany, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
