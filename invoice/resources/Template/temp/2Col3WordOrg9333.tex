...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rebecca May/Mae 	 Berggren Ltd} \\
		{\large Landon 90}\\
		{\large 39286, Ho Chi Minh, Huabei, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie Martinsson } \\
		{\large Carlos 22}\\
		{\large 18344, Montreal, Kentucky, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
