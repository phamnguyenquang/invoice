...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Xavier Rose 	 Danielsson} \\
		{\large Michael 32}\\
		{\large 95397, Dubai, Tuscany, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Serenity Catherine  Eliasson Pte Ltd } \\
		{\large Andrew 59}\\
		{\large 94812, Hong Kong, Indiana, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
