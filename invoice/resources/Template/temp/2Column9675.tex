...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lila Forsberg Corp} \\
		{\large Nathaniel 19}\\
		{\large 84669, Frankfurt am Main , Texas, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brayden Blomqvist } \\
		{\large Angelina 67}\\
		{\large 35888, Frankfurt am Main , Hawaii, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
