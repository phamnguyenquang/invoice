...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Thomas  Alexander  Falk} \\
		{\large Brielle 61}\\
		{\large 24599, Munich, Chiang Mai, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jordan Lee  Henriksson Corp } \\
		{\large Alan 77}\\
		{\large 19615, Frankfurt am Main , Hessen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
