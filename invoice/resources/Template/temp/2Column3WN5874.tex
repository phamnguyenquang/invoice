...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leah Christopher Martinsson} \\
		{\large Lucas 77}\\
		{\large 16034, London , Binh Thuan, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emily Thomas Andersson Ltd } \\
		{\large Hayden 64}\\
		{\large 73001, Montreal, Phu Yen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
