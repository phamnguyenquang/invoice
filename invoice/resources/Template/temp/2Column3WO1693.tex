...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Scarlett Louise 	 Nordin Corp} \\
		{\large Camden 47}\\
		{\large 33509, Stuttgart, Henan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emily Larsson } \\
		{\large Vanessa 87}\\
		{\large 98486, San Francisco, Saarland, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
