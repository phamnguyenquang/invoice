...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Peyton Catherine  Jansson} \\
		{\large Destiny 8}\\
		{\large 82550, Venice, Guangzhou, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Penelope Louise 	 Lind Corp } \\
		{\large Paul 13}\\
		{\large 91458, Venice, Indiana, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
