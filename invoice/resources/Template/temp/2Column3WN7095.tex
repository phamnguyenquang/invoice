...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Justin David Pålsson} \\
		{\large Bailey 60}\\
		{\large 27799, Frankfurt am Main , Tuscany, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaitlyn Marie 	 Nyström Pte Ltd } \\
		{\large Brianna 20}\\
		{\large 42335, Hong Kong, California, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
