...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kinsley Peter Lind} \\
		{\large Avery 61}\\
		{\large 36026, Barcelona, Chai Nat, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juliana John Forsberg Corp } \\
		{\large Nolan 90}\\
		{\large 28852, Frankfurt am Main , Indiana, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
