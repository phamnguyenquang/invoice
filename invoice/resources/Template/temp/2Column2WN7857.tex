...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melanie Hansen} \\
		{\large Luis 99}\\
		{\large 27388, Frankfurt am Main , Buriam, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reagan James Fredriksson Corp } \\
		{\large Antonio 93}\\
		{\large 15258, Frankfurt am Main , Hessen, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
