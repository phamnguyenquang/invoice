...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liliana Karlsson Ltd} \\
		{\large Isabelle 51}\\
		{\large 75920, Hong Kong, Tuscany, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adrian Berglund } \\
		{\large Hunter 42}\\
		{\large 78898, Frankfurt am Main , Hainan, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
