...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gael Michael Andersson} \\
		{\large Colin 93}\\
		{\large 16419, Stuttgart, Amnat Charoen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valerie Rose 	 Martinsson Ltd } \\
		{\large Katelyn 12}\\
		{\large 17718, Lisbon, California, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
