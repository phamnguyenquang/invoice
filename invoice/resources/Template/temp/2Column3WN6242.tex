...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaliyah Louise 	 Samuelsson} \\
		{\large Mark 8}\\
		{\large 25088, Stuttgart, Guangzhou, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryan Edward Eriksson Pte Ltd } \\
		{\large Catherine 80}\\
		{\large 43703, Paris, Bremen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
