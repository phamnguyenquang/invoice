...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brian Victoria Lindgren} \\
		{\large Declan 89}\\
		{\large 98609, Ho Chi Minh, Chai Nat, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Lee  Fransson Ltd } \\
		{\large Destiny 65}\\
		{\large 60926, Budapest, Guangzhou, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
