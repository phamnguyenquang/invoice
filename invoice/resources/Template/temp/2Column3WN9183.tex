...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Anna Elizabeth 	 Ek} \\
		{\large Hudson 77}\\
		{\large 52459, Dublin, Guangzhou, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Londyn James Andersson Corp } \\
		{\large Christopher 10}\\
		{\large 38784, New York , Bremen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
