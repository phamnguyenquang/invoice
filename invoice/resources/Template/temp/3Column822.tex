...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Carl von Ossietzky University of Oldenburg} \\
		{\large Rebecca 98}\\
		{\large 27217, Taipei, Binh Thuan, VietNam}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Eliana Ali } \\
		{\large Ethan 70}\\
		{\large 49375, Last Vegas, Guangdong, Australia }\\
    \switchcolumn
