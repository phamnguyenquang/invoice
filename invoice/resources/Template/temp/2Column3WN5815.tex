...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ashley Christopher Åkesson} \\
		{\large Henry 60}\\
		{\large 63158, Chicago, California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mary  Alexander  Norberg Inc } \\
		{\large Jameson 68}\\
		{\large 94448, Denver, Bremen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
