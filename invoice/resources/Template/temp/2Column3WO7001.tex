...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklyn Louise 	 Pettersson Pte Ltd} \\
		{\large Rebecca 6}\\
		{\large 11508, Vienna, California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Audrey Engström } \\
		{\large Joshua 99}\\
		{\large 43983, Abu Dhabi, Huabei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
