...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sofia Michael Mattsson} \\
		{\large Nicholas 92}\\
		{\large 95779, Hong Kong, Chiang Mai, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie Rose 	 Dahlberg Inc } \\
		{\large London 56}\\
		{\large 87685, Seoul, Hainan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
