...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lincoln  Alexander  Danielsson} \\
		{\large Carter 57}\\
		{\large 17454, SaiGon, Heibei, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adam James Mattsson Pte Ltd } \\
		{\large Lilly 28}\\
		{\large 98860, Vancouver, Hamburg, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
