...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Addison Anne Forsberg} \\
		{\large Adam 21}\\
		{\large 73257, Berlin, Saarland, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paige James Fredriksson Pte Ltd } \\
		{\large Rachel 9}\\
		{\large 21717, Abu Dhabi, Bayern, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
