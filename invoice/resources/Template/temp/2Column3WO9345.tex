...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Quinn Michael Nyström Corp} \\
		{\large Isaiah 36}\\
		{\large 41240, Sydney, Seattles, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Londyn Bengtsson } \\
		{\large Riley 42}\\
		{\large 74532, Frankfurt am Main , Kentucky, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
