...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryce Catherine  Jakobsson} \\
		{\large Eva 84}\\
		{\large 97660, Denver, Chai Nat, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Matthew John Forsberg Pte Ltd } \\
		{\large Antonio 96}\\
		{\large 44512, Hong Kong, Hamburg, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
