...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Genesis Catherine  Berggren} \\
		{\large Benjamin 36}\\
		{\large 45913, New York , Binh Thuan, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brody Mary 	 Sjöberg Pte Ltd } \\
		{\large Molly 60}\\
		{\large 29356, Hong Kong, Bayern, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
