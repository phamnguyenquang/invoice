...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hazel Amy  Mårtensson} \\
		{\large Mila 55}\\
		{\large 70053, Nha Trang, Guangzhou, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julianna  Alexander  Eliasson Ltd } \\
		{\large Elena 66}\\
		{\large 18367, Last Vegas, khanh Hoa, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
