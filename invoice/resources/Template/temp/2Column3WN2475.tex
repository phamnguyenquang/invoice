...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mckenzie John Holm} \\
		{\large Morgan 46}\\
		{\large 19654, London , Henan, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Claire Grace 	 Lundqvist Pte Ltd } \\
		{\large Joel 92}\\
		{\large 78789, Los Angeles, Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
