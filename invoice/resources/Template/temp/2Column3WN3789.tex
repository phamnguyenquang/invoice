...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Connor Anne Nordin} \\
		{\large Mckenzie 60}\\
		{\large 11404, Osaka, Saarland, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon Elizabeth 	 Andreasson Pte Ltd } \\
		{\large Kayla 46}\\
		{\large 63419, Frankfurt am Main , Chiang Rai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
