...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dominic Amy  Hellström} \\
		{\large Hayden 60}\\
		{\large 80201, Abu Dhabi, khanh Hoa, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maximus Amy  Sjöberg Inc } \\
		{\large Diego 45}\\
		{\large 44428, Amsterdam, Phu Yen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
