...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Anna Catherine  Holm} \\
		{\large Layla 78}\\
		{\large 10447, Frankfurt am Main , California, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valeria John Ahmed Ltd } \\
		{\large Henry 58}\\
		{\large 99105, Chicago, Tuscany, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
