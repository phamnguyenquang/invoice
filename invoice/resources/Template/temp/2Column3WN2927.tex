...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Riley Robert Blomqvist} \\
		{\large Patrick 45}\\
		{\large 61440, Berlin, Guangzhou, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gracie Lee  Lundberg Pte Ltd } \\
		{\large Liliana 8}\\
		{\large 25732, Melbourne, Hamburg, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
