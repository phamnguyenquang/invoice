...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline Christopher Holmberg} \\
		{\large Anna 37}\\
		{\large 52603, Berlin, Floria, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valentina Michael Dahlberg Ltd } \\
		{\large Jayla 55}\\
		{\large 62037, Last Vegas, Hamburg, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
