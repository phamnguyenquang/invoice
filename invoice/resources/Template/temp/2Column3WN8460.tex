...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adrian May/Mae 	 Holmgren} \\
		{\large Giovanni 39}\\
		{\large 96361, Frankfurt am Main , Ang Thong, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Landon Robert Ekström Ltd } \\
		{\large Luca 53}\\
		{\large 51309, Shanghai, Ang Thong, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
