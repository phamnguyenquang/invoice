...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Owen Christopher Wikström} \\
		{\large Ariana 15}\\
		{\large 48752, Vienna, Saarland, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubrey Elizabeth 	 Bergman Ltd } \\
		{\large Adam 26}\\
		{\large 55315, New York , Bremen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
