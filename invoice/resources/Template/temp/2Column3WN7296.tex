...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maximus Elizabeth 	 Nyberg} \\
		{\large George 56}\\
		{\large 63685, Frankfurt am Main , Buriam, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rylee David Löfgren Pte Ltd } \\
		{\large Jayden 34}\\
		{\large 57697, Moscow, Buriam, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
