...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaron May/Mae 	 Åkesson} \\
		{\large Valerie 40}\\
		{\large 63579, Beijing, California, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julianna Ann  Nordin Ltd } \\
		{\large Samuel 64}\\
		{\large 96029, Montreal, Saarland, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
