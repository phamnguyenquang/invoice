...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Austin Elizabeth 	 Larsson} \\
		{\large Julia 18}\\
		{\large 62747, Melbourne, California, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evan Amy  Bergström Ltd } \\
		{\large Zoe 85}\\
		{\large 35192, Frankfurt am Main , Guangdong, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
