...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harper Jane Lundin Pte Ltd} \\
		{\large Aiden 93}\\
		{\large 78844, Frankfurt am Main , Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Penelope Lundgren } \\
		{\large Reagan 45}\\
		{\large 46860, Tokyo, Buriam, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
