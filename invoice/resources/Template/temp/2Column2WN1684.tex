...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bentley Martinsson} \\
		{\large Naomi 80}\\
		{\large 23807, Frankfurt am Main , Phu Yen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harper Christopher Andreasson Inc } \\
		{\large Steven 32}\\
		{\large 85460, Abu Dhabi, Floria, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
