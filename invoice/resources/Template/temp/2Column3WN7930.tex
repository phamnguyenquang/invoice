...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklynn John Månsson} \\
		{\large Sydney 95}\\
		{\large 41207, Lisbon, Texas, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makayla Victoria Henriksson Inc } \\
		{\large Gavin 83}\\
		{\large 99467, Los Angeles, Ang Thong, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
