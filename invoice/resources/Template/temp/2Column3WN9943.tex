...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla John Eklund} \\
		{\large Caleb 20}\\
		{\large 32336, Venice, Guangzhou, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Malachi William Andersson Inc } \\
		{\large Lily 34}\\
		{\large 84799, Tokyo, Kentucky, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
