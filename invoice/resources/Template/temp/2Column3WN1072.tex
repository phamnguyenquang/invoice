...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Connor William Jakobsson} \\
		{\large Michelle 5}\\
		{\large 85104, Barcelona, Amnat Charoen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kevin May/Mae 	 Olofsson Ltd } \\
		{\large Eva 44}\\
		{\large 46372, Amsterdam, Phu Yen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
