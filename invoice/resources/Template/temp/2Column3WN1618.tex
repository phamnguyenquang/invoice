...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly Robert Sundberg} \\
		{\large Caleb 7}\\
		{\large 10078, Nha Trang, Bremen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Silas Ann  Bergman Corp } \\
		{\large Sawyer 28}\\
		{\large 88604, Frankfurt am Main , Hamburg, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
