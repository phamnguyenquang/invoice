...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Reagan Anne Söderberg} \\
		{\large Kingston 24}\\
		{\large 11797, London , Amnat Charoen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaden Thomas Eriksson Pte Ltd } \\
		{\large Kaden 17}\\
		{\large 76821, Ho Chi Minh, Seattles, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
