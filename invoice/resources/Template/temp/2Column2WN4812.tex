...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaden Sjögren} \\
		{\large Abigail 23}\\
		{\large 83458, Hong Kong, Texas, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eliana John Danielsson Pte Ltd } \\
		{\large Ayden 23}\\
		{\large 55360, Amsterdam, Chiang Mai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
