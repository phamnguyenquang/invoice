...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michael Rose 	 Nyström} \\
		{\large Madelyn 45}\\
		{\large 22277, Frankfurt am Main , Binh Thuan, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grayson Michael Ström Ltd } \\
		{\large Hadley 35}\\
		{\large 85399, Chicago, Huabei, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
