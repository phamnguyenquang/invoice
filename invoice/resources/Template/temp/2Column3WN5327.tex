...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mya Grace 	 Forsberg} \\
		{\large Joshua 31}\\
		{\large 64721, Frankfurt am Main , Seattles, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Antonio Amy  Berg Pte Ltd } \\
		{\large Jaxon 98}\\
		{\large 79518, Budapest, Bayern, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
