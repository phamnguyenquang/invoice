...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rachel Amy  Mattsson Pte Ltd} \\
		{\large Aaron 15}\\
		{\large 41602, Frankfurt am Main , Huabei, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mariah Danielsson } \\
		{\large Carson 41}\\
		{\large 15251, Singapore, Hamburg, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
