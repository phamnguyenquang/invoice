...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Robert Mattsson Pte Ltd} \\
		{\large Ashton 33}\\
		{\large 23550, Taipei, Guangzhou, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adeline Åberg } \\
		{\large Elizabeth 60}\\
		{\large 20185, Frankfurt am Main , Guangdong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
