...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall Rose 	 Lindgren} \\
		{\large Brody 53}\\
		{\large 35523, Frankfurt am Main , Hessen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Serenity Edward Norberg Corp } \\
		{\large Lilly 54}\\
		{\large 93129, Montreal, Saarland, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
