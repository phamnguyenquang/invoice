...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zoe Edward Berggren} \\
		{\large Cooper 90}\\
		{\large 96245, Toronto, Guangzhou, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sawyer  Alexander  Lundgren Inc } \\
		{\large John 56}\\
		{\large 40366, Vancouver, Hawaii, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
