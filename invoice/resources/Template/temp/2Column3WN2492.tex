...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nevaeh Catherine  Sandström} \\
		{\large Sawyer 32}\\
		{\large 74924, Hong Kong, Hamburg, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryder Grace 	 Berggren Pte Ltd } \\
		{\large Vivian 82}\\
		{\large 87574, Hanoi, Huabei, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
