...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Miles David Lindström Pte Ltd} \\
		{\large Riley 45}\\
		{\large 73099, Last Vegas, Floria, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaron Sjöberg } \\
		{\large Eliza 22}\\
		{\large 28454, Frankfurt am Main , Guangdong, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
