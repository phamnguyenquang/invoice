...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayden Åberg} \\
		{\large Bryan 22}\\
		{\large 69723, Frankfurt am Main , Binh Thuan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rebecca William Hermansson Corp } \\
		{\large Bryan 68}\\
		{\large 46288, Frankfurt am Main , Guangdong, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
