...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joel  Alexander  Sandberg} \\
		{\large Ashton 95}\\
		{\large 83956, Frankfurt am Main , Henan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaliyah Louise 	 Öberg Inc } \\
		{\large Everly 24}\\
		{\large 29448, Amsterdam, California, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
