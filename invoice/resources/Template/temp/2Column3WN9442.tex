...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Roman Amy  Nyström} \\
		{\large Everly 96}\\
		{\large 17655, Vienna, Binh Thuan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden  Alexander  Lindgren Inc } \\
		{\large Ariana 71}\\
		{\large 29396, Boston, Ang Thong, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
