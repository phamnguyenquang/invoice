...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Athena  Alexander  Claesson} \\
		{\large Parker 4}\\
		{\large 48284, Last Vegas, Seattles, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brianna Robert Nyström Corp } \\
		{\large Logan 87}\\
		{\large 67387, Chicago, Guangdong, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
