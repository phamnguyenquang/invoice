...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carter Olofsson} \\
		{\large Isaiah 71}\\
		{\large 40450, San Francisco, Bangkok, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Khloe Victoria Sandström Pte Ltd } \\
		{\large Robert 26}\\
		{\large 62599, Bonn, California, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
