...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eliana Pettersson Pte Ltd} \\
		{\large Kimberly 67}\\
		{\large 68535, Frankfurt am Main , Henan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexander Lundström } \\
		{\large Jude 80}\\
		{\large 36202, Washington, California, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
