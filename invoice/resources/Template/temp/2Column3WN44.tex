...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isla Anne Lundqvist} \\
		{\large Arianna 40}\\
		{\large 17935, Taipei, Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryson Thomas Gustafsson Pte Ltd } \\
		{\large Michelle 22}\\
		{\large 89166, Milan, Amnat Charoen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
