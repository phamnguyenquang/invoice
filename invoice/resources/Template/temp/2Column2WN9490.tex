...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brady Fredriksson} \\
		{\large Hunter 54}\\
		{\large 17947, San Francisco, Hessen, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Dominic Christopher Björklund Pte Ltd } \\
		{\large Delilah 31}\\
		{\large 11728, Venice, Ang Thong, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
