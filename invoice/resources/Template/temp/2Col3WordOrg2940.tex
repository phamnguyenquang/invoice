...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Claire May/Mae 	 Sandström Corp} \\
		{\large Paige 24}\\
		{\large 34836, Nha Trang, Indiana, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valentina Mattsson } \\
		{\large Makenzie 52}\\
		{\large 64050, Stuttgart, Chiang Mai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
