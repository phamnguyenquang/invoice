...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brody Michael Lundberg} \\
		{\large Julian 50}\\
		{\large 36852, Ho Chi Minh, Indiana, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Miguel Robert Björk Pte Ltd } \\
		{\large Jonah 55}\\
		{\large 54586, Budapest, Kentucky, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
