...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniel Jane Sjöberg} \\
		{\large Mason 21}\\
		{\large 24536, Boston, Guangdong, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabella Ann  Andreasson Pte Ltd } \\
		{\large Leo 89}\\
		{\large 45048, Los Angeles, Saarland, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
