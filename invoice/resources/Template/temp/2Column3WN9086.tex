...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aubrey May/Mae 	 Hellström} \\
		{\large Alexis 82}\\
		{\large 84365, Shanghai, Amnat Charoen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maya Louise 	 Berggren Pte Ltd } \\
		{\large Amelia 24}\\
		{\large 10305, Melbourne, khanh Hoa, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
