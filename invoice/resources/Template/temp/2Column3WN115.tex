...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaitlyn James Nordin} \\
		{\large Sara 41}\\
		{\large 89153, Moscow, Chiang Rai, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexandra Louise 	 Fransson Pte Ltd } \\
		{\large Vincent 70}\\
		{\large 67328, San Francisco, Binh Thuan, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
