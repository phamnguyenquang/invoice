...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro Henriksson Pte Ltd} \\
		{\large Brianna 51}\\
		{\large 85948, Nha Trang, Indiana, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Weston Pålsson } \\
		{\large Ryleigh 81}\\
		{\large 97764, Frankfurt am Main , Buriam, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
