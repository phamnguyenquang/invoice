...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ethan David Johansson} \\
		{\large Isaiah 3}\\
		{\large 11731, Montreal, Henan, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Patrick  Alexander  Strömberg Ltd } \\
		{\large Eric 56}\\
		{\large 74917, Chicago, Guangzhou, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
