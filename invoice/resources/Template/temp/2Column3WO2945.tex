...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicole Christopher Lindqvist Inc} \\
		{\large Ella 24}\\
		{\large 32407, Hong Kong, Bangkok, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy Fredriksson } \\
		{\large Ashley 3}\\
		{\large 81516, Stuttgart, Hawaii, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
