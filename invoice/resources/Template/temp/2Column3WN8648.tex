...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabella David Danielsson} \\
		{\large Alan 91}\\
		{\large 67654, Istanbul, Chiang Mai, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aurora May/Mae 	 Samuelsson Ltd } \\
		{\large Kevin 58}\\
		{\large 73367, Singapore, khanh Hoa, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
