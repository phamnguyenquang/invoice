...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Peyton Mårtensson} \\
		{\large Sara 45}\\
		{\large 94986, Singapore, Kentucky, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harper Christopher Ahmed Pte Ltd } \\
		{\large Victor 75}\\
		{\large 58876, Madrid, Binh Thuan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
