...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaiden Louise 	 Öberg Inc} \\
		{\large Violet 24}\\
		{\large 21821, Los Angeles, California, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Connor Forsberg } \\
		{\large Melody 38}\\
		{\large 93319, Frankfurt am Main , Guangdong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
