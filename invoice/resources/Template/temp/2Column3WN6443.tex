...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  John Lee  Svensson} \\
		{\large Mia 72}\\
		{\large 25139, Frankfurt am Main , Phu Yen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore Louise 	 Abrahamsson Pte Ltd } \\
		{\large Silas 3}\\
		{\large 58055, Berlin, Bangkok, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
