...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elise Grace 	 Jansson} \\
		{\large Jonathan 56}\\
		{\large 86149, Vancouver, Hainan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bennett Victoria Bergqvist Inc } \\
		{\large Andrea 14}\\
		{\large 92284, Beijing, Heibei, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
