...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriel Louise 	 Björklund} \\
		{\large Lily 24}\\
		{\large 74972, Taipei, Bangkok, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley Mary 	 Nyström Corp } \\
		{\large Kayden 10}\\
		{\large 33949, Vancouver, Guangdong, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
