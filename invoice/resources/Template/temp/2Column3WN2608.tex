...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles Anne Sjögren} \\
		{\large Eli 68}\\
		{\large 97692, Rome, Texas, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kevin Robert Jansson Pte Ltd } \\
		{\large Gabrielle 79}\\
		{\large 39725, San Francisco, Chiang Rai, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
