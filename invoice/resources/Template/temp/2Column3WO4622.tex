...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Athena Elizabeth 	 Sjöberg Corp} \\
		{\large Londyn 60}\\
		{\large 64451, San Francisco, Bayern, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Scarlett Gunnarsson } \\
		{\large Vanessa 85}\\
		{\large 79456, Milan, Seattles, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
