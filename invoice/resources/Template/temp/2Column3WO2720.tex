...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie Grace 	 Gunnarsson Inc} \\
		{\large Rylee 28}\\
		{\large 61733, Tokyo, Bayern, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabella Gunnarsson } \\
		{\large Ezekiel 17}\\
		{\large 11149, Frankfurt am Main , Guangzhou, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
