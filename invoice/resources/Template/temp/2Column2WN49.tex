...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Parker Axelsson} \\
		{\large Mary 51}\\
		{\large 18542, Nha Trang, Chiang Rai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ruby David Hedlund Corp } \\
		{\large Lilly 19}\\
		{\large 40132, Vancouver, Amnat Charoen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
