...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremy May/Mae 	 Andersson} \\
		{\large Morgan 25}\\
		{\large 17663, Vancouver, Bangkok, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paul William Hermansson Inc } \\
		{\large Norah 73}\\
		{\large 75425, New York , Indiana, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
