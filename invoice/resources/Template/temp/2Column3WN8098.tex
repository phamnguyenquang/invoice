...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalie Christopher Lindgren} \\
		{\large Cameron 19}\\
		{\large 19339, Boston, Guangdong, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Arianna Elizabeth 	 Lundberg Pte Ltd } \\
		{\large Amelia 85}\\
		{\large 36994, Dublin, Floria, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
