...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jessica Victoria Abrahamsson} \\
		{\large Vincent 60}\\
		{\large 51530, Vancouver, Ang Thong, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Elizabeth 	 Sjöberg Pte Ltd } \\
		{\large Brianna 46}\\
		{\large 70120, Paris, Bremen, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
