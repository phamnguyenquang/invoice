...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Braxton Ann  Hellström} \\
		{\large Isabelle 70}\\
		{\large 97678, Chicago, Hawaii, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmett Victoria Håkansson Ltd } \\
		{\large Vincent 2}\\
		{\large 53358, Last Vegas, Phu Yen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
