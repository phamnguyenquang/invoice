...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bennett Peter Jönsson} \\
		{\large Edward 19}\\
		{\large 25453, Dubai, Hainan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luca Catherine  Sandberg Inc } \\
		{\large Nora 40}\\
		{\large 89551, Frankfurt am Main , Amnat Charoen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
