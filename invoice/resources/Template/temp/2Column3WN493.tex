...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jasmine Anne Andreasson} \\
		{\large Samuel 88}\\
		{\large 93496, Osaka, Guangdong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michael May/Mae 	 Åkesson Inc } \\
		{\large Riley 87}\\
		{\large 70892, Frankfurt am Main , Guangzhou, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
