...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Thomas Ahmed} \\
		{\large Audrey 60}\\
		{\large 76637, Hanoi, Bremen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juliana Elizabeth 	 Johansson Pte Ltd } \\
		{\large Eva 29}\\
		{\large 89524, San Francisco, Binh Thuan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
