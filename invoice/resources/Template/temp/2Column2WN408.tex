...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lucy Magnusson} \\
		{\large Madison 76}\\
		{\large 36867, Berlin, Guangdong, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jace Louise 	 Lind Ltd } \\
		{\large Christopher 21}\\
		{\large 85294, Sydney, Guangzhou, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
