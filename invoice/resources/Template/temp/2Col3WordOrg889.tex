...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zachary David Lundgren Corp} \\
		{\large Annabelle 88}\\
		{\large 43833, Taipei, Amnat Charoen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Autumn Claesson } \\
		{\large Julian 9}\\
		{\large 73087, Frankfurt am Main , Bremen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
