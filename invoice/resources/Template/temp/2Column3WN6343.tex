...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniela Michael Mattsson} \\
		{\large Jonah 3}\\
		{\large 87775, Ho Chi Minh, Texas, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ian Grace 	 Åberg Corp } \\
		{\large Emmanuel 1}\\
		{\large 49853, Frankfurt am Main , Hawaii, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
