...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everly Catherine  Viklund} \\
		{\large Ryker 91}\\
		{\large 65505, Amsterdam, California, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jordyn Amy  Blomqvist Corp } \\
		{\large Aubree 42}\\
		{\large 65634, Beijing, Phu Yen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
