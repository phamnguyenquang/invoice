...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Claire Jane Arvidsson} \\
		{\large Molly 34}\\
		{\large 30848, Nha Trang, Bayern, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samuel Christopher Isaksson Corp } \\
		{\large Nolan 36}\\
		{\large 95997, Nha Trang, khanh Hoa, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
