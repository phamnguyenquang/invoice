...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Catherine  Forsberg Pte Ltd} \\
		{\large Theodore 44}\\
		{\large 71102, Budapest, Chiang Rai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christian Lindström } \\
		{\large Jacob 80}\\
		{\large 12172, Munich, Hessen, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
