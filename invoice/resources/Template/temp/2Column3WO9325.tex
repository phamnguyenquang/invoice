...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariana Elizabeth 	 Ahmed Pte Ltd} \\
		{\large Brian 50}\\
		{\large 45627, Florence, Hessen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valeria Berglund } \\
		{\large London 94}\\
		{\large 45239, San Francisco, Heibei, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
