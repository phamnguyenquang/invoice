...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte Henriksson} \\
		{\large Aiden 55}\\
		{\large 33056, San Francisco, Chai Nat, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mary Christopher Mohamed Ltd } \\
		{\large Noah 32}\\
		{\large 31702, Milan, Huabei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
