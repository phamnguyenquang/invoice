...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sarah Marie 	 Lundström Ltd} \\
		{\large Audrey 51}\\
		{\large 23580, Singapore, Huabei, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large London Wikström } \\
		{\large Bryan 80}\\
		{\large 90679, Ho Chi Minh, Ang Thong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
