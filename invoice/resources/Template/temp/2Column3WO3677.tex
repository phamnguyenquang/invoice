...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lucy Catherine  Gunnarsson Ltd} \\
		{\large Maddox 94}\\
		{\large 49848, Stuttgart, California, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryker Lindholm } \\
		{\large Adriana 23}\\
		{\large 71479, Istanbul, Huabei, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
