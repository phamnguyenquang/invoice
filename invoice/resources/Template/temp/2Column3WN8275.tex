...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina Amy  Ek} \\
		{\large Kenneth 33}\\
		{\large 52896, San Francisco, Seattles, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Graham Anne Nordström Ltd } \\
		{\large Kayla 73}\\
		{\large 48332, Melbourne, Binh Thuan, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
