...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dominic May/Mae 	 Henriksson Corp} \\
		{\large Noah 18}\\
		{\large 44261, Dublin, Hawaii, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cooper Mårtensson } \\
		{\large Lily 28}\\
		{\large 64497, Melbourne, California, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
