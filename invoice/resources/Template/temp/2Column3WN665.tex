...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lillian Louise 	 Andersson} \\
		{\large Aurora 96}\\
		{\large 56083, Lisbon, Chiang Rai, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charles Edward Wallin Inc } \\
		{\large Hazel 29}\\
		{\large 13936, SaiGon, Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
