...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aidan Thomas Svensson Corp} \\
		{\large Sean 96}\\
		{\large 49308, Abu Dhabi, Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sawyer Hellström } \\
		{\large Xavier 18}\\
		{\large 32537, Frankfurt am Main , California, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
