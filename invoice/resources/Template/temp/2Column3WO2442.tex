...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kayden Thomas Lindholm Corp} \\
		{\large Maddox 66}\\
		{\large 95094, Sydney, Ang Thong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayla Magnusson } \\
		{\large Victor 88}\\
		{\large 45797, Frankfurt am Main , Ang Thong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
