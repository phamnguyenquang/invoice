...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jake Catherine  Blom} \\
		{\large Amy 89}\\
		{\large 68180, Minsk, Chiang Mai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathan May/Mae 	 Lund Ltd } \\
		{\large Stephanie 82}\\
		{\large 54857, Frankfurt am Main , Hamburg, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
