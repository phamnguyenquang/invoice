...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicolas Christopher Wallin} \\
		{\large Isla 30}\\
		{\large 10376, Frankfurt am Main , Henan, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zoey Lee  Lindholm Ltd } \\
		{\large Lilly 47}\\
		{\large 18689, San Francisco, Saarland, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
