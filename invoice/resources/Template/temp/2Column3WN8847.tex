...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gavin Elizabeth 	 Persson} \\
		{\large Jayla 94}\\
		{\large 59594, Berlin, Guangzhou, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jasmine Elizabeth 	 Jonsson Pte Ltd } \\
		{\large Alexa 57}\\
		{\large 23837, Shanghai, Chiang Rai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
