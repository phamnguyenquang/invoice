...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bella Robert Holmberg} \\
		{\large Logan 3}\\
		{\large 23499, Taipei, Bremen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jessica Robert Lindström Pte Ltd } \\
		{\large Luna 19}\\
		{\large 47082, Los Angeles, Hamburg, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
