...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Micah Peter Söderberg Pte Ltd} \\
		{\large Leah 74}\\
		{\large 61376, Budapest, Chiang Mai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harper Åkesson } \\
		{\large Andrea 70}\\
		{\large 78297, Frankfurt am Main , Heibei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
