...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adriana Elizabeth 	 Lindström} \\
		{\large Mateo 77}\\
		{\large 17090, Tokyo, Ang Thong, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gianna Grace 	 Ali Corp } \\
		{\large Carter 60}\\
		{\large 20970, San Francisco, Amnat Charoen, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
