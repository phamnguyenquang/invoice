...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rebecca Elizabeth 	 Eliasson} \\
		{\large Jordan 17}\\
		{\large 45648, Nha Trang, Kentucky, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Izabella Michael Lundqvist Pte Ltd } \\
		{\large Aidan 59}\\
		{\large 63249, Sydney, Phu Yen, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
