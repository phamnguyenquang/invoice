...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eleanor Robert Andreasson Inc} \\
		{\large Matthew 14}\\
		{\large 26300, Los Angeles, Chiang Mai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large James Sundberg } \\
		{\large Everett 44}\\
		{\large 60839, Budapest, Amnat Charoen, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
