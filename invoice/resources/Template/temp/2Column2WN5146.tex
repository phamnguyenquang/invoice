...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Blake Pettersson} \\
		{\large Cora 4}\\
		{\large 19487, Osaka, Henan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrew  Alexander  Persson Pte Ltd } \\
		{\large Adeline 57}\\
		{\large 25395, Last Vegas, Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
