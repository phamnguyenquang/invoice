...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Savannah Lee  Fransson} \\
		{\large Sarah 8}\\
		{\large 10758, Melbourne, Chiang Rai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Colton Robert Arvidsson Inc } \\
		{\large Emmanuel 64}\\
		{\large 34609, Vancouver, California, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
