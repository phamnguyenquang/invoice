...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tucker Lindberg} \\
		{\large Rachel 90}\\
		{\large 28617, Taipei, Hessen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caroline Christopher Berglund Ltd } \\
		{\large Brianna 16}\\
		{\large 67241, Frankfurt am Main , Phu Yen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
