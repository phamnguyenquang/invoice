...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alan  Alexander  Nordin} \\
		{\large Adalyn 22}\\
		{\large 69525, Montreal, Ang Thong, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ashton Christopher Mohamed Corp } \\
		{\large Declan 36}\\
		{\large 68264, Nha Trang, California, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
