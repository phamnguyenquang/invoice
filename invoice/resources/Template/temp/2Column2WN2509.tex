...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aurora Viklund} \\
		{\large Brody 79}\\
		{\large 21019, Florence, Henan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklynn Christopher Berggren Ltd } \\
		{\large Aiden 52}\\
		{\large 18104, Abu Dhabi, Tuscany, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
