...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremiah Robert Arvidsson} \\
		{\large Wyatt 7}\\
		{\large 27472, Chicago, Saarland, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bella Edward Berglund Pte Ltd } \\
		{\large Khloe 88}\\
		{\large 12468, Vienna, Hainan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
