...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alaina John Andreasson} \\
		{\large Jordan 30}\\
		{\large 64501, Berlin, khanh Hoa, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angelina Louise 	 Nyberg Inc } \\
		{\large Oliver 30}\\
		{\large 91686, Frankfurt am Main , Bremen, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
