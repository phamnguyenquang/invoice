...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lincoln Lindqvist} \\
		{\large Ariel 98}\\
		{\large 44681, Barcelona, Buriam, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryder Louise 	 Mattsson Pte Ltd } \\
		{\large Isla 95}\\
		{\large 28744, Ho Chi Minh, Binh Thuan, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
