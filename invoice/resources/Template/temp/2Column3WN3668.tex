...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aubree Christopher Löfgren} \\
		{\large Gavin 20}\\
		{\large 15070, Toronto, Hessen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jacob Grace 	 Lindholm Inc } \\
		{\large Zoey 20}\\
		{\large 63983, New York , Saarland, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
