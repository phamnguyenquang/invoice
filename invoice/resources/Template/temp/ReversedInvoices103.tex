...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Guelph} \\
		{\large Aria 44}\\
		{\large 66067, Nha Trang, Chai Nat, South Africa }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Valeria Söderberg } \\
		{\large Savannah 91}\\
		{\large 29553, Frankfurt am Main , Binh Thuan, Russia}\\
    \switchcolumn
