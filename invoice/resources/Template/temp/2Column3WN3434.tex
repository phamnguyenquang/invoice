...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Justin James Sjöberg} \\
		{\large Everett 33}\\
		{\large 50144, Lisbon, Floria, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samantha Anne Nyström Pte Ltd } \\
		{\large Victoria 60}\\
		{\large 53359, Nha Trang, Phu Yen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
