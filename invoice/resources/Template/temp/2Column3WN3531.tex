...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Micah Louise 	 Bergström} \\
		{\large Brantley 28}\\
		{\large 38532, Montreal, Indiana, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juliana Elizabeth 	 Söderberg Corp } \\
		{\large Katherine 29}\\
		{\large 97057, Moscow, Seattles, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
