...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ellie Anne Ekström} \\
		{\large Molly 15}\\
		{\large 21821, Toronto, Ang Thong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liliana Louise 	 Håkansson Inc } \\
		{\large Olivia 82}\\
		{\large 67642, San Francisco, Binh Thuan, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
