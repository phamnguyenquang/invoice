...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope Kate 	 Bergman} \\
		{\large Brantley 58}\\
		{\large 54825, Budapest, Amnat Charoen, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Axel Elizabeth 	 Viklund Corp } \\
		{\large Gabrielle 58}\\
		{\large 10102, Toronto, Binh Thuan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
