...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mason Anne Dahlberg Inc} \\
		{\large Rylee 50}\\
		{\large 99991, Abu Dhabi, California, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maverick Strömberg } \\
		{\large Faith 12}\\
		{\large 39992, Frankfurt am Main , Guangzhou, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
