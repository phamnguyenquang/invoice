...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Genesis James Axelsson Corp} \\
		{\large Maria 75}\\
		{\large 16886, San Francisco, Indiana, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leah Mattsson } \\
		{\large Asher 87}\\
		{\large 47567, Frankfurt am Main , Kentucky, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
