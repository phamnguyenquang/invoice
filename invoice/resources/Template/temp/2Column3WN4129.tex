...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  William Elizabeth 	 Henriksson} \\
		{\large Jayla 78}\\
		{\large 96729, San Francisco, Ang Thong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lydia Anne Lind Inc } \\
		{\large Adalyn 10}\\
		{\large 21081, Dublin, Buriam, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
