...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Allison Thomas Åberg} \\
		{\large Daniel 7}\\
		{\large 79922, San Francisco, Bremen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Savannah Robert Hansen Pte Ltd } \\
		{\large Victoria 65}\\
		{\large 16112, Abu Dhabi, Ang Thong, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
