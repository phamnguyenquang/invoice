...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Addison Edward Åberg} \\
		{\large Grant 93}\\
		{\large 75060, Hong Kong, Henan, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maxwell Catherine  Nilsson Pte Ltd } \\
		{\large Katherine 22}\\
		{\large 75940, London , Hawaii, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
