...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sara Louise 	 Jönsson} \\
		{\large Katelyn 31}\\
		{\large 56181, Frankfurt am Main , Bayern, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryker Elizabeth 	 Berglund Inc } \\
		{\large Leonardo 39}\\
		{\large 87667, Vancouver, Guangdong, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
