...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mackenzie Louise 	 Mårtensson Inc} \\
		{\large Hayden 23}\\
		{\large 18191, New York , Indiana, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Quinn Andersson } \\
		{\large Peyton 4}\\
		{\large 59986, Amsterdam, Heibei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
