...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryleigh Robert Gustafsson Corp} \\
		{\large Aliyah 31}\\
		{\large 99886, Frankfurt am Main , Bayern, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julianna Nyström } \\
		{\large Matthew 68}\\
		{\large 63685, Amsterdam, Chiang Mai, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
