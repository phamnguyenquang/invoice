...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lucas Andersson} \\
		{\large Grant 95}\\
		{\large 22102, Frankfurt am Main , Hainan, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon  Alexander  Axelsson Corp } \\
		{\large Zoe 26}\\
		{\large 13070, Taipei, Binh Thuan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
