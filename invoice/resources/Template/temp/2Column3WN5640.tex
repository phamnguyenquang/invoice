...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryson Michael Wikström} \\
		{\large Willow 39}\\
		{\large 32573, Berlin, Hamburg, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jessica Catherine  Hassan Pte Ltd } \\
		{\large Sophia 78}\\
		{\large 67599, San Francisco, Heibei, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
