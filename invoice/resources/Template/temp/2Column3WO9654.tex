...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle Louise 	 Axelsson Pte Ltd} \\
		{\large Valentina 80}\\
		{\large 40120, Frankfurt am Main , Guangdong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sydney Bergman } \\
		{\large Layla 86}\\
		{\large 13963, Tokyo, Henan, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
