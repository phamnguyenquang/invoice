...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lucy Peter Löfgren Pte Ltd} \\
		{\large Madison 46}\\
		{\large 61859, Frankfurt am Main , Kentucky, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriel Lundström } \\
		{\large Kennedy 5}\\
		{\large 65749, Taipei, Hessen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
