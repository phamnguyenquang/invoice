...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicholas Lindqvist Inc} \\
		{\large Brayden 90}\\
		{\large 34543, Los Angeles, Guangzhou, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Santiago Forsberg } \\
		{\large Evan 61}\\
		{\large 12211, Frankfurt am Main , Chiang Mai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
