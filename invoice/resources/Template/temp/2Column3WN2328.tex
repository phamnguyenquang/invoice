...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hannah John Nordström} \\
		{\large Bryan 72}\\
		{\large 49516, Ho Chi Minh, Bayern, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hudson  Alexander  Månsson Corp } \\
		{\large Taylor 14}\\
		{\large 77749, Nha Trang, Saarland, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
