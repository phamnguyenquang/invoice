...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aubrey Danielsson Pte Ltd} \\
		{\large Jocelyn 89}\\
		{\large 46172, Washington, Bangkok, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aurora Abrahamsson } \\
		{\large Adalyn 15}\\
		{\large 31003, Frankfurt am Main , Huabei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
