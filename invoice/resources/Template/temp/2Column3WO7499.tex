...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katherine Kate 	 Samuelsson Pte Ltd} \\
		{\large Alejandro 8}\\
		{\large 89541, Vancouver, Texas, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wesley Svensson } \\
		{\large Caroline 90}\\
		{\large 80411, Frankfurt am Main , Chiang Mai, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
