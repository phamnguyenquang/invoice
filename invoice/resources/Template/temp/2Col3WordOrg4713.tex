...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lincoln Anne Hansson Pte Ltd} \\
		{\large Joel 72}\\
		{\large 40238, Frankfurt am Main , Kentucky, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Audrey Dahlberg } \\
		{\large Nicholas 99}\\
		{\large 38922, Moscow, Ang Thong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
