...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra  Alexander  Fransson} \\
		{\large Isaac 68}\\
		{\large 84933, Munich, Henan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesse Louise 	 Lundström Pte Ltd } \\
		{\large Audrey 38}\\
		{\large 10459, Melbourne, Hawaii, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
