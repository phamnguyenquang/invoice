...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Genesis Svensson} \\
		{\large Jaden 74}\\
		{\large 25868, Venice, Floria, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson Mary 	 Olsson Corp } \\
		{\large Jonathan 30}\\
		{\large 99182, Frankfurt am Main , Chiang Rai, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
