...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madelyn Peter Jakobsson Pte Ltd} \\
		{\large Ivy 11}\\
		{\large 94044, Melbourne, Tuscany, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexandra Eliasson } \\
		{\large Andrew 44}\\
		{\large 25285, Frankfurt am Main , Henan, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
