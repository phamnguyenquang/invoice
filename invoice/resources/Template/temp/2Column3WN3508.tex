...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonah Ann  Jakobsson} \\
		{\large Eliana 36}\\
		{\large 55080, Munich, Chiang Mai, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maddox  Alexander  Lundgren Pte Ltd } \\
		{\large Emmett 33}\\
		{\large 45194, Chicago, Chiang Rai, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
