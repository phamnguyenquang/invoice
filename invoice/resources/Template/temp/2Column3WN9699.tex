...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariana William Norberg} \\
		{\large Violet 79}\\
		{\large 72149, Tokyo, Bangkok, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Olivia Kate 	 Svensson Corp } \\
		{\large Joel 36}\\
		{\large 94771, Barcelona, Guangdong, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
