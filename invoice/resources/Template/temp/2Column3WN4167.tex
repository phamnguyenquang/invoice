...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline Peter Olofsson} \\
		{\large Lillian 18}\\
		{\large 47952, Los Angeles, Binh Thuan, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angel Christopher Norberg Ltd } \\
		{\large Harper 21}\\
		{\large 67813, Ho Chi Minh, Ang Thong, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
