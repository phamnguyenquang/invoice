...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ivan Bergström} \\
		{\large Ximena 93}\\
		{\large 92376, Washington, Tuscany, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gavin Christopher Jonsson Pte Ltd } \\
		{\large Lila 53}\\
		{\large 18499, Shanghai, Bangkok, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
