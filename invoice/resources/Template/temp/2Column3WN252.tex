...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Graham Robert Persson} \\
		{\large Angel 26}\\
		{\large 29725, San Francisco, Bayern, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabrielle Catherine  Claesson Pte Ltd } \\
		{\large Brody 17}\\
		{\large 89467, Madrid, Bayern, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
