...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Damian Mary 	 Martinsson} \\
		{\large Reagan 35}\\
		{\large 53230, Barcelona, Guangdong, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alaina Christopher Olofsson Ltd } \\
		{\large Katherine 26}\\
		{\large 58835, Melbourne, Guangzhou, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
