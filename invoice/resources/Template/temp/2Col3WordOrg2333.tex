...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leilani Kate 	 Ekström Pte Ltd} \\
		{\large Mia 46}\\
		{\large 64396, Sydney, Heibei, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Xavier Gunnarsson } \\
		{\large Jaxson 30}\\
		{\large 23906, Frankfurt am Main , Ang Thong, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
