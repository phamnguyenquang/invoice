...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Edward Grace 	 Jansson Pte Ltd} \\
		{\large Christian 61}\\
		{\large 22512, Amsterdam, Guangdong, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sofia Åberg } \\
		{\large Mia 56}\\
		{\large 62658, Frankfurt am Main , Hamburg, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
