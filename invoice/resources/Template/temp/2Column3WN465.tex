...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elise Louise 	 Hansen} \\
		{\large Riley 92}\\
		{\large 69427, Nha Trang, Chai Nat, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camden Amy  Gustafsson Pte Ltd } \\
		{\large Genesis 86}\\
		{\large 35492, Washington, Ang Thong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
