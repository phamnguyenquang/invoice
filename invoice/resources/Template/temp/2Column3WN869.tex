...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alex Victoria Lundqvist} \\
		{\large Jeremy 1}\\
		{\large 72380, Rome, Chiang Rai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abigail Grace 	 Dahl Inc } \\
		{\large Lauren 22}\\
		{\large 18377, San Francisco, Binh Thuan, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
