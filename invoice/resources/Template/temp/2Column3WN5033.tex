...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesse  Alexander  Eklund} \\
		{\large Alexis 87}\\
		{\large 64075, Hong Kong, Chiang Rai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juliana Lee  Ekström Pte Ltd } \\
		{\large Colin 91}\\
		{\large 63928, Abu Dhabi, Amnat Charoen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
