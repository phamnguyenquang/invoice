...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Richard David Wallin} \\
		{\large Alana 78}\\
		{\large 67318, Ho Chi Minh, Binh Thuan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katherine Louise 	 Pettersson Pte Ltd } \\
		{\large Zoe 15}\\
		{\large 54075, London , Texas, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
