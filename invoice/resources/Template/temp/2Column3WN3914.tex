...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victor Amy  Johansson} \\
		{\large Isabelle 91}\\
		{\large 37202, Washington, Hessen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Calvin Michael Pettersson Corp } \\
		{\large Tucker 36}\\
		{\large 73103, San Francisco, Hamburg, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
