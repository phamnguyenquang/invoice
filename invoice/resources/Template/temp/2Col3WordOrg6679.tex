...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josiah Victoria Arvidsson Ltd} \\
		{\large Alexandra 7}\\
		{\large 69627, Sydney, Huabei, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Trinity Wikström } \\
		{\large Nicolas 92}\\
		{\large 28758, Frankfurt am Main , Saarland, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
