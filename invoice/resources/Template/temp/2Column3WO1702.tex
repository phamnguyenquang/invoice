...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eliza  Alexander  Lindgren Corp} \\
		{\large Lauren 2}\\
		{\large 98645, Budapest, khanh Hoa, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jack Danielsson } \\
		{\large Sara 24}\\
		{\large 96503, Melbourne, Henan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
