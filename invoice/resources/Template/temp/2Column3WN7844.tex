...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Steven Victoria Jakobsson} \\
		{\large Madison 53}\\
		{\large 17820, Dublin, Indiana, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayla Peter Eriksson Corp } \\
		{\large Steven 12}\\
		{\large 81544, San Francisco, Amnat Charoen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
