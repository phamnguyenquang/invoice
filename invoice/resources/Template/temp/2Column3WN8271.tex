...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tucker Michael Mattsson} \\
		{\large Damian 28}\\
		{\large 71243, Frankfurt am Main , Saarland, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adam Elizabeth 	 Strömberg Pte Ltd } \\
		{\large Michelle 54}\\
		{\large 21301, Toronto, Floria, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
