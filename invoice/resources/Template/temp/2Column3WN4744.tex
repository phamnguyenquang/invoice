...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hayden Mary 	 Hermansson} \\
		{\large Isabel 88}\\
		{\large 77303, Vienna, Kentucky, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large George Robert Forsberg Pte Ltd } \\
		{\large Elias 13}\\
		{\large 74166, Shanghai, Amnat Charoen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
