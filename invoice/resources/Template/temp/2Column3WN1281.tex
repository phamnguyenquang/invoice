...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leah Victoria Mattsson} \\
		{\large Grant 79}\\
		{\large 18753, Hong Kong, Chiang Mai, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Miles Elizabeth 	 Fransson Ltd } \\
		{\large Maximus 26}\\
		{\large 34353, Washington, Hainan, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
