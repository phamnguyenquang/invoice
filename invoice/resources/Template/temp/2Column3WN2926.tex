...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lydia Marie 	 Andersson} \\
		{\large Faith 39}\\
		{\large 61775, Last Vegas, Hainan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liam Michael Nordström Inc } \\
		{\large Mia 69}\\
		{\large 56067, Montreal, Kentucky, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
