...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bradley Elizabeth 	 Andersson Corp} \\
		{\large Hazel 4}\\
		{\large 39336, Stuttgart, Binh Thuan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gael Nordin } \\
		{\large Noah 75}\\
		{\large 21004, Frankfurt am Main , Hainan, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
