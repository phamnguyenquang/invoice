...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jasmine Robert Gunnarsson} \\
		{\large Colin 19}\\
		{\large 25162, New York , Bangkok, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Giovanni Louise 	 Bergqvist Ltd } \\
		{\large Roman 16}\\
		{\large 63551, Seoul, Texas, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
