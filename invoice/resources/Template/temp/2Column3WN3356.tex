...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Malachi Elizabeth 	 Sandström} \\
		{\large Preston 84}\\
		{\large 70490, Denver, Saarland, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anthony Catherine  Henriksson Ltd } \\
		{\large Vivian 70}\\
		{\large 47061, Dubai, Tuscany, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
