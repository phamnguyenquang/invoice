...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leilani Rose 	 Blomqvist} \\
		{\large Jonathan 68}\\
		{\large 81422, Osaka, Seattles, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas Christopher Ek Pte Ltd } \\
		{\large Ezra 88}\\
		{\large 91300, Last Vegas, Bangkok, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
