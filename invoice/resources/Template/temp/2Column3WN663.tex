...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Diego Elizabeth 	 Hassan} \\
		{\large Hazel 16}\\
		{\large 98147, Budapest, Bremen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elise William Lundin Pte Ltd } \\
		{\large Nicolas 14}\\
		{\large 90326, Abu Dhabi, Huabei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
