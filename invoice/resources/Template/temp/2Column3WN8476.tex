...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hudson Louise 	 Arvidsson} \\
		{\large Connor 70}\\
		{\large 19101, New York , Chai Nat, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rachel William Öberg Pte Ltd } \\
		{\large Juliana 18}\\
		{\large 75321, Barcelona, Bangkok, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
