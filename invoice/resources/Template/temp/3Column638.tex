...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  National University of Colombia} \\
		{\large Bryce 11}\\
		{\large 95134, Frankfurt am Main , Binh Thuan, Indonesia s}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Eliza Lindholm } \\
		{\large Alice 5}\\
		{\large 90000, Ho Chi Minh, Bremen, South Korea}\\
    \switchcolumn
