...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julianna Rose 	 Strömberg} \\
		{\large Timothy 54}\\
		{\large 19696, Dubai, California, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mark Amy  Söderberg Ltd } \\
		{\large Ava 44}\\
		{\large 15975, Ho Chi Minh, Heibei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
