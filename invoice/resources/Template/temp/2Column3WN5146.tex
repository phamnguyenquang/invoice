...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Reagan Grace 	 Eliasson} \\
		{\large Lucas 49}\\
		{\large 45992, Frankfurt am Main , Indiana, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Miles Marie 	 Arvidsson Ltd } \\
		{\large Daniela 72}\\
		{\large 75977, San Francisco, Hainan, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
