...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bentley Robert Bengtsson Corp} \\
		{\large Maria 92}\\
		{\large 61711, Washington, Buriam, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aurora Mohamed } \\
		{\large Aubrey 77}\\
		{\large 56141, Frankfurt am Main , khanh Hoa, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
