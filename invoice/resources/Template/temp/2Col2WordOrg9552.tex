...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joshua Samuelsson Pte Ltd} \\
		{\large Abel 94}\\
		{\large 34206, Frankfurt am Main , Hessen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alyssa Axelsson } \\
		{\large Aliyah 56}\\
		{\large 59929, Hong Kong, Buriam, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
