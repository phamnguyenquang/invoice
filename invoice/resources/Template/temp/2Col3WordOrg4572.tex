...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Micah Edward Lindström Pte Ltd} \\
		{\large Zachary 83}\\
		{\large 68471, Frankfurt am Main , California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carter Lundin } \\
		{\large Matthew 36}\\
		{\large 55002, Madrid, Chai Nat, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
