...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hailey Thomas Andersson Pte Ltd} \\
		{\large Alexis 77}\\
		{\large 35335, Frankfurt am Main , Binh Thuan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariana Lundqvist } \\
		{\large Jeremiah 57}\\
		{\large 96390, Budapest, Chiang Mai, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
