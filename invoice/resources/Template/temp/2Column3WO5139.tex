...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Molly Victoria Lindqvist Pte Ltd} \\
		{\large Mckenzie 41}\\
		{\large 12039, Budapest, Indiana, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evan Löfgren } \\
		{\large Valeria 57}\\
		{\large 65949, Frankfurt am Main , Guangdong, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
