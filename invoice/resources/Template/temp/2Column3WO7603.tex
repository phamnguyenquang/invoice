...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sydney Louise 	 Håkansson Ltd} \\
		{\large Austin 41}\\
		{\large 60952, Montreal, California, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daisy Andersson } \\
		{\large Mateo 59}\\
		{\large 83293, Beijing, Guangzhou, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
