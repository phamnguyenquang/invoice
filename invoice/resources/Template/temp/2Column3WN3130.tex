...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicolas Robert Lindberg} \\
		{\large Jude 37}\\
		{\large 34649, Frankfurt am Main , Ang Thong, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carson Christopher Olsson Inc } \\
		{\large Rose 29}\\
		{\large 46663, Melbourne, Bremen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
