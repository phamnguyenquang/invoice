...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emily Rose 	 Andersson} \\
		{\large Bennett 52}\\
		{\large 86809, Toronto, Seattles, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon Peter Pettersson Inc } \\
		{\large Alexander 93}\\
		{\large 92694, Melbourne, Saarland, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
