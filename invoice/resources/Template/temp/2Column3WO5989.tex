...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ashton Christopher Ekström Pte Ltd} \\
		{\large Genesis 14}\\
		{\large 36900, New York , Ang Thong, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Miguel Lindholm } \\
		{\large Eric 80}\\
		{\large 38659, Singapore, Tuscany, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
