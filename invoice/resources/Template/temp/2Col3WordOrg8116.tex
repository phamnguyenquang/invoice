...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Margaret Christopher Sjögren Pte Ltd} \\
		{\large Rylee 93}\\
		{\large 96862, Washington, Chiang Rai, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large James Isaksson } \\
		{\large Gracie 74}\\
		{\large 83533, Hong Kong, Texas, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
