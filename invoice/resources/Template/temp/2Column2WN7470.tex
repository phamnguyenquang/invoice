...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Matthew Sandberg} \\
		{\large Adeline 44}\\
		{\large 52765, Los Angeles, Saarland, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklyn James Lundberg Pte Ltd } \\
		{\large Abigail 99}\\
		{\large 56932, San Francisco, Amnat Charoen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
