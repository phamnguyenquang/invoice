...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Greyson May/Mae 	 Martinsson Pte Ltd} \\
		{\large Quinn 61}\\
		{\large 46927, Vienna, California, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jordan Andersson } \\
		{\large Gavin 57}\\
		{\large 30227, Vienna, Huabei, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
