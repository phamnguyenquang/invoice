...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jordan Victoria Holmgren} \\
		{\large Nicole 98}\\
		{\large 98856, Minsk, Tuscany, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Declan Louise 	 Berg Corp } \\
		{\large Taylor 85}\\
		{\large 15598, Hong Kong, Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
