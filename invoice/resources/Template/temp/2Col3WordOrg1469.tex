...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Colin Louise 	 Nilsson Corp} \\
		{\large Brayden 40}\\
		{\large 57485, Budapest, Bangkok, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bentley Nordin } \\
		{\large Sebastian 95}\\
		{\large 47531, Frankfurt am Main , Binh Thuan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
