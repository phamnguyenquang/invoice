...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Berglund} \\
		{\large Max 60}\\
		{\large 19580, Frankfurt am Main , Guangzhou, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniela Elizabeth 	 Dahlberg Pte Ltd } \\
		{\large Genesis 5}\\
		{\large 13803, Barcelona, Hessen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
