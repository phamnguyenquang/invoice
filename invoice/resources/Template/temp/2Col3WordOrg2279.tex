...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel May/Mae 	 Engström Pte Ltd} \\
		{\large Caroline 96}\\
		{\large 14490, Frankfurt am Main , Binh Thuan, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angelina Nyström } \\
		{\large Molly 19}\\
		{\large 29339, New York , Hainan, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
