...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tristan Håkansson} \\
		{\large Piper 85}\\
		{\large 51802, Washington, Guangdong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elias May/Mae 	 Isaksson Ltd } \\
		{\large Adam 11}\\
		{\large 59433, Ho Chi Minh, khanh Hoa, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
