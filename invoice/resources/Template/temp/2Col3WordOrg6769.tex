...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope Christopher Viklund Ltd} \\
		{\large Aubree 4}\\
		{\large 16407, Singapore, Kentucky, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrea Eklund } \\
		{\large Gabrielle 96}\\
		{\large 97870, Frankfurt am Main , Hessen, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
