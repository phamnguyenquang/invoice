...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jude Jane Lindqvist} \\
		{\large Emery 65}\\
		{\large 30178, Chicago, Hessen, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Trinity David Hellström Inc } \\
		{\large Kayla 42}\\
		{\large 24014, Frankfurt am Main , Hamburg, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
