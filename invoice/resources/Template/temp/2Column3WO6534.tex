...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Layla Mary 	 Arvidsson Inc} \\
		{\large Victor 61}\\
		{\large 83048, Barcelona, Hainan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella Mårtensson } \\
		{\large Leilani 36}\\
		{\large 77638, Last Vegas, Heibei, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
