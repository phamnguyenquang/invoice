...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Beijing University of Chemical Technology} \\
		{\large Nathaniel 6}\\
		{\large 93303, Barcelona, Hessen, Mexico }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Alejandro Martinsson } \\
		{\large Serenity 85}\\
		{\large 66653, Florence, Floria, Denmark}\\
    \switchcolumn
