...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Calvin Marie 	 Samuelsson} \\
		{\large Nora 75}\\
		{\large 65964, Tokyo, Hessen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josephine Catherine  Henriksson Ltd } \\
		{\large Isabel 30}\\
		{\large 15843, Vancouver, Bayern, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
