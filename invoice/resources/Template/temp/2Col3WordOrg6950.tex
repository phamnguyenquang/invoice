...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tucker  Alexander  Lundqvist Ltd} \\
		{\large Ruby 55}\\
		{\large 87992, Munich, Chai Nat, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabella Andersson } \\
		{\large Aidan 44}\\
		{\large 92434, Bonn, Amnat Charoen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
