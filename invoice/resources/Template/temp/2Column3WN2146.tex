...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elena Michael Nyberg} \\
		{\large Avery 63}\\
		{\large 13272, Abu Dhabi, Chai Nat, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Parker Louise 	 Strömberg Pte Ltd } \\
		{\large Maverick 78}\\
		{\large 13128, Frankfurt am Main , Guangzhou, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
