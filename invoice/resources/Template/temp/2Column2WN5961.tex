...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Marcus Dahlberg} \\
		{\large Claire 65}\\
		{\large 86556, Frankfurt am Main , Hawaii, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mason Louise 	 Nordström Inc } \\
		{\large Preston 30}\\
		{\large 43277, Barcelona, Bremen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
