...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zoe Louise 	 Holmberg} \\
		{\large Jessica 59}\\
		{\large 89050, Los Angeles, Saarland, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jude Catherine  Lundström Inc } \\
		{\large Rylee 97}\\
		{\large 80816, San Francisco, Chai Nat, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
