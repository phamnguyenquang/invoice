...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zoey May/Mae 	 Abrahamsson} \\
		{\large Lucy 53}\\
		{\large 24778, Abu Dhabi, Binh Thuan, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michael Jane Dahlberg Inc } \\
		{\large Serenity 6}\\
		{\large 77391, Lisbon, Heibei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
