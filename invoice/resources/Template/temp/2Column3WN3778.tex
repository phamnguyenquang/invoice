...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rebecca Edward Isaksson} \\
		{\large Andrea 68}\\
		{\large 81315, Vienna, Bayern, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isaac Jane Abrahamsson Corp } \\
		{\large Sebastian 41}\\
		{\large 91733, San Francisco, Bayern, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
