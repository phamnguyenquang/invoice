...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall Mary 	 Andersson} \\
		{\large Jordan 32}\\
		{\large 73571, Chicago, Saarland, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniela Rose 	 Sandström Corp } \\
		{\large Brooklynn 64}\\
		{\large 76724, Munich, Chiang Mai, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
