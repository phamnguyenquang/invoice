...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniela Rose 	 Olofsson} \\
		{\large Morgan 28}\\
		{\large 14280, Frankfurt am Main , Seattles, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bailey Catherine  Jakobsson Corp } \\
		{\large Savannah 12}\\
		{\large 62928, Moscow, Indiana, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
