...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julian Grace 	 Magnusson Pte Ltd} \\
		{\large London 81}\\
		{\large 60439, Frankfurt am Main , Guangdong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Delilah Ahmed } \\
		{\large Delilah 52}\\
		{\large 91439, Paris, Phu Yen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
