...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adrian  Alexander  Jönsson Corp} \\
		{\large Eden 11}\\
		{\large 78157, SaiGon, Hamburg, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jude Wikström } \\
		{\large Julian 46}\\
		{\large 68681, Washington, Amnat Charoen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
