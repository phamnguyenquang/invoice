...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Marcus Edward Lundin} \\
		{\large Cooper 22}\\
		{\large 99567, London , Buriam, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesus Jane Hansson Pte Ltd } \\
		{\large Jack 67}\\
		{\large 20903, Boston, Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
