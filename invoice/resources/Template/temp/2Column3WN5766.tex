...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniela Marie 	 Falk} \\
		{\large Abel 38}\\
		{\large 40266, Istanbul, Chiang Rai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Richard Marie 	 Månsson Corp } \\
		{\large Kayden 48}\\
		{\large 67189, Frankfurt am Main , Henan, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
