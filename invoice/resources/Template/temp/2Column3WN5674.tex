...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryder Elizabeth 	 Isaksson} \\
		{\large Carter 25}\\
		{\large 92215, Washington, Bangkok, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabella William Lindgren Pte Ltd } \\
		{\large Bennett 18}\\
		{\large 81565, Vancouver, Guangzhou, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
