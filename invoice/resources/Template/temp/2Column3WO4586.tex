...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonathan Michael Blomqvist Pte Ltd} \\
		{\large Bailey 73}\\
		{\large 76189, Shanghai, Chiang Mai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large King Eriksson } \\
		{\large Luca 90}\\
		{\large 89823, Bonn, Huabei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
