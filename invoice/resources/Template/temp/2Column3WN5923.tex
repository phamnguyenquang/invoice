...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryan Kate 	 Mårtensson} \\
		{\large Sarah 33}\\
		{\large 65330, Bonn, Chiang Mai, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Richard William Fredriksson Corp } \\
		{\large Makenzie 74}\\
		{\large 68451, Ho Chi Minh, Guangdong, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
