...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Indian Institute of Management Ahmedabad} \\
		{\large Valerie 60}\\
		{\large 84674, Ho Chi Minh, Kentucky, Singapore}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Brooklyn Ahmed } \\
		{\large Caden 91}\\
		{\large 76552, Abu Dhabi, Hawaii, laos}\\
    \switchcolumn
