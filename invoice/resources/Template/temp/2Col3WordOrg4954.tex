...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adrian  Alexander  Ahmed Corp} \\
		{\large Piper 90}\\
		{\large 65326, Frankfurt am Main , Tuscany, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anthony Blom } \\
		{\large Isla 50}\\
		{\large 76237, Frankfurt am Main , Hainan, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
