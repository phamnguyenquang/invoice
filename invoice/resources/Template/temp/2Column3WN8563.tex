...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vincent Christopher Nordström} \\
		{\large Mary 77}\\
		{\large 99901, Taipei, Henan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Xavier Victoria Nyberg Ltd } \\
		{\large Juan 29}\\
		{\large 81679, Frankfurt am Main , Buriam, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
