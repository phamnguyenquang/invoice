...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaylee Victoria Nordin} \\
		{\large Valeria 20}\\
		{\large 96417, Stuttgart, Bayern, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalynn Lee  Mårtensson Pte Ltd } \\
		{\large Lila 67}\\
		{\large 49016, Budapest, Kentucky, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
