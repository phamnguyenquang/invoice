...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hayden John Sandström} \\
		{\large Greyson 96}\\
		{\large 45133, Vienna, Tuscany, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Giovanni Robert Fredriksson Pte Ltd } \\
		{\large Quinn 32}\\
		{\large 33744, San Francisco, Buriam, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
