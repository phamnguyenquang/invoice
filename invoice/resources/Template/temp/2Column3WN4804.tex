...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicolas Thomas Lundström} \\
		{\large Andrew 61}\\
		{\large 53814, Munich, Henan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aurora William Sandström Pte Ltd } \\
		{\large Lincoln 43}\\
		{\large 99748, Amsterdam, Kentucky, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
