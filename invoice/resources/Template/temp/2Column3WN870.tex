...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jordan Victoria Bengtsson} \\
		{\large Melody 50}\\
		{\large 55630, Shanghai, Amnat Charoen, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maxwell Amy  Berglund Pte Ltd } \\
		{\large Eric 34}\\
		{\large 97320, Frankfurt am Main , Henan, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
