...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sean Lundberg} \\
		{\large Tristan 78}\\
		{\large 92767, Frankfurt am Main , Ang Thong, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn  Alexander  Norberg Inc } \\
		{\large Katherine 52}\\
		{\large 65137, Paris, khanh Hoa, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
