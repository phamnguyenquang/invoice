...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Clara Thomas Nordström} \\
		{\large Antonio 40}\\
		{\large 34857, Shanghai, Bangkok, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melanie Christopher Berggren Pte Ltd } \\
		{\large Maddox 58}\\
		{\large 65330, Frankfurt am Main , Indiana, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
