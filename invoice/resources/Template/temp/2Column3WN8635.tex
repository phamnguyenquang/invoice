...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Camden William Samuelsson} \\
		{\large Kayden 10}\\
		{\large 73727, Amsterdam, khanh Hoa, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bennett John Ström Pte Ltd } \\
		{\large Mateo 73}\\
		{\large 21122, SaiGon, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
