...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juan Catherine  Berg} \\
		{\large Chloe 64}\\
		{\large 44771, Frankfurt am Main , Saarland, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Payton  Alexander  Lundin Pte Ltd } \\
		{\large Steven 38}\\
		{\large 71771, Berlin, Guangdong, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
