...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ashton Elizabeth 	 Norberg} \\
		{\large Wyatt 94}\\
		{\large 44869, Singapore, Binh Thuan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley Rose 	 Nilsson Ltd } \\
		{\large Autumn 40}\\
		{\large 59411, Frankfurt am Main , khanh Hoa, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
