...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabella Mary 	 Henriksson} \\
		{\large Piper 18}\\
		{\large 12301, Abu Dhabi, Tuscany, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Layla Robert Hassan Inc } \\
		{\large Kai 79}\\
		{\large 29281, San Francisco, Bangkok, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
