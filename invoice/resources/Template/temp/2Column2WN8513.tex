...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Savannah Arvidsson} \\
		{\large Gael 88}\\
		{\large 57488, Ho Chi Minh, Bangkok, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Benjamin Christopher Hellström Inc } \\
		{\large Levi 12}\\
		{\large 79132, Beijing, Texas, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
