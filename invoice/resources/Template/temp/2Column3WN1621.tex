...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaliyah Peter Hellström} \\
		{\large Isaac 87}\\
		{\large 12523, Washington, Indiana, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden Amy  Jansson Corp } \\
		{\large Nicholas 32}\\
		{\large 11336, Los Angeles, Guangdong, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
