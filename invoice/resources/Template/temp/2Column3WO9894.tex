...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremiah Christopher Gunnarsson Corp} \\
		{\large Grace 10}\\
		{\large 55352, Stuttgart, Bangkok, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Braxton Håkansson } \\
		{\large Logan 35}\\
		{\large 58533, Denver, Chiang Rai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
