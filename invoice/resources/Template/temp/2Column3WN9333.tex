...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Miguel Louise 	 Larsson} \\
		{\large Maya 92}\\
		{\large 49404, Montreal, Saarland, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Izabella  Alexander  Bergström Ltd } \\
		{\large Sophia 76}\\
		{\large 38637, Montreal, Heibei, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
