...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carter Lundqvist} \\
		{\large Asher 60}\\
		{\large 73753, Ho Chi Minh, Amnat Charoen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vincent Victoria Engström Ltd } \\
		{\large Emery 35}\\
		{\large 40650, Nha Trang, Ang Thong, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
