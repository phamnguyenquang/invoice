...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hannah Peter Nordström} \\
		{\large Bailey 88}\\
		{\large 68882, Washington, Ang Thong, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large William Louise 	 Abrahamsson Pte Ltd } \\
		{\large Braxton 57}\\
		{\large 64264, Hanoi, Ang Thong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
