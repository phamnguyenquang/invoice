...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexander Lee  Sjögren} \\
		{\large Jackson 68}\\
		{\large 77777, Rome, Hamburg, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Delilah Christopher Isaksson Inc } \\
		{\large Mariah 71}\\
		{\large 65482, New York , Indiana, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
