...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Robert Mary 	 Berglund Pte Ltd} \\
		{\large Delilah 29}\\
		{\large 76815, Washington, khanh Hoa, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Oliver Strömberg } \\
		{\large Colton 53}\\
		{\large 45498, Frankfurt am Main , Texas, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
