...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kennedy Catherine  Persson} \\
		{\large Paisley 59}\\
		{\large 85865, Seoul, Chiang Mai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden Victoria Öberg Pte Ltd } \\
		{\large Ryan 93}\\
		{\large 80656, Minsk, Hessen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
