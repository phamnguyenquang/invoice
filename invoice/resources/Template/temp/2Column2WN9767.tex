...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stella Magnusson} \\
		{\large Amy 4}\\
		{\large 11077, Barcelona, Ang Thong, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexander Grace 	 Blomqvist Ltd } \\
		{\large Dylan 80}\\
		{\large 84230, Melbourne, Chiang Rai, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
