...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hudson Lindgren} \\
		{\large Alana 65}\\
		{\large 94960, Chicago, Tuscany, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryan Catherine  Abrahamsson Inc } \\
		{\large Angelina 23}\\
		{\large 43201, San Francisco, Chiang Mai, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
