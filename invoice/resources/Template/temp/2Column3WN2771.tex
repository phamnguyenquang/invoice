...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paige Louise 	 Håkansson} \\
		{\large Abigail 4}\\
		{\large 42657, Dubai, Chai Nat, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Xavier Michael Viklund Corp } \\
		{\large Nicole 42}\\
		{\large 28459, Frankfurt am Main , Hessen, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
