...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Morgan Olsson} \\
		{\large Jaxson 87}\\
		{\large 34724, Frankfurt am Main , Hessen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabella James Strömberg Pte Ltd } \\
		{\large Noah 95}\\
		{\large 81658, Stuttgart, Texas, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
