...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Norah Louise 	 Sandström} \\
		{\large Isla 84}\\
		{\large 63933, Ho Chi Minh, Indiana, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Braxton Elizabeth 	 Mårtensson Ltd } \\
		{\large Izabella 44}\\
		{\large 44715, Frankfurt am Main , Guangdong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
