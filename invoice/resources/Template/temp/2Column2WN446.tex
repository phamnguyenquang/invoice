...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paige Hermansson} \\
		{\large Elena 78}\\
		{\large 57240, Vancouver, khanh Hoa, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mason Edward Eliasson Corp } \\
		{\large Alana 51}\\
		{\large 55183, Frankfurt am Main , Indiana, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
