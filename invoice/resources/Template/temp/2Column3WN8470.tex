...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gianna Catherine  Holm} \\
		{\large Kingston 14}\\
		{\large 62901, Montreal, Bremen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vivian Elizabeth 	 Sundberg Ltd } \\
		{\large Ellie 87}\\
		{\large 23240, Hong Kong, Texas, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
