...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brody Catherine  Eliasson} \\
		{\large Liliana 89}\\
		{\large 67849, Berlin, Binh Thuan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joel Thomas Axelsson Ltd } \\
		{\large Alexander 38}\\
		{\large 65403, Washington, Ang Thong, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
