...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mason Elizabeth 	 Wikström Pte Ltd} \\
		{\large Michael 54}\\
		{\large 79447, Washington, Indiana, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aidan Blomqvist } \\
		{\large Oscar 22}\\
		{\large 10856, Amsterdam, Huabei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
