...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julia Söderberg} \\
		{\large Ivan 72}\\
		{\large 58155, Frankfurt am Main , Texas, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Olivia David Lundström Corp } \\
		{\large Matthew 82}\\
		{\large 37169, Toronto, khanh Hoa, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
