...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Ludwig Maximilian University of Munich} \\
		{\large Preston 21}\\
		{\large 97908, Florence, Buriam, Cambodia}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Mckenzie Larsson } \\
		{\large Alexandra 69}\\
		{\large 44638, Washington, Amnat Charoen, United State }\\
    \switchcolumn
