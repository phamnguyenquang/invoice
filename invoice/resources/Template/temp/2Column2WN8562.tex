...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sophia Johansson} \\
		{\large Mia 67}\\
		{\large 57884, Venice, California, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hannah Elizabeth 	 Lundgren Pte Ltd } \\
		{\large London 10}\\
		{\large 63835, Denver, Saarland, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
