...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline Victoria Johansson Inc} \\
		{\large Bryce 61}\\
		{\large 12541, San Francisco, Phu Yen, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christian Lindberg } \\
		{\large Mariah 99}\\
		{\large 85296, Vienna, Bayern, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
