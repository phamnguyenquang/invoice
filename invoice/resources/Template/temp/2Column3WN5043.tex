...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eleanor William Fransson} \\
		{\large Bryson 52}\\
		{\large 51060, Hong Kong, Ang Thong, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Chase Rose 	 Falk Pte Ltd } \\
		{\large John 22}\\
		{\large 54181, Frankfurt am Main , Phu Yen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
