...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harrison Grace 	 Holmgren Pte Ltd} \\
		{\large Adalynn 57}\\
		{\large 42664, Frankfurt am Main , Chiang Mai, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everly Karlsson } \\
		{\large Ella 49}\\
		{\large 73778, Last Vegas, Binh Thuan, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
