...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryson Thomas Björk} \\
		{\large Benjamin 14}\\
		{\large 68969, Florence, Amnat Charoen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alejandro Thomas Olsson Pte Ltd } \\
		{\large Maxwell 65}\\
		{\large 68502, San Francisco, Phu Yen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
