...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Wyatt May/Mae 	 Bergqvist} \\
		{\large Ezekiel 14}\\
		{\large 60478, Singapore, Guangdong, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valentina Mary 	 Holmgren Corp } \\
		{\large Kenneth 60}\\
		{\large 42466, Melbourne, Hainan, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
