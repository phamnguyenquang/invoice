...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle Lundgren} \\
		{\large Rachel 21}\\
		{\large 62301, Frankfurt am Main , khanh Hoa, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kayden David Eriksson Corp } \\
		{\large Ezekiel 40}\\
		{\large 27322, Ho Chi Minh, Chiang Rai, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
