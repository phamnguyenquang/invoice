...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valerie Arvidsson} \\
		{\large Madeline 89}\\
		{\large 59487, Amsterdam, Chiang Rai, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julianna David Andreasson Pte Ltd } \\
		{\large Isaiah 73}\\
		{\large 63390, Budapest, Bangkok, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
