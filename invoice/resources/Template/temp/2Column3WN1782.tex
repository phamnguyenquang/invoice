...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriel Thomas Falk} \\
		{\large Juliana 43}\\
		{\large 53623, Munich, Hamburg, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Logan Catherine  Strömberg Corp } \\
		{\large Camila 77}\\
		{\large 45663, Frankfurt am Main , Hessen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
