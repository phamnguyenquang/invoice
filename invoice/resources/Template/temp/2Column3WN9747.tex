...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everett Christopher Blomqvist} \\
		{\large Miguel 57}\\
		{\large 62870, Stuttgart, Kentucky, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison Amy  Nilsson Pte Ltd } \\
		{\large Connor 52}\\
		{\large 17221, Vienna, Hawaii, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
