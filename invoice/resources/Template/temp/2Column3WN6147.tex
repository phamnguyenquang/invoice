...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amelia May/Mae 	 Jansson} \\
		{\large Alex 63}\\
		{\large 23930, Boston, Binh Thuan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abigail James Mohamed Pte Ltd } \\
		{\large Harmony 66}\\
		{\large 55555, Dublin, Seattles, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
