...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria May/Mae 	 Bergqvist} \\
		{\large Maxwell 4}\\
		{\large 60302, Chicago, Ang Thong, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Izabella Amy  Andreasson Inc } \\
		{\large Jace 54}\\
		{\large 59669, Ho Chi Minh, Guangdong, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
