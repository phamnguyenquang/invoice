...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eric Mary 	 Magnusson} \\
		{\large Sofia 87}\\
		{\large 12379, Rome, Buriam, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brianna Catherine  Jansson Ltd } \\
		{\large Steven 93}\\
		{\large 91889, Vancouver, Amnat Charoen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
