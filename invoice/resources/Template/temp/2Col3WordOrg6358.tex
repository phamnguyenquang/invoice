...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mariah Marie 	 Bengtsson Pte Ltd} \\
		{\large Maddox 35}\\
		{\large 86320, San Francisco, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Molly Bengtsson } \\
		{\large Calvin 45}\\
		{\large 22366, Dublin, Hamburg, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
