...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tyler Mary 	 Björklund} \\
		{\large James 14}\\
		{\large 65806, SaiGon, Guangzhou, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Miguel Catherine  Olsson Pte Ltd } \\
		{\large Julianna 93}\\
		{\large 80647, Abu Dhabi, khanh Hoa, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
