...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Savannah Christopher Sundberg Ltd} \\
		{\large Luna 94}\\
		{\large 56201, Stuttgart, Floria, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian Lindqvist } \\
		{\large Ava 69}\\
		{\large 12220, Ho Chi Minh, Bangkok, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
