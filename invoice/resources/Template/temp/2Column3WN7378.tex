...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Scarlett Marie 	 Bergström} \\
		{\large Isabella 55}\\
		{\large 75456, New York , Chiang Mai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriel Michael Nordström Pte Ltd } \\
		{\large Gracie 1}\\
		{\large 44145, Bonn, Henan, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
