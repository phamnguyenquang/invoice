...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Genesis Victoria Svensson} \\
		{\large Liam 17}\\
		{\large 10254, Budapest, Seattles, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hudson Louise 	 Blomqvist Pte Ltd } \\
		{\large Eliana 73}\\
		{\large 72597, Sydney, Guangdong, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
