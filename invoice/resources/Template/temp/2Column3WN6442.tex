...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Marie 	 Mårtensson} \\
		{\large Mary 71}\\
		{\large 39447, Frankfurt am Main , Hainan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Allison Amy  Martinsson Inc } \\
		{\large Angelina 52}\\
		{\large 75722, Vancouver, Seattles, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
