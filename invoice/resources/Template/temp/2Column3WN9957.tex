...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michael William Åberg} \\
		{\large Jessica 71}\\
		{\large 17073, Frankfurt am Main , Indiana, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angel Catherine  Åkesson Corp } \\
		{\large Silas 45}\\
		{\large 44450, SaiGon, Henan, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
