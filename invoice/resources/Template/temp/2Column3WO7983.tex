...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline Christopher Lundqvist Pte Ltd} \\
		{\large Michelle 78}\\
		{\large 32151, Osaka, Guangdong, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Dylan Ström } \\
		{\large Nevaeh 72}\\
		{\large 61087, Los Angeles, Ang Thong, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
