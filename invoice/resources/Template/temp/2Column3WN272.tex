...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Violet Ann  Ek} \\
		{\large Lilly 61}\\
		{\large 31850, Milan, Phu Yen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joshua Catherine  Karlsson Pte Ltd } \\
		{\large Valeria 10}\\
		{\large 21641, Nha Trang, Bremen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
