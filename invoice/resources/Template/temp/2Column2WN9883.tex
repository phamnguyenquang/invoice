...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria Bengtsson} \\
		{\large Laila 45}\\
		{\large 12448, Frankfurt am Main , Seattles, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaden Jane Hermansson Pte Ltd } \\
		{\large Eli 4}\\
		{\large 20963, Moscow, khanh Hoa, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
