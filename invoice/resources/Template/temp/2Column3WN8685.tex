...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eli Marie 	 Andersson} \\
		{\large Lucy 49}\\
		{\large 19379, Los Angeles, Chiang Rai, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexa James Samuelsson Corp } \\
		{\large Alejandro 76}\\
		{\large 40652, Singapore, Chiang Mai, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
