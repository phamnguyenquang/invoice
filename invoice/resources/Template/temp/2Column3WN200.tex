...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ethan Mary 	 Falk} \\
		{\large Roman 20}\\
		{\large 71998, Vienna, Ang Thong, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas Thomas Olsson Pte Ltd } \\
		{\large Rebecca 8}\\
		{\large 86969, Frankfurt am Main , Buriam, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
