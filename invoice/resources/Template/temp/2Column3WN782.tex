...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harper Kate 	 Pålsson} \\
		{\large Mila 99}\\
		{\large 32420, SaiGon, Binh Thuan, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn Victoria Bergström Pte Ltd } \\
		{\large Noah 40}\\
		{\large 62927, Hanoi, Amnat Charoen, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
