...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alan Christopher Axelsson} \\
		{\large Adeline 63}\\
		{\large 30787, Singapore, Bayern, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte Catherine  Andersson Pte Ltd } \\
		{\large Josephine 34}\\
		{\large 45455, Nha Trang, Hainan, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
