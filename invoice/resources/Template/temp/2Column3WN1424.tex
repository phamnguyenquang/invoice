...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jacob Peter Mattsson} \\
		{\large Emmanuel 48}\\
		{\large 69949, Stuttgart, Amnat Charoen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josephine Elizabeth 	 Karlsson Corp } \\
		{\large Serenity 17}\\
		{\large 91163, Moscow, Bremen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
