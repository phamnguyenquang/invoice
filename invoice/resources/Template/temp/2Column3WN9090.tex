...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rose Amy  Söderberg} \\
		{\large Serenity 19}\\
		{\large 83629, Frankfurt am Main , Guangzhou, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ashley Edward Löfgren Pte Ltd } \\
		{\large Aaliyah 89}\\
		{\large 37384, Berlin, Hessen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
