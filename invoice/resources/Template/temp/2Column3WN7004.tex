...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elena James Månsson} \\
		{\large Nolan 51}\\
		{\large 44508, Lisbon, Seattles, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isaac Marie 	 Jansson Pte Ltd } \\
		{\large Julianna 22}\\
		{\large 92078, Vancouver, Amnat Charoen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
