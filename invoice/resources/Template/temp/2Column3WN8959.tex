...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tristan John Nordström} \\
		{\large Julian 64}\\
		{\large 92286, Dubai, Guangdong, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Athena Victoria Arvidsson Pte Ltd } \\
		{\large Julia 85}\\
		{\large 91336, Stuttgart, Hainan, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
