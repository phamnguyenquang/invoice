...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Oliver Christopher Gustafsson} \\
		{\large Mark 18}\\
		{\large 22030, Shanghai, Chiang Rai, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Summer Louise 	 Jonsson Corp } \\
		{\large Parker 71}\\
		{\large 20734, Montreal, Hamburg, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
