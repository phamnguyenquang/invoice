...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ethan David Mattsson} \\
		{\large Jasmine 68}\\
		{\large 11059, Beijing, Binh Thuan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Diego Elizabeth 	 Hansson Corp } \\
		{\large Peyton 38}\\
		{\large 98365, Istanbul, Chiang Rai, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
