...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cooper May/Mae 	 Ekström Pte Ltd} \\
		{\large Cora 85}\\
		{\large 92484, Ho Chi Minh, Saarland, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cole Ahmed } \\
		{\large Jonah 91}\\
		{\large 81494, Nha Trang, khanh Hoa, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
