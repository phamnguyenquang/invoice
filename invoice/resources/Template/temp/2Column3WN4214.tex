...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ivy May/Mae 	 Strömberg} \\
		{\large Landon 11}\\
		{\large 13075, Beijing, Guangdong, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jose May/Mae 	 Pettersson Ltd } \\
		{\large Brady 3}\\
		{\large 95618, Frankfurt am Main , Bremen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
