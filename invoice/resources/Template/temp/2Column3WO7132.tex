...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Louise 	 Söderberg Ltd} \\
		{\large Bryan 36}\\
		{\large 22833, Montreal, Chiang Rai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jason Magnusson } \\
		{\large Adrian 68}\\
		{\large 53270, Frankfurt am Main , Binh Thuan, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
