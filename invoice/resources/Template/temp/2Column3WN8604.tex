...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Peyton Anne Ström} \\
		{\large Morgan 80}\\
		{\large 62444, New York , Buriam, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melanie James Mårtensson Pte Ltd } \\
		{\large Richard 72}\\
		{\large 41256, Frankfurt am Main , Chiang Mai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
