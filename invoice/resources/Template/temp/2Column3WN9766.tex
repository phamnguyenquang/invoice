...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayce May/Mae 	 Mohamed} \\
		{\large Julia 98}\\
		{\large 52300, Berlin, Amnat Charoen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Victoria Gunnarsson Ltd } \\
		{\large Autumn 68}\\
		{\large 24499, Sydney, Kentucky, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
