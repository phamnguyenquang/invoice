...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  London Louise 	 Blom Pte Ltd} \\
		{\large Christopher 14}\\
		{\large 81723, Istanbul, Texas, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madison Ahmed } \\
		{\large Ariana 84}\\
		{\large 89668, Rome, Seattles, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
