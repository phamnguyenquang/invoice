...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery Nordström} \\
		{\large Christopher 77}\\
		{\large 30541, Chicago, Kentucky, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryleigh May/Mae 	 Ström Inc } \\
		{\large George 18}\\
		{\large 94393, Istanbul, Chai Nat, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
