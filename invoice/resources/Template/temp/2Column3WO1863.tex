...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity Grace 	 Andersson Pte Ltd} \\
		{\large Camden 48}\\
		{\large 87870, Frankfurt am Main , Floria, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julia Lund } \\
		{\large Ryleigh 83}\\
		{\large 13874, San Francisco, Chiang Rai, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
