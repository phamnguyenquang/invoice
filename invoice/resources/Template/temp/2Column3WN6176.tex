...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amir Kate 	 Dahlberg} \\
		{\large Nicolas 23}\\
		{\large 35214, Last Vegas, Seattles, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryder Louise 	 Öberg Pte Ltd } \\
		{\large Eden 63}\\
		{\large 57352, Frankfurt am Main , Amnat Charoen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
