...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Patrick May/Mae 	 Lundström Corp} \\
		{\large Skylar 39}\\
		{\large 42434, Abu Dhabi, Guangzhou, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rylee Persson } \\
		{\large Cole 58}\\
		{\large 84841, Frankfurt am Main , Tuscany, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
