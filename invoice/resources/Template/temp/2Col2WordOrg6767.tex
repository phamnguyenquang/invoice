...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaliyah Samuelsson Inc} \\
		{\large Kaiden 47}\\
		{\large 85214, Frankfurt am Main , Indiana, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joshua Sundberg } \\
		{\large Cole 81}\\
		{\large 15521, Abu Dhabi, Binh Thuan, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
