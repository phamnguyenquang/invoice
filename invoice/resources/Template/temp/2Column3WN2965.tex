...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniel William Svensson} \\
		{\large Annabelle 22}\\
		{\large 17404, Beijing, Chiang Rai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wyatt Victoria Strömberg Pte Ltd } \\
		{\large Connor 28}\\
		{\large 27854, Bonn, Binh Thuan, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
