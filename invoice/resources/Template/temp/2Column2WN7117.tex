...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Micah Lundgren} \\
		{\large Noah 53}\\
		{\large 26190, Osaka, Guangdong, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alejandro James Mårtensson Corp } \\
		{\large Bailey 34}\\
		{\large 30920, Frankfurt am Main , Amnat Charoen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
