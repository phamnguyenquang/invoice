...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kennedy Louise 	 Löfgren} \\
		{\large Logan 2}\\
		{\large 83699, Hong Kong, Ang Thong, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Norah May/Mae 	 Björklund Inc } \\
		{\large Theodore 82}\\
		{\large 11890, Sydney, Texas, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
