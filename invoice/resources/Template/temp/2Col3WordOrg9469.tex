...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rebecca Michael Jönsson Pte Ltd} \\
		{\large Reagan 74}\\
		{\large 53311, Frankfurt am Main , Seattles, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaron Lund } \\
		{\large Ezra 76}\\
		{\large 95011, Los Angeles, Huabei, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
