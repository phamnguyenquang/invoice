...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aubrey James Samuelsson Ltd} \\
		{\large Ella 32}\\
		{\large 64233, Frankfurt am Main , Hessen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalia Sandström } \\
		{\large Sawyer 56}\\
		{\large 66314, Shanghai, Bangkok, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
