...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Morgan Mohamed} \\
		{\large Melanie 33}\\
		{\large 12517, Barcelona, Amnat Charoen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Greyson Mary 	 Jansson Pte Ltd } \\
		{\large Madeline 56}\\
		{\large 20836, Florence, Chiang Mai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
