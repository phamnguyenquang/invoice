...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Destiny Rose 	 Jakobsson} \\
		{\large Maria 79}\\
		{\large 21489, Budapest, Seattles, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalyn Catherine  Lundberg Pte Ltd } \\
		{\large Alan 43}\\
		{\large 53051, Washington, Guangdong, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
