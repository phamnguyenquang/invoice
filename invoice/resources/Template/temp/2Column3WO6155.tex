...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline William Jakobsson Pte Ltd} \\
		{\large Bradley 66}\\
		{\large 31807, Amsterdam, Kentucky, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tyler Fredriksson } \\
		{\large Sawyer 89}\\
		{\large 88130, Frankfurt am Main , Bayern, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
