...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kenneth Michael Bengtsson} \\
		{\large Marcus 94}\\
		{\large 39386, Dublin, Hessen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brielle Marie 	 Arvidsson Pte Ltd } \\
		{\large George 80}\\
		{\large 84810, Last Vegas, Heibei, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
