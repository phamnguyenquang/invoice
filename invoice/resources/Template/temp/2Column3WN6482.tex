...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Peter Abrahamsson} \\
		{\large Kayla 46}\\
		{\large 77404, Vienna, Hainan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michelle Ann  Jansson Corp } \\
		{\large Savannah 21}\\
		{\large 94318, Singapore, Henan, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
