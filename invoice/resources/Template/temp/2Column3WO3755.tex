...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Chase Lee  Mårtensson Pte Ltd} \\
		{\large Micah 74}\\
		{\large 81216, Frankfurt am Main , Ang Thong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ivan Strömberg } \\
		{\large Charlotte 68}\\
		{\large 51408, Singapore, Indiana, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
