...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maria Thomas Engström} \\
		{\large London 68}\\
		{\large 13710, Minsk, Saarland, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaron Elizabeth 	 Berggren Ltd } \\
		{\large Rylee 18}\\
		{\large 38975, Melbourne, Bangkok, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
