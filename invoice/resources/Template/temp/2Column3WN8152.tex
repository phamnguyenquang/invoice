...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte Marie 	 Bergström} \\
		{\large Norah 34}\\
		{\large 50946, Abu Dhabi, Guangzhou, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Payton  Alexander  Nordström Pte Ltd } \\
		{\large Mila 97}\\
		{\large 65494, Rome, Bangkok, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
