...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Braxton  Alexander  Bergqvist} \\
		{\large Ivy 49}\\
		{\large 82231, Frankfurt am Main , Hessen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Richard Thomas Mårtensson Ltd } \\
		{\large Sara 65}\\
		{\large 96332, Last Vegas, Chiang Rai, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
