...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Layla Catherine  Samuelsson} \\
		{\large Arianna 32}\\
		{\large 78855, Washington, Saarland, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan Anne Jönsson Pte Ltd } \\
		{\large Violet 18}\\
		{\large 94600, San Francisco, Kentucky, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
