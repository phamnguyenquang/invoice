...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hunter Amy  Persson} \\
		{\large Isla 68}\\
		{\large 33625, Amsterdam, Tuscany, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aliyah Jane Bengtsson Pte Ltd } \\
		{\large Jayla 58}\\
		{\large 79178, Melbourne, Seattles, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
