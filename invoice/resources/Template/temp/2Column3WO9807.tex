...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Izabella James Söderberg Corp} \\
		{\large Timothy 27}\\
		{\large 83962, Melbourne, Amnat Charoen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josephine Gustafsson } \\
		{\large Sawyer 54}\\
		{\large 75958, Washington, Guangdong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
