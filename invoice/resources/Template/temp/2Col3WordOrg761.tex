...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery May/Mae 	 Bergman Ltd} \\
		{\large Emmanuel 48}\\
		{\large 42666, Frankfurt am Main , Kentucky, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley Hellström } \\
		{\large Adalynn 22}\\
		{\large 76015, Last Vegas, Guangzhou, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
