...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Audrey Louise 	 Ahmed} \\
		{\large Eden 29}\\
		{\large 22892, Munich, Kentucky, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large London Catherine  Mohamed Inc } \\
		{\large Zoey 70}\\
		{\large 34103, San Francisco, Chiang Mai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
