...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles Michael Eklund} \\
		{\large Charles 47}\\
		{\large 81155, Munich, Binh Thuan, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eric Michael Magnusson Corp } \\
		{\large Adalynn 25}\\
		{\large 20410, Ho Chi Minh, Guangzhou, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
