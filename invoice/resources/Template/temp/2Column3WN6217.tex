...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly David Andersson} \\
		{\large Ava 64}\\
		{\large 58124, Madrid, Chiang Rai, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Timothy Catherine  Dahlberg Corp } \\
		{\large Zoe 95}\\
		{\large 49126, Ho Chi Minh, Phu Yen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
