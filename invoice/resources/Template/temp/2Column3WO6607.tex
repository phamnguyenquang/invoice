...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alyssa Peter Mohamed Corp} \\
		{\large George 25}\\
		{\large 79202, Frankfurt am Main , Hessen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sarah Andersson } \\
		{\large Preston 37}\\
		{\large 85807, Last Vegas, Chai Nat, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
