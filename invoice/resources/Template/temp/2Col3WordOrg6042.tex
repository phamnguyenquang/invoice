...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  George Elizabeth 	 Lundström Pte Ltd} \\
		{\large Giovanni 50}\\
		{\large 15583, Los Angeles, Tuscany, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joshua Håkansson } \\
		{\large Maddox 91}\\
		{\large 86651, Dublin, Seattles, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
