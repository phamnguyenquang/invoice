...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mariah Mary 	 Henriksson} \\
		{\large Justin 96}\\
		{\large 79171, Amsterdam, Bangkok, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alejandro Ann  Blomqvist Inc } \\
		{\large Anna 2}\\
		{\large 73882, San Francisco, Bayern, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
