...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bella Bengtsson} \\
		{\large Harrison 93}\\
		{\large 83316, Last Vegas, Buriam, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Morgan Christopher Hermansson Ltd } \\
		{\large Jayla 94}\\
		{\large 18975, Hanoi, Amnat Charoen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
