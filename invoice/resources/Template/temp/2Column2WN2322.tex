...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stephanie Norberg} \\
		{\large Charlotte 61}\\
		{\large 77705, Frankfurt am Main , Saarland, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caroline Jane Håkansson Ltd } \\
		{\large Mia 4}\\
		{\large 63104, Florence, Saarland, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
