...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Weston Christopher Isaksson Inc} \\
		{\large Violet 46}\\
		{\large 44422, New York , Kentucky, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie Nordström } \\
		{\large Kayla 83}\\
		{\large 55709, Madrid, Amnat Charoen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
