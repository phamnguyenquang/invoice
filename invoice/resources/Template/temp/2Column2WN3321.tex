...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Xavier Hassan} \\
		{\large Trinity 44}\\
		{\large 63528, Frankfurt am Main , Guangzhou, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camden May/Mae 	 Sjöberg Ltd } \\
		{\large Mckenzie 93}\\
		{\large 68033, New York , Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
