...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paige Elizabeth 	 Åkesson Pte Ltd} \\
		{\large Edward 6}\\
		{\large 48391, Hong Kong, Hessen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lillian Åberg } \\
		{\large Jaxon 21}\\
		{\large 29534, Vienna, Chiang Rai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
