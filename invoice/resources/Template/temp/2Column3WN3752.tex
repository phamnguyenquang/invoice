...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amelia Robert Ström} \\
		{\large Claire 98}\\
		{\large 62571, Amsterdam, Heibei, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jessica Louise 	 Arvidsson Corp } \\
		{\large Kai 2}\\
		{\large 83025, Frankfurt am Main , Heibei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
