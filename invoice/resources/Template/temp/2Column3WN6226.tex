...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lauren Mary 	 Sundberg} \\
		{\large Paisley 37}\\
		{\large 80377, Montreal, California, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariel Thomas Lundberg Inc } \\
		{\large Oliver 25}\\
		{\large 19623, Berlin, Amnat Charoen, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
