...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harper Anne Svensson} \\
		{\large Hudson 23}\\
		{\large 38199, Singapore, Tuscany, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angel Peter Magnusson Corp } \\
		{\large Aliyah 69}\\
		{\large 14742, Stuttgart, Seattles, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
