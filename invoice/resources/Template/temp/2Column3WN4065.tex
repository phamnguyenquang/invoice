...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Olivia John Abrahamsson} \\
		{\large Mila 60}\\
		{\large 28019, Hanoi, Hamburg, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesus Christopher Isaksson Corp } \\
		{\large Stella 93}\\
		{\large 14551, Melbourne, Phu Yen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
