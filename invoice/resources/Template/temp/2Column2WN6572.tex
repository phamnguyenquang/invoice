...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lauren Mohamed} \\
		{\large Jocelyn 8}\\
		{\large 19600, London , khanh Hoa, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan  Alexander  Lindqvist Ltd } \\
		{\large Rebecca 31}\\
		{\large 17142, Frankfurt am Main , Huabei, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
