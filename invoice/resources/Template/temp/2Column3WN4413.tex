...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mary Michael Persson} \\
		{\large Abel 80}\\
		{\large 21313, Frankfurt am Main , Bremen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ashley Louise 	 Larsson Corp } \\
		{\large Sadie 56}\\
		{\large 32318, Boston, Texas, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
