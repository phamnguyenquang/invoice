...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall Christopher Larsson} \\
		{\large Daniel 37}\\
		{\large 85805, Sydney, Seattles, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Matthew Christopher Ekström Ltd } \\
		{\large Madelyn 26}\\
		{\large 28383, Last Vegas, Huabei, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
