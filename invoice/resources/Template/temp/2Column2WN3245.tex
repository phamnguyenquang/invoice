...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hazel Abrahamsson} \\
		{\large Cora 80}\\
		{\large 28064, Osaka, Amnat Charoen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alejandro Catherine  Axelsson Pte Ltd } \\
		{\large Reese 20}\\
		{\large 76693, Beijing, Phu Yen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
