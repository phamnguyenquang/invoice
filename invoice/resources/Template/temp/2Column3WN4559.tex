...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lincoln Christopher Söderberg} \\
		{\large Sawyer 65}\\
		{\large 91461, Last Vegas, Phu Yen, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joel Robert Nyberg Corp } \\
		{\large Hailey 52}\\
		{\large 41099, Hanoi, Chiang Mai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
