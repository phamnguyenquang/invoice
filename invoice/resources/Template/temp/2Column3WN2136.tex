...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Austin Lee  Jansson} \\
		{\large Kingston 25}\\
		{\large 77597, Chicago, Guangdong, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Izabella Louise 	 Martinsson Pte Ltd } \\
		{\large Kennedy 52}\\
		{\large 22736, Montreal, Henan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
