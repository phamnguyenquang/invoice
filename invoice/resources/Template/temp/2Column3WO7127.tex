...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sean Elizabeth 	 Löfgren Pte Ltd} \\
		{\large Ruby 20}\\
		{\large 21968, Last Vegas, Henan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adriana Jönsson } \\
		{\large Levi 27}\\
		{\large 85065, Toronto, Kentucky, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
