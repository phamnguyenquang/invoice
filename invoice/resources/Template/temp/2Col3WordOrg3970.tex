...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Margaret Ann  Månsson Pte Ltd} \\
		{\large Christian 60}\\
		{\large 73374, Madrid, Kentucky, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everly Holmgren } \\
		{\large Christopher 62}\\
		{\large 16233, Hanoi, Hessen, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
