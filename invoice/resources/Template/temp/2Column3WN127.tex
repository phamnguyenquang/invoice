...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Evelyn Amy  Svensson} \\
		{\large Abraham 96}\\
		{\large 92308, San Francisco, Ang Thong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison Edward Bengtsson Corp } \\
		{\large Julian 85}\\
		{\large 74338, Istanbul, Hamburg, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
