...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kennedy Berglund Pte Ltd} \\
		{\large Nathan 76}\\
		{\large 97469, Frankfurt am Main , Chiang Rai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Violet Berglund } \\
		{\large Melanie 49}\\
		{\large 45609, Frankfurt am Main , Indiana, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
