...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  University of North Texas, Denton} \\
		{\large Jocelyn 20}\\
		{\large 18743, Ho Chi Minh, Guangzhou, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isaac Lundqvist } \\
		{\large Piper 83}\\
		{\large 18808, Frankfurt am Main , Hessen, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
