...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maya Edward Arvidsson Inc} \\
		{\large Christian 38}\\
		{\large 86116, Frankfurt am Main , Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angelina Forsberg } \\
		{\large Emmett 59}\\
		{\large 93085, Rome, Phu Yen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
