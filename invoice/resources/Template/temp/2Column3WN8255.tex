...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mariah Rose 	 Andersson} \\
		{\large Makayla 88}\\
		{\large 80477, Taipei, Kentucky, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brayden James Lundqvist Inc } \\
		{\large Sean 26}\\
		{\large 33769, Amsterdam, Phu Yen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
