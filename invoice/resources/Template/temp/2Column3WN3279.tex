...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zachary Catherine  Hellström} \\
		{\large Norah 1}\\
		{\large 66435, Ho Chi Minh, Binh Thuan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ethan Mary 	 Holmgren Inc } \\
		{\large Nicole 35}\\
		{\large 44173, Abu Dhabi, Guangdong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
