...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Autumn Louise 	 Nordström Ltd} \\
		{\large Ryder 1}\\
		{\large 16185, SaiGon, Buriam, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bailey Henriksson } \\
		{\large Hudson 35}\\
		{\large 60334, Frankfurt am Main , Ang Thong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
