...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Owen Victoria Björk} \\
		{\large Ivy 17}\\
		{\large 79809, San Francisco, Buriam, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kyle Amy  Fredriksson Inc } \\
		{\large Diego 87}\\
		{\large 94141, Taipei, Amnat Charoen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
