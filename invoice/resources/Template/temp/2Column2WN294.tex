...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nevaeh Jakobsson} \\
		{\large Jaxson 21}\\
		{\large 67515, Stuttgart, Hawaii, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daisy Mary 	 Andreasson Inc } \\
		{\large Jaxson 18}\\
		{\large 46177, Ho Chi Minh, Amnat Charoen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
