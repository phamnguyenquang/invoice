...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elise Edward Andersson} \\
		{\large Jason 9}\\
		{\large 54582, Frankfurt am Main , Floria, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie Lee  Ali Corp } \\
		{\large Madeline 87}\\
		{\large 52338, Moscow, Bremen, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
