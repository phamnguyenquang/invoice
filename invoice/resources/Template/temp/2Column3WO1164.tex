...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Delilah Louise 	 Lindgren Pte Ltd} \\
		{\large Asher 73}\\
		{\large 51546, Boston, Kentucky, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vanessa Söderberg } \\
		{\large Londyn 75}\\
		{\large 39346, Montreal, khanh Hoa, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
