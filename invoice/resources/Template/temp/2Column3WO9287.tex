...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Autumn Mary 	 Jansson Pte Ltd} \\
		{\large Alejandro 35}\\
		{\large 80895, Paris, Binh Thuan, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Easton Svensson } \\
		{\large Colton 54}\\
		{\large 82723, Hong Kong, Binh Thuan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
