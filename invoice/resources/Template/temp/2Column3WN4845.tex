...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalyn Edward Mårtensson} \\
		{\large Jonathan 13}\\
		{\large 35321, Dublin, Chiang Mai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Chloe Catherine  Nilsson Inc } \\
		{\large Nevaeh 90}\\
		{\large 21262, Seoul, Amnat Charoen, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
