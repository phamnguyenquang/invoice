...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lincoln May/Mae 	 Strömberg} \\
		{\large Sean 63}\\
		{\large 45028, Barcelona, Chiang Mai, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Landon Christopher Lindberg Corp } \\
		{\large Eli 19}\\
		{\large 50756, Florence, Guangzhou, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
