...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adeline Christopher Åberg} \\
		{\large Brandon 45}\\
		{\large 52381, Abu Dhabi, California, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathaniel Amy  Andreasson Inc } \\
		{\large Leonardo 91}\\
		{\large 51316, Berlin, Chiang Mai, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
