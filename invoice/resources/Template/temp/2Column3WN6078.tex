...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joshua Amy  Martinsson} \\
		{\large Harrison 67}\\
		{\large 50148, Last Vegas, khanh Hoa, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brayden Grace 	 Danielsson Pte Ltd } \\
		{\large Liam 48}\\
		{\large 48850, Frankfurt am Main , Chiang Rai, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
