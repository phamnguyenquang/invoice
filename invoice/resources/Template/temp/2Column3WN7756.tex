...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sawyer  Alexander  Lindgren} \\
		{\large Zoe 26}\\
		{\large 77065, Vancouver, California, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexander Victoria Månsson Pte Ltd } \\
		{\large Julia 87}\\
		{\large 85623, Seoul, Henan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
