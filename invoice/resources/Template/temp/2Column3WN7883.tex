...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Samantha Lee  Hansen} \\
		{\large Graham 8}\\
		{\large 72956, New York , Kentucky, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Olivia Rose 	 Håkansson Inc } \\
		{\large Paisley 33}\\
		{\large 75911, Frankfurt am Main , Binh Thuan, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
