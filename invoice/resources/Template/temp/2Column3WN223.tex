...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariel Rose 	 Lindholm} \\
		{\large Kaiden 35}\\
		{\large 71568, Milan, Ang Thong, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harmony May/Mae 	 Gunnarsson Corp } \\
		{\large Paige 89}\\
		{\large 45808, Last Vegas, Chiang Rai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
