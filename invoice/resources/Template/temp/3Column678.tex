...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Wageningen University and Research} \\
		{\large Katherine 36}\\
		{\large 53906, Istanbul, Binh Thuan, Singapore}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Olivia Sjöberg } \\
		{\large Jayden 52}\\
		{\large 32272, Frankfurt am Main , Chiang Mai, Canada }\\
    \switchcolumn
