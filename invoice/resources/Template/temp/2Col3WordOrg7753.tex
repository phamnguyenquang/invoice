...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amelia Mary 	 Berggren Pte Ltd} \\
		{\large Brielle 55}\\
		{\large 17251, Frankfurt am Main , Ang Thong, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reese Gunnarsson } \\
		{\large Kayden 25}\\
		{\large 20059, Frankfurt am Main , Texas, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
