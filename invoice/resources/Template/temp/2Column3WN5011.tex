...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Izabella James Blomqvist} \\
		{\large Avery 23}\\
		{\large 85159, Frankfurt am Main , Hamburg, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubree Catherine  Jansson Inc } \\
		{\large Adam 84}\\
		{\large 10668, Moscow, Chai Nat, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
