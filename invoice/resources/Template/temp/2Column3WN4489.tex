...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lillian Christopher Wallin} \\
		{\large Eden 22}\\
		{\large 58380, Ho Chi Minh, Amnat Charoen, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson Victoria Bengtsson Ltd } \\
		{\large Luna 60}\\
		{\large 45202, Frankfurt am Main , Heibei, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
