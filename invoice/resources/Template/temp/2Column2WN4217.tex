...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Robert Månsson} \\
		{\large Rachel 27}\\
		{\large 99927, Budapest, Guangdong, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Lee  Svensson Pte Ltd } \\
		{\large Valeria 33}\\
		{\large 80897, Frankfurt am Main , California, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
