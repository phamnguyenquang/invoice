...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bennett Henriksson} \\
		{\large Alaina 30}\\
		{\large 37936, Barcelona, Floria, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy May/Mae 	 Samuelsson Ltd } \\
		{\large Alexandra 66}\\
		{\large 88349, Toronto, Chai Nat, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
