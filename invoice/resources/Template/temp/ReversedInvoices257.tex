...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  National Taiwan University of Science and Technology} \\
		{\large Delilah 91}\\
		{\large 11696, Budapest, Bayern, Canada }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Eleanor Lundberg } \\
		{\large Trinity 39}\\
		{\large 72770, Bonn, Henan, Philippines}\\
    \switchcolumn
