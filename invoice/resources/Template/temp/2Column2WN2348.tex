...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonathan Lindqvist} \\
		{\large Abraham 61}\\
		{\large 42388, Vancouver, Hamburg, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juliana Jane Lundgren Pte Ltd } \\
		{\large Bentley 69}\\
		{\large 85985, Chicago, Amnat Charoen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
