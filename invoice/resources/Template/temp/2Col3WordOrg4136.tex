...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bradley Rose 	 Karlsson Corp} \\
		{\large Kaiden 44}\\
		{\large 12755, Milan, Hainan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lydia Johansson } \\
		{\large Bennett 82}\\
		{\large 96447, Frankfurt am Main , Amnat Charoen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
