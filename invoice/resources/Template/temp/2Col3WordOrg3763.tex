...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Weston Jane Bengtsson Pte Ltd} \\
		{\large Brielle 70}\\
		{\large 67447, Ho Chi Minh, Texas, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reagan Jonsson } \\
		{\large Elise 62}\\
		{\large 58835, Frankfurt am Main , Tuscany, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
