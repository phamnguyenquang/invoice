...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonah Christopher Eriksson} \\
		{\large Ivan 39}\\
		{\large 19899, Chicago, Ang Thong, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Timothy May/Mae 	 Björk Inc } \\
		{\large Trinity 26}\\
		{\large 65661, Hong Kong, Tuscany, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
