...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Austin William Andersson} \\
		{\large Eliana 20}\\
		{\large 40785, Minsk, Binh Thuan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte Louise 	 Eliasson Ltd } \\
		{\large Isabelle 27}\\
		{\large 11377, San Francisco, Bangkok, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
