...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle David Hansson} \\
		{\large Zachary 2}\\
		{\large 81804, Melbourne, Tuscany, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Axel Elizabeth 	 Claesson Corp } \\
		{\large Bentley 54}\\
		{\large 56109, Ho Chi Minh, California, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
