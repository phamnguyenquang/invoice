...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ian Victoria Olofsson} \\
		{\large Kylie 29}\\
		{\large 45124, Hong Kong, Tuscany, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Steven Christopher Holmberg Inc } \\
		{\large Angel 80}\\
		{\large 91012, SaiGon, Phu Yen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
