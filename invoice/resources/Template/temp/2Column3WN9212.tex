...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Oliver William Dahlberg} \\
		{\large Alexa 13}\\
		{\large 90915, Berlin, Hessen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michelle Jane Persson Pte Ltd } \\
		{\large Max 78}\\
		{\large 41476, Istanbul, Chiang Rai, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
