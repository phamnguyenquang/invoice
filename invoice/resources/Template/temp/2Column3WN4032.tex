...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalie Victoria Åkesson} \\
		{\large Layla 28}\\
		{\large 93237, Abu Dhabi, Buriam, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Patrick Rose 	 Sandberg Corp } \\
		{\large Isabelle 22}\\
		{\large 74029, San Francisco, Binh Thuan, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
