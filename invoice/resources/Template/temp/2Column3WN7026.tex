...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isaiah William Eklund} \\
		{\large Maverick 17}\\
		{\large 23476, Last Vegas, Binh Thuan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Arianna David Ekström Corp } \\
		{\large Nicolas 48}\\
		{\large 70682, Nha Trang, Henan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
