...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryker  Alexander  Olsson Inc} \\
		{\large Adam 39}\\
		{\large 24353, Moscow, Amnat Charoen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Khloe Jakobsson } \\
		{\large Ximena 2}\\
		{\large 44675, Singapore, Amnat Charoen, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
