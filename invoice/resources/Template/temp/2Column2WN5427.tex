...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope Sjöberg} \\
		{\large Julia 88}\\
		{\large 48014, Ho Chi Minh, Saarland, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaitlyn Victoria Persson Inc } \\
		{\large Lillian 71}\\
		{\large 68194, Last Vegas, Phu Yen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
