...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Maryland, College Park} \\
		{\large Maddox 77}\\
		{\large 98029, Frankfurt am Main , Chai Nat, Canada }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Joshua Olsson } \\
		{\large Gabrielle 12}\\
		{\large 65985, Dublin, Kentucky, South Korea}\\
    \switchcolumn
