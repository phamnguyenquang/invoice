...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ellie Edward Sandberg} \\
		{\large Kendall 13}\\
		{\large 91625, Singapore, Chiang Mai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexandra James Eliasson Corp } \\
		{\large Bradley 42}\\
		{\large 67487, Bonn, Texas, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
