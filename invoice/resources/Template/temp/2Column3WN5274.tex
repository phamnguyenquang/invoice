...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel Catherine  Lundqvist} \\
		{\large Colton 32}\\
		{\large 48319, Toronto, Tuscany, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Patrick Kate 	 Bergström Corp } \\
		{\large Laila 47}\\
		{\large 47491, Montreal, Binh Thuan, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
