...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Noah Catherine  Strömberg} \\
		{\large London 27}\\
		{\large 28593, San Francisco, Kentucky, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ellie Kate 	 Hermansson Pte Ltd } \\
		{\large William 13}\\
		{\large 10054, Beijing, Hawaii, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
