...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ashton Christopher Jonsson} \\
		{\large Kennedy 34}\\
		{\large 54458, Beijing, Hainan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eva William Nyberg Pte Ltd } \\
		{\large Stephanie 59}\\
		{\large 31453, Stuttgart, Ang Thong, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
