...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eden Kate 	 Arvidsson Inc} \\
		{\large Isabelle 54}\\
		{\large 82140, Ho Chi Minh, Indiana, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leilani Bergqvist } \\
		{\large Alana 60}\\
		{\large 63208, San Francisco, California, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
