...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kayden Bergman} \\
		{\large Lila 27}\\
		{\large 35508, Moscow, Phu Yen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Santiago Catherine  Engström Pte Ltd } \\
		{\large Genesis 60}\\
		{\large 18173, Vienna, Kentucky, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
