...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaden Michael Isaksson} \\
		{\large Victoria 95}\\
		{\large 24856, Nha Trang, Amnat Charoen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Scarlett Louise 	 Olofsson Corp } \\
		{\large Bennett 86}\\
		{\large 44579, San Francisco, Hawaii, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
