...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amir Catherine  Nordin Pte Ltd} \\
		{\large Everett 9}\\
		{\large 69108, Stuttgart, Binh Thuan, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Lindgren } \\
		{\large Laila 27}\\
		{\large 35341, Paris, Chiang Mai, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
