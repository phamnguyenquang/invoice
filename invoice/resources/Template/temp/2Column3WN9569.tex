...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Amy  Bengtsson} \\
		{\large Christopher 68}\\
		{\large 55717, San Francisco, Chiang Mai, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daisy James Mattsson Pte Ltd } \\
		{\large Aliyah 25}\\
		{\large 20283, Toronto, Bangkok, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
