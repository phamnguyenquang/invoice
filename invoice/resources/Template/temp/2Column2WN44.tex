...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Holmgren} \\
		{\large Michelle 12}\\
		{\large 23011, Abu Dhabi, Indiana, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rose Victoria Hellström Inc } \\
		{\large Norah 97}\\
		{\large 43013, Shanghai, Amnat Charoen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
