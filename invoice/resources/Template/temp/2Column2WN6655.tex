...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ethan Magnusson} \\
		{\large Maya 49}\\
		{\large 97307, Munich, Amnat Charoen, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rachel Catherine  Blomqvist Pte Ltd } \\
		{\large Sebastian 60}\\
		{\large 40975, Sydney, California, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
