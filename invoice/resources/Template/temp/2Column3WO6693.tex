...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sarah Amy  Mårtensson Pte Ltd} \\
		{\large Maddox 5}\\
		{\large 24300, Moscow, Buriam, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mackenzie Dahlberg } \\
		{\large Mckenzie 98}\\
		{\large 69326, San Francisco, Saarland, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
