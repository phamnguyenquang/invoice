...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nevaeh Robert Pettersson} \\
		{\large Andrew 4}\\
		{\large 46267, San Francisco, Chiang Rai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caden Elizabeth 	 Mattsson Corp } \\
		{\large Londyn 26}\\
		{\large 42593, Abu Dhabi, Texas, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
