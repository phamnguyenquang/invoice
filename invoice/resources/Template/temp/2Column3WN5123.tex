...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maxwell Louise 	 Ekström} \\
		{\large Jeremiah 59}\\
		{\large 26043, Shanghai, Chiang Mai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michael Victoria Nordin Ltd } \\
		{\large Daniela 48}\\
		{\large 87606, Last Vegas, Guangdong, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
