...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Elizabeth 	 Isaksson} \\
		{\large Cayden 11}\\
		{\large 37742, Istanbul, Heibei, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sarah  Alexander  Olsson Inc } \\
		{\large Samantha 27}\\
		{\large 51775, Toronto, Guangdong, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
