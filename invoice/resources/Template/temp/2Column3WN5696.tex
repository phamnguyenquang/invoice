...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Olivia Jane Lindberg} \\
		{\large Noah 43}\\
		{\large 92800, Beijing, Saarland, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ella Anne Hedlund Pte Ltd } \\
		{\large Nora 2}\\
		{\large 51526, Frankfurt am Main , Ang Thong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
