...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabel Kate 	 Åkesson} \\
		{\large Gianna 66}\\
		{\large 68667, Ho Chi Minh, Phu Yen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sean Peter Henriksson Inc } \\
		{\large Owen 31}\\
		{\large 85789, Boston, Buriam, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
