...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victor Catherine  Holmberg} \\
		{\large Jayla 19}\\
		{\large 10463, London , Kentucky, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emery Christopher Berglund Ltd } \\
		{\large Olivia 5}\\
		{\large 28754, London , Chiang Rai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
