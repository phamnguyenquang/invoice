...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Owen William Magnusson Pte Ltd} \\
		{\large Anthony 56}\\
		{\large 93760, Paris, Amnat Charoen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmanuel Holmberg } \\
		{\large Liam 48}\\
		{\large 43460, Frankfurt am Main , Saarland, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
