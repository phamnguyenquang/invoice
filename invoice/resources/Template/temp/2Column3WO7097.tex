...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elias May/Mae 	 Falk Ltd} \\
		{\large Destiny 70}\\
		{\large 10137, Amsterdam, California, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luca Bengtsson } \\
		{\large Oscar 42}\\
		{\large 59518, San Francisco, Chiang Mai, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
