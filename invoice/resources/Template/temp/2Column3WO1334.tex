...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriel Christopher Berg Pte Ltd} \\
		{\large Rebecca 59}\\
		{\large 83013, Amsterdam, Saarland, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melanie Gustafsson } \\
		{\large Eliza 91}\\
		{\large 71090, Nha Trang, Bangkok, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
