...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Reagan Amy  Jonsson Corp} \\
		{\large Christopher 12}\\
		{\large 64056, Ho Chi Minh, Chiang Mai, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon Lundström } \\
		{\large Joel 56}\\
		{\large 90497, Sydney, Bayern, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
