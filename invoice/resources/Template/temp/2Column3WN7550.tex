...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Greyson Rose 	 Björklund} \\
		{\large Mary 76}\\
		{\large 28831, Venice, Hessen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isaiah  Alexander  Bergqvist Pte Ltd } \\
		{\large Kendall 90}\\
		{\large 79728, Munich, Chai Nat, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
