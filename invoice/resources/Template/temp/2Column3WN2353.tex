...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gracie Christopher Hermansson} \\
		{\large Mckenzie 69}\\
		{\large 48857, Dubai, Guangzhou, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrew May/Mae 	 Lundin Pte Ltd } \\
		{\large Cameron 60}\\
		{\large 87969, Boston, Chiang Rai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
