...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariana Amy  Bergqvist} \\
		{\large Connor 14}\\
		{\large 32248, Barcelona, Saarland, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Annabelle Lee  Nordin Pte Ltd } \\
		{\large Alex 38}\\
		{\large 84752, New York , California, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
