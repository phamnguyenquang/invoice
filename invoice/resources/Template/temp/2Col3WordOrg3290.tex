...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lydia Elizabeth 	 Olofsson Ltd} \\
		{\large Joshua 97}\\
		{\large 64752, Hong Kong, khanh Hoa, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mia Eklund } \\
		{\large Asher 17}\\
		{\large 21948, Frankfurt am Main , Ang Thong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
