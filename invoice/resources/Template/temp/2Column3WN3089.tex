...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brady Kate 	 Nordström} \\
		{\large Peyton 81}\\
		{\large 31468, Frankfurt am Main , Bayern, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Scarlett Kate 	 Engström Inc } \\
		{\large Kinsley 62}\\
		{\large 10245, Madrid, Bayern, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
