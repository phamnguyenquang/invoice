...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Giovanni Marie 	 Viklund Ltd} \\
		{\large Isaac 82}\\
		{\large 54998, Rome, Chiang Rai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gracie Bengtsson } \\
		{\large Anthony 5}\\
		{\large 75944, Frankfurt am Main , Kentucky, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
