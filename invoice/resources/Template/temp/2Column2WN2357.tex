...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lila Viklund} \\
		{\large Victor 82}\\
		{\large 78995, Boston, Guangzhou, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eliana Mary 	 Dahlberg Corp } \\
		{\large Savannah 31}\\
		{\large 76246, Frankfurt am Main , Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
