...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Micah Michael Jakobsson Ltd} \\
		{\large Autumn 27}\\
		{\large 24936, Frankfurt am Main , Amnat Charoen, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sarah Martinsson } \\
		{\large Benjamin 66}\\
		{\large 44143, Ho Chi Minh, Seattles, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
