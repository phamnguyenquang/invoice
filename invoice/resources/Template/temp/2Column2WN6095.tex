...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria Mårtensson} \\
		{\large Cayden 8}\\
		{\large 57013, Melbourne, Amnat Charoen, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Victor Elizabeth 	 Samuelsson Ltd } \\
		{\large Justin 43}\\
		{\large 85506, Florence, Guangdong, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
