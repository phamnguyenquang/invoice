...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sophia Robert Andersson} \\
		{\large Kai 22}\\
		{\large 46602, Abu Dhabi, Kentucky, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Taylor Mary 	 Magnusson Pte Ltd } \\
		{\large Gael 47}\\
		{\large 30284, Lisbon, Guangdong, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
