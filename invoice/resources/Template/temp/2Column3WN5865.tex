...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maya Catherine  Nordström} \\
		{\large Giovanni 45}\\
		{\large 81323, Chicago, Floria, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jameson Marie 	 Ek Ltd } \\
		{\large James 99}\\
		{\large 11810, Washington, Bangkok, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
