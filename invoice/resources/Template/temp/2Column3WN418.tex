...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Payton Mary 	 Mohamed} \\
		{\large Lucas 36}\\
		{\large 84626, Abu Dhabi, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zachary Grace 	 Blomqvist Corp } \\
		{\large Laila 77}\\
		{\large 90878, Florence, Phu Yen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
