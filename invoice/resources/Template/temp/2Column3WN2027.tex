...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aurora David Pettersson} \\
		{\large Jonah 80}\\
		{\large 42808, Stuttgart, Kentucky, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sean Thomas Sjöberg Ltd } \\
		{\large Izabella 18}\\
		{\large 61045, Taipei, Tuscany, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
