...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harrison Robert Danielsson} \\
		{\large Sarah 76}\\
		{\large 75202, Tokyo, Guangdong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joshua Amy  Falk Pte Ltd } \\
		{\large Bennett 67}\\
		{\large 89134, Abu Dhabi, Hessen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
