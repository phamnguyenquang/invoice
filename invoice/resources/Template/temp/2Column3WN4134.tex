...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Timothy Catherine  Hellström} \\
		{\large Aaliyah 82}\\
		{\large 84889, Los Angeles, Hawaii, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Olivia Edward Svensson Pte Ltd } \\
		{\large Jeremy 97}\\
		{\large 19556, Hanoi, Chai Nat, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
