...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jace Christopher Månsson} \\
		{\large Alexander 83}\\
		{\large 87731, Frankfurt am Main , Hamburg, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josephine Ann  Holmberg Ltd } \\
		{\large David 56}\\
		{\large 48167, Frankfurt am Main , Amnat Charoen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
