...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bradley Peter Lundström} \\
		{\large Allison 95}\\
		{\large 66425, Hong Kong, khanh Hoa, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josephine Victoria Arvidsson Ltd } \\
		{\large Isaiah 97}\\
		{\large 58482, Chicago, Bangkok, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
