...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sawyer Michael Åberg} \\
		{\large Anna 35}\\
		{\large 36851, Abu Dhabi, Hawaii, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jason Catherine  Blomqvist Pte Ltd } \\
		{\large Hudson 50}\\
		{\large 72947, Minsk, Ang Thong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
