...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jordyn Elizabeth 	 Lundin} \\
		{\large Jeremiah 84}\\
		{\large 65878, Sydney, Heibei, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brielle Edward Persson Corp } \\
		{\large Emmett 38}\\
		{\large 70473, SaiGon, Binh Thuan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
