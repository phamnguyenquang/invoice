...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ayden Catherine  Svensson} \\
		{\large Mark 87}\\
		{\large 28983, Beijing, Ang Thong, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Thomas Catherine  Hermansson Ltd } \\
		{\large Calvin 57}\\
		{\large 37707, Boston, Phu Yen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
