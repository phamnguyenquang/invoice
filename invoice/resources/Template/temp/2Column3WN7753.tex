...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caden Christopher Jonsson} \\
		{\large Adalynn 50}\\
		{\large 19306, Frankfurt am Main , Hessen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melody Rose 	 Danielsson Pte Ltd } \\
		{\large Robert 3}\\
		{\large 75054, Hong Kong, Binh Thuan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
