...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Damian Thomas Pettersson Corp} \\
		{\large Josephine 98}\\
		{\large 28241, Frankfurt am Main , Chiang Rai, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Lundgren } \\
		{\large Ellie 29}\\
		{\large 13714, Milan, Bayern, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
