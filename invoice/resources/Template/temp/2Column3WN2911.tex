...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklynn Catherine  Abrahamsson} \\
		{\large Mariah 42}\\
		{\large 27280, Washington, Hamburg, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maya Jane Henriksson Corp } \\
		{\large Weston 50}\\
		{\large 99811, Last Vegas, Kentucky, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
