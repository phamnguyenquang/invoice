...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emilia Catherine  Jakobsson} \\
		{\large Jake 95}\\
		{\large 78853, Florence, Huabei, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camila  Alexander  Jansson Pte Ltd } \\
		{\large Jameson 39}\\
		{\large 60275, Ho Chi Minh, Huabei, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
