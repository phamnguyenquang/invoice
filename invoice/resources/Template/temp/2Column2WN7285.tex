...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elena Hassan} \\
		{\large Sean 18}\\
		{\large 78534, Stuttgart, Phu Yen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy Amy  Lindgren Pte Ltd } \\
		{\large Victor 68}\\
		{\large 35806, Last Vegas, Chiang Mai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
