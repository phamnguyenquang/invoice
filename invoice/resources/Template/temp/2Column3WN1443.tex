...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Miguel James Isaksson} \\
		{\large Wesley 75}\\
		{\large 82986, San Francisco, Hessen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alex Thomas Lindqvist Corp } \\
		{\large Kendall 54}\\
		{\large 57713, Melbourne, California, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
