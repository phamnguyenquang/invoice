...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Connor Catherine  Björklund Corp} \\
		{\large Liam 99}\\
		{\large 37764, Montreal, Chai Nat, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Claire Gustafsson } \\
		{\large Michelle 51}\\
		{\large 12280, Boston, California, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
