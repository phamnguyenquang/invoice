...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aria Mary 	 Andreasson} \\
		{\large Ashley 41}\\
		{\large 13450, Vancouver, Henan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katelyn Lee  Pålsson Inc } \\
		{\large Ellie 2}\\
		{\large 69830, Frankfurt am Main , Chiang Mai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
