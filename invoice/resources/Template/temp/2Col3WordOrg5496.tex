...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Greyson Elizabeth 	 Olofsson Corp} \\
		{\large Joseph 29}\\
		{\large 35881, Ho Chi Minh, Seattles, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julian Abrahamsson } \\
		{\large Justin 21}\\
		{\large 71807, Toronto, Chiang Rai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
