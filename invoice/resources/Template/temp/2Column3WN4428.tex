...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mckenzie Louise 	 Olsson} \\
		{\large Isabella 85}\\
		{\large 95689, Frankfurt am Main , Buriam, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hannah Thomas Dahl Ltd } \\
		{\large Penelope 68}\\
		{\large 49057, Vancouver, Tuscany, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
