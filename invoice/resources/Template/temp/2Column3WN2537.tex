...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Willow Christopher Strömberg} \\
		{\large Adeline 55}\\
		{\large 58662, Paris, Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paisley May/Mae 	 Lindgren Inc } \\
		{\large Paisley 67}\\
		{\large 69294, Moscow, Chiang Mai, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
