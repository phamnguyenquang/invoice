...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ashley Marie 	 Lindqvist} \\
		{\large Greyson 30}\\
		{\large 81870, Tokyo, Hainan, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Destiny Mary 	 Persson Pte Ltd } \\
		{\large Jason 89}\\
		{\large 45462, London , Guangzhou, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
