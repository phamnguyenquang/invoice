...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Thomas Berglund Pte Ltd} \\
		{\large Adam 2}\\
		{\large 95252, Florence, Binh Thuan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stella Gunnarsson } \\
		{\large Declan 19}\\
		{\large 41305, Chicago, Hamburg, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
