...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Antonio Edward Viklund} \\
		{\large Alex 32}\\
		{\large 10053, Minsk, Guangdong, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Skylar Grace 	 Löfgren Pte Ltd } \\
		{\large Oscar 85}\\
		{\large 86406, San Francisco, Buriam, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
