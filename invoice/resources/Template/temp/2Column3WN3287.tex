...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Michael Lindholm} \\
		{\large Declan 88}\\
		{\large 65914, Singapore, Huabei, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Giovanni Kate 	 Wallin Corp } \\
		{\large Ethan 25}\\
		{\large 63914, Barcelona, Bangkok, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
