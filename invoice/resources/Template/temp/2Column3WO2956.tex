...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Weston Catherine  Gunnarsson Ltd} \\
		{\large Kaylee 64}\\
		{\large 87981, London , Guangdong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubrey Henriksson } \\
		{\large Jeremiah 29}\\
		{\large 72434, Ho Chi Minh, Heibei, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
