...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicholas Louise 	 Andreasson} \\
		{\large Camila 25}\\
		{\large 62141, New York , Hamburg, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Savannah William Andersson Inc } \\
		{\large Bryan 7}\\
		{\large 21805, Budapest, Texas, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
