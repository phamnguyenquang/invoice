...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elise Louise 	 Lindström} \\
		{\large Hazel 48}\\
		{\large 65424, Taipei, Saarland, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore Louise 	 Arvidsson Corp } \\
		{\large Ava 65}\\
		{\large 50377, Los Angeles, Tuscany, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
