...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonathan Mary 	 Söderberg} \\
		{\large Adeline 38}\\
		{\large 49846, Frankfurt am Main , Indiana, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriel David Berggren Corp } \\
		{\large Kaden 39}\\
		{\large 49237, Tokyo, California, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
