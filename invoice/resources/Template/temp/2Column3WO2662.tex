...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jocelyn Christopher Månsson Pte Ltd} \\
		{\large Julian 81}\\
		{\large 90053, Istanbul, Kentucky, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Asher Holmberg } \\
		{\large Wyatt 78}\\
		{\large 61448, Frankfurt am Main , Hessen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
