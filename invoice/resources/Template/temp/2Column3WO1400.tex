...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nolan William Lundgren Pte Ltd} \\
		{\large Melanie 27}\\
		{\large 76878, Florence, Chai Nat, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Colton Karlsson } \\
		{\large Victoria 26}\\
		{\large 54136, Frankfurt am Main , Heibei, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
