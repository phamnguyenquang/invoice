...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gianna Hellström} \\
		{\large Jeremy 40}\\
		{\large 59845, Boston, Binh Thuan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Dominic Marie 	 Nordström Corp } \\
		{\large Ellie 48}\\
		{\large 27123, San Francisco, Bremen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
