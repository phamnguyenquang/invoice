...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Oscar  Alexander  Olofsson Corp} \\
		{\large Jasmine 18}\\
		{\large 94995, Vienna, Amnat Charoen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooke Magnusson } \\
		{\large Chase 27}\\
		{\large 25168, Frankfurt am Main , California, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
