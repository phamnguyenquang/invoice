...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmett Martinsson} \\
		{\large Reagan 64}\\
		{\large 50890, Abu Dhabi, Tuscany, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jace  Alexander  Åkesson Pte Ltd } \\
		{\large Madeline 81}\\
		{\large 84380, Frankfurt am Main , Guangdong, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
