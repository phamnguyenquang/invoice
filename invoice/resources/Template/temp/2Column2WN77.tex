...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jude Fredriksson} \\
		{\large Madeline 37}\\
		{\large 52047, Lisbon, Binh Thuan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Willow Rose 	 Eklund Pte Ltd } \\
		{\large Vincent 96}\\
		{\large 14949, Los Angeles, Seattles, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
