...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bella David Holm} \\
		{\large Melanie 26}\\
		{\large 54339, Frankfurt am Main , Hainan, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Izabella John Sandberg Corp } \\
		{\large Eliana 79}\\
		{\large 92255, Ho Chi Minh, khanh Hoa, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
