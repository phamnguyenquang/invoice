...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brady William Magnusson} \\
		{\large Vincent 42}\\
		{\large 77202, Melbourne, Indiana, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariana Grace 	 Lindholm Corp } \\
		{\large Austin 7}\\
		{\large 92180, New York , Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
