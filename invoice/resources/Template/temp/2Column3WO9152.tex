...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalia Victoria Lindberg Pte Ltd} \\
		{\large Aubrey 1}\\
		{\large 75584, Washington, Chai Nat, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Victor Johansson } \\
		{\large Vivian 63}\\
		{\large 85845, Singapore, Tuscany, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
