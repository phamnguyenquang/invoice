...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juliana Michael Eriksson} \\
		{\large Mila 49}\\
		{\large 15799, Moscow, Hamburg, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Morgan Elizabeth 	 Hansen Pte Ltd } \\
		{\large Aaliyah 59}\\
		{\large 25472, Frankfurt am Main , California, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
