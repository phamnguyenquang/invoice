...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Elizabeth 	 Öberg} \\
		{\large Jaden 70}\\
		{\large 59294, Chicago, California, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bradley Elizabeth 	 Ahmed Ltd } \\
		{\large Brady 99}\\
		{\large 77407, Denver, Hainan, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
