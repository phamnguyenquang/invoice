...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniel Michael Viklund} \\
		{\large Reese 92}\\
		{\large 26948, Denver, Saarland, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesse Thomas Lindström Corp } \\
		{\large Liliana 44}\\
		{\large 15900, Frankfurt am Main , Bayern, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
