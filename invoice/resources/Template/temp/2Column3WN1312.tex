...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dominic Robert Holmgren} \\
		{\large Elena 88}\\
		{\large 78148, Ho Chi Minh, California, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ava Grace 	 Bergström Pte Ltd } \\
		{\large Adeline 48}\\
		{\large 98172, Seoul, Bayern, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
