...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emery Rose 	 Ali} \\
		{\large Paul 35}\\
		{\large 57286, Denver, Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalynn William Isaksson Pte Ltd } \\
		{\large Kyle 29}\\
		{\large 84517, Montreal, Hainan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
