...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abel Thomas Abrahamsson} \\
		{\large Natalia 80}\\
		{\large 21811, Florence, Chiang Mai, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Naomi May/Mae 	 Wikström Pte Ltd } \\
		{\large Emily 33}\\
		{\large 59658, Bonn, Henan, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
