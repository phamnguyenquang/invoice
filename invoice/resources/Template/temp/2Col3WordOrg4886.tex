...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adriana Marie 	 Samuelsson Pte Ltd} \\
		{\large Greyson 13}\\
		{\large 99828, Los Angeles, Saarland, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Asher Gunnarsson } \\
		{\large Jocelyn 71}\\
		{\large 56956, Vancouver, Saarland, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
