...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lillian David Henriksson} \\
		{\large Brielle 36}\\
		{\large 36181, San Francisco, Seattles, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brady Marie 	 Sundberg Ltd } \\
		{\large Aiden 86}\\
		{\large 81941, Melbourne, Huabei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
