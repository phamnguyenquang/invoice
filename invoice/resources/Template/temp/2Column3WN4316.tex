...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremiah Peter Andersson} \\
		{\large Mason 30}\\
		{\large 62539, Frankfurt am Main , Bremen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Victoria Håkansson Pte Ltd } \\
		{\large Jace 54}\\
		{\large 70345, Florence, Indiana, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
