...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jasmine Mary 	 Lundin} \\
		{\large Avery 35}\\
		{\large 86653, Toronto, Hainan, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabelle May/Mae 	 Nordström Corp } \\
		{\large Aubree 52}\\
		{\large 12275, Frankfurt am Main , Hainan, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
