...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalia Lindgren} \\
		{\large Theodore 95}\\
		{\large 61532, Stuttgart, Chiang Rai, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaleb Catherine  Karlsson Pte Ltd } \\
		{\large Leah 19}\\
		{\large 61891, Budapest, Hainan, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
