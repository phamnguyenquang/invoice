...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lilly Grace 	 Fransson} \\
		{\large Adriana 93}\\
		{\large 94303, Rome, Tuscany, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Serenity Elizabeth 	 Strömberg Ltd } \\
		{\large Alaina 40}\\
		{\large 67257, San Francisco, khanh Hoa, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
