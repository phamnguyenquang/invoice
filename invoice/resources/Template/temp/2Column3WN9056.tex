...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall  Alexander  Mattsson} \\
		{\large Piper 31}\\
		{\large 13553, London , Bangkok, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mckenzie Grace 	 Hansen Corp } \\
		{\large Brandon 10}\\
		{\large 26208, Abu Dhabi, Texas, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
