...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stephanie Christopher Hansson Inc} \\
		{\large Anthony 10}\\
		{\large 14422, San Francisco, Chiang Rai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonah Axelsson } \\
		{\large Evelyn 80}\\
		{\large 61863, Ho Chi Minh, Hainan, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
