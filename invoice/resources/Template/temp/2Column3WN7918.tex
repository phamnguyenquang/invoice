...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jennifer Jane Lundin} \\
		{\large Jayla 39}\\
		{\large 60471, Ho Chi Minh, Chiang Mai, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hannah Catherine  Söderberg Inc } \\
		{\large Rose 66}\\
		{\large 20255, Vienna, Guangdong, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
