...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Clara John Lund} \\
		{\large Cayden 94}\\
		{\large 58420, Minsk, Floria, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large David David Fredriksson Pte Ltd } \\
		{\large Miles 95}\\
		{\large 17957, Last Vegas, California, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
