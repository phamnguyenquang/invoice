...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra Mary 	 Eklund} \\
		{\large Josiah 3}\\
		{\large 95724, Istanbul, Chiang Mai, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Henry  Alexander  Mohamed Pte Ltd } \\
		{\large Lincoln 85}\\
		{\large 17230, Nha Trang, Saarland, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
