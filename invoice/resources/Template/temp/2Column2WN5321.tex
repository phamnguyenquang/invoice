...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabella Samuelsson} \\
		{\large Khloe 78}\\
		{\large 45994, Florence, California, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Preston Louise 	 Sandström Pte Ltd } \\
		{\large Reese 72}\\
		{\large 51413, Istanbul, California, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
