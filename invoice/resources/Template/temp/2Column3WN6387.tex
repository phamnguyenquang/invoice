...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexis  Alexander  Eriksson} \\
		{\large Payton 84}\\
		{\large 11865, Vienna, Hessen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Colton Christopher Claesson Ltd } \\
		{\large Nathan 6}\\
		{\large 56891, Toronto, Guangdong, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
