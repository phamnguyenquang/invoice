...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexander Mary 	 Pettersson} \\
		{\large Damian 53}\\
		{\large 19693, Florence, Binh Thuan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison Grace 	 Lind Ltd } \\
		{\large Brooklynn 1}\\
		{\large 65973, Vancouver, khanh Hoa, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
