...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sara William Lundgren} \\
		{\large Emily 58}\\
		{\large 89344, SaiGon, Guangzhou, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sadie Elizabeth 	 Forsberg Pte Ltd } \\
		{\large Melody 15}\\
		{\large 32748, Bonn, Bangkok, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
