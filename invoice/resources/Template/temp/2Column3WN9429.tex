...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Annabelle Robert Sjögren} \\
		{\large Ryker 8}\\
		{\large 34209, Seoul, Hainan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Giovanni Louise 	 Abrahamsson Inc } \\
		{\large Paul 27}\\
		{\large 80383, Beijing, Chai Nat, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
