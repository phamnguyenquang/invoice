...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stella Marie 	 Jonsson} \\
		{\large Levi 93}\\
		{\large 75906, Hong Kong, khanh Hoa, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mila James Lindberg Ltd } \\
		{\large Samantha 60}\\
		{\large 89240, Frankfurt am Main , Hessen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
