...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly Louise 	 Björklund} \\
		{\large Serenity 35}\\
		{\large 59134, Nha Trang, Buriam, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ayden Louise 	 Håkansson Pte Ltd } \\
		{\large Catherine 59}\\
		{\large 79847, Nha Trang, Heibei, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
