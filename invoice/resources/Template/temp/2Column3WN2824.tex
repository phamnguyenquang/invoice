...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abraham Anne Bergström} \\
		{\large Kaylee 98}\\
		{\large 95950, Milan, Tuscany, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Catherine  Sundberg Corp } \\
		{\large Logan 39}\\
		{\large 91790, Berlin, Chiang Mai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
