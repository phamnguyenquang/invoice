...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariana Louise 	 Mattsson} \\
		{\large Ayden 31}\\
		{\large 44109, Chicago, Binh Thuan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicolas Kate 	 Eliasson Inc } \\
		{\large Ryleigh 68}\\
		{\large 92128, Los Angeles, Bangkok, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
