...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juan Anne Gunnarsson} \\
		{\large Hannah 75}\\
		{\large 96792, Hong Kong, Ang Thong, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Dominic Victoria Nordin Pte Ltd } \\
		{\large Madelyn 17}\\
		{\large 52641, Madrid, Guangzhou, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
