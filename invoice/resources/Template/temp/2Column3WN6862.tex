...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ethan Peter Blomqvist} \\
		{\large Cole 40}\\
		{\large 51740, San Francisco, California, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmett Amy  Sandberg Pte Ltd } \\
		{\large Tyler 88}\\
		{\large 45076, Madrid, Bayern, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
