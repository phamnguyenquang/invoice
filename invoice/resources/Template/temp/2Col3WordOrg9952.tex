...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Wesley Elizabeth 	 Axelsson Inc} \\
		{\large Luis 3}\\
		{\large 98736, Boston, Seattles, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremy Arvidsson } \\
		{\large Isla 62}\\
		{\large 57317, Frankfurt am Main , Guangdong, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
