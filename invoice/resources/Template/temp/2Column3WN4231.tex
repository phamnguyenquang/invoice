...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juliana Victoria Danielsson} \\
		{\large Catherine 76}\\
		{\large 16799, San Francisco, Ang Thong, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxon Anne Engström Pte Ltd } \\
		{\large Eliza 66}\\
		{\large 75359, San Francisco, Heibei, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
