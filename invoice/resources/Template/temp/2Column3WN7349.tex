...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joel  Alexander  Lundgren} \\
		{\large Adriana 55}\\
		{\large 68595, Munich, Indiana, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayden Michael Lindqvist Inc } \\
		{\large Ava 95}\\
		{\large 47139, Montreal, California, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
