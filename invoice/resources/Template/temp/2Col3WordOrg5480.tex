...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Oliver Marie 	 Isaksson Pte Ltd} \\
		{\large Caden 12}\\
		{\large 96130, Vancouver, Ang Thong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lydia Öberg } \\
		{\large Carter 73}\\
		{\large 11785, Shanghai, Amnat Charoen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
