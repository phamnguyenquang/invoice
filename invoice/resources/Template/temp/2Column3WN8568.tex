...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  David David Lindström} \\
		{\large Tyler 80}\\
		{\large 68796, Sydney, Chiang Mai, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Violet Christopher Jakobsson Ltd } \\
		{\large Hayden 24}\\
		{\large 82660, Florence, Hawaii, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
