...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie Amy  Lundgren Corp} \\
		{\large Jaden 99}\\
		{\large 97079, Hong Kong, Guangzhou, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ezra Ström } \\
		{\large Rachel 78}\\
		{\large 55031, Frankfurt am Main , Hessen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
