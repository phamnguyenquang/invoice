...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaden James Ström} \\
		{\large Owen 30}\\
		{\large 47345, Frankfurt am Main , Chiang Mai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vincent Elizabeth 	 Bengtsson Inc } \\
		{\large Ashton 68}\\
		{\large 22967, Beijing, Kentucky, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
