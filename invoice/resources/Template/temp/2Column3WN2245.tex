...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carlos Michael Ek} \\
		{\large Julian 20}\\
		{\large 65555, Frankfurt am Main , Binh Thuan, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas Edward Lindgren Inc } \\
		{\large Mark 10}\\
		{\large 98042, Frankfurt am Main , Hessen, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
