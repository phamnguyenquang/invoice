...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sophie Sandberg Pte Ltd} \\
		{\large Brayden 69}\\
		{\large 13877, Frankfurt am Main , Amnat Charoen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tucker Berggren } \\
		{\large Jose 43}\\
		{\large 95659, Chicago, Seattles, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
