...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katelyn Robert Lind} \\
		{\large Emmett 10}\\
		{\large 88886, Melbourne, Hainan, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalie Christopher Jansson Corp } \\
		{\large Dominic 60}\\
		{\large 78885, Frankfurt am Main , Bangkok, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
