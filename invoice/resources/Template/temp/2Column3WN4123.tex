...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rachel Elizabeth 	 Karlsson} \\
		{\large Edward 59}\\
		{\large 53047, Chicago, Buriam, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxon James Eklund Pte Ltd } \\
		{\large Zachary 34}\\
		{\large 45529, Singapore, Amnat Charoen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
