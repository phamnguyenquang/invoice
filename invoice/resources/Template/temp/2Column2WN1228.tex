...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isaac Isaksson} \\
		{\large Zachary 32}\\
		{\large 97691, Venice, Bangkok, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caden Robert Lindström Corp } \\
		{\large Adam 83}\\
		{\large 23035, Frankfurt am Main , Chiang Mai, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
