...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joshua Thomas Sandström} \\
		{\large Declan 21}\\
		{\large 18273, Los Angeles, Tuscany, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabrielle  Alexander  Lindholm Corp } \\
		{\large Easton 29}\\
		{\large 95522, Last Vegas, Bangkok, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
