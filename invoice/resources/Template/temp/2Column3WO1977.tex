...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gael Catherine  Sjöberg Pte Ltd} \\
		{\large Ashley 62}\\
		{\large 55234, Vancouver, Chiang Mai, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alejandro Berggren } \\
		{\large Adriana 52}\\
		{\large 51415, San Francisco, Chai Nat, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
