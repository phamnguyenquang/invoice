...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaliyah Mårtensson} \\
		{\large Cora 36}\\
		{\large 65252, Rome, Guangzhou, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore May/Mae 	 Isaksson Pte Ltd } \\
		{\large Makenzie 76}\\
		{\large 13455, Melbourne, Heibei, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
