...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zoey May/Mae 	 Axelsson} \\
		{\large Natalia 49}\\
		{\large 37463, Ho Chi Minh, Henan, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mason Elizabeth 	 Berglund Corp } \\
		{\large Ruby 91}\\
		{\large 38767, Washington, Hessen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
