...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lila Peter Lundström} \\
		{\large Eden 46}\\
		{\large 35615, Frankfurt am Main , Huabei, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery  Alexander  Sandström Inc } \\
		{\large Victor 46}\\
		{\large 80233, Madrid, Kentucky, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
