...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Amy  Blomqvist Pte Ltd} \\
		{\large Connor 2}\\
		{\large 33669, Beijing, khanh Hoa, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anthony Persson } \\
		{\large Gracie 90}\\
		{\large 60959, San Francisco, Amnat Charoen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
