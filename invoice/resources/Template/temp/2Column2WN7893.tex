...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zachary Engström} \\
		{\large Catherine 38}\\
		{\large 45247, Frankfurt am Main , Amnat Charoen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harper William Fredriksson Pte Ltd } \\
		{\large Declan 59}\\
		{\large 50348, Melbourne, Guangzhou, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
