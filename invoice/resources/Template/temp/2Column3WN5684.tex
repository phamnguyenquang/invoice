...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Payton Victoria Nyström} \\
		{\large Sawyer 26}\\
		{\large 70312, Amsterdam, Chiang Mai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucas Elizabeth 	 Bergqvist Pte Ltd } \\
		{\large Jonathan 52}\\
		{\large 47458, Hanoi, Bremen, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
