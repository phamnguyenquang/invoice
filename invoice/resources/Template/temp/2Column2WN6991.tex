...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Bergqvist} \\
		{\large Oliver 53}\\
		{\large 10965, Istanbul, Bangkok, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathaniel Elizabeth 	 Pålsson Pte Ltd } \\
		{\large Samuel 65}\\
		{\large 23607, Sydney, Guangzhou, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
