...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elise May/Mae 	 Lindberg Corp} \\
		{\large Noah 75}\\
		{\large 73480, Dublin, Huabei, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emery Sandström } \\
		{\large Isaac 79}\\
		{\large 30852, San Francisco, Amnat Charoen, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
