...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mya Christopher Mohamed} \\
		{\large Lydia 2}\\
		{\large 66189, Vienna, Amnat Charoen, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lyla Thomas Hellström Pte Ltd } \\
		{\large Santiago 74}\\
		{\large 48150, Tokyo, Guangdong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
