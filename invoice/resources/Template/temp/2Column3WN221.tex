...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  King Victoria Lundin} \\
		{\large Lily 69}\\
		{\large 65051, Los Angeles, Kentucky, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adeline Christopher Wallin Pte Ltd } \\
		{\large Kinsley 69}\\
		{\large 34168, Bonn, Huabei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
