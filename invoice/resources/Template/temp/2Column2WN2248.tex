...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jade Jonsson} \\
		{\large Preston 81}\\
		{\large 72757, San Francisco, Saarland, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Allison Louise 	 Svensson Inc } \\
		{\large Caleb 76}\\
		{\large 91154, Frankfurt am Main , Chiang Rai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
