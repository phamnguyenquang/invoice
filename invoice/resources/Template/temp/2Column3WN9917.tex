...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brayden Elizabeth 	 Henriksson} \\
		{\large Graham 2}\\
		{\large 13135, Osaka, Tuscany, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan Amy  Fredriksson Corp } \\
		{\large Khloe 36}\\
		{\large 69918, Barcelona, Chai Nat, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
