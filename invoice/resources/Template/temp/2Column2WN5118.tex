...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Samuel Johansson} \\
		{\large Emilia 99}\\
		{\large 52062, Los Angeles, Binh Thuan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy May/Mae 	 Eklund Ltd } \\
		{\large Valeria 12}\\
		{\large 17984, Nha Trang, California, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
