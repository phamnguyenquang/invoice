...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kingston Elizabeth 	 Lundberg Corp} \\
		{\large Colton 74}\\
		{\large 31728, Los Angeles, Binh Thuan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Peyton Mohamed } \\
		{\large Noah 71}\\
		{\large 55510, Budapest, Saarland, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
