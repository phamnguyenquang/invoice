...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madelyn Elizabeth 	 Lindqvist} \\
		{\large Alana 32}\\
		{\large 76145, Los Angeles, California, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ruby Ann  Lindberg Pte Ltd } \\
		{\large Delilah 58}\\
		{\large 97633, Singapore, Chai Nat, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
