...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniela Löfgren} \\
		{\large Alaina 65}\\
		{\large 87703, Los Angeles, Indiana, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Summer Grace 	 Eliasson Pte Ltd } \\
		{\large Ella 16}\\
		{\large 31953, Stuttgart, Indiana, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
