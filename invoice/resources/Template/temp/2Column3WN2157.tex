...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victor  Alexander  Berglund} \\
		{\large Jayden 4}\\
		{\large 68857, Frankfurt am Main , Hainan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caleb  Alexander  Åkesson Corp } \\
		{\large Ezra 44}\\
		{\large 97865, Osaka, Hawaii, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
