...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luna Christopher Andersson Pte Ltd} \\
		{\large Naomi 4}\\
		{\large 29572, Shanghai, Heibei, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sofia Ström } \\
		{\large Willow 86}\\
		{\large 59453, Frankfurt am Main , Kentucky, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
