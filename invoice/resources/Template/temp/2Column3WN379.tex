...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grayson Michael Jönsson} \\
		{\large Hudson 47}\\
		{\large 31631, Shanghai, Ang Thong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vanessa David Lindgren Corp } \\
		{\large Andrea 99}\\
		{\large 34007, Boston, Ang Thong, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
