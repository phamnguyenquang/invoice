...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ruby Victoria Gustafsson} \\
		{\large Norah 92}\\
		{\large 25235, London , Huabei, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bennett Louise 	 Bergman Corp } \\
		{\large Evelyn 17}\\
		{\large 82918, Frankfurt am Main , Saarland, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
