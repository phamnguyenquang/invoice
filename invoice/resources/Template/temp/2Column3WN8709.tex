...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maxwell Michael Berglund} \\
		{\large Sophia 94}\\
		{\large 87418, Dubai, California, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabella May/Mae 	 Bergman Inc } \\
		{\large Olivia 6}\\
		{\large 36061, Last Vegas, Chai Nat, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
