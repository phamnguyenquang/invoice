...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mackenzie Jane Bergqvist} \\
		{\large Santiago 77}\\
		{\large 85399, Lisbon, Guangzhou, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michelle Lee  Abrahamsson Pte Ltd } \\
		{\large Patrick 3}\\
		{\large 97526, Budapest, Bayern, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
