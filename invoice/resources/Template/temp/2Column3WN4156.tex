...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaylee Catherine  Sandberg} \\
		{\large Grace 84}\\
		{\large 72074, Berlin, Kentucky, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklyn  Alexander  Löfgren Ltd } \\
		{\large Jonathan 14}\\
		{\large 11884, Barcelona, Phu Yen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
