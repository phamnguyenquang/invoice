...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lilly Hassan} \\
		{\large Levi 91}\\
		{\large 49900, Abu Dhabi, Heibei, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Colton  Alexander  Fransson Pte Ltd } \\
		{\large Isla 32}\\
		{\large 10175, Last Vegas, Tuscany, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
