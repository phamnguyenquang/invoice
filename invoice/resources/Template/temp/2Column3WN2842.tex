...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalie Catherine  Larsson} \\
		{\large Robert 52}\\
		{\large 85098, Singapore, Binh Thuan, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Matthew  Alexander  Hermansson Inc } \\
		{\large Melody 3}\\
		{\large 67063, Chicago, Saarland, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
