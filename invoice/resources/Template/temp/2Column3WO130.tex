...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abigail Anne Bengtsson Corp} \\
		{\large Arianna 24}\\
		{\large 75337, Milan, Ang Thong, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katherine Andersson } \\
		{\large Jesse 15}\\
		{\large 35216, San Francisco, Kentucky, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
