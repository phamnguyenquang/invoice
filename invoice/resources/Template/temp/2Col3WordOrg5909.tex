...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kai Robert Nordin Inc} \\
		{\large Parker 99}\\
		{\large 67875, Frankfurt am Main , Binh Thuan, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valerie Sundberg } \\
		{\large Cameron 4}\\
		{\large 65577, Toronto, Guangzhou, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
