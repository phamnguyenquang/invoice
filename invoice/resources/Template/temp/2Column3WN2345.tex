...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxson Lee  Strömberg} \\
		{\large Aubree 85}\\
		{\large 20529, Abu Dhabi, Guangzhou, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryker William Eliasson Pte Ltd } \\
		{\large Diego 11}\\
		{\large 21428, Singapore, Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
