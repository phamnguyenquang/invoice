...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonathan Persson Corp} \\
		{\large Aiden 52}\\
		{\large 28071, Frankfurt am Main , Amnat Charoen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aidan Pålsson } \\
		{\large Ayden 3}\\
		{\large 57998, Singapore, Chiang Rai, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
