...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Catherine  Nyström} \\
		{\large Steven 5}\\
		{\large 95669, Toronto, Saarland, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bailey May/Mae 	 Berg Pte Ltd } \\
		{\large Leah 41}\\
		{\large 34402, Abu Dhabi, Chiang Rai, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
