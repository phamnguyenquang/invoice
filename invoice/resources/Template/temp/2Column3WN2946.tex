...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aidan Mary 	 Engström} \\
		{\large Isabel 8}\\
		{\large 81641, Melbourne, Heibei, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brielle Christopher Abrahamsson Corp } \\
		{\large Jack 26}\\
		{\large 55692, Hong Kong, Chiang Mai, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
