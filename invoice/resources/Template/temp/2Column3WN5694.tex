...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rose Edward Andreasson} \\
		{\large Bradley 53}\\
		{\large 64192, Toronto, Phu Yen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jacob Edward Svensson Ltd } \\
		{\large Michael 83}\\
		{\large 75228, Frankfurt am Main , Kentucky, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
