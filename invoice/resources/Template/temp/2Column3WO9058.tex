...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vivian Catherine  Pettersson Inc} \\
		{\large Quinn 40}\\
		{\large 91147, Hong Kong, Saarland, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caroline Hermansson } \\
		{\large Angelina 55}\\
		{\large 57527, Frankfurt am Main , Hessen, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
