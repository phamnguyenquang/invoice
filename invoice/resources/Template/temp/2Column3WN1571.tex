...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stephanie Robert Hellström} \\
		{\large Jesus 74}\\
		{\large 40875, Barcelona, Heibei, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lilly Catherine  Andersson Ltd } \\
		{\large Maxwell 63}\\
		{\large 95537, Taipei, Guangdong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
