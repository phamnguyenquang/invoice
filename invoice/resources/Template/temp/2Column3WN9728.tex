...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michael Peter Bengtsson} \\
		{\large Jocelyn 98}\\
		{\large 78878, Nha Trang, Phu Yen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxson Edward Sandström Inc } \\
		{\large Ashton 61}\\
		{\large 54851, Istanbul, Guangdong, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
