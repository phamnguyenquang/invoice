...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dominic  Alexander  Mattsson} \\
		{\large Brooke 55}\\
		{\large 50004, Milan, Amnat Charoen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hailey Jane Lundin Pte Ltd } \\
		{\large Sophie 45}\\
		{\large 53286, Moscow, Guangzhou, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
