...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicholas Victoria Mårtensson} \\
		{\large Jack 99}\\
		{\large 10313, Stuttgart, Huabei, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Edward Lee  Jonsson Pte Ltd } \\
		{\large Ariel 24}\\
		{\large 99739, Vancouver, California, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
