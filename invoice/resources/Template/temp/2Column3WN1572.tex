...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Piper Christopher Lind} \\
		{\large Sadie 34}\\
		{\large 74297, Stuttgart, Hawaii, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sara Thomas Magnusson Pte Ltd } \\
		{\large Penelope 82}\\
		{\large 85202, Lisbon, Bremen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
