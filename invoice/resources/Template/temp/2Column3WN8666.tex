...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle Elizabeth 	 Nordin} \\
		{\large Sophie 73}\\
		{\large 72703, Frankfurt am Main , Bangkok, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Victoria Mary 	 Lindberg Ltd } \\
		{\large Piper 36}\\
		{\large 18562, Osaka, Binh Thuan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
