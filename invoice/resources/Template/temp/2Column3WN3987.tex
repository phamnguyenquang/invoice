...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Timothy Elizabeth 	 Pettersson} \\
		{\large Diego 67}\\
		{\large 63761, Chicago, Binh Thuan, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alice Elizabeth 	 Bergman Ltd } \\
		{\large Elise 83}\\
		{\large 38808, Nha Trang, Floria, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
