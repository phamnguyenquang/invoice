...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Richard Marie 	 Eliasson Inc} \\
		{\large Lucy 79}\\
		{\large 26941, Frankfurt am Main , Chiang Rai, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian Månsson } \\
		{\large Alyssa 75}\\
		{\large 52178, Madrid, Saarland, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
