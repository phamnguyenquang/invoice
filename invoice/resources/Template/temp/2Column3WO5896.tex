...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Blake Grace 	 Forsberg Corp} \\
		{\large Taylor 86}\\
		{\large 78613, Nha Trang, Ang Thong, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmanuel Strömberg } \\
		{\large Emilia 45}\\
		{\large 25832, Stuttgart, khanh Hoa, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
