...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonathan William Viklund} \\
		{\large Sydney 46}\\
		{\large 18164, Los Angeles, khanh Hoa, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eric David Blomqvist Pte Ltd } \\
		{\large Anthony 63}\\
		{\large 45008, Los Angeles, Floria, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
