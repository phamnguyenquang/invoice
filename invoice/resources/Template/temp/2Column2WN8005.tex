...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aurora Öberg} \\
		{\large Santiago 2}\\
		{\large 36406, Frankfurt am Main , Hessen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maverick Catherine  Olsson Pte Ltd } \\
		{\large Bryson 16}\\
		{\large 29617, Berlin, Hainan, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
