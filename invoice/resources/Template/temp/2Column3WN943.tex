...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christian Christopher Lindqvist} \\
		{\large Paisley 61}\\
		{\large 96656, New York , Guangdong, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Jane Mohamed Ltd } \\
		{\large Lucy 73}\\
		{\large 61468, Nha Trang, Saarland, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
