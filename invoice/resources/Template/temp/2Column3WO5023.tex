...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kai Louise 	 Sjöberg Pte Ltd} \\
		{\large Brian 69}\\
		{\large 78250, Barcelona, Chiang Mai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Genesis Lindgren } \\
		{\large Benjamin 78}\\
		{\large 44646, Frankfurt am Main , Tuscany, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
