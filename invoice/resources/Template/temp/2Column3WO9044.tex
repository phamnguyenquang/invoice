...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hailey William Wikström Ltd} \\
		{\large Catherine 89}\\
		{\large 89711, Melbourne, Bayern, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emily Jönsson } \\
		{\large Kylie 24}\\
		{\large 40210, Frankfurt am Main , Chiang Mai, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
