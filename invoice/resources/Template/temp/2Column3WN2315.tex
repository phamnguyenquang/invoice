...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Athena Kate 	 Fredriksson} \\
		{\large Jayden 93}\\
		{\large 84173, Berlin, Kentucky, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Grace 	 Holm Pte Ltd } \\
		{\large Gabriel 85}\\
		{\large 95643, Frankfurt am Main , Tuscany, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
