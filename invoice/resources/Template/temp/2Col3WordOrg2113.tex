...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesus Catherine  Arvidsson Pte Ltd} \\
		{\large Hadley 71}\\
		{\large 96995, Milan, Seattles, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kinsley Blomqvist } \\
		{\large Bradley 49}\\
		{\large 44317, Istanbul, Seattles, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
