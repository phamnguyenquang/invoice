...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caleb Louise 	 Lundberg} \\
		{\large Jocelyn 75}\\
		{\large 78691, Nha Trang, Indiana, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tucker Louise 	 Eklund Corp } \\
		{\large Elena 6}\\
		{\large 31719, Budapest, Binh Thuan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
