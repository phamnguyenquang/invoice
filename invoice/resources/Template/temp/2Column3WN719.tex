...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  London Louise 	 Holmberg} \\
		{\large Grace 24}\\
		{\large 16074, Frankfurt am Main , Guangzhou, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maria Ann  Henriksson Ltd } \\
		{\large Edward 18}\\
		{\large 84735, Vienna, Saarland, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
