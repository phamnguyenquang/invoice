...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kinsley Mary 	 Nyström} \\
		{\large Elizabeth 35}\\
		{\large 31821, Vancouver, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooke Mary 	 Gunnarsson Inc } \\
		{\large Jordan 87}\\
		{\large 85856, Lisbon, Texas, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
