...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adriana Victoria Johansson} \\
		{\large Damian 98}\\
		{\large 24972, Istanbul, Hamburg, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriel John Nordström Inc } \\
		{\large Isla 66}\\
		{\large 44239, Last Vegas, Texas, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
