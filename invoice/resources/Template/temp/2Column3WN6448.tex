...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brielle Ann  Sjöberg} \\
		{\large Leilani 55}\\
		{\large 76041, Moscow, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexis Thomas Henriksson Pte Ltd } \\
		{\large Audrey 71}\\
		{\large 14171, Beijing, Guangzhou, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
