...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Miguel May/Mae 	 Pettersson} \\
		{\large Declan 81}\\
		{\large 17464, Singapore, Guangzhou, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bella Robert Jönsson Ltd } \\
		{\large Mia 9}\\
		{\large 49219, Last Vegas, Ang Thong, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
