...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aria Mary 	 Lind Pte Ltd} \\
		{\large Silas 59}\\
		{\large 68091, Frankfurt am Main , Buriam, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large London Magnusson } \\
		{\large Avery 24}\\
		{\large 43495, Frankfurt am Main , California, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
