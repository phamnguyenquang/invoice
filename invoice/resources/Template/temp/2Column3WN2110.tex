...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremiah Catherine  Lindqvist} \\
		{\large Everett 72}\\
		{\large 87034, Istanbul, Bremen, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Serenity Michael Hermansson Corp } \\
		{\large Easton 74}\\
		{\large 19492, Berlin, Bayern, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
