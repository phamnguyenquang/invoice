...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sungkyunkwan University	South} \\
		{\large Henry 98}\\
		{\large 75572, Nha Trang, Amnat Charoen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubrey Svensson } \\
		{\large Abigail 91}\\
		{\large 97768, Frankfurt am Main , Texas, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
