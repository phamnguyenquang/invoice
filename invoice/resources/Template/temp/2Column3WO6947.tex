...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mckenzie James Arvidsson Pte Ltd} \\
		{\large Riley 80}\\
		{\large 18470, Bonn, Kentucky, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Mohamed } \\
		{\large Hunter 57}\\
		{\large 94479, Ho Chi Minh, Floria, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
