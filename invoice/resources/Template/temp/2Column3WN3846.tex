...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Annabelle Grace 	 Fredriksson} \\
		{\large Graham 15}\\
		{\large 34665, Hanoi, Huabei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmett David Fredriksson Pte Ltd } \\
		{\large Arianna 11}\\
		{\large 19414, Beijing, Henan, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
