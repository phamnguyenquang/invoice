...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Annabelle Lundqvist Corp} \\
		{\large Everett 6}\\
		{\large 89790, Frankfurt am Main , Guangzhou, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harmony Lundström } \\
		{\large Stella 74}\\
		{\large 79704, Shanghai, Kentucky, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
