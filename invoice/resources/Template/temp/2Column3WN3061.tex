...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexa Louise 	 Mårtensson} \\
		{\large Richard 87}\\
		{\large 53890, Washington, khanh Hoa, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julia William Hermansson Corp } \\
		{\large Maverick 57}\\
		{\large 50806, Nha Trang, Kentucky, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
