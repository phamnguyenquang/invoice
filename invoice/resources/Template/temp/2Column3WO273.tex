...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Austin Christopher Wallin Inc} \\
		{\large Samuel 81}\\
		{\large 82344, Nha Trang, Amnat Charoen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large London Lundin } \\
		{\large Evelyn 5}\\
		{\large 62173, Last Vegas, khanh Hoa, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
