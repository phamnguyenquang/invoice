...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle Edward Jonsson Pte Ltd} \\
		{\large Ximena 10}\\
		{\large 96536, Frankfurt am Main , Binh Thuan, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julian Blom } \\
		{\large Stephanie 73}\\
		{\large 35503, Shanghai, Ang Thong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
