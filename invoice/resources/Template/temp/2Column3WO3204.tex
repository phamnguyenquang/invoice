...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paisley  Alexander  Lundström Ltd} \\
		{\large Brody 51}\\
		{\large 30882, Chicago, Indiana, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liam Gustafsson } \\
		{\large Maya 11}\\
		{\large 77064, Los Angeles, Chiang Mai, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
