...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aliyah Grace 	 Sandberg} \\
		{\large Adeline 53}\\
		{\large 12314, Stuttgart, Heibei, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubrey Christopher Sandberg Ltd } \\
		{\large Aaron 54}\\
		{\large 69226, SaiGon, Chiang Rai, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
