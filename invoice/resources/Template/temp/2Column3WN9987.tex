...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brian Elizabeth 	 Lund} \\
		{\large Michael 95}\\
		{\large 27847, Beijing, Tuscany, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kayden Mary 	 Lindström Pte Ltd } \\
		{\large Emily 82}\\
		{\large 28667, Frankfurt am Main , Hessen, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
