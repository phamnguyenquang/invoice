...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maverick Grace 	 Gustafsson Inc} \\
		{\large Sarah 84}\\
		{\large 69307, Singapore, khanh Hoa, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Summer Jonsson } \\
		{\large Kinsley 75}\\
		{\large 29087, Frankfurt am Main , Amnat Charoen, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
