...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremiah Peter Hellström} \\
		{\large Caden 69}\\
		{\large 38954, Seoul, Huabei, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexander John Arvidsson Corp } \\
		{\large Kaden 47}\\
		{\large 15101, San Francisco, Amnat Charoen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
