...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  John Månsson} \\
		{\large Harmony 10}\\
		{\large 99106, Shanghai, Hessen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Logan Marie 	 Åkesson Corp } \\
		{\large Hazel 88}\\
		{\large 91143, Frankfurt am Main , Seattles, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
