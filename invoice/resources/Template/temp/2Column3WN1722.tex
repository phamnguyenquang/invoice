...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremiah David Björklund} \\
		{\large Alice 72}\\
		{\large 96229, Rome, Amnat Charoen, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julia Grace 	 Abrahamsson Pte Ltd } \\
		{\large Greyson 56}\\
		{\large 89240, Vienna, California, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
