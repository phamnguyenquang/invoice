...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liliana Mary 	 Ekström} \\
		{\large Lucas 3}\\
		{\large 77149, Taipei, Texas, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Genesis  Alexander  Sandberg Corp } \\
		{\large Madison 75}\\
		{\large 36410, Frankfurt am Main , Chiang Rai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
