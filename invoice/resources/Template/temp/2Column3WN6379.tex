...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Richard Michael Hassan} \\
		{\large Julia 91}\\
		{\large 53167, Dubai, Indiana, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson Louise 	 Holmberg Pte Ltd } \\
		{\large Penelope 58}\\
		{\large 58088, Amsterdam, Chiang Mai, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
