...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kinsley David Magnusson Corp} \\
		{\large Lucas 95}\\
		{\large 22910, Vancouver, Binh Thuan, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Naomi Lindqvist } \\
		{\large Sawyer 49}\\
		{\large 11121, Frankfurt am Main , Tuscany, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
