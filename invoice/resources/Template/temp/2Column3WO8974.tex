...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayce Mary 	 Lindgren Pte Ltd} \\
		{\large Grant 56}\\
		{\large 59896, Lisbon, Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Athena Jonsson } \\
		{\large Cooper 76}\\
		{\large 76114, Frankfurt am Main , Chai Nat, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
