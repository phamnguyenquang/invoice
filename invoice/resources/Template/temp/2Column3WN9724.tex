...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eva Amy  Bergström} \\
		{\large Dominic 73}\\
		{\large 75307, Paris, Hainan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas Catherine  Karlsson Pte Ltd } \\
		{\large Brooklynn 69}\\
		{\large 16936, Singapore, Chiang Rai, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
