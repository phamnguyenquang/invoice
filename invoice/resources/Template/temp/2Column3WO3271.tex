...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rebecca Catherine  Lindqvist Inc} \\
		{\large Hayden 54}\\
		{\large 45137, Last Vegas, Chiang Mai, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Oliver Henriksson } \\
		{\large Nathaniel 94}\\
		{\large 27619, Toronto, Chiang Mai, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
