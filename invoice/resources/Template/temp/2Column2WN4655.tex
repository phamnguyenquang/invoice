...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mia Andreasson} \\
		{\large Hannah 29}\\
		{\large 30322, Bonn, Kentucky, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tyler Thomas Månsson Corp } \\
		{\large Ryan 73}\\
		{\large 63027, Frankfurt am Main , Ang Thong, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
