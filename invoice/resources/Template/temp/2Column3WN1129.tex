...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adeline Victoria Eriksson} \\
		{\large Ava 40}\\
		{\large 64462, London , Kentucky, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maria  Alexander  Wikström Ltd } \\
		{\large Hailey 62}\\
		{\large 15359, Seoul, Indiana, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
