...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jack Edward Bergman} \\
		{\large Alexandra 63}\\
		{\large 23179, Paris, Kentucky, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Silas Christopher Åkesson Pte Ltd } \\
		{\large Ashley 51}\\
		{\large 58934, Sydney, Chiang Mai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
