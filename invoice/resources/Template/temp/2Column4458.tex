...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryleigh Pettersson Inc} \\
		{\large Makenzie 73}\\
		{\large 81500, Frankfurt am Main , Ang Thong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camila Mattsson } \\
		{\large Jocelyn 76}\\
		{\large 94436, Berlin, Amnat Charoen, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
