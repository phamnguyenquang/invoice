...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle Edward Svensson} \\
		{\large Colton 98}\\
		{\large 53046, Ho Chi Minh, Bayern, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sarah  Alexander  Claesson Inc } \\
		{\large Kylie 64}\\
		{\large 99570, Frankfurt am Main , Chai Nat, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
