...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Annabelle Marie 	 Hellström Pte Ltd} \\
		{\large Christopher 38}\\
		{\large 82943, Sydney, Chai Nat, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Peyton Hellström } \\
		{\large Lily 90}\\
		{\large 37225, Los Angeles, Hessen, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
