...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Texas Medical Branch} \\
		{\large Leah 50}\\
		{\large 74472, Frankfurt am Main , California, Indonesia s}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Kayden Martinsson } \\
		{\large Grace 6}\\
		{\large 72197, Boston, Seattles, Cambodia}\\
    \switchcolumn
