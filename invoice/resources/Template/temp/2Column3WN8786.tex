...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaliyah Ann  Bergqvist} \\
		{\large Julianna 39}\\
		{\large 73010, Osaka, Seattles, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sarah Christopher Samuelsson Ltd } \\
		{\large Lyla 24}\\
		{\large 55111, Shanghai, khanh Hoa, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
