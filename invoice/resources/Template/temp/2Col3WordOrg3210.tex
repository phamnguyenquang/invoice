...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro Mary 	 Claesson Inc} \\
		{\large Khloe 96}\\
		{\large 67449, Paris, khanh Hoa, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abel Lundin } \\
		{\large Grayson 48}\\
		{\large 82952, Frankfurt am Main , Tuscany, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
