...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryder Louise 	 Hermansson Inc} \\
		{\large Timothy 47}\\
		{\large 25067, Frankfurt am Main , Saarland, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camden Åberg } \\
		{\large Kennedy 69}\\
		{\large 62318, Vancouver, Kentucky, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
