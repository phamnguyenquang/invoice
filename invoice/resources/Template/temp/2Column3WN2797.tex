...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayla John Gustafsson} \\
		{\large Luna 60}\\
		{\large 62547, Frankfurt am Main , Texas, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elias Kate 	 Hedlund Corp } \\
		{\large Nolan 93}\\
		{\large 99165, Washington, khanh Hoa, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
