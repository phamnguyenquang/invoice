...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Austin Peter Nordström} \\
		{\large Eleanor 60}\\
		{\large 68706, Frankfurt am Main , Indiana, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Willow Catherine  Hedlund Ltd } \\
		{\large Rachel 53}\\
		{\large 37305, Boston, Hessen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
