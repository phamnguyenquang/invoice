...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gael Victoria Mohamed} \\
		{\large Landon 13}\\
		{\large 18601, Chicago, Chiang Mai, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mckenzie Michael Andersson Pte Ltd } \\
		{\large Miguel 92}\\
		{\large 87367, Boston, Amnat Charoen, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
