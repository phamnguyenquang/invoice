...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Chase Rose 	 Lundström Inc} \\
		{\large Eliza 33}\\
		{\large 72458, Frankfurt am Main , Amnat Charoen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Henry Ekström } \\
		{\large Carlos 87}\\
		{\large 67644, Lisbon, California, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
