...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Malachi Edward Lundin} \\
		{\large Lydia 69}\\
		{\large 20175, Amsterdam, Binh Thuan, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ezra Rose 	 Björklund Corp } \\
		{\large Jack 35}\\
		{\large 67273, Istanbul, Amnat Charoen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
