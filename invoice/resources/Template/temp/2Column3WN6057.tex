...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harrison Rose 	 Lundberg} \\
		{\large Quinn 28}\\
		{\large 90762, Rome, Chiang Rai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vanessa Marie 	 Lindqvist Inc } \\
		{\large Cora 17}\\
		{\large 24901, Washington, California, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
