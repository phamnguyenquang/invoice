...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rylee Robert Lind} \\
		{\large Stephanie 81}\\
		{\large 32565, Boston, Ang Thong, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayden Elizabeth 	 Mattsson Pte Ltd } \\
		{\large Alice 60}\\
		{\large 74445, Boston, Phu Yen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
