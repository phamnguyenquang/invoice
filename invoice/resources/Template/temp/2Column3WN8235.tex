...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezra Amy  Lundberg} \\
		{\large Brielle 64}\\
		{\large 11783, Shanghai, Hessen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bentley Elizabeth 	 Isaksson Pte Ltd } \\
		{\large Paisley 87}\\
		{\large 22611, Melbourne, Indiana, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
