...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  William Thomas Larsson Pte Ltd} \\
		{\large Adalyn 65}\\
		{\large 99935, Frankfurt am Main , Guangzhou, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michelle Sandström } \\
		{\large Emilia 65}\\
		{\large 49139, Berlin, Seattles, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
