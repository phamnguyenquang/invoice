...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria Amy  Eriksson} \\
		{\large Malachi 96}\\
		{\large 97789, Nha Trang, Binh Thuan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremiah Catherine  Wallin Inc } \\
		{\large Alan 31}\\
		{\large 96274, Frankfurt am Main , Hamburg, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
