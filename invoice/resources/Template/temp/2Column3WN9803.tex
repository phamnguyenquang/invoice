...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Blake Lee  Olsson} \\
		{\large Edward 26}\\
		{\large 40031, Istanbul, Chai Nat, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Claire Christopher Holmgren Pte Ltd } \\
		{\large Jayden 60}\\
		{\large 97280, Frankfurt am Main , Huabei, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
