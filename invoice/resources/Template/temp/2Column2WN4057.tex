...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nora Hermansson} \\
		{\large Valerie 25}\\
		{\large 57316, Singapore, Guangzhou, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josephine Christopher Pettersson Ltd } \\
		{\large Valeria 48}\\
		{\large 91030, Washington, Bayern, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
