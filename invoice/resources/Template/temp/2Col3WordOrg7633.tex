...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aliyah Mary 	 Björklund Corp} \\
		{\large Lydia 91}\\
		{\large 32798, Milan, Buriam, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reagan Mårtensson } \\
		{\large Catherine 65}\\
		{\large 60952, Melbourne, Binh Thuan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
