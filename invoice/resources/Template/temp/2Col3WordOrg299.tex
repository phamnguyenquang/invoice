...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Edward Samuelsson Corp} \\
		{\large Sara 82}\\
		{\large 52191, Frankfurt am Main , Chai Nat, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reagan Söderberg } \\
		{\large Sean 8}\\
		{\large 58360, Dubai, Chai Nat, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
