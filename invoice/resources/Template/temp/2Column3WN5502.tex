...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kinsley Grace 	 Lundberg} \\
		{\large Aaliyah 92}\\
		{\large 74307, Washington, Bremen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Antonio Robert Eklund Ltd } \\
		{\large Victoria 17}\\
		{\large 73122, Frankfurt am Main , Heibei, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
