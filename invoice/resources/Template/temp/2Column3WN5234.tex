...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hannah Anne Holmgren} \\
		{\large Harper 88}\\
		{\large 29682, Denver, Ang Thong, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Justin  Alexander  Andersson Inc } \\
		{\large Sofia 77}\\
		{\large 39398, Frankfurt am Main , Seattles, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
