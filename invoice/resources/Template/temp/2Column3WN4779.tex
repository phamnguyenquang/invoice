...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Easton Louise 	 Lundin} \\
		{\large Ruby 79}\\
		{\large 84227, Stuttgart, Buriam, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Santiago Edward Arvidsson Pte Ltd } \\
		{\large Kayden 51}\\
		{\large 44086, Last Vegas, khanh Hoa, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
