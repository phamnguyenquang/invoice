...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla William Abrahamsson Pte Ltd} \\
		{\large Abel 54}\\
		{\large 95882, Frankfurt am Main , Tuscany, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caden Pettersson } \\
		{\large Ariana 62}\\
		{\large 85387, Amsterdam, Guangdong, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
