...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nevaeh May/Mae 	 Strömberg} \\
		{\large Michael 15}\\
		{\large 86487, Washington, Saarland, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reagan Elizabeth 	 Olofsson Pte Ltd } \\
		{\large Destiny 42}\\
		{\large 90371, Toronto, Binh Thuan, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
