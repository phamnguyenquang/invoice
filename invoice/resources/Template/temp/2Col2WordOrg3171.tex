...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Piper Martinsson Inc} \\
		{\large Alexis 45}\\
		{\large 27417, Munich, Guangzhou, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leah Henriksson } \\
		{\large Liam 87}\\
		{\large 13417, Frankfurt am Main , Bangkok, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
