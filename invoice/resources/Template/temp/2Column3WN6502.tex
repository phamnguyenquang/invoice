...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Xavier Robert Ahmed} \\
		{\large Aiden 82}\\
		{\large 45912, Frankfurt am Main , Tuscany, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camila Thomas Nordin Inc } \\
		{\large Charles 28}\\
		{\large 75733, Madrid, Guangdong, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
