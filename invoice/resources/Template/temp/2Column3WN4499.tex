...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ayden Victoria Holmberg} \\
		{\large Kaleb 46}\\
		{\large 80982, Paris, Kentucky, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ethan May/Mae 	 Bergqvist Pte Ltd } \\
		{\large Serenity 15}\\
		{\large 10673, Budapest, Tuscany, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
