...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maria Amy  Pettersson} \\
		{\large Michael 81}\\
		{\large 13998, Berlin, Binh Thuan, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriel Robert Andersson Inc } \\
		{\large Sarah 78}\\
		{\large 95139, Frankfurt am Main , Hessen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
