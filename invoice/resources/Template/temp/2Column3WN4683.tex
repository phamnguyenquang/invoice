...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Chloe Elizabeth 	 Olofsson} \\
		{\large Brooklynn 93}\\
		{\large 15991, Chicago, Chiang Rai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everett Peter Löfgren Inc } \\
		{\large Kaylee 19}\\
		{\large 17043, Montreal, Chiang Mai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
