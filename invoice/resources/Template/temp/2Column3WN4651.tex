...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte Victoria Hedlund} \\
		{\large Hannah 19}\\
		{\large 84283, Lisbon, Hessen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonah Victoria Eliasson Pte Ltd } \\
		{\large Layla 10}\\
		{\large 20296, Hanoi, Bangkok, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
