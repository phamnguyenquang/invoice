...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jasmine Peter Danielsson Pte Ltd} \\
		{\large Carson 31}\\
		{\large 60623, Last Vegas, Binh Thuan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michelle Nyberg } \\
		{\large Trinity 60}\\
		{\large 59917, Berlin, Amnat Charoen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
