...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniela Robert Söderberg} \\
		{\large Savannah 87}\\
		{\large 73050, New York , Bremen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michael Thomas Bergström Pte Ltd } \\
		{\large Emery 53}\\
		{\large 83964, Dublin, khanh Hoa, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
