...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Axel  Alexander  Lundberg} \\
		{\large Annabelle 45}\\
		{\large 88669, Munich, Floria, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Autumn Edward Viklund Corp } \\
		{\large Kinsley 24}\\
		{\large 50775, Nha Trang, Seattles, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
