...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Versailles Saint-Quentin-en-Yvelines University} \\
		{\large Destiny 79}\\
		{\large 20486, Vancouver, Ang Thong, Denmark}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Noah Samuelsson } \\
		{\large Melody 82}\\
		{\large 87677, Abu Dhabi, Tuscany, Indonesia s}\\
    \switchcolumn
