...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Camden Mary 	 Bergman Corp} \\
		{\large Liliana 10}\\
		{\large 66504, Frankfurt am Main , Hainan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lauren Falk } \\
		{\large Alexandra 72}\\
		{\large 45268, Venice, Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
