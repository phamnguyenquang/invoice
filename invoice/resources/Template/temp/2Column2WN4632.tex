...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caden Axelsson} \\
		{\large Mark 95}\\
		{\large 35969, Hong Kong, Hainan, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Victoria  Alexander  Martinsson Pte Ltd } \\
		{\large Eli 12}\\
		{\large 94625, Barcelona, Heibei, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
