...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brayden David Arvidsson} \\
		{\large Elizabeth 63}\\
		{\large 78287, Stuttgart, Indiana, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eliza Christopher Blomqvist Inc } \\
		{\large Lillian 13}\\
		{\large 90047, Last Vegas, Guangdong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
