...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bennett Sjöberg} \\
		{\large Dylan 97}\\
		{\large 31616, Berlin, Kentucky, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrea Ann  Andreasson Pte Ltd } \\
		{\large Madelyn 23}\\
		{\large 16403, Last Vegas, Indiana, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
