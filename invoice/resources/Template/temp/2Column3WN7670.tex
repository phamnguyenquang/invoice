...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline Catherine  Lundberg} \\
		{\large Brody 15}\\
		{\large 15300, Nha Trang, Heibei, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evelyn Peter Norberg Corp } \\
		{\large Eliza 3}\\
		{\large 93700, Hong Kong, khanh Hoa, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
