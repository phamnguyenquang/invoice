...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elise Elizabeth 	 Johansson Ltd} \\
		{\large Wyatt 37}\\
		{\large 76724, Barcelona, Ang Thong, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Logan Lundberg } \\
		{\large Eric 46}\\
		{\large 96250, Moscow, California, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
