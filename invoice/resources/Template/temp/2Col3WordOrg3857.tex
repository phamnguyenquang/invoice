...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tucker Louise 	 Andreasson Corp} \\
		{\large Angel 28}\\
		{\large 90815, Shanghai, Floria, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Austin Norberg } \\
		{\large Everett 73}\\
		{\large 88077, Los Angeles, Chai Nat, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
