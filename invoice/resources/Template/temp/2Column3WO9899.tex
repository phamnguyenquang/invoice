...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriella Louise 	 Lundgren Corp} \\
		{\large Gianna 42}\\
		{\large 54033, Hong Kong, Hessen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everly Samuelsson } \\
		{\large Zoe 15}\\
		{\large 94530, San Francisco, Bangkok, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
