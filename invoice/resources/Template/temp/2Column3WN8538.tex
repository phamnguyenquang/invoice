...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aria James Sundberg} \\
		{\large Mia 62}\\
		{\large 87314, Munich, Bremen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ella  Alexander  Hermansson Pte Ltd } \\
		{\large Jesus 8}\\
		{\large 12967, Los Angeles, Hawaii, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
