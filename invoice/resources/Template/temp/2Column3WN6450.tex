...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle Christopher Hansson} \\
		{\large Maxwell 77}\\
		{\large 39065, Los Angeles, Binh Thuan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Thomas Lindström Pte Ltd } \\
		{\large Samuel 24}\\
		{\large 21999, New York , Guangdong, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
