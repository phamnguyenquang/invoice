...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Annabelle Catherine  Danielsson} \\
		{\large Benjamin 51}\\
		{\large 54647, Last Vegas, Saarland, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Olivia David Andersson Inc } \\
		{\large Isabella 62}\\
		{\large 11745, Nha Trang, Guangdong, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
