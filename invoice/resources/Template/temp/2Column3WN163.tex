...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Norah William Sandberg} \\
		{\large Sebastian 56}\\
		{\large 93899, Last Vegas, Ang Thong, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalie Peter Martinsson Pte Ltd } \\
		{\large Annabelle 47}\\
		{\large 50361, New York , Bremen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
