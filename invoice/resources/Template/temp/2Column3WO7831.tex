...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Santiago Catherine  Karlsson Ltd} \\
		{\large Asher 45}\\
		{\large 85784, Nha Trang, Buriam, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large James Sandström } \\
		{\large Gabrielle 35}\\
		{\large 20176, Frankfurt am Main , Kentucky, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
