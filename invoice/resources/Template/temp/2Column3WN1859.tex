...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Riley Grace 	 Jönsson} \\
		{\large Aidan 79}\\
		{\large 11517, Hong Kong, Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie Grace 	 Mårtensson Pte Ltd } \\
		{\large Jayden 49}\\
		{\large 23224, Los Angeles, Indiana, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
