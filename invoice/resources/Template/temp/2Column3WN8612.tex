...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valentina Amy  Månsson} \\
		{\large Camila 58}\\
		{\large 74072, Last Vegas, Hamburg, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large George Kate 	 Lindholm Inc } \\
		{\large Aubree 67}\\
		{\large 59106, Frankfurt am Main , Floria, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
