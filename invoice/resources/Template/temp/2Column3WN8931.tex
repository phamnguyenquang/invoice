...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bentley Victoria Samuelsson} \\
		{\large Elena 37}\\
		{\large 32859, Florence, Guangdong, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wesley May/Mae 	 Mohamed Ltd } \\
		{\large Bailey 98}\\
		{\large 13169, Tokyo, Chai Nat, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
