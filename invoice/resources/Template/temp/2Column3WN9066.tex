...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria Louise 	 Magnusson} \\
		{\large Evan 83}\\
		{\large 15965, Frankfurt am Main , Henan, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jude Robert Lindgren Pte Ltd } \\
		{\large Jaxon 66}\\
		{\large 10420, Munich, Texas, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
