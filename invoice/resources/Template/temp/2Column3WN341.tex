...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Willow Amy  Holmberg} \\
		{\large Alex 91}\\
		{\large 95348, Madrid, Hainan, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Destiny Thomas Andersson Pte Ltd } \\
		{\large Hailey 63}\\
		{\large 96486, Melbourne, Chai Nat, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
