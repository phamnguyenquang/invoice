...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bailey Louise 	 Andersson} \\
		{\large Ivan 62}\\
		{\large 76713, Florence, Saarland, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Owen Rose 	 Viklund Corp } \\
		{\large Jonathan 23}\\
		{\large 38732, San Francisco, Tuscany, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
