...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eli Amy  Pettersson} \\
		{\large Sofia 10}\\
		{\large 63008, Milan, Floria, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubrey May/Mae 	 Strömberg Corp } \\
		{\large Caleb 29}\\
		{\large 35061, Singapore, Amnat Charoen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
