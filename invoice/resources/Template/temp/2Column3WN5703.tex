...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dylan Robert Henriksson} \\
		{\large Michelle 11}\\
		{\large 17767, Singapore, Hessen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesse Marie 	 Magnusson Ltd } \\
		{\large Roman 10}\\
		{\large 96260, SaiGon, Hamburg, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
