...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Axel David Eliasson Corp} \\
		{\large Axel 7}\\
		{\large 34053, Abu Dhabi, California, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Faith Lindqvist } \\
		{\large Angelina 59}\\
		{\large 97160, Frankfurt am Main , Bremen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
