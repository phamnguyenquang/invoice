...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alyssa Robert Gunnarsson} \\
		{\large Luke 39}\\
		{\large 64895, Minsk, Kentucky, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Declan Thomas Björklund Pte Ltd } \\
		{\large Giovanni 83}\\
		{\large 20689, Amsterdam, khanh Hoa, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
