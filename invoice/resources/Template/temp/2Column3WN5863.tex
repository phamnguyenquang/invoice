...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Steven Louise 	 Lundström} \\
		{\large Silas 20}\\
		{\large 93363, New York , Ang Thong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Chase Ann  Eliasson Inc } \\
		{\large Isla 59}\\
		{\large 21221, Hong Kong, Seattles, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
