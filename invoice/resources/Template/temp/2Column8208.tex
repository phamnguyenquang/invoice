...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victoria Abrahamsson Corp} \\
		{\large Harmony 32}\\
		{\large 33896, Nha Trang, Texas, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Serenity Pettersson } \\
		{\large Andrew 75}\\
		{\large 86201, Frankfurt am Main , California, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
