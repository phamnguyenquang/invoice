...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emma Andersson Pte Ltd} \\
		{\large Marcus 26}\\
		{\large 20583, Frankfurt am Main , khanh Hoa, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rylee Björk } \\
		{\large Jack 20}\\
		{\large 40479, Frankfurt am Main , Seattles, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
