...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Miguel Jönsson} \\
		{\large Josiah 36}\\
		{\large 77417, Frankfurt am Main , Chiang Rai, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julian William Jansson Pte Ltd } \\
		{\large Rylee 88}\\
		{\large 87707, Last Vegas, Chiang Rai, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
