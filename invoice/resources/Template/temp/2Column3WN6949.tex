...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezekiel Catherine  Berggren} \\
		{\large Jordyn 81}\\
		{\large 68881, Nha Trang, Hainan, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Elizabeth 	 Sandström Corp } \\
		{\large Trinity 62}\\
		{\large 45246, Hanoi, Bayern, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
