...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ashton  Alexander  Lindström} \\
		{\large Victor 40}\\
		{\large 80138, Venice, Ang Thong, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juliana Rose 	 Andersson Pte Ltd } \\
		{\large Melanie 91}\\
		{\large 69808, Last Vegas, Seattles, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
