...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rose  Alexander  Andreasson} \\
		{\large Penelope 90}\\
		{\large 51442, Tokyo, Hamburg, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Greyson Catherine  Nyström Corp } \\
		{\large Evelyn 44}\\
		{\large 17926, Amsterdam, Guangzhou, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
