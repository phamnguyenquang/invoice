...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jade Amy  Engström} \\
		{\large Ashton 72}\\
		{\large 26815, Stuttgart, Seattles, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amir Elizabeth 	 Holmgren Pte Ltd } \\
		{\large Rylee 58}\\
		{\large 11962, Minsk, Amnat Charoen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
