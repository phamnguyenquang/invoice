...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline Louise 	 Lindström Ltd} \\
		{\large Angel 38}\\
		{\large 54595, Los Angeles, Amnat Charoen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angelina Fransson } \\
		{\large Elizabeth 88}\\
		{\large 81213, Dublin, Saarland, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
