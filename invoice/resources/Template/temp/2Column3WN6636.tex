...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mary Rose 	 Nilsson} \\
		{\large Catherine 77}\\
		{\large 57679, Melbourne, Guangdong, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison Michael Andreasson Ltd } \\
		{\large Eleanor 39}\\
		{\large 61912, London , Amnat Charoen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
