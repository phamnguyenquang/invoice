...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Autumn John Holmgren} \\
		{\large Isabel 36}\\
		{\large 63420, Sydney, Kentucky, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isaiah Kate 	 Magnusson Ltd } \\
		{\large Jesus 94}\\
		{\large 53812, Frankfurt am Main , khanh Hoa, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
