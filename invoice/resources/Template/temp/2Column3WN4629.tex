...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nora Kate 	 Sjögren} \\
		{\large Stephanie 56}\\
		{\large 47545, Frankfurt am Main , Guangdong, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alana Michael Forsberg Inc } \\
		{\large Joseph 15}\\
		{\large 28266, Frankfurt am Main , Buriam, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
