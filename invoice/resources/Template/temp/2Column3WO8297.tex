...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hudson Edward Mohamed Pte Ltd} \\
		{\large Ivan 79}\\
		{\large 72898, Los Angeles, Huabei, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Steven Nyström } \\
		{\large Liam 63}\\
		{\large 77749, San Francisco, Amnat Charoen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
