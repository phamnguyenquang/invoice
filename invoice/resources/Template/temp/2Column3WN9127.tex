...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Reese John Bergqvist} \\
		{\large Avery 40}\\
		{\large 99939, San Francisco, Seattles, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryan David Hedlund Inc } \\
		{\large Asher 52}\\
		{\large 20521, Frankfurt am Main , Bangkok, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
