...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexander Rose 	 Larsson Ltd} \\
		{\large Bryce 32}\\
		{\large 48218, Montreal, Ang Thong, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mila Bengtsson } \\
		{\large Calvin 86}\\
		{\large 52727, Frankfurt am Main , Guangdong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
