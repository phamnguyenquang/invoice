...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hudson Marie 	 Larsson} \\
		{\large Valerie 6}\\
		{\large 24218, Chicago, Chiang Rai, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalie Grace 	 Andersson Inc } \\
		{\large Kevin 55}\\
		{\large 30701, Frankfurt am Main , Seattles, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
