...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bradley Amy  Sandberg} \\
		{\large Lily 29}\\
		{\large 41246, Frankfurt am Main , Hessen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Chase James Blom Pte Ltd } \\
		{\large Greyson 85}\\
		{\large 94918, Dublin, Buriam, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
