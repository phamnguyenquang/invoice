...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elizabeth Elizabeth 	 Falk} \\
		{\large Jose 68}\\
		{\large 90140, Chicago, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lilly Ann  Martinsson Inc } \\
		{\large Anthony 97}\\
		{\large 64354, Vancouver, khanh Hoa, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
