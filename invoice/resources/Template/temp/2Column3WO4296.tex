...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles Catherine  Nilsson Pte Ltd} \\
		{\large Elise 52}\\
		{\large 30186, Lisbon, Hawaii, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexandra Johansson } \\
		{\large Isabelle 60}\\
		{\large 19003, San Francisco, Hessen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
