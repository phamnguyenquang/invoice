...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aubrey Christopher Hansen Corp} \\
		{\large Liam 61}\\
		{\large 99419, Ho Chi Minh, Tuscany, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harper Gustafsson } \\
		{\large Brooklyn 32}\\
		{\large 86766, Vienna, Ang Thong, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
