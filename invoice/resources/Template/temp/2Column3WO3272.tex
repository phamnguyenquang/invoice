...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Catherine Peter Fredriksson Pte Ltd} \\
		{\large Serenity 8}\\
		{\large 15598, Sydney, Bangkok, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexandra Gunnarsson } \\
		{\large Tyler 67}\\
		{\large 65080, Chicago, California, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
