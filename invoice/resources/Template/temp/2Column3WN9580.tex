...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Thomas Lindqvist} \\
		{\large Silas 16}\\
		{\large 70368, Shanghai, Saarland, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Landon William Johansson Ltd } \\
		{\large Leonardo 91}\\
		{\large 25604, Last Vegas, Chiang Rai, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
