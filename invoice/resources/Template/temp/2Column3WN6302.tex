...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall Anne Isaksson} \\
		{\large Aurora 15}\\
		{\large 47618, Frankfurt am Main , Floria, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Benjamin Victoria Sundberg Pte Ltd } \\
		{\large Kenneth 50}\\
		{\large 88093, Ho Chi Minh, Seattles, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
