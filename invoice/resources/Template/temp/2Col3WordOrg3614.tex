...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  William Mary 	 Sjögren Pte Ltd} \\
		{\large Reagan 46}\\
		{\large 50540, Madrid, Saarland, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julia Hassan } \\
		{\large Piper 64}\\
		{\large 17315, Frankfurt am Main , Heibei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
