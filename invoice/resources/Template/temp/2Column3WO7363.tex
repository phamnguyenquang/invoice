...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Timothy Victoria Söderberg Pte Ltd} \\
		{\large Kayden 30}\\
		{\large 33883, Frankfurt am Main , khanh Hoa, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large James Öberg } \\
		{\large Eli 61}\\
		{\large 12291, Dublin, Amnat Charoen, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
