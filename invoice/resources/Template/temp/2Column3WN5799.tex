...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michelle Marie 	 Eklund} \\
		{\large Isaiah 43}\\
		{\large 27540, Boston, Phu Yen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leilani Christopher Persson Pte Ltd } \\
		{\large Aiden 46}\\
		{\large 82130, Dubai, Bayern, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
