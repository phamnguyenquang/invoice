...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Santiago  Alexander  Åkesson} \\
		{\large Ava 58}\\
		{\large 92447, Vienna, Chiang Rai, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jace Grace 	 Arvidsson Pte Ltd } \\
		{\large Sarah 33}\\
		{\large 79613, Nha Trang, Kentucky, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
