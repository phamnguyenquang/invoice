...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melody Amy  Forsberg} \\
		{\large Angel 17}\\
		{\large 42024, Seoul, Amnat Charoen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaitlyn Thomas Fredriksson Pte Ltd } \\
		{\large Paige 27}\\
		{\large 93469, Taipei, Guangzhou, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
