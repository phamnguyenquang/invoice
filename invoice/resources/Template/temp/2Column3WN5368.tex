...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lincoln David Samuelsson} \\
		{\large Joseph 47}\\
		{\large 82346, Chicago, Bremen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Calvin Louise 	 Bergström Inc } \\
		{\large Ava 45}\\
		{\large 88200, Frankfurt am Main , Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
