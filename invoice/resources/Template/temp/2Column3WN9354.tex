...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ethan Christopher Forsberg} \\
		{\large Charles 44}\\
		{\large 52797, Sydney, Hainan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nolan Mary 	 Lindberg Ltd } \\
		{\large Paige 78}\\
		{\large 50511, Last Vegas, Texas, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
