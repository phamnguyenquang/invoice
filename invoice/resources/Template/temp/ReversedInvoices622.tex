...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Indian Institute of Technology Kanpur} \\
		{\large Bryan 50}\\
		{\large 41661, Osaka, Chiang Rai, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amir Holmgren } \\
		{\large Allison 58}\\
		{\large 22673, San Francisco, Bremen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
