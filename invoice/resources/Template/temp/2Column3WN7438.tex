...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lydia Christopher Söderberg} \\
		{\large Cameron 71}\\
		{\large 19990, Berlin, Henan, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large William Louise 	 Pettersson Inc } \\
		{\large Andrea 48}\\
		{\large 89607, Los Angeles, Ang Thong, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
