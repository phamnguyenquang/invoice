...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ethan Rose 	 Pettersson} \\
		{\large Alexa 38}\\
		{\large 72976, Istanbul, Chiang Mai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abigail Catherine  Berglund Corp } \\
		{\large Evan 83}\\
		{\large 80324, Ho Chi Minh, Hawaii, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
