...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julia  Alexander  Strömberg} \\
		{\large Kenneth 90}\\
		{\large 70071, Dublin, Tuscany, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Colton  Alexander  Gunnarsson Pte Ltd } \\
		{\large Aidan 84}\\
		{\large 92606, Nha Trang, Henan, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
