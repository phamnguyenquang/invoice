...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leonardo Victoria Sandberg Pte Ltd} \\
		{\large Angel 15}\\
		{\large 65025, Washington, Binh Thuan, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Xavier Andersson } \\
		{\large Brayden 68}\\
		{\large 35464, Frankfurt am Main , Chiang Rai, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
