...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Santiago Christopher Wikström Inc} \\
		{\large Colin 53}\\
		{\large 40455, Vancouver, Ang Thong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmanuel Henriksson } \\
		{\large Roman 8}\\
		{\large 62057, Frankfurt am Main , Hamburg, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
