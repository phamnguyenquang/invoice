...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Landon  Alexander  Dahl} \\
		{\large Everly 3}\\
		{\large 90253, Washington, Guangzhou, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aliyah Robert Blomqvist Pte Ltd } \\
		{\large Aria 47}\\
		{\large 75344, Nha Trang, Heibei, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
