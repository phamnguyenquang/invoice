...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tucker May/Mae 	 Eklund Corp} \\
		{\large Clara 83}\\
		{\large 48921, Abu Dhabi, Buriam, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Nordström } \\
		{\large Adrian 98}\\
		{\large 34093, Los Angeles, Chiang Mai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
