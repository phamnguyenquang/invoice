...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eliana Louise 	 Hassan} \\
		{\large Kevin 6}\\
		{\large 71756, Ho Chi Minh, Chiang Mai, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kingston May/Mae 	 Danielsson Ltd } \\
		{\large Diego 50}\\
		{\large 28174, SaiGon, Hessen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
