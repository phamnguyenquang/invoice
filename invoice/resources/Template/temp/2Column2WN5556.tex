...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Delilah Larsson} \\
		{\large Kayla 59}\\
		{\large 59693, Abu Dhabi, Hainan, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabrielle Robert Andreasson Inc } \\
		{\large Ashton 16}\\
		{\large 28196, Ho Chi Minh, Saarland, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
