...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alan Catherine  Lundström} \\
		{\large Ella 98}\\
		{\large 20871, Ho Chi Minh, Hainan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Victor Peter Lindström Inc } \\
		{\large Kayla 32}\\
		{\large 15504, Seoul, Ang Thong, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
