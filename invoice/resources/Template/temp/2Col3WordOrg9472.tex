...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryker Edward Henriksson Inc} \\
		{\large Kayla 75}\\
		{\large 59107, Istanbul, Kentucky, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Thomas Samuelsson } \\
		{\large Elias 78}\\
		{\large 28574, San Francisco, California, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
