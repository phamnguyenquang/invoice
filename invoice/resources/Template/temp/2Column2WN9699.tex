...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklyn Samuelsson} \\
		{\large Abel 46}\\
		{\large 33342, Ho Chi Minh, Bangkok, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte May/Mae 	 Nyström Inc } \\
		{\large Savannah 43}\\
		{\large 54521, Los Angeles, Bayern, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
