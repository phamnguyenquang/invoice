...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel Edward Söderberg} \\
		{\large Jayden 8}\\
		{\large 25402, Hanoi, Huabei, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesus  Alexander  Mårtensson Corp } \\
		{\large Norah 76}\\
		{\large 87203, Ho Chi Minh, Phu Yen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
