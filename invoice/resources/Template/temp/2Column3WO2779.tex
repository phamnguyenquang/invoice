...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicholas Robert Dahlberg Ltd} \\
		{\large Kevin 54}\\
		{\large 19700, Montreal, Hamburg, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryleigh Ström } \\
		{\large Ruby 61}\\
		{\large 55469, San Francisco, khanh Hoa, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
