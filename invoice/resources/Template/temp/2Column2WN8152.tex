...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brody Martinsson} \\
		{\large Peyton 25}\\
		{\large 53124, Washington, Amnat Charoen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Chase James Ek Pte Ltd } \\
		{\large Lydia 9}\\
		{\large 99533, Frankfurt am Main , Hessen, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
