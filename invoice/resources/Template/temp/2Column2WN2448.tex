...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Margaret Mohamed} \\
		{\large Greyson 84}\\
		{\large 79301, Tokyo, Amnat Charoen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubrey Victoria Dahlberg Pte Ltd } \\
		{\large Harrison 30}\\
		{\large 32709, Milan, Hainan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
