...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicolas Karlsson Pte Ltd} \\
		{\large Sophie 38}\\
		{\large 91823, Frankfurt am Main , California, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Graham Andersson } \\
		{\large Aubrey 45}\\
		{\large 59368, Melbourne, Saarland, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
