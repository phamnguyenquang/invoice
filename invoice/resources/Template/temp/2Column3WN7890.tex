...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Noah Louise 	 Sandström} \\
		{\large Brooklynn 10}\\
		{\large 31446, Barcelona, Phu Yen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaitlyn Robert Olsson Corp } \\
		{\large Hannah 80}\\
		{\large 18755, Washington, Hamburg, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
