...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Micah Sandström} \\
		{\large Stella 3}\\
		{\large 10191, San Francisco, Chiang Rai, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon Catherine  Jonsson Pte Ltd } \\
		{\large Lila 83}\\
		{\large 75741, Vancouver, Floria, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
