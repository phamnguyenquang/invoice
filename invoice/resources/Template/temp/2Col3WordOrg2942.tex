...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Savannah Marie 	 Hedlund Ltd} \\
		{\large Mary 57}\\
		{\large 91167, Ho Chi Minh, Guangdong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Destiny Andreasson } \\
		{\large Kaitlyn 61}\\
		{\large 44378, New York , Guangdong, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
