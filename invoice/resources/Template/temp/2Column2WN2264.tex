...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline Danielsson} \\
		{\large Richard 67}\\
		{\large 45624, Los Angeles, Bangkok, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Victor Edward Nyström Pte Ltd } \\
		{\large Jude 33}\\
		{\large 46266, Beijing, Binh Thuan, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
