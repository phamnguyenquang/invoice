...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stella Thomas Strömberg} \\
		{\large Andrea 30}\\
		{\large 11299, Barcelona, Guangzhou, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooke Marie 	 Åkesson Ltd } \\
		{\large Malachi 85}\\
		{\large 65928, Dubai, Kentucky, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
