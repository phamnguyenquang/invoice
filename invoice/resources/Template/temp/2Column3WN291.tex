...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everly Jane Isaksson} \\
		{\large William 92}\\
		{\large 75232, Frankfurt am Main , Bangkok, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kylie Robert Lundberg Inc } \\
		{\large Scarlett 91}\\
		{\large 14833, Frankfurt am Main , khanh Hoa, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
