...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jade May/Mae 	 Blomqvist} \\
		{\large Kennedy 41}\\
		{\large 24138, San Francisco, Heibei, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Olivia  Alexander  Mattsson Corp } \\
		{\large Vincent 82}\\
		{\large 63618, Rome, Hessen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
