...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Benjamin  Alexander  Håkansson Corp} \\
		{\large Abigail 17}\\
		{\large 36228, London , Chiang Rai, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sean Andreasson } \\
		{\large Carter 25}\\
		{\large 27847, Singapore, Amnat Charoen, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
