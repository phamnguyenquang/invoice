...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leonardo David Lindgren} \\
		{\large Aria 12}\\
		{\large 81353, Ho Chi Minh, Seattles, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Edward Christopher Fransson Corp } \\
		{\large Michelle 15}\\
		{\large 23906, Milan, Hamburg, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
