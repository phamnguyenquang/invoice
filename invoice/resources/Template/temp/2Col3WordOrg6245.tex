...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alan Marie 	 Berg Pte Ltd} \\
		{\large Ethan 92}\\
		{\large 28106, Frankfurt am Main , Amnat Charoen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Audrey Lundberg } \\
		{\large Adalyn 4}\\
		{\large 58180, Dubai, Binh Thuan, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
