...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline Peter Martinsson Pte Ltd} \\
		{\large Angel 98}\\
		{\large 97642, Frankfurt am Main , Amnat Charoen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniela Nordin } \\
		{\large Allison 61}\\
		{\large 56939, Dublin, Indiana, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
