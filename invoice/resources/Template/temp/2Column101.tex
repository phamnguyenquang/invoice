...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Londyn Ekström Pte Ltd} \\
		{\large Christopher 97}\\
		{\large 55126, Frankfurt am Main , Heibei, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucas Nordin } \\
		{\large Maddox 36}\\
		{\large 55553, Last Vegas, Chiang Mai, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
