...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Londyn Andersson} \\
		{\large Justin 34}\\
		{\large 49418, Vienna, Seattles, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jordyn May/Mae 	 Nilsson Pte Ltd } \\
		{\large Carson 66}\\
		{\large 46327, Frankfurt am Main , Chiang Mai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
