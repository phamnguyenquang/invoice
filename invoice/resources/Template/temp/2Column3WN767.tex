...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Noah Elizabeth 	 Gunnarsson} \\
		{\large Tucker 15}\\
		{\large 15326, Denver, Hessen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Preston Edward Holmberg Pte Ltd } \\
		{\large Addison 57}\\
		{\large 75894, Lisbon, Phu Yen, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
