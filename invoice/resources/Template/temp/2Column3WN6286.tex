...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniel Michael Pettersson} \\
		{\large Serenity 55}\\
		{\large 46483, Boston, Huabei, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aliyah Louise 	 Andersson Ltd } \\
		{\large Ariana 52}\\
		{\large 73085, Frankfurt am Main , Hessen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
