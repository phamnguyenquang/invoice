...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maverick Peter Lindqvist} \\
		{\large Joshua 86}\\
		{\large 53113, Berlin, Kentucky, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hannah Thomas Söderberg Corp } \\
		{\large Stephanie 3}\\
		{\large 46968, Shanghai, Chai Nat, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
