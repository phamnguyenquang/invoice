...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Diego William Olsson} \\
		{\large Madeline 55}\\
		{\large 61510, Venice, Texas, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery  Alexander  Hermansson Pte Ltd } \\
		{\large Aurora 16}\\
		{\large 72245, New York , California, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
