...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Delilah Elizabeth 	 Holmgren Corp} \\
		{\large Zoey 57}\\
		{\large 42323, Washington, Chiang Rai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alex Lindström } \\
		{\large Easton 23}\\
		{\large 29279, Hanoi, California, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
