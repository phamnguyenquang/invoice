...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brianna Catherine  Nyström} \\
		{\large Cora 27}\\
		{\large 79606, Frankfurt am Main , Ang Thong, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Piper Amy  Hedlund Ltd } \\
		{\large Zachary 8}\\
		{\large 89126, Montreal, Hessen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
