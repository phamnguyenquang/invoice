...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amir Catherine  Månsson} \\
		{\large Sarah 14}\\
		{\large 78126, San Francisco, Bayern, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan Louise 	 Danielsson Corp } \\
		{\large Kayla 36}\\
		{\large 91203, Hanoi, Amnat Charoen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
