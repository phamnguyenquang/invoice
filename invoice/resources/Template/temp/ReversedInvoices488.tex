...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Johannes Gutenberg University Mainz} \\
		{\large Natalia 44}\\
		{\large 78910, Nha Trang, California, Australia }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Violet Hellström } \\
		{\large Liliana 98}\\
		{\large 65474, Boston, Chiang Rai, South Korea}\\
    \switchcolumn
