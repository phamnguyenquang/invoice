...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eric Louise 	 Ahmed} \\
		{\large Sofia 38}\\
		{\large 14926, New York , Seattles, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madison Elizabeth 	 Forsberg Pte Ltd } \\
		{\large Lilly 11}\\
		{\large 46611, Ho Chi Minh, California, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
