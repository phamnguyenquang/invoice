...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madelyn Catherine  Sandberg} \\
		{\large Stephanie 41}\\
		{\large 40269, Vancouver, Indiana, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Richard Edward Söderberg Inc } \\
		{\large Jackson 20}\\
		{\large 24526, Montreal, Guangzhou, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
