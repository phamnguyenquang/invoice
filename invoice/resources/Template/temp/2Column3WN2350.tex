...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Greyson Louise 	 Pålsson} \\
		{\large Daniel 68}\\
		{\large 30313, Sydney, Kentucky, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Giovanni Jane Blomqvist Ltd } \\
		{\large Nathaniel 88}\\
		{\large 98865, San Francisco, Bangkok, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
