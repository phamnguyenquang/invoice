...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly Christopher Sjöberg} \\
		{\large Olivia 15}\\
		{\large 13250, Lisbon, Hainan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brady Marie 	 Eliasson Ltd } \\
		{\large Arianna 51}\\
		{\large 68092, Last Vegas, Chiang Rai, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
