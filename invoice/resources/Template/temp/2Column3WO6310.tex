...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maddox Louise 	 Lundgren Corp} \\
		{\large Silas 31}\\
		{\large 66715, Washington, Phu Yen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nolan Sandström } \\
		{\large Mckenzie 13}\\
		{\large 77572, Frankfurt am Main , Buriam, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
