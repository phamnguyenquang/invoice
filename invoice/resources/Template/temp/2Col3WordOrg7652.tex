...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriel James Bergström Corp} \\
		{\large Kevin 51}\\
		{\large 34669, Vancouver, khanh Hoa, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Izabella Jakobsson } \\
		{\large Sophie 71}\\
		{\large 36926, San Francisco, Amnat Charoen, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
