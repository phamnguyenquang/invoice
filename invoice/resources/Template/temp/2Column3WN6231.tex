...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lucy Louise 	 Mohamed} \\
		{\large Benjamin 62}\\
		{\large 98009, Frankfurt am Main , Bayern, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrea Christopher Falk Inc } \\
		{\large Steven 70}\\
		{\large 83049, Florence, Amnat Charoen, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
