...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elizabeth David Claesson Pte Ltd} \\
		{\large Alexis 21}\\
		{\large 35373, Shanghai, Bangkok, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elizabeth Pålsson } \\
		{\large Nolan 9}\\
		{\large 13749, Abu Dhabi, Binh Thuan, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
