...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Federal University of Rio Grande do Sul} \\
		{\large Alexis 90}\\
		{\large 51147, Washington, Kentucky, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaron Falk } \\
		{\large Isaac 80}\\
		{\large 43051, Milan, Saarland, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
