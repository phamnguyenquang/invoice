...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  King Marie 	 Bengtsson Pte Ltd} \\
		{\large Weston 11}\\
		{\large 97722, Ho Chi Minh, Chai Nat, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melanie Blom } \\
		{\large Riley 78}\\
		{\large 93256, Washington, Guangzhou, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
