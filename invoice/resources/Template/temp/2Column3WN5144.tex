...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melanie Marie 	 Blom} \\
		{\large Grayson 90}\\
		{\large 81336, San Francisco, Hainan, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hadley  Alexander  Sandberg Pte Ltd } \\
		{\large Dominic 4}\\
		{\large 86740, Los Angeles, Saarland, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
