...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isla  Alexander  Blomqvist Corp} \\
		{\large Emilia 75}\\
		{\large 97015, Melbourne, Kentucky, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Malachi Svensson } \\
		{\large Graham 9}\\
		{\large 54009, Last Vegas, Seattles, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
