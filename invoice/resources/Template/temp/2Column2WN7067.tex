...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jace Hansson} \\
		{\large Nolan 76}\\
		{\large 12522, Frankfurt am Main , Bremen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maxwell Grace 	 Sjöberg Corp } \\
		{\large Chase 37}\\
		{\large 55585, Budapest, Amnat Charoen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
