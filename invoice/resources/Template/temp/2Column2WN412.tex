...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jordyn Sundberg} \\
		{\large Jayden 19}\\
		{\large 24131, Osaka, Guangdong, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Claire Louise 	 Arvidsson Pte Ltd } \\
		{\large Maxwell 26}\\
		{\large 15947, San Francisco, Binh Thuan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
