...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brayden Jane Berglund} \\
		{\large Londyn 80}\\
		{\large 21130, Washington, Bangkok, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brianna Victoria Strömberg Corp } \\
		{\large Rachel 89}\\
		{\large 92935, Frankfurt am Main , Amnat Charoen, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
