...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Norah Elizabeth 	 Fransson} \\
		{\large Gracie 67}\\
		{\large 96921, Florence, Henan, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Xavier Louise 	 Ahmed Corp } \\
		{\large Maximus 73}\\
		{\large 69709, Frankfurt am Main , Chiang Rai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
