...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxon Marie 	 Danielsson} \\
		{\large Amelia 4}\\
		{\large 11121, Denver, Bangkok, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson Anne Berglund Corp } \\
		{\large Aurora 53}\\
		{\large 45827, Frankfurt am Main , California, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
