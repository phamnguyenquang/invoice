...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Xavier Thomas Söderberg} \\
		{\large Lila 46}\\
		{\large 63428, Boston, Binh Thuan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryson Rose 	 Jakobsson Inc } \\
		{\large Logan 31}\\
		{\large 36469, Stuttgart, Hessen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
