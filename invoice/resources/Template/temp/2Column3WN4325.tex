...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Margaret Peter Sjöberg} \\
		{\large Owen 33}\\
		{\large 42137, Minsk, Bremen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christian Kate 	 Håkansson Corp } \\
		{\large Colton 88}\\
		{\large 91689, Frankfurt am Main , Binh Thuan, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
