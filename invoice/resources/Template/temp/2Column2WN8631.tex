...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte Hedlund} \\
		{\large Layla 27}\\
		{\large 38675, Ho Chi Minh, Guangzhou, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ezekiel John Danielsson Pte Ltd } \\
		{\large Bella 31}\\
		{\large 95161, Rome, Indiana, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
