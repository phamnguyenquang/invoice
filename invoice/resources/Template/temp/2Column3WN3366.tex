...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Delilah Christopher Åberg} \\
		{\large Ethan 21}\\
		{\large 60983, Boston, Hessen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hazel William Wikström Inc } \\
		{\large Annabelle 37}\\
		{\large 48967, Ho Chi Minh, Tuscany, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
