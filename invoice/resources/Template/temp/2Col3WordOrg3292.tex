...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katherine William Norberg Pte Ltd} \\
		{\large Kaden 34}\\
		{\large 99100, Chicago, Chiang Rai, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vincent Lundström } \\
		{\large Julianna 81}\\
		{\large 13614, Munich, Chiang Rai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
