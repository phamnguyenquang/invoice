...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melanie  Alexander  Henriksson} \\
		{\large Nolan 66}\\
		{\large 80836, Washington, Kentucky, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reese James Sundberg Inc } \\
		{\large Sean 28}\\
		{\large 35161, Amsterdam, Heibei, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
