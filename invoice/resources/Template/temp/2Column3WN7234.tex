...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Naomi Ann  Olsson} \\
		{\large Alejandro 28}\\
		{\large 55038, Abu Dhabi, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexis Grace 	 Jansson Pte Ltd } \\
		{\large Emilia 60}\\
		{\large 55533, Munich, Hainan, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
