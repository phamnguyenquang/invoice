...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Patrick Rose 	 Nyström} \\
		{\large Benjamin 6}\\
		{\large 12512, Hanoi, khanh Hoa, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hazel May/Mae 	 Magnusson Ltd } \\
		{\large Morgan 90}\\
		{\large 37077, San Francisco, Amnat Charoen, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
