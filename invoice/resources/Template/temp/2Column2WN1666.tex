...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hailey Isaksson} \\
		{\large Katherine 9}\\
		{\large 29515, Frankfurt am Main , Hawaii, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Destiny May/Mae 	 Gustafsson Pte Ltd } \\
		{\large Savannah 47}\\
		{\large 86192, Singapore, Huabei, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
