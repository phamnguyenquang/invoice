...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Marcus Jane Isaksson Corp} \\
		{\large Axel 43}\\
		{\large 33297, Singapore, Guangdong, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angel Björklund } \\
		{\large Kayden 32}\\
		{\large 63260, San Francisco, Chiang Rai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
