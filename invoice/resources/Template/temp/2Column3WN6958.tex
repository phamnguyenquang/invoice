...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brody Edward Blomqvist} \\
		{\large Luke 49}\\
		{\large 13856, Moscow, Hamburg, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kevin Louise 	 Pettersson Corp } \\
		{\large Easton 86}\\
		{\large 70366, Frankfurt am Main , Heibei, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
