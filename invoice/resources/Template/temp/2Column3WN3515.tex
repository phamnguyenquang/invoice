...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaitlyn Christopher Johansson} \\
		{\large Lucy 4}\\
		{\large 75862, Frankfurt am Main , Phu Yen, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tucker Robert Mårtensson Ltd } \\
		{\large Cooper 54}\\
		{\large 74543, Seoul, Guangdong, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
