...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lincoln Elizabeth 	 Holm} \\
		{\large Josephine 44}\\
		{\large 88571, Washington, Bremen, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kimberly Edward Axelsson Corp } \\
		{\large Addison 77}\\
		{\large 90690, Washington, Bayern, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
