...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline Kate 	 Mårtensson Ltd} \\
		{\large Joel 50}\\
		{\large 52655, Ho Chi Minh, Henan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cameron Björklund } \\
		{\large Santiago 17}\\
		{\large 80019, Abu Dhabi, Ang Thong, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
