...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brazilian Development Bank (BNDES)} \\
		{\large Kai 87}\\
		{\large 99760, Amsterdam, Buriam, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katelyn Andersson } \\
		{\large Caden 7}\\
		{\large 61515, Istanbul, khanh Hoa, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
