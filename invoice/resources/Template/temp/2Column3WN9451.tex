...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jasmine May/Mae 	 Magnusson} \\
		{\large Bryce 42}\\
		{\large 30780, Amsterdam, Seattles, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caroline Louise 	 Nordin Ltd } \\
		{\large Henry 18}\\
		{\large 18636, Chicago, Chiang Rai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
