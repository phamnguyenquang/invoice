...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jason Louise 	 Hermansson Corp} \\
		{\large Elise 29}\\
		{\large 73470, Ho Chi Minh, Bangkok, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Easton Hansson } \\
		{\large Katelyn 56}\\
		{\large 51038, Last Vegas, Chiang Rai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
