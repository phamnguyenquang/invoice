...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leonardo Victoria Lindström} \\
		{\large Cora 65}\\
		{\large 21759, Osaka, Kentucky, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sydney Catherine  Lundström Pte Ltd } \\
		{\large Angel 48}\\
		{\large 56066, Abu Dhabi, khanh Hoa, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
