...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Silas Christopher Sandström} \\
		{\large Alexander 60}\\
		{\large 37641, Vienna, Hamburg, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kyle Jane Lindberg Pte Ltd } \\
		{\large Genesis 28}\\
		{\large 16144, Last Vegas, Hawaii, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
