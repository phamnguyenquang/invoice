...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Peter Lindqvist Inc} \\
		{\large Aaliyah 40}\\
		{\large 50123, Los Angeles, Chiang Mai, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Oliver Karlsson } \\
		{\large Brielle 66}\\
		{\large 69876, Hong Kong, Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
