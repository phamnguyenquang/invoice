...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Peyton Victoria Månsson} \\
		{\large Richard 30}\\
		{\large 88263, Frankfurt am Main , Guangdong, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonah Peter Andreasson Ltd } \\
		{\large Hunter 31}\\
		{\large 49916, Moscow, Bremen, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
