...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jordan  Alexander  Mattsson} \\
		{\large Annabelle 65}\\
		{\large 94753, San Francisco, Floria, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tyler Amy  Nilsson Corp } \\
		{\large Bennett 70}\\
		{\large 58297, Abu Dhabi, Guangdong, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
