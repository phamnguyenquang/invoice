...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Norah Michael Pålsson Pte Ltd} \\
		{\large Eden 30}\\
		{\large 81134, Last Vegas, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariel Lindström } \\
		{\large Theodore 23}\\
		{\large 74327, Abu Dhabi, Saarland, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
