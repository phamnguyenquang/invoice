...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Reese  Alexander  Jakobsson Pte Ltd} \\
		{\large Michelle 64}\\
		{\large 75007, San Francisco, Seattles, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabella Hedlund } \\
		{\large Sophia 58}\\
		{\large 65652, Chicago, Chiang Rai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
