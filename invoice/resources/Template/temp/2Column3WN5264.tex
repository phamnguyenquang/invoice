...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Santiago Christopher Dahl} \\
		{\large Thomas 25}\\
		{\large 48719, Vancouver, khanh Hoa, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aria William Gustafsson Pte Ltd } \\
		{\large Gracie 73}\\
		{\large 18107, London , Kentucky, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
