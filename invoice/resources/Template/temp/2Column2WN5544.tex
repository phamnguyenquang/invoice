...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bentley Abrahamsson} \\
		{\large Everly 51}\\
		{\large 12856, Hanoi, khanh Hoa, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Michael Hansen Inc } \\
		{\large Ariel 37}\\
		{\large 74247, Last Vegas, Floria, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
