...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grayson Thomas Mattsson Pte Ltd} \\
		{\large Luca 16}\\
		{\large 92883, Toronto, Hessen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lyla Gustafsson } \\
		{\large Jaxson 81}\\
		{\large 45426, Beijing, Floria, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
