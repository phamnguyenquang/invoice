...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vanessa David Karlsson} \\
		{\large Aaron 40}\\
		{\large 59584, Madrid, Binh Thuan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexis May/Mae 	 Björklund Corp } \\
		{\large Charlotte 15}\\
		{\large 48400, Shanghai, Chiang Mai, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
