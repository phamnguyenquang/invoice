...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jack Eriksson} \\
		{\large Levi 78}\\
		{\large 55083, Los Angeles, Chiang Rai, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie Christopher Berglund Pte Ltd } \\
		{\large Joel 34}\\
		{\large 15092, Taipei, Hawaii, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
