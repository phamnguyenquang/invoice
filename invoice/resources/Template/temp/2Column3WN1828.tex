...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tristan Robert Samuelsson} \\
		{\large Kaitlyn 61}\\
		{\large 46892, Sydney, Hamburg, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryker Amy  Nyberg Corp } \\
		{\large Jack 28}\\
		{\large 81054, Frankfurt am Main , Bangkok, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
