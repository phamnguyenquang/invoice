...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valentina May/Mae 	 Lundgren} \\
		{\large Brooke 34}\\
		{\large 59202, Dublin, Guangzhou, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caleb Marie 	 Löfgren Corp } \\
		{\large Daniela 19}\\
		{\large 54573, Toronto, California, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
