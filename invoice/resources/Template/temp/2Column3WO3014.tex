...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jade Catherine  Bergman Pte Ltd} \\
		{\large Lilly 57}\\
		{\large 82640, Moscow, Kentucky, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabrielle Lundström } \\
		{\large Londyn 17}\\
		{\large 42688, Shanghai, Amnat Charoen, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
