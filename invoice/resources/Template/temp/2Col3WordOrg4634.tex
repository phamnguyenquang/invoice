...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lily Marie 	 Nyberg Inc} \\
		{\large Eva 25}\\
		{\large 41067, Frankfurt am Main , Amnat Charoen, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Andersson } \\
		{\large Margaret 19}\\
		{\large 86423, Paris, Chiang Mai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
