...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel Peter Åkesson} \\
		{\large Ezra 16}\\
		{\large 46130, New York , khanh Hoa, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reese Robert Lindqvist Ltd } \\
		{\large Eliana 39}\\
		{\large 69183, Frankfurt am Main , Chiang Mai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
