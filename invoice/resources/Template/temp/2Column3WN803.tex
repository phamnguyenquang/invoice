...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Quinn  Alexander  Lund} \\
		{\large Maddox 79}\\
		{\large 11618, Munich, Amnat Charoen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reagan  Alexander  Samuelsson Corp } \\
		{\large Luca 93}\\
		{\large 86957, Frankfurt am Main , Texas, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
