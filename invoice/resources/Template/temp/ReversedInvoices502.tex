...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Technical University of Dortmund} \\
		{\large Bradley 22}\\
		{\large 77939, Dublin, Bangkok, Argentina }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Taylor Sandström } \\
		{\large Maya 4}\\
		{\large 10146, New York , Chiang Rai, South Africa }\\
    \switchcolumn
