...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Margaret Eliasson} \\
		{\large Wyatt 7}\\
		{\large 62767, Dubai, Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reagan Louise 	 Lundström Corp } \\
		{\large Layla 40}\\
		{\large 52259, Frankfurt am Main , Heibei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
