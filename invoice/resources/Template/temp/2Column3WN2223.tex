...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maximus Jane Söderberg} \\
		{\large Kayden 8}\\
		{\large 39277, Stuttgart, Henan, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liliana Christopher Forsberg Pte Ltd } \\
		{\large Lila 91}\\
		{\large 25962, Last Vegas, Hamburg, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
