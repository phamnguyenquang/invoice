...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jameson Louise 	 Pålsson} \\
		{\large Katelyn 70}\\
		{\large 33690, Munich, Chiang Mai, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison Anne Gustafsson Pte Ltd } \\
		{\large Alejandro 50}\\
		{\large 87437, Last Vegas, Indiana, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
