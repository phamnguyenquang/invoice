...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michelle Elizabeth 	 Forsberg} \\
		{\large Alexis 59}\\
		{\large 89824, Sydney, Kentucky, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juliana David Ahmed Corp } \\
		{\large Nolan 69}\\
		{\large 91639, Venice, Kentucky, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
