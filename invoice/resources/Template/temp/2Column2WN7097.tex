...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooke Lundin} \\
		{\large Lyla 67}\\
		{\large 17446, Frankfurt am Main , Huabei, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Marie 	 Eriksson Pte Ltd } \\
		{\large Jacob 41}\\
		{\large 93231, Last Vegas, Guangzhou, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
