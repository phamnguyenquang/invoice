...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Anthony Catherine  Lundström} \\
		{\large Elena 40}\\
		{\large 64944, Barcelona, khanh Hoa, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalynn Peter Holm Corp } \\
		{\large Kayla 60}\\
		{\large 16478, Singapore, Floria, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
