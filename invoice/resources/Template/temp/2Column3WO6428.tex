...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Timothy  Alexander  Holmgren Pte Ltd} \\
		{\large Ian 41}\\
		{\large 67814, Singapore, Chiang Rai, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Payton Hermansson } \\
		{\large Miguel 70}\\
		{\large 36696, Tokyo, Texas, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
