...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hannah Christopher Åberg Pte Ltd} \\
		{\large Josiah 32}\\
		{\large 16976, Madrid, Binh Thuan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Skylar Lundberg } \\
		{\large Jeremy 14}\\
		{\large 67546, Beijing, Guangzhou, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
