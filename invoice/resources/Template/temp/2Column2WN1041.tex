...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bailey Eriksson} \\
		{\large Harper 35}\\
		{\large 51734, Moscow, Chiang Mai, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Faith Lee  Berggren Inc } \\
		{\large Cayden 65}\\
		{\large 21095, Frankfurt am Main , Guangdong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
