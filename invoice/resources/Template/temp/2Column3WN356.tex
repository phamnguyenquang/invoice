...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Anne Hansson} \\
		{\large Ivan 67}\\
		{\large 86073, London , Chiang Mai, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maverick Anne Hellström Pte Ltd } \\
		{\large Sarah 78}\\
		{\large 33199, Rome, Guangzhou, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
