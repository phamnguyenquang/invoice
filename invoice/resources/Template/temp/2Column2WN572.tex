...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Colin Björklund} \\
		{\large Aidan 79}\\
		{\large 30979, Frankfurt am Main , Huabei, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaliyah Victoria Hansson Inc } \\
		{\large Madison 1}\\
		{\large 77787, Frankfurt am Main , Tuscany, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
