...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rose May/Mae 	 Wikström} \\
		{\large Ariana 63}\\
		{\large 24989, Hong Kong, Hainan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Parker Elizabeth 	 Berg Pte Ltd } \\
		{\large Brantley 74}\\
		{\large 53543, Vancouver, Chiang Rai, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
