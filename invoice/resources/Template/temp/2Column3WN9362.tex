...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harrison Edward Lundström} \\
		{\large Riley 10}\\
		{\large 74551, Washington, Amnat Charoen, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aliyah Kate 	 Jönsson Corp } \\
		{\large Adalynn 34}\\
		{\large 47092, Nha Trang, Floria, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
