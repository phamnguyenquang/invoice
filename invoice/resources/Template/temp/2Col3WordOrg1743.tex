...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Elizabeth 	 Holm Pte Ltd} \\
		{\large Willow 21}\\
		{\large 72169, Frankfurt am Main , Floria, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carlos Olsson } \\
		{\large Sophia 37}\\
		{\large 86636, Hanoi, Saarland, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
