...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alaina William Danielsson} \\
		{\large Jesus 27}\\
		{\large 74096, Munich, Hessen, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniel May/Mae 	 Ekström Pte Ltd } \\
		{\large Ethan 88}\\
		{\large 56239, Last Vegas, Bayern, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
