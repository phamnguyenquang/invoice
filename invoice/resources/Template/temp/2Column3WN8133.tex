...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carter  Alexander  Andreasson} \\
		{\large King 50}\\
		{\large 24639, Vancouver, Hainan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carson  Alexander  Henriksson Corp } \\
		{\large Easton 8}\\
		{\large 73014, Montreal, khanh Hoa, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
