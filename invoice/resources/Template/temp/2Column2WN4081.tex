...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline Svensson} \\
		{\large Faith 36}\\
		{\large 11770, Frankfurt am Main , Hawaii, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Victoria Viklund Inc } \\
		{\large Cayden 7}\\
		{\large 47448, Florence, Huabei, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
