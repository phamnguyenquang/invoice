...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lillian Peter Andersson Ltd} \\
		{\large Alan 63}\\
		{\large 11206, Montreal, Hessen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Antonio Magnusson } \\
		{\large Christian 43}\\
		{\large 55627, Nha Trang, Binh Thuan, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
