...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lillian John Lundström} \\
		{\large Kayden 9}\\
		{\large 21257, Paris, Bangkok, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubrey Catherine  Lindberg Corp } \\
		{\large Zachary 63}\\
		{\large 59129, Beijing, Guangdong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
