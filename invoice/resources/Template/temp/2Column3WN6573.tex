...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Patrick Louise 	 Holmgren} \\
		{\large Emily 7}\\
		{\large 47977, London , Chiang Mai, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anthony David Lindberg Pte Ltd } \\
		{\large Isaac 23}\\
		{\large 52315, Berlin, Seattles, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
