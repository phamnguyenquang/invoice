...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie Catherine  Henriksson} \\
		{\large Brady 80}\\
		{\large 19015, Paris, Heibei, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy Kate 	 Bengtsson Ltd } \\
		{\large Clara 27}\\
		{\large 23306, Montreal, Bayern, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
