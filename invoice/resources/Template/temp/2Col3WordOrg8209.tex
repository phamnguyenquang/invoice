...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Roman William Berg Pte Ltd} \\
		{\large Roman 5}\\
		{\large 24634, Frankfurt am Main , Hessen, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brayden Nilsson } \\
		{\large Vanessa 50}\\
		{\large 80508, Amsterdam, California, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
