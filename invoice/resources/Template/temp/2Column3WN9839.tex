...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Londyn William Åkesson} \\
		{\large Wesley 74}\\
		{\large 74605, New York , Guangdong, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christian Rose 	 Karlsson Pte Ltd } \\
		{\large Thomas 78}\\
		{\large 81077, Dublin, Saarland, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
