...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dominic Kate 	 Norberg} \\
		{\large Jayden 71}\\
		{\large 58573, Frankfurt am Main , Chai Nat, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evan Louise 	 Nyberg Inc } \\
		{\large Kaitlyn 93}\\
		{\large 80008, Los Angeles, Seattles, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
