...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Logan Elizabeth 	 Eklund Corp} \\
		{\large Vanessa 98}\\
		{\large 24701, San Francisco, Indiana, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valentina Olofsson } \\
		{\large Matthew 8}\\
		{\large 38047, San Francisco, Chiang Rai, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
