...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina Marie 	 Berggren Pte Ltd} \\
		{\large Angelina 6}\\
		{\large 84031, Los Angeles, Texas, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalynn Lindberg } \\
		{\large Jude 70}\\
		{\large 92527, Los Angeles, Chiang Mai, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
