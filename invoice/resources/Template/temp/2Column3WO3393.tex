...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Willow Christopher Sandberg Ltd} \\
		{\large Delilah 94}\\
		{\large 75754, Frankfurt am Main , California, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maddox Nyström } \\
		{\large Ariel 3}\\
		{\large 22385, Toronto, Seattles, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
