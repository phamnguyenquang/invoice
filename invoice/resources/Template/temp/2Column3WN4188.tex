...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Louise 	 Falk} \\
		{\large Adeline 12}\\
		{\large 42941, San Francisco, Phu Yen, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaitlyn Louise 	 Karlsson Pte Ltd } \\
		{\large Cameron 25}\\
		{\large 29756, Hong Kong, Heibei, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
