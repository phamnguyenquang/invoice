...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hayden Michael Falk} \\
		{\large Katherine 77}\\
		{\large 70679, Frankfurt am Main , Hainan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayce Ann  Söderberg Pte Ltd } \\
		{\large Graham 46}\\
		{\large 92688, Stuttgart, Ang Thong, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
