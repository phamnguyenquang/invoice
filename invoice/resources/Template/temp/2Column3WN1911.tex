...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dylan Mary 	 Nyberg} \\
		{\large Ashton 31}\\
		{\large 93516, San Francisco, Hainan, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harrison  Alexander  Löfgren Pte Ltd } \\
		{\large Ryder 30}\\
		{\large 70997, Frankfurt am Main , Phu Yen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
