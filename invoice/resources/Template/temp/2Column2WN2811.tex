...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brady Jakobsson} \\
		{\large Christian 60}\\
		{\large 28029, Los Angeles, Phu Yen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camila Michael Eliasson Pte Ltd } \\
		{\large Abraham 47}\\
		{\large 33159, SaiGon, Bayern, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
