...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayden Anne Eklund} \\
		{\large Emma 96}\\
		{\large 82586, Hong Kong, Ang Thong, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Delilah Marie 	 Henriksson Ltd } \\
		{\large Brianna 80}\\
		{\large 43960, Vancouver, khanh Hoa, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
