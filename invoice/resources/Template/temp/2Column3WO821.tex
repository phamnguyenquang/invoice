...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Colin Kate 	 Danielsson Pte Ltd} \\
		{\large Edward 98}\\
		{\large 12510, Barcelona, Binh Thuan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makayla Hansson } \\
		{\large Hailey 40}\\
		{\large 60949, Ho Chi Minh, Bangkok, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
