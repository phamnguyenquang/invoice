...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Austin Anne Claesson Pte Ltd} \\
		{\large Sarah 88}\\
		{\large 28671, Frankfurt am Main , Tuscany, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Richard Mohamed } \\
		{\large William 33}\\
		{\large 60118, Berlin, Chiang Mai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
