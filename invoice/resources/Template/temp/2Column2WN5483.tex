...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lillian Jansson} \\
		{\large Charlotte 61}\\
		{\large 27404, New York , Floria, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson William Gustafsson Pte Ltd } \\
		{\large Jaxson 93}\\
		{\large 51260, Frankfurt am Main , Hessen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
