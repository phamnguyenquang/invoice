...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine John Ahmed} \\
		{\large Brady 17}\\
		{\large 89446, Frankfurt am Main , Chai Nat, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lyla Christopher Sjöberg Pte Ltd } \\
		{\large Vivian 20}\\
		{\large 31210, Minsk, Chiang Rai, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
