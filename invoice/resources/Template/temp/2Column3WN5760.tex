...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel Jane Abrahamsson} \\
		{\large Luna 12}\\
		{\large 19539, Budapest, Amnat Charoen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emilia Thomas Nyström Pte Ltd } \\
		{\large Gabrielle 24}\\
		{\large 73106, Paris, Heibei, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
