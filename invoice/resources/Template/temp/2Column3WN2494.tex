...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel Kate 	 Nyberg} \\
		{\large Kenneth 87}\\
		{\large 71210, Frankfurt am Main , Floria, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kayla Marie 	 Pålsson Inc } \\
		{\large Jayden 48}\\
		{\large 40145, Singapore, Ang Thong, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
