...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Delilah William Hermansson} \\
		{\large Katherine 69}\\
		{\large 25124, Singapore, Binh Thuan, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brielle Kate 	 Mårtensson Pte Ltd } \\
		{\large Zoe 60}\\
		{\large 20901, Minsk, Guangzhou, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
