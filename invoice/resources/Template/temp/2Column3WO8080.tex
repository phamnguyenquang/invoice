...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle Lee  Jansson Ltd} \\
		{\large Kaitlyn 93}\\
		{\large 72608, Frankfurt am Main , California, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josephine Jönsson } \\
		{\large Claire 14}\\
		{\large 56950, New York , Guangzhou, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
