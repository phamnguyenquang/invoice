...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  William Louise 	 Lindqvist Pte Ltd} \\
		{\large Jennifer 67}\\
		{\large 98720, Frankfurt am Main , Guangzhou, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalia Ekström } \\
		{\large Emmett 65}\\
		{\large 45899, Berlin, Phu Yen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
