...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bailey  Alexander  Pettersson} \\
		{\large Mya 35}\\
		{\large 42563, Lisbon, Hessen, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cameron May/Mae 	 Eliasson Inc } \\
		{\large Kaiden 73}\\
		{\large 53658, Moscow, khanh Hoa, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
