...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sara Marie 	 Hermansson} \\
		{\large Nora 27}\\
		{\large 19777, Minsk, Phu Yen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Athena Thomas Andersson Pte Ltd } \\
		{\large Ashton 80}\\
		{\large 25384, Frankfurt am Main , Chiang Mai, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
