...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Trinity Michael Martinsson} \\
		{\large Graham 7}\\
		{\large 13181, Toronto, Chiang Rai, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Scarlett Grace 	 Ahmed Pte Ltd } \\
		{\large Brooke 12}\\
		{\large 14235, Montreal, khanh Hoa, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
