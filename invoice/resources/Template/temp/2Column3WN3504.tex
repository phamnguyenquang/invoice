...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Genesis Louise 	 Magnusson} \\
		{\large Amir 90}\\
		{\large 98927, Ho Chi Minh, Saarland, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large David Thomas Björklund Inc } \\
		{\large Ashton 71}\\
		{\large 57422, Shanghai, Hamburg, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
