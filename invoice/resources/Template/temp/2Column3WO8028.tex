...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Connor James Gustafsson Pte Ltd} \\
		{\large Kayden 29}\\
		{\large 64665, Barcelona, Saarland, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison Lundqvist } \\
		{\large Luca 87}\\
		{\large 16885, SaiGon, Chiang Rai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
