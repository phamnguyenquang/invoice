...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexis Christopher Abrahamsson Ltd} \\
		{\large Londyn 5}\\
		{\large 23500, Los Angeles, Saarland, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maxwell Wallin } \\
		{\large Harmony 33}\\
		{\large 30083, Lisbon, Guangdong, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
