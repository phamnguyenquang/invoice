...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michelle Victoria Håkansson Ltd} \\
		{\large Santiago 70}\\
		{\large 34489, Frankfurt am Main , Hessen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emma Persson } \\
		{\large Christopher 8}\\
		{\large 66682, Last Vegas, Chiang Mai, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
