...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline May/Mae 	 Holmgren} \\
		{\large Colin 38}\\
		{\large 99013, Washington, Hessen, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabella Mary 	 Danielsson Corp } \\
		{\large Kendall 65}\\
		{\large 44072, SaiGon, Huabei, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
