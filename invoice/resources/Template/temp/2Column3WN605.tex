...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rylee Elizabeth 	 Jakobsson} \\
		{\large Levi 49}\\
		{\large 60747, Last Vegas, Bremen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Dominic Robert Blomqvist Inc } \\
		{\large Parker 20}\\
		{\large 77542, Moscow, Bayern, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
