...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery Anne Gunnarsson} \\
		{\large Diego 58}\\
		{\large 88687, Boston, Chiang Mai, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everly Amy  Blomqvist Pte Ltd } \\
		{\large Sawyer 23}\\
		{\large 54056, New York , Tuscany, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
