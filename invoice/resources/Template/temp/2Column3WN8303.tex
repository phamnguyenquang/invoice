...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hailey Rose 	 Falk} \\
		{\large Lucy 60}\\
		{\large 97463, Melbourne, Guangzhou, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremiah Louise 	 Håkansson Ltd } \\
		{\large Abel 74}\\
		{\large 27413, Frankfurt am Main , Kentucky, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
