...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rachel Marie 	 Mattsson Pte Ltd} \\
		{\large Vivian 2}\\
		{\large 19609, Frankfurt am Main , Phu Yen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Roman Eliasson } \\
		{\large Ryker 70}\\
		{\large 59203, San Francisco, Phu Yen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
