...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dominic Marie 	 Falk} \\
		{\large Adalynn 68}\\
		{\large 67337, San Francisco, Hamburg, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emma Grace 	 Sandberg Pte Ltd } \\
		{\large Lucy 54}\\
		{\large 58863, Budapest, Chai Nat, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
