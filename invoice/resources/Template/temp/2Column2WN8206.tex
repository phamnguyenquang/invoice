...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly Berg} \\
		{\large Connor 84}\\
		{\large 11045, Melbourne, Phu Yen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson Rose 	 Henriksson Pte Ltd } \\
		{\large Colton 89}\\
		{\large 59148, San Francisco, Huabei, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
