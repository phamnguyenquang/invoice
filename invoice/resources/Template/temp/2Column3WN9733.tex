...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexis Edward Lundqvist} \\
		{\large Luna 14}\\
		{\large 14824, Florence, Ang Thong, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonathan Christopher Bergström Pte Ltd } \\
		{\large Axel 73}\\
		{\large 53365, Singapore, Bangkok, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
