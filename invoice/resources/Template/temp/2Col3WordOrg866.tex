...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kayden Victoria Fransson Pte Ltd} \\
		{\large Kaylee 41}\\
		{\large 38319, Lisbon, Amnat Charoen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valerie Engström } \\
		{\large Annabelle 39}\\
		{\large 13404, New York , Chiang Mai, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
