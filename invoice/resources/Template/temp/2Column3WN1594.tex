...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniel Marie 	 Nilsson} \\
		{\large Braxton 54}\\
		{\large 19386, San Francisco, Texas, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emma Catherine  Fredriksson Corp } \\
		{\large Brianna 42}\\
		{\large 43676, Singapore, Chiang Mai, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
