...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabella Lee  Nyberg} \\
		{\large Juliana 13}\\
		{\large 19088, Frankfurt am Main , Kentucky, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brian Edward Jonsson Inc } \\
		{\large Brayden 26}\\
		{\large 78704, Ho Chi Minh, Binh Thuan, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
