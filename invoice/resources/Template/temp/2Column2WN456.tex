...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lucy Fredriksson} \\
		{\large Abigail 70}\\
		{\large 11379, Berlin, California, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonah David Larsson Corp } \\
		{\large Valeria 12}\\
		{\large 53241, Frankfurt am Main , Ang Thong, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
