...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jocelyn Sjöberg} \\
		{\large Jayce 22}\\
		{\large 30627, Abu Dhabi, California, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rachel Christopher Martinsson Ltd } \\
		{\large Mason 60}\\
		{\large 34084, Washington, Seattles, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
