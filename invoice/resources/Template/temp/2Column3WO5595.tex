...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Rose 	 Andersson Pte Ltd} \\
		{\large Valerie 42}\\
		{\large 94315, San Francisco, Floria, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Lund } \\
		{\large Gabriel 83}\\
		{\large 64022, Istanbul, Chiang Rai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
