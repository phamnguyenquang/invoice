...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  London Lee  Åkesson} \\
		{\large Wyatt 15}\\
		{\large 94602, Istanbul, Kentucky, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ella Louise 	 Bengtsson Pte Ltd } \\
		{\large Alexis 50}\\
		{\large 91375, Frankfurt am Main , Heibei, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
