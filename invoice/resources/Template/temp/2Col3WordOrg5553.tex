...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Oliver Jane Sjöberg Ltd} \\
		{\large Serenity 88}\\
		{\large 99925, Frankfurt am Main , California, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hannah Axelsson } \\
		{\large Bradley 62}\\
		{\large 10401, Abu Dhabi, Bremen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
