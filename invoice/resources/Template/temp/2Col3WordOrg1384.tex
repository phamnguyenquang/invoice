...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leilani Christopher Norberg Corp} \\
		{\large Kaleb 2}\\
		{\large 45063, Last Vegas, Phu Yen, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caroline Henriksson } \\
		{\large Jesus 96}\\
		{\large 22357, Moscow, Chiang Mai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
