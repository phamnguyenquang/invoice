...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alyssa Lee  Dahlberg} \\
		{\large Cameron 21}\\
		{\large 31458, Los Angeles, Kentucky, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large William Michael Nyström Pte Ltd } \\
		{\large Reagan 15}\\
		{\large 70608, Los Angeles, khanh Hoa, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
