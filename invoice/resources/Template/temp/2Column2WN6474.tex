...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alaina Henriksson} \\
		{\large Kaitlyn 81}\\
		{\large 19655, Frankfurt am Main , Bangkok, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ashton Robert Bergman Ltd } \\
		{\large Oscar 95}\\
		{\large 17180, Hanoi, Binh Thuan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
