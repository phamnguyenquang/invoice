...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Anna May/Mae 	 Söderberg} \\
		{\large Nora 65}\\
		{\large 90877, Moscow, Hamburg, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubree Michael Martinsson Pte Ltd } \\
		{\large Lilly 67}\\
		{\large 42094, Berlin, Chiang Mai, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
