...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Asher James Lindholm} \\
		{\large Aubree 9}\\
		{\large 92837, Frankfurt am Main , Ang Thong, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hailey William Sjöberg Ltd } \\
		{\large Sofia 50}\\
		{\large 70173, Singapore, Floria, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
