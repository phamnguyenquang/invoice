...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alan Elizabeth 	 Lindström} \\
		{\large Jonathan 14}\\
		{\large 38659, Berlin, Ang Thong, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmett David Wikström Corp } \\
		{\large Molly 28}\\
		{\large 93393, Montreal, Chiang Rai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
