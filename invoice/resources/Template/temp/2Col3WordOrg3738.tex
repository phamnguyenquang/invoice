...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lucas Victoria Danielsson Ltd} \\
		{\large Ashton 96}\\
		{\large 99508, New York , Tuscany, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Micah Lindberg } \\
		{\large Ayden 6}\\
		{\large 49069, Madrid, Kentucky, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
