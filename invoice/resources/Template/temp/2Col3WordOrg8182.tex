...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kevin Michael Gunnarsson Pte Ltd} \\
		{\large Timothy 14}\\
		{\large 27454, Boston, Tuscany, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore Claesson } \\
		{\large Lauren 32}\\
		{\large 86361, Lisbon, Saarland, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
