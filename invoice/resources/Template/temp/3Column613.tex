...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Shahid Beheshti University of Medical Sciences} \\
		{\large Chase 59}\\
		{\large 87394, Sydney, Kentucky, Denmark}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Marcus Engström } \\
		{\large Julianna 18}\\
		{\large 41291, Munich, Bangkok, Philippines}\\
    \switchcolumn
