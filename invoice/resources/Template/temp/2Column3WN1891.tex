...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maddox Kate 	 Pettersson} \\
		{\large Ivy 38}\\
		{\large 52461, Vancouver, Saarland, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariana Victoria Håkansson Ltd } \\
		{\large Preston 5}\\
		{\large 78448, Vancouver, Huabei, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
