...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ashley Pålsson} \\
		{\large Layla 32}\\
		{\large 52533, Frankfurt am Main , Chiang Mai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Antonio Victoria Nyberg Pte Ltd } \\
		{\large Amy 35}\\
		{\large 74025, Denver, Indiana, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
