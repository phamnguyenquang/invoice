...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stephanie Kate 	 Samuelsson} \\
		{\large Andrea 88}\\
		{\large 60751, Hong Kong, Texas, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Damian Michael Hermansson Inc } \\
		{\large Nicholas 12}\\
		{\large 10390, Shanghai, Chiang Mai, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
