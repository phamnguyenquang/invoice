...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Connor Kate 	 Eriksson} \\
		{\large Wesley 39}\\
		{\large 13828, Los Angeles, khanh Hoa, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Edward Eklund Pte Ltd } \\
		{\large Jasmine 26}\\
		{\large 41576, Nha Trang, Chiang Rai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
