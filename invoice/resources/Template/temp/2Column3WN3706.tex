...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amir Marie 	 Nyström} \\
		{\large Margaret 4}\\
		{\large 77434, Frankfurt am Main , Chai Nat, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Athena Louise 	 Åberg Pte Ltd } \\
		{\large Liliana 93}\\
		{\large 33421, Frankfurt am Main , Texas, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
