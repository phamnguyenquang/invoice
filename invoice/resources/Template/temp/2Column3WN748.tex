...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity Marie 	 Wallin} \\
		{\large Nora 53}\\
		{\large 68915, Stuttgart, Amnat Charoen, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklyn Rose 	 Jansson Inc } \\
		{\large Chloe 51}\\
		{\large 46671, Melbourne, California, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
