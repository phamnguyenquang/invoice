...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alan William Pettersson} \\
		{\large Julian 17}\\
		{\large 95764, Ho Chi Minh, Floria, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grayson Rose 	 Ström Pte Ltd } \\
		{\large Gabriella 70}\\
		{\large 29826, Los Angeles, Huabei, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
