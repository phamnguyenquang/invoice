...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aubrey Edward Danielsson} \\
		{\large Asher 17}\\
		{\large 10856, Istanbul, Binh Thuan, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley  Alexander  Martinsson Ltd } \\
		{\large Peyton 2}\\
		{\large 78340, Vienna, Chai Nat, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
