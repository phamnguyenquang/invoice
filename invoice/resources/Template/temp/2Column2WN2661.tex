...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Evelyn Lindberg} \\
		{\large Miguel 30}\\
		{\large 79319, Istanbul, Chiang Rai, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paige Elizabeth 	 Larsson Corp } \\
		{\large Bryson 62}\\
		{\large 10497, Munich, Guangdong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
