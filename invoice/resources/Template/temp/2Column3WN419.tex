...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katherine Louise 	 Hedlund} \\
		{\large Jameson 32}\\
		{\large 92285, Budapest, Hamburg, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hudson Elizabeth 	 Holmberg Ltd } \\
		{\large Madison 64}\\
		{\large 85315, Hong Kong, Binh Thuan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
