...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline May/Mae 	 Åberg Pte Ltd} \\
		{\large Kennedy 82}\\
		{\large 75697, Florence, Huabei, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anna Jakobsson } \\
		{\large Eden 8}\\
		{\large 67899, Frankfurt am Main , Kentucky, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
