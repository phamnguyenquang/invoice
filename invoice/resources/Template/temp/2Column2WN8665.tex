...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sawyer Lindberg} \\
		{\large Sawyer 18}\\
		{\large 82561, Dublin, Amnat Charoen, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaron Louise 	 Axelsson Corp } \\
		{\large Ryan 61}\\
		{\large 18847, Frankfurt am Main , Guangdong, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
