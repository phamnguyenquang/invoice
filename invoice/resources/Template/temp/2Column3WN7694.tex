...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ayden Christopher Holmberg} \\
		{\large Nolan 40}\\
		{\large 48438, Amsterdam, Floria, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalyn Victoria Svensson Pte Ltd } \\
		{\large Savannah 85}\\
		{\large 52529, Tokyo, Hamburg, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
