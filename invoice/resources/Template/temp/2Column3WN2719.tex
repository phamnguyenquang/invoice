...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremiah Thomas Hansson} \\
		{\large Mya 66}\\
		{\large 83825, Melbourne, California, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryan Rose 	 Samuelsson Corp } \\
		{\large Luca 92}\\
		{\large 27302, London , Chiang Rai, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
