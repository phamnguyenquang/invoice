...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alan Edward Lundin} \\
		{\large Andrea 76}\\
		{\large 82741, Nha Trang, Kentucky, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryder Michael Forsberg Pte Ltd } \\
		{\large Sebastian 62}\\
		{\large 59180, Budapest, Amnat Charoen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
