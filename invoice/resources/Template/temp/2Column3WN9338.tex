...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Axel May/Mae 	 Lindberg} \\
		{\large Jasmine 91}\\
		{\large 34960, Vancouver, Chiang Rai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ian David Claesson Pte Ltd } \\
		{\large Naomi 47}\\
		{\large 85299, Nha Trang, Phu Yen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
