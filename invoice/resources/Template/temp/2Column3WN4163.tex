...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Skylar Louise 	 Söderberg} \\
		{\large Julianna 53}\\
		{\large 25395, Stuttgart, Kentucky, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reese Victoria Fredriksson Corp } \\
		{\large Jordan 99}\\
		{\large 69277, Singapore, Guangdong, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
