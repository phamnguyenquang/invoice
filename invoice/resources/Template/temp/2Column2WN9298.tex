...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicolas Samuelsson} \\
		{\large Isaac 16}\\
		{\large 99036, Budapest, Kentucky, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mckenzie Louise 	 Berg Pte Ltd } \\
		{\large Harrison 98}\\
		{\large 82271, Abu Dhabi, Hawaii, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
