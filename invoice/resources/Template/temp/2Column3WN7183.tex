...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nolan Marie 	 Nordström} \\
		{\large Liam 37}\\
		{\large 44533, Frankfurt am Main , Guangdong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Elizabeth 	 Ahmed Pte Ltd } \\
		{\large Alexis 8}\\
		{\large 60138, Madrid, Heibei, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
