...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jasmine Rose 	 Mattsson} \\
		{\large Vincent 39}\\
		{\large 56210, London , Guangzhou, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adriana Christopher Lindqvist Ltd } \\
		{\large Alice 44}\\
		{\large 55392, Berlin, Hawaii, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
