...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lyla Thomas Bergström} \\
		{\large Addison 39}\\
		{\large 20024, Frankfurt am Main , Phu Yen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everly Catherine  Berg Corp } \\
		{\large Gavin 83}\\
		{\large 76249, Toronto, Seattles, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
