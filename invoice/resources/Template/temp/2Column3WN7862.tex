...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexis Kate 	 Lundqvist} \\
		{\large Maddox 24}\\
		{\large 75959, Montreal, Texas, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Colin Robert Viklund Ltd } \\
		{\large Colin 40}\\
		{\large 75958, Frankfurt am Main , Guangdong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
