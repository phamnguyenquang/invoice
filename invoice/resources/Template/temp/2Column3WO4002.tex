...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexa James Blomqvist Pte Ltd} \\
		{\large Kaiden 40}\\
		{\large 42995, Amsterdam, khanh Hoa, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amy Strömberg } \\
		{\large Amy 97}\\
		{\large 30652, Vienna, khanh Hoa, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
