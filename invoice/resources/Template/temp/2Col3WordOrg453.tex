...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Molly Michael Lundin Pte Ltd} \\
		{\large Graham 86}\\
		{\large 53331, Tokyo, California, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hudson Fredriksson } \\
		{\large Michael 7}\\
		{\large 24420, Frankfurt am Main , Kentucky, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
