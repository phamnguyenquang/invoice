...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryan Victoria Holmberg Inc} \\
		{\large Angelina 51}\\
		{\large 22058, Frankfurt am Main , Chai Nat, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bentley Lundqvist } \\
		{\large Eli 59}\\
		{\large 58337, Vienna, Hessen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
