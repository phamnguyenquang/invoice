...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Calvin Kate 	 Danielsson Pte Ltd} \\
		{\large Jocelyn 14}\\
		{\large 24545, Tokyo, Binh Thuan, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makayla Abrahamsson } \\
		{\large Lucas 37}\\
		{\large 19318, Frankfurt am Main , Guangdong, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
