...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Timothy Catherine  Gustafsson Pte Ltd} \\
		{\large Aaliyah 79}\\
		{\large 57834, Singapore, Chiang Rai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eleanor Pålsson } \\
		{\large Trinity 3}\\
		{\large 17127, Shanghai, Hessen, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
