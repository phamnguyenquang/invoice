...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Payton  Alexander  Håkansson} \\
		{\large Alexa 6}\\
		{\large 30382, Shanghai, Chiang Mai, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kenneth Ann  Dahlberg Corp } \\
		{\large Silas 45}\\
		{\large 13026, Washington, Hainan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
