...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maddox Berg} \\
		{\large Scarlett 78}\\
		{\large 20906, Chicago, Bangkok, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxson Michael Björklund Pte Ltd } \\
		{\large Luis 33}\\
		{\large 75764, Frankfurt am Main , khanh Hoa, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
