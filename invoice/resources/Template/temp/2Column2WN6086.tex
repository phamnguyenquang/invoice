...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriel Claesson} \\
		{\large Oliver 77}\\
		{\large 86319, London , Chai Nat, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathaniel Catherine  Bergqvist Inc } \\
		{\large Jeremy 69}\\
		{\large 30469, Montreal, Hessen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
