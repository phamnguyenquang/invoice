...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Layla Nyström Pte Ltd} \\
		{\large Bryce 21}\\
		{\large 45466, Frankfurt am Main , Hamburg, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hudson Holmberg } \\
		{\large Margaret 27}\\
		{\large 52651, Los Angeles, Binh Thuan, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
