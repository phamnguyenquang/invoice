...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Louise 	 Svensson} \\
		{\large Madeline 92}\\
		{\large 60231, Ho Chi Minh, Texas, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ashley Louise 	 Andersson Pte Ltd } \\
		{\large Benjamin 42}\\
		{\large 98884, Los Angeles, Chiang Mai, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
