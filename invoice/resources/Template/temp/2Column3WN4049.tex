...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore  Alexander  Bergman} \\
		{\large Katelyn 89}\\
		{\large 76576, Munich, Chai Nat, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriel Michael Samuelsson Corp } \\
		{\large Jonathan 32}\\
		{\large 35401, Montreal, Hessen, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
