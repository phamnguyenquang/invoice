...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Clara David Lundberg} \\
		{\large Emmett 11}\\
		{\large 45058, Frankfurt am Main , Chai Nat, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aidan Anne Ali Pte Ltd } \\
		{\large Norah 63}\\
		{\large 71351, Montreal, Heibei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
