...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Greyson  Alexander  Olsson} \\
		{\large Sophia 52}\\
		{\large 38080, Melbourne, Saarland, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sophie John Blom Pte Ltd } \\
		{\large Benjamin 14}\\
		{\large 38833, Barcelona, Hamburg, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
