...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elijah Ann  Hellström} \\
		{\large Connor 50}\\
		{\large 68038, San Francisco, California, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anna David Andersson Inc } \\
		{\large Charles 94}\\
		{\large 26446, Vancouver, Guangzhou, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
