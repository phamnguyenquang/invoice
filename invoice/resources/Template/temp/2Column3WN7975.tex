...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michelle Amy  Abrahamsson} \\
		{\large Thomas 1}\\
		{\large 60200, Los Angeles, Binh Thuan, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harmony Lee  Lindgren Corp } \\
		{\large Jesse 4}\\
		{\large 70389, Madrid, Heibei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
