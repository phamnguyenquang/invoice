...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Wikström} \\
		{\large Ethan 52}\\
		{\large 10924, Ho Chi Minh, Hamburg, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Braxton May/Mae 	 Söderberg Pte Ltd } \\
		{\large Nathan 73}\\
		{\large 74234, Montreal, Seattles, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
