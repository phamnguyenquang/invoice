...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kinsley May/Mae 	 Björklund} \\
		{\large Zachary 34}\\
		{\large 95521, Minsk, Hamburg, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Serenity Christopher Karlsson Corp } \\
		{\large Ella 54}\\
		{\large 13185, Frankfurt am Main , Bremen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
