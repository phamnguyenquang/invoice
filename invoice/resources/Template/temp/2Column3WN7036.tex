...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maya Michael Ekström} \\
		{\large David 81}\\
		{\large 23938, Osaka, Tuscany, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremy Elizabeth 	 Wallin Ltd } \\
		{\large Jaxon 75}\\
		{\large 56580, Los Angeles, Chai Nat, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
