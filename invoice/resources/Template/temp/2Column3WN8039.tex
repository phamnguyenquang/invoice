...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklynn Amy  Ekström} \\
		{\large Lilly 10}\\
		{\large 80503, Lisbon, khanh Hoa, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Taylor Rose 	 Lundqvist Pte Ltd } \\
		{\large Mark 73}\\
		{\large 57915, Los Angeles, Chiang Mai, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
