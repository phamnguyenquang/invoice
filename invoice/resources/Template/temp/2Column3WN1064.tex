...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabella James Magnusson} \\
		{\large Dylan 72}\\
		{\large 70120, Dubai, Hessen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hayden Christopher Forsberg Corp } \\
		{\large Mackenzie 14}\\
		{\large 97612, Berlin, Saarland, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
