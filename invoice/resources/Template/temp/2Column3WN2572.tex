...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Naomi Anne Berg} \\
		{\large Ariana 17}\\
		{\large 83169, Barcelona, Chiang Mai, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Miguel Edward Henriksson Pte Ltd } \\
		{\large Alexander 6}\\
		{\large 40806, Nha Trang, Seattles, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
