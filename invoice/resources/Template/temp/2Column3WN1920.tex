...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jason David Norberg} \\
		{\large Brady 15}\\
		{\large 31527, Abu Dhabi, Phu Yen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Norah Elizabeth 	 Håkansson Pte Ltd } \\
		{\large Charlotte 29}\\
		{\large 46938, Dubai, Guangzhou, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
