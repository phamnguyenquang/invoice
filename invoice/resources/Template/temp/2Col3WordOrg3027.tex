...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Trinity Robert Jonsson Ltd} \\
		{\large Ryan 35}\\
		{\large 20428, Frankfurt am Main , Bangkok, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amir Pettersson } \\
		{\large Jude 18}\\
		{\large 69055, Vancouver, Phu Yen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
