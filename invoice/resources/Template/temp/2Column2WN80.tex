...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariana Berg} \\
		{\large Lucy 97}\\
		{\large 19969, Frankfurt am Main , Kentucky, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caden  Alexander  Magnusson Pte Ltd } \\
		{\large Isabella 58}\\
		{\large 12891, Stuttgart, Bayern, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
