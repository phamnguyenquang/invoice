...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  University of Chinese Academy of Sciences} \\
		{\large Sawyer 90}\\
		{\large 47672, Frankfurt am Main , Hainan, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juliana Ahmed } \\
		{\large Sebastian 12}\\
		{\large 10567, Toronto, khanh Hoa, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
