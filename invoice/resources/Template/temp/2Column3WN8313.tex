...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Antonio William Jönsson} \\
		{\large Carter 91}\\
		{\large 38081, SaiGon, Guangdong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Damian Amy  Abrahamsson Pte Ltd } \\
		{\large Silas 32}\\
		{\large 89732, Tokyo, Guangdong, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
