...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luis Kate 	 Lindgren} \\
		{\large Quinn 10}\\
		{\large 66599, Frankfurt am Main , Seattles, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maria  Alexander  Löfgren Corp } \\
		{\large Ayden 97}\\
		{\large 18417, SaiGon, California, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
