...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cooper Marie 	 Lindgren Corp} \\
		{\large Alexa 89}\\
		{\large 40995, Istanbul, Phu Yen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mckenzie Bergström } \\
		{\large Jaxson 53}\\
		{\large 92041, Frankfurt am Main , Guangdong, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
