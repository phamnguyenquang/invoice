...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Malachi Kate 	 Pålsson} \\
		{\large Jade 61}\\
		{\large 68917, Venice, Bayern, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore Catherine  Mårtensson Pte Ltd } \\
		{\large Ryan 57}\\
		{\large 99089, Washington, Huabei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
