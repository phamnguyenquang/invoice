...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall Peter Andersson Pte Ltd} \\
		{\large Santiago 19}\\
		{\large 51143, Last Vegas, Chiang Rai, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harmony Mårtensson } \\
		{\large Brandon 70}\\
		{\large 88208, Taipei, Bangkok, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
