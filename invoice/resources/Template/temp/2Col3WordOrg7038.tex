...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elise Ann  Andersson Pte Ltd} \\
		{\large Brooklynn 51}\\
		{\large 14442, Frankfurt am Main , Hawaii, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ava Mårtensson } \\
		{\large Elias 38}\\
		{\large 32970, Last Vegas, California, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
