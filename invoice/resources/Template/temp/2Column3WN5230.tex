...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Steven Lee  Lind} \\
		{\large Gavin 69}\\
		{\large 31340, Frankfurt am Main , Henan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caden  Alexander  Henriksson Pte Ltd } \\
		{\large Stephanie 38}\\
		{\large 71337, Budapest, Bangkok, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
