...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Landon  Alexander  Magnusson} \\
		{\large Rylee 57}\\
		{\large 35380, Barcelona, Buriam, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Athena Ann  Abrahamsson Pte Ltd } \\
		{\large Faith 29}\\
		{\large 60184, Sydney, Guangzhou, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
