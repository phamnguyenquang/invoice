...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dominic Marie 	 Axelsson Ltd} \\
		{\large Juliana 83}\\
		{\large 55362, Frankfurt am Main , Heibei, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Annabelle Lundin } \\
		{\large Allison 22}\\
		{\large 18634, Melbourne, Kentucky, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
