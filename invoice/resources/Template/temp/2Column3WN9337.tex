...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Athena Kate 	 Lindström} \\
		{\large Grant 81}\\
		{\large 31665, Budapest, khanh Hoa, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryleigh Elizabeth 	 Berglund Corp } \\
		{\large Hannah 53}\\
		{\large 58651, Florence, Guangdong, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
