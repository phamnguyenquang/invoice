...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alana Mary 	 Samuelsson} \\
		{\large Alexander 62}\\
		{\large 17892, San Francisco, khanh Hoa, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Landon Michael Nilsson Inc } \\
		{\large Cameron 28}\\
		{\large 84212, Frankfurt am Main , Kentucky, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
