...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elijah Pettersson} \\
		{\large Roman 17}\\
		{\large 41605, Ho Chi Minh, Tuscany, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maddox Victoria Samuelsson Pte Ltd } \\
		{\large Melanie 55}\\
		{\large 95412, New York , Tuscany, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
