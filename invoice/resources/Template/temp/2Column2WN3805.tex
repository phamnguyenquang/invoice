...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Eliasson} \\
		{\large Asher 55}\\
		{\large 56525, Singapore, Saarland, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everett Jane Andreasson Corp } \\
		{\large Vivian 38}\\
		{\large 26440, Frankfurt am Main , Saarland, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
