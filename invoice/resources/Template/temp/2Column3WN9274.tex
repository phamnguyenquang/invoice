...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caden Mary 	 Viklund} \\
		{\large Rose 10}\\
		{\large 27486, Berlin, Amnat Charoen, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michelle Ann  Ahmed Pte Ltd } \\
		{\large Jonathan 6}\\
		{\large 51557, Frankfurt am Main , Huabei, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
