...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everett Jane Berg} \\
		{\large Ariel 13}\\
		{\large 57698, Abu Dhabi, Chai Nat, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklynn Catherine  Lindholm Ltd } \\
		{\large Destiny 99}\\
		{\large 97785, Frankfurt am Main , khanh Hoa, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
