...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kenneth  Alexander  Håkansson Ltd} \\
		{\large Kai 15}\\
		{\large 18051, Hong Kong, Guangdong, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elizabeth Abrahamsson } \\
		{\large Abigail 55}\\
		{\large 16288, Vienna, Texas, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
