...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryan Kate 	 Lundqvist} \\
		{\large Joseph 2}\\
		{\large 87618, Melbourne, khanh Hoa, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gianna Grace 	 Eriksson Pte Ltd } \\
		{\large Preston 98}\\
		{\large 54725, Berlin, Chai Nat, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
