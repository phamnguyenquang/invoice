...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aria Marie 	 Engström Pte Ltd} \\
		{\large Colin 4}\\
		{\large 86221, Frankfurt am Main , Chai Nat, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grayson Hansson } \\
		{\large Olivia 22}\\
		{\large 86597, Boston, Kentucky, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
