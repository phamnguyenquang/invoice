...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madelyn Catherine  Mohamed} \\
		{\large Cole 3}\\
		{\large 19093, Sydney, Chai Nat, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Autumn Michael Viklund Ltd } \\
		{\large Aubree 61}\\
		{\large 45359, Seoul, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
