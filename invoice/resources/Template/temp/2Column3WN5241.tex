...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adam Peter Hansson} \\
		{\large Gabriella 96}\\
		{\large 87862, Berlin, Hamburg, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josephine Elizabeth 	 Bergqvist Corp } \\
		{\large Sydney 14}\\
		{\large 23442, Berlin, California, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
