...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stephanie Eriksson} \\
		{\large Hazel 67}\\
		{\large 46321, Florence, Saarland, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicole Lee  Lindqvist Corp } \\
		{\large Emily 55}\\
		{\large 99442, Abu Dhabi, Amnat Charoen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
