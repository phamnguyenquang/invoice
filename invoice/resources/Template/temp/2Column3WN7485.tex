...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly Rose 	 Abrahamsson} \\
		{\large Ashton 89}\\
		{\large 59447, Venice, Chai Nat, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Marcus  Alexander  Andersson Pte Ltd } \\
		{\large Wyatt 80}\\
		{\large 29498, Berlin, Binh Thuan, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
