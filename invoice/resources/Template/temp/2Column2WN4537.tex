...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Marcus Sjögren} \\
		{\large Alaina 34}\\
		{\large 49999, Sydney, Huabei, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Serenity Elizabeth 	 Björklund Pte Ltd } \\
		{\large Mckenzie 4}\\
		{\large 98937, Los Angeles, Floria, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
