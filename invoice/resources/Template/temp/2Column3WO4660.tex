...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Edward Catherine  Andreasson Pte Ltd} \\
		{\large Thomas 1}\\
		{\large 48772, Venice, Henan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Serenity Gunnarsson } \\
		{\large Abel 79}\\
		{\large 39176, Taipei, Kentucky, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
