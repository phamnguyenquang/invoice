...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of North Carolina at Chapel Hill} \\
		{\large Valentina 51}\\
		{\large 19220, Frankfurt am Main , Tuscany, ThaiLand}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Hazel Norberg } \\
		{\large Paige 22}\\
		{\large 66397, Minsk, Tuscany, South Korea}\\
    \switchcolumn
