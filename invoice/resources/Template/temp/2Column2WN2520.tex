...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grace Berggren} \\
		{\large Abigail 80}\\
		{\large 93557, Washington, Guangzhou, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bradley Christopher Berglund Pte Ltd } \\
		{\large Cayden 23}\\
		{\large 12417, Frankfurt am Main , Ang Thong, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
