...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Landon Grace 	 Hansson} \\
		{\large Calvin 99}\\
		{\large 85972, Chicago, Kentucky, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ximena Victoria Dahlberg Pte Ltd } \\
		{\large Jayla 36}\\
		{\large 20453, Abu Dhabi, Kentucky, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
