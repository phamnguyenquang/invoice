...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julianna Thomas Olsson Ltd} \\
		{\large Jake 21}\\
		{\large 95645, Frankfurt am Main , Bangkok, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ella Bengtsson } \\
		{\large Aria 2}\\
		{\large 43060, Hong Kong, Binh Thuan, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
