...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxson James Ahmed} \\
		{\large Kylie 57}\\
		{\large 44731, Budapest, Chai Nat, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Savannah  Alexander  Mårtensson Pte Ltd } \\
		{\large Madelyn 19}\\
		{\large 29143, Vancouver, Saarland, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
