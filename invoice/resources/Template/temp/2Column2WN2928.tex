...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaitlyn Sundberg} \\
		{\large Liam 30}\\
		{\large 95889, Dubai, Amnat Charoen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large George Elizabeth 	 Håkansson Ltd } \\
		{\large Aria 40}\\
		{\large 38213, Los Angeles, Guangdong, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
