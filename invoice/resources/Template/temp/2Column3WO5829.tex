...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte William Holmberg Pte Ltd} \\
		{\large Amelia 31}\\
		{\large 76890, Ho Chi Minh, Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Claire Åkesson } \\
		{\large Gael 83}\\
		{\large 10008, Lisbon, Saarland, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
