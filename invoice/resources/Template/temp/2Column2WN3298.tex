...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cayden Lundberg} \\
		{\large Taylor 16}\\
		{\large 38814, Stuttgart, Amnat Charoen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Robert May/Mae 	 Jonsson Inc } \\
		{\large Paige 11}\\
		{\large 23311, Melbourne, Ang Thong, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
