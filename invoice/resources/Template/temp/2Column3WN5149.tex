...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melanie Elizabeth 	 Nordström} \\
		{\large Arianna 52}\\
		{\large 96045, Minsk, Guangdong, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madison Christopher Andersson Pte Ltd } \\
		{\large Eden 82}\\
		{\large 76952, Milan, Bangkok, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
