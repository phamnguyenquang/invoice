...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Payton Michael Strömberg Pte Ltd} \\
		{\large Rose 78}\\
		{\large 79660, Stuttgart, Amnat Charoen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paige Lundström } \\
		{\large Juan 73}\\
		{\large 36219, Nha Trang, California, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
