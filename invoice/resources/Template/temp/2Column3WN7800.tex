...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Morgan Michael Andreasson} \\
		{\large Rebecca 3}\\
		{\large 52788, Chicago, Chiang Rai, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rachel William Lundgren Pte Ltd } \\
		{\large Cameron 68}\\
		{\large 43882, Chicago, Indiana, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
