...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cameron Louise 	 Öberg} \\
		{\large Calvin 27}\\
		{\large 49610, New York , Ang Thong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Easton Elizabeth 	 Henriksson Ltd } \\
		{\large Emmett 87}\\
		{\large 62322, Chicago, khanh Hoa, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
