...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Morgan Louise 	 Henriksson} \\
		{\large Maddox 62}\\
		{\large 46149, Barcelona, Guangzhou, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large David Elizabeth 	 Mattsson Pte Ltd } \\
		{\large Adalynn 61}\\
		{\large 12471, Osaka, California, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
