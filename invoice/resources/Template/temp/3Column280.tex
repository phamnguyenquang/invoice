...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Polytechnic University of Bucharest} \\
		{\large Zachary 7}\\
		{\large 53430, Last Vegas, Kentucky, Cambodia}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Emilia Mohamed } \\
		{\large Jordyn 41}\\
		{\large 15859, Bonn, Kentucky, United State }\\
    \switchcolumn
