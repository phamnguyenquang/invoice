...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aurora Peter Lundgren Corp} \\
		{\large Christopher 96}\\
		{\large 75824, Ho Chi Minh, Henan, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn Olsson } \\
		{\large Charles 25}\\
		{\large 89548, Vancouver, Saarland, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
