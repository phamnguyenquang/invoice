...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicolas David Lundström} \\
		{\large Andrea 8}\\
		{\large 71615, Beijing, California, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nolan Christopher Jakobsson Pte Ltd } \\
		{\large Landon 21}\\
		{\large 86335, Montreal, Hawaii, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
