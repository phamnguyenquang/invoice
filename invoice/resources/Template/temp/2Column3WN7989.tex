...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Naomi Thomas Hellström} \\
		{\large Aaliyah 65}\\
		{\large 59954, Vienna, Hessen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Axel Louise 	 Jonsson Inc } \\
		{\large Emily 93}\\
		{\large 96920, Ho Chi Minh, Huabei, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
