...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sawyer Jakobsson} \\
		{\large Joel 66}\\
		{\large 94521, San Francisco, Hessen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eliana  Alexander  Karlsson Ltd } \\
		{\large Elias 94}\\
		{\large 43551, Ho Chi Minh, Hessen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
