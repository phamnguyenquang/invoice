...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carson James Lundin Pte Ltd} \\
		{\large Chase 52}\\
		{\large 85081, Los Angeles, Heibei, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalie Berglund } \\
		{\large Kennedy 10}\\
		{\large 67960, Frankfurt am Main , California, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
