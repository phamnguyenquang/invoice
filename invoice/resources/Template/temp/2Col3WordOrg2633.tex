...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emma Amy  Holmgren Pte Ltd} \\
		{\large Harper 61}\\
		{\large 71385, Frankfurt am Main , Huabei, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brayden Hellström } \\
		{\large Michelle 16}\\
		{\large 74744, London , Chai Nat, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
