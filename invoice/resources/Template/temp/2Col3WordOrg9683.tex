...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxson Jane Sandström Pte Ltd} \\
		{\large Maddox 77}\\
		{\large 56845, Frankfurt am Main , Hessen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte Gustafsson } \\
		{\large Londyn 55}\\
		{\large 20543, Vancouver, Heibei, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
