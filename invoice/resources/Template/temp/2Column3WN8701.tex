...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Blake Christopher Löfgren} \\
		{\large Elise 27}\\
		{\large 25109, Taipei, Tuscany, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson William Eriksson Inc } \\
		{\large Lydia 5}\\
		{\large 12182, Stuttgart, Chai Nat, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
