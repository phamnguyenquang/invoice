...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cooper Mary 	 Sundberg} \\
		{\large Gael 81}\\
		{\large 72824, San Francisco, Heibei, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesus  Alexander  Sundberg Corp } \\
		{\large Brianna 2}\\
		{\large 24968, Munich, Guangzhou, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
