...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope Catherine  Svensson Ltd} \\
		{\large Valentina 54}\\
		{\large 21597, Vancouver, Bangkok, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michelle Viklund } \\
		{\large Annabelle 82}\\
		{\large 50083, San Francisco, Hamburg, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
