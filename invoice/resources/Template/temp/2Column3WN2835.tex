...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrew Rose 	 Gunnarsson} \\
		{\large Sawyer 77}\\
		{\large 13686, Ho Chi Minh, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camden David Mårtensson Pte Ltd } \\
		{\large Autumn 35}\\
		{\large 97754, Sydney, Hamburg, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
