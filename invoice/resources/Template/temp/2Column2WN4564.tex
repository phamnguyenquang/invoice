...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra Samuelsson} \\
		{\large Kaiden 35}\\
		{\large 92574, Melbourne, Hamburg, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valentina Rose 	 Björklund Ltd } \\
		{\large Carter 43}\\
		{\large 32630, Tokyo, California, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
