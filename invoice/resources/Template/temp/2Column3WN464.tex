...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Trinity Robert Löfgren} \\
		{\large Molly 78}\\
		{\large 73999, Frankfurt am Main , Amnat Charoen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden Rose 	 Lindholm Corp } \\
		{\large Leah 13}\\
		{\large 30120, New York , Huabei, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
