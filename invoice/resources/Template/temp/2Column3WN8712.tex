...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harper Christopher Öberg} \\
		{\large Claire 55}\\
		{\large 96775, Washington, Seattles, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ximena John Nyberg Ltd } \\
		{\large Kevin 62}\\
		{\large 17876, Stuttgart, Bremen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
