...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Thomas Abrahamsson Pte Ltd} \\
		{\large Alana 20}\\
		{\large 81772, Chicago, California, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cooper Lindberg } \\
		{\large Kylie 68}\\
		{\large 80637, Barcelona, Amnat Charoen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
