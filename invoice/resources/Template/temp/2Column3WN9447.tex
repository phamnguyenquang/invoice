...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Grace 	 Nilsson} \\
		{\large Madison 3}\\
		{\large 97769, San Francisco, Texas, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lila Elizabeth 	 Söderberg Corp } \\
		{\large Emmanuel 49}\\
		{\large 94356, Washington, Guangdong, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
