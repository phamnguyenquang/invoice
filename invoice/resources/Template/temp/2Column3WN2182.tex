...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abel Louise 	 Svensson} \\
		{\large Lilly 30}\\
		{\large 51775, Seoul, Phu Yen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jade Amy  Forsberg Pte Ltd } \\
		{\large Mckenzie 12}\\
		{\large 28295, Nha Trang, Amnat Charoen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
