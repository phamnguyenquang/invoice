...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jennifer Grace 	 Strömberg} \\
		{\large Melody 60}\\
		{\large 75897, Washington, Hamburg, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harmony Michael Johansson Corp } \\
		{\large Luis 94}\\
		{\large 81050, London , Chiang Mai, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
