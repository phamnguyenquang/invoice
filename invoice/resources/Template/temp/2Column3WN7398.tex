...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gracie Grace 	 Hassan} \\
		{\large Ashley 77}\\
		{\large 54752, Stuttgart, Saarland, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Elizabeth 	 Håkansson Ltd } \\
		{\large Eric 30}\\
		{\large 38908, Dubai, Chiang Rai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
