...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victoria David Åkesson} \\
		{\large George 73}\\
		{\large 14515, Vienna, Hamburg, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angelina Christopher Mattsson Inc } \\
		{\large Angel 59}\\
		{\large 39338, San Francisco, Saarland, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
