...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kenneth William Martinsson Inc} \\
		{\large Noah 81}\\
		{\large 65517, Budapest, Ang Thong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michael Lindström } \\
		{\large Alexandra 15}\\
		{\large 47829, Istanbul, Binh Thuan, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
