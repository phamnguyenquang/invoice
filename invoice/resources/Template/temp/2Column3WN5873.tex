...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezra Christopher Lindholm} \\
		{\large Daniel 87}\\
		{\large 75162, Nha Trang, Floria, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elena Christopher Dahlberg Ltd } \\
		{\large Christopher 53}\\
		{\large 54342, Stuttgart, Floria, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
