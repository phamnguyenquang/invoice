...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooke Rose 	 Persson} \\
		{\large Elizabeth 47}\\
		{\large 74983, New York , Binh Thuan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bella Anne Ahmed Pte Ltd } \\
		{\large Everett 91}\\
		{\large 37259, Last Vegas, Huabei, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
