...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Easton Peter Mårtensson} \\
		{\large Willow 71}\\
		{\large 78415, Stuttgart, Amnat Charoen, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexis William Lundberg Pte Ltd } \\
		{\large Daisy 56}\\
		{\large 15827, Amsterdam, Guangdong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
