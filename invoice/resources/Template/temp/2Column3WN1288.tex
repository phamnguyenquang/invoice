...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liam Victoria Viklund} \\
		{\large Grant 16}\\
		{\large 79983, Florence, Floria, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alaina May/Mae 	 Andreasson Ltd } \\
		{\large Oscar 25}\\
		{\large 51801, Shanghai, Binh Thuan, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
