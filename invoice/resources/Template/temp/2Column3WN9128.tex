...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Arianna James Strömberg} \\
		{\large Miguel 47}\\
		{\large 19976, Vancouver, Hamburg, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samuel David Martinsson Ltd } \\
		{\large Tucker 63}\\
		{\large 86344, New York , Tuscany, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
