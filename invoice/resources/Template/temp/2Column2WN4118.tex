...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremy Andreasson} \\
		{\large Lila 70}\\
		{\large 14621, San Francisco, Buriam, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sofia Elizabeth 	 Fransson Pte Ltd } \\
		{\large Joel 24}\\
		{\large 29708, Abu Dhabi, Texas, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
