...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jack Louise 	 Ek} \\
		{\large Destiny 91}\\
		{\large 42971, Frankfurt am Main , Hamburg, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kingston Michael Norberg Ltd } \\
		{\large Aubree 8}\\
		{\large 99227, Last Vegas, khanh Hoa, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
