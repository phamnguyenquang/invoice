...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jordan Christopher Sundberg Corp} \\
		{\large Kayden 53}\\
		{\large 55009, Frankfurt am Main , Kentucky, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camila Mårtensson } \\
		{\large Kayden 57}\\
		{\large 10626, Abu Dhabi, Texas, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
