...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katelyn Edward Nilsson} \\
		{\large Michael 21}\\
		{\large 65049, Hong Kong, Hawaii, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryan Robert Björklund Corp } \\
		{\large Jack 88}\\
		{\large 10210, Dubai, Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
