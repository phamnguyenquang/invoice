...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nora David Abrahamsson} \\
		{\large Makenzie 62}\\
		{\large 11830, Frankfurt am Main , Guangzhou, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anna Edward Wallin Pte Ltd } \\
		{\large Sydney 80}\\
		{\large 39379, London , California, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
