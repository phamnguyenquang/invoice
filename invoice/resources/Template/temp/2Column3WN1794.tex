...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaliyah Mary 	 Larsson} \\
		{\large Adam 53}\\
		{\large 64893, Singapore, Tuscany, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariel William Axelsson Ltd } \\
		{\large Kendall 51}\\
		{\large 99407, Singapore, Ang Thong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
