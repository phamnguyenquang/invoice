...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liam Louise 	 Danielsson} \\
		{\large Mya 44}\\
		{\large 36146, Moscow, Amnat Charoen, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reagan May/Mae 	 Pålsson Pte Ltd } \\
		{\large Anthony 13}\\
		{\large 12382, Stuttgart, Seattles, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
