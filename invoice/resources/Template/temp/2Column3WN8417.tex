...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryson Mary 	 Jansson} \\
		{\large Kayden 67}\\
		{\large 92162, Lisbon, Amnat Charoen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kai Ann  Hassan Ltd } \\
		{\large Nathaniel 62}\\
		{\large 11136, Frankfurt am Main , Amnat Charoen, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
