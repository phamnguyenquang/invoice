...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jocelyn  Alexander  Isaksson} \\
		{\large Jonah 13}\\
		{\large 21622, Montreal, Huabei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adeline Victoria Arvidsson Pte Ltd } \\
		{\large Emmett 87}\\
		{\large 17515, Frankfurt am Main , Kentucky, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
