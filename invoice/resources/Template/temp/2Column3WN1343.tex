...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon Catherine  Arvidsson} \\
		{\large Daniel 46}\\
		{\large 92647, Last Vegas, Hessen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Victor Jane Nordström Ltd } \\
		{\large Rachel 20}\\
		{\large 92057, Frankfurt am Main , Saarland, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
