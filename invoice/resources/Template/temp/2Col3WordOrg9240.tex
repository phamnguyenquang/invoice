...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luna Christopher Lindqvist Corp} \\
		{\large Lincoln 3}\\
		{\large 64340, Los Angeles, Amnat Charoen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Genesis Bergström } \\
		{\large Cooper 89}\\
		{\large 62348, Denver, Tuscany, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
