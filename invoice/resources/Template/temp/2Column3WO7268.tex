...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hayden Louise 	 Hansson Ltd} \\
		{\large Alexandra 66}\\
		{\large 43513, Abu Dhabi, khanh Hoa, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaron Ekström } \\
		{\large Vanessa 30}\\
		{\large 43711, Frankfurt am Main , Kentucky, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
