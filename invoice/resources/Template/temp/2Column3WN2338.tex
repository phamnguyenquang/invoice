...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elias Elizabeth 	 Blom} \\
		{\large Catherine 72}\\
		{\large 53266, Hong Kong, Chai Nat, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anthony Mary 	 Fredriksson Inc } \\
		{\large Naomi 79}\\
		{\large 24939, New York , Hamburg, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
