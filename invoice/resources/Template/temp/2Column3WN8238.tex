...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Thomas Ann  Lundgren} \\
		{\large Naomi 36}\\
		{\large 30006, New York , Chiang Mai, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alejandro Christopher Bergqvist Corp } \\
		{\large Ryker 32}\\
		{\large 95616, New York , Chiang Rai, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
