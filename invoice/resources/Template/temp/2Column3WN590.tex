...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aiden William Holmberg} \\
		{\large Leo 36}\\
		{\large 67569, Osaka, Binh Thuan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hunter Mary 	 Claesson Inc } \\
		{\large Jesus 3}\\
		{\large 22673, Frankfurt am Main , Huabei, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
