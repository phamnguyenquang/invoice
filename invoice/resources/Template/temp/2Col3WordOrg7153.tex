...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emily Christopher Mattsson Pte Ltd} \\
		{\large Diego 61}\\
		{\large 13411, Los Angeles, Chiang Mai, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalyn Sjöberg } \\
		{\large Ryan 21}\\
		{\large 44306, Stuttgart, Guangzhou, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
