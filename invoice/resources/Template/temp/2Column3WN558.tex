...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Faith Lee  Wallin} \\
		{\large Bentley 8}\\
		{\large 42075, Melbourne, Bangkok, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harrison Victoria Abrahamsson Ltd } \\
		{\large Max 31}\\
		{\large 59507, Toronto, Binh Thuan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
