...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaitlyn  Alexander  Andreasson} \\
		{\large Liam 37}\\
		{\large 89349, Last Vegas, Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery William Lindberg Pte Ltd } \\
		{\large Ashley 62}\\
		{\large 83842, Hanoi, Bangkok, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
