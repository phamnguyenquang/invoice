...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremiah Lundström} \\
		{\large Gabrielle 1}\\
		{\large 48302, Shanghai, Chiang Rai, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte Michael Lindberg Ltd } \\
		{\large Sebastian 29}\\
		{\large 39544, Montreal, Binh Thuan, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
