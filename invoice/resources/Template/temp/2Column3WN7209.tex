...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Willow Grace 	 Jakobsson} \\
		{\large Aubree 52}\\
		{\large 54561, Vancouver, Seattles, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ivan Rose 	 Berglund Ltd } \\
		{\large Mateo 50}\\
		{\large 30217, Stuttgart, Buriam, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
