...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryson Christopher Mattsson Ltd} \\
		{\large Sophia 9}\\
		{\large 42181, Shanghai, khanh Hoa, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brayden Lundqvist } \\
		{\large Skylar 5}\\
		{\large 37060, Frankfurt am Main , Hessen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
