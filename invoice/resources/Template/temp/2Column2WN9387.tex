...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madison Johansson} \\
		{\large Ayden 81}\\
		{\large 95324, Frankfurt am Main , Hessen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madelyn Edward Berg Corp } \\
		{\large Brianna 93}\\
		{\large 53815, Frankfurt am Main , Bayern, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
