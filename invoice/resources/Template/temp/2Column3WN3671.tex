...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher John Lundqvist} \\
		{\large Brody 64}\\
		{\large 64494, Florence, Amnat Charoen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wyatt Victoria Bergström Inc } \\
		{\large Luca 54}\\
		{\large 40083, London , Kentucky, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
