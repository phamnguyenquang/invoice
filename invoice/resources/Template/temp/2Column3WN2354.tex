...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harrison Kate 	 Sandberg} \\
		{\large Ruby 80}\\
		{\large 30955, Munich, Henan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kinsley Victoria Johansson Pte Ltd } \\
		{\large Braxton 97}\\
		{\large 10387, Istanbul, Saarland, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
