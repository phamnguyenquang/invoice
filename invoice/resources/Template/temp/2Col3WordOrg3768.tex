...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Anna Elizabeth 	 Hermansson Inc} \\
		{\large Grace 37}\\
		{\large 28680, Frankfurt am Main , Bayern, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Quinn Lundgren } \\
		{\large Kaiden 9}\\
		{\large 10863, Tokyo, Bayern, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
