...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brianna Marie 	 Martinsson} \\
		{\large Alan 31}\\
		{\large 80999, Munich, Guangzhou, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaiden Christopher Hermansson Corp } \\
		{\large Alejandro 42}\\
		{\large 77773, Amsterdam, Buriam, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
