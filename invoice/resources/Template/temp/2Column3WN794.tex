...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Evelyn Grace 	 Holmgren} \\
		{\large Connor 16}\\
		{\large 34238, Montreal, khanh Hoa, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Faith James Danielsson Pte Ltd } \\
		{\large Jordyn 77}\\
		{\large 81519, Venice, Saarland, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
