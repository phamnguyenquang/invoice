...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madelyn Elizabeth 	 Björklund} \\
		{\large Athena 19}\\
		{\large 36508, Melbourne, Chai Nat, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Damian Kate 	 Lindgren Ltd } \\
		{\large Camden 2}\\
		{\large 45781, Lisbon, Saarland, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
