...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel Louise 	 Lundberg} \\
		{\large Tucker 94}\\
		{\large 71310, SaiGon, Chiang Rai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ellie James Gunnarsson Inc } \\
		{\large Piper 40}\\
		{\large 41380, Denver, Phu Yen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
