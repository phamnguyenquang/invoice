...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte Michael Henriksson Ltd} \\
		{\large Cameron 25}\\
		{\large 71456, Chicago, Floria, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carter Gunnarsson } \\
		{\large Jesus 74}\\
		{\large 77424, Abu Dhabi, Guangdong, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
