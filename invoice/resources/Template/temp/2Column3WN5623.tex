...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayden Kate 	 Danielsson} \\
		{\large Alex 7}\\
		{\large 54285, Nha Trang, khanh Hoa, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kinsley James Claesson Ltd } \\
		{\large Ashley 9}\\
		{\large 71374, Dubai, Heibei, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
