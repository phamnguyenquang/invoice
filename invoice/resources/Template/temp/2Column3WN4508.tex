...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jameson Louise 	 Lundberg} \\
		{\large Luna 32}\\
		{\large 75169, Lisbon, Bangkok, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jake James Danielsson Pte Ltd } \\
		{\large Joel 33}\\
		{\large 26641, Last Vegas, Hainan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
