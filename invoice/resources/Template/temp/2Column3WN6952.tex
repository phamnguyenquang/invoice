...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Destiny Robert Hellström} \\
		{\large Valerie 22}\\
		{\large 22968, Toronto, Seattles, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hadley Michael Olofsson Pte Ltd } \\
		{\large Daniel 41}\\
		{\large 75361, Hong Kong, Amnat Charoen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
