...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emery Michael Bergqvist} \\
		{\large Naomi 62}\\
		{\large 63436, Osaka, Chai Nat, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Catherine  Forsberg Ltd } \\
		{\large Jaxon 79}\\
		{\large 34374, London , Guangdong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
