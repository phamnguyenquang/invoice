...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabella Christopher Bergqvist} \\
		{\large Joseph 98}\\
		{\large 33646, Stuttgart, Phu Yen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kevin Edward Hansen Ltd } \\
		{\large Mateo 92}\\
		{\large 79014, Amsterdam, Amnat Charoen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
