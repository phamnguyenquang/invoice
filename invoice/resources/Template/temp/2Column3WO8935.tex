...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriella Ann  Gunnarsson Inc} \\
		{\large Eva 75}\\
		{\large 93601, Chicago, Hamburg, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooke Engström } \\
		{\large Christopher 81}\\
		{\large 73633, SaiGon, Buriam, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
