...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle Thomas Lindholm} \\
		{\large Jayla 50}\\
		{\large 16414, Singapore, Ang Thong, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Patrick William Fredriksson Inc } \\
		{\large Jeremy 32}\\
		{\large 17639, Denver, Chiang Rai, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
