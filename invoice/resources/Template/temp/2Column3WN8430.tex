...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicolas Lee  Bergqvist} \\
		{\large Aria 75}\\
		{\large 41322, Melbourne, Huabei, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hudson Michael Berglund Pte Ltd } \\
		{\large Henry 9}\\
		{\large 61739, Stuttgart, Saarland, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
