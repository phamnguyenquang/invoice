...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julianna May/Mae 	 Nordström Corp} \\
		{\large Logan 13}\\
		{\large 28426, Stuttgart, Henan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Blake Mohamed } \\
		{\large Antonio 8}\\
		{\large 55311, Venice, Amnat Charoen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
