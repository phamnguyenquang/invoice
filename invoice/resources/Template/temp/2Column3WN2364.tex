...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emily Grace 	 Engström} \\
		{\large Damian 63}\\
		{\large 54253, Washington, Indiana, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anthony Kate 	 Lindström Inc } \\
		{\large Ariana 94}\\
		{\large 13389, Frankfurt am Main , Seattles, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
