...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bailey David Sandström Ltd} \\
		{\large Jayden 32}\\
		{\large 36791, Seoul, Floria, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte Mattsson } \\
		{\large Nathaniel 75}\\
		{\large 11256, Frankfurt am Main , Saarland, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
