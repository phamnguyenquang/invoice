...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elijah May/Mae 	 Björklund} \\
		{\large Sebastian 35}\\
		{\large 37304, Singapore, Bangkok, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melody William Andersson Pte Ltd } \\
		{\large Adeline 44}\\
		{\large 38026, Frankfurt am Main , Guangzhou, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
