...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesse Marie 	 Söderberg} \\
		{\large Colin 88}\\
		{\large 84211, Barcelona, Chiang Rai, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Delilah Marie 	 Sjögren Pte Ltd } \\
		{\large Elizabeth 69}\\
		{\large 45638, Venice, Chiang Mai, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
