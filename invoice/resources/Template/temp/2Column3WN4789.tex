...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cameron  Alexander  Holmgren} \\
		{\large Serenity 81}\\
		{\large 43865, Lisbon, Floria, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Annabelle Catherine  Wikström Ltd } \\
		{\large Claire 70}\\
		{\large 89082, Los Angeles, Guangdong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
