...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brian Victoria Bergqvist} \\
		{\large Aubrey 5}\\
		{\large 89147, Hong Kong, Guangdong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cameron Michael Wikström Pte Ltd } \\
		{\large Savannah 32}\\
		{\large 70024, Minsk, Guangzhou, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
