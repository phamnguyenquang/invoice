...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maverick Peter Axelsson Corp} \\
		{\large Jeremy 24}\\
		{\large 65263, Beijing, Bayern, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vincent Lindberg } \\
		{\large Ryan 6}\\
		{\large 29915, Amsterdam, California, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
