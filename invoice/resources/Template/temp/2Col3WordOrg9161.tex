...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emery Mary 	 Mårtensson Ltd} \\
		{\large Nora 43}\\
		{\large 97234, Ho Chi Minh, Chiang Rai, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremiah Gustafsson } \\
		{\large Valerie 45}\\
		{\large 79774, Istanbul, Chiang Mai, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
