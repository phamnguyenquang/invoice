...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Clara Louise 	 Eriksson} \\
		{\large Cole 72}\\
		{\large 62510, Washington, California, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrea Christopher Nordström Pte Ltd } \\
		{\large Margaret 42}\\
		{\large 92522, SaiGon, Bayern, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
