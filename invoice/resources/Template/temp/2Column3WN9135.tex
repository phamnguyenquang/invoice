...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kayla Victoria Magnusson} \\
		{\large Harper 68}\\
		{\large 41705, Washington, Chai Nat, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Calvin Thomas Eriksson Pte Ltd } \\
		{\large Natalia 44}\\
		{\large 45727, Stuttgart, Guangdong, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
