...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie Ann  Forsberg} \\
		{\large Bentley 76}\\
		{\large 76221, Los Angeles, Guangdong, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryson Elizabeth 	 Öberg Ltd } \\
		{\large Kaylee 98}\\
		{\large 77770, Abu Dhabi, Chai Nat, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
