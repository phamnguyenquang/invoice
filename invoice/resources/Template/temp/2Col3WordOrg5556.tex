...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezekiel Elizabeth 	 Axelsson Inc} \\
		{\large Elena 47}\\
		{\large 74966, Ho Chi Minh, Phu Yen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte Nilsson } \\
		{\large Jose 84}\\
		{\large 34484, Washington, Amnat Charoen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
