...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Payton Grace 	 Larsson Pte Ltd} \\
		{\large Faith 10}\\
		{\large 12978, Boston, Ang Thong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jason Hermansson } \\
		{\large Brooklyn 13}\\
		{\large 62591, Frankfurt am Main , Guangdong, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
