...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alyssa Anne Samuelsson} \\
		{\large Mason 52}\\
		{\large 94534, Frankfurt am Main , Guangzhou, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Athena  Alexander  Bergström Pte Ltd } \\
		{\large Mackenzie 77}\\
		{\large 75409, Madrid, Kentucky, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
