...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joshua May/Mae 	 Falk} \\
		{\large William 51}\\
		{\large 13646, Frankfurt am Main , California, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aidan Lee  Löfgren Inc } \\
		{\large Parker 32}\\
		{\large 46182, Toronto, Ang Thong, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
