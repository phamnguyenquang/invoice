...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abraham Elizabeth 	 Hellström} \\
		{\large Victoria 16}\\
		{\large 13011, Budapest, Bangkok, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore Grace 	 Dahl Pte Ltd } \\
		{\large Santiago 27}\\
		{\large 10834, Istanbul, California, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
