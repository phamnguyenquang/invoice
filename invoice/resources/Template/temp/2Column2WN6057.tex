...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Andreasson} \\
		{\large Alex 1}\\
		{\large 79661, Dublin, Guangdong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grace Christopher Ahmed Pte Ltd } \\
		{\large Catherine 83}\\
		{\large 86851, Los Angeles, Saarland, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
