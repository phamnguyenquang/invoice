...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valerie Louise 	 Lundberg} \\
		{\large Allison 77}\\
		{\large 45369, Last Vegas, Chai Nat, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella Michael Martinsson Inc } \\
		{\large Nicolas 36}\\
		{\large 19169, Barcelona, Huabei, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
