...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ivy Louise 	 Lundin} \\
		{\large Zoey 96}\\
		{\large 71176, San Francisco, Bayern, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lilly Edward Håkansson Pte Ltd } \\
		{\large Destiny 49}\\
		{\large 76011, Hanoi, khanh Hoa, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
