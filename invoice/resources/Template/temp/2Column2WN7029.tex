...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jasmine Blomqvist} \\
		{\large Autumn 10}\\
		{\large 83949, Moscow, Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angel William Martinsson Ltd } \\
		{\large Caleb 15}\\
		{\large 33587, Frankfurt am Main , Indiana, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
