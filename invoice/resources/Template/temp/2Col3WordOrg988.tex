...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bailey Christopher Lundin Pte Ltd} \\
		{\large Melody 91}\\
		{\large 16767, Frankfurt am Main , Huabei, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie Fredriksson } \\
		{\large Gianna 13}\\
		{\large 52171, Montreal, Texas, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
