...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaleb Anne Lindqvist Pte Ltd} \\
		{\large Roman 94}\\
		{\large 14887, Frankfurt am Main , Guangzhou, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vivian Öberg } \\
		{\large Noah 77}\\
		{\large 47438, Hong Kong, Amnat Charoen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
