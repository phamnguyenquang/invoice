...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emilia Sundberg} \\
		{\large Bryson 31}\\
		{\large 88008, Frankfurt am Main , Bayern, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn Christopher Hassan Ltd } \\
		{\large Kaitlyn 56}\\
		{\large 84367, Denver, Kentucky, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
