...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joseph May/Mae 	 Mårtensson} \\
		{\large Hadley 93}\\
		{\large 87454, Frankfurt am Main , Binh Thuan, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joseph Catherine  Dahl Pte Ltd } \\
		{\large Cooper 5}\\
		{\large 66472, San Francisco, Floria, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
