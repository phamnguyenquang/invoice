...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melody Bergström} \\
		{\large Alyssa 64}\\
		{\large 50256, London , California, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cameron Louise 	 Sjögren Inc } \\
		{\large Izabella 98}\\
		{\large 61390, San Francisco, Bangkok, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
