...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sarah Elizabeth 	 Holmberg} \\
		{\large Chase 84}\\
		{\large 31726, Melbourne, Floria, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalie Lee  Arvidsson Pte Ltd } \\
		{\large Jacob 62}\\
		{\large 96095, Frankfurt am Main , Heibei, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
