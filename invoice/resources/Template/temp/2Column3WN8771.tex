...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryan Grace 	 Nordin} \\
		{\large Axel 15}\\
		{\large 96862, San Francisco, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alan Thomas Pålsson Inc } \\
		{\large Miguel 22}\\
		{\large 26701, Ho Chi Minh, Texas, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
