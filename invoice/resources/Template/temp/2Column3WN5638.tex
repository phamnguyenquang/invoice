...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrea Robert Löfgren} \\
		{\large Brayden 6}\\
		{\large 47332, Barcelona, Tuscany, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexa William Fransson Corp } \\
		{\large Emery 39}\\
		{\large 37786, Paris, Amnat Charoen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
