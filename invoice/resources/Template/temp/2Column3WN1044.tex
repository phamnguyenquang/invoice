...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aiden Anne Viklund} \\
		{\large Luis 17}\\
		{\large 32502, Taipei, Ang Thong, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Izabella May/Mae 	 Jakobsson Corp } \\
		{\large Alice 24}\\
		{\large 59069, Frankfurt am Main , Hainan, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
