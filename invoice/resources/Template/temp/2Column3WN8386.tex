...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Destiny Louise 	 Lindgren} \\
		{\large Victoria 23}\\
		{\large 54236, Osaka, Indiana, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kevin Christopher Bengtsson Pte Ltd } \\
		{\large Jackson 87}\\
		{\large 37963, Melbourne, Buriam, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
