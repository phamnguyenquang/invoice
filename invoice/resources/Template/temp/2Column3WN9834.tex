...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leonardo John Jönsson} \\
		{\large Leilani 80}\\
		{\large 26311, Amsterdam, Seattles, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large William Catherine  Bengtsson Pte Ltd } \\
		{\large Ella 72}\\
		{\large 99886, Washington, Hessen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
