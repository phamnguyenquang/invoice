...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexis Amy  Hellström} \\
		{\large Everly 36}\\
		{\large 92531, London , Binh Thuan, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Giovanni  Alexander  Mohamed Ltd } \\
		{\large Piper 10}\\
		{\large 18489, Frankfurt am Main , Huabei, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
