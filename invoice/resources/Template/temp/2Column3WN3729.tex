...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Molly Marie 	 Sandberg} \\
		{\large Gabriel 5}\\
		{\large 30024, Tokyo, Chai Nat, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kendall Elizabeth 	 Åkesson Pte Ltd } \\
		{\large Nevaeh 90}\\
		{\large 89142, Venice, Chiang Mai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
