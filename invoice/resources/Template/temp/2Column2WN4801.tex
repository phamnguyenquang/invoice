...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christian Lundqvist} \\
		{\large Lila 57}\\
		{\large 93096, Ho Chi Minh, Chiang Mai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella John Norberg Inc } \\
		{\large Autumn 45}\\
		{\large 88452, Milan, Phu Yen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
