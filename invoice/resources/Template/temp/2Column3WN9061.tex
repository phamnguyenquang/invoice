...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emery Anne Lundström} \\
		{\large Lyla 81}\\
		{\large 21887, Nha Trang, Hessen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katherine Grace 	 Forsberg Pte Ltd } \\
		{\large Adam 19}\\
		{\large 77711, Budapest, Tuscany, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
