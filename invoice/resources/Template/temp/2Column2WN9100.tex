...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Izabella Lundström} \\
		{\large Ashton 80}\\
		{\large 53800, Ho Chi Minh, Texas, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ayden Elizabeth 	 Engström Pte Ltd } \\
		{\large Zoe 56}\\
		{\large 95009, Beijing, Chiang Rai, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
