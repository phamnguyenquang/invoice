...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon Michael Hassan} \\
		{\large Amy 31}\\
		{\large 70544, Berlin, Buriam, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan Amy  Sundberg Pte Ltd } \\
		{\large Luna 50}\\
		{\large 70549, Istanbul, Chiang Rai, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
