...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Axel Jane Månsson} \\
		{\large Mary 78}\\
		{\large 77564, London , khanh Hoa, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Richard Christopher Hermansson Corp } \\
		{\large Natalie 6}\\
		{\large 82040, Frankfurt am Main , Bangkok, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
