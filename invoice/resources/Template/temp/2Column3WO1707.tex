...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriel Peter Öberg Pte Ltd} \\
		{\large Lincoln 60}\\
		{\large 74899, Frankfurt am Main , khanh Hoa, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jace Sandberg } \\
		{\large Ashton 52}\\
		{\large 88663, Taipei, Chiang Rai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
