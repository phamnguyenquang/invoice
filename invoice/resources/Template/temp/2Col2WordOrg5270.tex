...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Evan Lindström Pte Ltd} \\
		{\large Piper 78}\\
		{\large 32191, Frankfurt am Main , California, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melody Sandström } \\
		{\large Adriana 28}\\
		{\large 24787, Frankfurt am Main , Heibei, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
