...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonathan Peter Fransson} \\
		{\large Micah 9}\\
		{\large 14198, Ho Chi Minh, Chiang Mai, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Justin John Eliasson Inc } \\
		{\large Elijah 66}\\
		{\large 70957, New York , Guangdong, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
