...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra  Alexander  Fredriksson} \\
		{\large Liliana 71}\\
		{\large 10465, Florence, Hamburg, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Clara Christopher Norberg Pte Ltd } \\
		{\large Ryder 9}\\
		{\large 13369, Istanbul, Huabei, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
