...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sofia  Alexander  Olofsson Ltd} \\
		{\large Isaac 40}\\
		{\large 81596, Last Vegas, Phu Yen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kinsley Gunnarsson } \\
		{\large William 61}\\
		{\large 38542, Barcelona, Bangkok, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
