...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Chloe Mary 	 Eklund Corp} \\
		{\large Ashton 32}\\
		{\large 76844, Budapest, Bremen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amir Jönsson } \\
		{\large Giovanni 20}\\
		{\large 97411, Frankfurt am Main , khanh Hoa, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
