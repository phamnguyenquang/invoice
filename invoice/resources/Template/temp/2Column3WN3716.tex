...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  John William Söderberg} \\
		{\large Julia 17}\\
		{\large 75627, Shanghai, Chiang Mai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabella Grace 	 Bergman Corp } \\
		{\large Alejandro 87}\\
		{\large 40404, Berlin, Chai Nat, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
