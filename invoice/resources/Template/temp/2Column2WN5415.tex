...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jack Söderberg} \\
		{\large Easton 13}\\
		{\large 14814, Frankfurt am Main , Bremen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harmony Michael Söderberg Pte Ltd } \\
		{\large Timothy 1}\\
		{\large 52188, New York , Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
