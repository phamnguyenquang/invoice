...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kayla Michael Hermansson Pte Ltd} \\
		{\large Juliana 18}\\
		{\large 65301, Frankfurt am Main , Chiang Mai, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalyn Blomqvist } \\
		{\large Ryan 16}\\
		{\large 67390, Los Angeles, Texas, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
