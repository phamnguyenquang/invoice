...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michelle Michael Dahlberg Pte Ltd} \\
		{\large Tristan 41}\\
		{\large 50234, Toronto, Guangzhou, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicole Olsson } \\
		{\large Adeline 34}\\
		{\large 25264, Frankfurt am Main , Guangdong, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
