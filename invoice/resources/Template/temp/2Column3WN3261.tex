...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly Christopher Olsson} \\
		{\large Julianna 6}\\
		{\large 11099, Denver, Henan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooke Jane Andreasson Pte Ltd } \\
		{\large Emmett 45}\\
		{\large 98130, Milan, khanh Hoa, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
