...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklyn May/Mae 	 Holmgren} \\
		{\large Rylee 93}\\
		{\large 41849, Los Angeles, khanh Hoa, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Allison Catherine  Lundqvist Corp } \\
		{\large Emilia 61}\\
		{\large 63196, San Francisco, khanh Hoa, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
