...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Wesley Elizabeth 	 Sjögren} \\
		{\large Aubrey 99}\\
		{\large 52280, Ho Chi Minh, Saarland, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lily Louise 	 Lund Ltd } \\
		{\large Scarlett 47}\\
		{\large 64949, Frankfurt am Main , Ang Thong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
