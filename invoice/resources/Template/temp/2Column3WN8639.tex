...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juliana Catherine  Bergström} \\
		{\large Joel 91}\\
		{\large 20695, Chicago, Bangkok, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jameson Michael Lindqvist Pte Ltd } \\
		{\large Eleanor 97}\\
		{\large 51600, Washington, Phu Yen, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
