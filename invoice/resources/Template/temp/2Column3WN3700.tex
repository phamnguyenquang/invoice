...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Scarlett Anne Sundberg} \\
		{\large Victor 13}\\
		{\large 43552, San Francisco, Phu Yen, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Trinity Victoria Holmberg Pte Ltd } \\
		{\large Jameson 51}\\
		{\large 54045, Amsterdam, Guangzhou, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
