...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luna Catherine  Åkesson} \\
		{\large Alexa 15}\\
		{\large 65014, Istanbul, Phu Yen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison William Jönsson Corp } \\
		{\large Adriana 78}\\
		{\large 28952, Stuttgart, Heibei, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
