...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nevaeh Edward Andreasson} \\
		{\large Bryce 91}\\
		{\large 68372, Sydney, Floria, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer  Alexander  Samuelsson Pte Ltd } \\
		{\large Isabella 16}\\
		{\large 85573, Hong Kong, Bayern, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
