...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kinsley Mary 	 Lindström} \\
		{\large Jayden 71}\\
		{\large 29467, Milan, Amnat Charoen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrew Louise 	 Lundström Ltd } \\
		{\large Amelia 48}\\
		{\large 17249, Amsterdam, Floria, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
