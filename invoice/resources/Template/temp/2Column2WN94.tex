...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Holmberg} \\
		{\large Scarlett 5}\\
		{\large 76464, SaiGon, khanh Hoa, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maria Catherine  Samuelsson Pte Ltd } \\
		{\large Josephine 86}\\
		{\large 53328, Istanbul, Buriam, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
