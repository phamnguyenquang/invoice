...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle Andersson} \\
		{\large Summer 49}\\
		{\large 10149, Abu Dhabi, Guangdong, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aliyah Victoria Sandström Pte Ltd } \\
		{\large Vanessa 4}\\
		{\large 90683, SaiGon, Guangdong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
