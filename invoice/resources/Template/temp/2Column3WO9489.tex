...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooke Jane Sundberg Ltd} \\
		{\large Andrew 34}\\
		{\large 67659, Frankfurt am Main , Guangzhou, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hannah Lundgren } \\
		{\large Alyssa 35}\\
		{\large 53086, Denver, Guangdong, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
