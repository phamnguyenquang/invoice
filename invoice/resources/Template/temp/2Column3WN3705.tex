...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harmony Louise 	 Pålsson} \\
		{\large Xavier 66}\\
		{\large 99154, Ho Chi Minh, Guangdong, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wyatt John Ekström Pte Ltd } \\
		{\large Amelia 18}\\
		{\large 13598, Bonn, Saarland, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
