...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jennifer Berglund} \\
		{\large Kylie 83}\\
		{\large 37817, Frankfurt am Main , Chiang Mai, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sara Louise 	 Bergqvist Ltd } \\
		{\large Giovanni 46}\\
		{\large 51199, San Francisco, Guangzhou, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
