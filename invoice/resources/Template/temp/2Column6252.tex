...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Skylar Eliasson Corp} \\
		{\large Payton 40}\\
		{\large 86481, Frankfurt am Main , Kentucky, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sofia Wikström } \\
		{\large Victor 25}\\
		{\large 52782, San Francisco, Hamburg, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
