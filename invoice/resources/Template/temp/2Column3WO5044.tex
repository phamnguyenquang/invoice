...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Christopher Jönsson Pte Ltd} \\
		{\large Bennett 70}\\
		{\large 58524, Dublin, Henan, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brody Arvidsson } \\
		{\large Addison 63}\\
		{\large 23700, Last Vegas, Binh Thuan, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
