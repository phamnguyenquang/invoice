...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katherine Robert Pålsson} \\
		{\large Lucas 29}\\
		{\large 97818, Washington, Texas, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaylee Michael Claesson Inc } \\
		{\large Luke 34}\\
		{\large 81927, Stuttgart, Chiang Rai, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
