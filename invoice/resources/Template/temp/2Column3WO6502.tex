...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jose  Alexander  Månsson Pte Ltd} \\
		{\large Aidan 40}\\
		{\large 99061, SaiGon, Seattles, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adeline Nyström } \\
		{\large Serenity 82}\\
		{\large 69494, Frankfurt am Main , Bangkok, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
