...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Connor Elizabeth 	 Mårtensson Ltd} \\
		{\large Eleanor 88}\\
		{\large 55665, Moscow, Heibei, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gael Gustafsson } \\
		{\large Chloe 51}\\
		{\large 62064, Los Angeles, California, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
