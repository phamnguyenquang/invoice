...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aidan Edward Pettersson} \\
		{\large Benjamin 86}\\
		{\large 48852, Stuttgart, Henan, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Xavier Peter Andersson Pte Ltd } \\
		{\large Charles 99}\\
		{\large 57126, Singapore, Chiang Rai, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
