...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonah Christopher Lindqvist} \\
		{\large Dominic 84}\\
		{\large 55653, Budapest, Chiang Mai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jacob Anne Bergström Pte Ltd } \\
		{\large Xavier 10}\\
		{\large 83504, Chicago, Hessen, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
