...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariel Christopher Lindström} \\
		{\large Hadley 20}\\
		{\large 91761, Washington, Buriam, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mila Michael Sjöberg Pte Ltd } \\
		{\large Patrick 88}\\
		{\large 31420, Los Angeles, Seattles, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
