...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alana William Åberg} \\
		{\large Angel 36}\\
		{\large 94876, Frankfurt am Main , Heibei, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Chloe Christopher Jakobsson Ltd } \\
		{\large Alaina 36}\\
		{\large 84930, Moscow, Henan, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
