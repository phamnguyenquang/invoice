...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brielle  Alexander  Lindgren} \\
		{\large Marcus 76}\\
		{\large 44021, Madrid, Ang Thong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklyn Edward Karlsson Pte Ltd } \\
		{\large Sadie 78}\\
		{\large 24461, Frankfurt am Main , Hamburg, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
