...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vanessa Elizabeth 	 Viklund Corp} \\
		{\large Abigail 15}\\
		{\large 54870, San Francisco, Buriam, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Willow Pettersson } \\
		{\large Ryleigh 59}\\
		{\large 44584, Moscow, California, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
