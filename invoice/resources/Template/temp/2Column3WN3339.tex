...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryan Christopher Andreasson} \\
		{\large Eliza 32}\\
		{\large 83261, Singapore, Saarland, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Victor May/Mae 	 Olsson Pte Ltd } \\
		{\large Sarah 83}\\
		{\large 85863, Vienna, khanh Hoa, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
