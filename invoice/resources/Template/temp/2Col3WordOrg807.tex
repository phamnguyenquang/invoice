...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope Kate 	 Håkansson Pte Ltd} \\
		{\large Julian 57}\\
		{\large 64604, Singapore, Chai Nat, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryce Andersson } \\
		{\large Edward 86}\\
		{\large 27876, Madrid, Ang Thong, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
