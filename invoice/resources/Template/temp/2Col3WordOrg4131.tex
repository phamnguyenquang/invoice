...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luca Grace 	 Nyström Corp} \\
		{\large Marcus 46}\\
		{\large 36684, Last Vegas, Amnat Charoen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucy Samuelsson } \\
		{\large Jordan 9}\\
		{\large 39892, Frankfurt am Main , Texas, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
