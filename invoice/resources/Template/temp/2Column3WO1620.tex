...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grayson Victoria Samuelsson Ltd} \\
		{\large Lilly 28}\\
		{\large 99677, Ho Chi Minh, Chiang Rai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Arianna Samuelsson } \\
		{\large Makenzie 34}\\
		{\large 23817, Vienna, Buriam, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
