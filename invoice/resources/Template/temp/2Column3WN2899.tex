...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gianna James Ström} \\
		{\large Cooper 59}\\
		{\large 61539, Boston, Hainan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nora Thomas Martinsson Pte Ltd } \\
		{\large Piper 51}\\
		{\large 58813, Barcelona, Heibei, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
