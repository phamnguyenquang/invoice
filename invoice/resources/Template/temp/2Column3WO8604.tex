...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Patrick David Forsberg Pte Ltd} \\
		{\large Arianna 43}\\
		{\large 98689, Last Vegas, Binh Thuan, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Trinity Holmberg } \\
		{\large Destiny 16}\\
		{\large 11917, San Francisco, Hainan, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
