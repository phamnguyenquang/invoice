...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bentley Ann  Björklund} \\
		{\large Kaden 30}\\
		{\large 85798, Florence, Chiang Rai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amelia Victoria Sjögren Ltd } \\
		{\large Colton 8}\\
		{\large 67874, Milan, Seattles, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
