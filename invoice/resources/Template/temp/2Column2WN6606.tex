...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alice Eklund} \\
		{\large Lilly 55}\\
		{\large 44918, Vancouver, Bremen, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ashton Christopher Pettersson Pte Ltd } \\
		{\large Angelina 77}\\
		{\large 96707, Washington, Indiana, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
