...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caden Nilsson} \\
		{\large Daniel 49}\\
		{\large 10962, Los Angeles, Chiang Mai, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katherine Christopher Abrahamsson Ltd } \\
		{\large Oliver 70}\\
		{\large 44778, New York , Hainan, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
