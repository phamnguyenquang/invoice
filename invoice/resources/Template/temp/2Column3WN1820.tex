...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mary  Alexander  Sandberg} \\
		{\large Ava 14}\\
		{\large 94901, Vancouver, Hessen, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mackenzie William Holmberg Corp } \\
		{\large John 2}\\
		{\large 70774, Stuttgart, Binh Thuan, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
