...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gavin Louise 	 Löfgren} \\
		{\large Kimberly 99}\\
		{\large 68840, Rome, Bremen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Malachi Robert Hellström Corp } \\
		{\large Hannah 84}\\
		{\large 62370, Ho Chi Minh, Binh Thuan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
