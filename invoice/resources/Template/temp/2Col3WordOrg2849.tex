...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Reese Christopher Ekström Ltd} \\
		{\large Christopher 34}\\
		{\large 91853, Dubai, Phu Yen, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leah Strömberg } \\
		{\large Grayson 75}\\
		{\large 35276, Berlin, Indiana, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
