...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Riley Louise 	 Andersson} \\
		{\large Scarlett 85}\\
		{\large 41447, Frankfurt am Main , Indiana, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jordyn  Alexander  Blomqvist Corp } \\
		{\large Graham 21}\\
		{\large 20764, Toronto, Kentucky, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
