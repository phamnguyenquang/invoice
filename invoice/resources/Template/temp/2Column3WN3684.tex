...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Violet Elizabeth 	 Eliasson} \\
		{\large Maddox 86}\\
		{\large 10368, Abu Dhabi, Indiana, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gael Louise 	 Hedlund Pte Ltd } \\
		{\large Natalie 27}\\
		{\large 78650, Nha Trang, Chiang Rai, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
