...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Andersson Corp} \\
		{\large Luca 36}\\
		{\large 16128, San Francisco, Ang Thong, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abigail Lundström } \\
		{\large Sean 91}\\
		{\large 86050, San Francisco, Ang Thong, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
