...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooke Amy  Holmberg} \\
		{\large Elijah 55}\\
		{\large 65741, Last Vegas, Bangkok, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklyn Catherine  Eklund Pte Ltd } \\
		{\large Adalynn 55}\\
		{\large 63175, Bonn, California, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
