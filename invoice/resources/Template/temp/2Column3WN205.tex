...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leo Thomas Dahlberg} \\
		{\large Kyle 18}\\
		{\large 33508, Los Angeles, Heibei, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aurora Edward Nyström Pte Ltd } \\
		{\large Londyn 41}\\
		{\large 25435, Toronto, Amnat Charoen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
