...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Robert Christopher Olofsson} \\
		{\large Jayla 76}\\
		{\large 98209, Moscow, Kentucky, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Genesis Grace 	 Lindberg Pte Ltd } \\
		{\large Brayden 86}\\
		{\large 22142, London , Bangkok, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
