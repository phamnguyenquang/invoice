...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bella  Alexander  Hedlund Corp} \\
		{\large Richard 16}\\
		{\large 52246, Beijing, Guangdong, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Oliver Sundberg } \\
		{\large Gael 24}\\
		{\large 29724, San Francisco, Amnat Charoen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
