...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Margaret Edward Fredriksson Inc} \\
		{\large Christopher 35}\\
		{\large 18467, Dubai, Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaden Wallin } \\
		{\large Maverick 42}\\
		{\large 63276, SaiGon, Hawaii, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
