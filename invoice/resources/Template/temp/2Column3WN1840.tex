...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valerie Thomas Viklund} \\
		{\large Bella 51}\\
		{\large 67859, Moscow, California, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Allison Victoria Norberg Pte Ltd } \\
		{\large Brantley 29}\\
		{\large 82773, Toronto, Binh Thuan, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
