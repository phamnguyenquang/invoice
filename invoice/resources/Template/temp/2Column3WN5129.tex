...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonathan  Alexander  Nordström} \\
		{\large Cayden 86}\\
		{\large 15514, Budapest, Ang Thong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eli Catherine  Johansson Inc } \\
		{\large Valentina 65}\\
		{\large 90731, Rome, Amnat Charoen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
