...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalyn Åkesson} \\
		{\large Makenzie 32}\\
		{\large 20215, Istanbul, Binh Thuan, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maddox Louise 	 Lindström Corp } \\
		{\large Richard 74}\\
		{\large 45391, Frankfurt am Main , Hessen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
