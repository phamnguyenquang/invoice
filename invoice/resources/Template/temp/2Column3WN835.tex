...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Khloe Louise 	 Sjögren} \\
		{\large Aiden 44}\\
		{\large 40916, Rome, Chiang Rai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reagan Elizabeth 	 Sandström Ltd } \\
		{\large Xavier 61}\\
		{\large 77504, Budapest, Huabei, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
