...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ivan Catherine  Nordström} \\
		{\large Jaxon 42}\\
		{\large 35107, Frankfurt am Main , Chiang Mai, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michelle  Alexander  Ekström Ltd } \\
		{\large Delilah 52}\\
		{\large 31968, Shanghai, Heibei, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
