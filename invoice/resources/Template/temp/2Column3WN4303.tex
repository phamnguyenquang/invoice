...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Anthony Grace 	 Mårtensson} \\
		{\large Nora 96}\\
		{\large 40007, Florence, Kentucky, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sara Peter Arvidsson Pte Ltd } \\
		{\large Angel 82}\\
		{\large 28863, New York , Seattles, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
