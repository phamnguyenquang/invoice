...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vincent Elizabeth 	 Lindström} \\
		{\large Audrey 93}\\
		{\large 78582, Vienna, Bangkok, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hunter John Andersson Pte Ltd } \\
		{\large Isla 52}\\
		{\large 94665, Munich, Huabei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
