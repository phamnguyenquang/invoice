...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  St George's, University of London	} \\
		{\large Preston 59}\\
		{\large 98047, Nha Trang, Amnat Charoen, China }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Molly Sjögren } \\
		{\large Adriana 10}\\
		{\large 10000, Chicago, Kentucky, United State }\\
    \switchcolumn
