...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryker Marie 	 Blomqvist Corp} \\
		{\large Diego 64}\\
		{\large 48272, Frankfurt am Main , California, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jordyn Lindholm } \\
		{\large Brooke 39}\\
		{\large 50352, Taipei, Binh Thuan, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
