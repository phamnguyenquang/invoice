...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aubrey Elizabeth 	 Lind} \\
		{\large Samantha 20}\\
		{\large 83433, Barcelona, Amnat Charoen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremiah Kate 	 Wallin Corp } \\
		{\large Calvin 72}\\
		{\large 36427, Tokyo, Chiang Mai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
