...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon Catherine  Andersson} \\
		{\large Melody 56}\\
		{\large 31521, Ho Chi Minh, Seattles, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maverick Elizabeth 	 Björk Inc } \\
		{\large Rachel 69}\\
		{\large 71202, Ho Chi Minh, Kentucky, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
