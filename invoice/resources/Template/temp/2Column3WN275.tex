...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Xavier Amy  Fransson} \\
		{\large Kaden 75}\\
		{\large 93702, Singapore, Kentucky, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large James Thomas Nilsson Inc } \\
		{\large Andrew 46}\\
		{\large 26736, Nha Trang, Guangzhou, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
