...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abraham Victoria Andreasson Pte Ltd} \\
		{\large Melanie 9}\\
		{\large 59006, Vancouver, Bayern, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mateo Samuelsson } \\
		{\large Chloe 29}\\
		{\large 76125, Budapest, Buriam, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
