...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro Christopher Andersson} \\
		{\large Mark 48}\\
		{\large 76847, Berlin, Guangzhou, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sydney Edward Lundberg Pte Ltd } \\
		{\large Eliana 87}\\
		{\large 22973, Bonn, Bremen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
