...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexander  Alexander  Jansson} \\
		{\large Bryan 74}\\
		{\large 39297, Rome, Bangkok, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Austin Robert Pettersson Pte Ltd } \\
		{\large Brandon 45}\\
		{\large 21081, Barcelona, Tuscany, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
