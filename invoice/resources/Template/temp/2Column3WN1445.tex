...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rachel Rose 	 Gustafsson} \\
		{\large Stella 57}\\
		{\large 67431, Seoul, Chiang Mai, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large George Victoria Olsson Ltd } \\
		{\large Luis 40}\\
		{\large 85236, Frankfurt am Main , Indiana, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
