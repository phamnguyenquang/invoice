...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mila Elizabeth 	 Lundström} \\
		{\large Kinsley 53}\\
		{\large 45202, Barcelona, Hessen, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Edward John Olofsson Corp } \\
		{\large Alaina 67}\\
		{\large 24500, Nha Trang, Chai Nat, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
