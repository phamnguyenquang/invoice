...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jennifer Christopher Claesson} \\
		{\large Everett 24}\\
		{\large 46191, Istanbul, Hainan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hadley John Öberg Pte Ltd } \\
		{\large Lily 67}\\
		{\large 84366, Toronto, Guangzhou, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
