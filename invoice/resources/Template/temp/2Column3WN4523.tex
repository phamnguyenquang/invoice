...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mckenzie  Alexander  Arvidsson} \\
		{\large Victoria 76}\\
		{\large 81848, Los Angeles, Hainan, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hadley Rose 	 Lindberg Corp } \\
		{\large Aliyah 72}\\
		{\large 68713, Rome, Guangdong, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
