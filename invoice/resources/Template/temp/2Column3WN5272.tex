...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Camden Rose 	 Karlsson} \\
		{\large Jace 81}\\
		{\large 94897, San Francisco, California, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Richard Kate 	 Sjöberg Corp } \\
		{\large Ivan 52}\\
		{\large 93336, Taipei, Indiana, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
