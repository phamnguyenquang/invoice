...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gianna Catherine  Ström} \\
		{\large Oscar 5}\\
		{\large 70904, Minsk, Henan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden Marie 	 Viklund Pte Ltd } \\
		{\large Caleb 43}\\
		{\large 32269, Frankfurt am Main , Bangkok, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
