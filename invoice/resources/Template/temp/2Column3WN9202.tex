...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cole John Viklund} \\
		{\large Antonio 52}\\
		{\large 11897, Ho Chi Minh, California, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Genesis Louise 	 Isaksson Ltd } \\
		{\large Sarah 17}\\
		{\large 16498, Vienna, Chiang Mai, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
