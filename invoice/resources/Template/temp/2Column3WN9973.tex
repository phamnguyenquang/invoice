...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aubrey Catherine  Hedlund} \\
		{\large Alana 56}\\
		{\large 55645, Barcelona, Amnat Charoen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nolan David Lind Ltd } \\
		{\large Mila 78}\\
		{\large 57736, Munich, Guangzhou, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
