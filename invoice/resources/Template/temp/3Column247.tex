...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Charles University in Prague	Czech} \\
		{\large Damian 44}\\
		{\large 19320, Paris, Chiang Rai, United State }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Annabelle Gustafsson } \\
		{\large Brooklynn 39}\\
		{\large 15828, Lisbon, Guangzhou, Philippines}\\
    \switchcolumn
