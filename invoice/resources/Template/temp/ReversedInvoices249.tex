...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Massachusetts Amherst} \\
		{\large Kai 2}\\
		{\large 27979, Taipei, Chiang Rai, Australia }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Allison Jonsson } \\
		{\large Juan 45}\\
		{\large 70777, Hong Kong, Hamburg, Australia }\\
    \switchcolumn
