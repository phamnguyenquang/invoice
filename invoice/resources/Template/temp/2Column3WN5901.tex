...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria Michael Bergström} \\
		{\large Jace 19}\\
		{\large 16598, Tokyo, Phu Yen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large John Edward Sandström Corp } \\
		{\large Athena 83}\\
		{\large 68365, Frankfurt am Main , Hessen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
