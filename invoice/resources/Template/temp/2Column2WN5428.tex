...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valerie Holmberg} \\
		{\large Jasmine 82}\\
		{\large 85377, Frankfurt am Main , Hessen, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emilia Grace 	 Fredriksson Pte Ltd } \\
		{\large Avery 86}\\
		{\large 21899, SaiGon, Hamburg, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
