...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniela David Arvidsson} \\
		{\large Kinsley 97}\\
		{\large 75285, Abu Dhabi, Binh Thuan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ethan Elizabeth 	 Henriksson Ltd } \\
		{\large Jacob 33}\\
		{\large 55882, Milan, Chiang Rai, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
