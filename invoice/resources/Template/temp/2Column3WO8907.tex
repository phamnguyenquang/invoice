...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalynn  Alexander  Norberg Corp} \\
		{\large Londyn 48}\\
		{\large 59393, Frankfurt am Main , Bangkok, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eliana Lindström } \\
		{\large Natalia 5}\\
		{\large 83188, Madrid, Amnat Charoen, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
