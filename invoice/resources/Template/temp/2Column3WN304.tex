...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kingston Elizabeth 	 Engström} \\
		{\large Scarlett 32}\\
		{\large 35741, Melbourne, Phu Yen, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joseph Louise 	 Fransson Corp } \\
		{\large Alejandro 93}\\
		{\large 52975, Madrid, Heibei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
