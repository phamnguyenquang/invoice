...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jace  Alexander  Lundgren Pte Ltd} \\
		{\large Avery 14}\\
		{\large 68740, Chicago, Amnat Charoen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everett Jansson } \\
		{\large Jackson 31}\\
		{\large 68565, San Francisco, Saarland, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
