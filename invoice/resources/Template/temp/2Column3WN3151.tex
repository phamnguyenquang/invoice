...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Giovanni  Alexander  Dahlberg} \\
		{\large Charles 41}\\
		{\large 96003, Toronto, Guangdong, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryan William Öberg Ltd } \\
		{\large Mya 69}\\
		{\large 87572, Barcelona, Henan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
