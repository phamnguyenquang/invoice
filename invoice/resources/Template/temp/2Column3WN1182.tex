...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla Kate 	 Bengtsson} \\
		{\large Ayden 64}\\
		{\large 88404, Last Vegas, Saarland, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lyla Louise 	 Nordin Inc } \\
		{\large Melody 76}\\
		{\large 73665, Toronto, Chiang Mai, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
