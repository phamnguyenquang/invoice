...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesus Kate 	 Eklund} \\
		{\large Mckenzie 75}\\
		{\large 51556, Frankfurt am Main , Bangkok, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaden Catherine  Olofsson Corp } \\
		{\large Riley 13}\\
		{\large 22150, Osaka, Chiang Rai, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
