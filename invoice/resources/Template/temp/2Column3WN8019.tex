...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxson Elizabeth 	 Andersson} \\
		{\large Amir 75}\\
		{\large 89113, Singapore, Hawaii, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jake Peter Samuelsson Corp } \\
		{\large Ryan 11}\\
		{\large 20261, Abu Dhabi, Ang Thong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
