...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxson  Alexander  Mattsson} \\
		{\large Miguel 71}\\
		{\large 32934, Hanoi, Hawaii, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juliana William Bergström Inc } \\
		{\large Jameson 51}\\
		{\large 45253, Beijing, Chiang Mai, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
