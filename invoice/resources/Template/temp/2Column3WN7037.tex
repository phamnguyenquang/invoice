...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harper Christopher Hellström} \\
		{\large Evan 71}\\
		{\large 61375, Vienna, Hamburg, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eric  Alexander  Viklund Pte Ltd } \\
		{\large Eli 77}\\
		{\large 78038, Berlin, Tuscany, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
