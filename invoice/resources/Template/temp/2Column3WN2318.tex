...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sofia James Eriksson} \\
		{\large Nolan 87}\\
		{\large 35728, Melbourne, Chai Nat, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmanuel May/Mae 	 Andreasson Inc } \\
		{\large Preston 15}\\
		{\large 42871, Sydney, Indiana, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
