...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxson Marie 	 Berggren Pte Ltd} \\
		{\large Elise 67}\\
		{\large 47352, Montreal, Indiana, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayce Gustafsson } \\
		{\large Leilani 94}\\
		{\large 67330, Frankfurt am Main , Amnat Charoen, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
