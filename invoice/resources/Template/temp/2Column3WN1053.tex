...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope William Martinsson} \\
		{\large Gianna 10}\\
		{\large 20946, Vienna, Hessen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large James Victoria Håkansson Pte Ltd } \\
		{\large Zoe 44}\\
		{\large 55736, Boston, Tuscany, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
