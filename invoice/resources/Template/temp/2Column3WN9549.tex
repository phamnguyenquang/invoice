...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rachel Ann  Jakobsson} \\
		{\large Christopher 92}\\
		{\large 45114, Toronto, Guangzhou, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large David Marie 	 Hassan Inc } \\
		{\large Emily 16}\\
		{\large 22096, Hong Kong, Tuscany, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
