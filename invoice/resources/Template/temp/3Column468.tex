...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Grenoble Alpes University} \\
		{\large Bryson 75}\\
		{\large 62057, London , Amnat Charoen, New Zealand}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Payton Andersson } \\
		{\large Kaleb 26}\\
		{\large 46109, Frankfurt am Main , Binh Thuan, Philippines}\\
    \switchcolumn
