...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amelia Victoria Hellström} \\
		{\large Riley 56}\\
		{\large 31448, Osaka, Hessen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon Christopher Berg Pte Ltd } \\
		{\large Maria 94}\\
		{\large 26583, Beijing, Chiang Rai, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
