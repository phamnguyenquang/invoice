...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everly William Engström} \\
		{\large Adriana 2}\\
		{\large 14840, Sydney, Amnat Charoen, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesse Victoria Björklund Ltd } \\
		{\large Izabella 94}\\
		{\large 75843, Frankfurt am Main , Bremen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
