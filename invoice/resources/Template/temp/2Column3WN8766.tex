...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Willow Christopher Bergström} \\
		{\large Kayden 66}\\
		{\large 76249, Washington, Henan, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryson Jane Engström Pte Ltd } \\
		{\large Owen 44}\\
		{\large 33549, Melbourne, Saarland, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
