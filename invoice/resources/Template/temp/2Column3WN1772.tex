...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michelle Michael Eklund} \\
		{\large Benjamin 9}\\
		{\large 83032, Amsterdam, Chiang Rai, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Naomi Victoria Dahlberg Ltd } \\
		{\large Connor 97}\\
		{\large 99021, Frankfurt am Main , Hainan, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
