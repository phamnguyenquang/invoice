...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Allison Marie 	 Lindgren} \\
		{\large Nathan 83}\\
		{\large 12491, Hong Kong, Bayern, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reagan Anne Jakobsson Corp } \\
		{\large Ariel 11}\\
		{\large 51512, Last Vegas, Binh Thuan, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
