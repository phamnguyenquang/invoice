...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon Mary 	 Magnusson} \\
		{\large Juliana 26}\\
		{\large 80008, Madrid, Amnat Charoen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Matthew Robert Lundberg Pte Ltd } \\
		{\large Addison 73}\\
		{\large 52330, San Francisco, Phu Yen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
