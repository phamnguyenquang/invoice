...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vivian James Dahl} \\
		{\large Everly 28}\\
		{\large 36543, Frankfurt am Main , Amnat Charoen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kinsley May/Mae 	 Mattsson Inc } \\
		{\large Thomas 5}\\
		{\large 48127, Budapest, Chai Nat, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
