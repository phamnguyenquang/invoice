...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eliza Ann  Karlsson} \\
		{\large Eden 17}\\
		{\large 60209, Beijing, Heibei, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Greyson Robert Samuelsson Inc } \\
		{\large Izabella 41}\\
		{\large 21035, Frankfurt am Main , Bremen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
