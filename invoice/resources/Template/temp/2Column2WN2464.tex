...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alan Sjögren} \\
		{\large Serenity 19}\\
		{\large 65325, Minsk, Chiang Mai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kendall Elizabeth 	 Wikström Inc } \\
		{\large Valerie 71}\\
		{\large 85330, London , Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
