...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte Christopher Hellström} \\
		{\large Aaliyah 47}\\
		{\large 73789, Berlin, Tuscany, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniel Peter Eliasson Corp } \\
		{\large Hazel 14}\\
		{\large 39299, Berlin, California, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
