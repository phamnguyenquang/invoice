...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly Rose 	 Ahmed} \\
		{\large Damian 74}\\
		{\large 99671, Washington, Saarland, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmanuel Michael Henriksson Ltd } \\
		{\large Charles 18}\\
		{\large 37571, New York , Hawaii, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
