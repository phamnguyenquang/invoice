...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cole  Alexander  Isaksson} \\
		{\large Christian 45}\\
		{\large 40506, Los Angeles, Chai Nat, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evelyn Christopher Lindholm Corp } \\
		{\large Madison 25}\\
		{\large 59160, San Francisco, Chiang Mai, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
