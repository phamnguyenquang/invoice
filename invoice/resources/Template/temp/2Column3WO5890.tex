...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cayden Elizabeth 	 Öberg Corp} \\
		{\large Stephanie 33}\\
		{\large 89227, Madrid, Hamburg, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caden Blomqvist } \\
		{\large Caleb 81}\\
		{\large 52203, Frankfurt am Main , Amnat Charoen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
