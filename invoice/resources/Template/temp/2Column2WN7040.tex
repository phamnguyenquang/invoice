...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrew Abrahamsson} \\
		{\large Brian 91}\\
		{\large 85156, Madrid, Bremen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reagan Christopher Strömberg Corp } \\
		{\large Liam 91}\\
		{\large 83842, Shanghai, Seattles, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
