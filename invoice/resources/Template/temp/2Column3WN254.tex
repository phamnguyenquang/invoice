...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carson Kate 	 Abrahamsson} \\
		{\large Xavier 84}\\
		{\large 39174, New York , Binh Thuan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Silas William Ekström Ltd } \\
		{\large Makenzie 66}\\
		{\large 41187, Washington, Heibei, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
