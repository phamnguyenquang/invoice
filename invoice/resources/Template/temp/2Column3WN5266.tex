...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Braxton  Alexander  Lundgren} \\
		{\large Cole 74}\\
		{\large 10676, Minsk, Hessen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alex Thomas Samuelsson Corp } \\
		{\large Norah 25}\\
		{\large 86877, Frankfurt am Main , Amnat Charoen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
