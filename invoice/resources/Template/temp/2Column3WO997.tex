...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ashley Christopher Martinsson Corp} \\
		{\large William 4}\\
		{\large 82683, Frankfurt am Main , Texas, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angelina Berglund } \\
		{\large Tyler 64}\\
		{\large 20794, Hanoi, Bremen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
