...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rose Grace 	 Persson} \\
		{\large Emilia 66}\\
		{\large 61362, Singapore, Bangkok, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabel Victoria Wallin Pte Ltd } \\
		{\large Anna 14}\\
		{\large 22953, Frankfurt am Main , Guangdong, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
