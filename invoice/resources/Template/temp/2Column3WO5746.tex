...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elise Rose 	 Martinsson Pte Ltd} \\
		{\large Calvin 1}\\
		{\large 55281, San Francisco, Chiang Mai, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Annabelle Mårtensson } \\
		{\large Valentina 42}\\
		{\large 44966, Florence, Heibei, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
