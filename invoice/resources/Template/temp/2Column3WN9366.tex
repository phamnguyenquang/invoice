...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro Mary 	 Lindqvist} \\
		{\large Scarlett 14}\\
		{\large 63247, Dublin, Guangzhou, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zoe May/Mae 	 Henriksson Ltd } \\
		{\large Jonah 14}\\
		{\large 97942, Shanghai, Amnat Charoen, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
