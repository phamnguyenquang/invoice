...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harper Thomas Berggren} \\
		{\large Brody 70}\\
		{\large 79542, Milan, Binh Thuan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Londyn Robert Lundgren Ltd } \\
		{\large Maxwell 9}\\
		{\large 49435, Frankfurt am Main , Hawaii, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
