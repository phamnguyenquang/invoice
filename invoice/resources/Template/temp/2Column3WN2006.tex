...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriella William Öberg} \\
		{\large Hailey 81}\\
		{\large 69116, Frankfurt am Main , Guangzhou, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harper  Alexander  Hedlund Corp } \\
		{\large Payton 40}\\
		{\large 51305, Nha Trang, Texas, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
