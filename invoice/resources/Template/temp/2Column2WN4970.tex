...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly Sjöberg} \\
		{\large Aaron 67}\\
		{\large 26580, Ho Chi Minh, Heibei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samantha Catherine  Bergström Ltd } \\
		{\large Jacob 12}\\
		{\large 15325, Melbourne, Amnat Charoen, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
