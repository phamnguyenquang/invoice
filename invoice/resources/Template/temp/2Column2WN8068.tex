...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maximus Wallin} \\
		{\large Bryson 37}\\
		{\large 45512, Singapore, Tuscany, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Genesis Edward Sjögren Corp } \\
		{\large Julian 2}\\
		{\large 14658, Frankfurt am Main , Bangkok, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
