...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lyla William Sandström} \\
		{\large Skylar 89}\\
		{\large 37095, Frankfurt am Main , Phu Yen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Violet Mary 	 Ali Pte Ltd } \\
		{\large Luis 34}\\
		{\large 14373, Florence, Ang Thong, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
