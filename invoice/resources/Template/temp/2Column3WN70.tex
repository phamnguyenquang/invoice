...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kyle William Bergqvist} \\
		{\large George 2}\\
		{\large 77469, Ho Chi Minh, Kentucky, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Austin Michael Holm Pte Ltd } \\
		{\large Matthew 17}\\
		{\large 66271, Hanoi, Chiang Rai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
