...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jason Andreasson} \\
		{\large Carter 94}\\
		{\large 82572, Frankfurt am Main , Binh Thuan, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Genesis Christopher Jönsson Inc } \\
		{\large Calvin 1}\\
		{\large 47457, Ho Chi Minh, California, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
