...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  National Yang-Ming University} \\
		{\large Aidan 15}\\
		{\large 63788, Frankfurt am Main , Amnat Charoen, Russia}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Preston Söderberg } \\
		{\large Brielle 76}\\
		{\large 83952, Frankfurt am Main , Hawaii, France }\\
    \switchcolumn
