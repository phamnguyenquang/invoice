...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicole David Fransson} \\
		{\large Steven 30}\\
		{\large 22130, SaiGon, Binh Thuan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bennett Louise 	 Mattsson Pte Ltd } \\
		{\large Mateo 28}\\
		{\large 30748, Toronto, Saarland, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
