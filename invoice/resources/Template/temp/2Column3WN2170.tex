...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sarah David Lindström} \\
		{\large Aurora 36}\\
		{\large 46418, Istanbul, Seattles, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isaiah Kate 	 Blomqvist Corp } \\
		{\large Sawyer 46}\\
		{\large 46442, Abu Dhabi, Guangzhou, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
