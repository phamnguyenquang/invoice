...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vanessa Catherine  Norberg Corp} \\
		{\large Katelyn 96}\\
		{\large 93342, Frankfurt am Main , Guangzhou, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Molly Bergström } \\
		{\large Jude 92}\\
		{\large 75463, Berlin, Phu Yen, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
