...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liam Jane Karlsson} \\
		{\large Kaylee 46}\\
		{\large 28990, Amsterdam, Chai Nat, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Faith David Lundin Pte Ltd } \\
		{\large Rebecca 92}\\
		{\large 60341, Frankfurt am Main , Bangkok, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
