...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryleigh Christopher Fredriksson Pte Ltd} \\
		{\large Damian 37}\\
		{\large 98801, Dublin, Floria, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sean Lundqvist } \\
		{\large Chase 35}\\
		{\large 43794, SaiGon, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
