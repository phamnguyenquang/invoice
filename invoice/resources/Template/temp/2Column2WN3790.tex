...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Xavier Lundström} \\
		{\large Levi 89}\\
		{\large 32612, Ho Chi Minh, Texas, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Patrick David Holm Pte Ltd } \\
		{\large Sadie 62}\\
		{\large 41503, Frankfurt am Main , Guangzhou, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
