...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Autumn Grace 	 Samuelsson Corp} \\
		{\large Jeremiah 89}\\
		{\large 27500, Frankfurt am Main , Floria, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kimberly Larsson } \\
		{\large Andrea 22}\\
		{\large 52342, Seoul, Indiana, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
