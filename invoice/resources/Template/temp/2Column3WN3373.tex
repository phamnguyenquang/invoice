...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brianna Amy  Jansson} \\
		{\large Avery 17}\\
		{\large 89054, Montreal, Hainan, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Skylar David Lindgren Pte Ltd } \\
		{\large Gracie 14}\\
		{\large 49591, Ho Chi Minh, Ang Thong, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
