...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kylie Elizabeth 	 Ström} \\
		{\large Aliyah 23}\\
		{\large 75309, Los Angeles, Hawaii, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large King Louise 	 Nyström Ltd } \\
		{\large Eli 97}\\
		{\large 36086, Last Vegas, Bremen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
