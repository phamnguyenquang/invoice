...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Timothy Louise 	 Dahlberg} \\
		{\large Adalyn 93}\\
		{\large 55864, Boston, khanh Hoa, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayden Thomas Lindberg Corp } \\
		{\large Aubrey 80}\\
		{\large 34476, Hong Kong, Tuscany, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
