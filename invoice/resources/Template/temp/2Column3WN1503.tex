...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaron Grace 	 Lundström} \\
		{\large Lyla 85}\\
		{\large 25551, Hong Kong, Hessen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tucker Catherine  Andersson Corp } \\
		{\large Carlos 49}\\
		{\large 76776, Singapore, khanh Hoa, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
