...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mary Ann  Nordin} \\
		{\large Emery 46}\\
		{\large 16725, Nha Trang, Seattles, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elias Michael Abrahamsson Inc } \\
		{\large Brooklynn 31}\\
		{\large 85670, Minsk, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
