...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonathan Mattsson} \\
		{\large William 71}\\
		{\large 97944, Frankfurt am Main , Phu Yen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bella Jane Lindqvist Pte Ltd } \\
		{\large Aubree 26}\\
		{\large 88723, Bonn, Amnat Charoen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
