...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Roman Louise 	 Claesson Pte Ltd} \\
		{\large Leilani 47}\\
		{\large 52723, Frankfurt am Main , California, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harrison Eklund } \\
		{\large Ivy 57}\\
		{\large 56390, Frankfurt am Main , Indiana, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
