...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sadie Viklund} \\
		{\large Declan 65}\\
		{\large 43786, Stuttgart, Huabei, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Edward Victoria Danielsson Corp } \\
		{\large Carlos 47}\\
		{\large 78891, Last Vegas, Amnat Charoen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
