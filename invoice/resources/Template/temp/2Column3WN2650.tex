...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Violet Christopher Eriksson} \\
		{\large Mackenzie 46}\\
		{\large 69247, Ho Chi Minh, Amnat Charoen, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josiah  Alexander  Danielsson Inc } \\
		{\large Ella 49}\\
		{\large 31452, Boston, Bremen, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
