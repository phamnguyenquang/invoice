...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katelyn Michael Strömberg} \\
		{\large Mason 39}\\
		{\large 77997, Los Angeles, Seattles, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison Christopher Andreasson Pte Ltd } \\
		{\large David 46}\\
		{\large 75578, Vancouver, Floria, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
