...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrea Louise 	 Norberg Ltd} \\
		{\large Brayden 19}\\
		{\large 64854, Last Vegas, Tuscany, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Asher Sjögren } \\
		{\large Jesus 27}\\
		{\large 41632, Frankfurt am Main , Buriam, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
