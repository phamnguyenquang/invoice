...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emma May/Mae 	 Åberg Corp} \\
		{\large Christopher 93}\\
		{\large 13436, Frankfurt am Main , Chiang Rai, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore Lindqvist } \\
		{\large Caleb 15}\\
		{\large 72995, Frankfurt am Main , Binh Thuan, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
