...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alice Victoria Gustafsson Corp} \\
		{\large Lily 86}\\
		{\large 97359, Ho Chi Minh, Binh Thuan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore Andersson } \\
		{\large Jack 59}\\
		{\large 93215, Melbourne, Guangdong, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
