...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jennifer Rose 	 Hassan Inc} \\
		{\large Jack 68}\\
		{\large 71406, Last Vegas, Heibei, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adriana Gustafsson } \\
		{\large Bryce 58}\\
		{\large 79341, Ho Chi Minh, Chiang Mai, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
