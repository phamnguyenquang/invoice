...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kylie Andersson} \\
		{\large Melanie 41}\\
		{\large 72727, Abu Dhabi, Tuscany, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Christopher Hermansson Corp } \\
		{\large Luna 46}\\
		{\large 36606, Toronto, khanh Hoa, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
