...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Miguel Lundgren Pte Ltd} \\
		{\large Ryleigh 87}\\
		{\large 53098, Frankfurt am Main , Bayern, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalynn Berggren } \\
		{\large Adalynn 42}\\
		{\large 22747, Frankfurt am Main , Heibei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
