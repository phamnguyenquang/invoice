...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklynn Robert Lundin Pte Ltd} \\
		{\large Hannah 24}\\
		{\large 80340, Moscow, Phu Yen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caleb Björklund } \\
		{\large Isla 21}\\
		{\large 54408, Washington, California, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
