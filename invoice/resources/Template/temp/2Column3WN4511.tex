...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesse Edward Ekström} \\
		{\large Daniela 27}\\
		{\large 10806, Sydney, Heibei, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Dominic Edward Lindström Pte Ltd } \\
		{\large Dominic 27}\\
		{\large 78610, Nha Trang, Binh Thuan, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
