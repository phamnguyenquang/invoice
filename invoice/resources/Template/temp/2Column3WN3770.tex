...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caden  Alexander  Nordin} \\
		{\large Christopher 67}\\
		{\large 81035, Shanghai, Chiang Rai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bradley Peter Dahlberg Pte Ltd } \\
		{\large Mark 38}\\
		{\large 18775, Paris, Buriam, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
