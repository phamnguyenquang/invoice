...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina James Nilsson} \\
		{\large Destiny 83}\\
		{\large 75886, Dubai, Ang Thong, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bradley Mary 	 Arvidsson Corp } \\
		{\large Maximus 28}\\
		{\large 10840, Lisbon, Heibei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
