...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kevin Christopher Nilsson Ltd} \\
		{\large Annabelle 63}\\
		{\large 95655, Istanbul, Chiang Mai, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn Jansson } \\
		{\large Samuel 26}\\
		{\large 93057, San Francisco, Ang Thong, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
