...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paisley Robert Eklund} \\
		{\large Cole 56}\\
		{\large 18806, Munich, Tuscany, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Thomas Hassan Pte Ltd } \\
		{\large Carlos 1}\\
		{\large 27104, Denver, Binh Thuan, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
