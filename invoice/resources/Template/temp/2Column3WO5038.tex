...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Blake Michael Henriksson Pte Ltd} \\
		{\large Katelyn 79}\\
		{\large 41127, Ho Chi Minh, Hamburg, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eliana Pålsson } \\
		{\large Alana 93}\\
		{\large 49045, Vancouver, Heibei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
