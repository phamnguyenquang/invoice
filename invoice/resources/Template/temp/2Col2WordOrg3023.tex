...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Piper Henriksson Corp} \\
		{\large Samuel 60}\\
		{\large 56325, Frankfurt am Main , Seattles, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sean Magnusson } \\
		{\large Emma 79}\\
		{\large 80978, Singapore, Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
