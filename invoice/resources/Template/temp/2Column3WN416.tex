...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Scarlett  Alexander  Ström} \\
		{\large Carlos 2}\\
		{\large 88282, Budapest, Seattles, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christian William Sandström Inc } \\
		{\large Andrea 23}\\
		{\large 11588, Budapest, Chiang Rai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
