...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Addison Christopher Martinsson} \\
		{\large Destiny 44}\\
		{\large 33898, Barcelona, Tuscany, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Asher Victoria Lindgren Pte Ltd } \\
		{\large Leah 9}\\
		{\large 19219, Vienna, Hainan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
