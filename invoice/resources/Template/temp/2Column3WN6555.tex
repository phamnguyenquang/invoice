...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesse Edward Dahlberg} \\
		{\large Wesley 9}\\
		{\large 31564, Washington, Heibei, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jude Louise 	 Martinsson Ltd } \\
		{\large Ruby 34}\\
		{\large 44034, Washington, Hamburg, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
