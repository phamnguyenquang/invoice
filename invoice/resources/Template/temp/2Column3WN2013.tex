...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carter Marie 	 Öberg} \\
		{\large Lydia 57}\\
		{\large 24184, Frankfurt am Main , Huabei, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas John Söderberg Inc } \\
		{\large Valerie 48}\\
		{\large 84878, Dublin, Ang Thong, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
