...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Genesis Louise 	 Hedlund Ltd} \\
		{\large Gabriella 64}\\
		{\large 83306, Frankfurt am Main , Bayern, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison Samuelsson } \\
		{\large Chloe 43}\\
		{\large 42784, Shanghai, Chai Nat, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
