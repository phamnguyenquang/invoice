...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Easton Elizabeth 	 Andersson} \\
		{\large Bailey 89}\\
		{\large 21464, Ho Chi Minh, Bremen, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elijah  Alexander  Mårtensson Pte Ltd } \\
		{\large Tristan 51}\\
		{\large 25685, Boston, Binh Thuan, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
