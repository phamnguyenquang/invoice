...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everly Mary 	 Strömberg} \\
		{\large Caden 36}\\
		{\large 30110, Frankfurt am Main , Chiang Rai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juliana Amy  Mattsson Ltd } \\
		{\large Piper 26}\\
		{\large 79151, Ho Chi Minh, Hessen, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
