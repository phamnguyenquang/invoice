...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Willow Christopher Jonsson} \\
		{\large Savannah 56}\\
		{\large 67732, Stuttgart, Buriam, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryleigh Grace 	 Pålsson Corp } \\
		{\large Avery 98}\\
		{\large 52213, Madrid, Saarland, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
