...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ximena Robert Sandberg Inc} \\
		{\large Brady 26}\\
		{\large 81526, Frankfurt am Main , Floria, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Marcus Wikström } \\
		{\large Hadley 88}\\
		{\large 49470, Beijing, Ang Thong, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
