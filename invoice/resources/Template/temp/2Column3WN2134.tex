...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  William Catherine  Gunnarsson} \\
		{\large Katherine 39}\\
		{\large 63491, Denver, Bangkok, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Annabelle Louise 	 Falk Pte Ltd } \\
		{\large Nathan 78}\\
		{\large 68912, Osaka, Hamburg, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
