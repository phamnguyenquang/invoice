...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gianna Thomas Andersson} \\
		{\large Arianna 6}\\
		{\large 49043, Frankfurt am Main , Amnat Charoen, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kinsley  Alexander  Jakobsson Inc } \\
		{\large Mckenzie 73}\\
		{\large 63699, Nha Trang, Kentucky, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
