...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaden Peter Holmgren} \\
		{\large Dominic 39}\\
		{\large 54814, Los Angeles, Buriam, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Scarlett Christopher Ahmed Inc } \\
		{\large Madelyn 71}\\
		{\large 46580, Ho Chi Minh, Floria, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
