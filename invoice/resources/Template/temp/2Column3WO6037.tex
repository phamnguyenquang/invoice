...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Naomi Christopher Wikström Pte Ltd} \\
		{\large Jordyn 31}\\
		{\large 53703, Boston, Hawaii, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rebecca Lundqvist } \\
		{\large Charlotte 1}\\
		{\large 44889, Melbourne, Texas, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
