...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  George Mary 	 Bengtsson Pte Ltd} \\
		{\large Mateo 17}\\
		{\large 45554, Frankfurt am Main , Chai Nat, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesus Nordström } \\
		{\large Zoey 49}\\
		{\large 27092, Frankfurt am Main , Kentucky, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
