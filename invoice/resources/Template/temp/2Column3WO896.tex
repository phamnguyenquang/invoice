...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aliyah William Gustafsson Corp} \\
		{\large Cayden 13}\\
		{\large 35757, Nha Trang, Heibei, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayden Wikström } \\
		{\large Jennifer 77}\\
		{\large 90762, Los Angeles, Chiang Rai, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
