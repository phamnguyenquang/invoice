...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jessica Victoria Håkansson} \\
		{\large Alexis 94}\\
		{\large 46720, Denver, Tuscany, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sophie Louise 	 Nyberg Pte Ltd } \\
		{\large Kyle 89}\\
		{\large 20266, Frankfurt am Main , Texas, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
