...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Colton Robert Lind} \\
		{\large Sophie 95}\\
		{\large 55280, Los Angeles, Floria, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large James Catherine  Fransson Pte Ltd } \\
		{\large Miguel 38}\\
		{\large 19177, San Francisco, Hessen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
