...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leilani Victoria Söderberg} \\
		{\large Ezekiel 80}\\
		{\large 76599, Moscow, Phu Yen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harper Grace 	 Andersson Ltd } \\
		{\large Logan 52}\\
		{\large 30952, Budapest, Bayern, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
