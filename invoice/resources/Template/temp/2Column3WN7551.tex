...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline Louise 	 Martinsson} \\
		{\large Natalie 20}\\
		{\large 25654, Moscow, Huabei, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Asher Thomas Andersson Inc } \\
		{\large Victoria 38}\\
		{\large 31949, Stuttgart, Hawaii, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
