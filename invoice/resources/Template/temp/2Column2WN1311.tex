...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Pettersson} \\
		{\large Destiny 97}\\
		{\large 22191, Madrid, Henan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zachary Catherine  Sandberg Pte Ltd } \\
		{\large Brooke 31}\\
		{\large 42970, Chicago, Binh Thuan, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
