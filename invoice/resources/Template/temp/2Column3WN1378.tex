...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gael  Alexander  Arvidsson} \\
		{\large Reese 98}\\
		{\large 49273, Toronto, Hamburg, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Claire Thomas Henriksson Inc } \\
		{\large Miles 22}\\
		{\large 24240, Ho Chi Minh, Ang Thong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
