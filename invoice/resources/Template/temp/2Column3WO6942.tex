...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tristan  Alexander  Jönsson Corp} \\
		{\large Dominic 91}\\
		{\large 81109, Berlin, Binh Thuan, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklynn Holmberg } \\
		{\large Lilly 95}\\
		{\large 56354, Budapest, Amnat Charoen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
