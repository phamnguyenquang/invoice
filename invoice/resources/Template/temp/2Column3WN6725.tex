...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Edward Söderberg} \\
		{\large Bryce 19}\\
		{\large 86079, Shanghai, Guangdong, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Delilah Thomas Öberg Inc } \\
		{\large Maddox 26}\\
		{\large 98429, San Francisco, Indiana, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
