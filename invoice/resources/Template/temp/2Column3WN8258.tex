...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Destiny  Alexander  Andersson} \\
		{\large Emmett 45}\\
		{\large 62562, Dubai, Amnat Charoen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Benjamin Ann  Mårtensson Corp } \\
		{\large Lauren 43}\\
		{\large 28988, Barcelona, Hessen, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
