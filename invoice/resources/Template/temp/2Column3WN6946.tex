...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Landon Anne Forsberg} \\
		{\large Amy 51}\\
		{\large 44231, Chicago, Bangkok, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reagan Michael Lundqvist Ltd } \\
		{\large Eli 18}\\
		{\large 98370, Singapore, Amnat Charoen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
