...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Molly Jane Olofsson} \\
		{\large Patrick 70}\\
		{\large 22859, Venice, Guangzhou, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brian Ann  Ek Pte Ltd } \\
		{\large Michael 36}\\
		{\large 92734, Frankfurt am Main , Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
