...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carlos Lindholm} \\
		{\large Jaden 33}\\
		{\large 59134, Paris, Chai Nat, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Victoria Victoria Danielsson Pte Ltd } \\
		{\large Tucker 23}\\
		{\large 67946, Melbourne, Hessen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
