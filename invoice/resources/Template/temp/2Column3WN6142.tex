...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Robert  Alexander  Mohamed} \\
		{\large Reagan 50}\\
		{\large 35461, SaiGon, Kentucky, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Annabelle John Mårtensson Inc } \\
		{\large William 49}\\
		{\large 25585, Lisbon, Hawaii, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
