...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonathan Lee  Hedlund Ltd} \\
		{\large Reagan 14}\\
		{\large 53060, Moscow, Amnat Charoen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maddox Gustafsson } \\
		{\large Eleanor 50}\\
		{\large 60496, Florence, California, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
