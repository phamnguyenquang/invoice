...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Pålsson} \\
		{\large Daisy 8}\\
		{\large 40217, Hong Kong, Phu Yen, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Skylar Edward Fransson Pte Ltd } \\
		{\large Greyson 99}\\
		{\large 22781, Berlin, Chiang Rai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
