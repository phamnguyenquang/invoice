...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liliana Lee  Lundström} \\
		{\large Chloe 18}\\
		{\large 34872, Stuttgart, Binh Thuan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Chloe Elizabeth 	 Abrahamsson Inc } \\
		{\large Lily 2}\\
		{\large 17200, Hanoi, Chai Nat, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
