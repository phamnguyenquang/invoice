...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stephanie James Wallin} \\
		{\large Samuel 67}\\
		{\large 35828, Frankfurt am Main , Amnat Charoen, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo William Blom Ltd } \\
		{\large Jayla 41}\\
		{\large 26381, Toronto, Floria, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
