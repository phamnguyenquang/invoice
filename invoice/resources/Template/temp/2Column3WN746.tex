...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kyle Rose 	 Bergman} \\
		{\large Abigail 30}\\
		{\large 90869, Munich, Guangdong, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy Louise 	 Sandberg Corp } \\
		{\large Savannah 6}\\
		{\large 30653, Frankfurt am Main , Seattles, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
