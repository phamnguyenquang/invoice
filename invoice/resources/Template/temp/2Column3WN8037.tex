...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Giovanni May/Mae 	 Blom} \\
		{\large Bradley 48}\\
		{\large 29840, London , Heibei, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Miles Thomas Claesson Pte Ltd } \\
		{\large Paul 66}\\
		{\large 44736, Frankfurt am Main , Ang Thong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
