...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Malachi Sjöberg} \\
		{\large Chloe 70}\\
		{\large 53715, San Francisco, Kentucky, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caleb  Alexander  Lundgren Corp } \\
		{\large Brady 75}\\
		{\large 55025, Frankfurt am Main , Huabei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
