...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joshua Thomas Fredriksson} \\
		{\large Jeremy 68}\\
		{\large 55171, Sydney, Bremen, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian Grace 	 Berglund Corp } \\
		{\large Serenity 78}\\
		{\large 17047, Los Angeles, Binh Thuan, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
