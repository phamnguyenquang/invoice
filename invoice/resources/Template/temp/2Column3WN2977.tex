...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonah Louise 	 Engström} \\
		{\large Marcus 20}\\
		{\large 50322, Washington, Bangkok, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wesley Mary 	 Eliasson Pte Ltd } \\
		{\large Wesley 15}\\
		{\large 51341, Ho Chi Minh, Buriam, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
