...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jessica Christopher Jönsson} \\
		{\large Aria 53}\\
		{\large 32395, Sydney, Saarland, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison Louise 	 Karlsson Pte Ltd } \\
		{\large Emma 1}\\
		{\large 54471, Ho Chi Minh, Henan, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
