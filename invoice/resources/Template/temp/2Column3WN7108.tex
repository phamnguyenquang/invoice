...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lauren Thomas Håkansson} \\
		{\large Gianna 32}\\
		{\large 75611, Toronto, Floria, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isaiah  Alexander  Lindholm Pte Ltd } \\
		{\large Adalynn 2}\\
		{\large 57888, Denver, Hessen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
