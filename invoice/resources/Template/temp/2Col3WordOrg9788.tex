...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Andrew William Wikström Pte Ltd} \\
		{\large Ryker 84}\\
		{\large 89047, Ho Chi Minh, Seattles, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Justin Sjögren } \\
		{\large Eva 75}\\
		{\large 29441, Beijing, Seattles, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
