...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline Olofsson Pte Ltd} \\
		{\large Jocelyn 54}\\
		{\large 99327, Vienna, Hainan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Victoria Mattsson } \\
		{\large Maverick 16}\\
		{\large 99093, Frankfurt am Main , Bayern, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
