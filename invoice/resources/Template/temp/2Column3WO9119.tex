...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  King  Alexander  Andersson Pte Ltd} \\
		{\large Jace 70}\\
		{\large 61136, Frankfurt am Main , Chai Nat, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Quinn Ekström } \\
		{\large Kendall 39}\\
		{\large 90688, Dublin, Ang Thong, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
