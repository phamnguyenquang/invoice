...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery Robert Henriksson Corp} \\
		{\large Hadley 93}\\
		{\large 84542, Frankfurt am Main , Texas, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everett Bergström } \\
		{\large Valeria 30}\\
		{\large 40730, Vancouver, khanh Hoa, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
