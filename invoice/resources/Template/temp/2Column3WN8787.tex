...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel Christopher Pålsson} \\
		{\large Julianna 51}\\
		{\large 77845, Ho Chi Minh, Chai Nat, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julianna Louise 	 Bergqvist Corp } \\
		{\large Grayson 28}\\
		{\large 69549, London , Kentucky, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
