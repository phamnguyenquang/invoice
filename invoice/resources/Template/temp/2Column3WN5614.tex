...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tucker Robert Jakobsson} \\
		{\large Kaitlyn 39}\\
		{\large 85566, Frankfurt am Main , Saarland, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Evan Edward Lindqvist Ltd } \\
		{\large Isaiah 91}\\
		{\large 86128, Florence, Hawaii, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
