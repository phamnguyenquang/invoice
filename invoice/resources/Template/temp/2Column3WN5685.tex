...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liliana Elizabeth 	 Hermansson} \\
		{\large Lincoln 82}\\
		{\large 46263, Istanbul, Binh Thuan, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn  Alexander  Holm Corp } \\
		{\large Allison 82}\\
		{\large 21000, Sydney, Bangkok, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
