...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ximena Christopher Andersson Pte Ltd} \\
		{\large Joel 7}\\
		{\large 14223, Sydney, Guangdong, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hazel Dahlberg } \\
		{\large Eliza 8}\\
		{\large 25583, Frankfurt am Main , Texas, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
