...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte Louise 	 Ahmed Ltd} \\
		{\large Carter 5}\\
		{\large 39433, San Francisco, Kentucky, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wesley Sandberg } \\
		{\large Tucker 10}\\
		{\large 93285, Los Angeles, Bayern, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
