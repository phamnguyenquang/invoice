...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexis Louise 	 Strömberg} \\
		{\large Carson 92}\\
		{\large 40785, Washington, Chai Nat, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angel Robert Andersson Corp } \\
		{\large Destiny 21}\\
		{\large 49859, Sydney, Chai Nat, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
