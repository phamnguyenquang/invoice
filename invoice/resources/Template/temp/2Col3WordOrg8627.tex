...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore William Holmberg Pte Ltd} \\
		{\large Maxwell 93}\\
		{\large 24571, Hong Kong, Ang Thong, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryleigh Samuelsson } \\
		{\large Lauren 88}\\
		{\large 91759, Berlin, Guangzhou, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
