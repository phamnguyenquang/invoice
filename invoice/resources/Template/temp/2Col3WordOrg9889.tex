...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maddox Catherine  Danielsson Corp} \\
		{\large Victoria 37}\\
		{\large 16872, Budapest, Binh Thuan, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kenneth Bergman } \\
		{\large Caden 85}\\
		{\large 64002, Frankfurt am Main , Floria, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
