...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaden Lindqvist} \\
		{\large Chloe 2}\\
		{\large 64667, Singapore, Hessen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michelle  Alexander  Jansson Ltd } \\
		{\large Silas 33}\\
		{\large 88569, Frankfurt am Main , Bremen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
