...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery Thomas Norberg Pte Ltd} \\
		{\large Miguel 34}\\
		{\large 73082, Stuttgart, Hessen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vivian Magnusson } \\
		{\large Ivy 48}\\
		{\large 80876, Stuttgart, Bangkok, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
