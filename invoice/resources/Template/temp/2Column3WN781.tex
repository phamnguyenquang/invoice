...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Anne Bergström} \\
		{\large Chase 72}\\
		{\large 20613, Florence, Indiana, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mariah Louise 	 Nordin Corp } \\
		{\large Hadley 97}\\
		{\large 21741, Seoul, Amnat Charoen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
