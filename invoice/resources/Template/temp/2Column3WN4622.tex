...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra Michael Danielsson} \\
		{\large Hunter 39}\\
		{\large 10662, Istanbul, Phu Yen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Willow David Blom Corp } \\
		{\large Sarah 94}\\
		{\large 60290, Munich, Tuscany, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
