...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklynn Lee  Johansson} \\
		{\large Juan 44}\\
		{\large 82914, Lisbon, Amnat Charoen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brian Kate 	 Håkansson Pte Ltd } \\
		{\large Jaxson 16}\\
		{\large 52428, Berlin, Hainan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
