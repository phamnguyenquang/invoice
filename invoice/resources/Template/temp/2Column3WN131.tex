...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Santiago Marie 	 Jakobsson} \\
		{\large Jesse 83}\\
		{\large 78964, Ho Chi Minh, Hamburg, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carson Grace 	 Gustafsson Corp } \\
		{\large Ruby 61}\\
		{\large 72583, Taipei, Bangkok, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
