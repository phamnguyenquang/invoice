...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grace Edward Samuelsson} \\
		{\large Aubree 64}\\
		{\large 34374, Chicago, Saarland, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Henry May/Mae 	 Hansson Inc } \\
		{\large Piper 4}\\
		{\large 68042, Ho Chi Minh, Floria, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
