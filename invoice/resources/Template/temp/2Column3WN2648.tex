...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maverick John Abrahamsson} \\
		{\large Jayce 38}\\
		{\large 57884, Munich, Phu Yen, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Quinn Victoria Gunnarsson Corp } \\
		{\large Greyson 18}\\
		{\large 42839, Florence, California, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
