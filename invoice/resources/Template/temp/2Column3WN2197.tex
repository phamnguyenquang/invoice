...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryan Elizabeth 	 Sandström} \\
		{\large Roman 62}\\
		{\large 59405, Abu Dhabi, Amnat Charoen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte Jane Svensson Ltd } \\
		{\large Alana 16}\\
		{\large 30887, Amsterdam, khanh Hoa, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
