...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Delilah Christopher Henriksson} \\
		{\large Ashley 76}\\
		{\large 66698, Madrid, Tuscany, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samantha  Alexander  Nordström Pte Ltd } \\
		{\large Brian 29}\\
		{\large 45129, Budapest, Bayern, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
