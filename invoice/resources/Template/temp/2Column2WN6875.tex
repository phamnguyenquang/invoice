...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariel Lindström} \\
		{\large Colton 60}\\
		{\large 19721, Dublin, Hawaii, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Amy  Martinsson Corp } \\
		{\large Bryan 52}\\
		{\large 25734, Ho Chi Minh, Indiana, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
