...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kingston Amy  Nyberg} \\
		{\large Stephanie 99}\\
		{\large 63452, Istanbul, Ang Thong, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michael William Lundin Pte Ltd } \\
		{\large Brody 49}\\
		{\large 46450, Stuttgart, Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
