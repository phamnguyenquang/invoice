...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bella Victoria Abrahamsson} \\
		{\large Jasmine 41}\\
		{\large 22469, San Francisco, Seattles, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katherine Louise 	 Lind Ltd } \\
		{\large Emily 40}\\
		{\large 25601, Denver, California, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
