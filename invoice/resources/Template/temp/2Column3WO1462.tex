...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Austin Michael Magnusson Pte Ltd} \\
		{\large Emilia 53}\\
		{\large 65212, London , Hessen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sarah Lundberg } \\
		{\large Oliver 50}\\
		{\large 18843, Frankfurt am Main , California, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
