...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katelyn Louise 	 Gustafsson} \\
		{\large Ezra 22}\\
		{\large 37101, Sydney, Hainan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryker  Alexander  Abrahamsson Pte Ltd } \\
		{\large Aaron 76}\\
		{\large 56076, Barcelona, Hainan, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
