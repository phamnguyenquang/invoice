...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Samuel Christopher Söderberg} \\
		{\large Alex 69}\\
		{\large 52881, Hong Kong, Hessen, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liam James Hansen Pte Ltd } \\
		{\large Serenity 20}\\
		{\large 89418, Beijing, Hamburg, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
