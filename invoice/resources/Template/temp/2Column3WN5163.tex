...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Parker Louise 	 Håkansson} \\
		{\large Emilia 38}\\
		{\large 82915, Toronto, Ang Thong, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Michael Henriksson Pte Ltd } \\
		{\large Rose 87}\\
		{\large 41607, Florence, Amnat Charoen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
