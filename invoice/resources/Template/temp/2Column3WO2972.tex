...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Justin Catherine  Berggren Pte Ltd} \\
		{\large Justin 76}\\
		{\large 21827, Ho Chi Minh, Heibei, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lyla Ekström } \\
		{\large Stella 79}\\
		{\large 33617, Stuttgart, Guangzhou, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
