...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Skylar Catherine  Berg} \\
		{\large Ruby 93}\\
		{\large 28435, Barcelona, Ang Thong, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juan Jane Bergqvist Ltd } \\
		{\large Brantley 76}\\
		{\large 88934, Washington, Seattles, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
