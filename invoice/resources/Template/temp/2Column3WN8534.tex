...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Autumn John Pettersson} \\
		{\large Serenity 35}\\
		{\large 31041, Melbourne, Texas, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexander Louise 	 Norberg Pte Ltd } \\
		{\large Mia 90}\\
		{\large 28570, Beijing, California, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
