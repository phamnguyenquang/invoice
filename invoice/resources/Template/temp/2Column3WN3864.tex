...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jessica John Jansson} \\
		{\large Ariana 26}\\
		{\large 64909, Frankfurt am Main , Bangkok, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joel  Alexander  Wikström Ltd } \\
		{\large Zoe 45}\\
		{\large 50658, San Francisco, Hainan, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
