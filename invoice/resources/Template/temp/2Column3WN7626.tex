...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Molly  Alexander  Pålsson} \\
		{\large Alexandra 67}\\
		{\large 97076, Nha Trang, Bayern, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremy James Bergqvist Corp } \\
		{\large Ruby 87}\\
		{\large 28068, Vancouver, Amnat Charoen, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
