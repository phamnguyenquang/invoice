...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro Michael Löfgren} \\
		{\large Kevin 72}\\
		{\large 86233, Frankfurt am Main , Floria, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samantha Ann  Lundström Corp } \\
		{\large Jordan 87}\\
		{\large 94616, Milan, Floria, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
