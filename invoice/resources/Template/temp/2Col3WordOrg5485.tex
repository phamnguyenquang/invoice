...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Benjamin Robert Holmgren Inc} \\
		{\large Ethan 5}\\
		{\large 12117, Frankfurt am Main , Guangzhou, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Genesis Svensson } \\
		{\large Sofia 45}\\
		{\large 90990, Florence, Amnat Charoen, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
