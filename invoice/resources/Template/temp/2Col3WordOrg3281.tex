...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Marcus Kate 	 Johansson Pte Ltd} \\
		{\large Jennifer 68}\\
		{\large 46798, Hong Kong, Chiang Rai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mason Wikström } \\
		{\large Izabella 87}\\
		{\large 61860, Frankfurt am Main , Texas, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
