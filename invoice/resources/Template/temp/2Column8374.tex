...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joseph Hermansson Corp} \\
		{\large Jason 70}\\
		{\large 40700, Frankfurt am Main , California, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christian Öberg } \\
		{\large Parker 29}\\
		{\large 62737, Los Angeles, Tuscany, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
