...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nevaeh Grace 	 Wikström} \\
		{\large Mariah 36}\\
		{\large 34053, San Francisco, California, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madison Lee  Bergman Corp } \\
		{\large Colin 79}\\
		{\large 97621, Frankfurt am Main , Binh Thuan, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
