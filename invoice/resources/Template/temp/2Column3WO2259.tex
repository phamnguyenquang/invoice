...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ian  Alexander  Lundberg Pte Ltd} \\
		{\large Bentley 97}\\
		{\large 32301, Florence, Guangzhou, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Timothy Ekström } \\
		{\large Hannah 51}\\
		{\large 19471, Montreal, Guangzhou, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
