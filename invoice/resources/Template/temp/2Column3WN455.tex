...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rebecca Victoria Eriksson} \\
		{\large Destiny 11}\\
		{\large 71988, Taipei, Saarland, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicole John Eriksson Pte Ltd } \\
		{\large Matthew 5}\\
		{\large 50765, Beijing, Chiang Mai, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
