...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luke Michael Olsson} \\
		{\large Julia 27}\\
		{\large 33931, Amsterdam, Bayern, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Marcus Elizabeth 	 Sundberg Inc } \\
		{\large Margaret 85}\\
		{\large 48234, Munich, Hessen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
