...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Taylor Claesson Pte Ltd} \\
		{\large Isabelle 55}\\
		{\large 10443, Frankfurt am Main , Seattles, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Layla Arvidsson } \\
		{\large Lyla 48}\\
		{\large 23685, Frankfurt am Main , Hessen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
