...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie Elizabeth 	 Björk} \\
		{\large Angelina 13}\\
		{\large 60943, Denver, Kentucky, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayla May/Mae 	 Löfgren Corp } \\
		{\large Eli 94}\\
		{\large 40182, Denver, Guangdong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
