...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everly Michael Hermansson Inc} \\
		{\large Jennifer 22}\\
		{\large 30395, Frankfurt am Main , Henan, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Månsson } \\
		{\large Scarlett 71}\\
		{\large 67547, Frankfurt am Main , Saarland, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
