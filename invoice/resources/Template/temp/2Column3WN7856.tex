...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brielle Robert Bergqvist} \\
		{\large Hannah 64}\\
		{\large 88134, Venice, khanh Hoa, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucas John Blomqvist Inc } \\
		{\large Camden 59}\\
		{\large 37175, Los Angeles, California, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
