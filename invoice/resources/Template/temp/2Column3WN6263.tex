...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madison Grace 	 Jakobsson} \\
		{\large Kingston 43}\\
		{\large 52791, Los Angeles, Chai Nat, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Ann  Magnusson Inc } \\
		{\large Carson 73}\\
		{\large 97447, Budapest, California, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
