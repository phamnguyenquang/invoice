...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Graduate University for Advanced Studies} \\
		{\large Alyssa 94}\\
		{\large 46124, Abu Dhabi, Heibei, Denmark}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Jennifer Månsson } \\
		{\large Victoria 37}\\
		{\large 15355, Osaka, Hessen, Saudi Arabia }\\
    \switchcolumn
