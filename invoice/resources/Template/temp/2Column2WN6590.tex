...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall Gustafsson} \\
		{\large Nevaeh 63}\\
		{\large 64098, Frankfurt am Main , Heibei, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joshua Catherine  Mohamed Inc } \\
		{\large Bryan 96}\\
		{\large 12743, London , Binh Thuan, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
