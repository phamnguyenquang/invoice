...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rylee Elizabeth 	 Henriksson Pte Ltd} \\
		{\large Harper 58}\\
		{\large 79722, San Francisco, Chiang Rai, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley Ahmed } \\
		{\large Alexander 88}\\
		{\large 44563, Abu Dhabi, Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
