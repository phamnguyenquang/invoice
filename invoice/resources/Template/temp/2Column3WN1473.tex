...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emilia Marie 	 Holm} \\
		{\large Daniel 9}\\
		{\large 63869, Vienna, Chiang Rai, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anthony Louise 	 Sjöberg Pte Ltd } \\
		{\large Xavier 17}\\
		{\large 25083, Last Vegas, Seattles, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
