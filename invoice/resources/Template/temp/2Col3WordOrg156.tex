...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniela Elizabeth 	 Norberg Ltd} \\
		{\large Michelle 34}\\
		{\large 45837, Budapest, Hessen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Faith Hellström } \\
		{\large Anna 47}\\
		{\large 26545, Ho Chi Minh, Amnat Charoen, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
