...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kenneth Victoria Fredriksson Inc} \\
		{\large Cayden 2}\\
		{\large 17663, Frankfurt am Main , Hainan, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angel Nyström } \\
		{\large Luna 34}\\
		{\large 35862, Hong Kong, Ang Thong, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
