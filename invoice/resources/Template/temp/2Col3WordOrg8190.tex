...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxson Elizabeth 	 Bergman Ltd} \\
		{\large Rachel 11}\\
		{\large 39746, Montreal, California, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alan Eriksson } \\
		{\large Miles 58}\\
		{\large 13855, Frankfurt am Main , Hamburg, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
