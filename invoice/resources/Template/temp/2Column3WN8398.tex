...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kylie Elizabeth 	 Henriksson} \\
		{\large Logan 25}\\
		{\large 33390, Istanbul, Hamburg, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mackenzie Louise 	 Söderberg Ltd } \\
		{\large Avery 7}\\
		{\large 84475, Minsk, Texas, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
