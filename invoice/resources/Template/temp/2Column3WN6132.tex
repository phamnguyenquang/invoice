...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  James Christopher Arvidsson} \\
		{\large Jessica 54}\\
		{\large 26868, Stuttgart, Chiang Mai, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hannah Robert Holmgren Pte Ltd } \\
		{\large Aubrey 26}\\
		{\large 44391, Florence, Huabei, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
