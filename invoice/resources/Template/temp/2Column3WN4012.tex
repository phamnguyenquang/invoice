...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaliyah May/Mae 	 Samuelsson} \\
		{\large Brandon 59}\\
		{\large 34423, Vienna, Buriam, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madison Catherine  Mattsson Inc } \\
		{\large Paul 63}\\
		{\large 17272, Bonn, Amnat Charoen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
