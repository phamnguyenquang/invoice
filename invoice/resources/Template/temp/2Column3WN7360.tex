...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Izabella Grace 	 Eklund} \\
		{\large Isaiah 83}\\
		{\large 84342, Sydney, Guangdong, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amy Elizabeth 	 Strömberg Ltd } \\
		{\large Annabelle 6}\\
		{\large 26120, Florence, Guangdong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
