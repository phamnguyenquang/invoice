...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalynn Svensson} \\
		{\large Brady 20}\\
		{\large 13355, San Francisco, khanh Hoa, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Easton Jane Lundström Inc } \\
		{\large Adam 9}\\
		{\large 82985, Last Vegas, Guangzhou, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
