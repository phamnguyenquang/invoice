...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Scarlett Anne Bergqvist} \\
		{\large Julia 72}\\
		{\large 64668, Bonn, Chai Nat, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Robert Michael Samuelsson Pte Ltd } \\
		{\large Rylee 82}\\
		{\large 78611, Singapore, Kentucky, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
