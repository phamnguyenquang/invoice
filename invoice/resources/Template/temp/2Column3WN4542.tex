...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cole May/Mae 	 Söderberg} \\
		{\large Lucas 82}\\
		{\large 88683, New York , Ang Thong, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Declan Christopher Olsson Ltd } \\
		{\large Emma 97}\\
		{\large 40604, Frankfurt am Main , Huabei, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
