...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriel Anne Bengtsson Ltd} \\
		{\large Cameron 99}\\
		{\large 22784, Frankfurt am Main , Binh Thuan, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Dylan Hermansson } \\
		{\large Ashley 3}\\
		{\large 60447, Moscow, Chiang Mai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
