...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jameson James Holmgren} \\
		{\large Kingston 33}\\
		{\large 10873, Munich, Chiang Mai, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Skylar May/Mae 	 Bergman Pte Ltd } \\
		{\large Jennifer 1}\\
		{\large 21551, Washington, Phu Yen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
