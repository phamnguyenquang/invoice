...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eliana John Svensson} \\
		{\large Emmanuel 38}\\
		{\large 33860, Denver, Phu Yen, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madeline  Alexander  Åkesson Pte Ltd } \\
		{\large Emma 31}\\
		{\large 67319, New York , Huabei, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
