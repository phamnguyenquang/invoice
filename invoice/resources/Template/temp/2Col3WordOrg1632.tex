...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sydney Elizabeth 	 Gustafsson Pte Ltd} \\
		{\large Ariana 17}\\
		{\large 60093, Beijing, Chiang Mai, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian Andreasson } \\
		{\large Michael 28}\\
		{\large 39578, Amsterdam, Floria, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
