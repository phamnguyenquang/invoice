...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla Kate 	 Berggren} \\
		{\large Emma 40}\\
		{\large 86373, Budapest, Tuscany, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katelyn Louise 	 Hedlund Inc } \\
		{\large Asher 7}\\
		{\large 56144, Frankfurt am Main , Bayern, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
