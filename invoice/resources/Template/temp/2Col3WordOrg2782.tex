...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore David Persson Ltd} \\
		{\large Serenity 4}\\
		{\large 41210, Ho Chi Minh, khanh Hoa, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabrielle Samuelsson } \\
		{\large Julia 38}\\
		{\large 27526, Last Vegas, Indiana, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
