...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicholas Björklund} \\
		{\large Ethan 20}\\
		{\large 48634, Lisbon, Hessen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alaina Elizabeth 	 Pettersson Pte Ltd } \\
		{\large Brody 1}\\
		{\large 81615, Seoul, Indiana, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
