...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Willow Amy  Lundgren} \\
		{\large Gabrielle 66}\\
		{\large 71043, Melbourne, Guangzhou, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rebecca Elizabeth 	 Bergman Pte Ltd } \\
		{\large Harmony 15}\\
		{\large 69815, Boston, Bremen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
