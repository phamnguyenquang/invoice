...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Antonio Jane Pålsson} \\
		{\large Abel 12}\\
		{\large 56698, Venice, Saarland, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julianna Peter Lund Pte Ltd } \\
		{\large Jayce 76}\\
		{\large 41525, San Francisco, khanh Hoa, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
