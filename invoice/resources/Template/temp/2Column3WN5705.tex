...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nevaeh Michael Johansson} \\
		{\large Hazel 15}\\
		{\large 36139, Abu Dhabi, Hessen, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Savannah Marie 	 Andersson Pte Ltd } \\
		{\large Gracie 62}\\
		{\large 26354, Melbourne, Bayern, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
