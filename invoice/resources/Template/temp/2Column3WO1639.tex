...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Audrey Edward Sjöberg Corp} \\
		{\large Victoria 76}\\
		{\large 37317, Los Angeles, Bangkok, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camden Martinsson } \\
		{\large Jennifer 30}\\
		{\large 84914, Amsterdam, Hainan, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
