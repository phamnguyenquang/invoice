...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Samantha Christopher Eriksson} \\
		{\large Sebastian 21}\\
		{\large 54715, Abu Dhabi, Saarland, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery James Eliasson Ltd } \\
		{\large Cora 37}\\
		{\large 50342, Budapest, Bayern, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
