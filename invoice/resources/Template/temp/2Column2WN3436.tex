...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carter Andreasson} \\
		{\large Lucas 47}\\
		{\large 21009, Amsterdam, California, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden Amy  Sandström Pte Ltd } \\
		{\large Ivan 23}\\
		{\large 11505, Ho Chi Minh, Seattles, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
