...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paul Louise 	 Gunnarsson Ltd} \\
		{\large Ella 65}\\
		{\large 70683, Montreal, Chiang Mai, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Faith Svensson } \\
		{\large Amir 67}\\
		{\large 69983, Frankfurt am Main , Guangdong, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
