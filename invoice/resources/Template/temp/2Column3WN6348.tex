...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Antonio Elizabeth 	 Ström} \\
		{\large Katherine 64}\\
		{\large 86004, Seoul, Guangdong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carson Jane Sandström Ltd } \\
		{\large Aaron 18}\\
		{\large 35665, Hong Kong, Buriam, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
