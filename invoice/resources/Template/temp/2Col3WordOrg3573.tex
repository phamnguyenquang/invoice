...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Declan Robert Berggren Corp} \\
		{\large Adrian 91}\\
		{\large 74151, Frankfurt am Main , Chiang Mai, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Xavier Mårtensson } \\
		{\large Jacob 79}\\
		{\large 11885, Montreal, Hawaii, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
