...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lilly Lee  Axelsson} \\
		{\large Adam 98}\\
		{\large 39313, Washington, Tuscany, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Edward Öberg Corp } \\
		{\large Dylan 26}\\
		{\large 96373, Frankfurt am Main , Heibei, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
