...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maverick Rose 	 Ali} \\
		{\large Aliyah 92}\\
		{\large 31639, Hong Kong, Binh Thuan, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Grace 	 Viklund Pte Ltd } \\
		{\large Luna 19}\\
		{\large 63019, Nha Trang, Binh Thuan, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
