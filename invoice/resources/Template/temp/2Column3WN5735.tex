...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mila Mary 	 Lindqvist} \\
		{\large Ruby 22}\\
		{\large 99209, Vancouver, Chiang Mai, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jordan Christopher Fransson Inc } \\
		{\large Brandon 18}\\
		{\large 41174, Bonn, Kentucky, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
