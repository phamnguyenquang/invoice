...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brody Michael Pettersson} \\
		{\large Jude 12}\\
		{\large 37531, Nha Trang, Amnat Charoen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bentley May/Mae 	 Björklund Corp } \\
		{\large Bradley 2}\\
		{\large 84506, Los Angeles, Guangzhou, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
