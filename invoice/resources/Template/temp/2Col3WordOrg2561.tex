...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mackenzie Rose 	 Nordin Pte Ltd} \\
		{\large Emma 77}\\
		{\large 50769, Frankfurt am Main , Indiana, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Justin Gustafsson } \\
		{\large Harrison 93}\\
		{\large 98706, Madrid, Chai Nat, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
