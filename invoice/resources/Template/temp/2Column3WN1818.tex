...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Olivia  Alexander  Martinsson} \\
		{\large Joel 19}\\
		{\large 72601, Vancouver, Tuscany, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Audrey James Martinsson Corp } \\
		{\large Silas 7}\\
		{\large 58537, Frankfurt am Main , Binh Thuan, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
