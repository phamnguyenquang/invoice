...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valentina Victoria Sandström} \\
		{\large Angel 94}\\
		{\large 68869, London , Hessen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joseph Christopher Bergqvist Pte Ltd } \\
		{\large Aiden 9}\\
		{\large 18793, Stuttgart, Hessen, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
