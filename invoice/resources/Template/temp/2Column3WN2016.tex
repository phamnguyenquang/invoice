...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christian Marie 	 Löfgren} \\
		{\large Josiah 50}\\
		{\large 22961, Beijing, Tuscany, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmett Christopher Bergström Corp } \\
		{\large Jaden 22}\\
		{\large 52853, Stuttgart, California, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
