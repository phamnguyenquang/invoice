...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melody Kate 	 Hellström} \\
		{\large Theodore 19}\\
		{\large 22527, Ho Chi Minh, Hainan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angelina Catherine  Lindström Ltd } \\
		{\large Nathaniel 25}\\
		{\large 47089, Beijing, California, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
