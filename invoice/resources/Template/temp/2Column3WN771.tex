...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniel Ann  Arvidsson} \\
		{\large Skylar 70}\\
		{\large 33554, Munich, California, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adriana William Sandberg Ltd } \\
		{\large Kennedy 50}\\
		{\large 30017, Abu Dhabi, khanh Hoa, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
