...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vincent Louise 	 Jonsson} \\
		{\large Hadley 56}\\
		{\large 79168, Frankfurt am Main , Bremen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bentley Michael Berggren Corp } \\
		{\large Paisley 75}\\
		{\large 74922, Abu Dhabi, Hamburg, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
