...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liliana Catherine  Lundström} \\
		{\large Makayla 69}\\
		{\large 44167, Los Angeles, khanh Hoa, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte Louise 	 Pålsson Pte Ltd } \\
		{\large Jack 16}\\
		{\large 75380, Beijing, Hessen, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
