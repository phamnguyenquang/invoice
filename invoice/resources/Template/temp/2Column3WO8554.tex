...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Payton James Ahmed Pte Ltd} \\
		{\large Greyson 84}\\
		{\large 89399, Frankfurt am Main , Chiang Mai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Oliver Dahlberg } \\
		{\large Liliana 86}\\
		{\large 51678, Paris, Bayern, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
