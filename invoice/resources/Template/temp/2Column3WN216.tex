...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everett Ann  Berglund} \\
		{\large Ivy 45}\\
		{\large 81324, Amsterdam, Huabei, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie Thomas Norberg Pte Ltd } \\
		{\large Willow 28}\\
		{\large 54476, Abu Dhabi, Hawaii, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
