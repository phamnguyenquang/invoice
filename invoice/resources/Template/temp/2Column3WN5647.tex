...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabella Robert Lundqvist} \\
		{\large Eliana 22}\\
		{\large 22760, Vienna, Bremen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Rose 	 Gustafsson Pte Ltd } \\
		{\large Julianna 50}\\
		{\large 43864, Moscow, Guangzhou, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
