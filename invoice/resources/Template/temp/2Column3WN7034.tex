...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel William Bergman} \\
		{\large Abel 52}\\
		{\large 75035, London , Tuscany, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Victoria Thomas Karlsson Pte Ltd } \\
		{\large Cooper 89}\\
		{\large 78410, Boston, Chiang Rai, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
