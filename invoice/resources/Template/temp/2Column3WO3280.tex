...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaron Elizabeth 	 Lindqvist Inc} \\
		{\large Anna 51}\\
		{\large 77017, Frankfurt am Main , California, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brady Fredriksson } \\
		{\large Maxwell 55}\\
		{\large 92481, Taipei, Floria, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
