...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla Lundgren} \\
		{\large Thomas 15}\\
		{\large 60975, Moscow, Saarland, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madelyn Lee  Henriksson Pte Ltd } \\
		{\large Maxwell 40}\\
		{\large 70603, San Francisco, Chai Nat, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
