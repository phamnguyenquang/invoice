...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabella May/Mae 	 Andersson Corp} \\
		{\large Alana 72}\\
		{\large 27156, Frankfurt am Main , Hainan, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Dominic Nordström } \\
		{\large Lucas 26}\\
		{\large 19142, Lisbon, Binh Thuan, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
