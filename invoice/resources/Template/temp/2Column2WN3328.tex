...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Silas Bergqvist} \\
		{\large Alana 87}\\
		{\large 18517, Osaka, Guangdong, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melanie David Fredriksson Pte Ltd } \\
		{\large Angelina 83}\\
		{\large 46162, SaiGon, Ang Thong, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
