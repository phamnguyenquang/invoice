...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Clara May/Mae 	 Dahlberg Pte Ltd} \\
		{\large Brady 59}\\
		{\large 88413, Melbourne, Chiang Mai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Olofsson } \\
		{\large Eleanor 96}\\
		{\large 40735, Rome, Indiana, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
