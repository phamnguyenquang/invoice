...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Parker  Alexander  Arvidsson} \\
		{\large Zoey 30}\\
		{\large 69582, Istanbul, Tuscany, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maximus May/Mae 	 Fransson Inc } \\
		{\large Aaron 66}\\
		{\large 20189, Abu Dhabi, Henan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
