...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kai Jane Lindholm} \\
		{\large Allison 63}\\
		{\large 60518, Melbourne, Seattles, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grant Peter Nordström Inc } \\
		{\large Grayson 43}\\
		{\large 53790, Frankfurt am Main , Hessen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
