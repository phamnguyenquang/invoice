...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Santiago Christopher Holmgren} \\
		{\large Calvin 91}\\
		{\large 84126, Istanbul, Chiang Rai, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hazel Robert Gunnarsson Ltd } \\
		{\large Jordan 1}\\
		{\large 43825, Madrid, Tuscany, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
