...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julia Sjögren} \\
		{\large Kevin 34}\\
		{\large 27996, Istanbul, Bayern, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Michael Claesson Inc } \\
		{\large Camden 76}\\
		{\large 66637, Frankfurt am Main , Amnat Charoen, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
