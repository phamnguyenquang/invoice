...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Oliver David Pålsson Pte Ltd} \\
		{\large Izabella 38}\\
		{\large 52096, Berlin, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anthony Håkansson } \\
		{\large Kennedy 31}\\
		{\large 86270, London , khanh Hoa, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
