...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Dominic Edward Månsson} \\
		{\large Santiago 76}\\
		{\large 19487, Seoul, Bangkok, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gianna Louise 	 Söderberg Pte Ltd } \\
		{\large Luke 54}\\
		{\large 28625, Frankfurt am Main , Heibei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
