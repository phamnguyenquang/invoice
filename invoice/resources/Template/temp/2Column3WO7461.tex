...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Owen  Alexander  Sundberg Pte Ltd} \\
		{\large Jordan 87}\\
		{\large 26141, Los Angeles, Kentucky, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julianna Sandberg } \\
		{\large Eliza 5}\\
		{\large 78762, Munich, California, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
