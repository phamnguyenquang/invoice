...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Reese Catherine  Nyberg} \\
		{\large Kinsley 85}\\
		{\large 95678, Singapore, khanh Hoa, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emilia  Alexander  Forsberg Corp } \\
		{\large Maddox 35}\\
		{\large 20579, Frankfurt am Main , Heibei, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
