...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  London John Fransson Pte Ltd} \\
		{\large Max 86}\\
		{\large 40014, Frankfurt am Main , Henan, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaleb Svensson } \\
		{\large Oliver 22}\\
		{\large 21818, Washington, Seattles, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
