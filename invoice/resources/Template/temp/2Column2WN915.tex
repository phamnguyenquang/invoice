...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity Holm} \\
		{\large Valeria 33}\\
		{\large 51610, Istanbul, Hessen, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Timothy Christopher Sandström Pte Ltd } \\
		{\large Ximena 1}\\
		{\large 31460, Taipei, Binh Thuan, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
