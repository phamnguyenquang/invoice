...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mary May/Mae 	 Magnusson Corp} \\
		{\large Grayson 60}\\
		{\large 48893, Washington, Amnat Charoen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryder Gustafsson } \\
		{\large Savannah 91}\\
		{\large 66619, Frankfurt am Main , khanh Hoa, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
