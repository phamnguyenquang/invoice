...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Victoria Persson} \\
		{\large Josiah 73}\\
		{\large 75335, Frankfurt am Main , Ang Thong, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Dominic John Mohamed Pte Ltd } \\
		{\large Harper 72}\\
		{\large 36389, Venice, Binh Thuan, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
