...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rachel Fredriksson} \\
		{\large Jordan 2}\\
		{\large 25043, Frankfurt am Main , Buriam, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large London  Alexander  Falk Corp } \\
		{\large Olivia 25}\\
		{\large 36696, Melbourne, Saarland, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
