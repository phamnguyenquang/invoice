...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lilly Lundström} \\
		{\large Michelle 11}\\
		{\large 40022, Frankfurt am Main , Chiang Rai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Giovanni Elizabeth 	 Ekström Corp } \\
		{\large Avery 25}\\
		{\large 32467, Shanghai, Hamburg, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
