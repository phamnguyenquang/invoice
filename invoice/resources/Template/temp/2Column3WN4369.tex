...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Patrick Christopher Dahlberg} \\
		{\large Tucker 3}\\
		{\large 87919, Paris, Hainan, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Micah Jane Pettersson Inc } \\
		{\large Preston 2}\\
		{\large 62987, Vancouver, Indiana, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
