...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kenneth Elizabeth 	 Bergqvist} \\
		{\large Wyatt 57}\\
		{\large 61391, Barcelona, California, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Skylar Marie 	 Ahmed Inc } \\
		{\large Nevaeh 37}\\
		{\large 25060, SaiGon, California, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
