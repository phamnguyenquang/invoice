...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adriana Catherine  Andreasson} \\
		{\large Hayden 79}\\
		{\large 17302, Montreal, Ang Thong, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Richard Ann  Sandberg Corp } \\
		{\large Josephine 25}\\
		{\large 55323, Istanbul, Bangkok, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
