...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adriana Lee  Eklund} \\
		{\large Brooklyn 71}\\
		{\large 57538, Barcelona, Chiang Mai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jordan David Nordin Corp } \\
		{\large Wyatt 40}\\
		{\large 55124, Frankfurt am Main , Ang Thong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
