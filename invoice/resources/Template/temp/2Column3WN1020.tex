...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bradley Victoria Johansson} \\
		{\large Avery 99}\\
		{\large 51418, Frankfurt am Main , Binh Thuan, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathan Louise 	 Persson Pte Ltd } \\
		{\large Christian 53}\\
		{\large 71798, Denver, Phu Yen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
