...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vivian Michael Lindström Pte Ltd} \\
		{\large Andrea 55}\\
		{\large 70425, New York , Hainan, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vanessa Jakobsson } \\
		{\large Emma 84}\\
		{\large 71498, Ho Chi Minh, Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
