...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaleb Anne Hellström} \\
		{\large Olivia 14}\\
		{\large 85723, San Francisco, Bangkok, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brielle Amy  Hansson Inc } \\
		{\large Ella 39}\\
		{\large 84404, Los Angeles, Hessen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
