...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Weston Lee  Gunnarsson Corp} \\
		{\large Mya 46}\\
		{\large 61880, Frankfurt am Main , Chai Nat, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison Mattsson } \\
		{\large Alex 19}\\
		{\large 75037, Washington, Guangdong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
