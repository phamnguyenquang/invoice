...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaliyah James Berg} \\
		{\large Leo 76}\\
		{\large 66870, Tokyo, Hamburg, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaden Christopher Lundin Ltd } \\
		{\large Gracie 94}\\
		{\large 69654, Frankfurt am Main , Huabei, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
