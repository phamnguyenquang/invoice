...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hadley May/Mae 	 Åkesson} \\
		{\large Alyssa 25}\\
		{\large 68279, Montreal, Hawaii, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alan Christopher Gustafsson Corp } \\
		{\large Andrew 41}\\
		{\large 98531, Singapore, Huabei, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
