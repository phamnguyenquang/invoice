...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicholas May/Mae 	 Fredriksson Pte Ltd} \\
		{\large Ezra 69}\\
		{\large 39018, Frankfurt am Main , Heibei, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sydney Svensson } \\
		{\large Layla 53}\\
		{\large 92498, New York , Indiana, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
