...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniel Victoria Bergqvist} \\
		{\large Camila 75}\\
		{\large 61949, Taipei, Indiana, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Santiago Louise 	 Norberg Pte Ltd } \\
		{\large Luke 71}\\
		{\large 71718, Frankfurt am Main , Henan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
