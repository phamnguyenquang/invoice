...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Miguel John Martinsson} \\
		{\large Alexander 20}\\
		{\large 90485, Shanghai, Heibei, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ezekiel Robert Arvidsson Inc } \\
		{\large Timothy 7}\\
		{\large 29554, Abu Dhabi, Henan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
