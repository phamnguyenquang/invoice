...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mackenzie John Wikström} \\
		{\large Jennifer 11}\\
		{\large 37586, Berlin, Hessen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camden  Alexander  Holmgren Pte Ltd } \\
		{\large Julian 50}\\
		{\large 66165, Stuttgart, Hamburg, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
