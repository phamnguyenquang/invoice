...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Easton Marie 	 Fransson} \\
		{\large Jayden 24}\\
		{\large 26474, Budapest, Huabei, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryker Grace 	 Lindqvist Ltd } \\
		{\large Kendall 59}\\
		{\large 52391, Montreal, California, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
