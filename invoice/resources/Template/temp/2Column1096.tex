...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Logan Mårtensson Pte Ltd} \\
		{\large Oscar 20}\\
		{\large 53048, Frankfurt am Main , Chai Nat, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emilia Fransson } \\
		{\large George 18}\\
		{\large 83067, Nha Trang, Indiana, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
