...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Khloe May/Mae 	 Fransson} \\
		{\large Noah 99}\\
		{\large 38352, Budapest, Amnat Charoen, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harrison Louise 	 Lundström Corp } \\
		{\large Isla 49}\\
		{\large 76717, Budapest, Guangdong, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
