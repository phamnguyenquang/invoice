...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bennett Lee  Hellström} \\
		{\large Jonathan 35}\\
		{\large 56172, London , Saarland, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaron Rose 	 Danielsson Inc } \\
		{\large Quinn 65}\\
		{\large 34172, Washington, Heibei, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
