...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vincent Michael Lindholm} \\
		{\large Christopher 83}\\
		{\large 64012, Montreal, Ang Thong, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxson Victoria Gunnarsson Corp } \\
		{\large Kaitlyn 77}\\
		{\large 40503, Frankfurt am Main , Phu Yen, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
