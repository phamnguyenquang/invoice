...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Peyton Catherine  Sandström} \\
		{\large Max 43}\\
		{\large 20937, Toronto, Tuscany, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aiden Anne Bergqvist Corp } \\
		{\large Kylie 61}\\
		{\large 44070, Montreal, Guangzhou, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
