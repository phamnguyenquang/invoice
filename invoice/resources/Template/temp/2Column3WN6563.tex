...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madeline Michael Hassan} \\
		{\large Valerie 79}\\
		{\large 99089, Munich, Hainan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lila Jane Andersson Corp } \\
		{\large Malachi 95}\\
		{\large 86087, Frankfurt am Main , Ang Thong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
