...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Malachi Elizabeth 	 Mattsson Pte Ltd} \\
		{\large Benjamin 93}\\
		{\large 66946, Melbourne, Huabei, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zachary Andersson } \\
		{\large Luna 73}\\
		{\large 79730, Los Angeles, Hamburg, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
