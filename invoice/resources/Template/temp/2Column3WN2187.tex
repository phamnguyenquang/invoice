...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harper Rose 	 Nyberg} \\
		{\large Brian 70}\\
		{\large 82072, Frankfurt am Main , Hessen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabella Louise 	 Håkansson Corp } \\
		{\large Riley 9}\\
		{\large 32684, Rome, Bremen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
