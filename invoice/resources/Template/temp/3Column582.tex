...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  East China University of Science and Technology} \\
		{\large Scarlett 50}\\
		{\large 17976, Lisbon, khanh Hoa, Turkey }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Ariel Lundin } \\
		{\large Max 7}\\
		{\large 92315, New York , Bremen, Indonesia s}\\
    \switchcolumn
