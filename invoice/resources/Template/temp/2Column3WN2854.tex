...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jackson  Alexander  Bergqvist} \\
		{\large Emma 54}\\
		{\large 28210, London , Guangzhou, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Addison Anne Martinsson Ltd } \\
		{\large Mateo 39}\\
		{\large 39961, Istanbul, Bayern, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
