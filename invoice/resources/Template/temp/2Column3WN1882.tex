...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elise  Alexander  Åkesson} \\
		{\large Ryder 65}\\
		{\large 91491, Vienna, Saarland, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Oliver Michael Lindgren Ltd } \\
		{\large Alice 70}\\
		{\large 34740, Frankfurt am Main , Hessen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
