...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isaac Victoria Mohamed} \\
		{\large Allison 79}\\
		{\large 25443, Sydney, Amnat Charoen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Axel Louise 	 Wallin Inc } \\
		{\large Olivia 38}\\
		{\large 62359, Melbourne, Chiang Rai, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
