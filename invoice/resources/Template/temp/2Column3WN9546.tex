...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariel Victoria Fransson} \\
		{\large Bryson 55}\\
		{\large 66578, Frankfurt am Main , Amnat Charoen, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sofia Victoria Sjögren Ltd } \\
		{\large Kai 34}\\
		{\large 44911, Frankfurt am Main , Bangkok, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
