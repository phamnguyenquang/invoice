...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Noah Eliasson} \\
		{\large Harmony 64}\\
		{\large 42470, Frankfurt am Main , Heibei, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large London Anne Martinsson Pte Ltd } \\
		{\large Charlotte 26}\\
		{\large 45512, Boston, Kentucky, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
