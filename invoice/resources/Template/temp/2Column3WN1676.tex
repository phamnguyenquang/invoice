...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathan May/Mae 	 Larsson} \\
		{\large Jose 33}\\
		{\large 46648, Hong Kong, Guangdong, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gavin May/Mae 	 Lindholm Corp } \\
		{\large Charles 83}\\
		{\large 81445, Melbourne, Saarland, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
