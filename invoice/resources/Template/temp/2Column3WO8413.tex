...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joshua Catherine  Fredriksson Corp} \\
		{\large Jayce 12}\\
		{\large 15305, Frankfurt am Main , Guangzhou, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian Bergström } \\
		{\large Stella 96}\\
		{\large 33045, Dublin, Tuscany, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
