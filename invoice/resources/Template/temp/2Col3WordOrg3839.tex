...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie Christopher Berglund Inc} \\
		{\large Angel 63}\\
		{\large 53315, Ho Chi Minh, Saarland, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mackenzie Forsberg } \\
		{\large Katherine 81}\\
		{\large 88631, Tokyo, Bangkok, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
