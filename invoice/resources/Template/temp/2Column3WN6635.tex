...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Skylar Louise 	 Hermansson} \\
		{\large Madison 89}\\
		{\large 92153, Moscow, Tuscany, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabella Anne Bergström Pte Ltd } \\
		{\large Brandon 49}\\
		{\large 49156, Los Angeles, Amnat Charoen, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
