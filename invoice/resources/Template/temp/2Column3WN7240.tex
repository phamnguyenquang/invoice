...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayla Thomas Nordström} \\
		{\large Morgan 63}\\
		{\large 97489, Washington, Binh Thuan, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Rose 	 Pettersson Pte Ltd } \\
		{\large Antonio 97}\\
		{\large 56067, Frankfurt am Main , Tuscany, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
