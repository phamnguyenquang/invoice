...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melanie  Alexander  Larsson} \\
		{\large Emma 36}\\
		{\large 63532, Hong Kong, khanh Hoa, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mary Louise 	 Lindqvist Pte Ltd } \\
		{\large Julia 89}\\
		{\large 95221, Frankfurt am Main , Henan, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
