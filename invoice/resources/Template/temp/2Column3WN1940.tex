...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Chloe May/Mae 	 Karlsson} \\
		{\large Kennedy 58}\\
		{\large 51890, Florence, Huabei, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hunter Jane Holmgren Corp } \\
		{\large Alexandra 62}\\
		{\large 24665, Shanghai, Ang Thong, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
