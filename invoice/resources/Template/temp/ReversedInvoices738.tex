...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Beijing University of Technology} \\
		{\large Layla 58}\\
		{\large 35013, Boston, Hessen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gracie Svensson } \\
		{\large Gavin 74}\\
		{\large 53277, Frankfurt am Main , khanh Hoa, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
