...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alex Grace 	 Mårtensson Pte Ltd} \\
		{\large Alyssa 90}\\
		{\large 83572, Berlin, California, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexa Mårtensson } \\
		{\large Ariana 81}\\
		{\large 22055, Istanbul, Amnat Charoen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
