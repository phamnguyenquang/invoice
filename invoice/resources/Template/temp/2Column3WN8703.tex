...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Thomas Kate 	 Mårtensson} \\
		{\large Vivian 70}\\
		{\large 15840, Sydney, Hessen, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Dominic William Lundström Inc } \\
		{\large Eliza 9}\\
		{\large 96611, Frankfurt am Main , Buriam, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
