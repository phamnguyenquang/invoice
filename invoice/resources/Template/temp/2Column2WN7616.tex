...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adam Hansen} \\
		{\large Brian 34}\\
		{\large 22036, Frankfurt am Main , Tuscany, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aidan Catherine  Lundqvist Ltd } \\
		{\large Christian 91}\\
		{\large 80397, Dubai, khanh Hoa, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
