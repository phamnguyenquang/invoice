...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gavin Louise 	 Sjöberg Pte Ltd} \\
		{\large Autumn 12}\\
		{\large 98886, Boston, Amnat Charoen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayden Bengtsson } \\
		{\large Piper 89}\\
		{\large 32253, Osaka, California, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
