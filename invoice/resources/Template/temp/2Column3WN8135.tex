...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabel May/Mae 	 Hellström} \\
		{\large Alejandro 63}\\
		{\large 99191, Budapest, Bremen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sofia Catherine  Söderberg Ltd } \\
		{\large Everett 65}\\
		{\large 96859, Istanbul, Chiang Mai, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
