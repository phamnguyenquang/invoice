...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Savannah Robert Hellström} \\
		{\large Arianna 49}\\
		{\large 97624, Venice, Guangdong, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley James Dahlberg Corp } \\
		{\large Alejandro 56}\\
		{\large 14452, Barcelona, Chai Nat, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
