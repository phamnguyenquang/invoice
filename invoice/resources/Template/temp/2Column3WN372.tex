...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina Elizabeth 	 Engström} \\
		{\large Mason 24}\\
		{\large 85399, Ho Chi Minh, Seattles, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liliana Mary 	 Fredriksson Pte Ltd } \\
		{\large Taylor 50}\\
		{\large 86220, Shanghai, Hawaii, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
