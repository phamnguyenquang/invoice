...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sophia John Hermansson} \\
		{\large Ryker 96}\\
		{\large 98904, Istanbul, Tuscany, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josephine Jane Fredriksson Corp } \\
		{\large Avery 83}\\
		{\large 31079, Milan, Phu Yen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
