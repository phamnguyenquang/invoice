...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luke Elizabeth 	 Strömberg} \\
		{\large Miguel 68}\\
		{\large 62094, SaiGon, Bayern, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian Catherine  Bengtsson Pte Ltd } \\
		{\large Mateo 64}\\
		{\large 38878, Hong Kong, Hamburg, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
