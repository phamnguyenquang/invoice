...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon Thomas Holm} \\
		{\large Marcus 75}\\
		{\large 42185, Shanghai, Chiang Rai, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Austin Lee  Samuelsson Ltd } \\
		{\large Brayden 42}\\
		{\large 56231, Frankfurt am Main , Amnat Charoen, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
