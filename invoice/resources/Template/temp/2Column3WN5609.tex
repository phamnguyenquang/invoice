...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ivy Anne Söderberg} \\
		{\large Gabrielle 68}\\
		{\large 47790, Istanbul, Floria, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liliana Catherine  Sundberg Pte Ltd } \\
		{\large Ariana 10}\\
		{\large 29589, Sydney, Ang Thong, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
