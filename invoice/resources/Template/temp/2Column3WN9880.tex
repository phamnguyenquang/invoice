...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ian Louise 	 Johansson} \\
		{\large Valeria 19}\\
		{\large 46108, Beijing, Amnat Charoen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luis  Alexander  Gustafsson Inc } \\
		{\large Ryker 98}\\
		{\large 46131, Lisbon, Bayern, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
