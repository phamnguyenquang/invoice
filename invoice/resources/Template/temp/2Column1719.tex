...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katelyn Forsberg Corp} \\
		{\large Alexa 40}\\
		{\large 37314, Washington, khanh Hoa, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brayden Persson } \\
		{\large Claire 95}\\
		{\large 69574, Frankfurt am Main , Guangzhou, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
