...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Laila Christopher Ahmed Pte Ltd} \\
		{\large Riley 67}\\
		{\large 73737, Frankfurt am Main , Hamburg, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas Nyström } \\
		{\large Brooklyn 71}\\
		{\large 60754, Nha Trang, Guangzhou, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
