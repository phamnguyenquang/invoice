...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lydia Ann  Jönsson Ltd} \\
		{\large Jose 16}\\
		{\large 93749, Frankfurt am Main , Binh Thuan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hailey Hassan } \\
		{\large Layla 27}\\
		{\large 94102, Budapest, Floria, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
