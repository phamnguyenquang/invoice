...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Delilah  Alexander  Svensson} \\
		{\large Summer 86}\\
		{\large 41469, SaiGon, California, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lila Louise 	 Hansson Corp } \\
		{\large Gavin 28}\\
		{\large 69610, Milan, Bayern, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
