...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liam Robert Sjöberg} \\
		{\large Cameron 39}\\
		{\large 77909, Hong Kong, Chai Nat, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ayden Christopher Dahlberg Pte Ltd } \\
		{\large Alan 65}\\
		{\large 51323, Ho Chi Minh, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
