...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte Louise 	 Lindström Corp} \\
		{\large Colin 51}\\
		{\large 13808, Frankfurt am Main , California, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lauren Andersson } \\
		{\large Leilani 19}\\
		{\large 52614, New York , Tuscany, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
