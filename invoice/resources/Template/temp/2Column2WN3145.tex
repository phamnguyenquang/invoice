...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valentina Abrahamsson} \\
		{\large Maverick 18}\\
		{\large 24969, Montreal, California, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elijah Victoria Holmgren Corp } \\
		{\large Claire 3}\\
		{\large 78565, Montreal, Saarland, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
