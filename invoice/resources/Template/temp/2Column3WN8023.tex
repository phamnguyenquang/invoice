...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aurora Marie 	 Berglund} \\
		{\large Avery 98}\\
		{\large 98050, SaiGon, Bayern, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Declan Thomas Lindström Pte Ltd } \\
		{\large Owen 69}\\
		{\large 14049, Hong Kong, Kentucky, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
