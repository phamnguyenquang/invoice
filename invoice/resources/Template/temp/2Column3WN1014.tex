...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Christopher Blomqvist} \\
		{\large Jocelyn 50}\\
		{\large 30569, Amsterdam, Heibei, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leah Kate 	 Nilsson Ltd } \\
		{\large Morgan 39}\\
		{\large 61714, Berlin, Saarland, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
