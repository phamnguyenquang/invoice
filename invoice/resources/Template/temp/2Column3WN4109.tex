...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jacob Christopher Mårtensson} \\
		{\large Kai 18}\\
		{\large 82170, Ho Chi Minh, khanh Hoa, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathaniel Peter Holmgren Corp } \\
		{\large King 23}\\
		{\large 95373, Beijing, Texas, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
