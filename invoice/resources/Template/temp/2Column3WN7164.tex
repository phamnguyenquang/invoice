...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vivian Victoria Ahmed} \\
		{\large Hailey 12}\\
		{\large 46968, Madrid, Hessen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalia Victoria Nordström Pte Ltd } \\
		{\large Kayden 35}\\
		{\large 10393, Frankfurt am Main , Bayern, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
