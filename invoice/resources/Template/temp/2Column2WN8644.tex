...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Eliasson} \\
		{\large Natalia 38}\\
		{\large 69563, Frankfurt am Main , Hawaii, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kevin William Jönsson Pte Ltd } \\
		{\large Cole 44}\\
		{\large 22360, Minsk, California, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
