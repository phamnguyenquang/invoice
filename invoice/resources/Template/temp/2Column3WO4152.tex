...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sawyer Christopher Martinsson Ltd} \\
		{\large Tristan 61}\\
		{\large 80321, Chicago, Floria, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Laila Månsson } \\
		{\large Tucker 53}\\
		{\large 29485, San Francisco, Hamburg, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
