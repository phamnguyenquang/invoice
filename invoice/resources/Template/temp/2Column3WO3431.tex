...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liliana Victoria Fransson Pte Ltd} \\
		{\large Maximus 40}\\
		{\large 31640, Florence, Kentucky, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmanuel Olsson } \\
		{\large Bella 37}\\
		{\large 54100, Frankfurt am Main , Buriam, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
