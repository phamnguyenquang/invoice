...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Autumn Amy  Hermansson} \\
		{\large Brandon 83}\\
		{\large 80040, Frankfurt am Main , California, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jade Thomas Danielsson Pte Ltd } \\
		{\large Declan 54}\\
		{\large 84760, Boston, Heibei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
