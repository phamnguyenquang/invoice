...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madison Danielsson} \\
		{\large Emma 33}\\
		{\large 25557, Hanoi, Indiana, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kenneth Victoria Lindström Pte Ltd } \\
		{\large Carlos 54}\\
		{\large 23857, Last Vegas, Saarland, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
