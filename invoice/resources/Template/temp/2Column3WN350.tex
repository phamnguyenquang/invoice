...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luis Elizabeth 	 Åberg} \\
		{\large Dominic 98}\\
		{\large 75174, Los Angeles, Heibei, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cole Elizabeth 	 Olsson Ltd } \\
		{\large Stephanie 47}\\
		{\large 76003, London , Hessen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
