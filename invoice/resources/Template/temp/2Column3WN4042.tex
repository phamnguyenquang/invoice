...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leilani Rose 	 Pettersson} \\
		{\large Gianna 20}\\
		{\large 50321, Ho Chi Minh, Hawaii, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan Jane Eliasson Corp } \\
		{\large Jeremy 93}\\
		{\large 98828, Shanghai, Heibei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
