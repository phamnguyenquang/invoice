...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victoria Kate 	 Björklund Pte Ltd} \\
		{\large Sawyer 35}\\
		{\large 87352, Berlin, Guangdong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalia Hellström } \\
		{\large Thomas 3}\\
		{\large 42364, Hong Kong, Hamburg, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
