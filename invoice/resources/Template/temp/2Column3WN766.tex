...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maya James Andreasson} \\
		{\large Alyssa 71}\\
		{\large 64393, New York , Bayern, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harper Thomas Andreasson Pte Ltd } \\
		{\large Nicholas 27}\\
		{\large 84991, Osaka, Seattles, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
