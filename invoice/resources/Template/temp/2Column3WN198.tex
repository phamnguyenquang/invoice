...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Clara Michael Gunnarsson} \\
		{\large Sean 99}\\
		{\large 34873, Berlin, Bangkok, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wesley Christopher Lind Pte Ltd } \\
		{\large Emilia 23}\\
		{\large 94755, Lisbon, Phu Yen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
