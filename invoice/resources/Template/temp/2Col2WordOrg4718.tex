...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everett Martinsson Pte Ltd} \\
		{\large Nathaniel 41}\\
		{\large 29407, Frankfurt am Main , Guangdong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte Jansson } \\
		{\large Margaret 93}\\
		{\large 98520, SaiGon, Texas, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
