...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Richard Abrahamsson} \\
		{\large Samantha 30}\\
		{\large 70690, SaiGon, khanh Hoa, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maximus Christopher Sjögren Ltd } \\
		{\large Summer 79}\\
		{\large 68366, Florence, Seattles, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
