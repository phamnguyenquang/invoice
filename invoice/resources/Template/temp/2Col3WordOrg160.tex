...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity James Lindgren Pte Ltd} \\
		{\large Clara 48}\\
		{\large 18083, Beijing, Seattles, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camden Arvidsson } \\
		{\large Mackenzie 93}\\
		{\large 26651, Toronto, Guangdong, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
