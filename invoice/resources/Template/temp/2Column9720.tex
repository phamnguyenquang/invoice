...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Catherine Björklund Ltd} \\
		{\large Michelle 33}\\
		{\large 57192, Frankfurt am Main , Amnat Charoen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aliyah Lundgren } \\
		{\large Anthony 47}\\
		{\large 93969, Minsk, Heibei, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
