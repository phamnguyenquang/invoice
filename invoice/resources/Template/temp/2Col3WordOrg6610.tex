...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Skylar Louise 	 Larsson Inc} \\
		{\large Allison 52}\\
		{\large 15890, Frankfurt am Main , Bremen, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Damian Martinsson } \\
		{\large Nicholas 97}\\
		{\large 24752, Frankfurt am Main , Kentucky, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
