...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valerie Elizabeth 	 Fransson} \\
		{\large Avery 80}\\
		{\large 54816, Nha Trang, Chiang Rai, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bennett Marie 	 Sandström Pte Ltd } \\
		{\large Leah 67}\\
		{\large 98352, Stuttgart, Bremen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
