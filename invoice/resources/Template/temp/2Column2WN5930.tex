...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Braxton Holmberg} \\
		{\large Malachi 53}\\
		{\large 20001, Budapest, Chiang Mai, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cooper  Alexander  Karlsson Pte Ltd } \\
		{\large Maxwell 8}\\
		{\large 52515, Singapore, Phu Yen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
