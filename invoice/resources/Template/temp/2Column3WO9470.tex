...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kenneth Edward Blomqvist Corp} \\
		{\large Jacob 56}\\
		{\large 95423, Abu Dhabi, Amnat Charoen, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucas Henriksson } \\
		{\large Ryker 18}\\
		{\large 94282, Vancouver, Hessen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
