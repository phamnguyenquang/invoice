...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luna Axelsson} \\
		{\large Valeria 37}\\
		{\large 86121, SaiGon, Floria, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cameron Elizabeth 	 Månsson Pte Ltd } \\
		{\large Leilani 7}\\
		{\large 61504, Frankfurt am Main , California, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
