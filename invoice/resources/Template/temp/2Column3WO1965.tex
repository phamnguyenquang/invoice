...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Camden Ann  Mohamed Pte Ltd} \\
		{\large Maverick 52}\\
		{\large 25937, Frankfurt am Main , Texas, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kingston Persson } \\
		{\large Tristan 39}\\
		{\large 67171, London , Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
