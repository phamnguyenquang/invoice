...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adalynn Thomas Karlsson} \\
		{\large Daniel 56}\\
		{\large 36714, Madrid, Amnat Charoen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large William Louise 	 Eliasson Corp } \\
		{\large Alexandra 37}\\
		{\large 75472, Barcelona, Seattles, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
