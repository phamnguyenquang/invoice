...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Destiny Grace 	 Hellström} \\
		{\large Benjamin 27}\\
		{\large 77022, Frankfurt am Main , Hessen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexandra  Alexander  Sjögren Inc } \\
		{\large Leilani 53}\\
		{\large 51069, Nha Trang, Bayern, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
