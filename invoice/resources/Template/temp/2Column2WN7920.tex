...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brody Blomqvist} \\
		{\large Mariah 56}\\
		{\large 88935, San Francisco, Chiang Rai, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryan Elizabeth 	 Magnusson Corp } \\
		{\large Clara 48}\\
		{\large 13698, Last Vegas, Chiang Rai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
