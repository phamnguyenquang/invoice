...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte Catherine  Abrahamsson Ltd} \\
		{\large Giovanni 29}\\
		{\large 53946, Abu Dhabi, Chai Nat, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden Åberg } \\
		{\large Londyn 94}\\
		{\large 59492, Frankfurt am Main , Guangdong, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
