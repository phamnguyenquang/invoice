...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Noah Catherine  Abrahamsson Pte Ltd} \\
		{\large Kennedy 95}\\
		{\large 96614, Stuttgart, Hessen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie Sandberg } \\
		{\large Adrian 94}\\
		{\large 24574, Montreal, Seattles, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
