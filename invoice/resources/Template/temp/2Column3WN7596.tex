...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aidan Elizabeth 	 Lundberg} \\
		{\large Kendall 46}\\
		{\large 46957, Last Vegas, khanh Hoa, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Michael Jonsson Inc } \\
		{\large Matthew 90}\\
		{\large 33638, Frankfurt am Main , Guangzhou, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
