...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriella Abrahamsson} \\
		{\large Katherine 45}\\
		{\large 71651, Madrid, Guangdong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Patrick Mary 	 Magnusson Pte Ltd } \\
		{\large Ezra 12}\\
		{\large 81357, Taipei, Binh Thuan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
