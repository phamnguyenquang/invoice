...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elias Michael Bergström} \\
		{\large Athena 18}\\
		{\large 55327, Lisbon, Buriam, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Michael Eklund Corp } \\
		{\large Jaxson 85}\\
		{\large 68807, Frankfurt am Main , Ang Thong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
