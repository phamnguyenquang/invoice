...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liam May/Mae 	 Holmgren} \\
		{\large Aaron 39}\\
		{\large 71875, Chicago, Seattles, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lily Christopher Lindberg Pte Ltd } \\
		{\large Valerie 49}\\
		{\large 47392, Shanghai, Bangkok, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
