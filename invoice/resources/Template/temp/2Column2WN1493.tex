...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hunter Söderberg} \\
		{\large Alyssa 5}\\
		{\large 36599, Tokyo, Huabei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Londyn May/Mae 	 Andersson Corp } \\
		{\large Mason 54}\\
		{\large 37074, Frankfurt am Main , Chiang Mai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
