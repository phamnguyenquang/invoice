...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leo Robert Johansson} \\
		{\large Paige 13}\\
		{\large 90858, Venice, Hainan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayden Thomas Hellström Pte Ltd } \\
		{\large Cayden 37}\\
		{\large 10585, Istanbul, Ang Thong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
