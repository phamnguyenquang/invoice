...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Max Rose 	 Lundström Corp} \\
		{\large Jacob 72}\\
		{\large 33512, San Francisco, Chai Nat, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Londyn Eliasson } \\
		{\large Carlos 61}\\
		{\large 47175, Frankfurt am Main , khanh Hoa, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
