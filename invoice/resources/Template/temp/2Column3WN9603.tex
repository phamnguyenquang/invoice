...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sadie Thomas Ali} \\
		{\large Malachi 54}\\
		{\large 61373, Barcelona, Tuscany, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wyatt Amy  Blomqvist Pte Ltd } \\
		{\large Jonathan 77}\\
		{\large 20564, San Francisco, Chiang Rai, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
