...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rylee Victoria Hellström} \\
		{\large Eden 27}\\
		{\large 92994, Vienna, Hamburg, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isla May/Mae 	 Blomqvist Ltd } \\
		{\large Audrey 9}\\
		{\large 70816, Frankfurt am Main , Ang Thong, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
