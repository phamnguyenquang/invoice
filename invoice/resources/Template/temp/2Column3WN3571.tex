...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Izabella Louise 	 Samuelsson} \\
		{\large Antonio 72}\\
		{\large 71908, Abu Dhabi, Guangzhou, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Justin Louise 	 Olsson Corp } \\
		{\large Penelope 44}\\
		{\large 61835, San Francisco, Floria, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
