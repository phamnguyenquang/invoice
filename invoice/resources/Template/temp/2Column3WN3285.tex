...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aubrey Christopher Lund} \\
		{\large Noah 36}\\
		{\large 22530, Los Angeles, Hessen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Clara Elizabeth 	 Mattsson Corp } \\
		{\large Kevin 6}\\
		{\large 13076, Amsterdam, Guangzhou, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
