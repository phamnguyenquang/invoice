...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Levi Louise 	 Nordström} \\
		{\large Abel 33}\\
		{\large 70242, Budapest, Bangkok, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kenneth David Hedlund Pte Ltd } \\
		{\large Samuel 43}\\
		{\large 61321, Frankfurt am Main , Texas, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
