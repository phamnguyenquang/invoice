...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lyla Ann  Ström} \\
		{\large Paul 41}\\
		{\large 51225, Boston, Binh Thuan, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angelina Elizabeth 	 Bergström Pte Ltd } \\
		{\large Alexis 66}\\
		{\large 12696, Los Angeles, Buriam, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
