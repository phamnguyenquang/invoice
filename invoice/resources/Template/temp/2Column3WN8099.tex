...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emilia Victoria Bergqvist} \\
		{\large Malachi 96}\\
		{\large 99108, Hanoi, Chiang Mai, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kinsley Elizabeth 	 Lundqvist Corp } \\
		{\large Ivy 99}\\
		{\large 52203, San Francisco, Bayern, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
