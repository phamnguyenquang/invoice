...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bennett Bergqvist} \\
		{\large Daisy 3}\\
		{\large 36681, Moscow, Heibei, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Jane Pettersson Pte Ltd } \\
		{\large Rylee 34}\\
		{\large 91431, Melbourne, Kentucky, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
