...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ethan  Alexander  Olsson} \\
		{\large Aria 59}\\
		{\large 65920, Frankfurt am Main , Hessen, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Adalynn Christopher Håkansson Pte Ltd } \\
		{\large Logan 90}\\
		{\large 89312, Stuttgart, Bayern, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
