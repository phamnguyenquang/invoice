...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesse Marie 	 Dahlberg Ltd} \\
		{\large Brooke 22}\\
		{\large 87036, Frankfurt am Main , Hainan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abel Mårtensson } \\
		{\large Thomas 88}\\
		{\large 82816, Washington, Ang Thong, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
