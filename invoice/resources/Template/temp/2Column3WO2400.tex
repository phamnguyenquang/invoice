...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Riley  Alexander  Nyström Pte Ltd} \\
		{\large Samuel 39}\\
		{\large 79702, Chicago, Chiang Mai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrew Mårtensson } \\
		{\large Mackenzie 5}\\
		{\large 33872, Dublin, Guangzhou, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
