...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michael Peter Lundqvist} \\
		{\large Ian 59}\\
		{\large 22691, Frankfurt am Main , Guangdong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ruby Elizabeth 	 Andreasson Inc } \\
		{\large Declan 10}\\
		{\large 39315, Montreal, Chiang Rai, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
