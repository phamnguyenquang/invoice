...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles Robert Forsberg Ltd} \\
		{\large Margaret 29}\\
		{\large 17622, Frankfurt am Main , Phu Yen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harmony Eliasson } \\
		{\large Richard 1}\\
		{\large 48787, Melbourne, Guangzhou, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
