...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alyssa Elizabeth 	 Bengtsson} \\
		{\large Brantley 7}\\
		{\large 66337, Istanbul, Indiana, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Athena Louise 	 Danielsson Pte Ltd } \\
		{\large Vincent 67}\\
		{\large 87856, Toronto, Guangzhou, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
