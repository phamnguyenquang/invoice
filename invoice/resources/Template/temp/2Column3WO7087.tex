...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mary Robert Nyström Corp} \\
		{\large Jonah 48}\\
		{\large 31760, Frankfurt am Main , Chiang Mai, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson Viklund } \\
		{\large Sadie 58}\\
		{\large 51514, Melbourne, Chai Nat, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
