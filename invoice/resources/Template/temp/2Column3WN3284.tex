...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zachary Christopher Jansson} \\
		{\large Liliana 87}\\
		{\large 72514, Stuttgart, Binh Thuan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryan Mary 	 Pettersson Pte Ltd } \\
		{\large Nathan 34}\\
		{\large 67295, Amsterdam, Chiang Rai, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
