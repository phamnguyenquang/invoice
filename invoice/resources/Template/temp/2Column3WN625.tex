...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalia Christopher Henriksson} \\
		{\large Mia 92}\\
		{\large 93106, Istanbul, Bangkok, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madeline Rose 	 Hedlund Corp } \\
		{\large Julia 81}\\
		{\large 95615, Singapore, Hessen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
