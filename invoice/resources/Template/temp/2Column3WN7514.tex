...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Amelia Christopher Eklund} \\
		{\large Logan 17}\\
		{\large 51953, Frankfurt am Main , Bangkok, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryan  Alexander  Svensson Ltd } \\
		{\large Angelina 93}\\
		{\large 96189, Ho Chi Minh, Hessen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
