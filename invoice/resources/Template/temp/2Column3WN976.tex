...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jake Michael Bergqvist} \\
		{\large Cayden 28}\\
		{\large 80611, Stuttgart, Hawaii, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madeline Catherine  Mattsson Inc } \\
		{\large Logan 34}\\
		{\large 34571, Hong Kong, Hainan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
