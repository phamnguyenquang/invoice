...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jordyn Mårtensson} \\
		{\large Adalyn 14}\\
		{\large 76331, Berlin, Phu Yen, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Robert Anne Johansson Pte Ltd } \\
		{\large Daniel 91}\\
		{\large 25001, Frankfurt am Main , Chiang Rai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
