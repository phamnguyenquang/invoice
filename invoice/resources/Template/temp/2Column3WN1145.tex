...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Laila Michael Blomqvist} \\
		{\large Brayden 71}\\
		{\large 18263, Rome, Guangdong, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremy Louise 	 Gunnarsson Inc } \\
		{\large Stephanie 26}\\
		{\large 94592, Los Angeles, Henan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
