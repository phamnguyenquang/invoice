...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Maryland, Baltimore County} \\
		{\large Emma 30}\\
		{\large 30147, Frankfurt am Main , Chiang Rai, Germany }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Penelope Fransson } \\
		{\large Gianna 89}\\
		{\large 20181, Stuttgart, Floria, United State }\\
    \switchcolumn
