...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tristan Victoria Jansson Ltd} \\
		{\large Easton 4}\\
		{\large 89056, Frankfurt am Main , Hainan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Damian Nyberg } \\
		{\large Christian 15}\\
		{\large 34216, Barcelona, khanh Hoa, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
