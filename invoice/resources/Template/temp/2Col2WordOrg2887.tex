...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lincoln Johansson Ltd} \\
		{\large Lyla 57}\\
		{\large 23467, Ho Chi Minh, khanh Hoa, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathaniel Jonsson } \\
		{\large Rose 42}\\
		{\large 81279, Frankfurt am Main , Hainan, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
