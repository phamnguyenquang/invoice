...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liam Victoria Samuelsson} \\
		{\large Justin 37}\\
		{\large 52273, Last Vegas, Seattles, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mason May/Mae 	 Lindqvist Corp } \\
		{\large Jaden 26}\\
		{\large 94954, Montreal, Seattles, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
