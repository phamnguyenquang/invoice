...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Connor Karlsson} \\
		{\large Oscar 34}\\
		{\large 36716, Berlin, Kentucky, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angel Christopher Hermansson Corp } \\
		{\large Eva 83}\\
		{\large 55305, Frankfurt am Main , Kentucky, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
