...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jennifer Peter Abrahamsson Pte Ltd} \\
		{\large Isla 68}\\
		{\large 76888, San Francisco, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kinsley Ström } \\
		{\large Lucas 81}\\
		{\large 65569, Chicago, Guangzhou, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
