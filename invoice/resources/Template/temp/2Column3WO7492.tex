...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eliana  Alexander  Danielsson Inc} \\
		{\large Ryker 51}\\
		{\large 91116, Vienna, Amnat Charoen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brielle Falk } \\
		{\large Calvin 88}\\
		{\large 69545, Frankfurt am Main , Huabei, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
