...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie Christopher Lindberg Pte Ltd} \\
		{\large Zoe 78}\\
		{\large 44364, Dubai, Hamburg, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bailey Danielsson } \\
		{\large Margaret 3}\\
		{\large 71707, Los Angeles, Bayern, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
