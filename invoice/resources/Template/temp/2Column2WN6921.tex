...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Parker Hedlund} \\
		{\large Victor 95}\\
		{\large 43350, Frankfurt am Main , Bangkok, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sydney Amy  Nordin Corp } \\
		{\large Kai 95}\\
		{\large 92887, Frankfurt am Main , Hamburg, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
