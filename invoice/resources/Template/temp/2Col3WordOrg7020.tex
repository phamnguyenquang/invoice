...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaiden Grace 	 Olofsson Inc} \\
		{\large Jason 26}\\
		{\large 52059, Hanoi, Binh Thuan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremy Lundberg } \\
		{\large Emily 13}\\
		{\large 18726, Frankfurt am Main , Chiang Rai, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
