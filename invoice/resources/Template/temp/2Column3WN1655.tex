...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Clara Christopher Ek} \\
		{\large Londyn 90}\\
		{\large 21607, Montreal, Amnat Charoen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hadley Louise 	 Strömberg Inc } \\
		{\large Landon 2}\\
		{\large 75854, San Francisco, Hessen, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
