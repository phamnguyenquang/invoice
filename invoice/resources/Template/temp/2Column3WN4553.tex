...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mateo Mary 	 Gunnarsson} \\
		{\large Maddox 17}\\
		{\large 12720, Boston, Ang Thong, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden Amy  Bergman Corp } \\
		{\large Richard 13}\\
		{\large 67739, Frankfurt am Main , Heibei, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
