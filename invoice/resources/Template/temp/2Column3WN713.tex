...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Willow William Claesson} \\
		{\large Alice 12}\\
		{\large 39941, Toronto, Bayern, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Asher Louise 	 Björklund Pte Ltd } \\
		{\large Everett 9}\\
		{\large 56784, Last Vegas, Saarland, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
