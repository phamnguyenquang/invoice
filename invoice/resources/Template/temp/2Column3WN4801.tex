...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremiah Robert Lund} \\
		{\large Bryan 84}\\
		{\large 68793, Hong Kong, Chai Nat, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valeria Elizabeth 	 Nyberg Pte Ltd } \\
		{\large Samuel 44}\\
		{\large 40702, Barcelona, Ang Thong, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
