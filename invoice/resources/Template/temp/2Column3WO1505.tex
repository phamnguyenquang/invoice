...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gianna Louise 	 Andersson Pte Ltd} \\
		{\large Leo 25}\\
		{\large 45998, Frankfurt am Main , Amnat Charoen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ethan Björklund } \\
		{\large Delilah 7}\\
		{\large 35568, SaiGon, Amnat Charoen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
