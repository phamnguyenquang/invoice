...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Antonio Marie 	 Bergman} \\
		{\large Trinity 18}\\
		{\large 90421, San Francisco, Ang Thong, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremiah Kate 	 Viklund Inc } \\
		{\large Margaret 45}\\
		{\large 16350, Rome, California, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
