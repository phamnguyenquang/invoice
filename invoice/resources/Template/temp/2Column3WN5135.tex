...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina Christopher Sandberg} \\
		{\large Ashton 26}\\
		{\large 64440, Frankfurt am Main , Chiang Rai, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maddox Rose 	 Hansson Ltd } \\
		{\large Lilly 90}\\
		{\large 49973, Last Vegas, Hainan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
