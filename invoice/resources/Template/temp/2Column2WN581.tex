...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria Blomqvist} \\
		{\large Aliyah 76}\\
		{\large 99481, Frankfurt am Main , California, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large William Louise 	 Månsson Corp } \\
		{\large Vanessa 46}\\
		{\large 81492, Chicago, Floria, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
