...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kingston Christopher Blomqvist} \\
		{\large Aria 19}\\
		{\large 31934, Berlin, Floria, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Max May/Mae 	 Söderberg Corp } \\
		{\large Savannah 27}\\
		{\large 30325, Amsterdam, Guangdong, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
