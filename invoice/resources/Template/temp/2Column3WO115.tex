...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Matthew David Bengtsson Inc} \\
		{\large Mackenzie 99}\\
		{\large 54881, Dublin, Saarland, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Logan Holmberg } \\
		{\large Gael 36}\\
		{\large 28599, Frankfurt am Main , Ang Thong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
