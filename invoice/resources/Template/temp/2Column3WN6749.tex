...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lucas  Alexander  Henriksson} \\
		{\large Natalia 13}\\
		{\large 97312, Osaka, Guangzhou, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Noah David Hermansson Inc } \\
		{\large Mia 31}\\
		{\large 29133, Abu Dhabi, Seattles, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
