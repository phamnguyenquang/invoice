...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Wyatt Claesson} \\
		{\large Jayden 74}\\
		{\large 27746, Hong Kong, Phu Yen, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Benjamin  Alexander  Nordström Corp } \\
		{\large Matthew 18}\\
		{\large 25768, Frankfurt am Main , Guangdong, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
