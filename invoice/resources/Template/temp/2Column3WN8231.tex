...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley John Henriksson} \\
		{\large Andrea 48}\\
		{\large 52929, Singapore, Chiang Mai, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alejandro Louise 	 Persson Pte Ltd } \\
		{\large Jayden 4}\\
		{\large 79217, SaiGon, Floria, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
