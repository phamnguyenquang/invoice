...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abigail Ann  Johansson} \\
		{\large Vivian 49}\\
		{\large 30326, Berlin, Indiana, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large London Catherine  Gustafsson Ltd } \\
		{\large Natalia 23}\\
		{\large 56958, Amsterdam, Floria, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
