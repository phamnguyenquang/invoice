...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jasmine William Fredriksson} \\
		{\large Christopher 41}\\
		{\large 50296, New York , Saarland, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daisy Christopher Lundqvist Corp } \\
		{\large Jeremy 12}\\
		{\large 54841, Melbourne, Bangkok, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
