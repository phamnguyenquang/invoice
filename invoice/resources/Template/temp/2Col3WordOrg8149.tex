...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Destiny Amy  Abrahamsson Inc} \\
		{\large Alejandro 85}\\
		{\large 97663, Vancouver, Hamburg, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Malachi Ekström } \\
		{\large Sawyer 51}\\
		{\large 58144, Frankfurt am Main , Bayern, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
