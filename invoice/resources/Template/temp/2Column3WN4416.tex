...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sara Thomas Gustafsson} \\
		{\large Londyn 74}\\
		{\large 41047, Hong Kong, Chiang Rai, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leah William Mattsson Pte Ltd } \\
		{\large Ethan 88}\\
		{\large 18959, Ho Chi Minh, Huabei, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
