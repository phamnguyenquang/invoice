...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Antonio Thomas Gunnarsson} \\
		{\large Eli 82}\\
		{\large 43463, Chicago, Phu Yen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caleb May/Mae 	 Arvidsson Pte Ltd } \\
		{\large Robert 9}\\
		{\large 55426, Florence, Tuscany, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
