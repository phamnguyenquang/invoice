...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Austin Christopher Lundqvist} \\
		{\large Aidan 81}\\
		{\large 33593, San Francisco, Heibei, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luke Thomas Fransson Pte Ltd } \\
		{\large Stella 67}\\
		{\large 14779, Berlin, Heibei, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
