...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jacob Michael Hermansson} \\
		{\large Chase 4}\\
		{\large 74693, San Francisco, Guangzhou, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aidan Peter Olofsson Ltd } \\
		{\large Brody 38}\\
		{\large 96290, Beijing, Saarland, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
