...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Weston  Alexander  Lindqvist Corp} \\
		{\large Kevin 62}\\
		{\large 64475, San Francisco, Binh Thuan, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremiah Blomqvist } \\
		{\large Graham 15}\\
		{\large 46346, Chicago, Floria, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
