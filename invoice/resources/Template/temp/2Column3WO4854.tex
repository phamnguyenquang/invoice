...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caleb Catherine  Månsson Pte Ltd} \\
		{\large Anthony 50}\\
		{\large 25708, Tokyo, Bayern, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Patrick Sandström } \\
		{\large Ellie 29}\\
		{\large 24575, Beijing, California, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
