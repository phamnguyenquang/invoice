...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Faith  Alexander  Bengtsson} \\
		{\large Josiah 23}\\
		{\large 45038, Vancouver, Hainan, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucy Marie 	 Dahlberg Ltd } \\
		{\large Landon 81}\\
		{\large 99085, Frankfurt am Main , Heibei, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
