...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nolan May/Mae 	 Hassan Pte Ltd} \\
		{\large Theodore 54}\\
		{\large 33087, Frankfurt am Main , Guangdong, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Allison Björk } \\
		{\large Wyatt 47}\\
		{\large 55367, San Francisco, Ang Thong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
