...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Izabella Mary 	 Lindholm} \\
		{\large Audrey 82}\\
		{\large 48397, Beijing, Hawaii, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grayson David Gunnarsson Pte Ltd } \\
		{\large Aliyah 47}\\
		{\large 24361, Lisbon, Chiang Mai, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
