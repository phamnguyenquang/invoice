...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angel Elizabeth 	 Berggren Pte Ltd} \\
		{\large Payton 96}\\
		{\large 93771, Frankfurt am Main , Bremen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hailey Fredriksson } \\
		{\large Madelyn 6}\\
		{\large 53971, Singapore, Chiang Rai, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
