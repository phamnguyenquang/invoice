...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kyoto Prefectural University of Medicine} \\
		{\large Naomi 66}\\
		{\large 93842, Melbourne, Buriam, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sarah Jakobsson } \\
		{\large Owen 56}\\
		{\large 95141, Boston, Ang Thong, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
