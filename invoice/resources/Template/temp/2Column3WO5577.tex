...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Evan May/Mae 	 Holmgren Pte Ltd} \\
		{\large Connor 41}\\
		{\large 57419, Vancouver, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley Lundgren } \\
		{\large Kayla 82}\\
		{\large 89963, Hanoi, Hamburg, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
