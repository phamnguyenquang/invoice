...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Perpignan Via Domita} \\
		{\large Rachel 72}\\
		{\large 90686, SaiGon, Kentucky, United Kingdom}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Sawyer Sandberg } \\
		{\large Jackson 20}\\
		{\large 71292, Frankfurt am Main , California, Saudi Arabia }\\
    \switchcolumn
