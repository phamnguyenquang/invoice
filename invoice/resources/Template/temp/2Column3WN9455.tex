...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jose Michael Gustafsson} \\
		{\large Mason 80}\\
		{\large 83811, Hong Kong, Texas, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cooper Thomas Henriksson Corp } \\
		{\large Everett 64}\\
		{\large 64207, Frankfurt am Main , Indiana, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
