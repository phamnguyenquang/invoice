...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jace Louise 	 Axelsson Pte Ltd} \\
		{\large Isabella 12}\\
		{\large 85102, Vancouver, California, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Calvin Pettersson } \\
		{\large Declan 60}\\
		{\large 73766, Bonn, Seattles, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
