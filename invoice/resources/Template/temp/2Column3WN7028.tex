...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicholas James Berggren} \\
		{\large Jose 59}\\
		{\large 60993, Hong Kong, Guangdong, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alejandro William Forsberg Ltd } \\
		{\large Matthew 16}\\
		{\large 58309, Frankfurt am Main , Hessen, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
