...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryleigh Berglund} \\
		{\large Sara 12}\\
		{\large 46832, Abu Dhabi, Amnat Charoen, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zoey Mary 	 Claesson Ltd } \\
		{\large Valerie 15}\\
		{\large 33087, Frankfurt am Main , Hamburg, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
