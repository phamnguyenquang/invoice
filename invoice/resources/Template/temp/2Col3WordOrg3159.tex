...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abel Rose 	 Nyberg Pte Ltd} \\
		{\large Alexandra 20}\\
		{\large 80958, Frankfurt am Main , Bayern, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jessica Eklund } \\
		{\large Brielle 90}\\
		{\large 65416, Istanbul, Chai Nat, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
