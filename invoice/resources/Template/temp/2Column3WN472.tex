...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  King Rose 	 Bergqvist} \\
		{\large Bryson 65}\\
		{\large 36365, Hanoi, Tuscany, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large George Christopher Lindberg Pte Ltd } \\
		{\large Audrey 4}\\
		{\large 89886, Vancouver, Hessen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
