...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Oliver Louise 	 Månsson} \\
		{\large Juliana 84}\\
		{\large 34677, Toronto, Kentucky, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jesus Robert Löfgren Pte Ltd } \\
		{\large Nathan 24}\\
		{\large 73879, Shanghai, Kentucky, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
