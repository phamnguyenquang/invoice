...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Easton James Axelsson} \\
		{\large Max 16}\\
		{\large 64190, Last Vegas, Floria, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Autumn  Alexander  Nordström Ltd } \\
		{\large Joseph 57}\\
		{\large 24442, Hanoi, Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
