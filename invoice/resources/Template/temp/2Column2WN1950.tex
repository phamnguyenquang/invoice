...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall Björk} \\
		{\large Roman 38}\\
		{\large 55872, Frankfurt am Main , Ang Thong, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mark Jane Andreasson Pte Ltd } \\
		{\large Paige 87}\\
		{\large 50669, Ho Chi Minh, Bremen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
