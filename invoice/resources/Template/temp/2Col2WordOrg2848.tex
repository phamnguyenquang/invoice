...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grayson Lundström Pte Ltd} \\
		{\large Gael 90}\\
		{\large 22773, Frankfurt am Main , Seattles, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexis Abrahamsson } \\
		{\large Charles 5}\\
		{\large 32161, Frankfurt am Main , Floria, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
