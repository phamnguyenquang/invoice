...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Marcus Marie 	 Jönsson} \\
		{\large Max 13}\\
		{\large 21708, Los Angeles, Kentucky, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julia May/Mae 	 Pettersson Pte Ltd } \\
		{\large Bella 39}\\
		{\large 83177, Florence, California, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
