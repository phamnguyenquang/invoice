...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katherine Christopher Öberg} \\
		{\large Eva 39}\\
		{\large 96647, Frankfurt am Main , California, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paisley Elizabeth 	 Bergman Corp } \\
		{\large Steven 28}\\
		{\large 83554, Tokyo, Guangdong, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
