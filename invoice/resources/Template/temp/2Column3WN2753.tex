...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sadie Thomas Henriksson} \\
		{\large Steven 20}\\
		{\large 57309, Vancouver, Amnat Charoen, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sydney David Gunnarsson Pte Ltd } \\
		{\large Allison 39}\\
		{\large 29588, Denver, Phu Yen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
