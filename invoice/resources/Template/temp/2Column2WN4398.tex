...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luke Andersson} \\
		{\large Annabelle 66}\\
		{\large 12104, Denver, Bayern, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Piper Louise 	 Sandberg Corp } \\
		{\large Alexa 57}\\
		{\large 38674, Frankfurt am Main , California, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
