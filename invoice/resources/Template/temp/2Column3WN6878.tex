...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maverick David Blomqvist} \\
		{\large Nicolas 94}\\
		{\large 72092, Ho Chi Minh, Bangkok, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucy James Bergström Inc } \\
		{\large Leo 18}\\
		{\large 95719, Montreal, Bangkok, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
