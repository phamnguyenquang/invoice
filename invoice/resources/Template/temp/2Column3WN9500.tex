...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Santiago May/Mae 	 Johansson} \\
		{\large Emmett 49}\\
		{\large 30973, Montreal, Buriam, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mason  Alexander  Svensson Corp } \\
		{\large Scarlett 34}\\
		{\large 74154, Stuttgart, Saarland, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
