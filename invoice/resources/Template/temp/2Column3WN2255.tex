...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elias Thomas Wikström} \\
		{\large Matthew 95}\\
		{\large 38641, Berlin, Bremen, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mckenzie Thomas Söderberg Pte Ltd } \\
		{\large Braxton 11}\\
		{\large 81737, Barcelona, Chiang Mai, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
