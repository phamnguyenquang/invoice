...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Diego Marie 	 Nordström} \\
		{\large Natalie 20}\\
		{\large 34527, Los Angeles, Amnat Charoen, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bentley Thomas Danielsson Ltd } \\
		{\large Aurora 62}\\
		{\large 59904, Abu Dhabi, Binh Thuan, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
