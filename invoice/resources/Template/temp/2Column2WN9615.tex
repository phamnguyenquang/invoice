...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maddox Hansson} \\
		{\large Maddox 99}\\
		{\large 36554, San Francisco, Binh Thuan, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Preston Rose 	 Nordström Pte Ltd } \\
		{\large Cole 88}\\
		{\large 86139, San Francisco, Saarland, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
