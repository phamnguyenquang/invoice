...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremy Ann  Holm} \\
		{\large Chloe 14}\\
		{\large 95850, Hong Kong, Chiang Mai, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabelle Victoria Sandberg Pte Ltd } \\
		{\large Emmett 49}\\
		{\large 84759, Frankfurt am Main , Saarland, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
