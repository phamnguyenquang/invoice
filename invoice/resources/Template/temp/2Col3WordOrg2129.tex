...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kayla Anne Olsson Pte Ltd} \\
		{\large Oscar 83}\\
		{\large 20353, Frankfurt am Main , Tuscany, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexandra Gustafsson } \\
		{\large Lyla 87}\\
		{\large 41558, Moscow, Hamburg, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
