...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Robert Anne Andersson} \\
		{\large Luis 19}\\
		{\large 21794, San Francisco, Heibei, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melody Edward Lindberg Corp } \\
		{\large James 49}\\
		{\large 53405, Shanghai, California, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
