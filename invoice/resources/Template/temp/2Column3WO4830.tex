...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kayla May/Mae 	 Claesson Ltd} \\
		{\large Emma 76}\\
		{\large 87299, Sydney, Henan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Skylar Mårtensson } \\
		{\large Abel 78}\\
		{\large 47368, Barcelona, Amnat Charoen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
