...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryder Danielsson} \\
		{\large Gianna 55}\\
		{\large 34527, Taipei, Chiang Rai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Austin Mary 	 Fredriksson Corp } \\
		{\large Ashley 92}\\
		{\large 63228, Frankfurt am Main , Ang Thong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
