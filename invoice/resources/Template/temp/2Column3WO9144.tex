...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Colton Christopher Henriksson Corp} \\
		{\large Maxwell 46}\\
		{\large 47463, Munich, Buriam, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Roman Eklund } \\
		{\large Isla 28}\\
		{\large 38036, Venice, California, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
