...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jackson Catherine  Gunnarsson Pte Ltd} \\
		{\large Jocelyn 36}\\
		{\large 50422, Madrid, Bayern, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vincent Olsson } \\
		{\large Anna 48}\\
		{\large 96726, New York , Buriam, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
