...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline Elizabeth 	 Wallin} \\
		{\large Nicolas 16}\\
		{\large 50901, Last Vegas, Saarland, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hazel Anne Claesson Pte Ltd } \\
		{\large Hazel 21}\\
		{\large 26977, Madrid, Kentucky, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
