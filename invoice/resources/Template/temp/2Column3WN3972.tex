...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leilani Mary 	 Strömberg} \\
		{\large Melody 26}\\
		{\large 39945, Paris, California, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katherine Thomas Bergqvist Pte Ltd } \\
		{\large Melanie 17}\\
		{\large 84061, Florence, Hainan, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
