...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Sandberg} \\
		{\large Axel 52}\\
		{\large 69438, Frankfurt am Main , Hamburg, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Patrick Peter Olofsson Corp } \\
		{\large Savannah 22}\\
		{\large 90197, Boston, Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
