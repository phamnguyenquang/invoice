...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabel Mary 	 Mattsson} \\
		{\large Adriana 24}\\
		{\large 64342, Vancouver, Bremen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jameson Michael Lindberg Corp } \\
		{\large Aria 32}\\
		{\large 17844, Singapore, Saarland, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
