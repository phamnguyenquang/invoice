...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles Edward Mårtensson} \\
		{\large Christopher 31}\\
		{\large 71349, Montreal, Kentucky, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eliana John Lindgren Pte Ltd } \\
		{\large Alexa 91}\\
		{\large 59424, Moscow, Hamburg, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
