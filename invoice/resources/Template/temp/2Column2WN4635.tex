...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra Arvidsson} \\
		{\large Victoria 75}\\
		{\large 90266, Beijing, Hamburg, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Silas Jane Samuelsson Ltd } \\
		{\large Mateo 44}\\
		{\large 61672, Frankfurt am Main , Floria, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
