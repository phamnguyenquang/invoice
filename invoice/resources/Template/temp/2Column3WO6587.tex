...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Londyn Elizabeth 	 Axelsson Pte Ltd} \\
		{\large Dominic 95}\\
		{\large 80868, Budapest, Indiana, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaron Martinsson } \\
		{\large Aurora 10}\\
		{\large 86182, Ho Chi Minh, Chai Nat, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
