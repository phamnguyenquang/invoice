...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Genesis May/Mae 	 Jonsson} \\
		{\large Rose 93}\\
		{\large 66754, Chicago, Indiana, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christian Thomas Karlsson Corp } \\
		{\large Lucy 61}\\
		{\large 70854, Last Vegas, Hamburg, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
