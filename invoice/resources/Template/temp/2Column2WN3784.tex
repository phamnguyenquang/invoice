...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Weston Hellström} \\
		{\large Alexandra 71}\\
		{\large 29362, Lisbon, Hessen, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaxon Catherine  Viklund Pte Ltd } \\
		{\large Brian 53}\\
		{\large 41190, Ho Chi Minh, California, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
