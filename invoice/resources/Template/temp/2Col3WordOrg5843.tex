...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro May/Mae 	 Lindberg Pte Ltd} \\
		{\large Aliyah 64}\\
		{\large 65103, Washington, Hawaii, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cameron Jakobsson } \\
		{\large Brian 76}\\
		{\large 13876, Ho Chi Minh, Hainan, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
