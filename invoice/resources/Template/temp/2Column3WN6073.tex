...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremy Victoria Bengtsson} \\
		{\large Isla 31}\\
		{\large 17297, Denver, Phu Yen, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Marcus John Lundin Pte Ltd } \\
		{\large Rylee 44}\\
		{\large 17709, Barcelona, Binh Thuan, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
