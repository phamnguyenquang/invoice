...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro Lee  Eriksson} \\
		{\large Hazel 96}\\
		{\large 27002, Los Angeles, Hainan, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daisy Rose 	 Bergman Pte Ltd } \\
		{\large Layla 30}\\
		{\large 13854, Istanbul, Hamburg, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
