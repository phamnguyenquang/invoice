...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Mohamed} \\
		{\large Adrian 33}\\
		{\large 23416, Washington, Amnat Charoen, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cooper Rose 	 Pettersson Pte Ltd } \\
		{\large Avery 28}\\
		{\large 49061, Beijing, Floria, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
