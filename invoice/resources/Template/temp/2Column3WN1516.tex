...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hunter Ann  Pålsson} \\
		{\large Nicolas 43}\\
		{\large 14743, Denver, Indiana, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gracie Elizabeth 	 Axelsson Pte Ltd } \\
		{\large Brielle 57}\\
		{\large 53265, Los Angeles, Bremen, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
