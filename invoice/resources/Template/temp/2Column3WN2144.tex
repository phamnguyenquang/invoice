...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christian Edward Sundberg} \\
		{\large Cayden 49}\\
		{\large 78898, Last Vegas, khanh Hoa, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jackson Rose 	 Holmgren Inc } \\
		{\large Zachary 50}\\
		{\large 65724, Munich, Guangdong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
