...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles Bengtsson} \\
		{\large Jake 56}\\
		{\large 35282, London , Saarland, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leilani David Hansen Pte Ltd } \\
		{\large Jayla 40}\\
		{\large 56017, Frankfurt am Main , California, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
