...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ximena Robert Abrahamsson} \\
		{\large Elias 39}\\
		{\large 26698, Seoul, Bangkok, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paisley Louise 	 Fredriksson Pte Ltd } \\
		{\large Katelyn 68}\\
		{\large 20225, Dubai, Binh Thuan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
