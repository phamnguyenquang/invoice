...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lyla Jansson} \\
		{\large Julian 77}\\
		{\large 45621, Frankfurt am Main , Floria, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lilly  Alexander  Danielsson Pte Ltd } \\
		{\large London 55}\\
		{\large 34430, Budapest, Hessen, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
