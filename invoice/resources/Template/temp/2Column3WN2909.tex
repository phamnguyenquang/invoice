...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joseph Louise 	 Sjöberg} \\
		{\large Cooper 80}\\
		{\large 42638, Last Vegas, Hawaii, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ximena Catherine  Claesson Inc } \\
		{\large Alexa 67}\\
		{\large 83445, Madrid, Amnat Charoen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
