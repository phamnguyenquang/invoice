...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Benjamin Marie 	 Lundqvist} \\
		{\large Edward 43}\\
		{\large 90038, Milan, Amnat Charoen, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryker Marie 	 Lundgren Corp } \\
		{\large Joseph 20}\\
		{\large 62686, Shanghai, Amnat Charoen, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
