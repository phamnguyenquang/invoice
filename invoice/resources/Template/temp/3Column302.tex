...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Texas Health Science Center at San Antonio} \\
		{\large Caleb 27}\\
		{\large 70187, Singapore, Huabei, ThaiLand}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Marcus Jakobsson } \\
		{\large Asher 12}\\
		{\large 57906, Shanghai, Huabei, China }\\
    \switchcolumn
