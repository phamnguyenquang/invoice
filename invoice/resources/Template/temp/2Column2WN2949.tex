...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valentina Danielsson} \\
		{\large Lucas 56}\\
		{\large 42398, Florence, Binh Thuan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amir Rose 	 Lundberg Ltd } \\
		{\large Wyatt 37}\\
		{\large 88518, Los Angeles, Hainan, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
