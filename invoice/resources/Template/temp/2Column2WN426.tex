...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaxson Gustafsson} \\
		{\large Santiago 37}\\
		{\large 90053, Vancouver, Guangzhou, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Taylor Elizabeth 	 Lindberg Pte Ltd } \\
		{\large Michelle 40}\\
		{\large 82667, Last Vegas, Chai Nat, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
