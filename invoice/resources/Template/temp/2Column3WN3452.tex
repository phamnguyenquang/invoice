...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stephanie Catherine  Hedlund} \\
		{\large Jasmine 41}\\
		{\large 18745, Last Vegas, Ang Thong, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nolan James Björklund Pte Ltd } \\
		{\large Luis 66}\\
		{\large 46410, Moscow, Henan, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
