...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Taylor May/Mae 	 Håkansson} \\
		{\large Maria 99}\\
		{\large 84818, Barcelona, California, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian Anne Danielsson Corp } \\
		{\large Valeria 78}\\
		{\large 35855, Istanbul, Heibei, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
