...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryan Bergqvist} \\
		{\large Steven 76}\\
		{\large 34670, Frankfurt am Main , Bayern, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tristan Grace 	 Dahl Corp } \\
		{\large Theodore 13}\\
		{\large 36864, Frankfurt am Main , Buriam, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
