...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Austin John Lundqvist} \\
		{\large Eden 58}\\
		{\large 34137, Chicago, Ang Thong, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden David Magnusson Inc } \\
		{\large Alexandra 99}\\
		{\large 50416, Frankfurt am Main , Saarland, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
