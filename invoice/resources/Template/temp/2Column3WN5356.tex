...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jocelyn Louise 	 Hansson} \\
		{\large Mya 39}\\
		{\large 54685, Budapest, Saarland, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vanessa Elizabeth 	 Berggren Ltd } \\
		{\large Wyatt 20}\\
		{\large 96405, SaiGon, Ang Thong, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
