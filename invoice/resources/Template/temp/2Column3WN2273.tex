...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jeremiah Peter Engström} \\
		{\large Emily 59}\\
		{\large 55111, Madrid, Chiang Rai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Angelina Marie 	 Fredriksson Ltd } \\
		{\large Elizabeth 1}\\
		{\large 79419, Abu Dhabi, Hamburg, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
