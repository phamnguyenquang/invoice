...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayden Jane Andreasson} \\
		{\large Brooklynn 86}\\
		{\large 89629, Singapore, Amnat Charoen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Timothy Edward Lindqvist Pte Ltd } \\
		{\large Braxton 69}\\
		{\large 29742, Shanghai, Bayern, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
