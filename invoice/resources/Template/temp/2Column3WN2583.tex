...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Benjamin Lee  Henriksson} \\
		{\large Kinsley 80}\\
		{\large 82386, Last Vegas, Binh Thuan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madison Mary 	 Blom Inc } \\
		{\large Daisy 84}\\
		{\large 98311, Frankfurt am Main , Chiang Rai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
