...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Henry Strömberg} \\
		{\large Bryson 5}\\
		{\large 96010, Last Vegas, Amnat Charoen, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zoey Catherine  Lundström Inc } \\
		{\large Sawyer 55}\\
		{\large 82486, Hong Kong, Chai Nat, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
