...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaliyah Victoria Fredriksson} \\
		{\large Ethan 29}\\
		{\large 22034, Budapest, Guangzhou, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrew Catherine  Axelsson Inc } \\
		{\large Alexis 42}\\
		{\large 67396, Lisbon, Heibei, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
