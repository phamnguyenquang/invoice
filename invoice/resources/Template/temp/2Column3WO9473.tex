...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria Edward Mattsson Ltd} \\
		{\large Skylar 12}\\
		{\large 71796, Munich, Seattles, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sawyer Nordström } \\
		{\large Alan 9}\\
		{\large 57774, Nha Trang, Chiang Rai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
