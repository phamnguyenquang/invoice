...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jasmine  Alexander  Björklund Corp} \\
		{\large Ximena 26}\\
		{\large 50248, Florence, Huabei, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Victoria Nyström } \\
		{\large Kimberly 63}\\
		{\large 53794, Frankfurt am Main , Chiang Rai, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
