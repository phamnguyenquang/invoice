...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cayden David Svensson} \\
		{\large Khloe 84}\\
		{\large 18826, Abu Dhabi, Huabei, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Blake Michael Danielsson Inc } \\
		{\large Caden 73}\\
		{\large 34449, Ho Chi Minh, Hainan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
