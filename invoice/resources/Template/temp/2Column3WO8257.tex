...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Theodore Elizabeth 	 Björklund Corp} \\
		{\large George 8}\\
		{\large 49996, Frankfurt am Main , Hamburg, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jeremy Mattsson } \\
		{\large Kyle 28}\\
		{\large 55890, Barcelona, khanh Hoa, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
