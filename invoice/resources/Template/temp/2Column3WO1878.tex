...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryder May/Mae 	 Björk Pte Ltd} \\
		{\large Bentley 82}\\
		{\large 80333, Nha Trang, Huabei, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bailey Eliasson } \\
		{\large Michelle 78}\\
		{\large 44157, Ho Chi Minh, Binh Thuan, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
