...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Benjamin May/Mae 	 Magnusson} \\
		{\large Marcus 58}\\
		{\large 29136, Berlin, Amnat Charoen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Catherine  Ekström Pte Ltd } \\
		{\large Olivia 12}\\
		{\large 22357, Abu Dhabi, khanh Hoa, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
