...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte Anne Lundgren} \\
		{\large Jonah 64}\\
		{\large 51013, Osaka, Chiang Rai, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexander Elizabeth 	 Hassan Pte Ltd } \\
		{\large Micah 97}\\
		{\large 90753, Barcelona, khanh Hoa, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
