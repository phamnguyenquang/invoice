...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Santiago Marie 	 Lindström} \\
		{\large Wyatt 93}\\
		{\large 35578, Florence, Seattles, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalie Louise 	 Arvidsson Corp } \\
		{\large Connor 47}\\
		{\large 61111, Boston, Phu Yen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
