...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Reese William Andreasson} \\
		{\large Mariah 45}\\
		{\large 91890, Florence, Binh Thuan, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large King  Alexander  Norberg Pte Ltd } \\
		{\large Tyler 97}\\
		{\large 34226, Singapore, Kentucky, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
