...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra William Ekström Inc} \\
		{\large Hadley 29}\\
		{\large 44163, Budapest, khanh Hoa, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rebecca Wikström } \\
		{\large Aubrey 78}\\
		{\large 23811, Boston, Guangzhou, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
