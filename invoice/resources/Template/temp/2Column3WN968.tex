...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maddox Marie 	 Blomqvist} \\
		{\large Giovanni 89}\\
		{\large 56728, Paris, Floria, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jameson Louise 	 Sandström Ltd } \\
		{\large Caleb 13}\\
		{\large 44984, Washington, khanh Hoa, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
