...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Timothy Andersson} \\
		{\large Edward 88}\\
		{\large 86369, SaiGon, Binh Thuan, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hadley Christopher Nordin Inc } \\
		{\large Jackson 67}\\
		{\large 66931, Last Vegas, Chiang Mai, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
