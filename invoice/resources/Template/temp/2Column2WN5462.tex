...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Savannah Blom} \\
		{\large Ezra 50}\\
		{\large 30741, Venice, California, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Oliver Louise 	 Bergqvist Ltd } \\
		{\large Cole 94}\\
		{\large 12188, Frankfurt am Main , Chiang Rai, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
