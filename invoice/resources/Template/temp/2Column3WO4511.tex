...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexandra  Alexander  Wallin Pte Ltd} \\
		{\large Camila 89}\\
		{\large 27208, San Francisco, Floria, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Olivia Martinsson } \\
		{\large Ian 10}\\
		{\large 98029, Frankfurt am Main , Hessen, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
