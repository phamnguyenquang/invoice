...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kingston Peter Bergman} \\
		{\large Andrea 10}\\
		{\large 56219, Stuttgart, Chai Nat, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Paisley James Engström Ltd } \\
		{\large Scarlett 55}\\
		{\large 28054, Last Vegas, Huabei, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
