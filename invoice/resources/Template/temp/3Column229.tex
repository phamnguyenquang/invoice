...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  University of Tennessee Health Science Center} \\
		{\large Graham 47}\\
		{\large 27018, Vienna, Buriam, New Zealand}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Reese Hansson } \\
		{\large Robert 45}\\
		{\large 93185, SaiGon, Ang Thong, ThaiLand}\\
    \switchcolumn
