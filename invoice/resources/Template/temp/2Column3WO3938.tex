...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie Victoria Jönsson Inc} \\
		{\large Everett 32}\\
		{\large 30242, Chicago, Seattles, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniela Åkesson } \\
		{\large Jeremy 34}\\
		{\large 57841, Frankfurt am Main , Guangzhou, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
