...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Wesley William Ekström} \\
		{\large Luis 38}\\
		{\large 60556, Washington, Ang Thong, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella William Johansson Ltd } \\
		{\large Brooklynn 20}\\
		{\large 73260, Chicago, Amnat Charoen, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
