...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte David Åkesson} \\
		{\large Benjamin 76}\\
		{\large 50134, Vancouver, California, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large John James Bengtsson Pte Ltd } \\
		{\large Bryce 81}\\
		{\large 51366, Frankfurt am Main , Indiana, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
