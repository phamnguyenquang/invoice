...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aliyah Abrahamsson} \\
		{\large Savannah 1}\\
		{\large 76418, Istanbul, Chiang Mai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bryan Victoria Andersson Ltd } \\
		{\large Camden 51}\\
		{\large 48896, Amsterdam, Texas, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
