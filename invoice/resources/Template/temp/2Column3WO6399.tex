...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cooper May/Mae 	 Bengtsson Inc} \\
		{\large Sawyer 57}\\
		{\large 46715, Berlin, Binh Thuan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie Sjöberg } \\
		{\large Valeria 38}\\
		{\large 76486, Frankfurt am Main , Chiang Mai, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
