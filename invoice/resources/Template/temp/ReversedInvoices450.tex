...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Istanbul Technical University} \\
		{\large Asher 70}\\
		{\large 76247, Amsterdam, Chiang Mai, South Africa }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Levi Pettersson } \\
		{\large Layla 46}\\
		{\large 37610, Washington, Binh Thuan, Singapore}\\
    \switchcolumn
