...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abraham  Alexander  Lundgren} \\
		{\large Zoe 47}\\
		{\large 81569, Ho Chi Minh, Seattles, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aidan Jane Strömberg Pte Ltd } \\
		{\large Carter 93}\\
		{\large 70528, Minsk, Chiang Rai, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
