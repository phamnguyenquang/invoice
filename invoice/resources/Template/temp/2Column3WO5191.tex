...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Quinn Anne Björklund Ltd} \\
		{\large Christopher 90}\\
		{\large 93640, Frankfurt am Main , Indiana, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carter Henriksson } \\
		{\large Kevin 73}\\
		{\large 13114, Hong Kong, Texas, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
