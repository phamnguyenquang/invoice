...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paul Christopher Persson} \\
		{\large Norah 60}\\
		{\large 52718, Ho Chi Minh, Seattles, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zoe  Alexander  Lindholm Inc } \\
		{\large Makenzie 87}\\
		{\large 83788, Paris, Hamburg, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
