...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lincoln Peter Holmgren Inc} \\
		{\large Makenzie 27}\\
		{\large 82724, Frankfurt am Main , Phu Yen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alaina Gustafsson } \\
		{\large Joshua 10}\\
		{\large 80076, Melbourne, Amnat Charoen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
