...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Willow Elizabeth 	 Ek} \\
		{\large Kenneth 11}\\
		{\large 68283, Toronto, Guangdong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicholas James Mohamed Ltd } \\
		{\large Alyssa 90}\\
		{\large 70016, Madrid, Amnat Charoen, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
