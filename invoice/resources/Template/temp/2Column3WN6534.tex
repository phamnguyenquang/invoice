...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melanie Marie 	 Holmberg} \\
		{\large Jaden 3}\\
		{\large 68892, Hanoi, California, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julia Marie 	 Arvidsson Corp } \\
		{\large Leilani 91}\\
		{\large 60721, Nha Trang, Hessen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
