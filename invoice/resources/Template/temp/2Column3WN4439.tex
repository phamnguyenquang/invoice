...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Tyler Louise 	 Andersson} \\
		{\large Jordan 69}\\
		{\large 57130, Chicago, Huabei, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Olivia Victoria Henriksson Pte Ltd } \\
		{\large Mya 9}\\
		{\large 94924, Barcelona, California, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
