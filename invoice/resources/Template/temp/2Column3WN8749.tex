...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Diego  Alexander  Gunnarsson} \\
		{\large Valerie 81}\\
		{\large 92238, San Francisco, Guangzhou, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aliyah James Dahl Corp } \\
		{\large Alana 42}\\
		{\large 80487, SaiGon, Chiang Rai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
