...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Athena Marie 	 Martinsson} \\
		{\large Gianna 67}\\
		{\large 82149, Barcelona, Chai Nat, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kinsley Elizabeth 	 Åkesson Corp } \\
		{\large Tucker 65}\\
		{\large 84107, Ho Chi Minh, Ang Thong, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
