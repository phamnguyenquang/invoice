...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity Marie 	 Dahl Corp} \\
		{\large Londyn 18}\\
		{\large 81313, Stuttgart, Guangzhou, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ximena Lundberg } \\
		{\large Clara 13}\\
		{\large 81288, Frankfurt am Main , Kentucky, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
