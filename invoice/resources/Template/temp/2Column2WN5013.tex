...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie Andersson} \\
		{\large Piper 11}\\
		{\large 25019, Frankfurt am Main , Kentucky, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gael Catherine  Åberg Pte Ltd } \\
		{\large Nolan 43}\\
		{\large 66223, Berlin, Chiang Mai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
