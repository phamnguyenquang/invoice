...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriel Amy  Olofsson Pte Ltd} \\
		{\large Lucas 99}\\
		{\large 16635, San Francisco, Ang Thong, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Tyler Andreasson } \\
		{\large Luca 10}\\
		{\large 80995, Nha Trang, Chiang Rai, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
