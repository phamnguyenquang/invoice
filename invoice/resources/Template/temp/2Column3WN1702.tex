...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Samantha Lee  Åkesson} \\
		{\large Victor 42}\\
		{\large 66074, Ho Chi Minh, Seattles, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zoey Edward Lindholm Pte Ltd } \\
		{\large Aiden 25}\\
		{\large 82031, SaiGon, khanh Hoa, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
