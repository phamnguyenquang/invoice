...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Paris Nanterre University} \\
		{\large Justin 78}\\
		{\large 66915, Barcelona, Huabei, United Kingdom}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Aubrey Larsson } \\
		{\large Axel 3}\\
		{\large 39645, Frankfurt am Main , Kentucky, Singapore}\\
    \switchcolumn
