...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hudson Andreasson} \\
		{\large Matthew 29}\\
		{\large 13967, Lisbon, Binh Thuan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stella Rose 	 Jonsson Ltd } \\
		{\large Eden 65}\\
		{\large 69481, Frankfurt am Main , Indiana, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
