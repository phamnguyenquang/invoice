...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aurora Mary 	 Söderberg} \\
		{\large Abraham 34}\\
		{\large 42230, Nha Trang, Chiang Mai, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon Christopher Lindgren Pte Ltd } \\
		{\large Owen 69}\\
		{\large 65300, Osaka, Amnat Charoen, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
