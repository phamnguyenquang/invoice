...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Evelyn Robert Lund} \\
		{\large Oscar 78}\\
		{\large 35714, Minsk, Ang Thong, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ximena Elizabeth 	 Strömberg Pte Ltd } \\
		{\large Genesis 61}\\
		{\large 73504, Montreal, Amnat Charoen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
