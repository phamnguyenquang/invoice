...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zachary Amy  Johansson} \\
		{\large Alaina 19}\\
		{\large 10414, Florence, Chiang Mai, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Zachary Amy  Wikström Ltd } \\
		{\large Jessica 58}\\
		{\large 23901, Frankfurt am Main , Guangdong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
