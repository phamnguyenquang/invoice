...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  George Mason University} \\
		{\large Kaden 20}\\
		{\large 27380, Shanghai, Amnat Charoen, Argentina }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Parker Jakobsson } \\
		{\large Brian 18}\\
		{\large 58849, Washington, Binh Thuan, United State }\\
    \switchcolumn
