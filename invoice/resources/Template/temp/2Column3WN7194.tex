...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Molly Michael Sjögren} \\
		{\large Violet 47}\\
		{\large 14224, Toronto, Guangzhou, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stella Elizabeth 	 Dahlberg Ltd } \\
		{\large Kaiden 26}\\
		{\large 43504, Melbourne, Hessen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
