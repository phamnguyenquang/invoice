...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luke Hassan} \\
		{\large Melanie 88}\\
		{\large 72494, Abu Dhabi, Chiang Mai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christian Edward Eriksson Pte Ltd } \\
		{\large Brielle 68}\\
		{\large 33015, Moscow, Saarland, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
