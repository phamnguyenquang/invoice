...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesse Thomas Jakobsson} \\
		{\large Liliana 17}\\
		{\large 51661, Toronto, Amnat Charoen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bailey Thomas Holmberg Pte Ltd } \\
		{\large Mia 47}\\
		{\large 67163, Washington, Bremen, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
