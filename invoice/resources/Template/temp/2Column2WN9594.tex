...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Athena Lindgren} \\
		{\large Rebecca 25}\\
		{\large 40498, Los Angeles, khanh Hoa, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valentina  Alexander  Björklund Pte Ltd } \\
		{\large Brantley 60}\\
		{\large 58087, Melbourne, Bangkok, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
