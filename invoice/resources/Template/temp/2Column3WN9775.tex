...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sean Amy  Bergqvist} \\
		{\large Isla 18}\\
		{\large 27737, Frankfurt am Main , Chiang Mai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ruby Peter Andersson Pte Ltd } \\
		{\large Brianna 60}\\
		{\large 17435, Hanoi, Chai Nat, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
