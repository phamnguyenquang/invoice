...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Payton Elizabeth 	 Martinsson} \\
		{\large Camila 14}\\
		{\large 76219, Berlin, Hamburg, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaleb Elizabeth 	 Lindström Inc } \\
		{\large Everly 13}\\
		{\large 39565, Ho Chi Minh, Chiang Mai, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
