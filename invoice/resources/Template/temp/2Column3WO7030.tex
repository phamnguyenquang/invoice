...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alice Rose 	 Danielsson Pte Ltd} \\
		{\large Emery 25}\\
		{\large 86574, Florence, Hessen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Faith Sjöberg } \\
		{\large Brooklynn 98}\\
		{\large 75063, Frankfurt am Main , Amnat Charoen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
