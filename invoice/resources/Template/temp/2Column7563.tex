...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luis Bergqvist Corp} \\
		{\large Sophie 54}\\
		{\large 28798, Frankfurt am Main , Chiang Rai, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ezekiel Fredriksson } \\
		{\large Taylor 57}\\
		{\large 74855, Frankfurt am Main , Chiang Mai, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
