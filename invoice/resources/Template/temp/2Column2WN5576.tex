...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Richard Nyberg} \\
		{\large Jayden 25}\\
		{\large 66331, Melbourne, Seattles, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melody Edward Hermansson Ltd } \\
		{\large Jacob 53}\\
		{\large 24521, Frankfurt am Main , Hessen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
