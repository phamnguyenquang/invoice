...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Parker Rose 	 Håkansson} \\
		{\large Marcus 40}\\
		{\large 80754, Boston, Tuscany, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Austin Christopher Hedlund Pte Ltd } \\
		{\large Aliyah 88}\\
		{\large 73106, Los Angeles, Hainan, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
