...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jocelyn Christopher Andreasson} \\
		{\large Adriana 44}\\
		{\large 93303, Singapore, Guangzhou, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabelle Christopher Arvidsson Inc } \\
		{\large Nathaniel 11}\\
		{\large 43786, Taipei, Ang Thong, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
