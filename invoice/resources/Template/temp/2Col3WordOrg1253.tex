...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jacob Grace 	 Berg Ltd} \\
		{\large Grant 71}\\
		{\large 28981, San Francisco, Chiang Mai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valentina Hellström } \\
		{\large Annabelle 45}\\
		{\large 64250, Ho Chi Minh, khanh Hoa, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
