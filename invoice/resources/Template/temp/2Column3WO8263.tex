...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brody Christopher Wikström Pte Ltd} \\
		{\large Aaron 90}\\
		{\large 35133, SaiGon, Kentucky, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jessica Falk } \\
		{\large Justin 85}\\
		{\large 56283, Washington, Seattles, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
