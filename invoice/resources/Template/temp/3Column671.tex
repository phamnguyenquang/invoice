...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  London School of Hygiene & Tropical Medicine	} \\
		{\large Aria 28}\\
		{\large 31342, Frankfurt am Main , Chiang Mai, Switzerland}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Leonardo Gunnarsson } \\
		{\large Lilly 81}\\
		{\large 44346, Hong Kong, Guangdong, Switzerland}\\
    \switchcolumn
