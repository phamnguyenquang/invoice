...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kingston Bergqvist} \\
		{\large Evelyn 70}\\
		{\large 27998, Vancouver, Binh Thuan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gael James Gustafsson Pte Ltd } \\
		{\large Isabel 7}\\
		{\large 87517, Florence, Hessen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
