...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Margaret  Alexander  Olsson} \\
		{\large Jackson 71}\\
		{\large 57517, Berlin, Chiang Mai, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Connor Grace 	 Lindberg Inc } \\
		{\large Santiago 19}\\
		{\large 49219, Beijing, Buriam, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
