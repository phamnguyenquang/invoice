...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle Elizabeth 	 Mårtensson} \\
		{\large Hannah 25}\\
		{\large 81972, Ho Chi Minh, Binh Thuan, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lila Louise 	 Mohamed Ltd } \\
		{\large Paige 22}\\
		{\large 60787, Vancouver, Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
