...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kennedy William Ek} \\
		{\large Kenneth 14}\\
		{\large 41965, SaiGon, Ang Thong, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josephine  Alexander  Hedlund Pte Ltd } \\
		{\large Jose 38}\\
		{\large 28812, Istanbul, Hamburg, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
