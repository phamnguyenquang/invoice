...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Samuel Catherine  Jonsson} \\
		{\large Valerie 72}\\
		{\large 80657, Melbourne, Huabei, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ximena William Bengtsson Ltd } \\
		{\large Matthew 32}\\
		{\large 73928, Budapest, Bremen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
