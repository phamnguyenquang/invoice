...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ruby Gustafsson} \\
		{\large Harper 10}\\
		{\large 52954, Frankfurt am Main , Bayern, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Oscar  Alexander  Nyberg Inc } \\
		{\large Dominic 57}\\
		{\large 70226, Seoul, Guangzhou, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
