...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Kate 	 Claesson} \\
		{\large Alan 30}\\
		{\large 54792, Amsterdam, Hawaii, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hazel Peter Blomqvist Corp } \\
		{\large Brooke 41}\\
		{\large 73846, Washington, Hamburg, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
