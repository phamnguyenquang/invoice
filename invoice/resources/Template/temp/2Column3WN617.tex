...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathan Catherine  Fransson} \\
		{\large Katelyn 94}\\
		{\large 54430, Minsk, Buriam, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jason May/Mae 	 Eklund Pte Ltd } \\
		{\large Graham 71}\\
		{\large 47334, Nha Trang, Chiang Mai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
