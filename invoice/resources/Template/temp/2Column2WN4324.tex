...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stephanie Nordström} \\
		{\large Brantley 91}\\
		{\large 30753, Amsterdam, Seattles, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amelia Marie 	 Sundberg Pte Ltd } \\
		{\large Graham 86}\\
		{\large 83156, Frankfurt am Main , Kentucky, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
