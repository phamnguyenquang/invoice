...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bailey Grace 	 Danielsson} \\
		{\large Silas 82}\\
		{\large 51456, Amsterdam, Seattles, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eden Michael Magnusson Pte Ltd } \\
		{\large Olivia 60}\\
		{\large 10322, Montreal, Chai Nat, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
