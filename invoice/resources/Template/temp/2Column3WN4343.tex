...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Weston Victoria Eriksson} \\
		{\large Emma 3}\\
		{\large 64069, Boston, Hessen, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Giovanni Ann  Jönsson Pte Ltd } \\
		{\large Ariana 2}\\
		{\large 54038, Nha Trang, Bayern, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
