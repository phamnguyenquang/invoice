...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Margaret Jane Ekström Pte Ltd} \\
		{\large Ivan 71}\\
		{\large 20096, Venice, Guangdong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Quinn Mårtensson } \\
		{\large Peyton 44}\\
		{\large 38701, Abu Dhabi, Binh Thuan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
