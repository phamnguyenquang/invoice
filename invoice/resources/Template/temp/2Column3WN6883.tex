...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Londyn  Alexander  Jakobsson} \\
		{\large Valentina 93}\\
		{\large 79932, Abu Dhabi, Amnat Charoen, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bella Lee  Bengtsson Pte Ltd } \\
		{\large Sadie 16}\\
		{\large 97409, Last Vegas, Saarland, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
