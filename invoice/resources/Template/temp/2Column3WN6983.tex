...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ivy Mary 	 Bengtsson} \\
		{\large Sadie 69}\\
		{\large 66032, Montreal, Hawaii, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carson Marie 	 Löfgren Pte Ltd } \\
		{\large Skylar 20}\\
		{\large 92470, Ho Chi Minh, Hainan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
