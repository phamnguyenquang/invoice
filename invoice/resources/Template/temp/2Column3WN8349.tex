...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Samuel Rose 	 Arvidsson} \\
		{\large Dominic 78}\\
		{\large 31441, Barcelona, Chiang Mai, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrea Edward Mattsson Corp } \\
		{\large Kayden 15}\\
		{\large 46738, Barcelona, Hamburg, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
