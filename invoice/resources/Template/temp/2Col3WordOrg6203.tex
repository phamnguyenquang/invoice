...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ximena Edward Jönsson Pte Ltd} \\
		{\large Alan 28}\\
		{\large 48748, Munich, Chiang Rai, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Danielsson } \\
		{\large Hadley 30}\\
		{\large 46162, Barcelona, Tuscany, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
