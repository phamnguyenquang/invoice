...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jake Catherine  Sjögren} \\
		{\large Scarlett 54}\\
		{\large 35756, Rome, Hessen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joshua Edward Gunnarsson Inc } \\
		{\large Wyatt 50}\\
		{\large 37118, Ho Chi Minh, Amnat Charoen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
