...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  University of Texas Southwestern Medical Center} \\
		{\large Jameson 97}\\
		{\large 64922, New York , Guangdong, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Oliver Nyberg } \\
		{\large Stella 72}\\
		{\large 41921, Tokyo, Bangkok, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
