...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  University of Colorado Denver | Anschutz Medical Campus} \\
		{\large Blake 68}\\
		{\large 48896, Frankfurt am Main , Hessen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mila Bergman } \\
		{\large Xavier 85}\\
		{\large 24685, London , Henan, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
