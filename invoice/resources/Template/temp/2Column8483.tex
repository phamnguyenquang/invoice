...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaleb Nordin Inc} \\
		{\large Faith 45}\\
		{\large 55254, Frankfurt am Main , khanh Hoa, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kingston Jönsson } \\
		{\large Preston 38}\\
		{\large 79655, Frankfurt am Main , Ang Thong, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
