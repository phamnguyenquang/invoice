...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Quinn Marie 	 Nordström} \\
		{\large Izabella 5}\\
		{\large 48465, San Francisco, Amnat Charoen, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jacob Grace 	 Gunnarsson Ltd } \\
		{\large Gavin 43}\\
		{\large 74767, Montreal, Chai Nat, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
