...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brielle Björklund} \\
		{\large Ellie 32}\\
		{\large 77556, Frankfurt am Main , Seattles, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Wyatt Lee  Bengtsson Inc } \\
		{\large Riley 65}\\
		{\large 74618, Frankfurt am Main , Hessen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
