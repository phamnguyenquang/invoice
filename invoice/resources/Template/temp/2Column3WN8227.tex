...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brielle David Hassan} \\
		{\large Jameson 61}\\
		{\large 26459, Last Vegas, Indiana, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amelia Michael Lundgren Pte Ltd } \\
		{\large Ariana 41}\\
		{\large 62031, Chicago, Saarland, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
