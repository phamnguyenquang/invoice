...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bryan James Åberg} \\
		{\large Eliza 33}\\
		{\large 11477, Ho Chi Minh, Heibei, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklyn Edward Berglund Inc } \\
		{\large Amelia 72}\\
		{\large 28509, Frankfurt am Main , Chiang Mai, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
