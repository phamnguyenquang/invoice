...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sawyer Catherine  Ahmed} \\
		{\large Ashton 94}\\
		{\large 48177, New York , Amnat Charoen, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christian Edward Lundberg Corp } \\
		{\large Aidan 49}\\
		{\large 17364, Budapest, Phu Yen, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
