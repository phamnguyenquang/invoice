...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mckenzie Victoria Håkansson} \\
		{\large Daniel 10}\\
		{\large 53540, Milan, Hessen, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayla Grace 	 Blomqvist Corp } \\
		{\large Arianna 71}\\
		{\large 32944, Frankfurt am Main , Guangdong, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
