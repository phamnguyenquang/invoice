...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paige Gunnarsson} \\
		{\large Lila 77}\\
		{\large 50383, Washington, Chiang Mai, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ariana Edward Samuelsson Corp } \\
		{\large Evan 23}\\
		{\large 65764, Hong Kong, khanh Hoa, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
