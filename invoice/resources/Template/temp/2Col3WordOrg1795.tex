...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline Michael Dahl Corp} \\
		{\large Samuel 14}\\
		{\large 28400, Frankfurt am Main , Buriam, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Asher Bergström } \\
		{\large Natalie 49}\\
		{\large 30732, Budapest, Bremen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
