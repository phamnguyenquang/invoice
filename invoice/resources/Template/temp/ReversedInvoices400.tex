...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Tokyo University of Agriculture and Technology} \\
		{\large Emmanuel 49}\\
		{\large 77435, Toronto, Hainan, Australia }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Rachel Olofsson } \\
		{\large Oliver 99}\\
		{\large 74259, Vienna, Kentucky, China }\\
    \switchcolumn
