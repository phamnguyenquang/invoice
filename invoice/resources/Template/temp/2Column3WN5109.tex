...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daisy Thomas Strömberg} \\
		{\large Nicolas 43}\\
		{\large 25520, Taipei, Hainan, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ezekiel Robert Andreasson Pte Ltd } \\
		{\large Justin 44}\\
		{\large 18406, Barcelona, Bangkok, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
