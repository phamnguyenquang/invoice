...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Peyton William Lundin} \\
		{\large Jeremy 54}\\
		{\large 31801, Hong Kong, Hamburg, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn May/Mae 	 Falk Pte Ltd } \\
		{\large Alan 94}\\
		{\large 12993, Ho Chi Minh, California, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
