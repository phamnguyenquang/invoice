...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gracie John Nyberg} \\
		{\large Christopher 56}\\
		{\large 28496, Singapore, Hamburg, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melanie Robert Bergström Ltd } \\
		{\large Mya 40}\\
		{\large 88591, Osaka, Bremen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
