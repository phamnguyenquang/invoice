...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elise Edward Björk Pte Ltd} \\
		{\large Aurora 54}\\
		{\large 81714, Frankfurt am Main , Guangdong, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eleanor Eliasson } \\
		{\large Ashley 71}\\
		{\large 28512, Barcelona, Binh Thuan, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
