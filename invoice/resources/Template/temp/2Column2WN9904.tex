...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Reagan Pålsson} \\
		{\large Angel 72}\\
		{\large 85270, Abu Dhabi, Guangzhou, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madison Michael Fredriksson Pte Ltd } \\
		{\large Jason 13}\\
		{\large 68841, Frankfurt am Main , Hessen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
