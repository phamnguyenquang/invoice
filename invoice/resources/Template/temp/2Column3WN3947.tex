...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harrison William Blomqvist} \\
		{\large Zoey 18}\\
		{\large 90160, Frankfurt am Main , Floria, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abigail Kate 	 Bengtsson Inc } \\
		{\large Rebecca 10}\\
		{\large 81208, Bonn, Hamburg, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
