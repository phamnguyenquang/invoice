...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline Christopher Berglund} \\
		{\large Brielle 97}\\
		{\large 56652, Madrid, Hainan, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mateo Grace 	 Pettersson Corp } \\
		{\large Alexander 4}\\
		{\large 13102, Melbourne, Chiang Rai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
