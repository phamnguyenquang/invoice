...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Graham Marie 	 Blomqvist Corp} \\
		{\large Morgan 1}\\
		{\large 45571, Nha Trang, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lucy Hellström } \\
		{\large Mila 51}\\
		{\large 72324, Nha Trang, Tuscany, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
