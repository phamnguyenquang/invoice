...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Evelyn Danielsson} \\
		{\large Chloe 77}\\
		{\large 94627, Los Angeles, Seattles, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Willow Kate 	 Arvidsson Pte Ltd } \\
		{\large Katherine 98}\\
		{\large 81745, Last Vegas, Saarland, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
