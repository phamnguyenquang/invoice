...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Blomqvist} \\
		{\large Hayden 70}\\
		{\large 33925, Berlin, Hamburg, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brayden Rose 	 Holmgren Pte Ltd } \\
		{\large Isabelle 11}\\
		{\large 44238, Frankfurt am Main , Ang Thong, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
