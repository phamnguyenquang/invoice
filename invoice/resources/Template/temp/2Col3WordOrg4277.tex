...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Izabella  Alexander  Hedlund Corp} \\
		{\large Ryleigh 75}\\
		{\large 69756, Vancouver, Bangkok, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valeria Abrahamsson } \\
		{\large Piper 62}\\
		{\large 17097, Abu Dhabi, Seattles, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
