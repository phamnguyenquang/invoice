...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Natalie Louise 	 Sundberg Pte Ltd} \\
		{\large Brody 37}\\
		{\large 26270, Boston, Indiana, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luke Fredriksson } \\
		{\large Maya 99}\\
		{\large 60952, Los Angeles, Chiang Mai, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
