...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline Mary 	 Forsberg Pte Ltd} \\
		{\large Andrew 45}\\
		{\large 78672, London , Bayern, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Owen Eriksson } \\
		{\large Jonathan 7}\\
		{\large 56243, Last Vegas, Chiang Rai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
