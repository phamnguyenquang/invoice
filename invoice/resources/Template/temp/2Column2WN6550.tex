...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jocelyn Gustafsson} \\
		{\large Maddox 49}\\
		{\large 31351, Istanbul, Ang Thong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Scarlett Elizabeth 	 Hansson Pte Ltd } \\
		{\large Brooklynn 14}\\
		{\large 58925, Abu Dhabi, Henan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
