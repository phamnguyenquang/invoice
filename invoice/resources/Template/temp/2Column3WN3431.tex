...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Catherine  Lund} \\
		{\large Bradley 5}\\
		{\large 60650, Washington, Kentucky, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryder Elizabeth 	 Bergman Ltd } \\
		{\large Owen 37}\\
		{\large 90595, London , California, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
