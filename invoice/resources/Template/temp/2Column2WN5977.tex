...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elias Forsberg} \\
		{\large Avery 86}\\
		{\large 38763, Frankfurt am Main , khanh Hoa, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Peyton Ann  Bergström Pte Ltd } \\
		{\large Alexandra 98}\\
		{\large 14938, Montreal, Saarland, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
