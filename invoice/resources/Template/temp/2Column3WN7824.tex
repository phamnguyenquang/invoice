...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Miguel May/Mae 	 Bergman} \\
		{\large Rachel 91}\\
		{\large 59858, Barcelona, Bangkok, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Morgan James Andersson Inc } \\
		{\large Christian 13}\\
		{\large 69155, San Francisco, khanh Hoa, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
