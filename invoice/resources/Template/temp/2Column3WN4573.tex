...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Liliana Lee  Nyström} \\
		{\large Taylor 41}\\
		{\large 22217, San Francisco, California, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Genesis William Dahl Ltd } \\
		{\large Caroline 32}\\
		{\large 97808, Minsk, Binh Thuan, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
