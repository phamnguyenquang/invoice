...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elise Elizabeth 	 Gunnarsson Pte Ltd} \\
		{\large Joel 43}\\
		{\large 59688, Montreal, Hessen, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makayla Axelsson } \\
		{\large Claire 53}\\
		{\large 65329, Nha Trang, khanh Hoa, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
