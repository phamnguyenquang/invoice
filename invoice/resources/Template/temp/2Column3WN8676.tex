...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sofia Peter Ström} \\
		{\large Gracie 50}\\
		{\large 75596, San Francisco, California, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Graham Jane Ström Ltd } \\
		{\large Ashton 30}\\
		{\large 80472, Frankfurt am Main , California, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
