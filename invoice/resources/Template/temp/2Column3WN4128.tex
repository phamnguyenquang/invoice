...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hayden Lee  Abrahamsson} \\
		{\large Sarah 16}\\
		{\large 75968, Frankfurt am Main , Hessen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joseph William Eliasson Ltd } \\
		{\large Lincoln 94}\\
		{\large 48578, Seoul, Chiang Mai, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
