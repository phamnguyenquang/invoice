...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel William Martinsson} \\
		{\large Reese 60}\\
		{\large 91714, Vancouver, Guangdong, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josiah Edward Magnusson Ltd } \\
		{\large Victoria 42}\\
		{\large 98599, Abu Dhabi, Bangkok, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
