...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaleb Christopher Hansson Pte Ltd} \\
		{\large Landon 73}\\
		{\large 33773, Barcelona, California, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabella Abrahamsson } \\
		{\large Timothy 38}\\
		{\large 58423, Moscow, Amnat Charoen, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
