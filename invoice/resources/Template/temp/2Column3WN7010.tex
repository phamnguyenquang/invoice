...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aubrey David Henriksson} \\
		{\large Mckenzie 5}\\
		{\large 41950, Sydney, Saarland, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Harrison  Alexander  Sandberg Ltd } \\
		{\large Max 63}\\
		{\large 39561, Shanghai, Chiang Rai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
