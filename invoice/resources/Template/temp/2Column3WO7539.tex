...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonathan Christopher Olofsson Inc} \\
		{\large Nora 24}\\
		{\large 79812, Paris, Buriam, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryan Sandberg } \\
		{\large Aubree 38}\\
		{\large 96290, Frankfurt am Main , khanh Hoa, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
