...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grace Michael Bengtsson} \\
		{\large Blake 96}\\
		{\large 72494, New York , Tuscany, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carter Michael Pettersson Pte Ltd } \\
		{\large Cameron 75}\\
		{\large 59802, Beijing, Chiang Rai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
