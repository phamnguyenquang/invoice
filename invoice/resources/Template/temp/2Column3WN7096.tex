...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julianna William Eriksson} \\
		{\large Rebecca 64}\\
		{\large 78696, Shanghai, Kentucky, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmett Michael Dahl Inc } \\
		{\large Eva 30}\\
		{\large 30924, Denver, Bayern, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
