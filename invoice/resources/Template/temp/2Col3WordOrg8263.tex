...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lyla Christopher Persson Pte Ltd} \\
		{\large Jackson 70}\\
		{\large 83547, Amsterdam, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valentina Henriksson } \\
		{\large Blake 15}\\
		{\large 94405, Rome, Guangdong, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
