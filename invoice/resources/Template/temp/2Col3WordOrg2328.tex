...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michelle Christopher Norberg Corp} \\
		{\large Adrian 26}\\
		{\large 77640, Sydney, Tuscany, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Landon Andreasson } \\
		{\large Laila 52}\\
		{\large 39831, Istanbul, Bremen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
