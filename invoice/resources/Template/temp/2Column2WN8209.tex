...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cooper Blomqvist} \\
		{\large Autumn 49}\\
		{\large 96636, Sydney, California, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Roman William Sandström Corp } \\
		{\large Bryson 27}\\
		{\large 78512, San Francisco, Texas, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
