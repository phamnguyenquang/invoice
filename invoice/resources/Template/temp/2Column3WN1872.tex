...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Elizabeth 	 Berg} \\
		{\large Micah 90}\\
		{\large 83521, Melbourne, Chiang Mai, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Thomas Catherine  Sundberg Pte Ltd } \\
		{\large Paisley 19}\\
		{\large 67511, Denver, Chiang Rai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
