...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryker Hansson} \\
		{\large Diego 64}\\
		{\large 39004, Florence, Floria, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Anne Danielsson Pte Ltd } \\
		{\large Liam 1}\\
		{\large 62715, Barcelona, Indiana, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
