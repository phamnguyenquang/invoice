...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayce Christopher Holmberg Pte Ltd} \\
		{\large Christian 39}\\
		{\large 90969, Boston, Hawaii, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lilly Hansson } \\
		{\large Hudson 63}\\
		{\large 57831, Florence, Guangzhou, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
