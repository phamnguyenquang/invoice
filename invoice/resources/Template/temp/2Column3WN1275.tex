...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kayla Christopher Bengtsson} \\
		{\large Caleb 15}\\
		{\large 53738, Nha Trang, Seattles, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte Michael Larsson Pte Ltd } \\
		{\large Marcus 21}\\
		{\large 81368, Dubai, Guangzhou, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
