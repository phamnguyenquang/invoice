...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Roman Catherine  Sundberg Ltd} \\
		{\large Addison 71}\\
		{\large 95697, Frankfurt am Main , Hainan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Camden Abrahamsson } \\
		{\large Payton 30}\\
		{\large 50333, Dublin, Ang Thong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
