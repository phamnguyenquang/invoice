...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jason William Håkansson} \\
		{\large Elise 53}\\
		{\large 43711, Budapest, Hessen, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Steven Marie 	 Abrahamsson Corp } \\
		{\large Christopher 61}\\
		{\large 22815, San Francisco, Floria, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
