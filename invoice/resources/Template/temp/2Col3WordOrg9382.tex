...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian David Engström Pte Ltd} \\
		{\large Daisy 24}\\
		{\large 43709, Tokyo, Ang Thong, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Quinn Eriksson } \\
		{\large Julianna 91}\\
		{\large 35842, Frankfurt am Main , Bremen, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
