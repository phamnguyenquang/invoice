...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel  Alexander  Arvidsson} \\
		{\large Amy 23}\\
		{\large 33315, Budapest, Hainan, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eric  Alexander  Nordström Inc } \\
		{\large Sebastian 2}\\
		{\large 48349, Seoul, California, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
