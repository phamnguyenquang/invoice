...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Scarlett Thomas Eliasson Pte Ltd} \\
		{\large Caden 20}\\
		{\large 83105, Hong Kong, Guangdong, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaylee Söderberg } \\
		{\large Angel 73}\\
		{\large 74703, Denver, Texas, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
