...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaden Elizabeth 	 Magnusson} \\
		{\large Jackson 3}\\
		{\large 61572, Sydney, Hawaii, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden William Henriksson Pte Ltd } \\
		{\large Daisy 13}\\
		{\large 84630, Last Vegas, Hessen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
