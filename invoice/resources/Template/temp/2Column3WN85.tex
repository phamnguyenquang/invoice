...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ayden Louise 	 Nyberg} \\
		{\large Mariah 32}\\
		{\large 92567, Ho Chi Minh, Ang Thong, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lauren Jane Mattsson Corp } \\
		{\large Isaac 22}\\
		{\large 46966, Singapore, Chiang Mai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
