...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Khloe Christopher Bergman} \\
		{\large Jeremy 46}\\
		{\large 41589, Moscow, Seattles, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cooper  Alexander  Dahl Pte Ltd } \\
		{\large Adriana 49}\\
		{\large 21178, Singapore, Hamburg, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
