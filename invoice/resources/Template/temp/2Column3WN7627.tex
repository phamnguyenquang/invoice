...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle Ann  Axelsson} \\
		{\large Makayla 31}\\
		{\large 13399, Stuttgart, Texas, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mckenzie Mary 	 Berggren Pte Ltd } \\
		{\large Khloe 6}\\
		{\large 77155, Singapore, Amnat Charoen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
