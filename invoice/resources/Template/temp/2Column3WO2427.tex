...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maverick John Olofsson Pte Ltd} \\
		{\large Melody 96}\\
		{\large 64050, Berlin, Amnat Charoen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Oliver Hedlund } \\
		{\large Lucy 26}\\
		{\large 34766, Frankfurt am Main , Bangkok, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
