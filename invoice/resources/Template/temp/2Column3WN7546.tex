...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cora  Alexander  Andreasson} \\
		{\large Luna 11}\\
		{\large 12394, SaiGon, Ang Thong, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ethan Amy  Lindgren Pte Ltd } \\
		{\large Morgan 59}\\
		{\large 60165, San Francisco, Ang Thong, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
