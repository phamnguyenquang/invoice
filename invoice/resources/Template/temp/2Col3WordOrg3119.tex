...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luna Catherine  Mohamed Inc} \\
		{\large Edward 68}\\
		{\large 15910, Amsterdam, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Savannah Dahlberg } \\
		{\large Nolan 44}\\
		{\large 50438, Frankfurt am Main , Chai Nat, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
