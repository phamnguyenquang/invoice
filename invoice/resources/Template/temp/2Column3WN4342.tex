...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Stella  Alexander  Björk} \\
		{\large Eleanor 58}\\
		{\large 16222, Beijing, Phu Yen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Jane Andersson Pte Ltd } \\
		{\large Roman 32}\\
		{\large 53572, Montreal, Chiang Rai, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
