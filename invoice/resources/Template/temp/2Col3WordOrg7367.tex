...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexander Elizabeth 	 Arvidsson Inc} \\
		{\large Jaden 83}\\
		{\large 47780, Ho Chi Minh, Floria, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Forsberg } \\
		{\large Victoria 40}\\
		{\large 84125, Washington, Chiang Mai, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
