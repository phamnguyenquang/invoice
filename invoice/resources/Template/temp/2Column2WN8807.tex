...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brandon Mohamed} \\
		{\large Landon 9}\\
		{\large 94542, Nha Trang, Amnat Charoen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Connor William Jansson Pte Ltd } \\
		{\large James 36}\\
		{\large 49267, Nha Trang, Hainan, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
