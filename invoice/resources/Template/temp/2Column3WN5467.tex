...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel William Berglund} \\
		{\large Serenity 58}\\
		{\large 50454, Vienna, Chiang Rai, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmanuel Lee  Karlsson Inc } \\
		{\large Giovanni 79}\\
		{\large 61305, San Francisco, Ang Thong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
