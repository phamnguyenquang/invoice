...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caden May/Mae 	 Bergman Pte Ltd} \\
		{\large Christopher 30}\\
		{\large 43598, Beijing, Bremen, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melanie Lindholm } \\
		{\large Carson 87}\\
		{\large 71991, Washington, Hessen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
