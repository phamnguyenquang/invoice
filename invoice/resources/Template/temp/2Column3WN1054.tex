...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rebecca Marie 	 Abrahamsson} \\
		{\large Nora 83}\\
		{\large 39369, Los Angeles, Phu Yen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy Edward Söderberg Inc } \\
		{\large Silas 47}\\
		{\large 16401, Toronto, Seattles, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
