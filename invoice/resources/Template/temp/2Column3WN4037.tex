...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ellie Victoria Berglund} \\
		{\large Jayden 69}\\
		{\large 26487, SaiGon, Chiang Rai, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juliana Thomas Svensson Pte Ltd } \\
		{\large Savannah 53}\\
		{\large 34519, Hong Kong, Heibei, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
