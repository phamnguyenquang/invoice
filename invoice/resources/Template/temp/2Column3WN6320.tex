...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gavin Robert Ahmed} \\
		{\large Abel 55}\\
		{\large 93737, Dubai, California, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Arianna Kate 	 Lindgren Pte Ltd } \\
		{\large Charlotte 19}\\
		{\large 35099, Frankfurt am Main , Ang Thong, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
