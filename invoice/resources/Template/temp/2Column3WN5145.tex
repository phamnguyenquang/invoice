...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carlos May/Mae 	 Mårtensson} \\
		{\large Bradley 38}\\
		{\large 54196, Vancouver, Saarland, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sydney Jane Åberg Ltd } \\
		{\large Hadley 17}\\
		{\large 72230, Boston, Chiang Rai, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
