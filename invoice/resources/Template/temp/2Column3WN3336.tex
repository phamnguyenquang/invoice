...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  James  Alexander  Andreasson} \\
		{\large Mia 94}\\
		{\large 72539, Frankfurt am Main , Buriam, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryker Thomas Danielsson Pte Ltd } \\
		{\large Willow 76}\\
		{\large 28604, Bonn, Indiana, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
