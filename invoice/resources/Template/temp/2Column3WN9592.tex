...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Vanessa Catherine  Eklund} \\
		{\large Eva 85}\\
		{\large 52917, Hong Kong, California, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rachel Elizabeth 	 Nordström Inc } \\
		{\large Adeline 12}\\
		{\large 97106, Osaka, Indiana, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
