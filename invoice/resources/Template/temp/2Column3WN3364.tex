...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesus Anne Mårtensson} \\
		{\large Gianna 67}\\
		{\large 20165, Frankfurt am Main , Floria, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luca Elizabeth 	 Svensson Corp } \\
		{\large Brooklynn 60}\\
		{\large 95786, Taipei, Hessen, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
