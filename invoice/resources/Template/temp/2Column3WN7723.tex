...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ella Robert Henriksson} \\
		{\large Payton 41}\\
		{\large 50251, Hong Kong, Hessen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Michael Engström Corp } \\
		{\large Daniela 54}\\
		{\large 15437, Madrid, Buriam, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
