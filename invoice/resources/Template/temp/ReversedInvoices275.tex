...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Nara Institute of Science and Technology} \\
		{\large Christopher 63}\\
		{\large 17846, Osaka, Saarland, laos}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Ayden Ahmed } \\
		{\large Paul 45}\\
		{\large 94422, Frankfurt am Main , khanh Hoa, South Africa }\\
    \switchcolumn
