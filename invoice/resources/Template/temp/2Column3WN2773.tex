...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Annabelle Mary 	 Strömberg} \\
		{\large Serenity 49}\\
		{\large 65395, Chicago, Floria, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brady Thomas Hermansson Corp } \\
		{\large Connor 90}\\
		{\large 45031, Shanghai, Bayern, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
