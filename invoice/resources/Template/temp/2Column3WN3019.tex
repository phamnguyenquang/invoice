...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kingston Louise 	 Falk} \\
		{\large Delilah 32}\\
		{\large 45451, Ho Chi Minh, Phu Yen, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bradley  Alexander  Lundberg Pte Ltd } \\
		{\large Lucas 95}\\
		{\large 24129, Seoul, Buriam, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
