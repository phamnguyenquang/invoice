...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grayson Blomqvist} \\
		{\large Aaliyah 27}\\
		{\large 46444, Frankfurt am Main , Hawaii, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie Rose 	 Lundin Ltd } \\
		{\large Madelyn 67}\\
		{\large 42003, Frankfurt am Main , Binh Thuan, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
