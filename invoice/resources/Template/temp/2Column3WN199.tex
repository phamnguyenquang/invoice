...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Braxton Thomas Lundqvist} \\
		{\large Chase 17}\\
		{\large 23530, Frankfurt am Main , Chiang Rai, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Payton Ann  Jonsson Pte Ltd } \\
		{\large Maya 35}\\
		{\large 98365, Beijing, Hawaii, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
