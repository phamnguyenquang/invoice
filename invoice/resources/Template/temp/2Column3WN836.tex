...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Savannah Jane Johansson} \\
		{\large Kaleb 20}\\
		{\large 66115, Munich, Indiana, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cooper Victoria Jakobsson Inc } \\
		{\large Catherine 36}\\
		{\large 72736, Frankfurt am Main , Hamburg, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
