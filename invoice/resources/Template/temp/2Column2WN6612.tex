...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Pettersson} \\
		{\large Samuel 44}\\
		{\large 93088, Melbourne, Heibei, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaliyah Elizabeth 	 Dahlberg Inc } \\
		{\large Jacob 1}\\
		{\large 91499, Shanghai, Chiang Mai, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
