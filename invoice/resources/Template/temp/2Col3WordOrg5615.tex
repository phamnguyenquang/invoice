...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brianna May/Mae 	 Pålsson Corp} \\
		{\large Liam 1}\\
		{\large 42951, Stuttgart, Guangzhou, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Athena Gunnarsson } \\
		{\large Elijah 77}\\
		{\large 30196, Frankfurt am Main , Chiang Mai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
