...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kyle Grace 	 Mårtensson} \\
		{\large Joel 10}\\
		{\large 99859, Toronto, khanh Hoa, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jude Michael Martinsson Ltd } \\
		{\large Lincoln 55}\\
		{\large 31928, Melbourne, Phu Yen, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
