...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Preston May/Mae 	 Jönsson} \\
		{\large King 60}\\
		{\large 65433, Florence, Floria, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Quinn Christopher Eliasson Inc } \\
		{\large Daisy 64}\\
		{\large 24258, Lisbon, Saarland, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
