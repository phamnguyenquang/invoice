...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  China Medical University, Taiwan} \\
		{\large Brooklynn 15}\\
		{\large 49550, Last Vegas, Hainan, Singapore}\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Bailey Forsberg } \\
		{\large Juan 83}\\
		{\large 81275, Singapore, Chai Nat, Indonesia s}\\
    \switchcolumn
