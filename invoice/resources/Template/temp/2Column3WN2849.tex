...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayla Kate 	 Ekström} \\
		{\large Tyler 74}\\
		{\large 93247, Ho Chi Minh, Phu Yen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elise Christopher Ahmed Pte Ltd } \\
		{\large Alan 95}\\
		{\large 86730, Berlin, Ang Thong, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
