...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriel Berglund} \\
		{\large Sarah 55}\\
		{\large 84963, Abu Dhabi, Buriam, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexandra Thomas Bergqvist Pte Ltd } \\
		{\large Emily 67}\\
		{\large 24478, Vancouver, Seattles, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
