...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mason Gunnarsson Pte Ltd} \\
		{\large Bryce 56}\\
		{\large 16866, Frankfurt am Main , Guangdong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Trinity Samuelsson } \\
		{\large Lincoln 69}\\
		{\large 95308, Ho Chi Minh, Bangkok, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
