...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Malachi Christopher Nordström} \\
		{\large Brady 78}\\
		{\large 42839, Chicago, Ang Thong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amy Louise 	 Danielsson Ltd } \\
		{\large Maria 4}\\
		{\large 48610, Madrid, Kentucky, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
