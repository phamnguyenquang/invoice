...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Annabelle May/Mae 	 Gustafsson Pte Ltd} \\
		{\large Eliana 90}\\
		{\large 11295, Budapest, Bangkok, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mark Nilsson } \\
		{\large Reagan 60}\\
		{\large 99072, Los Angeles, Seattles, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
