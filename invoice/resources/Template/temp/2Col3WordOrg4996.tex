...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Cameron James Axelsson Pte Ltd} \\
		{\large Brady 69}\\
		{\large 76431, Frankfurt am Main , Floria, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cameron Hansen } \\
		{\large Avery 55}\\
		{\large 34574, Seoul, Binh Thuan, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
