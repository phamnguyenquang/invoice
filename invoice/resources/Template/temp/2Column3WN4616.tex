...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Preston Mary 	 Johansson} \\
		{\large Luis 6}\\
		{\large 50987, Frankfurt am Main , Bayern, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jonah John Sandberg Pte Ltd } \\
		{\large Jayce 17}\\
		{\large 66561, Hanoi, Tuscany, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
