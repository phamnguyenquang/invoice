...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adrian Engström} \\
		{\large Alana 68}\\
		{\large 67497, Abu Dhabi, Hessen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aria Christopher Arvidsson Ltd } \\
		{\large Rachel 99}\\
		{\large 80442, Last Vegas, Guangdong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
