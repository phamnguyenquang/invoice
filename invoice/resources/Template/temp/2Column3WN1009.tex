...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harrison Michael Håkansson} \\
		{\large Colton 59}\\
		{\large 28126, Shanghai, Hainan, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Damian Louise 	 Danielsson Inc } \\
		{\large Emily 90}\\
		{\large 44967, Vienna, khanh Hoa, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
