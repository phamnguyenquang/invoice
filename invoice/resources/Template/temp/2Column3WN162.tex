...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emmanuel Catherine  Bergqvist} \\
		{\large Elias 4}\\
		{\large 44973, Abu Dhabi, Ang Thong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabrielle James Pettersson Pte Ltd } \\
		{\large Taylor 96}\\
		{\large 88227, San Francisco, khanh Hoa, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
