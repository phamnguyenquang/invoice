...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Wyatt Louise 	 Persson} \\
		{\large Wyatt 30}\\
		{\large 55250, Los Angeles, Guangdong, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samantha Amy  Arvidsson Ltd } \\
		{\large Taylor 38}\\
		{\large 82961, Nha Trang, Phu Yen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
