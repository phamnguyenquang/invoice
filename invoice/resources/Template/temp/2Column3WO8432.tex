...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jaden William Blomqvist Corp} \\
		{\large Greyson 92}\\
		{\large 90125, Budapest, Guangzhou, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexander Håkansson } \\
		{\large Christopher 64}\\
		{\large 58412, Frankfurt am Main , Ang Thong, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
