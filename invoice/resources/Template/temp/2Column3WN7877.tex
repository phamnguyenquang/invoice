...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hadley Marie 	 Ek} \\
		{\large Jordan 25}\\
		{\large 39323, Frankfurt am Main , Guangzhou, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ezra Mary 	 Lundin Pte Ltd } \\
		{\large Jordan 59}\\
		{\large 84716, Ho Chi Minh, Indiana, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
