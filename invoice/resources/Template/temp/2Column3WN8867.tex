...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gracie Amy  Andersson} \\
		{\large Rachel 74}\\
		{\large 79092, Beijing, Chiang Mai, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elijah Elizabeth 	 Holmberg Corp } \\
		{\large Daniela 99}\\
		{\large 14201, Budapest, khanh Hoa, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
