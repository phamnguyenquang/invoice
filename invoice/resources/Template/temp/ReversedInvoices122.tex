...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Texas A&M University, College Station} \\
		{\large Kayla 66}\\
		{\large 17436, Berlin, Indiana, United State }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Angelina Bengtsson } \\
		{\large Aubrey 9}\\
		{\large 47785, Beijing, Hamburg, South Korea}\\
    \switchcolumn
