...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juliana Andersson} \\
		{\large Serenity 34}\\
		{\large 21897, Washington, Hawaii, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mariah Catherine  Lindström Pte Ltd } \\
		{\large Stephanie 30}\\
		{\large 32491, Abu Dhabi, Chiang Mai, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
