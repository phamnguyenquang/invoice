...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Olivia  Alexander  Jonsson} \\
		{\large Jennifer 67}\\
		{\large 11861, Singapore, Henan, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jaden Louise 	 Jansson Corp } \\
		{\large Elijah 49}\\
		{\large 94466, Last Vegas, Seattles, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
