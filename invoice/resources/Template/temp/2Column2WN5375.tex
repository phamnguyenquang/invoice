...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gavin Hedlund} \\
		{\large Cooper 24}\\
		{\large 89936, Sydney, Bangkok, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher William Björklund Pte Ltd } \\
		{\large Ayden 14}\\
		{\large 51903, Last Vegas, Bremen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
