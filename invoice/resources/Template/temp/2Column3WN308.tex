...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaron Ann  Magnusson} \\
		{\large Lydia 36}\\
		{\large 78801, San Francisco, Buriam, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Destiny Elizabeth 	 Öberg Corp } \\
		{\large Riley 30}\\
		{\large 96824, Hanoi, Bangkok, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
