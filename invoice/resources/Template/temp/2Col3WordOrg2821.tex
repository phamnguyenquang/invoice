...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Catherine Louise 	 Norberg Pte Ltd} \\
		{\large Isabella 40}\\
		{\large 80898, Tokyo, Amnat Charoen, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everly Nordström } \\
		{\large Braxton 22}\\
		{\large 57917, Frankfurt am Main , Heibei, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
