...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle John Gunnarsson} \\
		{\large Angelina 28}\\
		{\large 90066, Paris, Seattles, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katelyn Louise 	 Hermansson Ltd } \\
		{\large Jack 33}\\
		{\large 67222, Denver, Bayern, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
