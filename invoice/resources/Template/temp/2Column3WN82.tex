...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Audrey Robert Holm} \\
		{\large Cora 64}\\
		{\large 84061, Milan, Guangzhou, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brianna Elizabeth 	 Danielsson Ltd } \\
		{\large Mackenzie 87}\\
		{\large 21690, Singapore, Binh Thuan, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
