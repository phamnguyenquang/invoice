...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Catherine Christopher Dahlberg} \\
		{\large Brady 55}\\
		{\large 50948, Seoul, Chai Nat, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alyssa Amy  Gunnarsson Inc } \\
		{\large Kaiden 50}\\
		{\large 96359, Frankfurt am Main , Hessen, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
