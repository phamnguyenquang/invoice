...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abigail Rose 	 Jakobsson} \\
		{\large Faith 22}\\
		{\large 34439, San Francisco, Hessen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Colin Mary 	 Abrahamsson Ltd } \\
		{\large Angel 18}\\
		{\large 44471, Melbourne, Amnat Charoen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
