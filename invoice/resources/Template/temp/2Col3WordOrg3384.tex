...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brantley Louise 	 Hellström Inc} \\
		{\large Caroline 20}\\
		{\large 95528, Frankfurt am Main , khanh Hoa, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aurora Andersson } \\
		{\large Kyle 90}\\
		{\large 55855, Washington, Saarland, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
