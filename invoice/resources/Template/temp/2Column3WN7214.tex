...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Silas Louise 	 Lindberg} \\
		{\large Hazel 46}\\
		{\large 72336, Abu Dhabi, Hawaii, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalie Marie 	 Andersson Ltd } \\
		{\large Stella 72}\\
		{\large 22012, Minsk, Kentucky, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
