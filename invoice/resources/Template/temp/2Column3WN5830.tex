...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexa Louise 	 Lindqvist} \\
		{\large Aubrey 97}\\
		{\large 52610, Istanbul, Binh Thuan, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Patrick William Ali Inc } \\
		{\large Jeremiah 99}\\
		{\large 45251, Frankfurt am Main , Texas, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
