...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesus Louise 	 Johansson} \\
		{\large Kyle 85}\\
		{\large 81437, New York , Hainan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juan Marie 	 Henriksson Ltd } \\
		{\large Lillian 79}\\
		{\large 78884, Denver, Ang Thong, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
