...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jasmine Ann  Andreasson} \\
		{\large Antonio 65}\\
		{\large 12825, Frankfurt am Main , Guangdong, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jayden Lee  Jansson Corp } \\
		{\large Harrison 90}\\
		{\large 91192, Lisbon, Binh Thuan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
