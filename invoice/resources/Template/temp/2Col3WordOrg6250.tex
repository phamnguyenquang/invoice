...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ashley Christopher Falk Pte Ltd} \\
		{\large Easton 66}\\
		{\large 61828, Frankfurt am Main , Saarland, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large William Danielsson } \\
		{\large Grace 83}\\
		{\large 42395, London , Chiang Mai, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
