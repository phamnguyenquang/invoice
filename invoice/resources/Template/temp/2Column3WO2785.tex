...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leonardo John Pettersson Inc} \\
		{\large Allison 96}\\
		{\large 97751, Denver, Heibei, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elijah Magnusson } \\
		{\large Brody 6}\\
		{\large 16506, Frankfurt am Main , khanh Hoa, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
