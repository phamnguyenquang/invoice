...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kylie May/Mae 	 Lindqvist} \\
		{\large Angel 10}\\
		{\large 27902, Toronto, Seattles, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sadie Victoria Hedlund Inc } \\
		{\large Reese 25}\\
		{\large 19062, Washington, Saarland, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
