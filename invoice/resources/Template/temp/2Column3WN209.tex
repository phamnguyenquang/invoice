...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Peter Larsson} \\
		{\large Kyle 54}\\
		{\large 99364, Singapore, Chai Nat, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ximena James Eliasson Inc } \\
		{\large Alice 79}\\
		{\large 81885, Toronto, Tuscany, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
