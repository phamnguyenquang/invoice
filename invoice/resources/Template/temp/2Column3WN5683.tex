...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayden Edward Karlsson} \\
		{\large Jayce 3}\\
		{\large 34623, Dubai, Amnat Charoen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Willow Edward Larsson Ltd } \\
		{\large Nathan 82}\\
		{\large 88481, Boston, Tuscany, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
