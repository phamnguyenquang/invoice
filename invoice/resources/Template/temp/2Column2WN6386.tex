...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jocelyn Mårtensson} \\
		{\large Adam 1}\\
		{\large 22886, Toronto, Hawaii, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amelia John Lindgren Pte Ltd } \\
		{\large Jose 92}\\
		{\large 60127, Frankfurt am Main , Saarland, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
