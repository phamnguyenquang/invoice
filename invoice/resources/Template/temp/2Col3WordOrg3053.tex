...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  David Catherine  Lundin Inc} \\
		{\large Rylee 41}\\
		{\large 60157, Shanghai, Buriam, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Clara Mårtensson } \\
		{\large Jessica 94}\\
		{\large 64960, Frankfurt am Main , Hamburg, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
