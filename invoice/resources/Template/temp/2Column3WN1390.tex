...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Riley Louise 	 Bergström} \\
		{\large Joel 96}\\
		{\large 95846, Lisbon, Bremen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Katherine Edward Johansson Pte Ltd } \\
		{\large Amir 74}\\
		{\large 90154, Hong Kong, Chiang Rai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
