...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryleigh William Andreasson} \\
		{\large Eliana 19}\\
		{\large 18530, Los Angeles, Chiang Mai, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian Anne Mårtensson Inc } \\
		{\large Peyton 59}\\
		{\large 25683, Vancouver, Tuscany, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
