...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Camila  Alexander  Olofsson} \\
		{\large Sara 51}\\
		{\large 35394, Rome, Henan, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte Marie 	 Olsson Inc } \\
		{\large Brody 78}\\
		{\large 28747, San Francisco, Binh Thuan, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
