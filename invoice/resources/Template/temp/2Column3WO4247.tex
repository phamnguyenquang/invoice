...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joshua May/Mae 	 Engström Ltd} \\
		{\large Elias 49}\\
		{\large 15615, Frankfurt am Main , Tuscany, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caroline Hassan } \\
		{\large Roman 49}\\
		{\large 60731, Istanbul, Guangzhou, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
