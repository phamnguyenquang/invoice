...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Riley Rose 	 Hedlund} \\
		{\large Emmanuel 96}\\
		{\large 27228, Berlin, Chiang Mai, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie David Bergström Ltd } \\
		{\large Colton 13}\\
		{\large 17841, Istanbul, Seattles, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
