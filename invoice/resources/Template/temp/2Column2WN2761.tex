...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elizabeth Andersson} \\
		{\large Gabrielle 21}\\
		{\large 32297, Istanbul, Chiang Rai, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Christopher Ström Corp } \\
		{\large Isabelle 25}\\
		{\large 21160, Singapore, Hamburg, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
