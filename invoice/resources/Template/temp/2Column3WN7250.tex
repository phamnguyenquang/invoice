...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicole Victoria Bergqvist} \\
		{\large Valeria 86}\\
		{\large 76657, Munich, Buriam, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Daniela Marie 	 Lundqvist Inc } \\
		{\large Ella 54}\\
		{\large 51418, Abu Dhabi, Chiang Mai, Germany }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
