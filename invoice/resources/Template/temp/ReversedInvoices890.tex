...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Uniformed Services University of the Health Sciences} \\
		{\large Tyler 35}\\
		{\large 57903, Rome, Bayern, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ximena Olofsson } \\
		{\large Kayla 85}\\
		{\large 83642, SaiGon, Guangdong, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
%
