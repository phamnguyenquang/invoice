...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zoe Pettersson} \\
		{\large Josiah 33}\\
		{\large 50541, Milan, Guangdong, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian May/Mae 	 Abrahamsson Ltd } \\
		{\large Mason 24}\\
		{\large 89434, Last Vegas, Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
