...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lydia Peter Nordström} \\
		{\large Andrew 3}\\
		{\large 37627, Hanoi, Guangdong, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Clara Elizabeth 	 Mohamed Inc } \\
		{\large Christopher 32}\\
		{\large 85298, Frankfurt am Main , Bangkok, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
