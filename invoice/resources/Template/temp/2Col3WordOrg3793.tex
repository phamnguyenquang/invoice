...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kennedy Catherine  Norberg Pte Ltd} \\
		{\large Sydney 36}\\
		{\large 67616, Amsterdam, Heibei, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Landon Forsberg } \\
		{\large Wesley 66}\\
		{\large 62080, Montreal, Kentucky, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
