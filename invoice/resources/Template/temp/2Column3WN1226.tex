...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Declan Elizabeth 	 Jonsson} \\
		{\large Jaxson 83}\\
		{\large 82228, Osaka, Henan, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leilani Elizabeth 	 Abrahamsson Pte Ltd } \\
		{\large Jordan 95}\\
		{\large 98089, Lisbon, Guangzhou, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
