...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bradley Thomas Sandström} \\
		{\large Dylan 41}\\
		{\large 95412, Dubai, khanh Hoa, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cooper Kate 	 Åkesson Ltd } \\
		{\large Isabel 62}\\
		{\large 80691, Frankfurt am Main , Binh Thuan, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
