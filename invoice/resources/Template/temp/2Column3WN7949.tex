...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity May/Mae 	 Norberg} \\
		{\large Alyssa 46}\\
		{\large 83253, Amsterdam, Tuscany, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sydney Mary 	 Lind Inc } \\
		{\large Luca 78}\\
		{\large 79662, Washington, Heibei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
