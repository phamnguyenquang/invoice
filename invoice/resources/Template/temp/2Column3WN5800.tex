...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian James Gunnarsson} \\
		{\large Juan 28}\\
		{\large 90369, Barcelona, Bayern, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large William Elizabeth 	 Viklund Corp } \\
		{\large Sophie 44}\\
		{\large 56387, Bonn, Chiang Mai, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
