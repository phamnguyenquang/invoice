...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Anna Abrahamsson Pte Ltd} \\
		{\large Caleb 93}\\
		{\large 98574, Washington, Hessen, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eleanor Pettersson } \\
		{\large Arianna 55}\\
		{\large 45962, Frankfurt am Main , Texas, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
