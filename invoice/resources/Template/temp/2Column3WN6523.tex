...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle Marie 	 Fransson} \\
		{\large Hailey 55}\\
		{\large 44955, Frankfurt am Main , Hawaii, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Rylee Christopher Lund Ltd } \\
		{\large Maddox 2}\\
		{\large 74819, Denver, Hessen, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
