...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Penelope Lindqvist} \\
		{\large Joshua 64}\\
		{\large 60493, Florence, Binh Thuan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Catherine Robert Lundström Corp } \\
		{\large Stephanie 52}\\
		{\large 30828, Los Angeles, Indiana, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
