...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Kate 	 Bergström} \\
		{\large Timothy 71}\\
		{\large 74051, Florence, Amnat Charoen, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Micah Christopher Johansson Ltd } \\
		{\large Sean 32}\\
		{\large 29293, Bonn, Guangzhou, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
