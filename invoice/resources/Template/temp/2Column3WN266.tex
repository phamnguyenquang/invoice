...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Noah William Abrahamsson} \\
		{\large Autumn 40}\\
		{\large 28549, Last Vegas, California, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alejandro Robert Berggren Pte Ltd } \\
		{\large Carter 20}\\
		{\large 68990, Sydney, Tuscany, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
