...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Asher Amy  Olsson Pte Ltd} \\
		{\large Maria 48}\\
		{\large 20539, Hong Kong, Chai Nat, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nolan Abrahamsson } \\
		{\large Gabriel 83}\\
		{\large 43583, Washington, Chiang Mai, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
