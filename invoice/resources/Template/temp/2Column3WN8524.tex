...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Morgan  Alexander  Bengtsson} \\
		{\large Calvin 6}\\
		{\large 94523, Vienna, Chai Nat, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sebastian Peter Bergman Pte Ltd } \\
		{\large London 69}\\
		{\large 74222, Boston, Amnat Charoen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
