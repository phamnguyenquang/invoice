...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julian Christopher Månsson} \\
		{\large Nicolas 44}\\
		{\large 93026, Madrid, Bremen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalie Elizabeth 	 Strömberg Ltd } \\
		{\large Gabriella 6}\\
		{\large 93826, Tokyo, Chai Nat, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
