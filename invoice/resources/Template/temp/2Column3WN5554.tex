...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Grant Elizabeth 	 Axelsson} \\
		{\large Bennett 86}\\
		{\large 16026, Shanghai, Ang Thong, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ethan Elizabeth 	 Jakobsson Ltd } \\
		{\large Adalynn 63}\\
		{\large 22941, San Francisco, Amnat Charoen, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
