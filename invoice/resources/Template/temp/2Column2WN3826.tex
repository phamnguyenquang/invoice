...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryan Lundberg} \\
		{\large Angel 53}\\
		{\large 71635, Ho Chi Minh, California, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Malachi Kate 	 Sandström Ltd } \\
		{\large Adam 52}\\
		{\large 94560, Frankfurt am Main , Chiang Rai, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
