...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lilly Louise 	 Björklund Inc} \\
		{\large Ryleigh 26}\\
		{\large 12166, Vienna, Chiang Mai, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Summer Pettersson } \\
		{\large Destiny 24}\\
		{\large 60224, San Francisco, Floria, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
