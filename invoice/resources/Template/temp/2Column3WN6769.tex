...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Rose Rose 	 Dahl} \\
		{\large Kimberly 32}\\
		{\large 43553, Frankfurt am Main , Bremen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Louise 	 Magnusson Pte Ltd } \\
		{\large Damian 30}\\
		{\large 54331, Denver, Guangzhou, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
