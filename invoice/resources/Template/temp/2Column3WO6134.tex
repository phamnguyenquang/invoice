...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Wesley Michael Jönsson Ltd} \\
		{\large Isaiah 88}\\
		{\large 59559, Frankfurt am Main , Huabei, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julia Norberg } \\
		{\large Lily 38}\\
		{\large 53020, Frankfurt am Main , Henan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
