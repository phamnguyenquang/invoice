...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Avery Christopher Blom} \\
		{\large Richard 88}\\
		{\large 38026, Abu Dhabi, Bangkok, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Grace May/Mae 	 Mohamed Ltd } \\
		{\large Logan 4}\\
		{\large 88834, Osaka, Ang Thong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
