...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle Björklund} \\
		{\large Riley 72}\\
		{\large 71347, Seoul, Huabei, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore Anne Samuelsson Pte Ltd } \\
		{\large Claire 32}\\
		{\large 85547, Madrid, Chiang Rai, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
