...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julianna May/Mae 	 Persson Pte Ltd} \\
		{\large Jackson 82}\\
		{\large 77074, Moscow, Seattles, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ezekiel Blom } \\
		{\large Wesley 62}\\
		{\large 33532, San Francisco, Hamburg, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
