...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezra  Alexander  Jönsson} \\
		{\large Luke 5}\\
		{\large 29880, Last Vegas, Buriam, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Amir May/Mae 	 Pålsson Ltd } \\
		{\large Connor 95}\\
		{\large 99860, Ho Chi Minh, Tuscany, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
