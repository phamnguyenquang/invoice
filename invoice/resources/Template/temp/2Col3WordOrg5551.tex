...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Damian Christopher Öberg Pte Ltd} \\
		{\large Lucy 67}\\
		{\large 29768, Bonn, Chiang Mai, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elise Andersson } \\
		{\large Kendall 44}\\
		{\large 15184, Ho Chi Minh, Floria, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
