...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Scarlett John Fredriksson} \\
		{\large Kimberly 78}\\
		{\large 17704, San Francisco, Guangzhou, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden John Mårtensson Inc } \\
		{\large Henry 29}\\
		{\large 14667, Shanghai, Chiang Mai, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
