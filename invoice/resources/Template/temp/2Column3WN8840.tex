...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ava Christopher Lindberg} \\
		{\large Katherine 10}\\
		{\large 81573, Florence, Hainan, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ian Rose 	 Sandström Pte Ltd } \\
		{\large Alyssa 74}\\
		{\large 85474, SaiGon, Hamburg, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
