...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla Grace 	 Gustafsson Corp} \\
		{\large Laila 91}\\
		{\large 52900, Frankfurt am Main , Ang Thong, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Lundberg } \\
		{\large Brielle 96}\\
		{\large 52178, Abu Dhabi, Texas, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
