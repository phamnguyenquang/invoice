...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Hudson Louise 	 Martinsson} \\
		{\large Tyler 28}\\
		{\large 29372, Washington, California, Turkey }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Braxton Marie 	 Söderberg Corp } \\
		{\large Sara 1}\\
		{\large 23545, Nha Trang, khanh Hoa, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
