...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elijah Michael Bengtsson Corp} \\
		{\large Samuel 89}\\
		{\large 84072, Frankfurt am Main , Hessen, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicole Fredriksson } \\
		{\large Aria 36}\\
		{\large 27248, Rome, Binh Thuan, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
