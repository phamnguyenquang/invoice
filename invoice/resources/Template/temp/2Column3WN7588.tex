...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Parker James Andersson} \\
		{\large Mariah 91}\\
		{\large 71205, SaiGon, Ang Thong, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mark  Alexander  Ali Pte Ltd } \\
		{\large Lydia 43}\\
		{\large 75237, Last Vegas, Huabei, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
