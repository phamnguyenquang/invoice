...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sarah Thomas Ali} \\
		{\large Alexandra 60}\\
		{\large 92950, Frankfurt am Main , Chai Nat, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elias Peter Strömberg Pte Ltd } \\
		{\large King 54}\\
		{\large 87801, Toronto, Heibei, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
