...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly William Nordström} \\
		{\large Paisley 62}\\
		{\large 79839, Nha Trang, Chai Nat, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer  Alexander  Söderberg Pte Ltd } \\
		{\large Jaxson 42}\\
		{\large 59009, Los Angeles, California, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
