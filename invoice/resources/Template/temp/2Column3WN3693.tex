...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melody Victoria Danielsson} \\
		{\large Angelina 26}\\
		{\large 78790, Frankfurt am Main , Tuscany, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryleigh Amy  Nyström Inc } \\
		{\large Henry 14}\\
		{\large 81167, Florence, Seattles, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
