...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ryder Louise 	 Dahl} \\
		{\large Gracie 10}\\
		{\large 10755, SaiGon, Guangdong, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Naomi May/Mae 	 Arvidsson Inc } \\
		{\large Vivian 72}\\
		{\large 63356, Frankfurt am Main , Guangzhou, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
