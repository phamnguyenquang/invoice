...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zachary Christopher Nordström} \\
		{\large Jameson 71}\\
		{\large 18955, Paris, Chai Nat, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ezekiel May/Mae 	 Sjögren Ltd } \\
		{\large Noah 52}\\
		{\large 76994, Dubai, Amnat Charoen, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
