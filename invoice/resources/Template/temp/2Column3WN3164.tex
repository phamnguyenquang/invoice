...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harrison William Ekström} \\
		{\large Abel 99}\\
		{\large 65630, Madrid, Hamburg, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrew May/Mae 	 Olsson Ltd } \\
		{\large Annabelle 2}\\
		{\large 37403, Singapore, khanh Hoa, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
