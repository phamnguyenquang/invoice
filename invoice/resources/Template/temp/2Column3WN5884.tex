...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Graham David Eliasson} \\
		{\large Sara 53}\\
		{\large 23942, Stuttgart, Indiana, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Colin William Abrahamsson Ltd } \\
		{\large Adeline 67}\\
		{\large 57501, Washington, Kentucky, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
