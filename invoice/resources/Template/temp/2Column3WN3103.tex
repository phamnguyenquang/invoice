...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Braxton Louise 	 Lund} \\
		{\large Ivan 80}\\
		{\large 64072, Milan, Heibei, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hailey Elizabeth 	 Ekström Pte Ltd } \\
		{\large Isabelle 80}\\
		{\large 99643, Dubai, Chiang Rai, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
