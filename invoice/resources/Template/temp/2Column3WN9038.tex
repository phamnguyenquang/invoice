...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriella Victoria Eriksson} \\
		{\large Amelia 49}\\
		{\large 37898, Amsterdam, Phu Yen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Graham Peter Lindström Corp } \\
		{\large Alexis 5}\\
		{\large 14371, Madrid, Hainan, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
