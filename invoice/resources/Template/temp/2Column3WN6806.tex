...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Savannah Michael Bergström} \\
		{\large Easton 32}\\
		{\large 90932, Abu Dhabi, Binh Thuan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sawyer David Magnusson Corp } \\
		{\large Alex 10}\\
		{\large 58845, Abu Dhabi, Hawaii, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
