...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victoria Björklund} \\
		{\large Cole 18}\\
		{\large 60623, Barcelona, Hainan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jasmine Elizabeth 	 Hermansson Ltd } \\
		{\large Gabrielle 50}\\
		{\large 14820, Osaka, Guangdong, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
