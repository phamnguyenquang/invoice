...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Adeline William Söderberg} \\
		{\large Luca 71}\\
		{\large 13311, Frankfurt am Main , Hainan, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Richard  Alexander  Björk Pte Ltd } \\
		{\large Evelyn 29}\\
		{\large 13731, Hanoi, Hamburg, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
