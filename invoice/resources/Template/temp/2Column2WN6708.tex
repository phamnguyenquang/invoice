...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michael Lindberg} \\
		{\large Edward 91}\\
		{\large 77772, Frankfurt am Main , Heibei, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Faith Catherine  Bengtsson Inc } \\
		{\large Jaden 48}\\
		{\large 31044, Seoul, Floria, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
