...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Melody Håkansson} \\
		{\large Paige 72}\\
		{\large 78334, Shanghai, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Samuel Edward Sandström Pte Ltd } \\
		{\large Angel 29}\\
		{\large 16319, Vienna, Kentucky, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
