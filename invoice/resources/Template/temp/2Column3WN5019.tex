...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mary Elizabeth 	 Wallin} \\
		{\large Austin 67}\\
		{\large 95674, Washington, Hessen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Max Michael Jonsson Pte Ltd } \\
		{\large Aiden 88}\\
		{\large 17714, Denver, Guangzhou, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
