...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Université catholique de Louvain} \\
		{\large Jack 63}\\
		{\large 77953, Taipei, Texas, Saudi Arabia }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Peyton Berglund } \\
		{\large Harper 46}\\
		{\large 51102, Stuttgart, khanh Hoa, Indonesia s}\\
    \switchcolumn
