...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ruby Amy  Lind} \\
		{\large King 6}\\
		{\large 46226, Toronto, Saarland, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Cayden Marie 	 Lindström Ltd } \\
		{\large Peyton 47}\\
		{\large 22084, Frankfurt am Main , Chiang Mai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
