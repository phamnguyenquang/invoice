...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Peyton James Andreasson Pte Ltd} \\
		{\large Brianna 14}\\
		{\large 37699, Singapore, California, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brantley Björklund } \\
		{\large Khloe 26}\\
		{\large 69850, Bonn, khanh Hoa, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
