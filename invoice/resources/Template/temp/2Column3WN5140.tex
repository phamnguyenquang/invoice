...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Preston Rose 	 Björklund} \\
		{\large Jaxon 85}\\
		{\large 80115, SaiGon, Indiana, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Malachi Christopher Berggren Pte Ltd } \\
		{\large Sarah 50}\\
		{\large 27164, San Francisco, Phu Yen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
