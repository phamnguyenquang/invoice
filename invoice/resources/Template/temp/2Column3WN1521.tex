...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alejandro Amy  Åberg} \\
		{\large Lily 68}\\
		{\large 53513, London , Heibei, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Matthew William Olsson Pte Ltd } \\
		{\large Jocelyn 32}\\
		{\large 11433, Hong Kong, Binh Thuan, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
