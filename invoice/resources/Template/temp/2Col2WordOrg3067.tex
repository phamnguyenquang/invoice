...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valeria Martinsson Pte Ltd} \\
		{\large Christopher 20}\\
		{\large 64713, Nha Trang, Binh Thuan, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ivan Pettersson } \\
		{\large Jackson 91}\\
		{\large 84936, Chicago, Heibei, Turkey }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
