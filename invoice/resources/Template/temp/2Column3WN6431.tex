...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jackson Elizabeth 	 Lindholm} \\
		{\large Santiago 86}\\
		{\large 45490, Seoul, Buriam, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie Louise 	 Ström Inc } \\
		{\large Wesley 6}\\
		{\large 78828, Barcelona, Guangdong, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
