...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Summer Thomas Samuelsson Ltd} \\
		{\large Santiago 16}\\
		{\large 78806, San Francisco, Bayern, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley Abrahamsson } \\
		{\large Zachary 73}\\
		{\large 51534, Barcelona, Huabei, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
