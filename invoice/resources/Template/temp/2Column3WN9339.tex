...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriel Elizabeth 	 Bergqvist} \\
		{\large Summer 11}\\
		{\large 53491, Madrid, Chai Nat, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aaliyah William Eliasson Inc } \\
		{\large Ayden 98}\\
		{\large 35474, Beijing, Buriam, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
