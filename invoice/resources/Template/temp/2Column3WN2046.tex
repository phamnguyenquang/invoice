...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly Grace 	 Jönsson} \\
		{\large Jackson 66}\\
		{\large 70102, Stuttgart, Hamburg, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nathaniel Jane Hermansson Ltd } \\
		{\large Jose 73}\\
		{\large 25271, Dublin, Chiang Mai, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
