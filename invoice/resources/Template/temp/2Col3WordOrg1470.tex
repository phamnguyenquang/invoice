...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caroline Jane Olsson Pte Ltd} \\
		{\large Lilly 42}\\
		{\large 24203, Last Vegas, Seattles, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sara Arvidsson } \\
		{\large Adalynn 62}\\
		{\large 48442, Frankfurt am Main , Floria, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
