...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emery William Ström Corp} \\
		{\large Aubrey 74}\\
		{\large 24670, Frankfurt am Main , Henan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Asher Blom } \\
		{\large Theodore 16}\\
		{\large 82566, Nha Trang, Ang Thong, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
