...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  David Catherine  Lindström Pte Ltd} \\
		{\large Elizabeth 98}\\
		{\large 26001, Abu Dhabi, Hessen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Braxton Holmgren } \\
		{\large Michael 27}\\
		{\large 87287, Moscow, Binh Thuan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
