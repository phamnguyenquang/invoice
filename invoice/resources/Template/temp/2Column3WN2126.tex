...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emily Louise 	 Dahlberg} \\
		{\large Kaylee 28}\\
		{\large 45125, Los Angeles, Bayern, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella John Pettersson Inc } \\
		{\large Layla 99}\\
		{\large 31428, Moscow, Amnat Charoen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
