...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mackenzie Catherine  Axelsson Corp} \\
		{\large Micah 49}\\
		{\large 94776, Frankfurt am Main , Bremen, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hayden Andreasson } \\
		{\large Alan 83}\\
		{\large 92271, Singapore, Phu Yen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
