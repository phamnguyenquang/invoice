...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Savannah William Pålsson Pte Ltd} \\
		{\large Parker 78}\\
		{\large 15539, Florence, Henan, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brooklynn Andreasson } \\
		{\large Aaliyah 83}\\
		{\large 29311, Washington, Saarland, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
