...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Izabella Mårtensson} \\
		{\large Wesley 1}\\
		{\large 99207, San Francisco, Indiana, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maxwell Edward Forsberg Corp } \\
		{\large Gabrielle 68}\\
		{\large 68067, Hong Kong, Guangdong, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
