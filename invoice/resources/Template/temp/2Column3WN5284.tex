...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juliana Mary 	 Bergqvist} \\
		{\large Aidan 79}\\
		{\large 85278, Florence, California, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mark Grace 	 Åberg Ltd } \\
		{\large Jonah 18}\\
		{\large 24425, Melbourne, California, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
