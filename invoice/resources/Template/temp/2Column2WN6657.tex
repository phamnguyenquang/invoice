...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Roman Claesson} \\
		{\large Lucy 92}\\
		{\large 89290, Venice, Binh Thuan, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Silas Christopher Persson Pte Ltd } \\
		{\large Ian 69}\\
		{\large 37741, Los Angeles, Binh Thuan, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
