...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nicholas Mary 	 Abrahamsson} \\
		{\large Luke 28}\\
		{\large 89245, Hanoi, Indiana, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emilia Michael Bergqvist Ltd } \\
		{\large Alexis 35}\\
		{\large 35955, Munich, Amnat Charoen, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
