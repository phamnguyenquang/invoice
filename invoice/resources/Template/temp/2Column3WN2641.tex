...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katherine Michael Fransson} \\
		{\large Bryan 49}\\
		{\large 60428, Los Angeles, Buriam, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eli Edward Gunnarsson Corp } \\
		{\large Katherine 23}\\
		{\large 20569, Melbourne, Hawaii, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
