...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christian Elizabeth 	 Lindström Inc} \\
		{\large Charles 96}\\
		{\large 13273, Barcelona, Chiang Mai, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaitlyn Andersson } \\
		{\large Camden 79}\\
		{\large 86722, Melbourne, Buriam, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
