...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle Dahl Pte Ltd} \\
		{\large Malachi 58}\\
		{\large 54947, Frankfurt am Main , Amnat Charoen, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon Magnusson } \\
		{\large Adalyn 91}\\
		{\large 91159, Last Vegas, Floria, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
