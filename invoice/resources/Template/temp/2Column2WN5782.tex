...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Eden Hedlund} \\
		{\large Mark 15}\\
		{\large 51377, Frankfurt am Main , California, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Caden Louise 	 Fransson Ltd } \\
		{\large Adam 98}\\
		{\large 37518, Venice, Floria, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
