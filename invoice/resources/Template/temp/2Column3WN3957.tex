...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonathan Christopher Pålsson} \\
		{\large Maria 28}\\
		{\large 17224, London , Hessen, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Arianna Elizabeth 	 Wallin Corp } \\
		{\large Justin 58}\\
		{\large 79906, Munich, Saarland, Cambodia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
