...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabella Victoria Söderberg Corp} \\
		{\large Miles 41}\\
		{\large 88169, Melbourne, Chai Nat, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sean Jonsson } \\
		{\large Alex 20}\\
		{\large 12719, Beijing, Amnat Charoen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
