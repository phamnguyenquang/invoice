...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jameson Louise 	 Berglund} \\
		{\large Summer 76}\\
		{\large 53791, Melbourne, Guangzhou, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Patrick Louise 	 Sundberg Pte Ltd } \\
		{\large Summer 25}\\
		{\large 99759, Berlin, Guangdong, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
