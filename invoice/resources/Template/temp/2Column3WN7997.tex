...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Faith Ann  Fredriksson} \\
		{\large Adeline 44}\\
		{\large 45374, Singapore, Hessen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Eva Michael Gunnarsson Pte Ltd } \\
		{\large Brody 5}\\
		{\large 22048, Melbourne, Floria, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
