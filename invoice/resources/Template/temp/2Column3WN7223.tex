...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Valerie Catherine  Bergman} \\
		{\large Vivian 7}\\
		{\large 63679, Abu Dhabi, Heibei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elizabeth Amy  Lundström Corp } \\
		{\large Kendall 8}\\
		{\large 68977, Amsterdam, Ang Thong, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
