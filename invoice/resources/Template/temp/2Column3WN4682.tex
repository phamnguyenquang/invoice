...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Madison Thomas Engström} \\
		{\large Evelyn 16}\\
		{\large 64916, London , Hessen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ava May/Mae 	 Eklund Inc } \\
		{\large Gael 14}\\
		{\large 27521, Frankfurt am Main , Chai Nat, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
