...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Michelle Ann  Björk} \\
		{\large Victoria 26}\\
		{\large 23544, Seoul, Guangzhou, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alan Victoria Dahlberg Pte Ltd } \\
		{\large Cameron 23}\\
		{\large 24306, Montreal, California, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
