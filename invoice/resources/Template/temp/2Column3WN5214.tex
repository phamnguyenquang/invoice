...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  William Jane Björklund} \\
		{\large George 85}\\
		{\large 78521, Barcelona, Ang Thong, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Brandon Catherine  Karlsson Corp } \\
		{\large Tucker 55}\\
		{\large 51739, Singapore, Huabei, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
