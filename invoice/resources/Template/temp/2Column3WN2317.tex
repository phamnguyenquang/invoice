...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Emily Jane Mårtensson} \\
		{\large Rachel 20}\\
		{\large 21821, Venice, Seattles, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valeria Victoria Mårtensson Ltd } \\
		{\large Taylor 27}\\
		{\large 24322, Ho Chi Minh, Floria, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
