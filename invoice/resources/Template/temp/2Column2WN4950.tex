...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Parker Viklund} \\
		{\large Sara 17}\\
		{\large 64078, Beijing, Binh Thuan, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julian Louise 	 Martinsson Ltd } \\
		{\large Violet 78}\\
		{\large 46693, Frankfurt am Main , khanh Hoa, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
