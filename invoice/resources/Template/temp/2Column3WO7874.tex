...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ava Christopher Jonsson Inc} \\
		{\large Jack 93}\\
		{\large 47334, Boston, Floria, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie Lundqvist } \\
		{\large Nathaniel 91}\\
		{\large 91981, Frankfurt am Main , Amnat Charoen, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
