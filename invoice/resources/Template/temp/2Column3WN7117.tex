...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sebastian Lee  Abrahamsson} \\
		{\large Harmony 9}\\
		{\large 67850, Venice, Bayern, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Theodore Peter Larsson Ltd } \\
		{\large Ariana 74}\\
		{\large 67620, Ho Chi Minh, Amnat Charoen, Mexico }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
