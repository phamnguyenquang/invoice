...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Elias Anne Hermansson} \\
		{\large Joseph 58}\\
		{\large 59129, Frankfurt am Main , Indiana, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kayden Thomas Persson Ltd } \\
		{\large Hadley 48}\\
		{\large 28605, Washington, Kentucky, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
