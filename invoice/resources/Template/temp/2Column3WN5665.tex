...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Norah Elizabeth 	 Holm} \\
		{\large Richard 53}\\
		{\large 37828, Berlin, Kentucky, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Giovanni Victoria Forsberg Pte Ltd } \\
		{\large James 28}\\
		{\large 46753, Madrid, Binh Thuan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
