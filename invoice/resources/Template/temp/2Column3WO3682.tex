...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Angelina Robert Berggren Corp} \\
		{\large Isabelle 73}\\
		{\large 25624, Bonn, Chiang Mai, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mackenzie Falk } \\
		{\large Andrew 1}\\
		{\large 71399, Frankfurt am Main , California, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
