...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
		\textbf{\huge  Ulsan National Institute of Science and Technology	South} \\
		{\large Scarlett 61}\\
		{\large 64710, Washington, Seattles, Canada }\\
...
%RECEIVER INFORMATION
  ...
  \begin{paracol}{3}
	 	\textbf{\large Genesis Åkesson } \\
		{\large Payton 90}\\
		{\large 85612, Venice, Guangdong, Australia }\\
    \switchcolumn
