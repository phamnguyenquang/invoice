...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everett Christopher Andreasson} \\
		{\large Jaxson 24}\\
		{\large 65500, Abu Dhabi, Seattles, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Molly William Fransson Ltd } \\
		{\large Lilly 65}\\
		{\large 95729, Frankfurt am Main , Texas, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
