...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  William Robert Sundberg} \\
		{\large Connor 4}\\
		{\large 21872, San Francisco, Bremen, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Juliana James Åberg Pte Ltd } \\
		{\large Trinity 37}\\
		{\large 74348, Melbourne, Chiang Rai, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
