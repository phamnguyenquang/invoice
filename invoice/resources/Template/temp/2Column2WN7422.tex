...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lily Olsson} \\
		{\large Patrick 26}\\
		{\large 62663, Frankfurt am Main , Hainan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Liliana Amy  Andersson Ltd } \\
		{\large Michelle 58}\\
		{\large 98364, Frankfurt am Main , Hawaii, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
