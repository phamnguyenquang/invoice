...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Asher Robert Jakobsson} \\
		{\large Brayden 4}\\
		{\large 18642, Tokyo, Bremen, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Reese Thomas Pettersson Ltd } \\
		{\large Adeline 58}\\
		{\large 65196, San Francisco, Guangdong, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
