...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Katherine Christopher Gustafsson} \\
		{\large Norah 80}\\
		{\large 30644, Dublin, Binh Thuan, Singapore}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sydney Kate 	 Axelsson Corp } \\
		{\large Tristan 92}\\
		{\large 16720, Frankfurt am Main , Huabei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
