...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Abigail Fredriksson} \\
		{\large Aidan 98}\\
		{\large 61398, Singapore, Chai Nat, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery Catherine  Gunnarsson Ltd } \\
		{\large Brooklynn 84}\\
		{\large 97708, Hong Kong, Seattles, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
