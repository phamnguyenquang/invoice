...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aiden  Alexander  Abrahamsson Pte Ltd} \\
		{\large Miles 74}\\
		{\large 98374, Munich, Guangdong, India }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melanie Samuelsson } \\
		{\large Katherine 26}\\
		{\large 79996, Shanghai, Indiana, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
