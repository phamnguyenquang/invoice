...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Naomi Thomas Björk} \\
		{\large Abigail 32}\\
		{\large 85140, Istanbul, Binh Thuan, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Bentley Anne Gustafsson Pte Ltd } \\
		{\large Luke 39}\\
		{\large 48472, Minsk, Hessen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
