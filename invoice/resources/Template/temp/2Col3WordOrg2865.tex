...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaron Elizabeth 	 Lindgren Pte Ltd} \\
		{\large Richard 88}\\
		{\large 24445, Vancouver, Saarland, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Elias Henriksson } \\
		{\large Aurora 17}\\
		{\large 87697, Frankfurt am Main , Buriam, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
