...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aaliyah  Alexander  Nordin} \\
		{\large Maya 22}\\
		{\large 72613, Melbourne, Bangkok, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Oscar Victoria Berggren Ltd } \\
		{\large Rose 79}\\
		{\large 86105, Barcelona, Seattles, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
