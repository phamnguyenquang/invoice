...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Thomas Dahl} \\
		{\large Antonio 76}\\
		{\large 19792, Istanbul, California, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charlotte William Andreasson Corp } \\
		{\large Mackenzie 31}\\
		{\large 72652, Seoul, Heibei, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
