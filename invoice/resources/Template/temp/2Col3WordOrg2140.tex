...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sarah David Claesson Ltd} \\
		{\large Charlotte 46}\\
		{\large 92184, Stuttgart, Chiang Mai, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Scarlett Andersson } \\
		{\large Kendall 24}\\
		{\large 38483, Toronto, Amnat Charoen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
