...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Daniel Elizabeth 	 Björk} \\
		{\large Isla 70}\\
		{\large 37154, Milan, Phu Yen, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaiden Michael Fransson Corp } \\
		{\large Daniel 77}\\
		{\large 36812, Stuttgart, Chiang Mai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
