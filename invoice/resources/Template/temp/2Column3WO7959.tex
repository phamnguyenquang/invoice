...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Lucy Victoria Lindgren Inc} \\
		{\large Norah 86}\\
		{\large 80715, Budapest, Hamburg, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valentina Gunnarsson } \\
		{\large Lydia 22}\\
		{\large 33454, Stuttgart, California, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
