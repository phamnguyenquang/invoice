...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makenzie David Nyberg} \\
		{\large Graham 77}\\
		{\large 83747, Ho Chi Minh, Ang Thong, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Makenzie Robert Hedlund Pte Ltd } \\
		{\large Grayson 81}\\
		{\large 66793, Stuttgart, Tuscany, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
