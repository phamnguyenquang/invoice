...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jack Rose 	 Mårtensson} \\
		{\large Alexander 92}\\
		{\large 33265, Lisbon, Tuscany, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Colton Ann  Håkansson Pte Ltd } \\
		{\large Adalyn 32}\\
		{\large 96834, Stuttgart, Amnat Charoen, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
