...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victor Christopher Ström Pte Ltd} \\
		{\large Diego 18}\\
		{\large 16322, Dubai, Saarland, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubree Nyström } \\
		{\large Arianna 24}\\
		{\large 89143, Vancouver, Chiang Mai, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
