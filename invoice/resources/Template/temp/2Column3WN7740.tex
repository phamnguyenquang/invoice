...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jennifer William Karlsson} \\
		{\large Naomi 69}\\
		{\large 40014, Abu Dhabi, Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexa Peter Norberg Pte Ltd } \\
		{\large Eden 95}\\
		{\large 16140, Hong Kong, Binh Thuan, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
