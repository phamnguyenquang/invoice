...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nathaniel Christopher Isaksson} \\
		{\large Sophia 80}\\
		{\large 26509, Madrid, Bremen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Joseph Lee  Bergqvist Pte Ltd } \\
		{\large Ellie 61}\\
		{\large 39073, Last Vegas, Hamburg, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
