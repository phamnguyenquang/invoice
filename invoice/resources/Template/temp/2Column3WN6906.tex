...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kai  Alexander  Jansson} \\
		{\large Zoe 6}\\
		{\large 83396, Berlin, Phu Yen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everett Robert Björklund Ltd } \\
		{\large Kenneth 40}\\
		{\large 95682, Frankfurt am Main , California, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
