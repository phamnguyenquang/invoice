...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Thomas Olofsson} \\
		{\large Naomi 69}\\
		{\large 77617, Frankfurt am Main , Henan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Valeria  Alexander  Bengtsson Ltd } \\
		{\large Jason 9}\\
		{\large 25723, Amsterdam, Heibei, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
