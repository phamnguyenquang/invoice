...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Juliana Edward Lindholm} \\
		{\large Alexandra 31}\\
		{\large 86501, Sydney, Texas, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Piper Michael Forsberg Inc } \\
		{\large Lydia 25}\\
		{\large 13693, Los Angeles, Henan, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
