...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Nolan Grace 	 Berglund} \\
		{\large William 65}\\
		{\large 91716, Frankfurt am Main , Hessen, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nicole Rose 	 Viklund Corp } \\
		{\large Ezekiel 36}\\
		{\large 60489, Singapore, Floria, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
