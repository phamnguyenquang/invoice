...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ezra Lee  Lindberg} \\
		{\large Silas 81}\\
		{\large 23569, Denver, Bremen, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Margaret Elizabeth 	 Fransson Pte Ltd } \\
		{\large Alexandra 36}\\
		{\large 36819, Nha Trang, Tuscany, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
