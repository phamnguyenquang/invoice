...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Destiny Robert Gunnarsson} \\
		{\large Harrison 36}\\
		{\large 55998, Madrid, Seattles, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carter Jane Löfgren Pte Ltd } \\
		{\large King 26}\\
		{\large 29828, Stuttgart, Phu Yen, Brazil }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
