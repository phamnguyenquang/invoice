...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sofia Kate 	 Henriksson} \\
		{\large Maverick 70}\\
		{\large 50193, Ho Chi Minh, Indiana, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Christopher Edward Fransson Inc } \\
		{\large Adam 75}\\
		{\large 74645, Ho Chi Minh, Phu Yen, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
