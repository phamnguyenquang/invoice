...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaden Sandström} \\
		{\large Lyla 91}\\
		{\large 20931, Florence, Seattles, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kendall Christopher Sundberg Ltd } \\
		{\large Vanessa 45}\\
		{\large 14432, Beijing, Kentucky, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
