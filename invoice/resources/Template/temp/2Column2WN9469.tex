...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Peyton Jakobsson} \\
		{\large Rose 70}\\
		{\large 56691, Florence, Chiang Mai, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Vivian William Lindqvist Pte Ltd } \\
		{\large Gabriella 12}\\
		{\large 21850, Hong Kong, Chiang Mai, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
