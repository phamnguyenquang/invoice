...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity  Alexander  Lindgren Pte Ltd} \\
		{\large Mariah 19}\\
		{\large 20961, Amsterdam, Hamburg, New Zealand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kevin Pettersson } \\
		{\large Brianna 87}\\
		{\large 34056, Singapore, Guangdong, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
