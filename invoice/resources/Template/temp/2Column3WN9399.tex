...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Matthew Christopher Viklund} \\
		{\large Wesley 8}\\
		{\large 95187, Nha Trang, Saarland, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jude Christopher Fransson Corp } \\
		{\large Sophia 19}\\
		{\large 92303, Frankfurt am Main , Saarland, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
