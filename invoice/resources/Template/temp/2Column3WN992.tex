...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jude Lee  Mattsson} \\
		{\large Roman 70}\\
		{\large 80251, Frankfurt am Main , Binh Thuan, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ayden William Lindholm Ltd } \\
		{\large Mackenzie 55}\\
		{\large 53374, Los Angeles, Hawaii, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
