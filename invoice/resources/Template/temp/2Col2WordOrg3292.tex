...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Bennett Jakobsson Pte Ltd} \\
		{\large Maximus 62}\\
		{\large 74801, Vancouver, Amnat Charoen, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Payton Söderberg } \\
		{\large Maxwell 24}\\
		{\large 19231, Frankfurt am Main , Henan, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
