...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Isabelle Edward Forsberg Pte Ltd} \\
		{\large Adriana 92}\\
		{\large 39139, Frankfurt am Main , Hamburg, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kai Hellström } \\
		{\large King 75}\\
		{\large 77360, Frankfurt am Main , Texas, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
