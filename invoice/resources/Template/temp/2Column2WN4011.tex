...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Everett Hedlund} \\
		{\large Isabella 3}\\
		{\large 23265, Frankfurt am Main , Saarland, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sophia Christopher Strömberg Corp } \\
		{\large Jeremiah 17}\\
		{\large 80756, Chicago, Heibei, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
