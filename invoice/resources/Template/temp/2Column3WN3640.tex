...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Harmony Peter Pålsson} \\
		{\large Connor 98}\\
		{\large 84872, Melbourne, Hessen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gavin Thomas Löfgren Pte Ltd } \\
		{\large Damian 44}\\
		{\large 78921, Frankfurt am Main , Ang Thong, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
