...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Trinity Thomas Hansson} \\
		{\large Kaleb 78}\\
		{\large 26570, Minsk, Hainan, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriel Victoria Hermansson Pte Ltd } \\
		{\large Ryker 56}\\
		{\large 96927, Vancouver, Bangkok, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
