...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jocelyn Louise 	 Löfgren} \\
		{\large Katherine 16}\\
		{\large 51680, San Francisco, Hawaii, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Melanie James Hansen Ltd } \\
		{\large Chase 71}\\
		{\large 59226, Nha Trang, Hamburg, VietNam}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
