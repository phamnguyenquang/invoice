...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Joel Kate 	 Lindström} \\
		{\large Noah 7}\\
		{\large 79128, Abu Dhabi, Texas, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Avery May/Mae 	 Magnusson Corp } \\
		{\large Alexandra 74}\\
		{\large 99149, Frankfurt am Main , khanh Hoa, ThaiLand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
