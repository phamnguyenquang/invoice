...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kennedy Löfgren} \\
		{\large Gabriella 33}\\
		{\large 73978, Montreal, khanh Hoa, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Santiago Christopher Hellström Pte Ltd } \\
		{\large George 9}\\
		{\large 83257, Montreal, Huabei, China }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
