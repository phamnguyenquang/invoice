...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Caleb Louise 	 Jönsson} \\
		{\large Tucker 91}\\
		{\large 75848, Bonn, Guangdong, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Riley Louise 	 Isaksson Corp } \\
		{\large Mia 10}\\
		{\large 88384, Barcelona, California, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
