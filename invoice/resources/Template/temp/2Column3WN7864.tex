...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mia Mary 	 Abrahamsson} \\
		{\large Lucas 13}\\
		{\large 51048, Ho Chi Minh, Amnat Charoen, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jennifer Ann  Ek Pte Ltd } \\
		{\large Arianna 22}\\
		{\large 84003, Montreal, Hamburg, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
