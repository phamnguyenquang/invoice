...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Paul Thomas Olofsson Pte Ltd} \\
		{\large Alex 21}\\
		{\large 74084, Dublin, Hamburg, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Luca Strömberg } \\
		{\large Avery 68}\\
		{\large 19435, Frankfurt am Main , Phu Yen, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
