...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jesse Michael Mattsson Pte Ltd} \\
		{\large Ian 93}\\
		{\large 26702, Taipei, Heibei, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Everett Hansson } \\
		{\large Isaiah 57}\\
		{\large 24725, Boston, Binh Thuan, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
