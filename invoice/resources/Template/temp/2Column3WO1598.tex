...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Oscar Kate 	 Fredriksson Pte Ltd} \\
		{\large Isaac 46}\\
		{\large 93126, Singapore, California, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lyla Lindholm } \\
		{\large Joshua 20}\\
		{\large 18619, Nha Trang, Henan, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
