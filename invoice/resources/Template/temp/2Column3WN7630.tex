...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alyssa Rose 	 Danielsson} \\
		{\large Ryan 93}\\
		{\large 32851, San Francisco, Heibei, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Skylar Amy  Lundberg Inc } \\
		{\large Zachary 4}\\
		{\large 12636, Ho Chi Minh, Amnat Charoen, India }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
