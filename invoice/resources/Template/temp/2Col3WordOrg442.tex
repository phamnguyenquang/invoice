...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Leilani Grace 	 Magnusson Pte Ltd} \\
		{\large Josephine 8}\\
		{\large 68705, Chicago, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Emmett Holm } \\
		{\large Ivy 6}\\
		{\large 75383, Frankfurt am Main , Huabei, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
