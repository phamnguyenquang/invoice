...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Josephine Bengtsson} \\
		{\large Amy 95}\\
		{\large 84043, Hanoi, khanh Hoa, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julianna  Alexander  Lund Pte Ltd } \\
		{\large Aidan 83}\\
		{\large 70870, New York , Floria, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
