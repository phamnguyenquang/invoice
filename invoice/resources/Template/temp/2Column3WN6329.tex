...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jonah Louise 	 Jonsson} \\
		{\large Aria 22}\\
		{\large 53786, Abu Dhabi, Amnat Charoen, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Abigail Louise 	 Wallin Corp } \\
		{\large Eden 69}\\
		{\large 49145, Hong Kong, Hamburg, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
