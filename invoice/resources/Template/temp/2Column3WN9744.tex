...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kingston Catherine  Löfgren} \\
		{\large Declan 68}\\
		{\large 65584, Frankfurt am Main , Bremen, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Payton  Alexander  Månsson Inc } \\
		{\large Sebastian 36}\\
		{\large 53641, Stuttgart, Hessen, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
