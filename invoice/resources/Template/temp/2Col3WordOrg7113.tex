...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charlotte  Alexander  Lindqvist Pte Ltd} \\
		{\large Sophie 41}\\
		{\large 19316, Amsterdam, Guangzhou, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Lilly Åberg } \\
		{\large Paige 66}\\
		{\large 19528, Ho Chi Minh, Chiang Mai, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
