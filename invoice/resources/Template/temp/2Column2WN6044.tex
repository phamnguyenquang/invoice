...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Patrick Bergström} \\
		{\large Oliver 41}\\
		{\large 48687, Frankfurt am Main , Chiang Rai, Germany }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Josiah May/Mae 	 Danielsson Pte Ltd } \\
		{\large Nora 27}\\
		{\large 85272, Minsk, Phu Yen, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
