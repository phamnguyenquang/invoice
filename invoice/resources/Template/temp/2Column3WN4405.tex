...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Serenity Christopher Sundberg} \\
		{\large Alex 30}\\
		{\large 39616, SaiGon, Henan, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kaleb Thomas Lindberg Corp } \\
		{\large Elise 25}\\
		{\large 56664, Venice, Hessen, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
