...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jessica Robert Åkesson Pte Ltd} \\
		{\large Leilani 13}\\
		{\large 84893, Los Angeles, Amnat Charoen, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Isabelle Lund } \\
		{\large Makayla 67}\\
		{\large 88601, Washington, Henan, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
