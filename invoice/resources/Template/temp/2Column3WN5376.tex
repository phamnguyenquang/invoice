...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabrielle John Lundström} \\
		{\large Aiden 43}\\
		{\large 52594, Vancouver, Seattles, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Allison Catherine  Löfgren Ltd } \\
		{\large Camden 78}\\
		{\large 54572, Taipei, Heibei, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
