...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kaylee Grace 	 Johansson} \\
		{\large Jaxson 96}\\
		{\large 86474, Denver, Indiana, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Savannah Elizabeth 	 Hermansson Ltd } \\
		{\large Riley 45}\\
		{\large 34894, Amsterdam, Buriam, Philippines}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
