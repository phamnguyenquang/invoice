...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Audrey  Alexander  Andersson Pte Ltd} \\
		{\large Kennedy 58}\\
		{\large 91569, Milan, Huabei, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Stephanie Holmberg } \\
		{\large Kimberly 64}\\
		{\large 27609, San Francisco, Bremen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
