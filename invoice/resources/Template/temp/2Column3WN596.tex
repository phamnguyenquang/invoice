...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Christopher Ann  Arvidsson} \\
		{\large Taylor 51}\\
		{\large 30186, Melbourne, Seattles, Denmark}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryder Ann  Nordström Ltd } \\
		{\large Hazel 41}\\
		{\large 12377, Stuttgart, Indiana, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
