...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kendall Victoria Bengtsson} \\
		{\large Morgan 78}\\
		{\large 39435, Washington, Indiana, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sophie Rose 	 Nyström Pte Ltd } \\
		{\large Patrick 11}\\
		{\large 67920, Nha Trang, Chai Nat, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
