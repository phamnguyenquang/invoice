...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Brooklyn Thomas Nyberg} \\
		{\large Kyle 51}\\
		{\large 62908, San Francisco, khanh Hoa, Ireland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn Robert Samuelsson Corp } \\
		{\large Valentina 67}\\
		{\large 18269, Paris, Binh Thuan, Canada }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
