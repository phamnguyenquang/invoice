...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Sara Marie 	 Månsson} \\
		{\large Brooklynn 62}\\
		{\large 44155, Ho Chi Minh, Heibei, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Carlos Mary 	 Nordström Corp } \\
		{\large Jameson 5}\\
		{\large 82382, Vancouver, Chiang Rai, Denmark}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
