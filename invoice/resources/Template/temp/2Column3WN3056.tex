...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zachary Jane Abrahamsson} \\
		{\large Abigail 80}\\
		{\large 63429, Amsterdam, Binh Thuan, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Penelope Robert Arvidsson Ltd } \\
		{\large Maria 62}\\
		{\large 34594, Melbourne, Bangkok, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
