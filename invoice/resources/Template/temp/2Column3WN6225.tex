...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jennifer  Alexander  Mohamed} \\
		{\large Leo 85}\\
		{\large 94879, Frankfurt am Main , Saarland, VietNam}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jocelyn Christopher Sandström Ltd } \\
		{\large Savannah 89}\\
		{\large 26109, SaiGon, Saarland, Ireland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
