...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Carter Louise 	 Martinsson Pte Ltd} \\
		{\large Katelyn 62}\\
		{\large 75840, Lisbon, Binh Thuan, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michael Jakobsson } \\
		{\large Sophie 92}\\
		{\large 66619, Singapore, Guangdong, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
