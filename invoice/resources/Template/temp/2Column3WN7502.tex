...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Luke Peter Nordström} \\
		{\large Amy 97}\\
		{\large 90235, Frankfurt am Main , Binh Thuan, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Sofia Elizabeth 	 Åkesson Pte Ltd } \\
		{\large Jayla 40}\\
		{\large 70666, Paris, Hamburg, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
