...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Charles Michael Wallin} \\
		{\large Maria 62}\\
		{\large 18684, Washington, Tuscany, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Aubree Michael Forsberg Pte Ltd } \\
		{\large Greyson 99}\\
		{\large 72608, Frankfurt am Main , Hainan, Japan }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
