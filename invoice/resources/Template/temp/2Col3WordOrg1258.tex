...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mackenzie Anne Wikström Pte Ltd} \\
		{\large Bailey 43}\\
		{\large 46138, Melbourne, Texas, South Korea}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Audrey Claesson } \\
		{\large Stephanie 18}\\
		{\large 75731, Frankfurt am Main , Saarland, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
