...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gabriella Lee  Lundqvist} \\
		{\large Sean 5}\\
		{\large 72789, Montreal, Kentucky, Brazil }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Audrey Jane Johansson Ltd } \\
		{\large Eliza 15}\\
		{\large 97018, Singapore, khanh Hoa, Saudi Arabia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
