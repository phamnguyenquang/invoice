...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  David  Alexander  Ahmed Ltd} \\
		{\large Charlotte 42}\\
		{\large 11768, Lisbon, Chiang Mai, South Africa }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Santiago Fredriksson } \\
		{\large Paul 72}\\
		{\large 16133, Barcelona, Chiang Mai, United State }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
