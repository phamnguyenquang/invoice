...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jayla Christopher Söderberg Pte Ltd} \\
		{\large Christopher 15}\\
		{\large 98636, Milan, Hawaii, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Claire Nordin } \\
		{\large Allison 52}\\
		{\large 75003, San Francisco, Binh Thuan, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
