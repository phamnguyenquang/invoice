...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mason Christopher Bergqvist} \\
		{\large Adriana 53}\\
		{\large 34136, Amsterdam, Chiang Mai, China }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Levi Anne Lundgren Pte Ltd } \\
		{\large Adalyn 93}\\
		{\large 39061, Vancouver, Amnat Charoen, Indonesia s}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
