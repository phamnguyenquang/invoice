...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ayden May/Mae 	 Lundström} \\
		{\large Amelia 47}\\
		{\large 30903, Madrid, Binh Thuan, Saudi Arabia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Andrew Kate 	 Hermansson Ltd } \\
		{\large Abigail 96}\\
		{\large 62325, Vancouver, Amnat Charoen, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
