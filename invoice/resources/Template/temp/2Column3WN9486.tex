...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Ariana Mary 	 Holmberg} \\
		{\large Levi 40}\\
		{\large 62420, Barcelona, California, Cambodia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Madeline May/Mae 	 Larsson Inc } \\
		{\large Rose 72}\\
		{\large 80482, Tokyo, Chai Nat, United Kingdom}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
