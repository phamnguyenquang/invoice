...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Aubrey Thomas Engström} \\
		{\large Laila 94}\\
		{\large 70148, Last Vegas, Floria, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Anthony Robert Pettersson Pte Ltd } \\
		{\large Mia 28}\\
		{\large 86681, Venice, Amnat Charoen, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
