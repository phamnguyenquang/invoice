...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Makayla William Berglund Pte Ltd} \\
		{\large Jaxon 16}\\
		{\large 61839, Florence, Chai Nat, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Michael Martinsson } \\
		{\large Carlos 14}\\
		{\large 85211, Last Vegas, Henan, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
