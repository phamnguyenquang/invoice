...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  William William Blomqvist Pte Ltd} \\
		{\large Mary 47}\\
		{\large 88247, Los Angeles, Bremen, United Kingdom}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Maya Sundberg } \\
		{\large Kaitlyn 48}\\
		{\large 44296, Venice, Tuscany, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
