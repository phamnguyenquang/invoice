...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Alexander Henriksson Pte Ltd} \\
		{\large Valerie 12}\\
		{\large 90306, Vancouver, Saarland, Mexico }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Charles Lundström } \\
		{\large Matthew 37}\\
		{\large 92401, Frankfurt am Main , Hessen, South Africa }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
