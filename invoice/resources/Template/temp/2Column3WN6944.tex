...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Victoria Rose 	 Sandberg} \\
		{\large Ryder 50}\\
		{\large 51259, Amsterdam, Amnat Charoen, Russia}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Santiago Christopher Nyström Pte Ltd } \\
		{\large Bentley 70}\\
		{\large 75528, Boston, Bangkok, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
