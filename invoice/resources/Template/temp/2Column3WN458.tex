...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Zoey Anne Wikström} \\
		{\large Lila 99}\\
		{\large 22642, Venice, Hawaii, Switzerland}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Nolan Grace 	 Martinsson Corp } \\
		{\large Rylee 80}\\
		{\large 25177, Frankfurt am Main , Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
