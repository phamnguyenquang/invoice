...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maddox Elizabeth 	 Lund} \\
		{\large Angelina 60}\\
		{\large 69873, Melbourne, Hamburg, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Chloe Grace 	 Karlsson Pte Ltd } \\
		{\large Ezekiel 13}\\
		{\large 34924, Abu Dhabi, Amnat Charoen, Argentina }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
