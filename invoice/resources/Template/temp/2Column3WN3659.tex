...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Catherine Jane Bergman} \\
		{\large Amelia 63}\\
		{\large 43401, Beijing, Hessen, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Alexa Christopher Månsson Inc } \\
		{\large Owen 33}\\
		{\large 68789, Stuttgart, Hainan, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
