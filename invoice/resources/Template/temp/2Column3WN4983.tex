...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Julian May/Mae 	 Hansen} \\
		{\large Aubrey 32}\\
		{\large 38344, Taipei, Guangzhou, Italy }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Gabriella Catherine  Söderberg Ltd } \\
		{\large Olivia 42}\\
		{\large 45186, Seoul, Chiang Rai, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
