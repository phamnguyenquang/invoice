...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Maverick Lee  Björk Inc} \\
		{\large Peyton 35}\\
		{\large 37856, Frankfurt am Main , Guangzhou, Australia }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Ryleigh Bergman } \\
		{\large Weston 60}\\
		{\large 31811, Melbourne, Ang Thong, South Korea}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
