...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kimberly Louise 	 Bergqvist Pte Ltd} \\
		{\large Jayce 16}\\
		{\large 96668, Hong Kong, California, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Julia Hellström } \\
		{\large Adalyn 56}\\
		{\large 39885, Hong Kong, Chiang Rai, Italy }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
