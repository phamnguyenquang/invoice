...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Genesis Anne Gunnarsson} \\
		{\large James 74}\\
		{\large 50077, Hong Kong, Huabei, Indonesia s}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Audrey Victoria Falk Pte Ltd } \\
		{\large Ruby 54}\\
		{\large 35294, Singapore, Binh Thuan, Russia}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
