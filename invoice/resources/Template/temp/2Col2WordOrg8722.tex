...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Chloe Johansson Pte Ltd} \\
		{\large Gael 21}\\
		{\large 75782, Paris, Hamburg, United State }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Leonardo Björklund } \\
		{\large Patrick 25}\\
		{\large 69051, Frankfurt am Main , Guangzhou, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
