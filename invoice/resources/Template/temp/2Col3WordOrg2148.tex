...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jack Mary 	 Lindholm Ltd} \\
		{\large Lincoln 77}\\
		{\large 50558, Frankfurt am Main , Phu Yen, France }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large William Mårtensson } \\
		{\large Kennedy 3}\\
		{\large 10686, Frankfurt am Main , Indiana, France }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
