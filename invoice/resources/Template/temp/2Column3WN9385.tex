...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Jade William Månsson} \\
		{\large Camila 62}\\
		{\large 41499, Stuttgart, Saarland, Canada }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Kennedy James Söderberg Corp } \\
		{\large Ezra 54}\\
		{\large 60534, Frankfurt am Main , Indiana, New Zealand}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
