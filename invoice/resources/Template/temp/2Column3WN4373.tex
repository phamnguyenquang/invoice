...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Mckenzie Louise 	 Karlsson} \\
		{\large Kyle 33}\\
		{\large 91723, Istanbul, Tuscany, Argentina }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Mason May/Mae 	 Arvidsson Ltd } \\
		{\large Kevin 32}\\
		{\large 70261, New York , Binh Thuan, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
