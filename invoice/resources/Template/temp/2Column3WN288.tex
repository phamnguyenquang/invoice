...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Kevin Louise 	 Andersson} \\
		{\large Rachel 61}\\
		{\large 38218, Ho Chi Minh, Hainan, ThaiLand}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Natalie Edward Lundqvist Inc } \\
		{\large Nicholas 9}\\
		{\large 84721, Minsk, Amnat Charoen, Australia }\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
