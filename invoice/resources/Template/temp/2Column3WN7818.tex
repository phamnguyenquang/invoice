...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Patrick  Alexander  Wallin} \\
		{\large Rylee 48}\\
		{\large 83169, Last Vegas, Ang Thong, laos}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Jace Michael Isaksson Corp } \\
		{\large Miguel 39}\\
		{\large 22032, Vancouver, Guangdong, Singapore}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
