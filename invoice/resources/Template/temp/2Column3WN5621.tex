...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Gianna John Dahl} \\
		{\large Jaden 9}\\
		{\large 42556, Denver, Floria, Philippines}\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Hunter Louise 	 Henriksson Pte Ltd } \\
		{\large Jackson 56}\\
		{\large 67965, Nha Trang, Chiang Rai, Switzerland}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
