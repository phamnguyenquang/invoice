...
\begin{minipage}[t]{0.5\textwidth}
 	\begin{flushright}
		\textbf{\huge  Santiago Persson} \\
		{\large Kingston 84}\\
		{\large 62803, Boston, California, Japan }\\
...
\begin{minipage}[t]{0.5\textwidth}
	\begin{flushleft}
	%---------------------------------------
	 	\textbf{\large Destiny Elizabeth 	 Holmgren Pte Ltd } \\
		{\large Christopher 52}\\
		{\large 78822, Amsterdam, khanh Hoa, laos}\\
	%---------------------------------------
	\end{flushleft}
\end{minipage}
\begin{minipage}[t]{0.5\textwidth}
